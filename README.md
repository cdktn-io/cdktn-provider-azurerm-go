# CDKTF Go bindings for hashicorp/azurerm provider version 4.60.0

This repo builds and publishes the [Terraform azurerm provider](https://registry.terraform.io/providers/hashicorp/azurerm/4.60.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
Find auto-generated docs for this provider [here](https://github.com/cdktn-io/cdktn-provider-azurerm/blob/main/docs/API.go.md).
...
* [Terraform azurerm provider](https://registry.terraform.io/providers/hashicorp/azurerm/4.60.0)
