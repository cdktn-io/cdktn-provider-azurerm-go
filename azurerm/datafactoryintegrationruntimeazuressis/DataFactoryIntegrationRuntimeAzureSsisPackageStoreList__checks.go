...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisPackageStoreList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisPackageStoreList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataFactoryIntegrationRuntimeAzureSsisPackageStoreListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
