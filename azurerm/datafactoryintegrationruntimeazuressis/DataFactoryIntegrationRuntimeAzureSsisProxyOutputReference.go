...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisProxyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisProxyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
