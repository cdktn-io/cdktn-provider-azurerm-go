...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisPackageStoreList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisPackageStoreList) Resolve(context cdktf.IResolveContext) interface{} {
