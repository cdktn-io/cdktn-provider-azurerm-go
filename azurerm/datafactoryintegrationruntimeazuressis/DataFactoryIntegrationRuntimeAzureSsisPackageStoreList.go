...
func (j *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisPackageStoreList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryIntegrationRuntimeAzureSsisPackageStoreList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryIntegrationRuntimeAzureSsisPackageStoreList {
	_init_.Initialize()

	if err := validateNewDataFactoryIntegrationRuntimeAzureSsisPackageStoreListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisPackageStoreList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryIntegrationRuntimeAzureSsis.DataFactoryIntegrationRuntimeAzureSsisPackageStoreList",
...
func NewDataFactoryIntegrationRuntimeAzureSsisPackageStoreList_Override(d DataFactoryIntegrationRuntimeAzureSsisPackageStoreList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisPackageStoreList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisPackageStoreList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisPackageStoreList) Resolve(context cdktn.IResolveContext) interface{} {
