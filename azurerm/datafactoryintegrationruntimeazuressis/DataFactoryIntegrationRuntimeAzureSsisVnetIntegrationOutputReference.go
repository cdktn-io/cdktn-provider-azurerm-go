...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisVnetIntegrationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisVnetIntegrationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
