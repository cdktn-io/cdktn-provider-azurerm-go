...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisCustomSetupScriptOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisCustomSetupScriptOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
