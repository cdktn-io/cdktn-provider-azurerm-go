...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisExpressCustomSetupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisExpressCustomSetupOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
