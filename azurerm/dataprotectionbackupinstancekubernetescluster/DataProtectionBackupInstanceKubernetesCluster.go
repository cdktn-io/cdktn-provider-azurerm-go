...
func (j *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) ProtectionState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"protectionState",
...
func (j *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/data_protection_backup_instance_kubernetes_cluster azurerm_data_protection_backup_instance_kubernetes_cluster} Resource.
...
func (j *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataProtectionBackupInstanceKubernetesCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataProtectionBackupInstanceKubernetesCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
