...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/digitaltwinstimeseriesdatabaseconnection/internal"
...
func (j *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/digital_twins_time_series_database_connection azurerm_digital_twins_time_series_database_connection} Resource.
...
func (j *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection)SetCount(val interface{}) {
...
func (j *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DigitalTwinsTimeSeriesDatabaseConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDigitalTwinsTimeSeriesDatabaseConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) MoveFromId(id *string) {
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) MoveToId(id *string) {
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
