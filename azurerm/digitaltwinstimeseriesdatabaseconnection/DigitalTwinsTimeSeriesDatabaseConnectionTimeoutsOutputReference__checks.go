...
func (d *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnectionTimeoutsOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (j *jsiiProxy_DigitalTwinsTimeSeriesDatabaseConnectionTimeoutsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *DigitalTwinsTimeSeriesDatabaseConnectionTimeouts:
		val := val.(*DigitalTwinsTimeSeriesDatabaseConnectionTimeouts)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case DigitalTwinsTimeSeriesDatabaseConnectionTimeouts:
		val_ := val.(DigitalTwinsTimeSeriesDatabaseConnectionTimeouts)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *DigitalTwinsTimeSeriesDatabaseConnectionTimeouts; received %#v (a %T)", val, val)
		}
	}
