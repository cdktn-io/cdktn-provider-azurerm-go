...
func (s *jsiiProxy_SynapseWorkspaceCustomerManagedKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SynapseWorkspaceCustomerManagedKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
