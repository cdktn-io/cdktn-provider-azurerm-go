...
func (s *jsiiProxy_SynapseWorkspaceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SynapseWorkspaceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
