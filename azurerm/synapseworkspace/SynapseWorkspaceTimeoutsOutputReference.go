...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/synapseworkspace/internal"
...
func (j *jsiiProxy_SynapseWorkspaceTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSynapseWorkspaceTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SynapseWorkspaceTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSynapseWorkspaceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSynapseWorkspaceTimeoutsOutputReference_Override(s SynapseWorkspaceTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SynapseWorkspaceTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SynapseWorkspaceTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseWorkspaceTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SynapseWorkspaceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseWorkspaceTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
