...
func (j *jsiiProxy_KeyVault) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KeyVault) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KeyVault) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KeyVault) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KeyVault) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/key_vault azurerm_key_vault} Resource.
...
func (j *jsiiProxy_KeyVault)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KeyVault)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KeyVault)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KeyVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KeyVault) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVault) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KeyVault) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KeyVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KeyVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
