...
func (j *jsiiProxy_KeyVaultContactList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKeyVaultContactList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KeyVaultContactList {
	_init_.Initialize()
...
func NewKeyVaultContactList_Override(k KeyVaultContactList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KeyVaultContactList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KeyVaultContactList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KeyVaultContactList) Resolve(context cdktn.IResolveContext) interface{} {
