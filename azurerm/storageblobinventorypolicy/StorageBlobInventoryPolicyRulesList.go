...
func (s *jsiiProxy_StorageBlobInventoryPolicyRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageBlobInventoryPolicyRulesList) Resolve(context cdktf.IResolveContext) interface{} {
