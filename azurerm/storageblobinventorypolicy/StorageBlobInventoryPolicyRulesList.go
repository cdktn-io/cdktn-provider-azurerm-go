...
func (j *jsiiProxy_StorageBlobInventoryPolicyRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageBlobInventoryPolicyRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StorageBlobInventoryPolicyRulesList {
	_init_.Initialize()
...
func NewStorageBlobInventoryPolicyRulesList_Override(s StorageBlobInventoryPolicyRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageBlobInventoryPolicyRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageBlobInventoryPolicyRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageBlobInventoryPolicyRulesList) Resolve(context cdktn.IResolveContext) interface{} {
