...
func (s *jsiiProxy_StorageBlobInventoryPolicy) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (s *jsiiProxy_StorageBlobInventoryPolicy) validateImportFromParameters(id *string) error {
	return nil
}
...
func (s *jsiiProxy_StorageBlobInventoryPolicy) validateMoveToParameters(moveTarget *string, index interface{}) error {
	return nil
}

func (s *jsiiProxy_StorageBlobInventoryPolicy) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func validateStorageBlobInventoryPolicy_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
...
func (j *jsiiProxy_StorageBlobInventoryPolicy) validateSetCountParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_StorageBlobInventoryPolicy) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	return nil
}
