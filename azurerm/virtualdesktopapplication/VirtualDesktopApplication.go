...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/virtualdesktopapplication/internal"
...
func (j *jsiiProxy_VirtualDesktopApplication) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VirtualDesktopApplication) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VirtualDesktopApplication) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VirtualDesktopApplication) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VirtualDesktopApplication) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/virtual_desktop_application azurerm_virtual_desktop_application} Resource.
func NewVirtualDesktopApplication(scope constructs.Construct, id *string, config *VirtualDesktopApplicationConfig) VirtualDesktopApplication {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.virtualDesktopApplication.VirtualDesktopApplication",
...
func (j *jsiiProxy_VirtualDesktopApplication)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VirtualDesktopApplication)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VirtualDesktopApplication)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VirtualDesktopApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VirtualDesktopApplication) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopApplication) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VirtualDesktopApplication) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopApplication) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualDesktopApplication) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VirtualDesktopApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
