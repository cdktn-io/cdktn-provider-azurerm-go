...
func (j *jsiiProxy_VirtualDesktopApplicationTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualDesktopApplicationTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VirtualDesktopApplicationTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewVirtualDesktopApplicationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewVirtualDesktopApplicationTimeoutsOutputReference_Override(v VirtualDesktopApplicationTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualDesktopApplicationTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualDesktopApplicationTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopApplicationTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualDesktopApplicationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopApplicationTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
