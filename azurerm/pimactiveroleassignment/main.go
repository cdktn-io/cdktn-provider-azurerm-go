...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putTicket", GoMethod: "PutTicket"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTicket", GoMethod: "ResetTicket"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ticketInput", GoGetter: "TicketInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "durationDays", GoGetter: "DurationDays"},
			_jsii_.MemberProperty{JsiiProperty: "durationDaysInput", GoGetter: "DurationDaysInput"},
			_jsii_.MemberProperty{JsiiProperty: "durationHours", GoGetter: "DurationHours"},
			_jsii_.MemberProperty{JsiiProperty: "durationHoursInput", GoGetter: "DurationHoursInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetDurationDays", GoMethod: "ResetDurationDays"},
			_jsii_.MemberMethod{JsiiMethod: "resetDurationHours", GoMethod: "ResetDurationHours"},
			_jsii_.MemberMethod{JsiiMethod: "resetEndDateTime", GoMethod: "ResetEndDateTime"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetStartDateTime", GoMethod: "ResetStartDateTime"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_PimActiveRoleAssignmentTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
