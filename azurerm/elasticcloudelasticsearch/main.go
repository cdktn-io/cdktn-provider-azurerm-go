...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "elasticCloudEmailAddressInput", GoGetter: "ElasticCloudEmailAddressInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSendAzureadLogs", GoMethod: "ResetSendAzureadLogs"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sendAzureadLogsInput", GoGetter: "SendAzureadLogsInput"},
