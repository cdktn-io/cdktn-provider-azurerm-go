...
func (j *jsiiProxy_ResourceGroupPolicyRemediation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ResourceGroupPolicyRemediation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ResourceGroupPolicyRemediation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ResourceGroupPolicyRemediation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ResourceGroupPolicyRemediation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewResourceGroupPolicyRemediation(scope constructs.Construct, id *string, config *ResourceGroupPolicyRemediationConfig) ResourceGroupPolicyRemediation {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.resourceGroupPolicyRemediation.ResourceGroupPolicyRemediation",
...
func (j *jsiiProxy_ResourceGroupPolicyRemediation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ResourceGroupPolicyRemediation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ResourceGroupPolicyRemediation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ResourceGroupPolicyRemediation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_ResourceGroupPolicyRemediation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupPolicyRemediation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_ResourceGroupPolicyRemediation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupPolicyRemediation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_ResourceGroupPolicyRemediation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_ResourceGroupPolicyRemediation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
