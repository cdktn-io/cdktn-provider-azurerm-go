...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/resourcegrouppolicyremediation/internal"
...
func (j *jsiiProxy_ResourceGroupPolicyRemediationTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResourceGroupPolicyRemediationTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ResourceGroupPolicyRemediationTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewResourceGroupPolicyRemediationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_ResourceGroupPolicyRemediationTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.resourceGroupPolicyRemediation.ResourceGroupPolicyRemediationTimeoutsOutputReference",
...
func NewResourceGroupPolicyRemediationTimeoutsOutputReference_Override(r ResourceGroupPolicyRemediationTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourceGroupPolicyRemediationTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourceGroupPolicyRemediationTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupPolicyRemediationTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_ResourceGroupPolicyRemediationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupPolicyRemediationTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
