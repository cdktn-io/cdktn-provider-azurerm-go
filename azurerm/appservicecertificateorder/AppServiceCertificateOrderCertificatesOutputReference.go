...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/appservicecertificateorder/internal"
...
func (j *jsiiProxy_AppServiceCertificateOrderCertificatesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppServiceCertificateOrderCertificatesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AppServiceCertificateOrderCertificatesOutputReference {
	_init_.Initialize()

	if err := validateNewAppServiceCertificateOrderCertificatesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewAppServiceCertificateOrderCertificatesOutputReference_Override(a AppServiceCertificateOrderCertificatesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppServiceCertificateOrderCertificatesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppServiceCertificateOrderCertificatesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceCertificateOrderCertificatesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppServiceCertificateOrderCertificatesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceCertificateOrderCertificatesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
