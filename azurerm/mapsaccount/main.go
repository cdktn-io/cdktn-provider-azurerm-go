...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "xMsClientId", GoGetter: "XMsClientId"},
		},
		func() interface{} {
			j := jsiiProxy_MapsAccount{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_MapsAccountDataStoreList{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "uniqueNameInput", GoGetter: "UniqueNameInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_MapsAccountTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
