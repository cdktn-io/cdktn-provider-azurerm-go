...
func (r *jsiiProxy_RedisCacheIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedisCacheIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
