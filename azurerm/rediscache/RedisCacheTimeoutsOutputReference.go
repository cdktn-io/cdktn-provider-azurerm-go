...
func (r *jsiiProxy_RedisCacheTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedisCacheTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
