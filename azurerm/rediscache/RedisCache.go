...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/rediscache/internal"
...
func (j *jsiiProxy_RedisCache) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedisCache) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedisCache) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedisCache) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedisCache) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/redis_cache azurerm_redis_cache} Resource.
...
func (j *jsiiProxy_RedisCache)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedisCache)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedisCache)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RedisCache_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedisCache) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedisCache) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedisCache) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedisCache) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedisCache) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedisCache) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
