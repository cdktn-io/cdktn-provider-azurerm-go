...
func (j *jsiiProxy_RedisCachePatchScheduleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedisCachePatchScheduleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedisCachePatchScheduleList {
	_init_.Initialize()
...
func NewRedisCachePatchScheduleList_Override(r RedisCachePatchScheduleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedisCachePatchScheduleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedisCachePatchScheduleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedisCachePatchScheduleList) Resolve(context cdktn.IResolveContext) interface{} {
