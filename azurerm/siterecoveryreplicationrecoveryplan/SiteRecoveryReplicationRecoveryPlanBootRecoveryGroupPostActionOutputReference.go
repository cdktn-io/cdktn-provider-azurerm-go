...
func (s *jsiiProxy_SiteRecoveryReplicationRecoveryPlanBootRecoveryGroupPostActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SiteRecoveryReplicationRecoveryPlanBootRecoveryGroupPostActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
