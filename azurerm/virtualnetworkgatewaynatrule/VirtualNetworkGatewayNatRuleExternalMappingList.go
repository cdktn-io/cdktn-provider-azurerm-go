...
func (v *jsiiProxy_VirtualNetworkGatewayNatRuleExternalMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualNetworkGatewayNatRuleExternalMappingList) Resolve(context cdktf.IResolveContext) interface{} {
