...
func (j *jsiiProxy_VirtualNetworkGatewayNatRuleExternalMappingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualNetworkGatewayNatRuleExternalMappingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualNetworkGatewayNatRuleExternalMappingList {
	_init_.Initialize()

	if err := validateNewVirtualNetworkGatewayNatRuleExternalMappingListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_VirtualNetworkGatewayNatRuleExternalMappingList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.virtualNetworkGatewayNatRule.VirtualNetworkGatewayNatRuleExternalMappingList",
...
func NewVirtualNetworkGatewayNatRuleExternalMappingList_Override(v VirtualNetworkGatewayNatRuleExternalMappingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualNetworkGatewayNatRuleExternalMappingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualNetworkGatewayNatRuleExternalMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualNetworkGatewayNatRuleExternalMappingList) Resolve(context cdktn.IResolveContext) interface{} {
