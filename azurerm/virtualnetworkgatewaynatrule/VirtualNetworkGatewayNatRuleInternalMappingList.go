...
func (v *jsiiProxy_VirtualNetworkGatewayNatRuleInternalMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualNetworkGatewayNatRuleInternalMappingList) Resolve(context cdktf.IResolveContext) interface{} {
