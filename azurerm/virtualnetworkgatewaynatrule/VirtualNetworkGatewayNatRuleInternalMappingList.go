...
func (j *jsiiProxy_VirtualNetworkGatewayNatRuleInternalMappingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualNetworkGatewayNatRuleInternalMappingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualNetworkGatewayNatRuleInternalMappingList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.virtualNetworkGatewayNatRule.VirtualNetworkGatewayNatRuleInternalMappingList",
...
func NewVirtualNetworkGatewayNatRuleInternalMappingList_Override(v VirtualNetworkGatewayNatRuleInternalMappingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualNetworkGatewayNatRuleInternalMappingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualNetworkGatewayNatRuleInternalMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualNetworkGatewayNatRuleInternalMappingList) Resolve(context cdktn.IResolveContext) interface{} {
