...
func (v *jsiiProxy_VirtualNetworkGatewayNatRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualNetworkGatewayNatRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
