...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/servicebussubscriptionrule/internal"
...
func (j *jsiiProxy_ServicebusSubscriptionRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicebusSubscriptionRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ServicebusSubscriptionRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicebusSubscriptionRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicebusSubscriptionRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicebusSubscriptionRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewServicebusSubscriptionRule(scope constructs.Construct, id *string, config *ServicebusSubscriptionRuleConfig) ServicebusSubscriptionRule {
	...
	if err := validateNewServicebusSubscriptionRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ServicebusSubscriptionRule)SetCount(val interface{}) {
...
func (j *jsiiProxy_ServicebusSubscriptionRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicebusSubscriptionRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicebusSubscriptionRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_ServicebusSubscriptionRule)SetSqlFilter(val *string) {
	if err := j.validateSetSqlFilterParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func ServicebusSubscriptionRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateServicebusSubscriptionRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ServicebusSubscriptionRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateServicebusSubscriptionRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ServicebusSubscriptionRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateServicebusSubscriptionRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ServicebusSubscriptionRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateServicebusSubscriptionRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_ServicebusSubscriptionRule) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServicebusSubscriptionRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusSubscriptionRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_ServicebusSubscriptionRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicebusSubscriptionRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusSubscriptionRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicebusSubscriptionRule) MoveFromId(id *string) {
...
func (s *jsiiProxy_ServicebusSubscriptionRule) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_ServicebusSubscriptionRule) MoveToId(id *string) {
...
func (s *jsiiProxy_ServicebusSubscriptionRule) PutCorrelationFilter(value *ServicebusSubscriptionRuleCorrelationFilter) {
	if err := s.validatePutCorrelationFilterParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_ServicebusSubscriptionRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicebusSubscriptionRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_ServicebusSubscriptionRule) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_ServicebusSubscriptionRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
