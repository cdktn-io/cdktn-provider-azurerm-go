...
func (s *jsiiProxy_SecurityCenterContactTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityCenterContactTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
