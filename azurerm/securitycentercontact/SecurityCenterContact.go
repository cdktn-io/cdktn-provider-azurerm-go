...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/securitycentercontact/internal"
...
func (j *jsiiProxy_SecurityCenterContact) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecurityCenterContact) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SecurityCenterContact) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecurityCenterContact) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecurityCenterContact) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecurityCenterContact) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/security_center_contact azurerm_security_center_contact} Resource.
func NewSecurityCenterContact(scope constructs.Construct, id *string, config *SecurityCenterContactConfig) SecurityCenterContact {
	...
	if err := validateNewSecurityCenterContactParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SecurityCenterContact)SetAlertNotifications(val interface{}) {
	if err := j.validateSetAlertNotificationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SecurityCenterContact)SetAlertsToAdmins(val interface{}) {
	if err := j.validateSetAlertsToAdminsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_SecurityCenterContact)SetCount(val interface{}) {
...
func (j *jsiiProxy_SecurityCenterContact)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityCenterContact)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecurityCenterContact)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecurityCenterContact_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityCenterContact_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SecurityCenterContact_IsConstruct(x interface{}) *bool {
	...
	if err := validateSecurityCenterContact_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SecurityCenterContact_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSecurityCenterContact_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SecurityCenterContact_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSecurityCenterContact_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SecurityCenterContact) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityCenterContact) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityCenterContact) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SecurityCenterContact) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecurityCenterContact) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityCenterContact) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecurityCenterContact) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurityCenterContact) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SecurityCenterContact) MoveToId(id *string) {
...
func (s *jsiiProxy_SecurityCenterContact) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecurityCenterContact) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SecurityCenterContact) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SecurityCenterContact) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
