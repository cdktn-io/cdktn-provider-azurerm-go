...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "driverVersion", GoGetter: "DriverVersion"},
			_jsii_.MemberProperty{JsiiProperty: "driverVersionInput", GoGetter: "DriverVersionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDriverVersion", GoMethod: "ResetDriverVersion"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.dataFactoryLinkedServiceMysql.DataFactoryLinkedServiceMysqlConfig",
		reflect.TypeOf((*DataFactoryLinkedServiceMysqlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.dataFactoryLinkedServiceMysql.DataFactoryLinkedServiceMysqlTimeouts",
