...
func (c *jsiiProxy_ContainerConnectedRegistryTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerConnectedRegistryTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
