...
func (c *jsiiProxy_ContainerConnectedRegistry) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ContainerConnectedRegistry) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ContainerConnectedRegistry) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
