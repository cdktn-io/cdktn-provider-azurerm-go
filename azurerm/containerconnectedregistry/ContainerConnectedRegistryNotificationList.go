...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/containerconnectedregistry/internal"
...
func (j *jsiiProxy_ContainerConnectedRegistryNotificationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerConnectedRegistryNotificationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerConnectedRegistryNotificationList {
	_init_.Initialize()

	if err := validateNewContainerConnectedRegistryNotificationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerConnectedRegistryNotificationList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.containerConnectedRegistry.ContainerConnectedRegistryNotificationList",
...
func NewContainerConnectedRegistryNotificationList_Override(c ContainerConnectedRegistryNotificationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerConnectedRegistryNotificationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerConnectedRegistryNotificationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerConnectedRegistryNotificationList) Resolve(context cdktn.IResolveContext) interface{} {
