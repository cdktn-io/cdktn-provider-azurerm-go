...
func (c *jsiiProxy_ContainerConnectedRegistryNotificationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerConnectedRegistryNotificationList) Resolve(context cdktf.IResolveContext) interface{} {
