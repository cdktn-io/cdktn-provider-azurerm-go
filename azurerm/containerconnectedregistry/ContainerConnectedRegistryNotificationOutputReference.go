...
func (j *jsiiProxy_ContainerConnectedRegistryNotificationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerConnectedRegistryNotificationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerConnectedRegistryNotificationOutputReference {
	_init_.Initialize()

	if err := validateNewContainerConnectedRegistryNotificationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewContainerConnectedRegistryNotificationOutputReference_Override(c ContainerConnectedRegistryNotificationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerConnectedRegistryNotificationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerConnectedRegistryNotificationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerConnectedRegistryNotificationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerConnectedRegistryNotificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerConnectedRegistryNotificationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
