...
func (a *jsiiProxy_ApiManagementCustomDomainManagementList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementCustomDomainManagementList) Resolve(context cdktf.IResolveContext) interface{} {
