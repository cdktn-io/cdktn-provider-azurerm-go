...
func (j *jsiiProxy_ApiManagementCustomDomainManagementList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementCustomDomainManagementList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementCustomDomainManagementList {
	_init_.Initialize()

	if err := validateNewApiManagementCustomDomainManagementListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiManagementCustomDomainManagementList_Override(a ApiManagementCustomDomainManagementList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementCustomDomainManagementList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementCustomDomainManagementList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementCustomDomainManagementList) Resolve(context cdktn.IResolveContext) interface{} {
