...
func (a *jsiiProxy_ApiManagementCustomDomainPortalList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementCustomDomainPortalList) Resolve(context cdktf.IResolveContext) interface{} {
