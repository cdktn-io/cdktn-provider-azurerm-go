...
func (j *jsiiProxy_ApiManagementCustomDomainPortalList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementCustomDomainPortalList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementCustomDomainPortalList {
	_init_.Initialize()

	if err := validateNewApiManagementCustomDomainPortalListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiManagementCustomDomainPortalList_Override(a ApiManagementCustomDomainPortalList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementCustomDomainPortalList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementCustomDomainPortalList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementCustomDomainPortalList) Resolve(context cdktn.IResolveContext) interface{} {
