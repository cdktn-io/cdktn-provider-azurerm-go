...
func (j *jsiiProxy_ApiManagementCustomDomainDeveloperPortalList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementCustomDomainDeveloperPortalList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementCustomDomainDeveloperPortalList {
	_init_.Initialize()
...
func NewApiManagementCustomDomainDeveloperPortalList_Override(a ApiManagementCustomDomainDeveloperPortalList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementCustomDomainDeveloperPortalList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementCustomDomainDeveloperPortalList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementCustomDomainDeveloperPortalList) Resolve(context cdktn.IResolveContext) interface{} {
