...
func (j *jsiiProxy_ApiManagementCustomDomain) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiManagementCustomDomain) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiManagementCustomDomain) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiManagementCustomDomain) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiManagementCustomDomain) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/api_management_custom_domain azurerm_api_management_custom_domain} Resource.
...
func (j *jsiiProxy_ApiManagementCustomDomain)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiManagementCustomDomain)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiManagementCustomDomain)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApiManagementCustomDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApiManagementCustomDomain) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementCustomDomain) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiManagementCustomDomain) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementCustomDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiManagementCustomDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiManagementCustomDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
