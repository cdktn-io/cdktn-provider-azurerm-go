...
func (a *jsiiProxy_ApiManagementCustomDomainScmList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementCustomDomainScmList) Resolve(context cdktf.IResolveContext) interface{} {
