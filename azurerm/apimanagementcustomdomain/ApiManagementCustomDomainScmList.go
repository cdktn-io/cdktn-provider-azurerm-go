...
func (j *jsiiProxy_ApiManagementCustomDomainScmList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementCustomDomainScmList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementCustomDomainScmList {
	_init_.Initialize()
...
func NewApiManagementCustomDomainScmList_Override(a ApiManagementCustomDomainScmList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementCustomDomainScmList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementCustomDomainScmList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementCustomDomainScmList) Resolve(context cdktn.IResolveContext) interface{} {
