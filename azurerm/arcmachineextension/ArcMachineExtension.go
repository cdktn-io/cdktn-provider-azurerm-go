...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/arcmachineextension/internal"
...
func (j *jsiiProxy_ArcMachineExtension) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ArcMachineExtension) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ArcMachineExtension) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ArcMachineExtension) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ArcMachineExtension) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/arc_machine_extension azurerm_arc_machine_extension} Resource.
...
func (j *jsiiProxy_ArcMachineExtension)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ArcMachineExtension)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ArcMachineExtension)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ArcMachineExtension_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ArcMachineExtension) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ArcMachineExtension) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ArcMachineExtension) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ArcMachineExtension) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ArcMachineExtension) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
