...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "arcMachineId", GoGetter: "ArcMachineId"},
			_jsii_.MemberProperty{JsiiProperty: "arcMachineIdInput", GoGetter: "ArcMachineIdInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ArcMachineExtensionTimeoutsOutputReference{}
