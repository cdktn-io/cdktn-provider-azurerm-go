...
func (j *jsiiProxy_ApplicationGatewayHttpListenerCustomErrorConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayHttpListenerCustomErrorConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayHttpListenerCustomErrorConfigurationList {
	_init_.Initialize()

	if err := validateNewApplicationGatewayHttpListenerCustomErrorConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayHttpListenerCustomErrorConfigurationList_Override(a ApplicationGatewayHttpListenerCustomErrorConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayHttpListenerCustomErrorConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayHttpListenerCustomErrorConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayHttpListenerCustomErrorConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
