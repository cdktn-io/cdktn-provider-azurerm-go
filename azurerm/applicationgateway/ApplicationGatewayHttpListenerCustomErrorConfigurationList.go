...
func (a *jsiiProxy_ApplicationGatewayHttpListenerCustomErrorConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayHttpListenerCustomErrorConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
