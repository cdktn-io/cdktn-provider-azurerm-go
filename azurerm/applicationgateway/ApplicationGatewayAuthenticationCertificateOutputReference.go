...
func (j *jsiiProxy_ApplicationGatewayAuthenticationCertificateOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayAuthenticationCertificateOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApplicationGatewayAuthenticationCertificateOutputReference {
	_init_.Initialize()

	if err := validateNewApplicationGatewayAuthenticationCertificateOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayAuthenticationCertificateOutputReference_Override(a ApplicationGatewayAuthenticationCertificateOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayAuthenticationCertificateOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayAuthenticationCertificateOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayAuthenticationCertificateOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApplicationGatewayAuthenticationCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayAuthenticationCertificateOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
