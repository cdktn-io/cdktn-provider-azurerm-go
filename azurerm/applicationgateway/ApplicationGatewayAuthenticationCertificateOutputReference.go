...
func (a *jsiiProxy_ApplicationGatewayAuthenticationCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayAuthenticationCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
