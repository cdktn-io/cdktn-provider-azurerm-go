...
func (a *jsiiProxy_ApplicationGatewayTrustedRootCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayTrustedRootCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
