...
func (j *jsiiProxy_ApplicationGatewayPrivateLinkConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayPrivateLinkConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayPrivateLinkConfigurationList {
	_init_.Initialize()
...
func NewApplicationGatewayPrivateLinkConfigurationList_Override(a ApplicationGatewayPrivateLinkConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayPrivateLinkConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayPrivateLinkConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayPrivateLinkConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
