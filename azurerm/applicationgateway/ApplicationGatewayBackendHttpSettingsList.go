...
func (j *jsiiProxy_ApplicationGatewayBackendHttpSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayBackendHttpSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayBackendHttpSettingsList {
	_init_.Initialize()

	if err := validateNewApplicationGatewayBackendHttpSettingsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayBackendHttpSettingsList_Override(a ApplicationGatewayBackendHttpSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayBackendHttpSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayBackendHttpSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayBackendHttpSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
