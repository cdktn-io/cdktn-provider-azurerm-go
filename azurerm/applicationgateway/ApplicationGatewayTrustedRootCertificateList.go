...
func (j *jsiiProxy_ApplicationGatewayTrustedRootCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayTrustedRootCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayTrustedRootCertificateList {
	_init_.Initialize()

	if err := validateNewApplicationGatewayTrustedRootCertificateListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayTrustedRootCertificateList_Override(a ApplicationGatewayTrustedRootCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayTrustedRootCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayTrustedRootCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayTrustedRootCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
