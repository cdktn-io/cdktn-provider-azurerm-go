...
func (a *jsiiProxy_ApplicationGatewayTrustedRootCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayTrustedRootCertificateList) Resolve(context cdktf.IResolveContext) interface{} {
