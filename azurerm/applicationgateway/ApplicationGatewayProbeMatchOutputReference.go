...
func (a *jsiiProxy_ApplicationGatewayProbeMatchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayProbeMatchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
