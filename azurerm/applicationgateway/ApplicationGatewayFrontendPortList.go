...
func (j *jsiiProxy_ApplicationGatewayFrontendPortList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayFrontendPortList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayFrontendPortList {
	_init_.Initialize()
...
func NewApplicationGatewayFrontendPortList_Override(a ApplicationGatewayFrontendPortList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayFrontendPortList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayFrontendPortList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayFrontendPortList) Resolve(context cdktn.IResolveContext) interface{} {
