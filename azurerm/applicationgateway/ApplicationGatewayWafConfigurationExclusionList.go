...
func (a *jsiiProxy_ApplicationGatewayWafConfigurationExclusionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayWafConfigurationExclusionList) Resolve(context cdktf.IResolveContext) interface{} {
