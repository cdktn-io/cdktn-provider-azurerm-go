...
func (j *jsiiProxy_ApplicationGatewayBackendHttpSettingsAuthenticationCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayBackendHttpSettingsAuthenticationCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayBackendHttpSettingsAuthenticationCertificateList {
	_init_.Initialize()

	if err := validateNewApplicationGatewayBackendHttpSettingsAuthenticationCertificateListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayBackendHttpSettingsAuthenticationCertificateList_Override(a ApplicationGatewayBackendHttpSettingsAuthenticationCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayBackendHttpSettingsAuthenticationCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayBackendHttpSettingsAuthenticationCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayBackendHttpSettingsAuthenticationCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
