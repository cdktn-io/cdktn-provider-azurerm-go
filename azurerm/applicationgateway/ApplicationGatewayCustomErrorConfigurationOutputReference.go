...
func (a *jsiiProxy_ApplicationGatewayCustomErrorConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayCustomErrorConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
