...
func (j *jsiiProxy_ApplicationGatewayBackendAddressPoolOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayBackendAddressPoolOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApplicationGatewayBackendAddressPoolOutputReference {
	_init_.Initialize()

	if err := validateNewApplicationGatewayBackendAddressPoolOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayBackendAddressPoolOutputReference_Override(a ApplicationGatewayBackendAddressPoolOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayBackendAddressPoolOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayBackendAddressPoolOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayBackendAddressPoolOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApplicationGatewayBackendAddressPoolOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayBackendAddressPoolOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
