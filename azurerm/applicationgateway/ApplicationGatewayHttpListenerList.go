...
func (j *jsiiProxy_ApplicationGatewayHttpListenerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayHttpListenerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayHttpListenerList {
	_init_.Initialize()
...
func NewApplicationGatewayHttpListenerList_Override(a ApplicationGatewayHttpListenerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayHttpListenerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayHttpListenerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayHttpListenerList) Resolve(context cdktn.IResolveContext) interface{} {
