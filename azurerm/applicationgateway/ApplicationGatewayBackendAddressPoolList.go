...
func (j *jsiiProxy_ApplicationGatewayBackendAddressPoolList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayBackendAddressPoolList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayBackendAddressPoolList {
	_init_.Initialize()
...
func NewApplicationGatewayBackendAddressPoolList_Override(a ApplicationGatewayBackendAddressPoolList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayBackendAddressPoolList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayBackendAddressPoolList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayBackendAddressPoolList) Resolve(context cdktn.IResolveContext) interface{} {
