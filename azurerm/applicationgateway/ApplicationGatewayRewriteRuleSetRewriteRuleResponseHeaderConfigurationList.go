...
func (j *jsiiProxy_ApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfigurationList {
	_init_.Initialize()

	if err := validateNewApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfigurationList_Override(a ApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
