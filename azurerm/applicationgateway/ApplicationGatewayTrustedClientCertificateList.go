...
func (j *jsiiProxy_ApplicationGatewayTrustedClientCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayTrustedClientCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayTrustedClientCertificateList {
	_init_.Initialize()
...
func NewApplicationGatewayTrustedClientCertificateList_Override(a ApplicationGatewayTrustedClientCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayTrustedClientCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayTrustedClientCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayTrustedClientCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
