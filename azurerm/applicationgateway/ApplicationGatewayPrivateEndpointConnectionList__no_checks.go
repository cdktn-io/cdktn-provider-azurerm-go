...
func (a *jsiiProxy_ApplicationGatewayPrivateEndpointConnectionList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_ApplicationGatewayPrivateEndpointConnectionList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewApplicationGatewayPrivateEndpointConnectionListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
