...
type ApplicationGatewaySslProfileOutputReference interface {
	...
	SetVerifyClientCertificateIssuerDn(val interface{})
	VerifyClientCertificateIssuerDnInput() interface{}
...
func (j *jsiiProxy_ApplicationGatewaySslProfileOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_ApplicationGatewaySslProfileOutputReference) VerifyClientCertificateIssuerDn() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApplicationGatewaySslProfileOutputReference) VerifyClientCertificateIssuerDnInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"verifyClientCertificateIssuerDnInput",
		&returns,
	)
	return returns
}
...
func NewApplicationGatewaySslProfileOutputReference_Override(a ApplicationGatewaySslProfileOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewaySslProfileOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_ApplicationGatewaySslProfileOutputReference)SetVerifyClientCertificateIssuerDn(val interface{}) {
	if err := j.validateSetVerifyClientCertificateIssuerDnParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (a *jsiiProxy_ApplicationGatewaySslProfileOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewaySslProfileOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApplicationGatewaySslProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewaySslProfileOutputReference) ResetVerifyClientCertificateIssuerDn() {
	_jsii_.InvokeVoid(
		a,
		"resetVerifyClientCertificateIssuerDn",
		nil, // no parameters
...
func (a *jsiiProxy_ApplicationGatewaySslProfileOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
