...
func (j *jsiiProxy_ApplicationGatewayRewriteRuleSetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayRewriteRuleSetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayRewriteRuleSetList {
	_init_.Initialize()

	if err := validateNewApplicationGatewayRewriteRuleSetListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayRewriteRuleSetList_Override(a ApplicationGatewayRewriteRuleSetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayRewriteRuleSetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayRewriteRuleSetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayRewriteRuleSetList) Resolve(context cdktn.IResolveContext) interface{} {
