...
func (a *jsiiProxy_ApplicationGatewayFrontendPortOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayFrontendPortOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
