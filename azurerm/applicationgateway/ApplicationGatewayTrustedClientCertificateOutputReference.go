...
func (a *jsiiProxy_ApplicationGatewayTrustedClientCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayTrustedClientCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
