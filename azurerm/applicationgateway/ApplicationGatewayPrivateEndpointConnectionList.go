...
func (j *jsiiProxy_ApplicationGatewayPrivateEndpointConnectionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayPrivateEndpointConnectionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayPrivateEndpointConnectionList {
	_init_.Initialize()
...
func NewApplicationGatewayPrivateEndpointConnectionList_Override(a ApplicationGatewayPrivateEndpointConnectionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayPrivateEndpointConnectionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayPrivateEndpointConnectionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayPrivateEndpointConnectionList) Resolve(context cdktn.IResolveContext) interface{} {
