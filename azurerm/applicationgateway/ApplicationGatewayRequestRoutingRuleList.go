...
func (j *jsiiProxy_ApplicationGatewayRequestRoutingRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayRequestRoutingRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayRequestRoutingRuleList {
	_init_.Initialize()

	if err := validateNewApplicationGatewayRequestRoutingRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayRequestRoutingRuleList_Override(a ApplicationGatewayRequestRoutingRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayRequestRoutingRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayRequestRoutingRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayRequestRoutingRuleList) Resolve(context cdktn.IResolveContext) interface{} {
