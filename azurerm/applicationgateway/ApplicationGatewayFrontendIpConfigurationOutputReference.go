...
func (j *jsiiProxy_ApplicationGatewayFrontendIpConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayFrontendIpConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApplicationGatewayFrontendIpConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewApplicationGatewayFrontendIpConfigurationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayFrontendIpConfigurationOutputReference_Override(a ApplicationGatewayFrontendIpConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayFrontendIpConfigurationOutputReference)SetPrivateLinkConfigurationName(val *string) {
	if err := j.validateSetPrivateLinkConfigurationNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ApplicationGatewayFrontendIpConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayFrontendIpConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayFrontendIpConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApplicationGatewayFrontendIpConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayFrontendIpConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
