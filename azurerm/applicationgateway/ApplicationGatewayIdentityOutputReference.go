...
func (j *jsiiProxy_ApplicationGatewayIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ApplicationGatewayIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewApplicationGatewayIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayIdentityOutputReference_Override(a ApplicationGatewayIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApplicationGatewayIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
