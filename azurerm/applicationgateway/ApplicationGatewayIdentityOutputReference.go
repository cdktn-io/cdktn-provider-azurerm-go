...
func (a *jsiiProxy_ApplicationGatewayIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
