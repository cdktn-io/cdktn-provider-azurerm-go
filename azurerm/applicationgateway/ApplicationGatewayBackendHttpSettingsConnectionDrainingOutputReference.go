...
func (j *jsiiProxy_ApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReference {
	_init_.Initialize()

	if err := validateNewApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReference_Override(a ApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReference)SetDrainTimeoutSec(val *float64) {
	if err := j.validateSetDrainTimeoutSecParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayBackendHttpSettingsConnectionDrainingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
