...
func (j *jsiiProxy_ApplicationGatewayPrivateLinkConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayPrivateLinkConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApplicationGatewayPrivateLinkConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewApplicationGatewayPrivateLinkConfigurationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayPrivateLinkConfigurationOutputReference_Override(a ApplicationGatewayPrivateLinkConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayPrivateLinkConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayPrivateLinkConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayPrivateLinkConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApplicationGatewayPrivateLinkConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayPrivateLinkConfigurationOutputReference) PutIpConfiguration(value interface{}) {
	if err := a.validatePutIpConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_ApplicationGatewayPrivateLinkConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
