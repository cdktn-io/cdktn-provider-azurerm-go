...
func (a *jsiiProxy_ApplicationGatewayAutoscaleConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayAutoscaleConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
