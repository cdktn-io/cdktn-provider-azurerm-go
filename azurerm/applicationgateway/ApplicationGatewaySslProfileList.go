...
func (j *jsiiProxy_ApplicationGatewaySslProfileList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewaySslProfileList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewaySslProfileList {
	_init_.Initialize()
...
func NewApplicationGatewaySslProfileList_Override(a ApplicationGatewaySslProfileList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewaySslProfileList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewaySslProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewaySslProfileList) Resolve(context cdktn.IResolveContext) interface{} {
