...
func (j *jsiiProxy_ApplicationGatewaySslCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewaySslCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewaySslCertificateList {
	_init_.Initialize()

	if err := validateNewApplicationGatewaySslCertificateListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewaySslCertificateList_Override(a ApplicationGatewaySslCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewaySslCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewaySslCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewaySslCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
