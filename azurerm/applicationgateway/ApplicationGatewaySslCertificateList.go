...
func (a *jsiiProxy_ApplicationGatewaySslCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewaySslCertificateList) Resolve(context cdktf.IResolveContext) interface{} {
