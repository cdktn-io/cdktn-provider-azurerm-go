...
func (j *jsiiProxy_ApplicationGatewayRewriteRuleSetRewriteRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayRewriteRuleSetRewriteRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayRewriteRuleSetRewriteRuleList {
	_init_.Initialize()
...
func NewApplicationGatewayRewriteRuleSetRewriteRuleList_Override(a ApplicationGatewayRewriteRuleSetRewriteRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayRewriteRuleSetRewriteRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayRewriteRuleSetRewriteRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayRewriteRuleSetRewriteRuleList) Resolve(context cdktn.IResolveContext) interface{} {
