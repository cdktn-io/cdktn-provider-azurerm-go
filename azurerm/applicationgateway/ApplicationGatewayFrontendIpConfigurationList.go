...
func (j *jsiiProxy_ApplicationGatewayFrontendIpConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayFrontendIpConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayFrontendIpConfigurationList {
	_init_.Initialize()

	if err := validateNewApplicationGatewayFrontendIpConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApplicationGatewayFrontendIpConfigurationList_Override(a ApplicationGatewayFrontendIpConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayFrontendIpConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayFrontendIpConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayFrontendIpConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
