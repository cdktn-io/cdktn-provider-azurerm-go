...
func (j *jsiiProxy_ApplicationGatewayProbeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayProbeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayProbeList {
	_init_.Initialize()
...
func NewApplicationGatewayProbeList_Override(a ApplicationGatewayProbeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayProbeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayProbeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayProbeList) Resolve(context cdktn.IResolveContext) interface{} {
