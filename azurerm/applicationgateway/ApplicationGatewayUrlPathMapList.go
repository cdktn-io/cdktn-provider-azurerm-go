...
func (j *jsiiProxy_ApplicationGatewayUrlPathMapList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationGatewayUrlPathMapList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayUrlPathMapList {
	_init_.Initialize()
...
func NewApplicationGatewayUrlPathMapList_Override(a ApplicationGatewayUrlPathMapList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationGatewayUrlPathMapList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationGatewayUrlPathMapList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayUrlPathMapList) Resolve(context cdktn.IResolveContext) interface{} {
