...
func (a *jsiiProxy_ApplicationGatewayUrlPathMapList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayUrlPathMapList) Resolve(context cdktf.IResolveContext) interface{} {
