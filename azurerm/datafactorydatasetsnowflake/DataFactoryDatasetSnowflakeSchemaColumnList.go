...
func (j *jsiiProxy_DataFactoryDatasetSnowflakeSchemaColumnList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryDatasetSnowflakeSchemaColumnList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryDatasetSnowflakeSchemaColumnList {
	_init_.Initialize()

	if err := validateNewDataFactoryDatasetSnowflakeSchemaColumnListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryDatasetSnowflakeSchemaColumnList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryDatasetSnowflake.DataFactoryDatasetSnowflakeSchemaColumnList",
...
func NewDataFactoryDatasetSnowflakeSchemaColumnList_Override(d DataFactoryDatasetSnowflakeSchemaColumnList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryDatasetSnowflakeSchemaColumnList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryDatasetSnowflakeSchemaColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryDatasetSnowflakeSchemaColumnList) Resolve(context cdktn.IResolveContext) interface{} {
