...
func (d *jsiiProxy_DataFactoryDatasetSnowflakeSchemaColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryDatasetSnowflakeSchemaColumnList) Resolve(context cdktf.IResolveContext) interface{} {
