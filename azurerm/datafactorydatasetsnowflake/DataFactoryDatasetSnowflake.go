...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/datafactorydatasetsnowflake/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/data_factory_dataset_snowflake azurerm_data_factory_dataset_snowflake}.
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/data_factory_dataset_snowflake azurerm_data_factory_dataset_snowflake} Resource.
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataFactoryDatasetSnowflake)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataFactoryDatasetSnowflake_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataFactoryDatasetSnowflake) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetSnowflake) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DataFactoryDatasetSnowflake) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetSnowflake) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryDatasetSnowflake) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataFactoryDatasetSnowflake) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
