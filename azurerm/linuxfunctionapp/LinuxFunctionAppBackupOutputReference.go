...
func (l *jsiiProxy_LinuxFunctionAppBackupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppBackupOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
