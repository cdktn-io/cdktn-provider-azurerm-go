...
func (j *jsiiProxy_LinuxFunctionAppIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxFunctionAppIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LinuxFunctionAppIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxFunctionAppIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewLinuxFunctionAppIdentityOutputReference_Override(l LinuxFunctionAppIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxFunctionAppIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxFunctionAppIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxFunctionAppIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
