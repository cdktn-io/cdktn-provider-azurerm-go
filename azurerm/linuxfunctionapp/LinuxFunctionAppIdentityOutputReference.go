...
func (l *jsiiProxy_LinuxFunctionAppIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
