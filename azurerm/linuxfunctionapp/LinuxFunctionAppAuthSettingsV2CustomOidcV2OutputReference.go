...
func (l *jsiiProxy_LinuxFunctionAppAuthSettingsV2CustomOidcV2OutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppAuthSettingsV2CustomOidcV2OutputReference) Resolve(context cdktf.IResolveContext) interface{} {
