...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/linux_function_app azurerm_linux_function_app}.
...
func (j *jsiiProxy_LinuxFunctionApp) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LinuxFunctionApp) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LinuxFunctionApp) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LinuxFunctionApp) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LinuxFunctionApp) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/linux_function_app azurerm_linux_function_app} Resource.
func NewLinuxFunctionApp(scope constructs.Construct, id *string, config *LinuxFunctionAppConfig) LinuxFunctionApp {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxFunctionApp.LinuxFunctionApp",
...
func (j *jsiiProxy_LinuxFunctionApp)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LinuxFunctionApp)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LinuxFunctionApp)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a LinuxFunctionApp resource upon running "cdktn plan <stack-name>".
func LinuxFunctionApp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LinuxFunctionApp) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionApp) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LinuxFunctionApp) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionApp) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LinuxFunctionApp) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LinuxFunctionApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
