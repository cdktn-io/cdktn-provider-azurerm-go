...
func (j *jsiiProxy_LinuxFunctionAppSiteCredentialOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxFunctionAppSiteCredentialOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LinuxFunctionAppSiteCredentialOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxFunctionAppSiteCredentialOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxFunctionAppSiteCredentialOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxFunctionApp.LinuxFunctionAppSiteCredentialOutputReference",
...
func NewLinuxFunctionAppSiteCredentialOutputReference_Override(l LinuxFunctionAppSiteCredentialOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxFunctionAppSiteCredentialOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxFunctionAppSiteCredentialOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppSiteCredentialOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxFunctionAppSiteCredentialOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppSiteCredentialOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
