...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigAppServiceLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigAppServiceLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
