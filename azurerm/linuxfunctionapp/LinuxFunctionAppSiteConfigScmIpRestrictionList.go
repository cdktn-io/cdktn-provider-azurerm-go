...
func (j *jsiiProxy_LinuxFunctionAppSiteConfigScmIpRestrictionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxFunctionAppSiteConfigScmIpRestrictionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxFunctionAppSiteConfigScmIpRestrictionList {
	_init_.Initialize()

	if err := validateNewLinuxFunctionAppSiteConfigScmIpRestrictionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxFunctionAppSiteConfigScmIpRestrictionList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxFunctionApp.LinuxFunctionAppSiteConfigScmIpRestrictionList",
...
func NewLinuxFunctionAppSiteConfigScmIpRestrictionList_Override(l LinuxFunctionAppSiteConfigScmIpRestrictionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxFunctionAppSiteConfigScmIpRestrictionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigScmIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigScmIpRestrictionList) Resolve(context cdktn.IResolveContext) interface{} {
