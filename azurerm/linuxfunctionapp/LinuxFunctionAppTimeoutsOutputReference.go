...
func (l *jsiiProxy_LinuxFunctionAppTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
