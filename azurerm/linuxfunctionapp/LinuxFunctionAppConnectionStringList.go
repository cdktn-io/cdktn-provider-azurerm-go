...
func (j *jsiiProxy_LinuxFunctionAppConnectionStringList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxFunctionAppConnectionStringList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxFunctionAppConnectionStringList {
	_init_.Initialize()

	if err := validateNewLinuxFunctionAppConnectionStringListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxFunctionAppConnectionStringList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxFunctionApp.LinuxFunctionAppConnectionStringList",
...
func NewLinuxFunctionAppConnectionStringList_Override(l LinuxFunctionAppConnectionStringList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxFunctionAppConnectionStringList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxFunctionAppConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxFunctionAppConnectionStringList) Resolve(context cdktn.IResolveContext) interface{} {
