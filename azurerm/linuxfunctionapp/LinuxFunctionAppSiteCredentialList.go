...
func (j *jsiiProxy_LinuxFunctionAppSiteCredentialList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxFunctionAppSiteCredentialList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxFunctionAppSiteCredentialList {
	_init_.Initialize()
...
func NewLinuxFunctionAppSiteCredentialList_Override(l LinuxFunctionAppSiteCredentialList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxFunctionAppSiteCredentialList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxFunctionAppSiteCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxFunctionAppSiteCredentialList) Resolve(context cdktn.IResolveContext) interface{} {
