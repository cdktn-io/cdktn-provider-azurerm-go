...
func (j *jsiiProxy_LinuxFunctionAppAuthSettingsMicrosoftOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxFunctionAppAuthSettingsMicrosoftOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LinuxFunctionAppAuthSettingsMicrosoftOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxFunctionAppAuthSettingsMicrosoftOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxFunctionAppAuthSettingsMicrosoftOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxFunctionApp.LinuxFunctionAppAuthSettingsMicrosoftOutputReference",
...
func NewLinuxFunctionAppAuthSettingsMicrosoftOutputReference_Override(l LinuxFunctionAppAuthSettingsMicrosoftOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxFunctionAppAuthSettingsMicrosoftOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxFunctionAppAuthSettingsMicrosoftOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppAuthSettingsMicrosoftOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxFunctionAppAuthSettingsMicrosoftOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppAuthSettingsMicrosoftOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
