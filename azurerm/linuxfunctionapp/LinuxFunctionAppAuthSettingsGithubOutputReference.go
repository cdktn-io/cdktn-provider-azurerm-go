...
func (j *jsiiProxy_LinuxFunctionAppAuthSettingsGithubOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxFunctionAppAuthSettingsGithubOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LinuxFunctionAppAuthSettingsGithubOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxFunctionAppAuthSettingsGithubOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxFunctionAppAuthSettingsGithubOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxFunctionApp.LinuxFunctionAppAuthSettingsGithubOutputReference",
...
func NewLinuxFunctionAppAuthSettingsGithubOutputReference_Override(l LinuxFunctionAppAuthSettingsGithubOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxFunctionAppAuthSettingsGithubOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxFunctionAppAuthSettingsGithubOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppAuthSettingsGithubOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxFunctionAppAuthSettingsGithubOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppAuthSettingsGithubOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
