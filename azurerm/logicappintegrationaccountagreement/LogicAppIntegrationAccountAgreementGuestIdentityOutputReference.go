...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/logicappintegrationaccountagreement/internal"
...
func (j *jsiiProxy_LogicAppIntegrationAccountAgreementGuestIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogicAppIntegrationAccountAgreementGuestIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LogicAppIntegrationAccountAgreementGuestIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewLogicAppIntegrationAccountAgreementGuestIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewLogicAppIntegrationAccountAgreementGuestIdentityOutputReference_Override(l LogicAppIntegrationAccountAgreementGuestIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogicAppIntegrationAccountAgreementGuestIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementGuestIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementGuestIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementGuestIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementGuestIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
