...
func (j *jsiiProxy_LogicAppIntegrationAccountAgreementTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogicAppIntegrationAccountAgreementTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LogicAppIntegrationAccountAgreementTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewLogicAppIntegrationAccountAgreementTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewLogicAppIntegrationAccountAgreementTimeoutsOutputReference_Override(l LogicAppIntegrationAccountAgreementTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogicAppIntegrationAccountAgreementTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
