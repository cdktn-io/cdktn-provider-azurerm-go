...
func (j *jsiiProxy_LogicAppIntegrationAccountAgreementHostIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogicAppIntegrationAccountAgreementHostIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LogicAppIntegrationAccountAgreementHostIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewLogicAppIntegrationAccountAgreementHostIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewLogicAppIntegrationAccountAgreementHostIdentityOutputReference_Override(l LogicAppIntegrationAccountAgreementHostIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogicAppIntegrationAccountAgreementHostIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementHostIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementHostIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementHostIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountAgreementHostIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
