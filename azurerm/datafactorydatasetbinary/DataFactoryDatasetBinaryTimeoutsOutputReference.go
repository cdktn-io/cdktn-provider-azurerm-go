...
func (d *jsiiProxy_DataFactoryDatasetBinaryTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetBinaryTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
