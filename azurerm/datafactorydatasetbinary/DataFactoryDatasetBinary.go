...
func (j *jsiiProxy_DataFactoryDatasetBinary) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataFactoryDatasetBinary) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataFactoryDatasetBinary) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataFactoryDatasetBinary) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataFactoryDatasetBinary) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataFactoryDatasetBinary)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataFactoryDatasetBinary)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataFactoryDatasetBinary)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataFactoryDatasetBinary_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataFactoryDatasetBinary) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetBinary) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DataFactoryDatasetBinary) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetBinary) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryDatasetBinary) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataFactoryDatasetBinary) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
