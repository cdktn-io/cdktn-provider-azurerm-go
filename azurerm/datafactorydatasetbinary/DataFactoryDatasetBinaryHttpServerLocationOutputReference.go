...
func (d *jsiiProxy_DataFactoryDatasetBinaryHttpServerLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetBinaryHttpServerLocationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
