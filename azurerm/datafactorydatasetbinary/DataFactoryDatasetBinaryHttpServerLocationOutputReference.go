...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/datafactorydatasetbinary/internal"
...
func (j *jsiiProxy_DataFactoryDatasetBinaryHttpServerLocationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryDatasetBinaryHttpServerLocationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataFactoryDatasetBinaryHttpServerLocationOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryDatasetBinaryHttpServerLocationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryDatasetBinaryHttpServerLocationOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryDatasetBinary.DataFactoryDatasetBinaryHttpServerLocationOutputReference",
...
func NewDataFactoryDatasetBinaryHttpServerLocationOutputReference_Override(d DataFactoryDatasetBinaryHttpServerLocationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryDatasetBinaryHttpServerLocationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryDatasetBinaryHttpServerLocationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetBinaryHttpServerLocationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryDatasetBinaryHttpServerLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetBinaryHttpServerLocationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
