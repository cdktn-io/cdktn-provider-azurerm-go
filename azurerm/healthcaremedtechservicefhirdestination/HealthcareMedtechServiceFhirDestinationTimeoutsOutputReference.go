...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/healthcaremedtechservicefhirdestination/internal"
...
func (j *jsiiProxy_HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHealthcareMedtechServiceFhirDestinationTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.healthcareMedtechServiceFhirDestination.HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference",
...
func NewHealthcareMedtechServiceFhirDestinationTimeoutsOutputReference_Override(h HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
