...
func (c *jsiiProxy_ContainerGroupExposedPortOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerGroupExposedPortOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
