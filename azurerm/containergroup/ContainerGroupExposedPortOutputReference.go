...
func (j *jsiiProxy_ContainerGroupExposedPortOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupExposedPortOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerGroupExposedPortOutputReference {
	_init_.Initialize()

	if err := validateNewContainerGroupExposedPortOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerGroupExposedPortOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.containerGroup.ContainerGroupExposedPortOutputReference",
...
func NewContainerGroupExposedPortOutputReference_Override(c ContainerGroupExposedPortOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupExposedPortOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupExposedPortOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupExposedPortOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerGroupExposedPortOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupExposedPortOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
