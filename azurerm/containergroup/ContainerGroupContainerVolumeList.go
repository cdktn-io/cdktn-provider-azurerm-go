...
func (j *jsiiProxy_ContainerGroupContainerVolumeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupContainerVolumeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerGroupContainerVolumeList {
	_init_.Initialize()
...
func NewContainerGroupContainerVolumeList_Override(c ContainerGroupContainerVolumeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupContainerVolumeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupContainerVolumeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerGroupContainerVolumeList) Resolve(context cdktn.IResolveContext) interface{} {
