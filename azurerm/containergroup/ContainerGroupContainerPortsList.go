...
func (j *jsiiProxy_ContainerGroupContainerPortsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupContainerPortsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerGroupContainerPortsList {
	_init_.Initialize()
...
func NewContainerGroupContainerPortsList_Override(c ContainerGroupContainerPortsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupContainerPortsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupContainerPortsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerGroupContainerPortsList) Resolve(context cdktn.IResolveContext) interface{} {
