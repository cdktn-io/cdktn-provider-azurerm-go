...
func (j *jsiiProxy_ContainerGroupContainerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupContainerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerGroupContainerList {
	_init_.Initialize()
...
func NewContainerGroupContainerList_Override(c ContainerGroupContainerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupContainerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupContainerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerGroupContainerList) Resolve(context cdktn.IResolveContext) interface{} {
