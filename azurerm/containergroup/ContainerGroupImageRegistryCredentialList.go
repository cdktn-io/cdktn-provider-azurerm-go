...
func (j *jsiiProxy_ContainerGroupImageRegistryCredentialList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupImageRegistryCredentialList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerGroupImageRegistryCredentialList {
	_init_.Initialize()

	if err := validateNewContainerGroupImageRegistryCredentialListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerGroupImageRegistryCredentialList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.containerGroup.ContainerGroupImageRegistryCredentialList",
...
func NewContainerGroupImageRegistryCredentialList_Override(c ContainerGroupImageRegistryCredentialList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupImageRegistryCredentialList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupImageRegistryCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerGroupImageRegistryCredentialList) Resolve(context cdktn.IResolveContext) interface{} {
