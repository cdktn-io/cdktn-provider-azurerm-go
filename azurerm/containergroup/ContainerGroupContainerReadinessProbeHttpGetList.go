...
func (j *jsiiProxy_ContainerGroupContainerReadinessProbeHttpGetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupContainerReadinessProbeHttpGetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerGroupContainerReadinessProbeHttpGetList {
	_init_.Initialize()

	if err := validateNewContainerGroupContainerReadinessProbeHttpGetListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerGroupContainerReadinessProbeHttpGetList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.containerGroup.ContainerGroupContainerReadinessProbeHttpGetList",
...
func NewContainerGroupContainerReadinessProbeHttpGetList_Override(c ContainerGroupContainerReadinessProbeHttpGetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupContainerReadinessProbeHttpGetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupContainerReadinessProbeHttpGetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerGroupContainerReadinessProbeHttpGetList) Resolve(context cdktn.IResolveContext) interface{} {
