...
func (j *jsiiProxy_ContainerGroupContainerLivenessProbeHttpGetOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupContainerLivenessProbeHttpGetOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerGroupContainerLivenessProbeHttpGetOutputReference {
	_init_.Initialize()

	if err := validateNewContainerGroupContainerLivenessProbeHttpGetOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerGroupContainerLivenessProbeHttpGetOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.containerGroup.ContainerGroupContainerLivenessProbeHttpGetOutputReference",
...
func NewContainerGroupContainerLivenessProbeHttpGetOutputReference_Override(c ContainerGroupContainerLivenessProbeHttpGetOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupContainerLivenessProbeHttpGetOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupContainerLivenessProbeHttpGetOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupContainerLivenessProbeHttpGetOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerGroupContainerLivenessProbeHttpGetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupContainerLivenessProbeHttpGetOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
