...
func (j *jsiiProxy_ContainerGroupExposedPortList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupExposedPortList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerGroupExposedPortList {
	_init_.Initialize()
...
func NewContainerGroupExposedPortList_Override(c ContainerGroupExposedPortList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupExposedPortList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupExposedPortList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerGroupExposedPortList) Resolve(context cdktn.IResolveContext) interface{} {
