...
func (c *jsiiProxy_ContainerGroupIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerGroupIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
