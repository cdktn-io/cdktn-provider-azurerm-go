...
func (j *jsiiProxy_ContainerGroupInitContainerVolumeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupInitContainerVolumeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerGroupInitContainerVolumeList {
	_init_.Initialize()

	if err := validateNewContainerGroupInitContainerVolumeListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerGroupInitContainerVolumeList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.containerGroup.ContainerGroupInitContainerVolumeList",
...
func NewContainerGroupInitContainerVolumeList_Override(c ContainerGroupInitContainerVolumeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupInitContainerVolumeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupInitContainerVolumeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerGroupInitContainerVolumeList) Resolve(context cdktn.IResolveContext) interface{} {
