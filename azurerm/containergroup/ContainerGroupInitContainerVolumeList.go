...
func (c *jsiiProxy_ContainerGroupInitContainerVolumeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerGroupInitContainerVolumeList) Resolve(context cdktf.IResolveContext) interface{} {
