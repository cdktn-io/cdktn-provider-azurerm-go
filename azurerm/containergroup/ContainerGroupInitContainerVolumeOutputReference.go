...
func (c *jsiiProxy_ContainerGroupInitContainerVolumeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerGroupInitContainerVolumeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
