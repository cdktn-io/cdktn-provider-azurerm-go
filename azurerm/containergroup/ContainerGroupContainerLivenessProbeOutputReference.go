...
func (j *jsiiProxy_ContainerGroupContainerLivenessProbeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupContainerLivenessProbeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ContainerGroupContainerLivenessProbeOutputReference {
	_init_.Initialize()

	if err := validateNewContainerGroupContainerLivenessProbeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerGroupContainerLivenessProbeOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.containerGroup.ContainerGroupContainerLivenessProbeOutputReference",
...
func NewContainerGroupContainerLivenessProbeOutputReference_Override(c ContainerGroupContainerLivenessProbeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupContainerLivenessProbeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupContainerLivenessProbeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupContainerLivenessProbeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerGroupContainerLivenessProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupContainerLivenessProbeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
