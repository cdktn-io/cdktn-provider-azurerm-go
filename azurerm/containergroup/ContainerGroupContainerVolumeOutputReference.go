...
func (j *jsiiProxy_ContainerGroupContainerVolumeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupContainerVolumeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerGroupContainerVolumeOutputReference {
	_init_.Initialize()

	if err := validateNewContainerGroupContainerVolumeOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerGroupContainerVolumeOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.containerGroup.ContainerGroupContainerVolumeOutputReference",
...
func NewContainerGroupContainerVolumeOutputReference_Override(c ContainerGroupContainerVolumeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupContainerVolumeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupContainerVolumeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupContainerVolumeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerGroupContainerVolumeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupContainerVolumeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
