...
func (j *jsiiProxy_ContainerGroupDiagnosticsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupDiagnosticsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ContainerGroupDiagnosticsOutputReference {
	_init_.Initialize()
...
func NewContainerGroupDiagnosticsOutputReference_Override(c ContainerGroupDiagnosticsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupDiagnosticsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupDiagnosticsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupDiagnosticsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerGroupDiagnosticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupDiagnosticsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
