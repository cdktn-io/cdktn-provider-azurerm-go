...
func (j *jsiiProxy_ContainerGroupDiagnosticsLogAnalyticsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupDiagnosticsLogAnalyticsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ContainerGroupDiagnosticsLogAnalyticsOutputReference {
	_init_.Initialize()
...
func NewContainerGroupDiagnosticsLogAnalyticsOutputReference_Override(c ContainerGroupDiagnosticsLogAnalyticsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupDiagnosticsLogAnalyticsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupDiagnosticsLogAnalyticsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupDiagnosticsLogAnalyticsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerGroupDiagnosticsLogAnalyticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerGroupDiagnosticsLogAnalyticsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
