...
func (c *jsiiProxy_ContainerGroupDiagnosticsLogAnalyticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerGroupDiagnosticsLogAnalyticsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
