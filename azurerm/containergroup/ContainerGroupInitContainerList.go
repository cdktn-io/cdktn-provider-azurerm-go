...
func (c *jsiiProxy_ContainerGroupInitContainerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerGroupInitContainerList) Resolve(context cdktf.IResolveContext) interface{} {
