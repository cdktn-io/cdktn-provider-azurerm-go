...
func (j *jsiiProxy_ContainerGroupInitContainerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerGroupInitContainerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerGroupInitContainerList {
	_init_.Initialize()

	if err := validateNewContainerGroupInitContainerListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerGroupInitContainerList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.containerGroup.ContainerGroupInitContainerList",
...
func NewContainerGroupInitContainerList_Override(c ContainerGroupInitContainerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerGroupInitContainerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerGroupInitContainerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerGroupInitContainerList) Resolve(context cdktn.IResolveContext) interface{} {
