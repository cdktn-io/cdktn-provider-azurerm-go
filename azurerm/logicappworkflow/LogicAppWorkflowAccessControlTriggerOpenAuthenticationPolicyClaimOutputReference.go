...
func (j *jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyClaimOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyClaimOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyClaimOutputReference {
	_init_.Initialize()

	if err := validateNewLogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyClaimOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyClaimOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyClaimOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyClaimOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyClaimOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyClaimOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
