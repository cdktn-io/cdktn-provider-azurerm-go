...
func (l *jsiiProxy_LogicAppWorkflowAccessControlContentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlContentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
