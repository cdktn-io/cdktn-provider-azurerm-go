...
func (j *jsiiProxy_LogicAppWorkflowAccessControlContentOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogicAppWorkflowAccessControlContentOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LogicAppWorkflowAccessControlContentOutputReference {
	_init_.Initialize()

	if err := validateNewLogicAppWorkflowAccessControlContentOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewLogicAppWorkflowAccessControlContentOutputReference_Override(l LogicAppWorkflowAccessControlContentOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogicAppWorkflowAccessControlContentOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlContentOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlContentOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlContentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlContentOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
