...
func (l *jsiiProxy_LogicAppWorkflowTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppWorkflowTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
