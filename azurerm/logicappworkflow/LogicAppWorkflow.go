...
func (l *jsiiProxy_LogicAppWorkflow) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogicAppWorkflow) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
