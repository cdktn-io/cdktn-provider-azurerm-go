...
func (j *jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList {
	_init_.Initialize()
...
func NewLogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList_Override(l LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlTriggerOpenAuthenticationPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
