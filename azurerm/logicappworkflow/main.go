...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "integrationServiceEnvironmentId", GoGetter: "IntegrationServiceEnvironmentId"},
			_jsii_.MemberProperty{JsiiProperty: "integrationServiceEnvironmentIdInput", GoGetter: "IntegrationServiceEnvironmentIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "logicAppIntegrationAccountIdInput", GoGetter: "LogicAppIntegrationAccountIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIntegrationServiceEnvironmentId", GoMethod: "ResetIntegrationServiceEnvironmentId"},
			_jsii_.MemberMethod{JsiiMethod: "resetLogicAppIntegrationAccountId", GoMethod: "ResetLogicAppIntegrationAccountId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetParameters", GoMethod: "ResetParameters"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "resetWorkflowParameters", GoMethod: "ResetWorkflowParameters"},
			_jsii_.MemberMethod{JsiiMethod: "resetWorkflowSchema", GoMethod: "ResetWorkflowSchema"},
			_jsii_.MemberMethod{JsiiMethod: "resetWorkflowVersion", GoMethod: "ResetWorkflowVersion"},
			...
			_jsii_.MemberProperty{JsiiProperty: "workflowParametersInput", GoGetter: "WorkflowParametersInput"},
			_jsii_.MemberProperty{JsiiProperty: "workflowSchema", GoGetter: "WorkflowSchema"},
			_jsii_.MemberProperty{JsiiProperty: "workflowSchemaInput", GoGetter: "WorkflowSchemaInput"},
			_jsii_.MemberProperty{JsiiProperty: "workflowVersion", GoGetter: "WorkflowVersion"},
			_jsii_.MemberProperty{JsiiProperty: "workflowVersionInput", GoGetter: "WorkflowVersionInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowedCallerIpAddressRangeInput", GoGetter: "AllowedCallerIpAddressRangeInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putWorkflowManagement", GoMethod: "PutWorkflowManagement"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWorkflowManagement", GoMethod: "ResetWorkflowManagement"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			...
			_jsii_.MemberProperty{JsiiProperty: "workflowManagement", GoGetter: "WorkflowManagement"},
			_jsii_.MemberProperty{JsiiProperty: "workflowManagementInput", GoGetter: "WorkflowManagementInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberMethod{JsiiMethod: "putClaim", GoMethod: "PutClaim"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
