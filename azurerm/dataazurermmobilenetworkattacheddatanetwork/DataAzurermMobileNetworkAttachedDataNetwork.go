...
func (d *jsiiProxy_DataAzurermMobileNetworkAttachedDataNetwork) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermMobileNetworkAttachedDataNetwork) ToHclTerraform() interface{} {
	var returns interface{}
