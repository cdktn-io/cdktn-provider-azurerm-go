...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hsmSetting", GoGetter: "HsmSetting"},
			_jsii_.MemberProperty{JsiiProperty: "hsmSettingInput", GoGetter: "HsmSettingInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putHsmSetting", GoMethod: "PutHsmSetting"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putRootSquash", GoMethod: "PutRootSquash"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetEncryptionKey", GoMethod: "ResetEncryptionKey"},
			_jsii_.MemberMethod{JsiiMethod: "resetHsmSetting", GoMethod: "ResetHsmSetting"},
			...
			_jsii_.MemberProperty{JsiiProperty: "storageCapacityInTb", GoGetter: "StorageCapacityInTb"},
			_jsii_.MemberProperty{JsiiProperty: "storageCapacityInTbInput", GoGetter: "StorageCapacityInTbInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "importPrefix", GoGetter: "ImportPrefix"},
			_jsii_.MemberProperty{JsiiProperty: "importPrefixInput", GoGetter: "ImportPrefixInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "loggingContainerId", GoGetter: "LoggingContainerId"},
			_jsii_.MemberProperty{JsiiProperty: "loggingContainerIdInput", GoGetter: "LoggingContainerIdInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetImportPrefix", GoMethod: "ResetImportPrefix"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberProperty{JsiiProperty: "timeOfDayInUtc", GoGetter: "TimeOfDayInUtc"},
			_jsii_.MemberProperty{JsiiProperty: "timeOfDayInUtcInput", GoGetter: "TimeOfDayInUtcInput"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSquashGid", GoMethod: "ResetSquashGid"},
			_jsii_.MemberMethod{JsiiMethod: "resetSquashUid", GoMethod: "ResetSquashUid"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "squashGid", GoGetter: "SquashGid"},
			_jsii_.MemberProperty{JsiiProperty: "squashGidInput", GoGetter: "SquashGidInput"},
			_jsii_.MemberProperty{JsiiProperty: "squashUid", GoGetter: "SquashUid"},
			_jsii_.MemberProperty{JsiiProperty: "squashUidInput", GoGetter: "SquashUidInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
