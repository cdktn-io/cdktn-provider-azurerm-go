...
func (m *jsiiProxy_ManagedLustreFileSystemRootSquashOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedLustreFileSystemRootSquashOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
