...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/digitaltwinsendpointeventhub/internal"
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhubTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhubTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
