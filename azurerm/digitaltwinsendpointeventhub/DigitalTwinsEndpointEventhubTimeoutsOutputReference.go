...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/digitaltwinsendpointeventhub/internal"
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhubTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDigitalTwinsEndpointEventhubTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DigitalTwinsEndpointEventhubTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDigitalTwinsEndpointEventhubTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DigitalTwinsEndpointEventhubTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.digitalTwinsEndpointEventhub.DigitalTwinsEndpointEventhubTimeoutsOutputReference",
...
func NewDigitalTwinsEndpointEventhubTimeoutsOutputReference_Override(d DigitalTwinsEndpointEventhubTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhubTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhubTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhubTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhubTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhubTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
