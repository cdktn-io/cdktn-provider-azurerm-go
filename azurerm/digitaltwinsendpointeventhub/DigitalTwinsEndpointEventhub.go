...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/digital_twins_endpoint_eventhub azurerm_digital_twins_endpoint_eventhub} Resource.
func NewDigitalTwinsEndpointEventhub(scope constructs.Construct, id *string, config *DigitalTwinsEndpointEventhubConfig) DigitalTwinsEndpointEventhub {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.digitalTwinsEndpointEventhub.DigitalTwinsEndpointEventhub",
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DigitalTwinsEndpointEventhub)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DigitalTwinsEndpointEventhub_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventhub) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
