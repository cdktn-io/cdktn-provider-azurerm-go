...
func (j *jsiiProxy_KubernetesClusterWebAppRoutingWebAppRoutingIdentityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterWebAppRoutingWebAppRoutingIdentityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KubernetesClusterWebAppRoutingWebAppRoutingIdentityList {
	_init_.Initialize()
...
func NewKubernetesClusterWebAppRoutingWebAppRoutingIdentityList_Override(k KubernetesClusterWebAppRoutingWebAppRoutingIdentityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterWebAppRoutingWebAppRoutingIdentityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterWebAppRoutingWebAppRoutingIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KubernetesClusterWebAppRoutingWebAppRoutingIdentityList) Resolve(context cdktn.IResolveContext) interface{} {
