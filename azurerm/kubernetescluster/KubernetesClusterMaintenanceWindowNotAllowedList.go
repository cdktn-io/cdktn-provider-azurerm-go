...
func (j *jsiiProxy_KubernetesClusterMaintenanceWindowNotAllowedList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterMaintenanceWindowNotAllowedList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KubernetesClusterMaintenanceWindowNotAllowedList {
	_init_.Initialize()

	if err := validateNewKubernetesClusterMaintenanceWindowNotAllowedListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewKubernetesClusterMaintenanceWindowNotAllowedList_Override(k KubernetesClusterMaintenanceWindowNotAllowedList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterMaintenanceWindowNotAllowedList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowNotAllowedList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowNotAllowedList) Resolve(context cdktn.IResolveContext) interface{} {
