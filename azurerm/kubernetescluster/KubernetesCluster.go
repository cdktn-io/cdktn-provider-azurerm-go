...
func (k *jsiiProxy_KubernetesCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KubernetesCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KubernetesCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
