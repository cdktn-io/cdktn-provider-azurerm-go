...
func (k *jsiiProxy_KubernetesClusterKubeAdminConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KubernetesClusterKubeAdminConfigList) Resolve(context cdktf.IResolveContext) interface{} {
