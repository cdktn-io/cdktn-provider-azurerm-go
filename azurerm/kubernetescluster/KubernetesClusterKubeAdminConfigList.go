...
func (j *jsiiProxy_KubernetesClusterKubeAdminConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterKubeAdminConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KubernetesClusterKubeAdminConfigList {
	_init_.Initialize()

	if err := validateNewKubernetesClusterKubeAdminConfigListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewKubernetesClusterKubeAdminConfigList_Override(k KubernetesClusterKubeAdminConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterKubeAdminConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterKubeAdminConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KubernetesClusterKubeAdminConfigList) Resolve(context cdktn.IResolveContext) interface{} {
