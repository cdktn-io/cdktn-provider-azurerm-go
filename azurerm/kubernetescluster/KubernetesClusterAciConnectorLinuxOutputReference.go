...
func (k *jsiiProxy_KubernetesClusterAciConnectorLinuxOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterAciConnectorLinuxOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
