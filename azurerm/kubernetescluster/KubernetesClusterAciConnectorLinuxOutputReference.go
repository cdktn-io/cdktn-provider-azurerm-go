...
func (j *jsiiProxy_KubernetesClusterAciConnectorLinuxOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterAciConnectorLinuxOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) KubernetesClusterAciConnectorLinuxOutputReference {
	_init_.Initialize()

	if err := validateNewKubernetesClusterAciConnectorLinuxOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewKubernetesClusterAciConnectorLinuxOutputReference_Override(k KubernetesClusterAciConnectorLinuxOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterAciConnectorLinuxOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterAciConnectorLinuxOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterAciConnectorLinuxOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KubernetesClusterAciConnectorLinuxOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterAciConnectorLinuxOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
