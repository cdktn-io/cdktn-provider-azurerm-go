...
func (j *jsiiProxy_KubernetesClusterIngressApplicationGatewayOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterIngressApplicationGatewayOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) KubernetesClusterIngressApplicationGatewayOutputReference {
	_init_.Initialize()

	if err := validateNewKubernetesClusterIngressApplicationGatewayOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewKubernetesClusterIngressApplicationGatewayOutputReference_Override(k KubernetesClusterIngressApplicationGatewayOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterIngressApplicationGatewayOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterIngressApplicationGatewayOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterIngressApplicationGatewayOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KubernetesClusterIngressApplicationGatewayOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterIngressApplicationGatewayOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
