...
func (j *jsiiProxy_KubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityList {
	_init_.Initialize()
...
func NewKubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityList_Override(k KubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityList) Resolve(context cdktn.IResolveContext) interface{} {
