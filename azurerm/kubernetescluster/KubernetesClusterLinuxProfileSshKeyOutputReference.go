...
func (k *jsiiProxy_KubernetesClusterLinuxProfileSshKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterLinuxProfileSshKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
