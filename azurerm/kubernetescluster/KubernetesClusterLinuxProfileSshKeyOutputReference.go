...
func (j *jsiiProxy_KubernetesClusterLinuxProfileSshKeyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterLinuxProfileSshKeyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) KubernetesClusterLinuxProfileSshKeyOutputReference {
	_init_.Initialize()

	if err := validateNewKubernetesClusterLinuxProfileSshKeyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewKubernetesClusterLinuxProfileSshKeyOutputReference_Override(k KubernetesClusterLinuxProfileSshKeyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterLinuxProfileSshKeyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterLinuxProfileSshKeyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterLinuxProfileSshKeyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KubernetesClusterLinuxProfileSshKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterLinuxProfileSshKeyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
