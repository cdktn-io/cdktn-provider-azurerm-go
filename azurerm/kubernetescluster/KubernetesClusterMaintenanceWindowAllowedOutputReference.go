...
func (j *jsiiProxy_KubernetesClusterMaintenanceWindowAllowedOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterMaintenanceWindowAllowedOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) KubernetesClusterMaintenanceWindowAllowedOutputReference {
	_init_.Initialize()

	if err := validateNewKubernetesClusterMaintenanceWindowAllowedOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewKubernetesClusterMaintenanceWindowAllowedOutputReference_Override(k KubernetesClusterMaintenanceWindowAllowedOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterMaintenanceWindowAllowedOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowAllowedOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowAllowedOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowAllowedOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowAllowedOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
