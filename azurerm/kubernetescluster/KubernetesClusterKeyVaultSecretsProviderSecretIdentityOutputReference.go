...
func (j *jsiiProxy_KubernetesClusterKeyVaultSecretsProviderSecretIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterKeyVaultSecretsProviderSecretIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) KubernetesClusterKeyVaultSecretsProviderSecretIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewKubernetesClusterKeyVaultSecretsProviderSecretIdentityOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewKubernetesClusterKeyVaultSecretsProviderSecretIdentityOutputReference_Override(k KubernetesClusterKeyVaultSecretsProviderSecretIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterKeyVaultSecretsProviderSecretIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterKeyVaultSecretsProviderSecretIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterKeyVaultSecretsProviderSecretIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KubernetesClusterKeyVaultSecretsProviderSecretIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterKeyVaultSecretsProviderSecretIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
