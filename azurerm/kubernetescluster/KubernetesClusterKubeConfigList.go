...
func (j *jsiiProxy_KubernetesClusterKubeConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterKubeConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KubernetesClusterKubeConfigList {
	_init_.Initialize()
...
func NewKubernetesClusterKubeConfigList_Override(k KubernetesClusterKubeConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterKubeConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterKubeConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KubernetesClusterKubeConfigList) Resolve(context cdktn.IResolveContext) interface{} {
