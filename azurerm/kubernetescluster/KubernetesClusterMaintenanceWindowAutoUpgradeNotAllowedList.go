...
func (j *jsiiProxy_KubernetesClusterMaintenanceWindowAutoUpgradeNotAllowedList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterMaintenanceWindowAutoUpgradeNotAllowedList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KubernetesClusterMaintenanceWindowAutoUpgradeNotAllowedList {
	_init_.Initialize()
...
func NewKubernetesClusterMaintenanceWindowAutoUpgradeNotAllowedList_Override(k KubernetesClusterMaintenanceWindowAutoUpgradeNotAllowedList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterMaintenanceWindowAutoUpgradeNotAllowedList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowAutoUpgradeNotAllowedList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowAutoUpgradeNotAllowedList) Resolve(context cdktn.IResolveContext) interface{} {
