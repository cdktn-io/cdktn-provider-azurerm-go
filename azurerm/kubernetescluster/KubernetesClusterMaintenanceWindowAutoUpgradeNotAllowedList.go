...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowAutoUpgradeNotAllowedList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowAutoUpgradeNotAllowedList) Resolve(context cdktf.IResolveContext) interface{} {
