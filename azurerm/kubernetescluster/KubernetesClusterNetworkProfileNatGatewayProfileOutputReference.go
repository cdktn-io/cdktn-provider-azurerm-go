...
func (k *jsiiProxy_KubernetesClusterNetworkProfileNatGatewayProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterNetworkProfileNatGatewayProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
