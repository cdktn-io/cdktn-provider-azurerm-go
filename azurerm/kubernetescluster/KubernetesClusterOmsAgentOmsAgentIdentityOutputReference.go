...
func (j *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterOmsAgentOmsAgentIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) KubernetesClusterOmsAgentOmsAgentIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewKubernetesClusterOmsAgentOmsAgentIdentityOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewKubernetesClusterOmsAgentOmsAgentIdentityOutputReference_Override(k KubernetesClusterOmsAgentOmsAgentIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
