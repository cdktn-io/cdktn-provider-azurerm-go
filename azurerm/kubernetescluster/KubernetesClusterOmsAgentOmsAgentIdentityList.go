...
func (j *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKubernetesClusterOmsAgentOmsAgentIdentityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KubernetesClusterOmsAgentOmsAgentIdentityList {
	_init_.Initialize()
...
func NewKubernetesClusterOmsAgentOmsAgentIdentityList_Override(k KubernetesClusterOmsAgentOmsAgentIdentityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityList) Resolve(context cdktn.IResolveContext) interface{} {
