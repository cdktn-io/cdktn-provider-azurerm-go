...
func (k *jsiiProxy_KubernetesClusterServicePrincipalOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterServicePrincipalOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
