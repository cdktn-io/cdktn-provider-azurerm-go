...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "capabilityType", GoGetter: "CapabilityType"},
			_jsii_.MemberProperty{JsiiProperty: "capabilityTypeInput", GoGetter: "CapabilityTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "chaosStudioTargetId", GoGetter: "ChaosStudioTargetId"},
			_jsii_.MemberProperty{JsiiProperty: "chaosStudioTargetIdInput", GoGetter: "ChaosStudioTargetIdInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ChaosStudioCapabilityTimeoutsOutputReference{}
