...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassList) Resolve(context cdktf.IResolveContext) interface{} {
