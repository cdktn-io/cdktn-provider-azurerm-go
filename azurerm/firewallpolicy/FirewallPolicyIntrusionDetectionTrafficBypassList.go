...
func (j *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallPolicyIntrusionDetectionTrafficBypassList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyIntrusionDetectionTrafficBypassList {
	_init_.Initialize()

	if err := validateNewFirewallPolicyIntrusionDetectionTrafficBypassListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewFirewallPolicyIntrusionDetectionTrafficBypassList_Override(f FirewallPolicyIntrusionDetectionTrafficBypassList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassList) Resolve(context cdktn.IResolveContext) interface{} {
