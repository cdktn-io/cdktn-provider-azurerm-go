...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/firewallpolicy/internal"
...
func (j *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallPolicyInsightsLogAnalyticsWorkspaceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FirewallPolicyInsightsLogAnalyticsWorkspaceOutputReference {
	_init_.Initialize()

	if err := validateNewFirewallPolicyInsightsLogAnalyticsWorkspaceOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewFirewallPolicyInsightsLogAnalyticsWorkspaceOutputReference_Override(f FirewallPolicyInsightsLogAnalyticsWorkspaceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceOutputReference)SetFirewallLocation(val *string) {
	if err := j.validateSetFirewallLocationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
