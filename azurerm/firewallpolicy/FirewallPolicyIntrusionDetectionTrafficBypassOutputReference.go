...
func (j *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallPolicyIntrusionDetectionTrafficBypassOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FirewallPolicyIntrusionDetectionTrafficBypassOutputReference {
	_init_.Initialize()
...
func NewFirewallPolicyIntrusionDetectionTrafficBypassOutputReference_Override(f FirewallPolicyIntrusionDetectionTrafficBypassOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionTrafficBypassOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
