...
func (j *jsiiProxy_FirewallPolicyInsightsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallPolicyInsightsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FirewallPolicyInsightsOutputReference {
	_init_.Initialize()

	if err := validateNewFirewallPolicyInsightsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewFirewallPolicyInsightsOutputReference_Override(f FirewallPolicyInsightsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallPolicyInsightsOutputReference)SetDefaultLogAnalyticsWorkspaceId(val *string) {
	if err := j.validateSetDefaultLogAnalyticsWorkspaceIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_FirewallPolicyInsightsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallPolicyInsightsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyInsightsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FirewallPolicyInsightsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyInsightsOutputReference) PutLogAnalyticsWorkspace(value interface{}) {
	if err := f.validatePutLogAnalyticsWorkspaceParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		f,
...
func (f *jsiiProxy_FirewallPolicyInsightsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
