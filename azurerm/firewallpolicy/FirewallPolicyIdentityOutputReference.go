...
func (f *jsiiProxy_FirewallPolicyIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
