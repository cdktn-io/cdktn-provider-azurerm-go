...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionSignatureOverridesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionSignatureOverridesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
