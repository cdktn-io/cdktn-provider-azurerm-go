...
func (j *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallPolicyInsightsLogAnalyticsWorkspaceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyInsightsLogAnalyticsWorkspaceList {
	_init_.Initialize()
...
func NewFirewallPolicyInsightsLogAnalyticsWorkspaceList_Override(f FirewallPolicyInsightsLogAnalyticsWorkspaceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceList) Resolve(context cdktn.IResolveContext) interface{} {
