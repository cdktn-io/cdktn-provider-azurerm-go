...
func (f *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyInsightsLogAnalyticsWorkspaceList) Resolve(context cdktf.IResolveContext) interface{} {
