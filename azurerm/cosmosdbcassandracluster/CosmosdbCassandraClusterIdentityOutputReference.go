...
func (c *jsiiProxy_CosmosdbCassandraClusterIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraClusterIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
