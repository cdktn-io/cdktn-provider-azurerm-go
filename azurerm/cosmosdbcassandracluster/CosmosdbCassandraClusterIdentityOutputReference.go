...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/cosmosdbcassandracluster/internal"
...
func (j *jsiiProxy_CosmosdbCassandraClusterIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbCassandraClusterIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CosmosdbCassandraClusterIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewCosmosdbCassandraClusterIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewCosmosdbCassandraClusterIdentityOutputReference_Override(c CosmosdbCassandraClusterIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbCassandraClusterIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbCassandraClusterIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraClusterIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CosmosdbCassandraClusterIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraClusterIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
