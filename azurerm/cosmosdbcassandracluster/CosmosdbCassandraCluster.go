...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/cosmosdb_cassandra_cluster azurerm_cosmosdb_cassandra_cluster} Resource.
...
func (c *jsiiProxy_CosmosdbCassandraCluster) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CosmosdbCassandraCluster) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CosmosdbCassandraCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CosmosdbCassandraCluster) MoveFromId(id *string) {
...
func (c *jsiiProxy_CosmosdbCassandraCluster) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CosmosdbCassandraCluster) MoveToId(id *string) {
...
func (c *jsiiProxy_CosmosdbCassandraCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CosmosdbCassandraCluster) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CosmosdbCassandraCluster) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CosmosdbCassandraCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
