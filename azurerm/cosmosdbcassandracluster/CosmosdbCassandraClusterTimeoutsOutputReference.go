...
func (c *jsiiProxy_CosmosdbCassandraClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
