...
func (e *jsiiProxy_ExpressRouteCircuitSkuOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_ExpressRouteCircuitSkuOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
