...
func (j *jsiiProxy_ExpressRouteCircuit) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ExpressRouteCircuit) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ExpressRouteCircuit) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ExpressRouteCircuit) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ExpressRouteCircuit) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/express_route_circuit azurerm_express_route_circuit} Resource.
...
func (j *jsiiProxy_ExpressRouteCircuit)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ExpressRouteCircuit)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ExpressRouteCircuit)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ExpressRouteCircuit_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_ExpressRouteCircuit) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ExpressRouteCircuit) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_ExpressRouteCircuit) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ExpressRouteCircuit) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_ExpressRouteCircuit) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_ExpressRouteCircuit) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
