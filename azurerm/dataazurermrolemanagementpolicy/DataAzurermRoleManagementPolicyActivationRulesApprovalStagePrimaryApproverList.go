...
func (j *jsiiProxy_DataAzurermRoleManagementPolicyActivationRulesApprovalStagePrimaryApproverList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataAzurermRoleManagementPolicyActivationRulesApprovalStagePrimaryApproverList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermRoleManagementPolicyActivationRulesApprovalStagePrimaryApproverList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermRoleManagementPolicyActivationRulesApprovalStagePrimaryApproverList) Resolve(context cdktf.IResolveContext) interface{} {
