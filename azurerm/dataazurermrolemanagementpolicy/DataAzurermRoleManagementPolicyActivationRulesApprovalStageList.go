...
func (j *jsiiProxy_DataAzurermRoleManagementPolicyActivationRulesApprovalStageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermRoleManagementPolicyActivationRulesApprovalStageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermRoleManagementPolicyActivationRulesApprovalStageList {
	_init_.Initialize()
...
func NewDataAzurermRoleManagementPolicyActivationRulesApprovalStageList_Override(d DataAzurermRoleManagementPolicyActivationRulesApprovalStageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermRoleManagementPolicyActivationRulesApprovalStageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermRoleManagementPolicyActivationRulesApprovalStageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermRoleManagementPolicyActivationRulesApprovalStageList) Resolve(context cdktn.IResolveContext) interface{} {
