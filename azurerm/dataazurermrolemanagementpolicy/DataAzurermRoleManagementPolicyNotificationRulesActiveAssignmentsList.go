...
func (j *jsiiProxy_DataAzurermRoleManagementPolicyNotificationRulesActiveAssignmentsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermRoleManagementPolicyNotificationRulesActiveAssignmentsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermRoleManagementPolicyNotificationRulesActiveAssignmentsList {
	_init_.Initialize()
...
func NewDataAzurermRoleManagementPolicyNotificationRulesActiveAssignmentsList_Override(d DataAzurermRoleManagementPolicyNotificationRulesActiveAssignmentsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermRoleManagementPolicyNotificationRulesActiveAssignmentsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermRoleManagementPolicyNotificationRulesActiveAssignmentsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermRoleManagementPolicyNotificationRulesActiveAssignmentsList) Resolve(context cdktn.IResolveContext) interface{} {
