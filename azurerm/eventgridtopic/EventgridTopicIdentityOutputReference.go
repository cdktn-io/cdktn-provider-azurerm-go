...
func (e *jsiiProxy_EventgridTopicIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventgridTopicIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
