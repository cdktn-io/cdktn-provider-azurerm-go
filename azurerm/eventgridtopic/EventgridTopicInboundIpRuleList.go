...
func (j *jsiiProxy_EventgridTopicInboundIpRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridTopicInboundIpRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridTopicInboundIpRuleList {
	_init_.Initialize()
...
func NewEventgridTopicInboundIpRuleList_Override(e EventgridTopicInboundIpRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridTopicInboundIpRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridTopicInboundIpRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridTopicInboundIpRuleList) Resolve(context cdktn.IResolveContext) interface{} {
