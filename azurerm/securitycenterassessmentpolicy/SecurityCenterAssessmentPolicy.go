...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/securitycenterassessmentpolicy/internal"
...
func (j *jsiiProxy_SecurityCenterAssessmentPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecurityCenterAssessmentPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecurityCenterAssessmentPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecurityCenterAssessmentPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecurityCenterAssessmentPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SecurityCenterAssessmentPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityCenterAssessmentPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecurityCenterAssessmentPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecurityCenterAssessmentPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityCenterAssessmentPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) MoveToId(id *string) {
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
