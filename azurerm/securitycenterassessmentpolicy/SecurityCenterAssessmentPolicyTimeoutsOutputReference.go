...
func (s *jsiiProxy_SecurityCenterAssessmentPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityCenterAssessmentPolicyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
