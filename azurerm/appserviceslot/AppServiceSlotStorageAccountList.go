...
func (a *jsiiProxy_AppServiceSlotStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppServiceSlotStorageAccountList) Resolve(context cdktf.IResolveContext) interface{} {
