...
func (j *jsiiProxy_AppServiceSlotStorageAccountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppServiceSlotStorageAccountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppServiceSlotStorageAccountList {
	_init_.Initialize()

	if err := validateNewAppServiceSlotStorageAccountListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewAppServiceSlotStorageAccountList_Override(a AppServiceSlotStorageAccountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppServiceSlotStorageAccountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppServiceSlotStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppServiceSlotStorageAccountList) Resolve(context cdktn.IResolveContext) interface{} {
