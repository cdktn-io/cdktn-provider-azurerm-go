...
func (a *jsiiProxy_AppServiceSlotSiteCredentialOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotSiteCredentialOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
