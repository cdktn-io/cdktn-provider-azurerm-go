...
func (a *jsiiProxy_AppServiceSlotAuthSettingsTwitterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotAuthSettingsTwitterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
