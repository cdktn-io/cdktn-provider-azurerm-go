...
func (a *jsiiProxy_AppServiceSlotLogsHttpLogsFileSystemOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotLogsHttpLogsFileSystemOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
