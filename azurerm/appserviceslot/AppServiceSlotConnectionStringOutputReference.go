...
func (a *jsiiProxy_AppServiceSlotConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotConnectionStringOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
