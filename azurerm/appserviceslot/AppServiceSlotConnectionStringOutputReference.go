...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/appserviceslot/internal"
...
func (j *jsiiProxy_AppServiceSlotConnectionStringOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppServiceSlotConnectionStringOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AppServiceSlotConnectionStringOutputReference {
	_init_.Initialize()

	if err := validateNewAppServiceSlotConnectionStringOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewAppServiceSlotConnectionStringOutputReference_Override(a AppServiceSlotConnectionStringOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppServiceSlotConnectionStringOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppServiceSlotConnectionStringOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotConnectionStringOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppServiceSlotConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotConnectionStringOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
