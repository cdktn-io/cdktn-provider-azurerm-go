...
func (j *jsiiProxy_AppServiceSlot) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppServiceSlot) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppServiceSlot) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppServiceSlot) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppServiceSlot) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/app_service_slot azurerm_app_service_slot} Resource.
...
func (j *jsiiProxy_AppServiceSlot)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppServiceSlot)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppServiceSlot)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AppServiceSlot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppServiceSlot) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceSlot) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppServiceSlot) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceSlot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppServiceSlot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppServiceSlot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
