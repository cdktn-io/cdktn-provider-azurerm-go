...
func (j *jsiiProxy_AppServiceSlotAuthSettingsMicrosoftOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppServiceSlotAuthSettingsMicrosoftOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppServiceSlotAuthSettingsMicrosoftOutputReference {
	_init_.Initialize()

	if err := validateNewAppServiceSlotAuthSettingsMicrosoftOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAppServiceSlotAuthSettingsMicrosoftOutputReference_Override(a AppServiceSlotAuthSettingsMicrosoftOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppServiceSlotAuthSettingsMicrosoftOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppServiceSlotAuthSettingsMicrosoftOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotAuthSettingsMicrosoftOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppServiceSlotAuthSettingsMicrosoftOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotAuthSettingsMicrosoftOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
