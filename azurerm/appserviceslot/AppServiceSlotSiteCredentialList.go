...
func (j *jsiiProxy_AppServiceSlotSiteCredentialList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppServiceSlotSiteCredentialList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppServiceSlotSiteCredentialList {
	_init_.Initialize()
...
func NewAppServiceSlotSiteCredentialList_Override(a AppServiceSlotSiteCredentialList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppServiceSlotSiteCredentialList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppServiceSlotSiteCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppServiceSlotSiteCredentialList) Resolve(context cdktn.IResolveContext) interface{} {
