...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/datafactorylinkedserviceazurefunction/internal"
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureFunction) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureFunction) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureFunction) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureFunction) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureFunction) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/data_factory_linked_service_azure_function azurerm_data_factory_linked_service_azure_function} Resource.
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureFunction)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureFunction)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureFunction)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataFactoryLinkedServiceAzureFunction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureFunction) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureFunction) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureFunction) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureFunction) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureFunction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureFunction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
