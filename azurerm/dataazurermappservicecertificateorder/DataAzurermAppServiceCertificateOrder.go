...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/app_service_certificate_order azurerm_app_service_certificate_order} Data Source.
...
func (d *jsiiProxy_DataAzurermAppServiceCertificateOrder) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermAppServiceCertificateOrder) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
