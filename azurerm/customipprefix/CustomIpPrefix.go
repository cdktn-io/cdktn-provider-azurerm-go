...
func (j *jsiiProxy_CustomIpPrefix) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CustomIpPrefix) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CustomIpPrefix) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CustomIpPrefix) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CustomIpPrefix) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/custom_ip_prefix azurerm_custom_ip_prefix} Resource.
...
func (j *jsiiProxy_CustomIpPrefix)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CustomIpPrefix)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CustomIpPrefix)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CustomIpPrefix_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CustomIpPrefix) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CustomIpPrefix) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CustomIpPrefix) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CustomIpPrefix) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CustomIpPrefix) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CustomIpPrefix) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
