...
func (k *jsiiProxy_KeyVaultKeyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyVaultKeyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
