...
type KeyVaultKey interface {
	...
	ReleasePolicy() KeyVaultKeyReleasePolicyOutputReference
	ReleasePolicyInput() *KeyVaultKeyReleasePolicy
	ResourceId() *string
	...
	PutReleasePolicy(value *KeyVaultKeyReleasePolicy)
...
func (j *jsiiProxy_KeyVaultKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KeyVaultKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KeyVaultKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KeyVaultKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KeyVaultKey) ReleasePolicy() KeyVaultKeyReleasePolicyOutputReference {
	var returns KeyVaultKeyReleasePolicyOutputReference
	_jsii_.Get(
		j,
		"releasePolicy",
		&returns,
...
func (j *jsiiProxy_KeyVaultKey) ReleasePolicyInput() *KeyVaultKeyReleasePolicy {
...
func (j *jsiiProxy_KeyVaultKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_KeyVaultKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KeyVaultKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KeyVaultKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KeyVaultKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KeyVaultKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultKey) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KeyVaultKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KeyVaultKey) PutReleasePolicy(value *KeyVaultKeyReleasePolicy) {
	if err := k.validatePutReleasePolicyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		k,
...
func (k *jsiiProxy_KeyVaultKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KeyVaultKey) ResetReleasePolicy() {
	_jsii_.InvokeVoid(
		k,
		"resetReleasePolicy",
		nil, // no parameters
...
func (k *jsiiProxy_KeyVaultKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
