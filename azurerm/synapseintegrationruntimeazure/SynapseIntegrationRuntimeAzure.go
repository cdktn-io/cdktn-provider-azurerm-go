...
func (j *jsiiProxy_SynapseIntegrationRuntimeAzure) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SynapseIntegrationRuntimeAzure) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SynapseIntegrationRuntimeAzure) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SynapseIntegrationRuntimeAzure) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SynapseIntegrationRuntimeAzure) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/synapse_integration_runtime_azure azurerm_synapse_integration_runtime_azure} Resource.
...
func (j *jsiiProxy_SynapseIntegrationRuntimeAzure)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SynapseIntegrationRuntimeAzure)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SynapseIntegrationRuntimeAzure)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SynapseIntegrationRuntimeAzure_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SynapseIntegrationRuntimeAzure) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeAzure) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeAzure) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeAzure) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeAzure) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeAzure) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
