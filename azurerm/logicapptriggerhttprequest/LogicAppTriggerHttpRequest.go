...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/logicapptriggerhttprequest/internal"
...
func (j *jsiiProxy_LogicAppTriggerHttpRequest) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LogicAppTriggerHttpRequest) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LogicAppTriggerHttpRequest) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LogicAppTriggerHttpRequest) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LogicAppTriggerHttpRequest) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LogicAppTriggerHttpRequest)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LogicAppTriggerHttpRequest)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LogicAppTriggerHttpRequest)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LogicAppTriggerHttpRequest_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateLogicAppTriggerHttpRequest_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) MoveFromId(id *string) {
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) MoveToId(id *string) {
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) ToHclTerraform() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogicAppTriggerHttpRequest) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
