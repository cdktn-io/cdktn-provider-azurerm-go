...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.logicAppTriggerHttpRequest.LogicAppTriggerHttpRequestConfig",
		reflect.TypeOf((*LogicAppTriggerHttpRequestConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.logicAppTriggerHttpRequest.LogicAppTriggerHttpRequestTimeouts",
