...
func init() {
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_StackHciLogicalNetworkSubnetIpPoolOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "ipAllocationMethod", GoGetter: "IpAllocationMethod"},
			_jsii_.MemberProperty{JsiiProperty: "ipAllocationMethodInput", GoGetter: "IpAllocationMethodInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIpPool", GoMethod: "ResetIpPool"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_StackHciLogicalNetworkTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
