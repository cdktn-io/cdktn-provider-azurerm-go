...
func (j *jsiiProxy_StackHciLogicalNetworkSubnetOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStackHciLogicalNetworkSubnetOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StackHciLogicalNetworkSubnetOutputReference {
	_init_.Initialize()
...
func NewStackHciLogicalNetworkSubnetOutputReference_Override(s StackHciLogicalNetworkSubnetOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StackHciLogicalNetworkSubnetOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StackHciLogicalNetworkSubnetOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StackHciLogicalNetworkSubnetOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StackHciLogicalNetworkSubnetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StackHciLogicalNetworkSubnetOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
