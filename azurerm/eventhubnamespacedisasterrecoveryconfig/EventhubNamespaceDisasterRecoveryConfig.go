...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/eventhubnamespacedisasterrecoveryconfig/internal"
...
func (j *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EventhubNamespaceDisasterRecoveryConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EventhubNamespaceDisasterRecoveryConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
