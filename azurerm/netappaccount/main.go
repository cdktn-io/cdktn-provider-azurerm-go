...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "aesEncryptionEnabledInput", GoGetter: "AesEncryptionEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "kerberosAdName", GoGetter: "KerberosAdName"},
			_jsii_.MemberProperty{JsiiProperty: "kerberosAdNameInput", GoGetter: "KerberosAdNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "kerberosKdcIp", GoGetter: "KerberosKdcIp"},
			_jsii_.MemberProperty{JsiiProperty: "kerberosKdcIpInput", GoGetter: "KerberosKdcIpInput"},
			_jsii_.MemberProperty{JsiiProperty: "ldapOverTlsEnabled", GoGetter: "LdapOverTlsEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "ldapOverTlsEnabledInput", GoGetter: "LdapOverTlsEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "ldapSigningEnabled", GoGetter: "LdapSigningEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "ldapSigningEnabledInput", GoGetter: "LdapSigningEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "localNfsUsersWithLdapAllowed", GoGetter: "LocalNfsUsersWithLdapAllowed"},
			_jsii_.MemberProperty{JsiiProperty: "localNfsUsersWithLdapAllowedInput", GoGetter: "LocalNfsUsersWithLdapAllowedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAesEncryptionEnabled", GoMethod: "ResetAesEncryptionEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetKerberosAdName", GoMethod: "ResetKerberosAdName"},
			_jsii_.MemberMethod{JsiiMethod: "resetKerberosKdcIp", GoMethod: "ResetKerberosKdcIp"},
			_jsii_.MemberMethod{JsiiMethod: "resetLdapOverTlsEnabled", GoMethod: "ResetLdapOverTlsEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetLdapSigningEnabled", GoMethod: "ResetLdapSigningEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetLocalNfsUsersWithLdapAllowed", GoMethod: "ResetLocalNfsUsersWithLdapAllowed"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSiteName", GoMethod: "ResetSiteName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "siteNameInput", GoGetter: "SiteNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "smbServerName", GoGetter: "SmbServerName"},
			_jsii_.MemberProperty{JsiiProperty: "smbServerNameInput", GoGetter: "SmbServerNameInput"},
