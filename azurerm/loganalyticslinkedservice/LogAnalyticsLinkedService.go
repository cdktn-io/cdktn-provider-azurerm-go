...
func (l *jsiiProxy_LogAnalyticsLinkedService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogAnalyticsLinkedService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
