...
func (j *jsiiProxy_DataAzurermNginxDeployment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermNginxDeployment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermNginxDeployment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermNginxDeployment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermNginxDeployment) Tags() cdktn.StringMap {
...
func (j *jsiiProxy_DataAzurermNginxDeployment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/nginx_deployment azurerm_nginx_deployment} Data Source.
...
func (j *jsiiProxy_DataAzurermNginxDeployment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermNginxDeployment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermNginxDeployment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermNginxDeployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermNginxDeployment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermNginxDeployment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermNginxDeployment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermNginxDeployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
