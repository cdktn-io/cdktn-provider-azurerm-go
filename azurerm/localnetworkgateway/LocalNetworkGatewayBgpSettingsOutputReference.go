...
func (l *jsiiProxy_LocalNetworkGatewayBgpSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LocalNetworkGatewayBgpSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
