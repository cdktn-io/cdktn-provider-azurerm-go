...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/local_network_gateway azurerm_local_network_gateway} Resource.
...
func (l *jsiiProxy_LocalNetworkGateway) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LocalNetworkGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LocalNetworkGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
