...
func (m *jsiiProxy_MssqlManagedInstanceStartStopSchedule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MssqlManagedInstanceStartStopSchedule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MssqlManagedInstanceStartStopSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
