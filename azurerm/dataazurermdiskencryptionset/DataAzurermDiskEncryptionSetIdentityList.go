...
func (j *jsiiProxy_DataAzurermDiskEncryptionSetIdentityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermDiskEncryptionSetIdentityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermDiskEncryptionSetIdentityList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermDiskEncryptionSet.DataAzurermDiskEncryptionSetIdentityList",
...
func NewDataAzurermDiskEncryptionSetIdentityList_Override(d DataAzurermDiskEncryptionSetIdentityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermDiskEncryptionSetIdentityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermDiskEncryptionSetIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermDiskEncryptionSetIdentityList) Resolve(context cdktn.IResolveContext) interface{} {
