...
func (s *jsiiProxy_ServicebusSubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicebusSubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicebusSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
