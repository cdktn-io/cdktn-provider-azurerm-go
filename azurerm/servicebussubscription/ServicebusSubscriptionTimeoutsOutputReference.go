...
func (s *jsiiProxy_ServicebusSubscriptionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicebusSubscriptionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
