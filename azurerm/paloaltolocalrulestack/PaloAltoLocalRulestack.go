...
func (p *jsiiProxy_PaloAltoLocalRulestack) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PaloAltoLocalRulestack) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
