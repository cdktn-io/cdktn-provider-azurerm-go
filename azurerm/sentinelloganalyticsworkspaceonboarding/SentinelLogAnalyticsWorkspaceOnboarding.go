...
func (j *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SentinelLogAnalyticsWorkspaceOnboarding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SentinelLogAnalyticsWorkspaceOnboarding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
