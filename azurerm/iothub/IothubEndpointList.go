...
func (j *jsiiProxy_IothubEndpointList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIothubEndpointList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IothubEndpointList {
	_init_.Initialize()
...
func NewIothubEndpointList_Override(i IothubEndpointList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IothubEndpointList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IothubEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IothubEndpointList) Resolve(context cdktn.IResolveContext) interface{} {
