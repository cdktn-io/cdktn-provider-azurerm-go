...
func (i *jsiiProxy_IothubEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IothubEndpointList) Resolve(context cdktf.IResolveContext) interface{} {
