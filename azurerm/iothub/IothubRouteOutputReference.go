...
func (i *jsiiProxy_IothubRouteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubRouteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
