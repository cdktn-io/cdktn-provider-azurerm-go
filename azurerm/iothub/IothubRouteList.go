...
func (j *jsiiProxy_IothubRouteList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIothubRouteList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IothubRouteList {
	_init_.Initialize()
...
func NewIothubRouteList_Override(i IothubRouteList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IothubRouteList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IothubRouteList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IothubRouteList) Resolve(context cdktn.IResolveContext) interface{} {
