...
func (j *jsiiProxy_IothubCloudToDeviceFeedbackList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIothubCloudToDeviceFeedbackList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IothubCloudToDeviceFeedbackList {
	_init_.Initialize()

	if err := validateNewIothubCloudToDeviceFeedbackListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewIothubCloudToDeviceFeedbackList_Override(i IothubCloudToDeviceFeedbackList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IothubCloudToDeviceFeedbackList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IothubCloudToDeviceFeedbackList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IothubCloudToDeviceFeedbackList) Resolve(context cdktn.IResolveContext) interface{} {
