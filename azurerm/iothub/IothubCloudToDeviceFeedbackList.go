...
func (i *jsiiProxy_IothubCloudToDeviceFeedbackList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IothubCloudToDeviceFeedbackList) Resolve(context cdktf.IResolveContext) interface{} {
