...
func (i *jsiiProxy_IothubFallbackRouteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubFallbackRouteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
