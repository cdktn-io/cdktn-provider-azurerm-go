...
func (j *jsiiProxy_Iothub) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Iothub) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Iothub) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Iothub) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Iothub) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/iothub azurerm_iothub} Resource.
...
func (j *jsiiProxy_Iothub)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Iothub)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Iothub)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Iothub_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_Iothub) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_Iothub) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_Iothub) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_Iothub) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_Iothub) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_Iothub) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
