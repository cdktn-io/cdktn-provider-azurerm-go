...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "cloudToDevice", GoGetter: "CloudToDevice"},
			_jsii_.MemberProperty{JsiiProperty: "cloudToDeviceInput", GoGetter: "CloudToDeviceInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "eventHubEventsEndpoint", GoGetter: "EventHubEventsEndpoint"},
			_jsii_.MemberProperty{JsiiProperty: "eventHubEventsNamespace", GoGetter: "EventHubEventsNamespace"},
			_jsii_.MemberProperty{JsiiProperty: "eventHubEventsPath", GoGetter: "EventHubEventsPath"},
			_jsii_.MemberProperty{JsiiProperty: "eventHubOperationsEndpoint", GoGetter: "EventHubOperationsEndpoint"},
			_jsii_.MemberProperty{JsiiProperty: "eventHubOperationsPath", GoGetter: "EventHubOperationsPath"},
			_jsii_.MemberProperty{JsiiProperty: "eventHubPartitionCount", GoGetter: "EventHubPartitionCount"},
			_jsii_.MemberProperty{JsiiProperty: "eventHubPartitionCountInput", GoGetter: "EventHubPartitionCountInput"},
			_jsii_.MemberProperty{JsiiProperty: "eventHubRetentionInDays", GoGetter: "EventHubRetentionInDays"},
			_jsii_.MemberProperty{JsiiProperty: "eventHubRetentionInDaysInput", GoGetter: "EventHubRetentionInDaysInput"},
			_jsii_.MemberProperty{JsiiProperty: "fallbackRoute", GoGetter: "FallbackRoute"},
			_jsii_.MemberProperty{JsiiProperty: "fallbackRouteInput", GoGetter: "FallbackRouteInput"},
			_jsii_.MemberProperty{JsiiProperty: "fileUpload", GoGetter: "FileUpload"},
			_jsii_.MemberProperty{JsiiProperty: "fileUploadInput", GoGetter: "FileUploadInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putCloudToDevice", GoMethod: "PutCloudToDevice"},
			_jsii_.MemberMethod{JsiiMethod: "putEndpoint", GoMethod: "PutEndpoint"},
			_jsii_.MemberMethod{JsiiMethod: "putEnrichment", GoMethod: "PutEnrichment"},
			_jsii_.MemberMethod{JsiiMethod: "putFallbackRoute", GoMethod: "PutFallbackRoute"},
			_jsii_.MemberMethod{JsiiMethod: "putFileUpload", GoMethod: "PutFileUpload"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCloudToDevice", GoMethod: "ResetCloudToDevice"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEventHubPartitionCount", GoMethod: "ResetEventHubPartitionCount"},
			_jsii_.MemberMethod{JsiiMethod: "resetEventHubRetentionInDays", GoMethod: "ResetEventHubRetentionInDays"},
			_jsii_.MemberMethod{JsiiMethod: "resetFallbackRoute", GoMethod: "ResetFallbackRoute"},
			_jsii_.MemberMethod{JsiiMethod: "resetFileUpload", GoMethod: "ResetFileUpload"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sharedAccessPolicy", GoGetter: "SharedAccessPolicy"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "feedback", GoGetter: "Feedback"},
			_jsii_.MemberProperty{JsiiProperty: "feedbackInput", GoGetter: "FeedbackInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maxDeliveryCount", GoGetter: "MaxDeliveryCount"},
			_jsii_.MemberProperty{JsiiProperty: "maxDeliveryCountInput", GoGetter: "MaxDeliveryCountInput"},
			_jsii_.MemberMethod{JsiiMethod: "putFeedback", GoMethod: "PutFeedback"},
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultTtl", GoMethod: "ResetDefaultTtl"},
			_jsii_.MemberMethod{JsiiMethod: "resetFeedback", GoMethod: "ResetFeedback"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaxDeliveryCount", GoMethod: "ResetMaxDeliveryCount"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "entityPathInput", GoGetter: "EntityPathInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEntityPath", GoMethod: "ResetEntityPath"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEndpointNames", GoMethod: "ResetEndpointNames"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "applyToBuiltinEventhubEndpointInput", GoGetter: "ApplyToBuiltinEventhubEndpointInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetApplyToBuiltinEventhubEndpoint", GoMethod: "ResetApplyToBuiltinEventhubEndpoint"},
