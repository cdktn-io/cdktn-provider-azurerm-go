...
func (j *jsiiProxy_IothubNetworkRuleSetIpRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIothubNetworkRuleSetIpRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IothubNetworkRuleSetIpRuleList {
	_init_.Initialize()
...
func NewIothubNetworkRuleSetIpRuleList_Override(i IothubNetworkRuleSetIpRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IothubNetworkRuleSetIpRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IothubNetworkRuleSetIpRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IothubNetworkRuleSetIpRuleList) Resolve(context cdktn.IResolveContext) interface{} {
