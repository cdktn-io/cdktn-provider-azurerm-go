...
func (j *jsiiProxy_IothubNetworkRuleSetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIothubNetworkRuleSetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IothubNetworkRuleSetList {
	_init_.Initialize()

	if err := validateNewIothubNetworkRuleSetListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewIothubNetworkRuleSetList_Override(i IothubNetworkRuleSetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IothubNetworkRuleSetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IothubNetworkRuleSetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IothubNetworkRuleSetList) Resolve(context cdktn.IResolveContext) interface{} {
