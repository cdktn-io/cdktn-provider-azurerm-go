...
func (i *jsiiProxy_IothubNetworkRuleSetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubNetworkRuleSetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
