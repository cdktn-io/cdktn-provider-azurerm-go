...
func (j *jsiiProxy_IothubEnrichmentList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIothubEnrichmentList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IothubEnrichmentList {
	_init_.Initialize()
...
func NewIothubEnrichmentList_Override(i IothubEnrichmentList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IothubEnrichmentList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IothubEnrichmentList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IothubEnrichmentList) Resolve(context cdktn.IResolveContext) interface{} {
