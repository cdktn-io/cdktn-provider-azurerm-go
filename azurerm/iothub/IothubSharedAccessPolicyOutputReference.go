...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/iothub/internal"
...
func (j *jsiiProxy_IothubSharedAccessPolicyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIothubSharedAccessPolicyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) IothubSharedAccessPolicyOutputReference {
	_init_.Initialize()

	if err := validateNewIothubSharedAccessPolicyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewIothubSharedAccessPolicyOutputReference_Override(i IothubSharedAccessPolicyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IothubSharedAccessPolicyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IothubSharedAccessPolicyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubSharedAccessPolicyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_IothubSharedAccessPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubSharedAccessPolicyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
