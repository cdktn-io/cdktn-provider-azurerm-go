...
func (i *jsiiProxy_IothubSharedAccessPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubSharedAccessPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
