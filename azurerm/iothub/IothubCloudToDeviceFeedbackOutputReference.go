...
func (j *jsiiProxy_IothubCloudToDeviceFeedbackOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIothubCloudToDeviceFeedbackOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) IothubCloudToDeviceFeedbackOutputReference {
	_init_.Initialize()
...
func NewIothubCloudToDeviceFeedbackOutputReference_Override(i IothubCloudToDeviceFeedbackOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IothubCloudToDeviceFeedbackOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IothubCloudToDeviceFeedbackOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubCloudToDeviceFeedbackOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_IothubCloudToDeviceFeedbackOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubCloudToDeviceFeedbackOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
