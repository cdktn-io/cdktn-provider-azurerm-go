...
func (i *jsiiProxy_IothubIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
