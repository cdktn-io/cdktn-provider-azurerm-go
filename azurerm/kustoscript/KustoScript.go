...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/kusto_script azurerm_kusto_script} Resource.
...
func (k *jsiiProxy_KustoScript) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KustoScript) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
