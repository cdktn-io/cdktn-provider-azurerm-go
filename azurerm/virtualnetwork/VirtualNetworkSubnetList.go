...
func (j *jsiiProxy_VirtualNetworkSubnetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualNetworkSubnetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualNetworkSubnetList {
	_init_.Initialize()
...
func NewVirtualNetworkSubnetList_Override(v VirtualNetworkSubnetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualNetworkSubnetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualNetworkSubnetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualNetworkSubnetList) Resolve(context cdktn.IResolveContext) interface{} {
