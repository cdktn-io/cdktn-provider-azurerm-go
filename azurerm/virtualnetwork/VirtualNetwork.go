...
func (v *jsiiProxy_VirtualNetwork) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualNetwork) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
