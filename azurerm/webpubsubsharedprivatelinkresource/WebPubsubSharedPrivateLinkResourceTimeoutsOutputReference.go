...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/webpubsubsharedprivatelinkresource/internal"
...
func (j *jsiiProxy_WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebPubsubSharedPrivateLinkResourceTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewWebPubsubSharedPrivateLinkResourceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.webPubsubSharedPrivateLinkResource.WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference",
...
func NewWebPubsubSharedPrivateLinkResourceTimeoutsOutputReference_Override(w WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
