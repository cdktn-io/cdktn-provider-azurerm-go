...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
