...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WebPubsubSharedPrivateLinkResource)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.webPubsubSharedPrivateLinkResource.WebPubsubSharedPrivateLinkResourceConfig",
		reflect.TypeOf((*WebPubsubSharedPrivateLinkResourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.webPubsubSharedPrivateLinkResource.WebPubsubSharedPrivateLinkResourceTimeouts",
		reflect.TypeOf((*WebPubsubSharedPrivateLinkResourceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azurerm.webPubsubSharedPrivateLinkResource.WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference",
		reflect.TypeOf((*WebPubsubSharedPrivateLinkResourceTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
