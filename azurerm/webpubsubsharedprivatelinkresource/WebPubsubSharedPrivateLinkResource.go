...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/webpubsubsharedprivatelinkresource/internal"
...
func (j *jsiiProxy_WebPubsubSharedPrivateLinkResource) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/web_pubsub_shared_private_link_resource azurerm_web_pubsub_shared_private_link_resource} Resource.
func NewWebPubsubSharedPrivateLinkResource(scope constructs.Construct, id *string, config *WebPubsubSharedPrivateLinkResourceConfig) WebPubsubSharedPrivateLinkResource {
	...
	if err := validateNewWebPubsubSharedPrivateLinkResourceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WebPubsubSharedPrivateLinkResource)SetCount(val interface{}) {
...
func WebPubsubSharedPrivateLinkResource_IsConstruct(x interface{}) *bool {
	...
	if err := validateWebPubsubSharedPrivateLinkResource_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebPubsubSharedPrivateLinkResource_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebPubsubSharedPrivateLinkResource_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebPubsubSharedPrivateLinkResource_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebPubsubSharedPrivateLinkResource_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResource) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResource) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResource) MoveFromId(id *string) {
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResource) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResource) MoveToId(id *string) {
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResource) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WebPubsubSharedPrivateLinkResource) ToHclTerraform() interface{} {
	var returns interface{}
