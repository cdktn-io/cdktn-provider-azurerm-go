...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/streamanalyticsmanagedprivateendpoint/internal"
...
func (j *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/stream_analytics_managed_private_endpoint azurerm_stream_analytics_managed_private_endpoint} Resource.
func NewStreamAnalyticsManagedPrivateEndpoint(scope constructs.Construct, id *string, config *StreamAnalyticsManagedPrivateEndpointConfig) StreamAnalyticsManagedPrivateEndpoint {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.streamAnalyticsManagedPrivateEndpoint.StreamAnalyticsManagedPrivateEndpoint",
...
func (j *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StreamAnalyticsManagedPrivateEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateStreamAnalyticsManagedPrivateEndpoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) MoveFromId(id *string) {
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) MoveToId(id *string) {
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
