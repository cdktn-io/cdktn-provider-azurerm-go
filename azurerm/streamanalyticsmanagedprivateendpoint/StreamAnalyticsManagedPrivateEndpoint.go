...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/streamanalyticsmanagedprivateendpoint/internal"
...
func StreamAnalyticsManagedPrivateEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint) ImportFrom(id *string, provider cdktf.TerraformProvider) {
