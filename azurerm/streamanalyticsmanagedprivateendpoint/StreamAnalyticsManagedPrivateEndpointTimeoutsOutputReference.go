...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpointTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsManagedPrivateEndpointTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
