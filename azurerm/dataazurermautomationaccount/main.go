...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.dataAzurermAutomationAccount.DataAzurermAutomationAccountEncryption",
		reflect.TypeOf((*DataAzurermAutomationAccountEncryption)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azurerm.dataAzurermAutomationAccount.DataAzurermAutomationAccountEncryptionList",
		reflect.TypeOf((*DataAzurermAutomationAccountEncryptionList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAzurermAutomationAccountEncryptionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
