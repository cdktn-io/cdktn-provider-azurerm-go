...
func (a *jsiiProxy_AutomanageConfigurationBackupRetentionPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutomanageConfigurationBackupRetentionPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
