...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/dataprotectionbackuppolicydisk/internal"
...
func (j *jsiiProxy_DataProtectionBackupPolicyDisk) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataProtectionBackupPolicyDisk) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataProtectionBackupPolicyDisk) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataProtectionBackupPolicyDisk) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataProtectionBackupPolicyDisk) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/data_protection_backup_policy_disk azurerm_data_protection_backup_policy_disk} Resource.
...
func (j *jsiiProxy_DataProtectionBackupPolicyDisk)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataProtectionBackupPolicyDisk)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataProtectionBackupPolicyDisk)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataProtectionBackupPolicyDisk_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataProtectionBackupPolicyDisk) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataProtectionBackupPolicyDisk) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DataProtectionBackupPolicyDisk) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataProtectionBackupPolicyDisk) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataProtectionBackupPolicyDisk) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataProtectionBackupPolicyDisk) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
