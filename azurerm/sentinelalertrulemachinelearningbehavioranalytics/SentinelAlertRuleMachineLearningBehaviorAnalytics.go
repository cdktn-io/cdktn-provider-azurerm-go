...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/sentinelalertrulemachinelearningbehavioranalytics/internal"
...
func SentinelAlertRuleMachineLearningBehaviorAnalytics_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) ImportFrom(id *string, provider cdktf.TerraformProvider) {
