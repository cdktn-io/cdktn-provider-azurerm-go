...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/sentinelalertrulemachinelearningbehavioranalytics/internal"
...
func (j *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewSentinelAlertRuleMachineLearningBehaviorAnalytics(scope constructs.Construct, id *string, config *SentinelAlertRuleMachineLearningBehaviorAnalyticsConfig) SentinelAlertRuleMachineLearningBehaviorAnalytics {
	...
	if err := validateNewSentinelAlertRuleMachineLearningBehaviorAnalyticsParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.sentinelAlertRuleMachineLearningBehaviorAnalytics.SentinelAlertRuleMachineLearningBehaviorAnalytics",
...
func (j *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SentinelAlertRuleMachineLearningBehaviorAnalytics_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSentinelAlertRuleMachineLearningBehaviorAnalytics_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SentinelAlertRuleMachineLearningBehaviorAnalytics_IsConstruct(x interface{}) *bool {
	...
	if err := validateSentinelAlertRuleMachineLearningBehaviorAnalytics_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SentinelAlertRuleMachineLearningBehaviorAnalytics_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSentinelAlertRuleMachineLearningBehaviorAnalytics_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SentinelAlertRuleMachineLearningBehaviorAnalytics_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSentinelAlertRuleMachineLearningBehaviorAnalytics_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) MoveFromId(id *string) {
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) MoveToId(id *string) {
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalytics) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
