...
func (j *jsiiProxy_FirewallNatRuleCollectionRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallNatRuleCollectionRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallNatRuleCollectionRuleList {
	_init_.Initialize()
...
func NewFirewallNatRuleCollectionRuleList_Override(f FirewallNatRuleCollectionRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallNatRuleCollectionRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallNatRuleCollectionRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallNatRuleCollectionRuleList) Resolve(context cdktn.IResolveContext) interface{} {
