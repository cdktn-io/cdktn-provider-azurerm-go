...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/firewallnatrulecollection/internal"
...
func (j *jsiiProxy_FirewallNatRuleCollection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FirewallNatRuleCollection) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_FirewallNatRuleCollection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FirewallNatRuleCollection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FirewallNatRuleCollection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FirewallNatRuleCollection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/firewall_nat_rule_collection azurerm_firewall_nat_rule_collection} Resource.
func NewFirewallNatRuleCollection(scope constructs.Construct, id *string, config *FirewallNatRuleCollectionConfig) FirewallNatRuleCollection {
	...
	if err := validateNewFirewallNatRuleCollectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_FirewallNatRuleCollection)SetCount(val interface{}) {
...
func (j *jsiiProxy_FirewallNatRuleCollection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FirewallNatRuleCollection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FirewallNatRuleCollection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FirewallNatRuleCollection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateFirewallNatRuleCollection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func FirewallNatRuleCollection_IsConstruct(x interface{}) *bool {
	...
	if err := validateFirewallNatRuleCollection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func FirewallNatRuleCollection_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateFirewallNatRuleCollection_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func FirewallNatRuleCollection_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateFirewallNatRuleCollection_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (f *jsiiProxy_FirewallNatRuleCollection) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FirewallNatRuleCollection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallNatRuleCollection) HasResourceMove() interface{} {
	var returns interface{}
...
func (f *jsiiProxy_FirewallNatRuleCollection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FirewallNatRuleCollection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallNatRuleCollection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FirewallNatRuleCollection) MoveFromId(id *string) {
...
func (f *jsiiProxy_FirewallNatRuleCollection) MoveTo(moveTarget *string, index interface{}) {
...
func (f *jsiiProxy_FirewallNatRuleCollection) MoveToId(id *string) {
...
func (f *jsiiProxy_FirewallNatRuleCollection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FirewallNatRuleCollection) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (f *jsiiProxy_FirewallNatRuleCollection) ToHclTerraform() interface{} {
	var returns interface{}
...
func (f *jsiiProxy_FirewallNatRuleCollection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
