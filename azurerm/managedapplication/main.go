...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.managedApplication.ManagedApplicationConfig",
		reflect.TypeOf((*ManagedApplicationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.managedApplication.ManagedApplicationIdentity",
		reflect.TypeOf((*ManagedApplicationIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azurerm.managedApplication.ManagedApplicationIdentityOutputReference",
		reflect.TypeOf((*ManagedApplicationIdentityOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.managedApplication.ManagedApplicationPlan",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.managedApplication.ManagedApplicationTimeouts",
