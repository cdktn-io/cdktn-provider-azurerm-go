...
func (j *jsiiProxy_ManagedApplicationPlanOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewManagedApplicationPlanOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ManagedApplicationPlanOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.managedApplication.ManagedApplicationPlanOutputReference",
...
func NewManagedApplicationPlanOutputReference_Override(m ManagedApplicationPlanOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ManagedApplicationPlanOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_ManagedApplicationPlanOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagedApplicationPlanOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_ManagedApplicationPlanOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagedApplicationPlanOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
