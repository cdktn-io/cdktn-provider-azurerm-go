...
func (m *jsiiProxy_ManagedApplicationPlanOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedApplicationPlanOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
