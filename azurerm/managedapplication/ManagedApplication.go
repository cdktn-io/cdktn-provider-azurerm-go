...
func (j *jsiiProxy_ManagedApplication) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ManagedApplication) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ManagedApplication) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ManagedApplication) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ManagedApplication) Outputs() cdktn.StringMap {
...
func (j *jsiiProxy_ManagedApplication) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ManagedApplication) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewManagedApplication(scope constructs.Construct, id *string, config *ManagedApplicationConfig) ManagedApplication {
	...
	if err := validateNewManagedApplicationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ManagedApplication)SetApplicationDefinitionId(val *string) {
	if err := j.validateSetApplicationDefinitionIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ManagedApplication)SetCount(val interface{}) {
...
func (j *jsiiProxy_ManagedApplication)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ManagedApplication)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ManagedApplication)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ManagedApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateManagedApplication_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ManagedApplication_IsConstruct(x interface{}) *bool {
	...
	if err := validateManagedApplication_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ManagedApplication_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateManagedApplication_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ManagedApplication_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateManagedApplication_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_ManagedApplication) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_ManagedApplication) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagedApplication) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_ManagedApplication) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_ManagedApplication) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagedApplication) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_ManagedApplication) MoveFromId(id *string) {
...
func (m *jsiiProxy_ManagedApplication) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_ManagedApplication) MoveToId(id *string) {
...
func (m *jsiiProxy_ManagedApplication) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_ManagedApplication) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_ManagedApplication) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_ManagedApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
