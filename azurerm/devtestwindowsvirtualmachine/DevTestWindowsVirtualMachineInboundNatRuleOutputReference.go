...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/devtestwindowsvirtualmachine/internal"
...
func (j *jsiiProxy_DevTestWindowsVirtualMachineInboundNatRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDevTestWindowsVirtualMachineInboundNatRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DevTestWindowsVirtualMachineInboundNatRuleOutputReference {
	_init_.Initialize()

	if err := validateNewDevTestWindowsVirtualMachineInboundNatRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DevTestWindowsVirtualMachineInboundNatRuleOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.devTestWindowsVirtualMachine.DevTestWindowsVirtualMachineInboundNatRuleOutputReference",
...
func NewDevTestWindowsVirtualMachineInboundNatRuleOutputReference_Override(d DevTestWindowsVirtualMachineInboundNatRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DevTestWindowsVirtualMachineInboundNatRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineInboundNatRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineInboundNatRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineInboundNatRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineInboundNatRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
