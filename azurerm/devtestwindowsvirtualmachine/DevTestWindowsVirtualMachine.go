...
func (d *jsiiProxy_DevTestWindowsVirtualMachine) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachine) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
