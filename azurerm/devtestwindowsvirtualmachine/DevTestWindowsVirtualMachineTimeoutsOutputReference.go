...
func (d *jsiiProxy_DevTestWindowsVirtualMachineTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
