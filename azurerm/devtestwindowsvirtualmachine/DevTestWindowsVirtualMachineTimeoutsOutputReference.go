...
func (j *jsiiProxy_DevTestWindowsVirtualMachineTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDevTestWindowsVirtualMachineTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DevTestWindowsVirtualMachineTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDevTestWindowsVirtualMachineTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DevTestWindowsVirtualMachineTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.devTestWindowsVirtualMachine.DevTestWindowsVirtualMachineTimeoutsOutputReference",
...
func NewDevTestWindowsVirtualMachineTimeoutsOutputReference_Override(d DevTestWindowsVirtualMachineTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DevTestWindowsVirtualMachineTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
