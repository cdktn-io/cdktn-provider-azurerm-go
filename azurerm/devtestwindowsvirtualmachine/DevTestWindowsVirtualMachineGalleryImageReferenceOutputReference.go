...
func (d *jsiiProxy_DevTestWindowsVirtualMachineGalleryImageReferenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineGalleryImageReferenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
