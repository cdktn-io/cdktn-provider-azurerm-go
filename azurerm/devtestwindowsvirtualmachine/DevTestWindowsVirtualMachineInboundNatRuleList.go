...
func (j *jsiiProxy_DevTestWindowsVirtualMachineInboundNatRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDevTestWindowsVirtualMachineInboundNatRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DevTestWindowsVirtualMachineInboundNatRuleList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.devTestWindowsVirtualMachine.DevTestWindowsVirtualMachineInboundNatRuleList",
...
func NewDevTestWindowsVirtualMachineInboundNatRuleList_Override(d DevTestWindowsVirtualMachineInboundNatRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DevTestWindowsVirtualMachineInboundNatRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineInboundNatRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DevTestWindowsVirtualMachineInboundNatRuleList) Resolve(context cdktn.IResolveContext) interface{} {
