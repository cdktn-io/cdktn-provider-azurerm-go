...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putNextHop", GoMethod: "PutNextHop"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ruleCollectionId", GoGetter: "RuleCollectionId"},
			_jsii_.MemberProperty{JsiiProperty: "ruleCollectionIdInput", GoGetter: "RuleCollectionIdInput"},
		...
		func() interface{} {
			j := jsiiProxy_NetworkManagerRoutingRule{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_NetworkManagerRoutingRuleTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
