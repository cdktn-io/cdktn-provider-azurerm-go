...
func (j *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringBeginsWithList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridSystemTopicEventSubscriptionAdvancedFilterStringBeginsWithList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridSystemTopicEventSubscriptionAdvancedFilterStringBeginsWithList {
	_init_.Initialize()

	if err := validateNewEventgridSystemTopicEventSubscriptionAdvancedFilterStringBeginsWithListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringBeginsWithList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridSystemTopicEventSubscription.EventgridSystemTopicEventSubscriptionAdvancedFilterStringBeginsWithList",
...
func NewEventgridSystemTopicEventSubscriptionAdvancedFilterStringBeginsWithList_Override(e EventgridSystemTopicEventSubscriptionAdvancedFilterStringBeginsWithList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringBeginsWithList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringBeginsWithList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringBeginsWithList) Resolve(context cdktn.IResolveContext) interface{} {
