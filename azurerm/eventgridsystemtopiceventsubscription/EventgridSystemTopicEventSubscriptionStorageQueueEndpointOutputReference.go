...
func (j *jsiiProxy_EventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) EventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference {
	_init_.Initialize()

	if err := validateNewEventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridSystemTopicEventSubscription.EventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference",
...
func NewEventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference_Override(e EventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionStorageQueueEndpointOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
