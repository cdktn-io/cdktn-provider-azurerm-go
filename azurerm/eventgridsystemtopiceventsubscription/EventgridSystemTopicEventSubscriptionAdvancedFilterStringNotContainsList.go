...
func (j *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringNotContainsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridSystemTopicEventSubscriptionAdvancedFilterStringNotContainsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridSystemTopicEventSubscriptionAdvancedFilterStringNotContainsList {
	_init_.Initialize()

	if err := validateNewEventgridSystemTopicEventSubscriptionAdvancedFilterStringNotContainsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringNotContainsList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridSystemTopicEventSubscription.EventgridSystemTopicEventSubscriptionAdvancedFilterStringNotContainsList",
...
func NewEventgridSystemTopicEventSubscriptionAdvancedFilterStringNotContainsList_Override(e EventgridSystemTopicEventSubscriptionAdvancedFilterStringNotContainsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringNotContainsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringNotContainsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringNotContainsList) Resolve(context cdktn.IResolveContext) interface{} {
