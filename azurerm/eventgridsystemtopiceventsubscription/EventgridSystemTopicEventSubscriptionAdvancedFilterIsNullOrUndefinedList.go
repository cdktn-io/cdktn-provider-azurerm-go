...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterIsNullOrUndefinedList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterIsNullOrUndefinedList) Resolve(context cdktf.IResolveContext) interface{} {
