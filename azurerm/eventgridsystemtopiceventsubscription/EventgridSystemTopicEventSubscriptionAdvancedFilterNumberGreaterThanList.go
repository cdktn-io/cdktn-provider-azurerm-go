...
func (j *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterNumberGreaterThanList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridSystemTopicEventSubscriptionAdvancedFilterNumberGreaterThanList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridSystemTopicEventSubscriptionAdvancedFilterNumberGreaterThanList {
	_init_.Initialize()

	if err := validateNewEventgridSystemTopicEventSubscriptionAdvancedFilterNumberGreaterThanListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterNumberGreaterThanList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridSystemTopicEventSubscription.EventgridSystemTopicEventSubscriptionAdvancedFilterNumberGreaterThanList",
...
func NewEventgridSystemTopicEventSubscriptionAdvancedFilterNumberGreaterThanList_Override(e EventgridSystemTopicEventSubscriptionAdvancedFilterNumberGreaterThanList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterNumberGreaterThanList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterNumberGreaterThanList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterNumberGreaterThanList) Resolve(context cdktn.IResolveContext) interface{} {
