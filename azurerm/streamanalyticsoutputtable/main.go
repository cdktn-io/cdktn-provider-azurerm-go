...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "columnsToRemove", GoGetter: "ColumnsToRemove"},
			_jsii_.MemberProperty{JsiiProperty: "columnsToRemoveInput", GoGetter: "ColumnsToRemoveInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetColumnsToRemove", GoMethod: "ResetColumnsToRemove"},
		...
		func() interface{} {
			j := jsiiProxy_StreamAnalyticsOutputTable{}
