...
func (d *jsiiProxy_DataAzurermStorageContainersContainersList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAzurermStorageContainersContainersList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataAzurermStorageContainersContainersList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataAzurermStorageContainersContainersList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
