...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PostgresqlVirtualNetworkRule)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.postgresqlVirtualNetworkRule.PostgresqlVirtualNetworkRuleConfig",
		reflect.TypeOf((*PostgresqlVirtualNetworkRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.postgresqlVirtualNetworkRule.PostgresqlVirtualNetworkRuleTimeouts",
		reflect.TypeOf((*PostgresqlVirtualNetworkRuleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azurerm.postgresqlVirtualNetworkRule.PostgresqlVirtualNetworkRuleTimeoutsOutputReference",
		reflect.TypeOf((*PostgresqlVirtualNetworkRuleTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
