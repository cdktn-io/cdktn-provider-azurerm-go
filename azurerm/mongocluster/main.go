...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "administratorUsername", GoGetter: "AdministratorUsername"},
			_jsii_.MemberProperty{JsiiProperty: "administratorUsernameInput", GoGetter: "AdministratorUsernameInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "computeTier", GoGetter: "ComputeTier"},
			_jsii_.MemberProperty{JsiiProperty: "computeTierInput", GoGetter: "ComputeTierInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "dataApiModeEnabled", GoGetter: "DataApiModeEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "dataApiModeEnabledInput", GoGetter: "DataApiModeEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "highAvailabilityMode", GoGetter: "HighAvailabilityMode"},
			_jsii_.MemberProperty{JsiiProperty: "highAvailabilityModeInput", GoGetter: "HighAvailabilityModeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "previewFeatures", GoGetter: "PreviewFeatures"},
			_jsii_.MemberProperty{JsiiProperty: "previewFeaturesInput", GoGetter: "PreviewFeaturesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAdministratorUsername", GoMethod: "ResetAdministratorUsername"},
			_jsii_.MemberMethod{JsiiMethod: "resetAuthenticationMethods", GoMethod: "ResetAuthenticationMethods"},
			_jsii_.MemberMethod{JsiiMethod: "resetComputeTier", GoMethod: "ResetComputeTier"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDataApiModeEnabled", GoMethod: "ResetDataApiModeEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetHighAvailabilityMode", GoMethod: "ResetHighAvailabilityMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIdentity", GoMethod: "ResetIdentity"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPreviewFeatures", GoMethod: "ResetPreviewFeatures"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetStorageSizeInGb", GoMethod: "ResetStorageSizeInGb"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "pointInTimeUtc", GoGetter: "PointInTimeUtc"},
			_jsii_.MemberProperty{JsiiProperty: "pointInTimeUtcInput", GoGetter: "PointInTimeUtcInput"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
