...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupApplicationRuleCollectionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupApplicationRuleCollectionList) Resolve(context cdktf.IResolveContext) interface{} {
