...
func (j *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallPolicyRuleCollectionGroupNetworkRuleCollectionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyRuleCollectionGroupNetworkRuleCollectionList {
	_init_.Initialize()
...
func NewFirewallPolicyRuleCollectionGroupNetworkRuleCollectionList_Override(f FirewallPolicyRuleCollectionGroupNetworkRuleCollectionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionList) Resolve(context cdktn.IResolveContext) interface{} {
