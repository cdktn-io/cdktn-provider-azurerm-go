...
func (j *jsiiProxy_FirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList {
	_init_.Initialize()
...
func NewFirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList_Override(f FirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList) Resolve(context cdktn.IResolveContext) interface{} {
