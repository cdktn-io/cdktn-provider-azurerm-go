...
func (j *jsiiProxy_FirewallPolicyRuleCollectionGroupTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallPolicyRuleCollectionGroupTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FirewallPolicyRuleCollectionGroupTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewFirewallPolicyRuleCollectionGroupTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_FirewallPolicyRuleCollectionGroupTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.firewallPolicyRuleCollectionGroup.FirewallPolicyRuleCollectionGroupTimeoutsOutputReference",
...
func NewFirewallPolicyRuleCollectionGroupTimeoutsOutputReference_Override(f FirewallPolicyRuleCollectionGroupTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallPolicyRuleCollectionGroupTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
