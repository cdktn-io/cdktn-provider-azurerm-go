...
func (j *jsiiProxy_FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList {
	_init_.Initialize()
...
func NewFirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList_Override(f FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList) Resolve(context cdktn.IResolveContext) interface{} {
