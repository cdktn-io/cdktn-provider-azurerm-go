...
func (j *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList {
	_init_.Initialize()
...
func NewFirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList_Override(f FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList) Resolve(context cdktn.IResolveContext) interface{} {
