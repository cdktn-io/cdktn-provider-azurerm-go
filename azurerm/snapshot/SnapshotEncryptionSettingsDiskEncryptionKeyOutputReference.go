...
func (s *jsiiProxy_SnapshotEncryptionSettingsDiskEncryptionKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SnapshotEncryptionSettingsDiskEncryptionKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
