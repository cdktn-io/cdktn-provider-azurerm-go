...
func (j *jsiiProxy_SnapshotTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSnapshotTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SnapshotTimeoutsOutputReference {
	_init_.Initialize()
...
func NewSnapshotTimeoutsOutputReference_Override(s SnapshotTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SnapshotTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SnapshotTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SnapshotTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SnapshotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SnapshotTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
