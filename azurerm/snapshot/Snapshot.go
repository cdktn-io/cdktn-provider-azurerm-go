...
func (j *jsiiProxy_Snapshot) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Snapshot) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Snapshot) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Snapshot) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Snapshot) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Snapshot) TrustedLaunchEnabled() cdktn.IResolvable {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/snapshot azurerm_snapshot} Resource.
...
func (j *jsiiProxy_Snapshot)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Snapshot)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Snapshot)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Snapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_Snapshot) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_Snapshot) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_Snapshot) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_Snapshot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_Snapshot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_Snapshot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
