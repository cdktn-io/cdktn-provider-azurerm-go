...
func (a *jsiiProxy_ApiManagementApiOperationTagTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationTagTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
