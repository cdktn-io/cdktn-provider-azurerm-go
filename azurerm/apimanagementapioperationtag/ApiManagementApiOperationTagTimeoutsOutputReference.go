...
func (j *jsiiProxy_ApiManagementApiOperationTagTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationTagTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ApiManagementApiOperationTagTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementApiOperationTagTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementApiOperationTagTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementApiOperationTag.ApiManagementApiOperationTagTimeoutsOutputReference",
...
func NewApiManagementApiOperationTagTimeoutsOutputReference_Override(a ApiManagementApiOperationTagTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationTagTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationTagTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationTagTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementApiOperationTagTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationTagTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
