...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/apimanagementapioperationtag/internal"
...
func (j *jsiiProxy_ApiManagementApiOperationTag) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiManagementApiOperationTag) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ApiManagementApiOperationTag) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiManagementApiOperationTag) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiManagementApiOperationTag) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiManagementApiOperationTag) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/api_management_api_operation_tag azurerm_api_management_api_operation_tag} Resource.
func NewApiManagementApiOperationTag(scope constructs.Construct, id *string, config *ApiManagementApiOperationTagConfig) ApiManagementApiOperationTag {
	...
	if err := validateNewApiManagementApiOperationTagParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementApiOperationTag{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementApiOperationTag.ApiManagementApiOperationTag",
...
func (j *jsiiProxy_ApiManagementApiOperationTag)SetApiOperationId(val *string) {
	if err := j.validateSetApiOperationIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ApiManagementApiOperationTag)SetCount(val interface{}) {
...
func (j *jsiiProxy_ApiManagementApiOperationTag)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiManagementApiOperationTag)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiManagementApiOperationTag)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApiManagementApiOperationTag_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApiManagementApiOperationTag_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ApiManagementApiOperationTag_IsConstruct(x interface{}) *bool {
	...
	if err := validateApiManagementApiOperationTag_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiManagementApiOperationTag_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiManagementApiOperationTag_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApiManagementApiOperationTag_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApiManagementApiOperationTag_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ApiManagementApiOperationTag) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiManagementApiOperationTag) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationTag) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiManagementApiOperationTag) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiManagementApiOperationTag) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationTag) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiManagementApiOperationTag) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiManagementApiOperationTag) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApiManagementApiOperationTag) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiManagementApiOperationTag) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiManagementApiOperationTag) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApiManagementApiOperationTag) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiManagementApiOperationTag) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
