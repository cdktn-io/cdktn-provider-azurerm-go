...
func (j *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupFilterNotList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermConsumptionBudgetResourceGroupFilterNotList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermConsumptionBudgetResourceGroupFilterNotList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermConsumptionBudgetResourceGroup.DataAzurermConsumptionBudgetResourceGroupFilterNotList",
...
func NewDataAzurermConsumptionBudgetResourceGroupFilterNotList_Override(d DataAzurermConsumptionBudgetResourceGroupFilterNotList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupFilterNotList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupFilterNotList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupFilterNotList) Resolve(context cdktn.IResolveContext) interface{} {
