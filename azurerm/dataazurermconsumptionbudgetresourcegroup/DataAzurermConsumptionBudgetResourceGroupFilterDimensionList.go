...
func (j *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupFilterDimensionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermConsumptionBudgetResourceGroupFilterDimensionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermConsumptionBudgetResourceGroupFilterDimensionList {
	_init_.Initialize()
...
func NewDataAzurermConsumptionBudgetResourceGroupFilterDimensionList_Override(d DataAzurermConsumptionBudgetResourceGroupFilterDimensionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupFilterDimensionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupFilterDimensionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupFilterDimensionList) Resolve(context cdktn.IResolveContext) interface{} {
