...
func (j *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupTimePeriodList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermConsumptionBudgetResourceGroupTimePeriodList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermConsumptionBudgetResourceGroupTimePeriodList {
	_init_.Initialize()
...
func NewDataAzurermConsumptionBudgetResourceGroupTimePeriodList_Override(d DataAzurermConsumptionBudgetResourceGroupTimePeriodList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupTimePeriodList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupTimePeriodList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupTimePeriodList) Resolve(context cdktn.IResolveContext) interface{} {
