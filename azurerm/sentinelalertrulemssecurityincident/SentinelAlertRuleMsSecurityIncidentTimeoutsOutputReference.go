...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/sentinelalertrulemssecurityincident/internal"
...
func (j *jsiiProxy_SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSentinelAlertRuleMsSecurityIncidentTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.sentinelAlertRuleMsSecurityIncident.SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference",
...
func NewSentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference_Override(s SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
