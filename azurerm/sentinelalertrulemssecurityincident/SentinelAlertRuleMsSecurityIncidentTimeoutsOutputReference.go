...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/sentinelalertrulemssecurityincident/internal"
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncidentTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
