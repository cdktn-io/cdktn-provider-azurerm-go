...
func (j *jsiiProxy_SentinelAlertRuleMsSecurityIncident) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SentinelAlertRuleMsSecurityIncident) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SentinelAlertRuleMsSecurityIncident) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SentinelAlertRuleMsSecurityIncident) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SentinelAlertRuleMsSecurityIncident) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/sentinel_alert_rule_ms_security_incident azurerm_sentinel_alert_rule_ms_security_incident} Resource.
func NewSentinelAlertRuleMsSecurityIncident(scope constructs.Construct, id *string, config *SentinelAlertRuleMsSecurityIncidentConfig) SentinelAlertRuleMsSecurityIncident {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.sentinelAlertRuleMsSecurityIncident.SentinelAlertRuleMsSecurityIncident",
...
func (j *jsiiProxy_SentinelAlertRuleMsSecurityIncident)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SentinelAlertRuleMsSecurityIncident)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SentinelAlertRuleMsSecurityIncident)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SentinelAlertRuleMsSecurityIncident_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncident) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncident) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncident) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncident) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncident) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SentinelAlertRuleMsSecurityIncident) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
