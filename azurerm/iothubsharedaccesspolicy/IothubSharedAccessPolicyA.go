...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/iothubsharedaccesspolicy/internal"
...
func (j *jsiiProxy_IothubSharedAccessPolicyA) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IothubSharedAccessPolicyA) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IothubSharedAccessPolicyA) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IothubSharedAccessPolicyA) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IothubSharedAccessPolicyA) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/iothub_shared_access_policy azurerm_iothub_shared_access_policy} Resource.
...
func (j *jsiiProxy_IothubSharedAccessPolicyA)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IothubSharedAccessPolicyA)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IothubSharedAccessPolicyA)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IothubSharedAccessPolicyA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IothubSharedAccessPolicyA) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubSharedAccessPolicyA) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IothubSharedAccessPolicyA) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubSharedAccessPolicyA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IothubSharedAccessPolicyA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IothubSharedAccessPolicyA) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
