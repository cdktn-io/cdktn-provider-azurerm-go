...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "jobTarget", GoGetter: "JobTarget"},
			_jsii_.MemberProperty{JsiiProperty: "jobTargetInput", GoGetter: "JobTargetInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putJobTarget", GoMethod: "PutJobTarget"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetJobTarget", GoMethod: "ResetJobTarget"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_MssqlJobTargetGroupTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
