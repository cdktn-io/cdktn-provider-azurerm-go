...
func (j *jsiiProxy_AppService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AppService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AppService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppService) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
