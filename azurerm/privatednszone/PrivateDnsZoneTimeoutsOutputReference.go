...
func (j *jsiiProxy_PrivateDnsZoneTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivateDnsZoneTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PrivateDnsZoneTimeoutsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.privateDnsZone.PrivateDnsZoneTimeoutsOutputReference",
...
func NewPrivateDnsZoneTimeoutsOutputReference_Override(p PrivateDnsZoneTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivateDnsZoneTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivateDnsZoneTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateDnsZoneTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PrivateDnsZoneTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateDnsZoneTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
