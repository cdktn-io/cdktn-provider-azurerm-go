...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/privatednszone/internal"
...
func NewPrivateDnsZoneSoaRecordOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PrivateDnsZoneSoaRecordOutputReference {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.privateDnsZone.PrivateDnsZoneSoaRecordOutputReference",
