...
func (j *jsiiProxy_PrivateDnsZone) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PrivateDnsZone) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PrivateDnsZone) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PrivateDnsZone) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PrivateDnsZone) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/private_dns_zone azurerm_private_dns_zone} Resource.
...
func (j *jsiiProxy_PrivateDnsZone)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PrivateDnsZone)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PrivateDnsZone)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PrivateDnsZone_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PrivateDnsZone) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateDnsZone) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PrivateDnsZone) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateDnsZone) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PrivateDnsZone) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
