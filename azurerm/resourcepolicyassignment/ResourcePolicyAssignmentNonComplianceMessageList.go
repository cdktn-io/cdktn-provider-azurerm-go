...
func (j *jsiiProxy_ResourcePolicyAssignmentNonComplianceMessageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResourcePolicyAssignmentNonComplianceMessageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ResourcePolicyAssignmentNonComplianceMessageList {
	_init_.Initialize()
...
func NewResourcePolicyAssignmentNonComplianceMessageList_Override(r ResourcePolicyAssignmentNonComplianceMessageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourcePolicyAssignmentNonComplianceMessageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourcePolicyAssignmentNonComplianceMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ResourcePolicyAssignmentNonComplianceMessageList) Resolve(context cdktn.IResolveContext) interface{} {
