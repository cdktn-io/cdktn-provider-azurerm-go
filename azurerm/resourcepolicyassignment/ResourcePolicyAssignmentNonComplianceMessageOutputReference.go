...
func (j *jsiiProxy_ResourcePolicyAssignmentNonComplianceMessageOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResourcePolicyAssignmentNonComplianceMessageOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ResourcePolicyAssignmentNonComplianceMessageOutputReference {
	_init_.Initialize()

	if err := validateNewResourcePolicyAssignmentNonComplianceMessageOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewResourcePolicyAssignmentNonComplianceMessageOutputReference_Override(r ResourcePolicyAssignmentNonComplianceMessageOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourcePolicyAssignmentNonComplianceMessageOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourcePolicyAssignmentNonComplianceMessageOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourcePolicyAssignmentNonComplianceMessageOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_ResourcePolicyAssignmentNonComplianceMessageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourcePolicyAssignmentNonComplianceMessageOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
