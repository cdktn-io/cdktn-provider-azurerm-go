...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/servicebusqueueauthorizationrule/internal"
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicebusQueueAuthorizationRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ServicebusQueueAuthorizationRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicebusQueueAuthorizationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
