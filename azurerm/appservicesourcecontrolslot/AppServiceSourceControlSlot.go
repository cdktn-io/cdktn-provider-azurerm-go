...
func (a *jsiiProxy_AppServiceSourceControlSlot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppServiceSourceControlSlot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppServiceSourceControlSlot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
