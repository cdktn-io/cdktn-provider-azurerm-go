...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionSeverityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionSeverityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
