...
func (j *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyList {
	_init_.Initialize()

	if err := validateNewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.monitorAlertProcessingRuleSuppression.MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyList",
...
func NewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyList_Override(m MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyList) Resolve(context cdktn.IResolveContext) interface{} {
