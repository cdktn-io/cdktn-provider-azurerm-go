...
func (j *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList {
	_init_.Initialize()
...
func NewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList_Override(m MonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList) Resolve(context cdktn.IResolveContext) interface{} {
