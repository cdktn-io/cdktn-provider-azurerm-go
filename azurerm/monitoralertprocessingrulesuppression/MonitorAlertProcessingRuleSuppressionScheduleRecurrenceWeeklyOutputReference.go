...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/monitoralertprocessingrulesuppression/internal"
...
func (j *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.monitorAlertProcessingRuleSuppression.MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference",
...
func NewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference_Override(m MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceWeeklyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
