...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionMonitorConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionMonitorConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
