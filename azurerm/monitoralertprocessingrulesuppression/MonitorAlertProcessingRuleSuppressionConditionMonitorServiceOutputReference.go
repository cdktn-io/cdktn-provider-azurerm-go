...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionMonitorServiceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionMonitorServiceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
