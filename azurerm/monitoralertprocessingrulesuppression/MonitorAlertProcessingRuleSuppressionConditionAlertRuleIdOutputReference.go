...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionAlertRuleIdOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionAlertRuleIdOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
