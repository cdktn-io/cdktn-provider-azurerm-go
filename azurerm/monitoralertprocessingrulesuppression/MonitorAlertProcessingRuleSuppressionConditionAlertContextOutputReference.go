...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionAlertContextOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionAlertContextOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
