...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/monitor_alert_processing_rule_suppression azurerm_monitor_alert_processing_rule_suppression} Resource.
func NewMonitorAlertProcessingRuleSuppression(scope constructs.Construct, id *string, config *MonitorAlertProcessingRuleSuppressionConfig) MonitorAlertProcessingRuleSuppression {
	...
	if err := validateNewMonitorAlertProcessingRuleSuppressionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func MonitorAlertProcessingRuleSuppression_IsConstruct(x interface{}) *bool {
	...
	if err := validateMonitorAlertProcessingRuleSuppression_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MonitorAlertProcessingRuleSuppression_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateMonitorAlertProcessingRuleSuppression_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MonitorAlertProcessingRuleSuppression_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateMonitorAlertProcessingRuleSuppression_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppression) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppression) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppression) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppression) MoveFromId(id *string) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppression) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppression) MoveToId(id *string) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppression) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppression) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppression) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppression) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
