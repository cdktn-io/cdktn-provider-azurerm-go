...
func (j *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceMonthlyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceMonthlyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorAlertProcessingRuleSuppressionScheduleRecurrenceMonthlyList {
	_init_.Initialize()
...
func NewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceMonthlyList_Override(m MonitorAlertProcessingRuleSuppressionScheduleRecurrenceMonthlyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceMonthlyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceMonthlyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceMonthlyList) Resolve(context cdktn.IResolveContext) interface{} {
