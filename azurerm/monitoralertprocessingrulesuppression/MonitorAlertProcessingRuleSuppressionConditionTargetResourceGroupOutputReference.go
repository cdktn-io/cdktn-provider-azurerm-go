...
func (j *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionTargetResourceGroupOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAlertProcessingRuleSuppressionConditionTargetResourceGroupOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MonitorAlertProcessingRuleSuppressionConditionTargetResourceGroupOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorAlertProcessingRuleSuppressionConditionTargetResourceGroupOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMonitorAlertProcessingRuleSuppressionConditionTargetResourceGroupOutputReference_Override(m MonitorAlertProcessingRuleSuppressionConditionTargetResourceGroupOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionTargetResourceGroupOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionTargetResourceGroupOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionTargetResourceGroupOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionTargetResourceGroupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionTargetResourceGroupOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
