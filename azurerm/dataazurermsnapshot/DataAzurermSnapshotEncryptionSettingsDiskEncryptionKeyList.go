...
func (j *jsiiProxy_DataAzurermSnapshotEncryptionSettingsDiskEncryptionKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermSnapshotEncryptionSettingsDiskEncryptionKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermSnapshotEncryptionSettingsDiskEncryptionKeyList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermSnapshot.DataAzurermSnapshotEncryptionSettingsDiskEncryptionKeyList",
...
func NewDataAzurermSnapshotEncryptionSettingsDiskEncryptionKeyList_Override(d DataAzurermSnapshotEncryptionSettingsDiskEncryptionKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermSnapshotEncryptionSettingsDiskEncryptionKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermSnapshotEncryptionSettingsDiskEncryptionKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermSnapshotEncryptionSettingsDiskEncryptionKeyList) Resolve(context cdktn.IResolveContext) interface{} {
