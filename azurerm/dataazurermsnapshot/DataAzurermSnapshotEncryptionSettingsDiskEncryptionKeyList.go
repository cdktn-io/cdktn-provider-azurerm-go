...
func (d *jsiiProxy_DataAzurermSnapshotEncryptionSettingsDiskEncryptionKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermSnapshotEncryptionSettingsDiskEncryptionKeyList) Resolve(context cdktf.IResolveContext) interface{} {
