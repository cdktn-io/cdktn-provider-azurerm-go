...
func (d *jsiiProxy_DataAzurermEventgridDomainIdentityList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAzurermEventgridDomainIdentityList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermEventgridDomainIdentityList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermEventgridDomainIdentityList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
