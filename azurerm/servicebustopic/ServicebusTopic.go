...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/servicebustopic/internal"
...
func (j *jsiiProxy_ServicebusTopic) BatchedOperationsEnabled() interface{} {
...
func (j *jsiiProxy_ServicebusTopic) BatchedOperationsEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ServicebusTopic) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicebusTopic) ExpressEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"expressEnabled",
...
func (j *jsiiProxy_ServicebusTopic) ExpressEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"expressEnabledInput",
...
func (j *jsiiProxy_ServicebusTopic) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicebusTopic) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicebusTopic) PartitioningEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"partitioningEnabled",
...
func (j *jsiiProxy_ServicebusTopic) PartitioningEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ServicebusTopic) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicebusTopic) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ServicebusTopic)SetBatchedOperationsEnabled(val interface{}) {
...
func (j *jsiiProxy_ServicebusTopic)SetExpressEnabled(val interface{}) {
...
func (j *jsiiProxy_ServicebusTopic)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicebusTopic)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicebusTopic)SetPartitioningEnabled(val interface{}) {
...
func (j *jsiiProxy_ServicebusTopic)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ServicebusTopic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServicebusTopic) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusTopic) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicebusTopic) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusTopic) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicebusTopic) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicebusTopic) ResetBatchedOperationsEnabled() {
	_jsii_.InvokeVoid(
		s,
		"resetBatchedOperationsEnabled",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusTopic) ResetExpressEnabled() {
	_jsii_.InvokeVoid(
		s,
		"resetExpressEnabled",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusTopic) ResetPartitioningEnabled() {
	_jsii_.InvokeVoid(
		s,
		"resetPartitioningEnabled",
		nil, // no parameters
...
func (s *jsiiProxy_ServicebusTopic) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
