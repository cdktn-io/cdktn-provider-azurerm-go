...
func (j *jsiiProxy_ServicebusTopicTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServicebusTopicTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ServicebusTopicTimeoutsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.servicebusTopic.ServicebusTopicTimeoutsOutputReference",
...
func NewServicebusTopicTimeoutsOutputReference_Override(s ServicebusTopicTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServicebusTopicTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServicebusTopicTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusTopicTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServicebusTopicTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusTopicTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
