...
func (s *jsiiProxy_ServicebusTopicTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicebusTopicTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
