...
func (j *jsiiProxy_FunctionAppIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FunctionAppIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewFunctionAppIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_FunctionAppIdentityOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppIdentityOutputReference",
...
func NewFunctionAppIdentityOutputReference_Override(f FunctionAppIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FunctionAppIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
