...
func (f *jsiiProxy_FunctionAppIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FunctionAppIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
