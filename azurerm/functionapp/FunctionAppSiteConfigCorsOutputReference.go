...
func (j *jsiiProxy_FunctionAppSiteConfigCorsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppSiteConfigCorsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FunctionAppSiteConfigCorsOutputReference {
	_init_.Initialize()

	if err := validateNewFunctionAppSiteConfigCorsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_FunctionAppSiteConfigCorsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppSiteConfigCorsOutputReference",
...
func NewFunctionAppSiteConfigCorsOutputReference_Override(f FunctionAppSiteConfigCorsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppSiteConfigCorsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppSiteConfigCorsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppSiteConfigCorsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FunctionAppSiteConfigCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppSiteConfigCorsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
