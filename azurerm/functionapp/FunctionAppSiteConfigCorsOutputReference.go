...
func (f *jsiiProxy_FunctionAppSiteConfigCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FunctionAppSiteConfigCorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
