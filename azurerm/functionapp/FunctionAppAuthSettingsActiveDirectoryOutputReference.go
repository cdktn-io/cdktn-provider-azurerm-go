...
func (j *jsiiProxy_FunctionAppAuthSettingsActiveDirectoryOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppAuthSettingsActiveDirectoryOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FunctionAppAuthSettingsActiveDirectoryOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppAuthSettingsActiveDirectoryOutputReference",
...
func NewFunctionAppAuthSettingsActiveDirectoryOutputReference_Override(f FunctionAppAuthSettingsActiveDirectoryOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppAuthSettingsActiveDirectoryOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppAuthSettingsActiveDirectoryOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppAuthSettingsActiveDirectoryOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FunctionAppAuthSettingsActiveDirectoryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppAuthSettingsActiveDirectoryOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
