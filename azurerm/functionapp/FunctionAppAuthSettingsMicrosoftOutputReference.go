...
func (j *jsiiProxy_FunctionAppAuthSettingsMicrosoftOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppAuthSettingsMicrosoftOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FunctionAppAuthSettingsMicrosoftOutputReference {
	_init_.Initialize()

	if err := validateNewFunctionAppAuthSettingsMicrosoftOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_FunctionAppAuthSettingsMicrosoftOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppAuthSettingsMicrosoftOutputReference",
...
func NewFunctionAppAuthSettingsMicrosoftOutputReference_Override(f FunctionAppAuthSettingsMicrosoftOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppAuthSettingsMicrosoftOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppAuthSettingsMicrosoftOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppAuthSettingsMicrosoftOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FunctionAppAuthSettingsMicrosoftOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppAuthSettingsMicrosoftOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
