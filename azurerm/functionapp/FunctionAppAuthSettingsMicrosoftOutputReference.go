...
func (f *jsiiProxy_FunctionAppAuthSettingsMicrosoftOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FunctionAppAuthSettingsMicrosoftOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
