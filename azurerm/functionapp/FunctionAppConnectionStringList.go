...
func (j *jsiiProxy_FunctionAppConnectionStringList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppConnectionStringList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FunctionAppConnectionStringList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppConnectionStringList",
...
func NewFunctionAppConnectionStringList_Override(f FunctionAppConnectionStringList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppConnectionStringList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FunctionAppConnectionStringList) Resolve(context cdktn.IResolveContext) interface{} {
