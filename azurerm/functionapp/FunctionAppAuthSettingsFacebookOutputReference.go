...
func (j *jsiiProxy_FunctionAppAuthSettingsFacebookOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppAuthSettingsFacebookOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FunctionAppAuthSettingsFacebookOutputReference {
	_init_.Initialize()

	if err := validateNewFunctionAppAuthSettingsFacebookOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_FunctionAppAuthSettingsFacebookOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppAuthSettingsFacebookOutputReference",
...
func NewFunctionAppAuthSettingsFacebookOutputReference_Override(f FunctionAppAuthSettingsFacebookOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppAuthSettingsFacebookOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppAuthSettingsFacebookOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppAuthSettingsFacebookOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FunctionAppAuthSettingsFacebookOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppAuthSettingsFacebookOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
