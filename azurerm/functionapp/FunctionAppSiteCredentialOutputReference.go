...
func (f *jsiiProxy_FunctionAppSiteCredentialOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FunctionAppSiteCredentialOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
