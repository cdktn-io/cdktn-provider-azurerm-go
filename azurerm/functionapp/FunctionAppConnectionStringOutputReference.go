...
func (j *jsiiProxy_FunctionAppConnectionStringOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppConnectionStringOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FunctionAppConnectionStringOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppConnectionStringOutputReference",
...
func NewFunctionAppConnectionStringOutputReference_Override(f FunctionAppConnectionStringOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppConnectionStringOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppConnectionStringOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppConnectionStringOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FunctionAppConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppConnectionStringOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
