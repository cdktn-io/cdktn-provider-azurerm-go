...
func (f *jsiiProxy_FunctionAppConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FunctionAppConnectionStringOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
