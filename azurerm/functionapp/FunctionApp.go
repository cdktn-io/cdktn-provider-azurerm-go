...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/function_app azurerm_function_app} Resource.
...
func (f *jsiiProxy_FunctionApp) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FunctionApp) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
