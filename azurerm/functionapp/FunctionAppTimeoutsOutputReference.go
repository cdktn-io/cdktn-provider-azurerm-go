...
func (j *jsiiProxy_FunctionAppTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FunctionAppTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewFunctionAppTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_FunctionAppTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppTimeoutsOutputReference",
...
func NewFunctionAppTimeoutsOutputReference_Override(f FunctionAppTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FunctionAppTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
