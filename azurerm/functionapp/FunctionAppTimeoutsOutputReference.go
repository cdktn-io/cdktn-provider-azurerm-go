...
func (f *jsiiProxy_FunctionAppTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FunctionAppTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
