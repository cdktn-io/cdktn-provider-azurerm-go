...
func (j *jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppSiteConfigIpRestrictionHeadersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FunctionAppSiteConfigIpRestrictionHeadersOutputReference {
	_init_.Initialize()

	if err := validateNewFunctionAppSiteConfigIpRestrictionHeadersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppSiteConfigIpRestrictionHeadersOutputReference",
...
func NewFunctionAppSiteConfigIpRestrictionHeadersOutputReference_Override(f FunctionAppSiteConfigIpRestrictionHeadersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
