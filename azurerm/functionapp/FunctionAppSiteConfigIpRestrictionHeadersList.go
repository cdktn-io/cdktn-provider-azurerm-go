...
func (j *jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppSiteConfigIpRestrictionHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FunctionAppSiteConfigIpRestrictionHeadersList {
	_init_.Initialize()

	if err := validateNewFunctionAppSiteConfigIpRestrictionHeadersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppSiteConfigIpRestrictionHeadersList",
...
func NewFunctionAppSiteConfigIpRestrictionHeadersList_Override(f FunctionAppSiteConfigIpRestrictionHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FunctionAppSiteConfigIpRestrictionHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
