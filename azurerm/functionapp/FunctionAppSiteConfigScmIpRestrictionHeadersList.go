...
func (j *jsiiProxy_FunctionAppSiteConfigScmIpRestrictionHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppSiteConfigScmIpRestrictionHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FunctionAppSiteConfigScmIpRestrictionHeadersList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppSiteConfigScmIpRestrictionHeadersList",
...
func NewFunctionAppSiteConfigScmIpRestrictionHeadersList_Override(f FunctionAppSiteConfigScmIpRestrictionHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppSiteConfigScmIpRestrictionHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppSiteConfigScmIpRestrictionHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FunctionAppSiteConfigScmIpRestrictionHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
