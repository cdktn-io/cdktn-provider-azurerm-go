...
func (j *jsiiProxy_FunctionAppAuthSettingsGoogleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppAuthSettingsGoogleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FunctionAppAuthSettingsGoogleOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppAuthSettingsGoogleOutputReference",
...
func NewFunctionAppAuthSettingsGoogleOutputReference_Override(f FunctionAppAuthSettingsGoogleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppAuthSettingsGoogleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppAuthSettingsGoogleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppAuthSettingsGoogleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FunctionAppAuthSettingsGoogleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppAuthSettingsGoogleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
