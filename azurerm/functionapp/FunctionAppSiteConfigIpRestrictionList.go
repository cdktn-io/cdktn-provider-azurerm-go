...
func (j *jsiiProxy_FunctionAppSiteConfigIpRestrictionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppSiteConfigIpRestrictionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FunctionAppSiteConfigIpRestrictionList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.functionApp.FunctionAppSiteConfigIpRestrictionList",
...
func NewFunctionAppSiteConfigIpRestrictionList_Override(f FunctionAppSiteConfigIpRestrictionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppSiteConfigIpRestrictionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppSiteConfigIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FunctionAppSiteConfigIpRestrictionList) Resolve(context cdktn.IResolveContext) interface{} {
