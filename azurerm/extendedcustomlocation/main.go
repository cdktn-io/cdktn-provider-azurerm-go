...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "clusterExtensionIdsInput", GoGetter: "ClusterExtensionIdsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "hostResourceIdInput", GoGetter: "HostResourceIdInput"},
