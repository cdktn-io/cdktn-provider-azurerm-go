...
func (n *jsiiProxy_NetappVolumeGroupOracleVolumeDataProtectionReplicationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetappVolumeGroupOracleVolumeDataProtectionReplicationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
