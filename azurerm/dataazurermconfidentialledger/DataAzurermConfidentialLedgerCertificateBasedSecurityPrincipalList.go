...
func (j *jsiiProxy_DataAzurermConfidentialLedgerCertificateBasedSecurityPrincipalList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermConfidentialLedgerCertificateBasedSecurityPrincipalList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermConfidentialLedgerCertificateBasedSecurityPrincipalList {
	_init_.Initialize()
...
func NewDataAzurermConfidentialLedgerCertificateBasedSecurityPrincipalList_Override(d DataAzurermConfidentialLedgerCertificateBasedSecurityPrincipalList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermConfidentialLedgerCertificateBasedSecurityPrincipalList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermConfidentialLedgerCertificateBasedSecurityPrincipalList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermConfidentialLedgerCertificateBasedSecurityPrincipalList) Resolve(context cdktn.IResolveContext) interface{} {
