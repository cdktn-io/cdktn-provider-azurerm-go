...
func (p *jsiiProxy_PostgresqlServerThreatDetectionPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PostgresqlServerThreatDetectionPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
