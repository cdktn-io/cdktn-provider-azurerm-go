...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/postgresqlserver/internal"
...
func (j *jsiiProxy_PostgresqlServerTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPostgresqlServerTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PostgresqlServerTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewPostgresqlServerTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewPostgresqlServerTimeoutsOutputReference_Override(p PostgresqlServerTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PostgresqlServerTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PostgresqlServerTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PostgresqlServerTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PostgresqlServerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PostgresqlServerTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
