...
func (p *jsiiProxy_PostgresqlServerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PostgresqlServerTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
