...
func (p *jsiiProxy_PostgresqlServer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PostgresqlServer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PostgresqlServer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
