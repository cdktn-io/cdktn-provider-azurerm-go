...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexList) Resolve(context cdktf.IResolveContext) interface{} {
