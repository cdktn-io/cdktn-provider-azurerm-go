...
func (j *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbSqlContainerIndexingPolicyCompositeIndexList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbSqlContainerIndexingPolicyCompositeIndexList {
	_init_.Initialize()

	if err := validateNewCosmosdbSqlContainerIndexingPolicyCompositeIndexListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCosmosdbSqlContainerIndexingPolicyCompositeIndexList_Override(c CosmosdbSqlContainerIndexingPolicyCompositeIndexList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexList) Resolve(context cdktn.IResolveContext) interface{} {
