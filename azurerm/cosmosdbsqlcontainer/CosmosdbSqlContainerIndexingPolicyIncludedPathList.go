...
func (j *jsiiProxy_CosmosdbSqlContainerIndexingPolicyIncludedPathList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbSqlContainerIndexingPolicyIncludedPathList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbSqlContainerIndexingPolicyIncludedPathList {
	_init_.Initialize()
...
func NewCosmosdbSqlContainerIndexingPolicyIncludedPathList_Override(c CosmosdbSqlContainerIndexingPolicyIncludedPathList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbSqlContainerIndexingPolicyIncludedPathList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyIncludedPathList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyIncludedPathList) Resolve(context cdktn.IResolveContext) interface{} {
