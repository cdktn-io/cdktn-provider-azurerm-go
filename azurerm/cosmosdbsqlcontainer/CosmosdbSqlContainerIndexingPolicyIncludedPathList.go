...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyIncludedPathList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyIncludedPathList) Resolve(context cdktf.IResolveContext) interface{} {
