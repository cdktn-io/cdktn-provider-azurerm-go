...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyIncludedPathOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyIncludedPathOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
