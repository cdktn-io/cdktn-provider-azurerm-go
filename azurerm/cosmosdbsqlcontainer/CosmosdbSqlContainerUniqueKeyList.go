...
func (c *jsiiProxy_CosmosdbSqlContainerUniqueKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbSqlContainerUniqueKeyList) Resolve(context cdktf.IResolveContext) interface{} {
