...
func (j *jsiiProxy_CosmosdbSqlContainerUniqueKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbSqlContainerUniqueKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbSqlContainerUniqueKeyList {
	_init_.Initialize()
...
func NewCosmosdbSqlContainerUniqueKeyList_Override(c CosmosdbSqlContainerUniqueKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbSqlContainerUniqueKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbSqlContainerUniqueKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbSqlContainerUniqueKeyList) Resolve(context cdktn.IResolveContext) interface{} {
