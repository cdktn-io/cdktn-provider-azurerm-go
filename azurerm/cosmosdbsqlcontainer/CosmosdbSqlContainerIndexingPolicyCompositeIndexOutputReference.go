...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/cosmosdbsqlcontainer/internal"
...
func (j *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbSqlContainerIndexingPolicyCompositeIndexOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CosmosdbSqlContainerIndexingPolicyCompositeIndexOutputReference {
	_init_.Initialize()

	if err := validateNewCosmosdbSqlContainerIndexingPolicyCompositeIndexOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewCosmosdbSqlContainerIndexingPolicyCompositeIndexOutputReference_Override(c CosmosdbSqlContainerIndexingPolicyCompositeIndexOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlContainerIndexingPolicyCompositeIndexOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
