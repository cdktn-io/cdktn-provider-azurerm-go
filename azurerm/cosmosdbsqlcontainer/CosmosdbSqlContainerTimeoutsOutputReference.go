...
func (c *jsiiProxy_CosmosdbSqlContainerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlContainerTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
