...
func (c *jsiiProxy_CosmosdbSqlContainerAutoscaleSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlContainerAutoscaleSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
