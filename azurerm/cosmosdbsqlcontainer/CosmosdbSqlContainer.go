...
func (c *jsiiProxy_CosmosdbSqlContainer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CosmosdbSqlContainer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CosmosdbSqlContainer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
