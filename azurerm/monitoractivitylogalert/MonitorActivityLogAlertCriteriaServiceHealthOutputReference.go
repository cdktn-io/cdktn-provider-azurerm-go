...
func (m *jsiiProxy_MonitorActivityLogAlertCriteriaServiceHealthOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorActivityLogAlertCriteriaServiceHealthOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
