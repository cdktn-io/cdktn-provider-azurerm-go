...
func (j *jsiiProxy_MonitorActivityLogAlert) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MonitorActivityLogAlert) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MonitorActivityLogAlert) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MonitorActivityLogAlert) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MonitorActivityLogAlert) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MonitorActivityLogAlert)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MonitorActivityLogAlert)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MonitorActivityLogAlert)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MonitorActivityLogAlert_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MonitorActivityLogAlert) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActivityLogAlert) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MonitorActivityLogAlert) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActivityLogAlert) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitorActivityLogAlert) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitorActivityLogAlert) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
