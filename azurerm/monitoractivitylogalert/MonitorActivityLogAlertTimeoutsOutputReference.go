...
func (m *jsiiProxy_MonitorActivityLogAlertTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorActivityLogAlertTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
