...
func (j *jsiiProxy_MonitorActivityLogAlertTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActivityLogAlertTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MonitorActivityLogAlertTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorActivityLogAlertTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_MonitorActivityLogAlertTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.monitorActivityLogAlert.MonitorActivityLogAlertTimeoutsOutputReference",
...
func NewMonitorActivityLogAlertTimeoutsOutputReference_Override(m MonitorActivityLogAlertTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActivityLogAlertTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActivityLogAlertTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActivityLogAlertTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorActivityLogAlertTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActivityLogAlertTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
