...
func (r *jsiiProxy_ResourceDeploymentScriptAzureCliEnvironmentVariableList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ResourceDeploymentScriptAzureCliEnvironmentVariableList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*ResourceDeploymentScriptAzureCliEnvironmentVariable; received %#v (a %T)", val, val)
		}
	}
