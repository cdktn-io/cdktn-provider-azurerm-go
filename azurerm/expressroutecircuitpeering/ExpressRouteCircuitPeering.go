...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/expressroutecircuitpeering/internal"
...
func (j *jsiiProxy_ExpressRouteCircuitPeering) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ExpressRouteCircuitPeering) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ExpressRouteCircuitPeering) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ExpressRouteCircuitPeering) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ExpressRouteCircuitPeering) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ExpressRouteCircuitPeering)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ExpressRouteCircuitPeering)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ExpressRouteCircuitPeering)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ExpressRouteCircuitPeering_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_ExpressRouteCircuitPeering) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ExpressRouteCircuitPeering) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_ExpressRouteCircuitPeering) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ExpressRouteCircuitPeering) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_ExpressRouteCircuitPeering) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_ExpressRouteCircuitPeering) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
