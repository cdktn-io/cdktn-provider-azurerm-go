...
func (m *jsiiProxy_MachineLearningComputeInstanceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MachineLearningComputeInstanceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
