...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/iothubdpscertificate/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/resources/iothub_dps_certificate azurerm_iothub_dps_certificate} Resource.
...
func IothubDpsCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IothubDpsCertificate) ImportFrom(id *string, provider cdktf.TerraformProvider) {
