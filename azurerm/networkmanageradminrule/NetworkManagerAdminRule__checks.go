...
func (n *jsiiProxy_NetworkManagerAdminRule) validatePutDestinationParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NetworkManagerAdminRuleDestination; received %#v (a %T)", value, value)
		}
	}
...
func (n *jsiiProxy_NetworkManagerAdminRule) validatePutSourceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NetworkManagerAdminRuleSource; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_NetworkManagerAdminRule) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
