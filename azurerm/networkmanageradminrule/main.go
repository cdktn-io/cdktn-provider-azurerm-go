...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "adminRuleCollectionId", GoGetter: "AdminRuleCollectionId"},
			_jsii_.MemberProperty{JsiiProperty: "adminRuleCollectionIdInput", GoGetter: "AdminRuleCollectionIdInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "addressPrefixType", GoGetter: "AddressPrefixType"},
			_jsii_.MemberProperty{JsiiProperty: "addressPrefixTypeInput", GoGetter: "AddressPrefixTypeInput"},
