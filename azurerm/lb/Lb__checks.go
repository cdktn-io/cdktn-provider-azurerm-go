...
func (l *jsiiProxy_Lb) validatePutFrontendIpConfigurationParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*LbFrontendIpConfiguration:
		value := value.(*[]*LbFrontendIpConfiguration)
	...
	case []*LbFrontendIpConfiguration:
		value_ := value.([]*LbFrontendIpConfiguration)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LbFrontendIpConfiguration; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Lb) validateSetEdgeZoneParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_Lb) validateSetLocationParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Lb) validateSetSkuParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
