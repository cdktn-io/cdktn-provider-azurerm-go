...
func (s *jsiiProxy_StreamAnalyticsStreamInputEventhubSerializationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputEventhubSerializationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
