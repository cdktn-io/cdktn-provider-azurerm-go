...
func (m *jsiiProxy_MssqlVirtualMachineTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MssqlVirtualMachineTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
