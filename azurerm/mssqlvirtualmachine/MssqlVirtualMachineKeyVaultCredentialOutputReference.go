...
func (m *jsiiProxy_MssqlVirtualMachineKeyVaultCredentialOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MssqlVirtualMachineKeyVaultCredentialOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
