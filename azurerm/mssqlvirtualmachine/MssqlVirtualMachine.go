...
func (j *jsiiProxy_MssqlVirtualMachine) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MssqlVirtualMachine) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MssqlVirtualMachine) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MssqlVirtualMachine) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MssqlVirtualMachine) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/mssql_virtual_machine azurerm_mssql_virtual_machine} Resource.
...
func (j *jsiiProxy_MssqlVirtualMachine)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MssqlVirtualMachine)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MssqlVirtualMachine)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MssqlVirtualMachine_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MssqlVirtualMachine) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlVirtualMachine) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MssqlVirtualMachine) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlVirtualMachine) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MssqlVirtualMachine) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MssqlVirtualMachine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
