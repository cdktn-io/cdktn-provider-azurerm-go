...
func (m *jsiiProxy_MssqlVirtualMachineSqlInstanceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MssqlVirtualMachineSqlInstanceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
