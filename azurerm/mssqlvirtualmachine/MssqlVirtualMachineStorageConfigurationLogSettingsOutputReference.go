...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/mssqlvirtualmachine/internal"
...
func (j *jsiiProxy_MssqlVirtualMachineStorageConfigurationLogSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMssqlVirtualMachineStorageConfigurationLogSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MssqlVirtualMachineStorageConfigurationLogSettingsOutputReference {
	_init_.Initialize()

	if err := validateNewMssqlVirtualMachineStorageConfigurationLogSettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMssqlVirtualMachineStorageConfigurationLogSettingsOutputReference_Override(m MssqlVirtualMachineStorageConfigurationLogSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MssqlVirtualMachineStorageConfigurationLogSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MssqlVirtualMachineStorageConfigurationLogSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlVirtualMachineStorageConfigurationLogSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MssqlVirtualMachineStorageConfigurationLogSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlVirtualMachineStorageConfigurationLogSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
