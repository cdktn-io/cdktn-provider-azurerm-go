...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdaInputList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdaInputList) Resolve(context cdktf.IResolveContext) interface{} {
