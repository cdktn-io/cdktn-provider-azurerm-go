...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdaInputList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStreamAnalyticsFunctionJavascriptUdaInputList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StreamAnalyticsFunctionJavascriptUdaInputList {
	_init_.Initialize()
...
func NewStreamAnalyticsFunctionJavascriptUdaInputList_Override(s StreamAnalyticsFunctionJavascriptUdaInputList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdaInputList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdaInputList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdaInputList) Resolve(context cdktn.IResolveContext) interface{} {
