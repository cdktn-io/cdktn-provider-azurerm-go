...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/stream_analytics_function_javascript_uda azurerm_stream_analytics_function_javascript_uda} Resource.
func NewStreamAnalyticsFunctionJavascriptUda(scope constructs.Construct, id *string, config *StreamAnalyticsFunctionJavascriptUdaConfig) StreamAnalyticsFunctionJavascriptUda {
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.streamAnalyticsFunctionJavascriptUda.StreamAnalyticsFunctionJavascriptUda",
