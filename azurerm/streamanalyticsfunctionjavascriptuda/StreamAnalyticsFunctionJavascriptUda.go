...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/resources/stream_analytics_function_javascript_uda azurerm_stream_analytics_function_javascript_uda}.
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUda) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUda) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUda) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUda) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUda) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/resources/stream_analytics_function_javascript_uda azurerm_stream_analytics_function_javascript_uda} Resource.
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUda)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUda)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUda)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StreamAnalyticsFunctionJavascriptUda_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUda) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUda) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUda) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
