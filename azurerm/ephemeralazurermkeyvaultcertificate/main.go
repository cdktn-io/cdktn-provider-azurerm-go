...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EphemeralAzurermKeyVaultCertificate)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "certificateCount", GoGetter: "CertificateCount"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.ephemeralAzurermKeyVaultCertificate.EphemeralAzurermKeyVaultCertificateConfig",
		reflect.TypeOf((*EphemeralAzurermKeyVaultCertificateConfig)(nil)).Elem(),
	)
}
