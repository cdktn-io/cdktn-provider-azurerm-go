...
func (j *jsiiProxy_GalleryApplicationVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GalleryApplicationVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GalleryApplicationVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GalleryApplicationVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GalleryApplicationVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/gallery_application_version azurerm_gallery_application_version} Resource.
...
func (j *jsiiProxy_GalleryApplicationVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GalleryApplicationVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GalleryApplicationVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GalleryApplicationVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GalleryApplicationVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GalleryApplicationVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GalleryApplicationVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GalleryApplicationVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GalleryApplicationVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GalleryApplicationVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
