...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/galleryapplicationversion/internal"
...
func (j *jsiiProxy_GalleryApplicationVersionTargetRegionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGalleryApplicationVersionTargetRegionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GalleryApplicationVersionTargetRegionOutputReference {
	_init_.Initialize()

	if err := validateNewGalleryApplicationVersionTargetRegionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewGalleryApplicationVersionTargetRegionOutputReference_Override(g GalleryApplicationVersionTargetRegionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GalleryApplicationVersionTargetRegionOutputReference)SetRegionalReplicaCount(val *float64) {
	if err := j.validateSetRegionalReplicaCountParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_GalleryApplicationVersionTargetRegionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GalleryApplicationVersionTargetRegionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GalleryApplicationVersionTargetRegionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GalleryApplicationVersionTargetRegionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GalleryApplicationVersionTargetRegionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
