...
func (g *jsiiProxy_GalleryApplicationVersionTargetRegionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GalleryApplicationVersionTargetRegionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
