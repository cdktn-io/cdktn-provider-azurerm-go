...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "packageFile", GoGetter: "PackageFile"},
			_jsii_.MemberProperty{JsiiProperty: "packageFileInput", GoGetter: "PackageFileInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPackageFile", GoMethod: "ResetPackageFile"},
