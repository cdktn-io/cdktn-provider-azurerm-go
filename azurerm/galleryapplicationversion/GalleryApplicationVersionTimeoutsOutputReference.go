...
func (g *jsiiProxy_GalleryApplicationVersionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GalleryApplicationVersionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
