...
func (g *jsiiProxy_GalleryApplicationVersionTargetRegionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GalleryApplicationVersionTargetRegionList) Resolve(context cdktf.IResolveContext) interface{} {
