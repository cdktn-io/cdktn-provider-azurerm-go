...
func (j *jsiiProxy_GalleryApplicationVersionTargetRegionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGalleryApplicationVersionTargetRegionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GalleryApplicationVersionTargetRegionList {
	_init_.Initialize()
...
func NewGalleryApplicationVersionTargetRegionList_Override(g GalleryApplicationVersionTargetRegionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GalleryApplicationVersionTargetRegionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GalleryApplicationVersionTargetRegionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GalleryApplicationVersionTargetRegionList) Resolve(context cdktn.IResolveContext) interface{} {
