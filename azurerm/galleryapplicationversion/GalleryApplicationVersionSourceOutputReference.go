...
func (j *jsiiProxy_GalleryApplicationVersionSourceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGalleryApplicationVersionSourceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GalleryApplicationVersionSourceOutputReference {
	_init_.Initialize()

	if err := validateNewGalleryApplicationVersionSourceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewGalleryApplicationVersionSourceOutputReference_Override(g GalleryApplicationVersionSourceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GalleryApplicationVersionSourceOutputReference)SetDefaultConfigurationLink(val *string) {
	if err := j.validateSetDefaultConfigurationLinkParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_GalleryApplicationVersionSourceOutputReference)SetMediaLink(val *string) {
	if err := j.validateSetMediaLinkParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_GalleryApplicationVersionSourceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GalleryApplicationVersionSourceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GalleryApplicationVersionSourceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GalleryApplicationVersionSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GalleryApplicationVersionSourceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
