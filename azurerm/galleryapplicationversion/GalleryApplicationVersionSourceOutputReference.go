...
func (g *jsiiProxy_GalleryApplicationVersionSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GalleryApplicationVersionSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
