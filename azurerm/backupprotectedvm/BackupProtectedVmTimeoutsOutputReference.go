...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/backupprotectedvm/internal"
...
func (j *jsiiProxy_BackupProtectedVmTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBackupProtectedVmTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BackupProtectedVmTimeoutsOutputReference {
	_init_.Initialize()
...
func NewBackupProtectedVmTimeoutsOutputReference_Override(b BackupProtectedVmTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BackupProtectedVmTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BackupProtectedVmTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupProtectedVmTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BackupProtectedVmTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupProtectedVmTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
