...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "excludeDiskLuns", GoGetter: "ExcludeDiskLuns"},
			_jsii_.MemberProperty{JsiiProperty: "excludeDiskLunsInput", GoGetter: "ExcludeDiskLunsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "includeDiskLuns", GoGetter: "IncludeDiskLuns"},
			_jsii_.MemberProperty{JsiiProperty: "includeDiskLunsInput", GoGetter: "IncludeDiskLunsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "protectionStateInput", GoGetter: "ProtectionStateInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExcludeDiskLuns", GoMethod: "ResetExcludeDiskLuns"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIncludeDiskLuns", GoMethod: "ResetIncludeDiskLuns"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetProtectionState", GoMethod: "ResetProtectionState"},
