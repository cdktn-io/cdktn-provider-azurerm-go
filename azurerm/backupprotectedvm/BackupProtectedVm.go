...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/backup_protected_vm azurerm_backup_protected_vm} Resource.
...
func (b *jsiiProxy_BackupProtectedVm) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupProtectedVm) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BackupProtectedVm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
