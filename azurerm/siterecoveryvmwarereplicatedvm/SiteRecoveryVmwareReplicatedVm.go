...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/site_recovery_vmware_replicated_vm azurerm_site_recovery_vmware_replicated_vm} Resource.
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicatedVm) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicatedVm) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicatedVm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
