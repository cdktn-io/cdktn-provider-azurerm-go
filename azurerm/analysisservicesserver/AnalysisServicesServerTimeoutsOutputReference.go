...
func (a *jsiiProxy_AnalysisServicesServerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AnalysisServicesServerTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
