...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "powerBiServiceEnabled", GoGetter: "PowerBiServiceEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "powerBiServiceEnabledInput", GoGetter: "PowerBiServiceEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPowerBiServiceEnabled", GoMethod: "ResetPowerBiServiceEnabled"},
