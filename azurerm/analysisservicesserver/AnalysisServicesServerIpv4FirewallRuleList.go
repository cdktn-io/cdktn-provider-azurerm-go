...
func (j *jsiiProxy_AnalysisServicesServerIpv4FirewallRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAnalysisServicesServerIpv4FirewallRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AnalysisServicesServerIpv4FirewallRuleList {
	_init_.Initialize()

	if err := validateNewAnalysisServicesServerIpv4FirewallRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewAnalysisServicesServerIpv4FirewallRuleList_Override(a AnalysisServicesServerIpv4FirewallRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AnalysisServicesServerIpv4FirewallRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AnalysisServicesServerIpv4FirewallRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AnalysisServicesServerIpv4FirewallRuleList) Resolve(context cdktn.IResolveContext) interface{} {
