...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/recovery_services_vault azurerm_recovery_services_vault} Resource.
...
func (r *jsiiProxy_RecoveryServicesVault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RecoveryServicesVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RecoveryServicesVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
