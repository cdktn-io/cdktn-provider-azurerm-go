...
func (j *jsiiProxy_RecoveryServicesVaultTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRecoveryServicesVaultTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) RecoveryServicesVaultTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewRecoveryServicesVaultTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewRecoveryServicesVaultTimeoutsOutputReference_Override(r RecoveryServicesVaultTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_RecoveryServicesVaultTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RecoveryServicesVaultTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RecoveryServicesVaultTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_RecoveryServicesVaultTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RecoveryServicesVaultTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
