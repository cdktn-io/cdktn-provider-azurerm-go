...
func (r *jsiiProxy_RecoveryServicesVaultTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RecoveryServicesVaultTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
