...
func (j *jsiiProxy_RecoveryServicesVaultIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRecoveryServicesVaultIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) RecoveryServicesVaultIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewRecoveryServicesVaultIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewRecoveryServicesVaultIdentityOutputReference_Override(r RecoveryServicesVaultIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_RecoveryServicesVaultIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RecoveryServicesVaultIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RecoveryServicesVaultIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_RecoveryServicesVaultIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RecoveryServicesVaultIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
