...
func (j *jsiiProxy_ResourcePolicyRemediationTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResourcePolicyRemediationTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ResourcePolicyRemediationTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewResourcePolicyRemediationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_ResourcePolicyRemediationTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.resourcePolicyRemediation.ResourcePolicyRemediationTimeoutsOutputReference",
...
func NewResourcePolicyRemediationTimeoutsOutputReference_Override(r ResourcePolicyRemediationTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourcePolicyRemediationTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourcePolicyRemediationTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourcePolicyRemediationTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_ResourcePolicyRemediationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourcePolicyRemediationTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
