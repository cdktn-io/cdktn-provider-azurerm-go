...
func (r *jsiiProxy_ResourcePolicyRemediationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_ResourcePolicyRemediationTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
