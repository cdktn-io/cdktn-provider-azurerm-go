...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/resourcepolicyremediation/internal"
...
func (j *jsiiProxy_ResourcePolicyRemediation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ResourcePolicyRemediation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ResourcePolicyRemediation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ResourcePolicyRemediation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ResourcePolicyRemediation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/resource_policy_remediation azurerm_resource_policy_remediation} Resource.
...
func (j *jsiiProxy_ResourcePolicyRemediation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ResourcePolicyRemediation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ResourcePolicyRemediation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ResourcePolicyRemediation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateResourcePolicyRemediation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_ResourcePolicyRemediation) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_ResourcePolicyRemediation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourcePolicyRemediation) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_ResourcePolicyRemediation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_ResourcePolicyRemediation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourcePolicyRemediation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_ResourcePolicyRemediation) MoveFromId(id *string) {
...
func (r *jsiiProxy_ResourcePolicyRemediation) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_ResourcePolicyRemediation) MoveToId(id *string) {
...
func (r *jsiiProxy_ResourcePolicyRemediation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_ResourcePolicyRemediation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_ResourcePolicyRemediation) ToHclTerraform() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_ResourcePolicyRemediation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
