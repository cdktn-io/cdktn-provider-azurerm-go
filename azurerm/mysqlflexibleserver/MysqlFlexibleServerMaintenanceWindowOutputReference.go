...
func (m *jsiiProxy_MysqlFlexibleServerMaintenanceWindowOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MysqlFlexibleServerMaintenanceWindowOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
