...
func (j *jsiiProxy_MysqlFlexibleServerMaintenanceWindowOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMysqlFlexibleServerMaintenanceWindowOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MysqlFlexibleServerMaintenanceWindowOutputReference {
	_init_.Initialize()

	if err := validateNewMysqlFlexibleServerMaintenanceWindowOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMysqlFlexibleServerMaintenanceWindowOutputReference_Override(m MysqlFlexibleServerMaintenanceWindowOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MysqlFlexibleServerMaintenanceWindowOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MysqlFlexibleServerMaintenanceWindowOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MysqlFlexibleServerMaintenanceWindowOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MysqlFlexibleServerMaintenanceWindowOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MysqlFlexibleServerMaintenanceWindowOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
