...
func (m *jsiiProxy_MysqlFlexibleServerStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MysqlFlexibleServerStorageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
