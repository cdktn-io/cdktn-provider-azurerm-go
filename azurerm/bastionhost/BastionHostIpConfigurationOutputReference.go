...
func (b *jsiiProxy_BastionHostIpConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BastionHostIpConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
