...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/bastionhost/internal"
...
func (j *jsiiProxy_BastionHost) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BastionHost) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BastionHost) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BastionHost) PrivateOnlyEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_BastionHost) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BastionHost) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/bastion_host azurerm_bastion_host} Resource.
...
func (j *jsiiProxy_BastionHost)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BastionHost)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BastionHost)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BastionHost_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BastionHost) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BastionHost) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BastionHost) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BastionHost) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BastionHost) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BastionHost) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
