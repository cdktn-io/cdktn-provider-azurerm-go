...
func (j *jsiiProxy_SynapseSparkPool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SynapseSparkPool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SynapseSparkPool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SynapseSparkPool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SynapseSparkPool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SynapseSparkPool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SynapseSparkPool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SynapseSparkPool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SynapseSparkPool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SynapseSparkPool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSparkPool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SynapseSparkPool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSparkPool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SynapseSparkPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SynapseSparkPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
