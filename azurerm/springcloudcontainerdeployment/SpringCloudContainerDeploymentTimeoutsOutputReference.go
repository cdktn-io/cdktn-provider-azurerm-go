...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/springcloudcontainerdeployment/internal"
...
func (j *jsiiProxy_SpringCloudContainerDeploymentTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudContainerDeploymentTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SpringCloudContainerDeploymentTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSpringCloudContainerDeploymentTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSpringCloudContainerDeploymentTimeoutsOutputReference_Override(s SpringCloudContainerDeploymentTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudContainerDeploymentTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudContainerDeploymentTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudContainerDeploymentTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SpringCloudContainerDeploymentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudContainerDeploymentTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
