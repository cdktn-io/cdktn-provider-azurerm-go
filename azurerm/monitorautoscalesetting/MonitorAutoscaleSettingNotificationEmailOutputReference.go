...
func (m *jsiiProxy_MonitorAutoscaleSettingNotificationEmailOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSettingNotificationEmailOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
