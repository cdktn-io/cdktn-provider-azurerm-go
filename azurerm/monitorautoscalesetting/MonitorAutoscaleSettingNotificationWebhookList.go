...
func (m *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookList) Resolve(context cdktf.IResolveContext) interface{} {
