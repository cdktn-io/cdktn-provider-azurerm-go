...
func (j *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAutoscaleSettingNotificationWebhookList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorAutoscaleSettingNotificationWebhookList {
	_init_.Initialize()

	if err := validateNewMonitorAutoscaleSettingNotificationWebhookListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewMonitorAutoscaleSettingNotificationWebhookList_Override(m MonitorAutoscaleSettingNotificationWebhookList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookList) Resolve(context cdktn.IResolveContext) interface{} {
