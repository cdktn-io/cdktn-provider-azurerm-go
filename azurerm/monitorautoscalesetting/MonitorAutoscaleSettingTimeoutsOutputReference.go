...
func (m *jsiiProxy_MonitorAutoscaleSettingTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSettingTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
