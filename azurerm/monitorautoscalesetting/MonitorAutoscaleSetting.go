...
func (j *jsiiProxy_MonitorAutoscaleSetting) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MonitorAutoscaleSetting) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MonitorAutoscaleSetting) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MonitorAutoscaleSetting) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MonitorAutoscaleSetting) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MonitorAutoscaleSetting)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MonitorAutoscaleSetting)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MonitorAutoscaleSetting)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MonitorAutoscaleSetting_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MonitorAutoscaleSetting) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSetting) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MonitorAutoscaleSetting) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSetting) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitorAutoscaleSetting) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitorAutoscaleSetting) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
