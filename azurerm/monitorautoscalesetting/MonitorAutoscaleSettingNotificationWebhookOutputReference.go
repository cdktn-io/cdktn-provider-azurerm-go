...
func (j *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAutoscaleSettingNotificationWebhookOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorAutoscaleSettingNotificationWebhookOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorAutoscaleSettingNotificationWebhookOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewMonitorAutoscaleSettingNotificationWebhookOutputReference_Override(m MonitorAutoscaleSettingNotificationWebhookOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSettingNotificationWebhookOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
