...
func (j *jsiiProxy_MonitorAutoscaleSettingProfileOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAutoscaleSettingProfileOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorAutoscaleSettingProfileOutputReference {
	_init_.Initialize()
...
func NewMonitorAutoscaleSettingProfileOutputReference_Override(m MonitorAutoscaleSettingProfileOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAutoscaleSettingProfileOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
