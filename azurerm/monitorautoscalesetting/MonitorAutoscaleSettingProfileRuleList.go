...
func (j *jsiiProxy_MonitorAutoscaleSettingProfileRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAutoscaleSettingProfileRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorAutoscaleSettingProfileRuleList {
	_init_.Initialize()
...
func NewMonitorAutoscaleSettingProfileRuleList_Override(m MonitorAutoscaleSettingProfileRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAutoscaleSettingProfileRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileRuleList) Resolve(context cdktn.IResolveContext) interface{} {
