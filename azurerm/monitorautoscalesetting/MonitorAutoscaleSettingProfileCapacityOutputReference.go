...
func (j *jsiiProxy_MonitorAutoscaleSettingProfileCapacityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAutoscaleSettingProfileCapacityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MonitorAutoscaleSettingProfileCapacityOutputReference {
	_init_.Initialize()
...
func NewMonitorAutoscaleSettingProfileCapacityOutputReference_Override(m MonitorAutoscaleSettingProfileCapacityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAutoscaleSettingProfileCapacityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileCapacityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileCapacityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileCapacityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileCapacityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
