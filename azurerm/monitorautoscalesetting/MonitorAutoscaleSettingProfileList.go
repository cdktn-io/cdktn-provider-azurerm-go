...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileList) Resolve(context cdktf.IResolveContext) interface{} {
