...
func (j *jsiiProxy_MonitorAutoscaleSettingProfileList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAutoscaleSettingProfileList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorAutoscaleSettingProfileList {
	_init_.Initialize()

	if err := validateNewMonitorAutoscaleSettingProfileListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewMonitorAutoscaleSettingProfileList_Override(m MonitorAutoscaleSettingProfileList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAutoscaleSettingProfileList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileList) Resolve(context cdktn.IResolveContext) interface{} {
