...
func (j *jsiiProxy_MonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsList {
	_init_.Initialize()

	if err := validateNewMonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewMonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsList_Override(m MonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsList) Resolve(context cdktn.IResolveContext) interface{} {
