...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsList) Resolve(context cdktf.IResolveContext) interface{} {
