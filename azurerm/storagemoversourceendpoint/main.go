...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nfsVersion", GoGetter: "NfsVersion"},
			_jsii_.MemberProperty{JsiiProperty: "nfsVersionInput", GoGetter: "NfsVersionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNfsVersion", GoMethod: "ResetNfsVersion"},
