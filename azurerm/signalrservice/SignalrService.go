...
func (j *jsiiProxy_SignalrService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SignalrService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SignalrService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SignalrService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SignalrService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/signalr_service azurerm_signalr_service} Resource.
...
func (j *jsiiProxy_SignalrService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SignalrService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SignalrService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SignalrService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SignalrService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SignalrService) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SignalrService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SignalrService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SignalrService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SignalrService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
