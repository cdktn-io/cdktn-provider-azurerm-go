...
func (s *jsiiProxy_SignalrService) validatePutCorsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SignalrServiceCors; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SignalrService) validatePutUpstreamEndpointParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SignalrServiceUpstreamEndpoint; received %#v (a %T)", value, value)
		}
	}
