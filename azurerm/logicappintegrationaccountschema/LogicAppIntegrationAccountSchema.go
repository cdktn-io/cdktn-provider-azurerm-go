...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/logicappintegrationaccountschema/internal"
...
func (j *jsiiProxy_LogicAppIntegrationAccountSchema) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LogicAppIntegrationAccountSchema) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LogicAppIntegrationAccountSchema) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LogicAppIntegrationAccountSchema) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LogicAppIntegrationAccountSchema) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewLogicAppIntegrationAccountSchema(scope constructs.Construct, id *string, config *LogicAppIntegrationAccountSchemaConfig) LogicAppIntegrationAccountSchema {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.logicAppIntegrationAccountSchema.LogicAppIntegrationAccountSchema",
...
func (j *jsiiProxy_LogicAppIntegrationAccountSchema)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LogicAppIntegrationAccountSchema)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LogicAppIntegrationAccountSchema)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LogicAppIntegrationAccountSchema_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LogicAppIntegrationAccountSchema) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountSchema) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountSchema) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountSchema) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogicAppIntegrationAccountSchema) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountSchema) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
