...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/datafactorylinkedserviceazuredatabricks/internal"
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryLinkedServiceAzureDatabricks.DataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference",
...
func NewDataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference_Override(d DataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureDatabricksTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
