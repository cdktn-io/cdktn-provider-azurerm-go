...
func (d *jsiiProxy_DataFactoryDatasetParquetTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetParquetTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
