...
func (d *jsiiProxy_DataFactoryDatasetParquetAzureBlobFsLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetParquetAzureBlobFsLocationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
