...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/datafactorydatasetparquet/internal"
...
func (j *jsiiProxy_DataFactoryDatasetParquet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataFactoryDatasetParquet) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataFactoryDatasetParquet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataFactoryDatasetParquet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataFactoryDatasetParquet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataFactoryDatasetParquet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/data_factory_dataset_parquet azurerm_data_factory_dataset_parquet} Resource.
func NewDataFactoryDatasetParquet(scope constructs.Construct, id *string, config *DataFactoryDatasetParquetConfig) DataFactoryDatasetParquet {
	...
	if err := validateNewDataFactoryDatasetParquetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataFactoryDatasetParquet)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataFactoryDatasetParquet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataFactoryDatasetParquet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataFactoryDatasetParquet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataFactoryDatasetParquet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataFactoryDatasetParquet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataFactoryDatasetParquet_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataFactoryDatasetParquet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryDatasetParquet_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryDatasetParquet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryDatasetParquet_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryDatasetParquet_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataFactoryDatasetParquet) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataFactoryDatasetParquet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetParquet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DataFactoryDatasetParquet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetParquet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryDatasetParquet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataFactoryDatasetParquet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataFactoryDatasetParquet) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataFactoryDatasetParquet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
