...
func (j *jsiiProxy_StorageManagementPolicyRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageManagementPolicyRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StorageManagementPolicyRuleList {
	_init_.Initialize()
...
func NewStorageManagementPolicyRuleList_Override(s StorageManagementPolicyRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageManagementPolicyRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageManagementPolicyRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageManagementPolicyRuleList) Resolve(context cdktn.IResolveContext) interface{} {
