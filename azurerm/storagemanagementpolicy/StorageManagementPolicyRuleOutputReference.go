...
func (j *jsiiProxy_StorageManagementPolicyRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageManagementPolicyRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StorageManagementPolicyRuleOutputReference {
	_init_.Initialize()
...
func NewStorageManagementPolicyRuleOutputReference_Override(s StorageManagementPolicyRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageManagementPolicyRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageManagementPolicyRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageManagementPolicyRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageManagementPolicyRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageManagementPolicyRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
