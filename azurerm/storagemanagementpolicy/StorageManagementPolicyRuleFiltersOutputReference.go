...
func (s *jsiiProxy_StorageManagementPolicyRuleFiltersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageManagementPolicyRuleFiltersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
