...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTierToColdAfterDaysSinceCreationGreaterThan", GoMethod: "ResetTierToColdAfterDaysSinceCreationGreaterThan"},
			_jsii_.MemberMethod{JsiiMethod: "resetTierToColdAfterDaysSinceLastAccessTimeGreaterThan", GoMethod: "ResetTierToColdAfterDaysSinceLastAccessTimeGreaterThan"},
			_jsii_.MemberMethod{JsiiMethod: "resetTierToColdAfterDaysSinceModificationGreaterThan", GoMethod: "ResetTierToColdAfterDaysSinceModificationGreaterThan"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tierToColdAfterDaysSinceCreationGreaterThanInput", GoGetter: "TierToColdAfterDaysSinceCreationGreaterThanInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tierToColdAfterDaysSinceLastAccessTimeGreaterThanInput", GoGetter: "TierToColdAfterDaysSinceLastAccessTimeGreaterThanInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tierToColdAfterDaysSinceModificationGreaterThanInput", GoGetter: "TierToColdAfterDaysSinceModificationGreaterThanInput"},
