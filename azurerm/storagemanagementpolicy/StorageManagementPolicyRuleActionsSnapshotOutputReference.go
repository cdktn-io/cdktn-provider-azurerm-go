...
func (j *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference) TierToColdAfterDaysSinceCreationGreaterThan() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference) TierToColdAfterDaysSinceCreationGreaterThanInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func NewStorageManagementPolicyRuleActionsSnapshotOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StorageManagementPolicyRuleActionsSnapshotOutputReference {
	_init_.Initialize()
...
func NewStorageManagementPolicyRuleActionsSnapshotOutputReference_Override(s StorageManagementPolicyRuleActionsSnapshotOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference)SetTierToColdAfterDaysSinceCreationGreaterThan(val *float64) {
...
func (s *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference) ResetTierToColdAfterDaysSinceCreationGreaterThan() {
	_jsii_.InvokeVoid(
		s,
		"resetTierToColdAfterDaysSinceCreationGreaterThan",
		nil, // no parameters
...
func (s *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
