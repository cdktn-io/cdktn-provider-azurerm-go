...
func (s *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageManagementPolicyRuleActionsSnapshotOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
