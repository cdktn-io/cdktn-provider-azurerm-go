...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/sourcecontroltoken/internal"
...
func (j *jsiiProxy_SourceControlToken) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SourceControlToken) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SourceControlToken) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SourceControlToken) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SourceControlToken) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/source_control_token azurerm_source_control_token} Resource.
...
func (j *jsiiProxy_SourceControlToken)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SourceControlToken)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SourceControlToken)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SourceControlToken_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSourceControlToken_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SourceControlToken) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SourceControlToken) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SourceControlToken) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SourceControlToken) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SourceControlToken) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SourceControlToken) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SourceControlToken) MoveFromId(id *string) {
...
func (s *jsiiProxy_SourceControlToken) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SourceControlToken) MoveToId(id *string) {
...
func (s *jsiiProxy_SourceControlToken) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SourceControlToken) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SourceControlToken) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SourceControlToken) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
