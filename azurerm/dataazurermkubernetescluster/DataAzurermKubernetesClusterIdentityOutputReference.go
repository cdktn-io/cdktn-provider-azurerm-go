...
func (d *jsiiProxy_DataAzurermKubernetesClusterIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
