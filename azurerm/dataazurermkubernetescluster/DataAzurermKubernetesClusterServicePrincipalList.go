...
func (j *jsiiProxy_DataAzurermKubernetesClusterServicePrincipalList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterServicePrincipalList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterServicePrincipalList {
	_init_.Initialize()
...
func NewDataAzurermKubernetesClusterServicePrincipalList_Override(d DataAzurermKubernetesClusterServicePrincipalList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterServicePrincipalList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterServicePrincipalList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterServicePrincipalList) Resolve(context cdktn.IResolveContext) interface{} {
