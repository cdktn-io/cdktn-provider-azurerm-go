...
func (j *jsiiProxy_DataAzurermKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlList {
	_init_.Initialize()

	if err := validateNewDataAzurermKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlList",
...
func NewDataAzurermKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlList_Override(d DataAzurermKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlList) Resolve(context cdktn.IResolveContext) interface{} {
