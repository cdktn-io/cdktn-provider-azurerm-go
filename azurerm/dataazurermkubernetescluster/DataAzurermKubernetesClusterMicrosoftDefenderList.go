...
func (d *jsiiProxy_DataAzurermKubernetesClusterMicrosoftDefenderList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterMicrosoftDefenderList) Resolve(context cdktf.IResolveContext) interface{} {
