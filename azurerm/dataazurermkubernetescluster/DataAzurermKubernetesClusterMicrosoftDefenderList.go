...
func (j *jsiiProxy_DataAzurermKubernetesClusterMicrosoftDefenderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterMicrosoftDefenderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterMicrosoftDefenderList {
	_init_.Initialize()
...
func NewDataAzurermKubernetesClusterMicrosoftDefenderList_Override(d DataAzurermKubernetesClusterMicrosoftDefenderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterMicrosoftDefenderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterMicrosoftDefenderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterMicrosoftDefenderList) Resolve(context cdktn.IResolveContext) interface{} {
