...
func (d *jsiiProxy_DataAzurermKubernetesClusterNetworkProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterNetworkProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
