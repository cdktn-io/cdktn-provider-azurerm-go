...
func (j *jsiiProxy_DataAzurermKubernetesClusterIngressApplicationGatewayList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterIngressApplicationGatewayList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterIngressApplicationGatewayList {
	_init_.Initialize()
...
func NewDataAzurermKubernetesClusterIngressApplicationGatewayList_Override(d DataAzurermKubernetesClusterIngressApplicationGatewayList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterIngressApplicationGatewayList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterIngressApplicationGatewayList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterIngressApplicationGatewayList) Resolve(context cdktn.IResolveContext) interface{} {
