...
func (j *jsiiProxy_DataAzurermKubernetesCluster) CurrentKubernetesVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzurermKubernetesCluster) ServiceMeshProfile() DataAzurermKubernetesClusterServiceMeshProfileList {
	var returns DataAzurermKubernetesClusterServiceMeshProfileList
	_jsii_.Get(
		j,
		"serviceMeshProfile",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/kubernetes_cluster azurerm_kubernetes_cluster} Data Source.
...
func (d *jsiiProxy_DataAzurermKubernetesCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermKubernetesCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
