...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeConfigList) Resolve(context cdktf.IResolveContext) interface{} {
