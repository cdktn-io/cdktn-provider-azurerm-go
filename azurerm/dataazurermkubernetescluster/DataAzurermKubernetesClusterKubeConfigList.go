...
func (j *jsiiProxy_DataAzurermKubernetesClusterKubeConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterKubeConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterKubeConfigList {
	_init_.Initialize()

	if err := validateNewDataAzurermKubernetesClusterKubeConfigListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKubernetesClusterKubeConfigList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterKubeConfigList",
...
func NewDataAzurermKubernetesClusterKubeConfigList_Override(d DataAzurermKubernetesClusterKubeConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterKubeConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeConfigList) Resolve(context cdktn.IResolveContext) interface{} {
