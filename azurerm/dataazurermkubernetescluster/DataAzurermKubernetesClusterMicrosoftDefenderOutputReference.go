...
func (d *jsiiProxy_DataAzurermKubernetesClusterMicrosoftDefenderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterMicrosoftDefenderOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
