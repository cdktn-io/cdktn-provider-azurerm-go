...
func (j *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterLinuxProfileSshKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterLinuxProfileSshKeyList {
	_init_.Initialize()

	if err := validateNewDataAzurermKubernetesClusterLinuxProfileSshKeyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterLinuxProfileSshKeyList",
...
func NewDataAzurermKubernetesClusterLinuxProfileSshKeyList_Override(d DataAzurermKubernetesClusterLinuxProfileSshKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyList) Resolve(context cdktn.IResolveContext) interface{} {
