...
func (d *jsiiProxy_DataAzurermKubernetesClusterServicePrincipalOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterServicePrincipalOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
