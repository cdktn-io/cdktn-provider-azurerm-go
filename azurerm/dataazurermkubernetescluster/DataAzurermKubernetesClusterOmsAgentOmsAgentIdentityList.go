...
func (j *jsiiProxy_DataAzurermKubernetesClusterOmsAgentOmsAgentIdentityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterOmsAgentOmsAgentIdentityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterOmsAgentOmsAgentIdentityList {
	_init_.Initialize()
...
func NewDataAzurermKubernetesClusterOmsAgentOmsAgentIdentityList_Override(d DataAzurermKubernetesClusterOmsAgentOmsAgentIdentityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterOmsAgentOmsAgentIdentityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterOmsAgentOmsAgentIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterOmsAgentOmsAgentIdentityList) Resolve(context cdktn.IResolveContext) interface{} {
