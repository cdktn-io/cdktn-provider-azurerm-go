...
func (j *jsiiProxy_DataAzurermKubernetesClusterAgentPoolProfileUpgradeSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterAgentPoolProfileUpgradeSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterAgentPoolProfileUpgradeSettingsList {
	_init_.Initialize()

	if err := validateNewDataAzurermKubernetesClusterAgentPoolProfileUpgradeSettingsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKubernetesClusterAgentPoolProfileUpgradeSettingsList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterAgentPoolProfileUpgradeSettingsList",
...
func NewDataAzurermKubernetesClusterAgentPoolProfileUpgradeSettingsList_Override(d DataAzurermKubernetesClusterAgentPoolProfileUpgradeSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterAgentPoolProfileUpgradeSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterAgentPoolProfileUpgradeSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterAgentPoolProfileUpgradeSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
