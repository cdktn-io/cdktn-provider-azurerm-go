...
func (j *jsiiProxy_DataAzurermKubernetesClusterAciConnectorLinuxList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterAciConnectorLinuxList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterAciConnectorLinuxList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterAciConnectorLinuxList",
...
func NewDataAzurermKubernetesClusterAciConnectorLinuxList_Override(d DataAzurermKubernetesClusterAciConnectorLinuxList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterAciConnectorLinuxList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterAciConnectorLinuxList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterAciConnectorLinuxList) Resolve(context cdktn.IResolveContext) interface{} {
