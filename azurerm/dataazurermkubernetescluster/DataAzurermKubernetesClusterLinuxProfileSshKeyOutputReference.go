...
func (j *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference {
	_init_.Initialize()

	if err := validateNewDataAzurermKubernetesClusterLinuxProfileSshKeyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference",
...
func NewDataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference_Override(d DataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileSshKeyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
