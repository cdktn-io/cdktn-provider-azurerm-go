...
func (d *jsiiProxy_DataAzurermKubernetesClusterStorageProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterStorageProfileList) Resolve(context cdktf.IResolveContext) interface{} {
