...
func (j *jsiiProxy_DataAzurermKubernetesClusterStorageProfileList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterStorageProfileList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterStorageProfileList {
	_init_.Initialize()
...
func NewDataAzurermKubernetesClusterStorageProfileList_Override(d DataAzurermKubernetesClusterStorageProfileList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterStorageProfileList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterStorageProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterStorageProfileList) Resolve(context cdktn.IResolveContext) interface{} {
