...
func (d *jsiiProxy_DataAzurermKubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityList) Resolve(context cdktf.IResolveContext) interface{} {
