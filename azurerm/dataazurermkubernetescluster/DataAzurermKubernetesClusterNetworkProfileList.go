...
func (j *jsiiProxy_DataAzurermKubernetesClusterNetworkProfileList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterNetworkProfileList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterNetworkProfileList {
	_init_.Initialize()
...
func NewDataAzurermKubernetesClusterNetworkProfileList_Override(d DataAzurermKubernetesClusterNetworkProfileList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterNetworkProfileList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterNetworkProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterNetworkProfileList) Resolve(context cdktn.IResolveContext) interface{} {
