...
func (j *jsiiProxy_DataAzurermKubernetesClusterKubeletIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterKubeletIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermKubernetesClusterKubeletIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewDataAzurermKubernetesClusterKubeletIdentityOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKubernetesClusterKubeletIdentityOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterKubeletIdentityOutputReference",
...
func NewDataAzurermKubernetesClusterKubeletIdentityOutputReference_Override(d DataAzurermKubernetesClusterKubeletIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterKubeletIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeletIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeletIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeletIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeletIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
