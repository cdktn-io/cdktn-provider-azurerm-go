...
func (j *jsiiProxy_DataAzurermKubernetesClusterWindowsProfileList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterWindowsProfileList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterWindowsProfileList {
	_init_.Initialize()
...
func NewDataAzurermKubernetesClusterWindowsProfileList_Override(d DataAzurermKubernetesClusterWindowsProfileList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterWindowsProfileList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterWindowsProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterWindowsProfileList) Resolve(context cdktn.IResolveContext) interface{} {
