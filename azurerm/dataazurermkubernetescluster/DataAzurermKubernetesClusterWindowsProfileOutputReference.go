...
func (d *jsiiProxy_DataAzurermKubernetesClusterWindowsProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterWindowsProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
