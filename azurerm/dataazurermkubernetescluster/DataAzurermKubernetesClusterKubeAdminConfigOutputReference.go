...
func (j *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterKubeAdminConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermKubernetesClusterKubeAdminConfigOutputReference {
	_init_.Initialize()

	if err := validateNewDataAzurermKubernetesClusterKubeAdminConfigOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterKubeAdminConfigOutputReference",
...
func NewDataAzurermKubernetesClusterKubeAdminConfigOutputReference_Override(d DataAzurermKubernetesClusterKubeAdminConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
