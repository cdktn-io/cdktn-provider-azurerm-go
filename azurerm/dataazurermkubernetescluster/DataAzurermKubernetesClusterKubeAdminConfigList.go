...
func (j *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterKubeAdminConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterKubeAdminConfigList {
	_init_.Initialize()

	if err := validateNewDataAzurermKubernetesClusterKubeAdminConfigListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterKubeAdminConfigList",
...
func NewDataAzurermKubernetesClusterKubeAdminConfigList_Override(d DataAzurermKubernetesClusterKubeAdminConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigList) Resolve(context cdktn.IResolveContext) interface{} {
