...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKubeAdminConfigList) Resolve(context cdktf.IResolveContext) interface{} {
