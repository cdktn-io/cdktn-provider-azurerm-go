...
func (d *jsiiProxy_DataAzurermKubernetesClusterOmsAgentList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterOmsAgentList) Resolve(context cdktf.IResolveContext) interface{} {
