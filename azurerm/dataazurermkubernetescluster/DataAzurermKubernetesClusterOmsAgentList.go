...
func (j *jsiiProxy_DataAzurermKubernetesClusterOmsAgentList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterOmsAgentList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterOmsAgentList {
	_init_.Initialize()

	if err := validateNewDataAzurermKubernetesClusterOmsAgentListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKubernetesClusterOmsAgentList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterOmsAgentList",
...
func NewDataAzurermKubernetesClusterOmsAgentList_Override(d DataAzurermKubernetesClusterOmsAgentList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterOmsAgentList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterOmsAgentList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterOmsAgentList) Resolve(context cdktn.IResolveContext) interface{} {
