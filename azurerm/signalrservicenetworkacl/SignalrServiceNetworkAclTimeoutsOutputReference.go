...
func (s *jsiiProxy_SignalrServiceNetworkAclTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SignalrServiceNetworkAclTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
