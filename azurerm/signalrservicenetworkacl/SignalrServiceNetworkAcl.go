...
func (s *jsiiProxy_SignalrServiceNetworkAcl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SignalrServiceNetworkAcl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
