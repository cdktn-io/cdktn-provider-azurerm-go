...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/signalrservicenetworkacl/internal"
...
func (j *jsiiProxy_SignalrServiceNetworkAclPrivateEndpointList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSignalrServiceNetworkAclPrivateEndpointList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SignalrServiceNetworkAclPrivateEndpointList {
	_init_.Initialize()

	if err := validateNewSignalrServiceNetworkAclPrivateEndpointListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewSignalrServiceNetworkAclPrivateEndpointList_Override(s SignalrServiceNetworkAclPrivateEndpointList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SignalrServiceNetworkAclPrivateEndpointList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SignalrServiceNetworkAclPrivateEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SignalrServiceNetworkAclPrivateEndpointList) Resolve(context cdktn.IResolveContext) interface{} {
