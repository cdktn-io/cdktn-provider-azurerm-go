...
func (s *jsiiProxy_SignalrServiceNetworkAclPrivateEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SignalrServiceNetworkAclPrivateEndpointList) Resolve(context cdktf.IResolveContext) interface{} {
