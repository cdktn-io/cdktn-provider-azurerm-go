...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.natGatewayPublicIpAssociation.NatGatewayPublicIpAssociationConfig",
		reflect.TypeOf((*NatGatewayPublicIpAssociationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.natGatewayPublicIpAssociation.NatGatewayPublicIpAssociationTimeouts",
