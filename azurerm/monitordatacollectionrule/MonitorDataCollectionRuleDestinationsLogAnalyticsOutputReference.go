...
func (j *jsiiProxy_MonitorDataCollectionRuleDestinationsLogAnalyticsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorDataCollectionRuleDestinationsLogAnalyticsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorDataCollectionRuleDestinationsLogAnalyticsOutputReference {
	_init_.Initialize()
...
func NewMonitorDataCollectionRuleDestinationsLogAnalyticsOutputReference_Override(m MonitorDataCollectionRuleDestinationsLogAnalyticsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorDataCollectionRuleDestinationsLogAnalyticsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDestinationsLogAnalyticsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDestinationsLogAnalyticsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorDataCollectionRuleDestinationsLogAnalyticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDestinationsLogAnalyticsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
