...
func (j *jsiiProxy_MonitorDataCollectionRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MonitorDataCollectionRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MonitorDataCollectionRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MonitorDataCollectionRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MonitorDataCollectionRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MonitorDataCollectionRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MonitorDataCollectionRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MonitorDataCollectionRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MonitorDataCollectionRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MonitorDataCollectionRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorDataCollectionRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MonitorDataCollectionRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorDataCollectionRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitorDataCollectionRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitorDataCollectionRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
