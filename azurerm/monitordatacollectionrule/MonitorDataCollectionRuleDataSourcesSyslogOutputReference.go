...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorDataCollectionRuleDataSourcesSyslogOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorDataCollectionRuleDataSourcesSyslogOutputReference {
	_init_.Initialize()
...
func NewMonitorDataCollectionRuleDataSourcesSyslogOutputReference_Override(m MonitorDataCollectionRuleDataSourcesSyslogOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
