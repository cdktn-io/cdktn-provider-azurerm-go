...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorDataCollectionRuleDataSourcesSyslogList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorDataCollectionRuleDataSourcesSyslogList {
	_init_.Initialize()

	if err := validateNewMonitorDataCollectionRuleDataSourcesSyslogListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewMonitorDataCollectionRuleDataSourcesSyslogList_Override(m MonitorDataCollectionRuleDataSourcesSyslogList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogList) Resolve(context cdktn.IResolveContext) interface{} {
