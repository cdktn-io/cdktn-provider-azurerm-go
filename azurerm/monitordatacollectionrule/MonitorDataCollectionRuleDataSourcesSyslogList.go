...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesSyslogList) Resolve(context cdktf.IResolveContext) interface{} {
