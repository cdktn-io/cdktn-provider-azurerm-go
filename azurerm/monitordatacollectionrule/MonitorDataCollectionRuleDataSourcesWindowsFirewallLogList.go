...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesWindowsFirewallLogList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesWindowsFirewallLogList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesWindowsFirewallLogList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesWindowsFirewallLogList) Resolve(context cdktf.IResolveContext) interface{} {
