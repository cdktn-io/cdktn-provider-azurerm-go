...
func (m *jsiiProxy_MonitorDataCollectionRule) validatePutDataFlowParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*MonitorDataCollectionRuleDataFlow; received %#v (a %T)", value, value)
		}
	}
...
func (m *jsiiProxy_MonitorDataCollectionRule) validatePutStreamDeclarationParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*MonitorDataCollectionRuleStreamDeclaration; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_MonitorDataCollectionRule) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
