...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesLogFileOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorDataCollectionRuleDataSourcesLogFileOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorDataCollectionRuleDataSourcesLogFileOutputReference {
	_init_.Initialize()
...
func NewMonitorDataCollectionRuleDataSourcesLogFileOutputReference_Override(m MonitorDataCollectionRuleDataSourcesLogFileOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesLogFileOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesLogFileOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesLogFileOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesLogFileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesLogFileOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
