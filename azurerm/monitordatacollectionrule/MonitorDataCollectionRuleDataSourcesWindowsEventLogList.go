...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesWindowsEventLogList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesWindowsEventLogList) Resolve(context cdktf.IResolveContext) interface{} {
