...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesWindowsEventLogList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorDataCollectionRuleDataSourcesWindowsEventLogList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorDataCollectionRuleDataSourcesWindowsEventLogList {
	_init_.Initialize()

	if err := validateNewMonitorDataCollectionRuleDataSourcesWindowsEventLogListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewMonitorDataCollectionRuleDataSourcesWindowsEventLogList_Override(m MonitorDataCollectionRuleDataSourcesWindowsEventLogList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesWindowsEventLogList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesWindowsEventLogList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesWindowsEventLogList) Resolve(context cdktn.IResolveContext) interface{} {
