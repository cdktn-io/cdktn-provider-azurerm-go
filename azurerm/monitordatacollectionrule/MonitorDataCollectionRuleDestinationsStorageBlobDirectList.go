...
func (m *jsiiProxy_MonitorDataCollectionRuleDestinationsStorageBlobDirectList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDestinationsStorageBlobDirectList) Resolve(context cdktf.IResolveContext) interface{} {
