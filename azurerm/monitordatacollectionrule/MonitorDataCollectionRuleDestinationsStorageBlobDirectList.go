...
func (j *jsiiProxy_MonitorDataCollectionRuleDestinationsStorageBlobDirectList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorDataCollectionRuleDestinationsStorageBlobDirectList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorDataCollectionRuleDestinationsStorageBlobDirectList {
	_init_.Initialize()
...
func NewMonitorDataCollectionRuleDestinationsStorageBlobDirectList_Override(m MonitorDataCollectionRuleDestinationsStorageBlobDirectList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorDataCollectionRuleDestinationsStorageBlobDirectList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDestinationsStorageBlobDirectList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDestinationsStorageBlobDirectList) Resolve(context cdktn.IResolveContext) interface{} {
