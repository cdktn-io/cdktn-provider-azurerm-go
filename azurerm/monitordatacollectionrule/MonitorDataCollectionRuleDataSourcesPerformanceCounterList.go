...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesPerformanceCounterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorDataCollectionRuleDataSourcesPerformanceCounterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorDataCollectionRuleDataSourcesPerformanceCounterList {
	_init_.Initialize()
...
func NewMonitorDataCollectionRuleDataSourcesPerformanceCounterList_Override(m MonitorDataCollectionRuleDataSourcesPerformanceCounterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorDataCollectionRuleDataSourcesPerformanceCounterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesPerformanceCounterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesPerformanceCounterList) Resolve(context cdktn.IResolveContext) interface{} {
