...
func (m *jsiiProxy_MonitorDataCollectionRuleDestinationsLogAnalyticsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDestinationsLogAnalyticsList) Resolve(context cdktf.IResolveContext) interface{} {
