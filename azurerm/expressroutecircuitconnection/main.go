...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "addressPrefixIpv4", GoGetter: "AddressPrefixIpv4"},
			_jsii_.MemberProperty{JsiiProperty: "addressPrefixIpv4Input", GoGetter: "AddressPrefixIpv4Input"},
			_jsii_.MemberProperty{JsiiProperty: "addressPrefixIpv6", GoGetter: "AddressPrefixIpv6"},
			_jsii_.MemberProperty{JsiiProperty: "addressPrefixIpv6Input", GoGetter: "AddressPrefixIpv6Input"},
			...
			_jsii_.MemberProperty{JsiiProperty: "peerPeeringId", GoGetter: "PeerPeeringId"},
			_jsii_.MemberProperty{JsiiProperty: "peerPeeringIdInput", GoGetter: "PeerPeeringIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAddressPrefixIpv6", GoMethod: "ResetAddressPrefixIpv6"},
