...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/expressroutecircuitconnection/internal"
...
func (j *jsiiProxy_ExpressRouteCircuitConnectionTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewExpressRouteCircuitConnectionTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ExpressRouteCircuitConnectionTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewExpressRouteCircuitConnectionTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewExpressRouteCircuitConnectionTimeoutsOutputReference_Override(e ExpressRouteCircuitConnectionTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ExpressRouteCircuitConnectionTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_ExpressRouteCircuitConnectionTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ExpressRouteCircuitConnectionTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_ExpressRouteCircuitConnectionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_ExpressRouteCircuitConnectionTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
