...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermDataProtectionBackupVaultIdentityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermDataProtectionBackupVaultIdentityList {
	_init_.Initialize()

	if err := validateNewDataAzurermDataProtectionBackupVaultIdentityListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAzurermDataProtectionBackupVaultIdentityList_Override(d DataAzurermDataProtectionBackupVaultIdentityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityList) Resolve(context cdktn.IResolveContext) interface{} {
