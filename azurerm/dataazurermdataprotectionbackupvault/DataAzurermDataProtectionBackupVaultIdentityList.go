...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityList) Resolve(context cdktf.IResolveContext) interface{} {
