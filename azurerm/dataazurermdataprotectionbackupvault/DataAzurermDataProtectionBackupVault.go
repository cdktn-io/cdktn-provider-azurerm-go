...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/dataazurermdataprotectionbackupvault/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/data_protection_backup_vault azurerm_data_protection_backup_vault}.
...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVault) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVault) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVault) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVault) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVault) Tags() cdktn.StringMap {
...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVault) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/data_protection_backup_vault azurerm_data_protection_backup_vault} Data Source.
func NewDataAzurermDataProtectionBackupVault(scope constructs.Construct, id *string, config *DataAzurermDataProtectionBackupVaultConfig) DataAzurermDataProtectionBackupVault {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermDataProtectionBackupVault.DataAzurermDataProtectionBackupVault",
...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVault)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVault)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVault)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermDataProtectionBackupVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAzurermDataProtectionBackupVault_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVault) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVault) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVault) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVault) ToHclTerraform() interface{} {
	var returns interface{}
