...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermDataProtectionBackupVaultIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermDataProtectionBackupVaultIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewDataAzurermDataProtectionBackupVaultIdentityOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermDataProtectionBackupVault.DataAzurermDataProtectionBackupVaultIdentityOutputReference",
...
func NewDataAzurermDataProtectionBackupVaultIdentityOutputReference_Override(d DataAzurermDataProtectionBackupVaultIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
