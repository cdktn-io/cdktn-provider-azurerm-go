...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermDataProtectionBackupVaultIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
