...
func (j *jsiiProxy_PaloAltoLocalRulestackRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PaloAltoLocalRulestackRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PaloAltoLocalRulestackRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PaloAltoLocalRulestackRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PaloAltoLocalRulestackRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/palo_alto_local_rulestack_rule azurerm_palo_alto_local_rulestack_rule} Resource.
...
func (j *jsiiProxy_PaloAltoLocalRulestackRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PaloAltoLocalRulestackRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PaloAltoLocalRulestackRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PaloAltoLocalRulestackRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PaloAltoLocalRulestackRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PaloAltoLocalRulestackRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PaloAltoLocalRulestackRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PaloAltoLocalRulestackRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PaloAltoLocalRulestackRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PaloAltoLocalRulestackRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
