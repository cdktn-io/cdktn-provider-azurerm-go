...
func (p *jsiiProxy_PaloAltoLocalRulestackRuleSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PaloAltoLocalRulestackRuleSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
