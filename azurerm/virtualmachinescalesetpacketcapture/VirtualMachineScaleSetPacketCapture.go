...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/virtual_machine_scale_set_packet_capture azurerm_virtual_machine_scale_set_packet_capture} Resource.
...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCapture) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCapture) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCapture) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCapture) MoveFromId(id *string) {
...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCapture) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCapture) MoveToId(id *string) {
...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCapture) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCapture) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCapture) ToHclTerraform() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCapture) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
