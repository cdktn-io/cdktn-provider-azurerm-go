...
func (m *jsiiProxy_MssqlManagedInstanceSecurityAlertPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MssqlManagedInstanceSecurityAlertPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
