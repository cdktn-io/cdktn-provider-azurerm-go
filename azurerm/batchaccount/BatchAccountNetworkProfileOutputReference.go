...
func (b *jsiiProxy_BatchAccountNetworkProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchAccountNetworkProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
