...
func (b *jsiiProxy_BatchAccountNetworkProfileNodeManagementAccessOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchAccountNetworkProfileNodeManagementAccessOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
