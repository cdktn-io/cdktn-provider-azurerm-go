...
func (d *jsiiProxy_DataAzurermApiManagementHostnameConfigurationDeveloperPortalList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermApiManagementHostnameConfigurationDeveloperPortalList) Resolve(context cdktf.IResolveContext) interface{} {
