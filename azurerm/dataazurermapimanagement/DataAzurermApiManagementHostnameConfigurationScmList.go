...
func (d *jsiiProxy_DataAzurermApiManagementHostnameConfigurationScmList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermApiManagementHostnameConfigurationScmList) Resolve(context cdktf.IResolveContext) interface{} {
