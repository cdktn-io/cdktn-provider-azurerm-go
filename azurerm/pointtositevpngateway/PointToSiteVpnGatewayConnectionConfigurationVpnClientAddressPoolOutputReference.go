...
func (j *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationVpnClientAddressPoolOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPointToSiteVpnGatewayConnectionConfigurationVpnClientAddressPoolOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PointToSiteVpnGatewayConnectionConfigurationVpnClientAddressPoolOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.pointToSiteVpnGateway.PointToSiteVpnGatewayConnectionConfigurationVpnClientAddressPoolOutputReference",
...
func NewPointToSiteVpnGatewayConnectionConfigurationVpnClientAddressPoolOutputReference_Override(p PointToSiteVpnGatewayConnectionConfigurationVpnClientAddressPoolOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationVpnClientAddressPoolOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationVpnClientAddressPoolOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationVpnClientAddressPoolOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationVpnClientAddressPoolOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationVpnClientAddressPoolOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
