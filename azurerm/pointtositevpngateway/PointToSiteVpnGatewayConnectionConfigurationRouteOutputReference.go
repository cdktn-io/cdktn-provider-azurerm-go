...
func (j *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationRouteOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPointToSiteVpnGatewayConnectionConfigurationRouteOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PointToSiteVpnGatewayConnectionConfigurationRouteOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.pointToSiteVpnGateway.PointToSiteVpnGatewayConnectionConfigurationRouteOutputReference",
...
func NewPointToSiteVpnGatewayConnectionConfigurationRouteOutputReference_Override(p PointToSiteVpnGatewayConnectionConfigurationRouteOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationRouteOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationRouteOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationRouteOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationRouteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationRouteOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
