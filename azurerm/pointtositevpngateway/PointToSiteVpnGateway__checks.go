...
func (p *jsiiProxy_PointToSiteVpnGateway) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (p *jsiiProxy_PointToSiteVpnGateway) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (p *jsiiProxy_PointToSiteVpnGateway) validatePutConnectionConfigurationParameters(value interface{}) error {
	...
	case *[]*PointToSiteVpnGatewayConnectionConfiguration:
		value := value.(*[]*PointToSiteVpnGatewayConnectionConfiguration)
	...
	case []*PointToSiteVpnGatewayConnectionConfiguration:
		value_ := value.([]*PointToSiteVpnGatewayConnectionConfiguration)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*PointToSiteVpnGatewayConnectionConfiguration; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_PointToSiteVpnGateway) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
