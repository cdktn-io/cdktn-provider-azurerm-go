...
func (p *jsiiProxy_PointToSiteVpnGatewayTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PointToSiteVpnGatewayTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
