...
func (j *jsiiProxy_PointToSiteVpnGatewayTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPointToSiteVpnGatewayTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PointToSiteVpnGatewayTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewPointToSiteVpnGatewayTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_PointToSiteVpnGatewayTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.pointToSiteVpnGateway.PointToSiteVpnGatewayTimeoutsOutputReference",
...
func NewPointToSiteVpnGatewayTimeoutsOutputReference_Override(p PointToSiteVpnGatewayTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PointToSiteVpnGatewayTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PointToSiteVpnGatewayTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PointToSiteVpnGatewayTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PointToSiteVpnGatewayTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PointToSiteVpnGatewayTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
