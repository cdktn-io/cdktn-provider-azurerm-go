...
func (j *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPointToSiteVpnGatewayConnectionConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PointToSiteVpnGatewayConnectionConfigurationOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.pointToSiteVpnGateway.PointToSiteVpnGatewayConnectionConfigurationOutputReference",
...
func NewPointToSiteVpnGatewayConnectionConfigurationOutputReference_Override(p PointToSiteVpnGatewayConnectionConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PointToSiteVpnGatewayConnectionConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
