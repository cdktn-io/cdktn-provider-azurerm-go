...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bool", GoGetter: "Bool"},
			...
			_jsii_.MemberProperty{JsiiProperty: "null", GoGetter: "Null"},
			...
			_jsii_.MemberProperty{JsiiProperty: "string", GoGetter: "String"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermAutomationVariablesEncryptedList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermAutomationVariablesObjectList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermAutomationVariablesObjectOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
