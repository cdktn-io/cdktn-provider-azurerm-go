...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/mssqlmanagedinstancetransparentdataencryption/internal"
...
func (j *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) ManagedHsmKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"managedHsmKeyId",
...
func (j *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) ManagedHsmKeyIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption)SetManagedHsmKeyId(val *string) {
...
func (j *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MssqlManagedInstanceTransparentDataEncryption_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) ResetManagedHsmKeyId() {
	_jsii_.InvokeVoid(
		m,
		"resetManagedHsmKeyId",
		nil, // no parameters
...
func (m *jsiiProxy_MssqlManagedInstanceTransparentDataEncryption) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
