...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/data_factory_linked_service_azure_blob_storage azurerm_data_factory_linked_service_azure_blob_storage} Resource.
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureBlobStorage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureBlobStorage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureBlobStorage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
