...
func (d *jsiiProxy_DataAzurermDatabricksWorkspaceCustomParametersList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAzurermDatabricksWorkspaceCustomParametersList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermDatabricksWorkspaceCustomParametersList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermDatabricksWorkspaceCustomParametersList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
