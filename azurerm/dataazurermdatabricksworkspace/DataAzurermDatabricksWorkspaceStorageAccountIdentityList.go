...
func (j *jsiiProxy_DataAzurermDatabricksWorkspaceStorageAccountIdentityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermDatabricksWorkspaceStorageAccountIdentityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermDatabricksWorkspaceStorageAccountIdentityList {
	_init_.Initialize()
...
func NewDataAzurermDatabricksWorkspaceStorageAccountIdentityList_Override(d DataAzurermDatabricksWorkspaceStorageAccountIdentityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermDatabricksWorkspaceStorageAccountIdentityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermDatabricksWorkspaceStorageAccountIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermDatabricksWorkspaceStorageAccountIdentityList) Resolve(context cdktn.IResolveContext) interface{} {
