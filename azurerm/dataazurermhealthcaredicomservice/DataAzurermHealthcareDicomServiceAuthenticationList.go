...
func (j *jsiiProxy_DataAzurermHealthcareDicomServiceAuthenticationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermHealthcareDicomServiceAuthenticationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermHealthcareDicomServiceAuthenticationList {
	_init_.Initialize()
...
func NewDataAzurermHealthcareDicomServiceAuthenticationList_Override(d DataAzurermHealthcareDicomServiceAuthenticationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermHealthcareDicomServiceAuthenticationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermHealthcareDicomServiceAuthenticationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermHealthcareDicomServiceAuthenticationList) Resolve(context cdktn.IResolveContext) interface{} {
