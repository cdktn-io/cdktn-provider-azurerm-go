...
func (d *jsiiProxy_DataAzurermHealthcareDicomServiceAuthenticationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermHealthcareDicomServiceAuthenticationList) Resolve(context cdktf.IResolveContext) interface{} {
