...
func (p *jsiiProxy_PrivateDnsResolverInboundEndpointIpConfigurationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivateDnsResolverInboundEndpointIpConfigurationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
