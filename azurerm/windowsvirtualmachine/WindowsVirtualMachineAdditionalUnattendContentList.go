...
func (w *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentList) Resolve(context cdktf.IResolveContext) interface{} {
