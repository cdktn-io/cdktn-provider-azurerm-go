...
func (j *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineAdditionalUnattendContentList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsVirtualMachineAdditionalUnattendContentList {
	_init_.Initialize()
...
func NewWindowsVirtualMachineAdditionalUnattendContentList_Override(w WindowsVirtualMachineAdditionalUnattendContentList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentList) Resolve(context cdktn.IResolveContext) interface{} {
