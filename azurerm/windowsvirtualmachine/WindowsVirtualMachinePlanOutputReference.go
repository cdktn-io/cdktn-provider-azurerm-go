...
func (w *jsiiProxy_WindowsVirtualMachinePlanOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachinePlanOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
