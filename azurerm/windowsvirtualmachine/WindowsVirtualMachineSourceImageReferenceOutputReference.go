...
func (w *jsiiProxy_WindowsVirtualMachineSourceImageReferenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineSourceImageReferenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
