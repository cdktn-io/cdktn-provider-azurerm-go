...
func (j *jsiiProxy_WindowsVirtualMachineSourceImageReferenceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineSourceImageReferenceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsVirtualMachineSourceImageReferenceOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsVirtualMachineSourceImageReferenceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWindowsVirtualMachineSourceImageReferenceOutputReference_Override(w WindowsVirtualMachineSourceImageReferenceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineSourceImageReferenceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineSourceImageReferenceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineSourceImageReferenceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsVirtualMachineSourceImageReferenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineSourceImageReferenceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
