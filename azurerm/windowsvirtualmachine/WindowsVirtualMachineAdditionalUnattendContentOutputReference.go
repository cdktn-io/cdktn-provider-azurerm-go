...
func (j *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineAdditionalUnattendContentOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsVirtualMachineAdditionalUnattendContentOutputReference {
	_init_.Initialize()
...
func NewWindowsVirtualMachineAdditionalUnattendContentOutputReference_Override(w WindowsVirtualMachineAdditionalUnattendContentOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineAdditionalUnattendContentOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
