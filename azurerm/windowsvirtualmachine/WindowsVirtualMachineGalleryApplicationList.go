...
func (w *jsiiProxy_WindowsVirtualMachineGalleryApplicationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineGalleryApplicationList) Resolve(context cdktf.IResolveContext) interface{} {
