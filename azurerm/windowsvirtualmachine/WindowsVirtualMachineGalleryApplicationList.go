...
func (j *jsiiProxy_WindowsVirtualMachineGalleryApplicationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineGalleryApplicationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsVirtualMachineGalleryApplicationList {
	_init_.Initialize()

	if err := validateNewWindowsVirtualMachineGalleryApplicationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewWindowsVirtualMachineGalleryApplicationList_Override(w WindowsVirtualMachineGalleryApplicationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineGalleryApplicationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineGalleryApplicationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineGalleryApplicationList) Resolve(context cdktn.IResolveContext) interface{} {
