...
func (w *jsiiProxy_WindowsVirtualMachineIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
