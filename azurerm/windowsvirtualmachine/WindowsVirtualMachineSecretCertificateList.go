...
func (j *jsiiProxy_WindowsVirtualMachineSecretCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineSecretCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsVirtualMachineSecretCertificateList {
	_init_.Initialize()
...
func NewWindowsVirtualMachineSecretCertificateList_Override(w WindowsVirtualMachineSecretCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineSecretCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineSecretCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineSecretCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
