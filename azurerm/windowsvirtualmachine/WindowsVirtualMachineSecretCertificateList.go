...
func (w *jsiiProxy_WindowsVirtualMachineSecretCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineSecretCertificateList) Resolve(context cdktf.IResolveContext) interface{} {
