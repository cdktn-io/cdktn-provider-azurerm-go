...
func (w *jsiiProxy_WindowsVirtualMachineWinrmListenerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineWinrmListenerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
