...
func (w *jsiiProxy_WindowsVirtualMachineSecretCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineSecretCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
