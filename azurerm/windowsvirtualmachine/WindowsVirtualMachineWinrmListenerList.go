...
func (j *jsiiProxy_WindowsVirtualMachineWinrmListenerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineWinrmListenerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsVirtualMachineWinrmListenerList {
	_init_.Initialize()
...
func NewWindowsVirtualMachineWinrmListenerList_Override(w WindowsVirtualMachineWinrmListenerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineWinrmListenerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineWinrmListenerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineWinrmListenerList) Resolve(context cdktn.IResolveContext) interface{} {
