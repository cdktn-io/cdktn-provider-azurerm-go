...
func (j *jsiiProxy_WindowsVirtualMachineSecretList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineSecretList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsVirtualMachineSecretList {
	_init_.Initialize()
...
func NewWindowsVirtualMachineSecretList_Override(w WindowsVirtualMachineSecretList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineSecretList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineSecretList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineSecretList) Resolve(context cdktn.IResolveContext) interface{} {
