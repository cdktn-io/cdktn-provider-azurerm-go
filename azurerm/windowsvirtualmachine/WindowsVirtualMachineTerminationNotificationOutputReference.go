...
func (w *jsiiProxy_WindowsVirtualMachineTerminationNotificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineTerminationNotificationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
