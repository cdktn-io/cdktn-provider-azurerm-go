...
func (j *jsiiProxy_WindowsVirtualMachineTerminationNotificationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineTerminationNotificationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsVirtualMachineTerminationNotificationOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsVirtualMachineTerminationNotificationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWindowsVirtualMachineTerminationNotificationOutputReference_Override(w WindowsVirtualMachineTerminationNotificationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineTerminationNotificationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineTerminationNotificationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineTerminationNotificationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsVirtualMachineTerminationNotificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineTerminationNotificationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
