...
func (j *jsiiProxy_DevTestVirtualNetworkSubnetSharedPublicIpAddressAllowedPortsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDevTestVirtualNetworkSubnetSharedPublicIpAddressAllowedPortsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DevTestVirtualNetworkSubnetSharedPublicIpAddressAllowedPortsList {
	_init_.Initialize()
...
func NewDevTestVirtualNetworkSubnetSharedPublicIpAddressAllowedPortsList_Override(d DevTestVirtualNetworkSubnetSharedPublicIpAddressAllowedPortsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DevTestVirtualNetworkSubnetSharedPublicIpAddressAllowedPortsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DevTestVirtualNetworkSubnetSharedPublicIpAddressAllowedPortsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DevTestVirtualNetworkSubnetSharedPublicIpAddressAllowedPortsList) Resolve(context cdktn.IResolveContext) interface{} {
