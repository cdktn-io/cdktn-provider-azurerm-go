...
func (d *jsiiProxy_DevTestVirtualNetworkSubnetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DevTestVirtualNetworkSubnetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
