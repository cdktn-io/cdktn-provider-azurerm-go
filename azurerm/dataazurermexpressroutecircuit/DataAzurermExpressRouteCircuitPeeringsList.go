...
func (d *jsiiProxy_DataAzurermExpressRouteCircuitPeeringsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermExpressRouteCircuitPeeringsList) Resolve(context cdktf.IResolveContext) interface{} {
