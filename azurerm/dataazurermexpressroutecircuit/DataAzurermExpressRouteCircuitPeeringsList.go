...
func (j *jsiiProxy_DataAzurermExpressRouteCircuitPeeringsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermExpressRouteCircuitPeeringsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermExpressRouteCircuitPeeringsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermExpressRouteCircuit.DataAzurermExpressRouteCircuitPeeringsList",
...
func NewDataAzurermExpressRouteCircuitPeeringsList_Override(d DataAzurermExpressRouteCircuitPeeringsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermExpressRouteCircuitPeeringsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermExpressRouteCircuitPeeringsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermExpressRouteCircuitPeeringsList) Resolve(context cdktn.IResolveContext) interface{} {
