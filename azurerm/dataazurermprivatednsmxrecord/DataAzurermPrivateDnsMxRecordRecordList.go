...
func (d *jsiiProxy_DataAzurermPrivateDnsMxRecordRecordList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermPrivateDnsMxRecordRecordList) Resolve(context cdktf.IResolveContext) interface{} {
