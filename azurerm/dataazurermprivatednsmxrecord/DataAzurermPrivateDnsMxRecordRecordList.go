...
func (j *jsiiProxy_DataAzurermPrivateDnsMxRecordRecordList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermPrivateDnsMxRecordRecordList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermPrivateDnsMxRecordRecordList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermPrivateDnsMxRecord.DataAzurermPrivateDnsMxRecordRecordList",
...
func NewDataAzurermPrivateDnsMxRecordRecordList_Override(d DataAzurermPrivateDnsMxRecordRecordList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermPrivateDnsMxRecordRecordList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermPrivateDnsMxRecordRecordList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermPrivateDnsMxRecordRecordList) Resolve(context cdktn.IResolveContext) interface{} {
