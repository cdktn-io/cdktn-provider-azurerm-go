...
func (j *jsiiProxy_DataFactoryDatasetAzureBlob) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataFactoryDatasetAzureBlob) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataFactoryDatasetAzureBlob) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataFactoryDatasetAzureBlob) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataFactoryDatasetAzureBlob) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/data_factory_dataset_azure_blob azurerm_data_factory_dataset_azure_blob} Resource.
...
func (j *jsiiProxy_DataFactoryDatasetAzureBlob)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataFactoryDatasetAzureBlob)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataFactoryDatasetAzureBlob)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataFactoryDatasetAzureBlob_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataFactoryDatasetAzureBlob) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetAzureBlob) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DataFactoryDatasetAzureBlob) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetAzureBlob) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryDatasetAzureBlob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataFactoryDatasetAzureBlob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
