...
func (j *jsiiProxy_ManagementGroupPolicyAssignmentNonComplianceMessageOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewManagementGroupPolicyAssignmentNonComplianceMessageOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ManagementGroupPolicyAssignmentNonComplianceMessageOutputReference {
	_init_.Initialize()
...
func NewManagementGroupPolicyAssignmentNonComplianceMessageOutputReference_Override(m ManagementGroupPolicyAssignmentNonComplianceMessageOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ManagementGroupPolicyAssignmentNonComplianceMessageOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_ManagementGroupPolicyAssignmentNonComplianceMessageOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagementGroupPolicyAssignmentNonComplianceMessageOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_ManagementGroupPolicyAssignmentNonComplianceMessageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagementGroupPolicyAssignmentNonComplianceMessageOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
