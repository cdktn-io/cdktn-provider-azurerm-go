...
func (j *jsiiProxy_ManagementGroupPolicyAssignmentNonComplianceMessageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewManagementGroupPolicyAssignmentNonComplianceMessageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ManagementGroupPolicyAssignmentNonComplianceMessageList {
	_init_.Initialize()
...
func NewManagementGroupPolicyAssignmentNonComplianceMessageList_Override(m ManagementGroupPolicyAssignmentNonComplianceMessageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ManagementGroupPolicyAssignmentNonComplianceMessageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_ManagementGroupPolicyAssignmentNonComplianceMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_ManagementGroupPolicyAssignmentNonComplianceMessageList) Resolve(context cdktn.IResolveContext) interface{} {
