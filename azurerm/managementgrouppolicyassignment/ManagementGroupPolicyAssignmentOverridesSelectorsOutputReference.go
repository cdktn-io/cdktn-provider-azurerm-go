...
func (m *jsiiProxy_ManagementGroupPolicyAssignmentOverridesSelectorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagementGroupPolicyAssignmentOverridesSelectorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
