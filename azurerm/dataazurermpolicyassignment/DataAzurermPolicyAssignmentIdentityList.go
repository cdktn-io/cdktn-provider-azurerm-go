...
func (j *jsiiProxy_DataAzurermPolicyAssignmentIdentityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermPolicyAssignmentIdentityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermPolicyAssignmentIdentityList {
	_init_.Initialize()
...
func NewDataAzurermPolicyAssignmentIdentityList_Override(d DataAzurermPolicyAssignmentIdentityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermPolicyAssignmentIdentityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermPolicyAssignmentIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermPolicyAssignmentIdentityList) Resolve(context cdktn.IResolveContext) interface{} {
