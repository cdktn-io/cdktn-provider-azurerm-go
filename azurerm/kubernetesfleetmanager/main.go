...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hubProfile", GoGetter: "HubProfile"},
			_jsii_.MemberProperty{JsiiProperty: "hubProfileInput", GoGetter: "HubProfileInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putHubProfile", GoMethod: "PutHubProfile"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetHubProfile", GoMethod: "ResetHubProfile"},
