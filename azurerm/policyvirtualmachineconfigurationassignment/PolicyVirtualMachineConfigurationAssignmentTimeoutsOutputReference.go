...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/policyvirtualmachineconfigurationassignment/internal"
...
func (j *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewPolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewPolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference_Override(p PolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
