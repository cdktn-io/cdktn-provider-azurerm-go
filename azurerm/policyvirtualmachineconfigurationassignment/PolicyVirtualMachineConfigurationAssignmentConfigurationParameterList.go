...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentConfigurationParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentConfigurationParameterList) Resolve(context cdktf.IResolveContext) interface{} {
