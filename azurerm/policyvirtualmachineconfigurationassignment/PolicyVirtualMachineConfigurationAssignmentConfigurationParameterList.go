...
func (j *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentConfigurationParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPolicyVirtualMachineConfigurationAssignmentConfigurationParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PolicyVirtualMachineConfigurationAssignmentConfigurationParameterList {
	_init_.Initialize()

	if err := validateNewPolicyVirtualMachineConfigurationAssignmentConfigurationParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewPolicyVirtualMachineConfigurationAssignmentConfigurationParameterList_Override(p PolicyVirtualMachineConfigurationAssignmentConfigurationParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentConfigurationParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentConfigurationParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentConfigurationParameterList) Resolve(context cdktn.IResolveContext) interface{} {
