...
func (j *jsiiProxy_MssqlManagedInstance) DnsZone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dnsZone",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/mssql_managed_instance azurerm_mssql_managed_instance} Resource.
...
func (m *jsiiProxy_MssqlManagedInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MssqlManagedInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MssqlManagedInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
