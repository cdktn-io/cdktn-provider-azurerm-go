...
func (m *jsiiProxy_MssqlManagedInstanceIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MssqlManagedInstanceIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
