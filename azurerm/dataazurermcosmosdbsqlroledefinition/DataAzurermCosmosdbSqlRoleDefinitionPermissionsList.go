...
func (j *jsiiProxy_DataAzurermCosmosdbSqlRoleDefinitionPermissionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermCosmosdbSqlRoleDefinitionPermissionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermCosmosdbSqlRoleDefinitionPermissionsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermCosmosdbSqlRoleDefinition.DataAzurermCosmosdbSqlRoleDefinitionPermissionsList",
...
func NewDataAzurermCosmosdbSqlRoleDefinitionPermissionsList_Override(d DataAzurermCosmosdbSqlRoleDefinitionPermissionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermCosmosdbSqlRoleDefinitionPermissionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermCosmosdbSqlRoleDefinitionPermissionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermCosmosdbSqlRoleDefinitionPermissionsList) Resolve(context cdktn.IResolveContext) interface{} {
