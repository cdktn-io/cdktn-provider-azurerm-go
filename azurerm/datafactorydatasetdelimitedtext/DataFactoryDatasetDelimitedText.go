...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/data_factory_dataset_delimited_text azurerm_data_factory_dataset_delimited_text} Resource.
...
func (d *jsiiProxy_DataFactoryDatasetDelimitedText) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryDatasetDelimitedText) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataFactoryDatasetDelimitedText) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
