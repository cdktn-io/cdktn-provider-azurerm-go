...
func (j *jsiiProxy_DataFactoryDatasetDelimitedTextSchemaColumnList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryDatasetDelimitedTextSchemaColumnList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryDatasetDelimitedTextSchemaColumnList {
	_init_.Initialize()

	if err := validateNewDataFactoryDatasetDelimitedTextSchemaColumnListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryDatasetDelimitedTextSchemaColumnList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryDatasetDelimitedText.DataFactoryDatasetDelimitedTextSchemaColumnList",
...
func NewDataFactoryDatasetDelimitedTextSchemaColumnList_Override(d DataFactoryDatasetDelimitedTextSchemaColumnList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryDatasetDelimitedTextSchemaColumnList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryDatasetDelimitedTextSchemaColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryDatasetDelimitedTextSchemaColumnList) Resolve(context cdktn.IResolveContext) interface{} {
