...
func (d *jsiiProxy_DataFactoryDatasetDelimitedTextSchemaColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryDatasetDelimitedTextSchemaColumnList) Resolve(context cdktf.IResolveContext) interface{} {
