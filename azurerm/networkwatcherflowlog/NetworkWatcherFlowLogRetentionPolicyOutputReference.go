...
func (n *jsiiProxy_NetworkWatcherFlowLogRetentionPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkWatcherFlowLogRetentionPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
