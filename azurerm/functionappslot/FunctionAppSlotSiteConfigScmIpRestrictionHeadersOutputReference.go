...
func (j *jsiiProxy_FunctionAppSlotSiteConfigScmIpRestrictionHeadersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppSlotSiteConfigScmIpRestrictionHeadersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FunctionAppSlotSiteConfigScmIpRestrictionHeadersOutputReference {
	_init_.Initialize()
...
func NewFunctionAppSlotSiteConfigScmIpRestrictionHeadersOutputReference_Override(f FunctionAppSlotSiteConfigScmIpRestrictionHeadersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppSlotSiteConfigScmIpRestrictionHeadersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppSlotSiteConfigScmIpRestrictionHeadersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppSlotSiteConfigScmIpRestrictionHeadersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FunctionAppSlotSiteConfigScmIpRestrictionHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppSlotSiteConfigScmIpRestrictionHeadersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
