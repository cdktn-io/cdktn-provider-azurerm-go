...
func (j *jsiiProxy_FunctionAppSlotSiteConfigScmIpRestrictionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppSlotSiteConfigScmIpRestrictionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FunctionAppSlotSiteConfigScmIpRestrictionList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.functionAppSlot.FunctionAppSlotSiteConfigScmIpRestrictionList",
...
func NewFunctionAppSlotSiteConfigScmIpRestrictionList_Override(f FunctionAppSlotSiteConfigScmIpRestrictionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppSlotSiteConfigScmIpRestrictionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppSlotSiteConfigScmIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FunctionAppSlotSiteConfigScmIpRestrictionList) Resolve(context cdktn.IResolveContext) interface{} {
