...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyIssuerParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyIssuerParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKeyVaultCertificateCertificatePolicyIssuerParametersList {
	_init_.Initialize()
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyIssuerParametersList_Override(d DataAzurermKeyVaultCertificateCertificatePolicyIssuerParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyIssuerParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyIssuerParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyIssuerParametersList) Resolve(context cdktn.IResolveContext) interface{} {
