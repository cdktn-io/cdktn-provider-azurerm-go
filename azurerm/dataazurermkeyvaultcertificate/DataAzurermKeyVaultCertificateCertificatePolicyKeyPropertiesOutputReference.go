...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference) Exportable() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference) ReuseKey() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"reuseKey",
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference {
	_init_.Initialize()

	if err := validateNewDataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKeyVaultCertificate.DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference",
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference_Override(d DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
