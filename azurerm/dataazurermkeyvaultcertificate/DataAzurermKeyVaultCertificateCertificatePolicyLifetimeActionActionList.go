...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionActionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionActionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionActionList {
	_init_.Initialize()

	if err := validateNewDataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionActionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionActionList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermKeyVaultCertificate.DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionActionList",
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionActionList_Override(d DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionActionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionActionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionActionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionActionList) Resolve(context cdktn.IResolveContext) interface{} {
