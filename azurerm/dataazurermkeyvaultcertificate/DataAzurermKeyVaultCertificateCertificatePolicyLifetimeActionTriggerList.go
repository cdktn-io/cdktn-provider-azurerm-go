...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList {
	_init_.Initialize()
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList_Override(d DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionTriggerList) Resolve(context cdktn.IResolveContext) interface{} {
