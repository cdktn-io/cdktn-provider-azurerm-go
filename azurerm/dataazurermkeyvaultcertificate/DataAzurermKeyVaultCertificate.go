...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/dataazurermkeyvaultcertificate/internal"
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificate) Count() interface{} {
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificate) Tags() cdktn.StringMap {
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/key_vault_certificate azurerm_key_vault_certificate} Data Source.
func NewDataAzurermKeyVaultCertificate(scope constructs.Construct, id *string, config *DataAzurermKeyVaultCertificateConfig) DataAzurermKeyVaultCertificate {
	...
	if err := validateNewDataAzurermKeyVaultCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificate)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermKeyVaultCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAzurermKeyVaultCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAzurermKeyVaultCertificate_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAzurermKeyVaultCertificate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermKeyVaultCertificate_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermKeyVaultCertificate_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermKeyVaultCertificate_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermKeyVaultCertificate_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificate) ToHclTerraform() interface{} {
	var returns interface{}
