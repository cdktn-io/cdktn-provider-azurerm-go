...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesList {
	_init_.Initialize()
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesList_Override(d DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyKeyPropertiesList) Resolve(context cdktn.IResolveContext) interface{} {
