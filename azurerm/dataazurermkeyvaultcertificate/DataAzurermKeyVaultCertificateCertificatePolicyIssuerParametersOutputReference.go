...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyIssuerParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyIssuerParametersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
