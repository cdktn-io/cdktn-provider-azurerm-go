...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList {
	_init_.Initialize()
...
func NewDataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList_Override(d DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicyLifetimeActionList) Resolve(context cdktn.IResolveContext) interface{} {
