...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/logicappintegrationaccountbatchconfiguration/internal"
...
func (j *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewLogicAppIntegrationAccountBatchConfiguration(scope constructs.Construct, id *string, config *LogicAppIntegrationAccountBatchConfigurationConfig) LogicAppIntegrationAccountBatchConfiguration {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.logicAppIntegrationAccountBatchConfiguration.LogicAppIntegrationAccountBatchConfiguration",
...
func (j *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LogicAppIntegrationAccountBatchConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateLogicAppIntegrationAccountBatchConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) MoveFromId(id *string) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) MoveToId(id *string) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) ToHclTerraform() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
