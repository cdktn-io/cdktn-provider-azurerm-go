...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/logicappintegrationaccountbatchconfiguration/internal"
...
func LogicAppIntegrationAccountBatchConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LogicAppIntegrationAccountBatchConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
