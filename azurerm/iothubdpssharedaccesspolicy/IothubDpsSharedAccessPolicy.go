...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/iothubdpssharedaccesspolicy/internal"
...
func (i *jsiiProxy_IothubDpsSharedAccessPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IothubDpsSharedAccessPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IothubDpsSharedAccessPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
