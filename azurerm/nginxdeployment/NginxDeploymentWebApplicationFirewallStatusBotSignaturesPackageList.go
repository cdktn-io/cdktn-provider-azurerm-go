...
func (j *jsiiProxy_NginxDeploymentWebApplicationFirewallStatusBotSignaturesPackageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNginxDeploymentWebApplicationFirewallStatusBotSignaturesPackageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NginxDeploymentWebApplicationFirewallStatusBotSignaturesPackageList {
	_init_.Initialize()
...
func NewNginxDeploymentWebApplicationFirewallStatusBotSignaturesPackageList_Override(n NginxDeploymentWebApplicationFirewallStatusBotSignaturesPackageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NginxDeploymentWebApplicationFirewallStatusBotSignaturesPackageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NginxDeploymentWebApplicationFirewallStatusBotSignaturesPackageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NginxDeploymentWebApplicationFirewallStatusBotSignaturesPackageList) Resolve(context cdktn.IResolveContext) interface{} {
