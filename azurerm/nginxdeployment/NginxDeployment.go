...
func (n *jsiiProxy_NginxDeployment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NginxDeployment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NginxDeployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
