...
func (n *jsiiProxy_NginxDeployment) validatePutFrontendPrivateParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*NginxDeploymentFrontendPrivate; received %#v (a %T)", value, value)
		}
	}
...
func (n *jsiiProxy_NginxDeployment) validatePutLoggingStorageAccountParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*NginxDeploymentLoggingStorageAccount; received %#v (a %T)", value, value)
		}
	}
...
func (n *jsiiProxy_NginxDeployment) validatePutNetworkInterfaceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*NginxDeploymentNetworkInterface; received %#v (a %T)", value, value)
		}
	}
