...
func (n *jsiiProxy_NginxDeployment) validatePutAutoScaleProfileParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NginxDeploymentAutoScaleProfile; received %#v (a %T)", value, value)
		}
	}
...
func (n *jsiiProxy_NginxDeployment) validatePutFrontendPrivateParameters(value interface{}) error {
	...
	case *[]*NginxDeploymentFrontendPrivate:
		value := value.(*[]*NginxDeploymentFrontendPrivate)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*NginxDeploymentFrontendPrivate:
		value_ := value.([]*NginxDeploymentFrontendPrivate)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NginxDeploymentFrontendPrivate; received %#v (a %T)", value, value)
		}
	}
...
func (n *jsiiProxy_NginxDeployment) validatePutNetworkInterfaceParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*NginxDeploymentNetworkInterface:
		value := value.(*[]*NginxDeploymentNetworkInterface)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*NginxDeploymentNetworkInterface:
		value_ := value.([]*NginxDeploymentNetworkInterface)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NginxDeploymentNetworkInterface; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_NginxDeployment) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
