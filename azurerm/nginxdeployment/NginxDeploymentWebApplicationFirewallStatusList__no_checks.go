...
func (n *jsiiProxy_NginxDeploymentWebApplicationFirewallStatusList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_NginxDeploymentWebApplicationFirewallStatusList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewNginxDeploymentWebApplicationFirewallStatusListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
