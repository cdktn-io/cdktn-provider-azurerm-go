...
func (j *jsiiProxy_LinuxVirtualMachineScaleSet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LinuxVirtualMachineScaleSet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LinuxVirtualMachineScaleSet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LinuxVirtualMachineScaleSet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LinuxVirtualMachineScaleSet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/linux_virtual_machine_scale_set azurerm_linux_virtual_machine_scale_set} Resource.
...
func (j *jsiiProxy_LinuxVirtualMachineScaleSet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LinuxVirtualMachineScaleSet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LinuxVirtualMachineScaleSet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LinuxVirtualMachineScaleSet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
