...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetExtensionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetExtensionList) Resolve(context cdktf.IResolveContext) interface{} {
