...
func (j *jsiiProxy_LinuxVirtualMachineScaleSetTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxVirtualMachineScaleSetTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LinuxVirtualMachineScaleSetTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxVirtualMachineScaleSetTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxVirtualMachineScaleSetTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetTimeoutsOutputReference",
...
func NewLinuxVirtualMachineScaleSetTimeoutsOutputReference_Override(l LinuxVirtualMachineScaleSetTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxVirtualMachineScaleSetTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
