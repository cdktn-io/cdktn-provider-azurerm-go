...
func (j *jsiiProxy_LinuxVirtualMachineScaleSetNetworkInterfaceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxVirtualMachineScaleSetNetworkInterfaceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxVirtualMachineScaleSetNetworkInterfaceList {
	_init_.Initialize()

	if err := validateNewLinuxVirtualMachineScaleSetNetworkInterfaceListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxVirtualMachineScaleSetNetworkInterfaceList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetNetworkInterfaceList",
...
func NewLinuxVirtualMachineScaleSetNetworkInterfaceList_Override(l LinuxVirtualMachineScaleSetNetworkInterfaceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxVirtualMachineScaleSetNetworkInterfaceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetNetworkInterfaceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetNetworkInterfaceList) Resolve(context cdktn.IResolveContext) interface{} {
