...
func (j *jsiiProxy_LinuxVirtualMachineScaleSetDataDiskList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxVirtualMachineScaleSetDataDiskList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxVirtualMachineScaleSetDataDiskList {
	_init_.Initialize()
...
func NewLinuxVirtualMachineScaleSetDataDiskList_Override(l LinuxVirtualMachineScaleSetDataDiskList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxVirtualMachineScaleSetDataDiskList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetDataDiskList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetDataDiskList) Resolve(context cdktn.IResolveContext) interface{} {
