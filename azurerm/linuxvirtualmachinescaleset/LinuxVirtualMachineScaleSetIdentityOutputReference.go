...
func (j *jsiiProxy_LinuxVirtualMachineScaleSetIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxVirtualMachineScaleSetIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LinuxVirtualMachineScaleSetIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxVirtualMachineScaleSetIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxVirtualMachineScaleSetIdentityOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetIdentityOutputReference",
...
func NewLinuxVirtualMachineScaleSetIdentityOutputReference_Override(l LinuxVirtualMachineScaleSetIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxVirtualMachineScaleSetIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
