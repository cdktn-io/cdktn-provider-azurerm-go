...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/cdnfrontdoorcustomdomainassociation/internal"
...
func (j *jsiiProxy_CdnFrontdoorCustomDomainAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CdnFrontdoorCustomDomainAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CdnFrontdoorCustomDomainAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CdnFrontdoorCustomDomainAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CdnFrontdoorCustomDomainAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CdnFrontdoorCustomDomainAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CdnFrontdoorCustomDomainAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CdnFrontdoorCustomDomainAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CdnFrontdoorCustomDomainAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CdnFrontdoorCustomDomainAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomainAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomainAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomainAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomainAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomainAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
