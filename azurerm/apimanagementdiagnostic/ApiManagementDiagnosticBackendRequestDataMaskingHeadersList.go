...
func (j *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementDiagnosticBackendRequestDataMaskingHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementDiagnosticBackendRequestDataMaskingHeadersList {
	_init_.Initialize()
...
func NewApiManagementDiagnosticBackendRequestDataMaskingHeadersList_Override(a ApiManagementDiagnosticBackendRequestDataMaskingHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
