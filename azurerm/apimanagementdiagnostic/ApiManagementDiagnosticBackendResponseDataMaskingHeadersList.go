...
func (j *jsiiProxy_ApiManagementDiagnosticBackendResponseDataMaskingHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementDiagnosticBackendResponseDataMaskingHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementDiagnosticBackendResponseDataMaskingHeadersList {
	_init_.Initialize()

	if err := validateNewApiManagementDiagnosticBackendResponseDataMaskingHeadersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiManagementDiagnosticBackendResponseDataMaskingHeadersList_Override(a ApiManagementDiagnosticBackendResponseDataMaskingHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementDiagnosticBackendResponseDataMaskingHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendResponseDataMaskingHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendResponseDataMaskingHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
