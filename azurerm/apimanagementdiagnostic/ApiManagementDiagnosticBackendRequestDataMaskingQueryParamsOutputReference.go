...
func (j *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementDiagnosticBackendRequestDataMaskingQueryParamsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementDiagnosticBackendRequestDataMaskingQueryParamsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewApiManagementDiagnosticBackendRequestDataMaskingQueryParamsOutputReference_Override(a ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
