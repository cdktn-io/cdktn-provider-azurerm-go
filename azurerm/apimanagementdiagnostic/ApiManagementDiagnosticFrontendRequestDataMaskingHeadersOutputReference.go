...
func (j *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementDiagnosticFrontendRequestDataMaskingHeadersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementDiagnosticFrontendRequestDataMaskingHeadersOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementDiagnosticFrontendRequestDataMaskingHeadersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewApiManagementDiagnosticFrontendRequestDataMaskingHeadersOutputReference_Override(a ApiManagementDiagnosticFrontendRequestDataMaskingHeadersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
