...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/apimanagementdiagnostic/internal"
...
func (j *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReference_Override(a ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
