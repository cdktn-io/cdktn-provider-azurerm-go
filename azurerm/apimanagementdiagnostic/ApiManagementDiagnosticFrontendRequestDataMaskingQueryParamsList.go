...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsList) Resolve(context cdktf.IResolveContext) interface{} {
