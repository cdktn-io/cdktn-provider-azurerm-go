...
func (j *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsList {
	_init_.Initialize()

	if err := validateNewApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsList_Override(a ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsList) Resolve(context cdktn.IResolveContext) interface{} {
