...
func (j *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementDiagnosticBackendRequestDataMaskingQueryParamsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsList {
	_init_.Initialize()
...
func NewApiManagementDiagnosticBackendRequestDataMaskingQueryParamsList_Override(a ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingQueryParamsList) Resolve(context cdktn.IResolveContext) interface{} {
