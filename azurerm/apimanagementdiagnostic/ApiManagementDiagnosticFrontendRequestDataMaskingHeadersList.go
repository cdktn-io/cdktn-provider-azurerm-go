...
func (j *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementDiagnosticFrontendRequestDataMaskingHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementDiagnosticFrontendRequestDataMaskingHeadersList {
	_init_.Initialize()

	if err := validateNewApiManagementDiagnosticFrontendRequestDataMaskingHeadersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiManagementDiagnosticFrontendRequestDataMaskingHeadersList_Override(a ApiManagementDiagnosticFrontendRequestDataMaskingHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
