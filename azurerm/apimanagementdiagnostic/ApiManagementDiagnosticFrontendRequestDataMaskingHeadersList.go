...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestDataMaskingHeadersList) Resolve(context cdktf.IResolveContext) interface{} {
