...
func (j *jsiiProxy_StorageTableAclList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageTableAclList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StorageTableAclList {
	_init_.Initialize()

	if err := validateNewStorageTableAclListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewStorageTableAclList_Override(s StorageTableAclList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageTableAclList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageTableAclList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageTableAclList) Resolve(context cdktn.IResolveContext) interface{} {
