...
func (s *jsiiProxy_StorageTableAclList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageTableAclList) Resolve(context cdktf.IResolveContext) interface{} {
