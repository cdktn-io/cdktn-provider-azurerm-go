...
func (j *jsiiProxy_StorageTable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StorageTable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StorageTable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StorageTable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StorageTable) StorageAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageAccountId",
...
func (j *jsiiProxy_StorageTable) StorageAccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_StorageTable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/storage_table azurerm_storage_table} Resource.
...
func (j *jsiiProxy_StorageTable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StorageTable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StorageTable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_StorageTable)SetStorageAccountId(val *string) {
...
func StorageTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StorageTable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageTable) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StorageTable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageTable) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageTable) ResetStorageAccountId() {
	_jsii_.InvokeVoid(
		s,
		"resetStorageAccountId",
		nil, // no parameters
...
func (s *jsiiProxy_StorageTable) ResetStorageAccountName() {
	_jsii_.InvokeVoid(
		s,
		"resetStorageAccountName",
		nil, // no parameters
...
func (s *jsiiProxy_StorageTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
