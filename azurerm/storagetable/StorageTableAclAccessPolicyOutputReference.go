...
func (j *jsiiProxy_StorageTableAclAccessPolicyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageTableAclAccessPolicyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StorageTableAclAccessPolicyOutputReference {
	_init_.Initialize()
...
func NewStorageTableAclAccessPolicyOutputReference_Override(s StorageTableAclAccessPolicyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageTableAclAccessPolicyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageTableAclAccessPolicyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageTableAclAccessPolicyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageTableAclAccessPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageTableAclAccessPolicyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
