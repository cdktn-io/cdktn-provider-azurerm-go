...
func (j *jsiiProxy_StorageTableAclAccessPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageTableAclAccessPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StorageTableAclAccessPolicyList {
	_init_.Initialize()

	if err := validateNewStorageTableAclAccessPolicyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewStorageTableAclAccessPolicyList_Override(s StorageTableAclAccessPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageTableAclAccessPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageTableAclAccessPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageTableAclAccessPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
