...
func (s *jsiiProxy_StorageTableAclOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageTableAclOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
