...
func (s *jsiiProxy_StorageTableTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageTableTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
