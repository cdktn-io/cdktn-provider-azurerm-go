...
func (d *jsiiProxy_DigitalTwinsEndpointServicebusTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DigitalTwinsEndpointServicebusTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
