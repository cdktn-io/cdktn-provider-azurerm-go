...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyCustomRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorFirewallPolicyCustomRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorFirewallPolicyCustomRuleList {
	_init_.Initialize()
...
func NewCdnFrontdoorFirewallPolicyCustomRuleList_Override(c CdnFrontdoorFirewallPolicyCustomRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyCustomRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyCustomRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyCustomRuleList) Resolve(context cdktn.IResolveContext) interface{} {
