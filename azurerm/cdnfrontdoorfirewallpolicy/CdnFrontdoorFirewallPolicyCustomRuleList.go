...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyCustomRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyCustomRuleList) Resolve(context cdktf.IResolveContext) interface{} {
