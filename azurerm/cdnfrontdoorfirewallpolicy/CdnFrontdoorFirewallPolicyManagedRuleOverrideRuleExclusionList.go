...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList {
	_init_.Initialize()
...
func NewCdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList_Override(c CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList) Resolve(context cdktn.IResolveContext) interface{} {
