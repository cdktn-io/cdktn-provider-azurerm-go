...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleList) Resolve(context cdktf.IResolveContext) interface{} {
