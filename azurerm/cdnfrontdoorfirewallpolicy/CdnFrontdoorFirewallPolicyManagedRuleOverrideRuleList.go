...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorFirewallPolicyManagedRuleOverrideRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleList {
	_init_.Initialize()
...
func NewCdnFrontdoorFirewallPolicyManagedRuleOverrideRuleList_Override(c CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleList) Resolve(context cdktn.IResolveContext) interface{} {
