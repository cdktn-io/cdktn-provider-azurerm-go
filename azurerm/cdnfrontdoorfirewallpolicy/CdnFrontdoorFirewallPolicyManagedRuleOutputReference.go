...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorFirewallPolicyManagedRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CdnFrontdoorFirewallPolicyManagedRuleOutputReference {
	_init_.Initialize()

	if err := validateNewCdnFrontdoorFirewallPolicyManagedRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewCdnFrontdoorFirewallPolicyManagedRuleOutputReference_Override(c CdnFrontdoorFirewallPolicyManagedRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOutputReference) PutOverride(value interface{}) {
	if err := c.validatePutOverrideParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
