...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}

func validateNewCdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
	return nil
}
