...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionList {
	_init_.Initialize()
...
func NewCdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionList_Override(c CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionList) Resolve(context cdktn.IResolveContext) interface{} {
