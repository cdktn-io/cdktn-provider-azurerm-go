...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionList) Resolve(context cdktf.IResolveContext) interface{} {
