...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference {
	_init_.Initialize()

	if err := validateNewCdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewCdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference_Override(c CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
