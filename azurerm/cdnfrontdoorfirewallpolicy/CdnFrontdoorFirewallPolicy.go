...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicy) JsChallengeCookieExpirationInMinutes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicy) JsChallengeCookieExpirationInMinutesInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/cdn_frontdoor_firewall_policy azurerm_cdn_frontdoor_firewall_policy} Resource.
...
func (j *jsiiProxy_CdnFrontdoorFirewallPolicy)SetJsChallengeCookieExpirationInMinutes(val *float64) {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicy) ResetJsChallengeCookieExpirationInMinutes() {
	_jsii_.InvokeVoid(
		c,
		"resetJsChallengeCookieExpirationInMinutes",
		nil, // no parameters
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
