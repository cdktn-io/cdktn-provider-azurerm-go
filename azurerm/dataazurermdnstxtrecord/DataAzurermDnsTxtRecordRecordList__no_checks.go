...
func (d *jsiiProxy_DataAzurermDnsTxtRecordRecordList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAzurermDnsTxtRecordRecordList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermDnsTxtRecordRecordList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermDnsTxtRecordRecordList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
