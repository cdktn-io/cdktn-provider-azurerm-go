...
func (j *jsiiProxy_DataFactoryTriggerTumblingWindowRetryOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryTriggerTumblingWindowRetryOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataFactoryTriggerTumblingWindowRetryOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryTriggerTumblingWindowRetryOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewDataFactoryTriggerTumblingWindowRetryOutputReference_Override(d DataFactoryTriggerTumblingWindowRetryOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryTriggerTumblingWindowRetryOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryTriggerTumblingWindowRetryOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryTriggerTumblingWindowRetryOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryTriggerTumblingWindowRetryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryTriggerTumblingWindowRetryOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
