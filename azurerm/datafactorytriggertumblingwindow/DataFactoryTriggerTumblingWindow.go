...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/data_factory_trigger_tumbling_window azurerm_data_factory_trigger_tumbling_window} Resource.
...
func (d *jsiiProxy_DataFactoryTriggerTumblingWindow) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryTriggerTumblingWindow) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataFactoryTriggerTumblingWindow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
