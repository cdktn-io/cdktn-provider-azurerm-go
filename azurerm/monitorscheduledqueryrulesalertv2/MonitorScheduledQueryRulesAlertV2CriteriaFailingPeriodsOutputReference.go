...
func (m *jsiiProxy_MonitorScheduledQueryRulesAlertV2CriteriaFailingPeriodsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesAlertV2CriteriaFailingPeriodsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
