...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/relaynamespaceauthorizationrule/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/relay_namespace_authorization_rule azurerm_relay_namespace_authorization_rule}.
...
func (j *jsiiProxy_RelayNamespaceAuthorizationRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RelayNamespaceAuthorizationRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RelayNamespaceAuthorizationRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RelayNamespaceAuthorizationRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RelayNamespaceAuthorizationRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RelayNamespaceAuthorizationRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/relay_namespace_authorization_rule azurerm_relay_namespace_authorization_rule} Resource.
func NewRelayNamespaceAuthorizationRule(scope constructs.Construct, id *string, config *RelayNamespaceAuthorizationRuleConfig) RelayNamespaceAuthorizationRule {
	...
	if err := validateNewRelayNamespaceAuthorizationRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_RelayNamespaceAuthorizationRule)SetCount(val interface{}) {
...
func (j *jsiiProxy_RelayNamespaceAuthorizationRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RelayNamespaceAuthorizationRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RelayNamespaceAuthorizationRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a RelayNamespaceAuthorizationRule resource upon running "cdktn plan <stack-name>".
func RelayNamespaceAuthorizationRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRelayNamespaceAuthorizationRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func RelayNamespaceAuthorizationRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateRelayNamespaceAuthorizationRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func RelayNamespaceAuthorizationRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRelayNamespaceAuthorizationRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func RelayNamespaceAuthorizationRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateRelayNamespaceAuthorizationRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) MoveFromId(id *string) {
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) MoveToId(id *string) {
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRule) ToHclTerraform() interface{} {
	var returns interface{}
