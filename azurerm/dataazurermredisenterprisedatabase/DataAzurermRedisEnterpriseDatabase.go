...
func (j *jsiiProxy_DataAzurermRedisEnterpriseDatabase) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermRedisEnterpriseDatabase) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermRedisEnterpriseDatabase) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermRedisEnterpriseDatabase) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermRedisEnterpriseDatabase) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAzurermRedisEnterpriseDatabase(scope constructs.Construct, id *string, config *DataAzurermRedisEnterpriseDatabaseConfig) DataAzurermRedisEnterpriseDatabase {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermRedisEnterpriseDatabase.DataAzurermRedisEnterpriseDatabase",
...
func (j *jsiiProxy_DataAzurermRedisEnterpriseDatabase)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermRedisEnterpriseDatabase)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermRedisEnterpriseDatabase)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermRedisEnterpriseDatabase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermRedisEnterpriseDatabase) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermRedisEnterpriseDatabase) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermRedisEnterpriseDatabase) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermRedisEnterpriseDatabase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
