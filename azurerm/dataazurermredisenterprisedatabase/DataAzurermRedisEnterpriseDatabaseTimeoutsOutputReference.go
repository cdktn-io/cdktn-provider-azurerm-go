...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/dataazurermredisenterprisedatabase/internal"
...
func (j *jsiiProxy_DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDataAzurermRedisEnterpriseDatabaseTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermRedisEnterpriseDatabase.DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference",
...
func NewDataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference_Override(d DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
