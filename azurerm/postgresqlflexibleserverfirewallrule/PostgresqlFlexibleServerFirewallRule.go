...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/postgresqlflexibleserverfirewallrule/internal"
...
func (j *jsiiProxy_PostgresqlFlexibleServerFirewallRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PostgresqlFlexibleServerFirewallRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PostgresqlFlexibleServerFirewallRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PostgresqlFlexibleServerFirewallRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PostgresqlFlexibleServerFirewallRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/postgresql_flexible_server_firewall_rule azurerm_postgresql_flexible_server_firewall_rule} Resource.
func NewPostgresqlFlexibleServerFirewallRule(scope constructs.Construct, id *string, config *PostgresqlFlexibleServerFirewallRuleConfig) PostgresqlFlexibleServerFirewallRule {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.postgresqlFlexibleServerFirewallRule.PostgresqlFlexibleServerFirewallRule",
...
func (j *jsiiProxy_PostgresqlFlexibleServerFirewallRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PostgresqlFlexibleServerFirewallRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PostgresqlFlexibleServerFirewallRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PostgresqlFlexibleServerFirewallRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PostgresqlFlexibleServerFirewallRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PostgresqlFlexibleServerFirewallRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PostgresqlFlexibleServerFirewallRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PostgresqlFlexibleServerFirewallRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PostgresqlFlexibleServerFirewallRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PostgresqlFlexibleServerFirewallRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
