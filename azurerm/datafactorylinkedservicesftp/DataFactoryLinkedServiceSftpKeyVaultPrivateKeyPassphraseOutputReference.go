...
func (d *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPrivateKeyPassphraseOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPrivateKeyPassphraseOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
