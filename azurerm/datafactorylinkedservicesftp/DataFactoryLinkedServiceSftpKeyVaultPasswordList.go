...
func (j *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPasswordList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPasswordList) InternalValue() interface{} {
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPasswordList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPasswordList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewDataFactoryLinkedServiceSftpKeyVaultPasswordList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryLinkedServiceSftpKeyVaultPasswordList {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryLinkedServiceSftp.DataFactoryLinkedServiceSftpKeyVaultPasswordList",
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPasswordList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPasswordList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPasswordList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPasswordList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPasswordList) Get(index *float64) DataFactoryLinkedServiceSftpKeyVaultPasswordOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataFactoryLinkedServiceSftpKeyVaultPasswordOutputReference
...
func (d *jsiiProxy_DataFactoryLinkedServiceSftpKeyVaultPasswordList) ToString() *string {
	var returns *string
