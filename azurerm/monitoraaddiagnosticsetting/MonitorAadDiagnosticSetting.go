...
type MonitorAadDiagnosticSetting interface {
	...
	EnabledLog() MonitorAadDiagnosticSettingEnabledLogList
...
func (j *jsiiProxy_MonitorAadDiagnosticSetting) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MonitorAadDiagnosticSetting) EnabledLog() MonitorAadDiagnosticSettingEnabledLogList {
	var returns MonitorAadDiagnosticSettingEnabledLogList
	_jsii_.Get(
		j,
		"enabledLog",
		&returns,
...
func (j *jsiiProxy_MonitorAadDiagnosticSetting) EnabledLogInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledLogInput",
...
func (j *jsiiProxy_MonitorAadDiagnosticSetting) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MonitorAadDiagnosticSetting) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MonitorAadDiagnosticSetting) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MonitorAadDiagnosticSetting) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/monitor_aad_diagnostic_setting azurerm_monitor_aad_diagnostic_setting} Resource.
...
func (j *jsiiProxy_MonitorAadDiagnosticSetting)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MonitorAadDiagnosticSetting)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MonitorAadDiagnosticSetting)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MonitorAadDiagnosticSetting_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MonitorAadDiagnosticSetting) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAadDiagnosticSetting) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MonitorAadDiagnosticSetting) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAadDiagnosticSetting) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitorAadDiagnosticSetting) PutEnabledLog(value interface{}) {
...
func (m *jsiiProxy_MonitorAadDiagnosticSetting) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitorAadDiagnosticSetting) ResetEnabledLog() {
	_jsii_.InvokeVoid(
		m,
		"resetEnabledLog",
		nil, // no parameters
...
func (m *jsiiProxy_MonitorAadDiagnosticSetting) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
