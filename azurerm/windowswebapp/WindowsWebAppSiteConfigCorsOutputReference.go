...
func (w *jsiiProxy_WindowsWebAppSiteConfigCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigCorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
