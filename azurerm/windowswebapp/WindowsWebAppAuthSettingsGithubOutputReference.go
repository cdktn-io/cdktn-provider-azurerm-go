...
func (j *jsiiProxy_WindowsWebAppAuthSettingsGithubOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppAuthSettingsGithubOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsWebAppAuthSettingsGithubOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsWebAppAuthSettingsGithubOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppAuthSettingsGithubOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppAuthSettingsGithubOutputReference",
...
func NewWindowsWebAppAuthSettingsGithubOutputReference_Override(w WindowsWebAppAuthSettingsGithubOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppAuthSettingsGithubOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsGithubOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsGithubOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsGithubOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsGithubOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
