...
func (j *jsiiProxy_WindowsWebAppConnectionStringList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppConnectionStringList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppConnectionStringList {
	_init_.Initialize()

	if err := validateNewWindowsWebAppConnectionStringListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppConnectionStringList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppConnectionStringList",
...
func NewWindowsWebAppConnectionStringList_Override(w WindowsWebAppConnectionStringList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppConnectionStringList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppConnectionStringList) Resolve(context cdktn.IResolveContext) interface{} {
