...
func (w *jsiiProxy_WindowsWebAppConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppConnectionStringList) Resolve(context cdktf.IResolveContext) interface{} {
