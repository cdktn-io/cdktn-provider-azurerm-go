...
func (j *jsiiProxy_WindowsWebAppAuthSettingsFacebookOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppAuthSettingsFacebookOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsWebAppAuthSettingsFacebookOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsWebAppAuthSettingsFacebookOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppAuthSettingsFacebookOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppAuthSettingsFacebookOutputReference",
...
func NewWindowsWebAppAuthSettingsFacebookOutputReference_Override(w WindowsWebAppAuthSettingsFacebookOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppAuthSettingsFacebookOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsFacebookOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsFacebookOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsFacebookOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsFacebookOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
