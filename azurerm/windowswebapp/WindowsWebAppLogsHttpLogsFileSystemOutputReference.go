...
func (w *jsiiProxy_WindowsWebAppLogsHttpLogsFileSystemOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppLogsHttpLogsFileSystemOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
