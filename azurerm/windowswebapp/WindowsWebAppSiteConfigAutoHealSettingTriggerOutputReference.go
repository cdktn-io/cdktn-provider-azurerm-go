...
type WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference interface {
	...
	SlowRequestWithPath() WindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPathList
...
func (j *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference) SlowRequestWithPath() WindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPathList {
	var returns WindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPathList
	_jsii_.Get(
		j,
		"slowRequestWithPath",
		&returns,
...
func (j *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference) SlowRequestWithPathInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference",
...
func NewWindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference_Override(w WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference) PutSlowRequestWithPath(value interface{}) {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference) ResetSlowRequestWithPath() {
	_jsii_.InvokeVoid(
		w,
		"resetSlowRequestWithPath",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
