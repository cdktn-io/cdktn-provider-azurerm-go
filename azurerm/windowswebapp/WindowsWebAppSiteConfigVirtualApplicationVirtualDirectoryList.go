...
func (w *jsiiProxy_WindowsWebAppSiteConfigVirtualApplicationVirtualDirectoryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigVirtualApplicationVirtualDirectoryList) Resolve(context cdktf.IResolveContext) interface{} {
