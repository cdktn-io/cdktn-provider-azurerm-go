...
func (j *jsiiProxy_WindowsWebAppAuthSettingsGoogleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppAuthSettingsGoogleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsWebAppAuthSettingsGoogleOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsWebAppAuthSettingsGoogleOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppAuthSettingsGoogleOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppAuthSettingsGoogleOutputReference",
...
func NewWindowsWebAppAuthSettingsGoogleOutputReference_Override(w WindowsWebAppAuthSettingsGoogleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppAuthSettingsGoogleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsGoogleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsGoogleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsGoogleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsGoogleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
