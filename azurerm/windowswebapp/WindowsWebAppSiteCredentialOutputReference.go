...
func (j *jsiiProxy_WindowsWebAppSiteCredentialOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSiteCredentialOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsWebAppSiteCredentialOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppSiteCredentialOutputReference",
...
func NewWindowsWebAppSiteCredentialOutputReference_Override(w WindowsWebAppSiteCredentialOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSiteCredentialOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSiteCredentialOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteCredentialOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppSiteCredentialOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteCredentialOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
