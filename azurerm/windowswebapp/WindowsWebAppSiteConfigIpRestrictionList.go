...
func (j *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSiteConfigIpRestrictionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSiteConfigIpRestrictionList {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSiteConfigIpRestrictionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSiteConfigIpRestrictionList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppSiteConfigIpRestrictionList",
...
func NewWindowsWebAppSiteConfigIpRestrictionList_Override(w WindowsWebAppSiteConfigIpRestrictionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionList) Resolve(context cdktn.IResolveContext) interface{} {
