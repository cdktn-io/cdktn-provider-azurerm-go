...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/windows_web_app azurerm_windows_web_app}.
...
func (j *jsiiProxy_WindowsWebApp) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WindowsWebApp) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WindowsWebApp) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WindowsWebApp) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WindowsWebApp) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_WindowsWebApp) VirtualNetworkBackupRestoreEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebApp) VirtualNetworkBackupRestoreEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebApp) VirtualNetworkImagePullEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebApp) VirtualNetworkImagePullEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/windows_web_app azurerm_windows_web_app} Resource.
func NewWindowsWebApp(scope constructs.Construct, id *string, config *WindowsWebAppConfig) WindowsWebApp {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebApp",
...
func (j *jsiiProxy_WindowsWebApp)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WindowsWebApp)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WindowsWebApp)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_WindowsWebApp)SetVirtualNetworkBackupRestoreEnabled(val interface{}) {
...
func (j *jsiiProxy_WindowsWebApp)SetVirtualNetworkImagePullEnabled(val interface{}) {
...
// Generates CDKTN code for importing a WindowsWebApp resource upon running "cdktn plan <stack-name>".
func WindowsWebApp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WindowsWebApp) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebApp) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WindowsWebApp) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebApp) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WindowsWebApp) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WindowsWebApp) ResetVirtualNetworkBackupRestoreEnabled() {
	_jsii_.InvokeVoid(
		w,
		"resetVirtualNetworkBackupRestoreEnabled",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsWebApp) ResetVirtualNetworkImagePullEnabled() {
	_jsii_.InvokeVoid(
		w,
		"resetVirtualNetworkImagePullEnabled",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsWebApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
