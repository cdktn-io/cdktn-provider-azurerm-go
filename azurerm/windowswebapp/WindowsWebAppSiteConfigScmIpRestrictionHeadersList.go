...
func (j *jsiiProxy_WindowsWebAppSiteConfigScmIpRestrictionHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSiteConfigScmIpRestrictionHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSiteConfigScmIpRestrictionHeadersList {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSiteConfigScmIpRestrictionHeadersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSiteConfigScmIpRestrictionHeadersList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppSiteConfigScmIpRestrictionHeadersList",
...
func NewWindowsWebAppSiteConfigScmIpRestrictionHeadersList_Override(w WindowsWebAppSiteConfigScmIpRestrictionHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSiteConfigScmIpRestrictionHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigScmIpRestrictionHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigScmIpRestrictionHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
