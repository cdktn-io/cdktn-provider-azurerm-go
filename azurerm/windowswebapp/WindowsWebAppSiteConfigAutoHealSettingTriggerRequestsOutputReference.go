...
func (j *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference",
...
func NewWindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference_Override(w WindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerRequestsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
