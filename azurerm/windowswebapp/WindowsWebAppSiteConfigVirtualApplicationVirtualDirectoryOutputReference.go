...
func (w *jsiiProxy_WindowsWebAppSiteConfigVirtualApplicationVirtualDirectoryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigVirtualApplicationVirtualDirectoryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
