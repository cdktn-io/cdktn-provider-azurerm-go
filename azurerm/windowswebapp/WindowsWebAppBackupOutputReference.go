...
func (j *jsiiProxy_WindowsWebAppBackupOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppBackupOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsWebAppBackupOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppBackupOutputReference",
...
func NewWindowsWebAppBackupOutputReference_Override(w WindowsWebAppBackupOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppBackupOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppBackupOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppBackupOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppBackupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppBackupOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
