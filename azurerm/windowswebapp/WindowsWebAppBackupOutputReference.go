...
func (w *jsiiProxy_WindowsWebAppBackupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppBackupOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
