...
func (w *jsiiProxy_WindowsWebAppConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppConnectionStringOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
