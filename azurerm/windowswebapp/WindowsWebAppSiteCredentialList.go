...
func (j *jsiiProxy_WindowsWebAppSiteCredentialList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSiteCredentialList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSiteCredentialList {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSiteCredentialListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSiteCredentialList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppSiteCredentialList",
...
func NewWindowsWebAppSiteCredentialList_Override(w WindowsWebAppSiteCredentialList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSiteCredentialList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSiteCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSiteCredentialList) Resolve(context cdktn.IResolveContext) interface{} {
