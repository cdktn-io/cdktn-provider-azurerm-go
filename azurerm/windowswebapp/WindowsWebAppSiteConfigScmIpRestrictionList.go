...
func (w *jsiiProxy_WindowsWebAppSiteConfigScmIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigScmIpRestrictionList) Resolve(context cdktf.IResolveContext) interface{} {
