...
func (w *jsiiProxy_WindowsWebAppSiteConfigVirtualApplicationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigVirtualApplicationList) Resolve(context cdktf.IResolveContext) interface{} {
