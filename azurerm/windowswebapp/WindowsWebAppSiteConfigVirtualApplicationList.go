...
func (j *jsiiProxy_WindowsWebAppSiteConfigVirtualApplicationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSiteConfigVirtualApplicationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSiteConfigVirtualApplicationList {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSiteConfigVirtualApplicationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSiteConfigVirtualApplicationList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppSiteConfigVirtualApplicationList",
...
func NewWindowsWebAppSiteConfigVirtualApplicationList_Override(w WindowsWebAppSiteConfigVirtualApplicationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSiteConfigVirtualApplicationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigVirtualApplicationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigVirtualApplicationList) Resolve(context cdktn.IResolveContext) interface{} {
