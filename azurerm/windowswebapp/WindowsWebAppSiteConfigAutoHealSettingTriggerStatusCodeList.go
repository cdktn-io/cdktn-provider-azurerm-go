...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList) Resolve(context cdktf.IResolveContext) interface{} {
