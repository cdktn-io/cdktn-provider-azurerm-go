...
func (j *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList",
...
func NewWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList_Override(w WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingTriggerStatusCodeList) Resolve(context cdktn.IResolveContext) interface{} {
