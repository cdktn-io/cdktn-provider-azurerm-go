...
func (j *jsiiProxy_WindowsWebAppAuthSettingsTwitterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppAuthSettingsTwitterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsWebAppAuthSettingsTwitterOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsWebAppAuthSettingsTwitterOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppAuthSettingsTwitterOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppAuthSettingsTwitterOutputReference",
...
func NewWindowsWebAppAuthSettingsTwitterOutputReference_Override(w WindowsWebAppAuthSettingsTwitterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppAuthSettingsTwitterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsTwitterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsTwitterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsTwitterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppAuthSettingsTwitterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
