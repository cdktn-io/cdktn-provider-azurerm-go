...
func (j *jsiiProxy_WindowsWebAppStorageAccountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppStorageAccountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppStorageAccountList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppStorageAccountList",
...
func NewWindowsWebAppStorageAccountList_Override(w WindowsWebAppStorageAccountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppStorageAccountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppStorageAccountList) Resolve(context cdktn.IResolveContext) interface{} {
