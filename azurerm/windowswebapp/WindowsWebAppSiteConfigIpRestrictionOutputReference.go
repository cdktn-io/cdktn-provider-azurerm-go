...
func (j *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionOutputReference) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionOutputReference) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSiteConfigIpRestrictionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsWebAppSiteConfigIpRestrictionOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSiteConfigIpRestrictionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSiteConfigIpRestrictionOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebApp.WindowsWebAppSiteConfigIpRestrictionOutputReference",
...
func NewWindowsWebAppSiteConfigIpRestrictionOutputReference_Override(w WindowsWebAppSiteConfigIpRestrictionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionOutputReference)SetDescription(val *string) {
...
func (j *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionOutputReference) ResetDescription() {
	_jsii_.InvokeVoid(
		w,
		"resetDescription",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsWebAppSiteConfigIpRestrictionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
