...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewPaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatList {
	_init_.Initialize()
...
func NewPaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatList_Override(p PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubStrataCloudManagerDestinationNatList) Resolve(context cdktf.IResolveContext) interface{} {
