...
func (j *jsiiProxy_SharedImageVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SharedImageVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SharedImageVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SharedImageVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SharedImageVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SharedImageVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SharedImageVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SharedImageVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SharedImageVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SharedImageVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SharedImageVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SharedImageVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SharedImageVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SharedImageVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SharedImageVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
