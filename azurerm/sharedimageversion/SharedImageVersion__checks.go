...
func (s *jsiiProxy_SharedImageVersion) validatePutTargetRegionParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SharedImageVersionTargetRegion; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_SharedImageVersion) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
