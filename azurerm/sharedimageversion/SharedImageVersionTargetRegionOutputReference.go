...
func (s *jsiiProxy_SharedImageVersionTargetRegionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SharedImageVersionTargetRegionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
