...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/sharedimageversion/internal"
...
func (j *jsiiProxy_SharedImageVersionTargetRegionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSharedImageVersionTargetRegionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SharedImageVersionTargetRegionOutputReference {
	_init_.Initialize()

	if err := validateNewSharedImageVersionTargetRegionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewSharedImageVersionTargetRegionOutputReference_Override(s SharedImageVersionTargetRegionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SharedImageVersionTargetRegionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SharedImageVersionTargetRegionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SharedImageVersionTargetRegionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SharedImageVersionTargetRegionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SharedImageVersionTargetRegionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
