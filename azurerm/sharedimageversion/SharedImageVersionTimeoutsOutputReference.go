...
func (s *jsiiProxy_SharedImageVersionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SharedImageVersionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
