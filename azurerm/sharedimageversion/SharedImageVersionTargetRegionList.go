...
func (s *jsiiProxy_SharedImageVersionTargetRegionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SharedImageVersionTargetRegionList) Resolve(context cdktf.IResolveContext) interface{} {
