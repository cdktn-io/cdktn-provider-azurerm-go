...
func (j *jsiiProxy_SharedImageVersionTargetRegionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSharedImageVersionTargetRegionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SharedImageVersionTargetRegionList {
	_init_.Initialize()
...
func NewSharedImageVersionTargetRegionList_Override(s SharedImageVersionTargetRegionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SharedImageVersionTargetRegionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SharedImageVersionTargetRegionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SharedImageVersionTargetRegionList) Resolve(context cdktn.IResolveContext) interface{} {
