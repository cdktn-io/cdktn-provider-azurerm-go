...
func (j *jsiiProxy_SubscriptionTemplateDeployment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SubscriptionTemplateDeployment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SubscriptionTemplateDeployment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SubscriptionTemplateDeployment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SubscriptionTemplateDeployment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/subscription_template_deployment azurerm_subscription_template_deployment} Resource.
...
func (j *jsiiProxy_SubscriptionTemplateDeployment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SubscriptionTemplateDeployment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SubscriptionTemplateDeployment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SubscriptionTemplateDeployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SubscriptionTemplateDeployment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubscriptionTemplateDeployment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SubscriptionTemplateDeployment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubscriptionTemplateDeployment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SubscriptionTemplateDeployment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SubscriptionTemplateDeployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
