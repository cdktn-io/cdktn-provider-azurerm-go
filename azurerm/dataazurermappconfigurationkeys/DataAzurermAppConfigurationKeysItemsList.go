...
func (d *jsiiProxy_DataAzurermAppConfigurationKeysItemsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermAppConfigurationKeysItemsList) Resolve(context cdktf.IResolveContext) interface{} {
