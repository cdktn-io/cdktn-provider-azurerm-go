...
func (j *jsiiProxy_DataAzurermAppConfigurationKeysItemsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermAppConfigurationKeysItemsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermAppConfigurationKeysItemsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermAppConfigurationKeys.DataAzurermAppConfigurationKeysItemsList",
...
func NewDataAzurermAppConfigurationKeysItemsList_Override(d DataAzurermAppConfigurationKeysItemsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermAppConfigurationKeysItemsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermAppConfigurationKeysItemsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermAppConfigurationKeysItemsList) Resolve(context cdktn.IResolveContext) interface{} {
