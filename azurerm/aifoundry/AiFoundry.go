...
func (a *jsiiProxy_AiFoundry) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AiFoundry) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AiFoundry) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
