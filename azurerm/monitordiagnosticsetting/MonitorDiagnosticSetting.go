...
func (j *jsiiProxy_MonitorDiagnosticSetting) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MonitorDiagnosticSetting) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MonitorDiagnosticSetting) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MonitorDiagnosticSetting) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MonitorDiagnosticSetting) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MonitorDiagnosticSetting)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MonitorDiagnosticSetting)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MonitorDiagnosticSetting)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MonitorDiagnosticSetting_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MonitorDiagnosticSetting) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorDiagnosticSetting) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MonitorDiagnosticSetting) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorDiagnosticSetting) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitorDiagnosticSetting) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitorDiagnosticSetting) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
