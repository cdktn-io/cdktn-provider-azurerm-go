...
func (m *jsiiProxy_MonitorDiagnosticSettingEnabledLogOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorDiagnosticSettingEnabledLogOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
