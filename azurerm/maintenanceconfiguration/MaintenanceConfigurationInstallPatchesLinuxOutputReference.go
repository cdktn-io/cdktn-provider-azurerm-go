...
func (j *jsiiProxy_MaintenanceConfigurationInstallPatchesLinuxOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMaintenanceConfigurationInstallPatchesLinuxOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MaintenanceConfigurationInstallPatchesLinuxOutputReference {
	_init_.Initialize()
...
func NewMaintenanceConfigurationInstallPatchesLinuxOutputReference_Override(m MaintenanceConfigurationInstallPatchesLinuxOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MaintenanceConfigurationInstallPatchesLinuxOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MaintenanceConfigurationInstallPatchesLinuxOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MaintenanceConfigurationInstallPatchesLinuxOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MaintenanceConfigurationInstallPatchesLinuxOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MaintenanceConfigurationInstallPatchesLinuxOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
