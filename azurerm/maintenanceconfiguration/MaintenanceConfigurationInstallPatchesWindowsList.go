...
func (j *jsiiProxy_MaintenanceConfigurationInstallPatchesWindowsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMaintenanceConfigurationInstallPatchesWindowsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MaintenanceConfigurationInstallPatchesWindowsList {
	_init_.Initialize()
...
func NewMaintenanceConfigurationInstallPatchesWindowsList_Override(m MaintenanceConfigurationInstallPatchesWindowsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MaintenanceConfigurationInstallPatchesWindowsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MaintenanceConfigurationInstallPatchesWindowsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MaintenanceConfigurationInstallPatchesWindowsList) Resolve(context cdktn.IResolveContext) interface{} {
