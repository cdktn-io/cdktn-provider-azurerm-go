...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterDiskEncryptionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightInteractiveQueryClusterDiskEncryptionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightInteractiveQueryClusterDiskEncryptionList {
	_init_.Initialize()

	if err := validateNewHdinsightInteractiveQueryClusterDiskEncryptionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewHdinsightInteractiveQueryClusterDiskEncryptionList_Override(h HdinsightInteractiveQueryClusterDiskEncryptionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterDiskEncryptionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterDiskEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterDiskEncryptionList) Resolve(context cdktn.IResolveContext) interface{} {
