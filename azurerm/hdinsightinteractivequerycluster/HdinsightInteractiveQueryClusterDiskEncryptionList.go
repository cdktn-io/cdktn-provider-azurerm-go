...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterDiskEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterDiskEncryptionList) Resolve(context cdktf.IResolveContext) interface{} {
