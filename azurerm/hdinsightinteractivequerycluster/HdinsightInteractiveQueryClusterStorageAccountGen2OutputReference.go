...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference) StorageAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageAccountId",
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference) StorageAccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference) UserAssignedIdentityId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference) UserAssignedIdentityIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewHdinsightInteractiveQueryClusterStorageAccountGen2OutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightInteractiveQueryCluster.HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference",
...
func NewHdinsightInteractiveQueryClusterStorageAccountGen2OutputReference_Override(h HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference)SetStorageAccountId(val *string) {
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference)SetUserAssignedIdentityId(val *string) {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountGen2OutputReference) Resolve(context cdktn.IResolveContext) interface{} {
