...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterGatewayOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightInteractiveQueryClusterGatewayOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightInteractiveQueryClusterGatewayOutputReference {
	_init_.Initialize()

	if err := validateNewHdinsightInteractiveQueryClusterGatewayOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_HdinsightInteractiveQueryClusterGatewayOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightInteractiveQueryCluster.HdinsightInteractiveQueryClusterGatewayOutputReference",
...
func NewHdinsightInteractiveQueryClusterGatewayOutputReference_Override(h HdinsightInteractiveQueryClusterGatewayOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterGatewayOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterGatewayOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterGatewayOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterGatewayOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterGatewayOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
