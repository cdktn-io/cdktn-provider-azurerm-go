...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterComponentVersionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightInteractiveQueryClusterComponentVersionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightInteractiveQueryClusterComponentVersionOutputReference {
	_init_.Initialize()

	if err := validateNewHdinsightInteractiveQueryClusterComponentVersionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_HdinsightInteractiveQueryClusterComponentVersionOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightInteractiveQueryCluster.HdinsightInteractiveQueryClusterComponentVersionOutputReference",
...
func NewHdinsightInteractiveQueryClusterComponentVersionOutputReference_Override(h HdinsightInteractiveQueryClusterComponentVersionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterComponentVersionOutputReference)SetInteractiveHive(val *string) {
	if err := j.validateSetInteractiveHiveParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterComponentVersionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterComponentVersionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterComponentVersionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterComponentVersionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterComponentVersionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
