...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterMonitorOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightInteractiveQueryClusterMonitorOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightInteractiveQueryClusterMonitorOutputReference {
	_init_.Initialize()
...
func NewHdinsightInteractiveQueryClusterMonitorOutputReference_Override(h HdinsightInteractiveQueryClusterMonitorOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterMonitorOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterMonitorOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterMonitorOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterMonitorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterMonitorOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
