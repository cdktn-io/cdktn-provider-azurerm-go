...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountList) Resolve(context cdktf.IResolveContext) interface{} {
