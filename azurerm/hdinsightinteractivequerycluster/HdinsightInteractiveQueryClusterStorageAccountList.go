...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightInteractiveQueryClusterStorageAccountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightInteractiveQueryClusterStorageAccountList {
	_init_.Initialize()

	if err := validateNewHdinsightInteractiveQueryClusterStorageAccountListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightInteractiveQueryCluster.HdinsightInteractiveQueryClusterStorageAccountList",
...
func NewHdinsightInteractiveQueryClusterStorageAccountList_Override(h HdinsightInteractiveQueryClusterStorageAccountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountList) Resolve(context cdktn.IResolveContext) interface{} {
