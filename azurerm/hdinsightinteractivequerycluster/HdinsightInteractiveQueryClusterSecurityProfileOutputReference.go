...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterSecurityProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterSecurityProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
