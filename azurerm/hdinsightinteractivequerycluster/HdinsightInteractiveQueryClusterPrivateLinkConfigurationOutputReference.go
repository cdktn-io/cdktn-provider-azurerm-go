...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterPrivateLinkConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterPrivateLinkConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
