...
type HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference interface {
	...
	ScriptActions() HdinsightInteractiveQueryClusterRolesWorkerNodeScriptActionsList
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference) ScriptActions() HdinsightInteractiveQueryClusterRolesWorkerNodeScriptActionsList {
	var returns HdinsightInteractiveQueryClusterRolesWorkerNodeScriptActionsList
	_jsii_.Get(
		j,
		"scriptActions",
		&returns,
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference) ScriptActionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"scriptActionsInput",
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference {
	_init_.Initialize()

	if err := validateNewHdinsightInteractiveQueryClusterRolesWorkerNodeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightInteractiveQueryCluster.HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference",
...
func NewHdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference_Override(h HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference) PutScriptActions(value interface{}) {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference) ResetScriptActions() {
	_jsii_.InvokeVoid(
		h,
		"resetScriptActions",
		nil, // no parameters
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterRolesWorkerNodeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
