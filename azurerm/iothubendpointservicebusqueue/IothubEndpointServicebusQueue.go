...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/iothubendpointservicebusqueue/internal"
...
func (j *jsiiProxy_IothubEndpointServicebusQueue) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IothubEndpointServicebusQueue) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IothubEndpointServicebusQueue) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IothubEndpointServicebusQueue) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IothubEndpointServicebusQueue) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IothubEndpointServicebusQueue) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IothubEndpointServicebusQueue)SetCount(val interface{}) {
...
func (j *jsiiProxy_IothubEndpointServicebusQueue)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IothubEndpointServicebusQueue)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IothubEndpointServicebusQueue)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IothubEndpointServicebusQueue_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIothubEndpointServicebusQueue_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) MoveFromId(id *string) {
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) MoveToId(id *string) {
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) ToHclTerraform() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IothubEndpointServicebusQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
