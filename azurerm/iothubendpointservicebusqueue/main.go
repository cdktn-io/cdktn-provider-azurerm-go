...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IothubEndpointServicebusQueue)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.iothubEndpointServicebusQueue.IothubEndpointServicebusQueueConfig",
		reflect.TypeOf((*IothubEndpointServicebusQueueConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.iothubEndpointServicebusQueue.IothubEndpointServicebusQueueTimeouts",
		reflect.TypeOf((*IothubEndpointServicebusQueueTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azurerm.iothubEndpointServicebusQueue.IothubEndpointServicebusQueueTimeoutsOutputReference",
		reflect.TypeOf((*IothubEndpointServicebusQueueTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
