...
func (i *jsiiProxy_IothubEndpointServicebusQueueTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubEndpointServicebusQueueTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
