...
func (r *jsiiProxy_RoleManagementPolicyActiveAssignmentRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RoleManagementPolicyActiveAssignmentRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
