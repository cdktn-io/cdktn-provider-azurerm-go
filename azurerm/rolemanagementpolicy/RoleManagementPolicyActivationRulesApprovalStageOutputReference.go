...
func (r *jsiiProxy_RoleManagementPolicyActivationRulesApprovalStageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RoleManagementPolicyActivationRulesApprovalStageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
