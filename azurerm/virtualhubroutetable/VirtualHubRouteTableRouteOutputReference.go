...
func (v *jsiiProxy_VirtualHubRouteTableRouteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualHubRouteTableRouteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
