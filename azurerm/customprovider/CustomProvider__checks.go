...
func (c *jsiiProxy_CustomProvider) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (c *jsiiProxy_CustomProvider) validatePutActionParameters(value interface{}) error {
	...
	case *[]*CustomProviderAction:
		value := value.(*[]*CustomProviderAction)
	...
	case []*CustomProviderAction:
		value_ := value.([]*CustomProviderAction)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CustomProviderAction; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CustomProvider) validatePutResourceTypeParameters(value interface{}) error {
	...
	case *[]*CustomProviderResourceType:
		value := value.(*[]*CustomProviderResourceType)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CustomProviderResourceType:
		value_ := value.([]*CustomProviderResourceType)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CustomProviderResourceType; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CustomProvider) validatePutValidationParameters(value interface{}) error {
	...
	case *[]*CustomProviderValidation:
		value := value.(*[]*CustomProviderValidation)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CustomProviderValidation:
		value_ := value.([]*CustomProviderValidation)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CustomProviderValidation; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CustomProvider) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	if feature == "" {
...
func (j *jsiiProxy_CustomProvider) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
