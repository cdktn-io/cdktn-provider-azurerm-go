...
func (c *jsiiProxy_CustomProvider) validatePutActionParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CustomProviderAction; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CustomProvider) validatePutResourceTypeParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CustomProviderResourceType; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CustomProvider) validatePutValidationParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CustomProviderValidation; received %#v (a %T)", value, value)
		}
	}
