...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "keyVaultIdentityClientId", GoGetter: "KeyVaultIdentityClientId"},
			_jsii_.MemberProperty{JsiiProperty: "keyVaultIdentityClientIdInput", GoGetter: "KeyVaultIdentityClientIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetKeyVaultIdentityClientId", GoMethod: "ResetKeyVaultIdentityClientId"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ApiManagementCertificateTimeoutsOutputReference{}
