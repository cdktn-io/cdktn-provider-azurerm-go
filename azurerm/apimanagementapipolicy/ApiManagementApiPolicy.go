...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/api_management_api_policy azurerm_api_management_api_policy}.
...
func (j *jsiiProxy_ApiManagementApiPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiManagementApiPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiManagementApiPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiManagementApiPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiManagementApiPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/api_management_api_policy azurerm_api_management_api_policy} Resource.
func NewApiManagementApiPolicy(scope constructs.Construct, id *string, config *ApiManagementApiPolicyConfig) ApiManagementApiPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementApiPolicy.ApiManagementApiPolicy",
...
func (j *jsiiProxy_ApiManagementApiPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiManagementApiPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiManagementApiPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApiManagementApiPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApiManagementApiPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiPolicy) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiManagementApiPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiManagementApiPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiManagementApiPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiManagementApiPolicy) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiManagementApiPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApiManagementApiPolicy) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiManagementApiPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiManagementApiPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApiManagementApiPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiManagementApiPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
