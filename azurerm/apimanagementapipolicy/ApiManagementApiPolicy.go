...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/apimanagementapipolicy/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/api_management_api_policy azurerm_api_management_api_policy} Resource.
func NewApiManagementApiPolicy(scope constructs.Construct, id *string, config *ApiManagementApiPolicyConfig) ApiManagementApiPolicy {
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.apiManagementApiPolicy.ApiManagementApiPolicy",
