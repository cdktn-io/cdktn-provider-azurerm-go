...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTriggerUrl", GoMethod: "ResetTriggerUrl"},
			...
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "triggerUrl", GoGetter: "TriggerUrl"},
			_jsii_.MemberProperty{JsiiProperty: "triggerUrlInput", GoGetter: "TriggerUrlInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "propertyPath", GoGetter: "PropertyPath"},
			_jsii_.MemberProperty{JsiiProperty: "propertyPathInput", GoGetter: "PropertyPathInput"},
		...
		func() interface{} {
			j := jsiiProxy_SecurityCenterAutomationSourceRuleSetRuleOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_SecurityCenterAutomationTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
