...
func (o *jsiiProxy_OrbitalSpacecraftLinksList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OrbitalSpacecraftLinksList) Resolve(context cdktf.IResolveContext) interface{} {
