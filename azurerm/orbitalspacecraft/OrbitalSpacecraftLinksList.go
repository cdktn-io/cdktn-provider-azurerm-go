...
func (j *jsiiProxy_OrbitalSpacecraftLinksList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewOrbitalSpacecraftLinksList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OrbitalSpacecraftLinksList {
	_init_.Initialize()

	if err := validateNewOrbitalSpacecraftLinksListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewOrbitalSpacecraftLinksList_Override(o OrbitalSpacecraftLinksList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_OrbitalSpacecraftLinksList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (o *jsiiProxy_OrbitalSpacecraftLinksList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OrbitalSpacecraftLinksList) Resolve(context cdktn.IResolveContext) interface{} {
