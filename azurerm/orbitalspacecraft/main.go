...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "noradId", GoGetter: "NoradId"},
			_jsii_.MemberProperty{JsiiProperty: "noradIdInput", GoGetter: "NoradIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "titleLine", GoGetter: "TitleLine"},
			_jsii_.MemberProperty{JsiiProperty: "titleLineInput", GoGetter: "TitleLineInput"},
