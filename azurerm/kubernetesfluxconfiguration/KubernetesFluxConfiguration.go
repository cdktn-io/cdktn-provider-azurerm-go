...
func (j *jsiiProxy_KubernetesFluxConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KubernetesFluxConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KubernetesFluxConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KubernetesFluxConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KubernetesFluxConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/kubernetes_flux_configuration azurerm_kubernetes_flux_configuration} Resource.
func NewKubernetesFluxConfiguration(scope constructs.Construct, id *string, config *KubernetesFluxConfigurationConfig) KubernetesFluxConfiguration {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.kubernetesFluxConfiguration.KubernetesFluxConfiguration",
...
func (j *jsiiProxy_KubernetesFluxConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KubernetesFluxConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KubernetesFluxConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KubernetesFluxConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KubernetesFluxConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesFluxConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KubernetesFluxConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesFluxConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KubernetesFluxConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KubernetesFluxConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
