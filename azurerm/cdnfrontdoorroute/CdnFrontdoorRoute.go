...
func (j *jsiiProxy_CdnFrontdoorRoute) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CdnFrontdoorRoute) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CdnFrontdoorRoute) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CdnFrontdoorRoute) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CdnFrontdoorRoute) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CdnFrontdoorRoute)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CdnFrontdoorRoute)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CdnFrontdoorRoute)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CdnFrontdoorRoute_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CdnFrontdoorRoute) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRoute) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CdnFrontdoorRoute) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRoute) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CdnFrontdoorRoute) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CdnFrontdoorRoute) ResetCdnFrontdoorOriginIds() {
	_jsii_.InvokeVoid(
		c,
		"resetCdnFrontdoorOriginIds",
		nil, // no parameters
...
func (c *jsiiProxy_CdnFrontdoorRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
