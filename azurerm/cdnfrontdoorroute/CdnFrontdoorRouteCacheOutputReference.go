...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/cdnfrontdoorroute/internal"
...
func (j *jsiiProxy_CdnFrontdoorRouteCacheOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRouteCacheOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CdnFrontdoorRouteCacheOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.cdnFrontdoorRoute.CdnFrontdoorRouteCacheOutputReference",
...
func NewCdnFrontdoorRouteCacheOutputReference_Override(c CdnFrontdoorRouteCacheOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRouteCacheOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRouteCacheOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRouteCacheOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CdnFrontdoorRouteCacheOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRouteCacheOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
