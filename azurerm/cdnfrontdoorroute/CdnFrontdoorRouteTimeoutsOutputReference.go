...
func (c *jsiiProxy_CdnFrontdoorRouteTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRouteTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
