...
func (j *jsiiProxy_BackupPolicyFileShareRetentionDailyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBackupPolicyFileShareRetentionDailyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BackupPolicyFileShareRetentionDailyOutputReference {
	_init_.Initialize()

	if err := validateNewBackupPolicyFileShareRetentionDailyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewBackupPolicyFileShareRetentionDailyOutputReference_Override(b BackupPolicyFileShareRetentionDailyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BackupPolicyFileShareRetentionDailyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BackupPolicyFileShareRetentionDailyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyFileShareRetentionDailyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BackupPolicyFileShareRetentionDailyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyFileShareRetentionDailyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
