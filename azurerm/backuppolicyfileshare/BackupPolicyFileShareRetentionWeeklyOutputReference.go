...
func (b *jsiiProxy_BackupPolicyFileShareRetentionWeeklyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupPolicyFileShareRetentionWeeklyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
