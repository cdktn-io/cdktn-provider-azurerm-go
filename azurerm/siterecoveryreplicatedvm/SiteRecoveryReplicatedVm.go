...
func (j *jsiiProxy_SiteRecoveryReplicatedVm) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SiteRecoveryReplicatedVm) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SiteRecoveryReplicatedVm) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SiteRecoveryReplicatedVm) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SiteRecoveryReplicatedVm) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/site_recovery_replicated_vm azurerm_site_recovery_replicated_vm} Resource.
func NewSiteRecoveryReplicatedVm(scope constructs.Construct, id *string, config *SiteRecoveryReplicatedVmConfig) SiteRecoveryReplicatedVm {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVm",
...
func (j *jsiiProxy_SiteRecoveryReplicatedVm)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SiteRecoveryReplicatedVm)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SiteRecoveryReplicatedVm)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SiteRecoveryReplicatedVm_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SiteRecoveryReplicatedVm) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SiteRecoveryReplicatedVm) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SiteRecoveryReplicatedVm) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SiteRecoveryReplicatedVm) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SiteRecoveryReplicatedVm) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SiteRecoveryReplicatedVm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
