...
func (s *jsiiProxy_SiteRecoveryReplicatedVmNetworkInterfaceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SiteRecoveryReplicatedVmNetworkInterfaceList) Resolve(context cdktf.IResolveContext) interface{} {
