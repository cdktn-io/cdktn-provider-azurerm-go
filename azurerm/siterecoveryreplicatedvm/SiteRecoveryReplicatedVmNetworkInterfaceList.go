...
func (j *jsiiProxy_SiteRecoveryReplicatedVmNetworkInterfaceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSiteRecoveryReplicatedVmNetworkInterfaceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SiteRecoveryReplicatedVmNetworkInterfaceList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmNetworkInterfaceList",
...
func NewSiteRecoveryReplicatedVmNetworkInterfaceList_Override(s SiteRecoveryReplicatedVmNetworkInterfaceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SiteRecoveryReplicatedVmNetworkInterfaceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SiteRecoveryReplicatedVmNetworkInterfaceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SiteRecoveryReplicatedVmNetworkInterfaceList) Resolve(context cdktn.IResolveContext) interface{} {
