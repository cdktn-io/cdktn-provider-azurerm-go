...
func (s *jsiiProxy_SiteRecoveryReplicatedVmManagedDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SiteRecoveryReplicatedVmManagedDiskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
