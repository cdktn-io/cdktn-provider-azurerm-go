...
type DataAzurermHdinsightCluster interface {
	...
	ComponentVersions() cdktn.StringMap
	// Experimental.
...
func (j *jsiiProxy_DataAzurermHdinsightCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermHdinsightCluster) ComponentVersions() cdktn.StringMap {
...
func (j *jsiiProxy_DataAzurermHdinsightCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermHdinsightCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermHdinsightCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermHdinsightCluster) Tags() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_DataAzurermHdinsightCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAzurermHdinsightCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermHdinsightCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermHdinsightCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermHdinsightCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermHdinsightCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermHdinsightCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermHdinsightCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermHdinsightCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
