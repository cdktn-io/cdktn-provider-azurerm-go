...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "regenerateKeyAutomatically", GoGetter: "RegenerateKeyAutomatically"},
			_jsii_.MemberProperty{JsiiProperty: "regenerateKeyAutomaticallyInput", GoGetter: "RegenerateKeyAutomaticallyInput"},
			_jsii_.MemberProperty{JsiiProperty: "regenerationPeriod", GoGetter: "RegenerationPeriod"},
			_jsii_.MemberProperty{JsiiProperty: "regenerationPeriodInput", GoGetter: "RegenerationPeriodInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegenerateKeyAutomatically", GoMethod: "ResetRegenerateKeyAutomatically"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegenerationPeriod", GoMethod: "ResetRegenerationPeriod"},
