...
func (j *jsiiProxy_KeyVaultManagedStorageAccount) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KeyVaultManagedStorageAccount) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KeyVaultManagedStorageAccount) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KeyVaultManagedStorageAccount) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KeyVaultManagedStorageAccount) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/key_vault_managed_storage_account azurerm_key_vault_managed_storage_account} Resource.
...
func (j *jsiiProxy_KeyVaultManagedStorageAccount)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KeyVaultManagedStorageAccount)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KeyVaultManagedStorageAccount)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KeyVaultManagedStorageAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
