...
type AzurermProvider interface {
	...
	Functions() providerfunctions.AzurermProviderFunctions
	// Experimental.
...
func (j *jsiiProxy_AzurermProvider) Functions() providerfunctions.AzurermProviderFunctions {
	var returns providerfunctions.AzurermProviderFunctions
	_jsii_.Get(
		j,
		"functions",
		&returns,
...
func (a *jsiiProxy_AzurermProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AzurermProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
