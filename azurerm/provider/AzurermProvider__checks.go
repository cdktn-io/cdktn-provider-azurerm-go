...
func (j *jsiiProxy_AzurermProvider) validateSetEnhancedValidationParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*AzurermProviderEnhancedValidation:
		val := val.(*[]*AzurermProviderEnhancedValidation)
	...
	case []*AzurermProviderEnhancedValidation:
		val_ := val.([]*AzurermProviderEnhancedValidation)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*AzurermProviderEnhancedValidation; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_AzurermProvider) validateSetFeaturesParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*AzurermProviderFeatures; received %#v (a %T)", val, val)
		}
	}
