...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "msiApiVersion", GoGetter: "MsiApiVersion"},
			_jsii_.MemberProperty{JsiiProperty: "msiApiVersionInput", GoGetter: "MsiApiVersionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMsiApiVersion", GoMethod: "ResetMsiApiVersion"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUseAksWorkloadIdentity", GoMethod: "ResetUseAksWorkloadIdentity"},
			...
			_jsii_.MemberProperty{JsiiProperty: "resourceProviderRegistrations", GoGetter: "ResourceProviderRegistrations"},
			...
			_jsii_.MemberProperty{JsiiProperty: "useAksWorkloadIdentity", GoGetter: "UseAksWorkloadIdentity"},
			_jsii_.MemberProperty{JsiiProperty: "useAksWorkloadIdentityInput", GoGetter: "UseAksWorkloadIdentityInput"},
