...
func (l *jsiiProxy_LogAnalyticsSolutionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsSolutionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
