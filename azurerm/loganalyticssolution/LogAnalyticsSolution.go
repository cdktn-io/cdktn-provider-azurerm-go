...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/loganalyticssolution/internal"
...
func (j *jsiiProxy_LogAnalyticsSolution) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LogAnalyticsSolution) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LogAnalyticsSolution) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LogAnalyticsSolution) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LogAnalyticsSolution) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LogAnalyticsSolution) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/log_analytics_solution azurerm_log_analytics_solution} Resource.
func NewLogAnalyticsSolution(scope constructs.Construct, id *string, config *LogAnalyticsSolutionConfig) LogAnalyticsSolution {
	_init_.Initialize()

	if err := validateNewLogAnalyticsSolutionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LogAnalyticsSolution)SetCount(val interface{}) {
...
func (j *jsiiProxy_LogAnalyticsSolution)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LogAnalyticsSolution)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LogAnalyticsSolution)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_LogAnalyticsSolution)SetSolutionName(val *string) {
	if err := j.validateSetSolutionNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func LogAnalyticsSolution_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateLogAnalyticsSolution_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LogAnalyticsSolution_IsConstruct(x interface{}) *bool {
	...
	if err := validateLogAnalyticsSolution_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LogAnalyticsSolution_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLogAnalyticsSolution_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LogAnalyticsSolution_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLogAnalyticsSolution_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LogAnalyticsSolution) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LogAnalyticsSolution) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsSolution) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogAnalyticsSolution) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LogAnalyticsSolution) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsSolution) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogAnalyticsSolution) MoveFromId(id *string) {
...
func (l *jsiiProxy_LogAnalyticsSolution) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LogAnalyticsSolution) MoveToId(id *string) {
...
func (l *jsiiProxy_LogAnalyticsSolution) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogAnalyticsSolution) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LogAnalyticsSolution) ToHclTerraform() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogAnalyticsSolution) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
