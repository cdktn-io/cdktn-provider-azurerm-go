...
func (j *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference) StorageAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageAccountId",
...
func (j *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference) StorageAccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference) StorageContainerUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageContainerUrl",
...
func (j *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference) StorageContainerUrlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightSparkClusterStorageAccountOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) HdinsightSparkClusterStorageAccountOutputReference {
	_init_.Initialize()
...
func NewHdinsightSparkClusterStorageAccountOutputReference_Override(h HdinsightSparkClusterStorageAccountOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference)SetStorageAccountId(val *string) {
...
func (j *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference)SetStorageContainerUrl(val *string) {
...
func (j *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference) ResetStorageAccountId() {
	_jsii_.InvokeVoid(
		h,
		"resetStorageAccountId",
		nil, // no parameters
...
func (h *jsiiProxy_HdinsightSparkClusterStorageAccountOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
