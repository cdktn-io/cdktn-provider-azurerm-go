...
func (h *jsiiProxy_HdinsightSparkClusterDiskEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightSparkClusterDiskEncryptionList) Resolve(context cdktf.IResolveContext) interface{} {
