...
func (j *jsiiProxy_HdinsightSparkClusterDiskEncryptionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightSparkClusterDiskEncryptionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightSparkClusterDiskEncryptionList {
	_init_.Initialize()
...
func NewHdinsightSparkClusterDiskEncryptionList_Override(h HdinsightSparkClusterDiskEncryptionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightSparkClusterDiskEncryptionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightSparkClusterDiskEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightSparkClusterDiskEncryptionList) Resolve(context cdktn.IResolveContext) interface{} {
