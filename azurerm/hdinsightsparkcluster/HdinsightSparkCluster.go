...
func (j *jsiiProxy_HdinsightSparkCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_HdinsightSparkCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_HdinsightSparkCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_HdinsightSparkCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_HdinsightSparkCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/hdinsight_spark_cluster azurerm_hdinsight_spark_cluster} Resource.
...
func (j *jsiiProxy_HdinsightSparkCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_HdinsightSparkCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_HdinsightSparkCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func HdinsightSparkCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (h *jsiiProxy_HdinsightSparkCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightSparkCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (h *jsiiProxy_HdinsightSparkCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightSparkCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HdinsightSparkCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HdinsightSparkCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
