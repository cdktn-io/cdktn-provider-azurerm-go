...
func (h *jsiiProxy_HdinsightSparkClusterMetastoresHiveOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightSparkClusterMetastoresHiveOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
