...
func (j *jsiiProxy_StorageAccountQueuePropertiesCorsRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountQueuePropertiesCorsRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StorageAccountQueuePropertiesCorsRuleList {
	_init_.Initialize()
...
func NewStorageAccountQueuePropertiesCorsRuleList_Override(s StorageAccountQueuePropertiesCorsRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountQueuePropertiesCorsRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountQueuePropertiesCorsRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageAccountQueuePropertiesCorsRuleList) Resolve(context cdktn.IResolveContext) interface{} {
