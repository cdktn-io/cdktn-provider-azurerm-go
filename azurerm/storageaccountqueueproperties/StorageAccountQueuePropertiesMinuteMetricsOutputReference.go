...
func (j *jsiiProxy_StorageAccountQueuePropertiesMinuteMetricsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountQueuePropertiesMinuteMetricsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StorageAccountQueuePropertiesMinuteMetricsOutputReference {
	_init_.Initialize()
...
func NewStorageAccountQueuePropertiesMinuteMetricsOutputReference_Override(s StorageAccountQueuePropertiesMinuteMetricsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountQueuePropertiesMinuteMetricsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountQueuePropertiesMinuteMetricsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountQueuePropertiesMinuteMetricsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageAccountQueuePropertiesMinuteMetricsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountQueuePropertiesMinuteMetricsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
