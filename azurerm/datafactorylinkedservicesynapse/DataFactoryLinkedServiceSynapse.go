...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/datafactorylinkedservicesynapse/internal"
...
func (j *jsiiProxy_DataFactoryLinkedServiceSynapse) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/data_factory_linked_service_synapse azurerm_data_factory_linked_service_synapse} Resource.
func NewDataFactoryLinkedServiceSynapse(scope constructs.Construct, id *string, config *DataFactoryLinkedServiceSynapseConfig) DataFactoryLinkedServiceSynapse {
	...
	if err := validateNewDataFactoryLinkedServiceSynapseParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataFactoryLinkedServiceSynapse)SetCount(val interface{}) {
...
func DataFactoryLinkedServiceSynapse_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataFactoryLinkedServiceSynapse_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryLinkedServiceSynapse_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryLinkedServiceSynapse_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryLinkedServiceSynapse_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryLinkedServiceSynapse_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataFactoryLinkedServiceSynapse) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceSynapse) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataFactoryLinkedServiceSynapse) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryLinkedServiceSynapse) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceSynapse) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceSynapse) MoveToId(id *string) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceSynapse) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceSynapse) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataFactoryLinkedServiceSynapse) ToHclTerraform() interface{} {
	var returns interface{}
