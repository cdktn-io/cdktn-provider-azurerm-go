...
func (h *jsiiProxy_HdinsightKafkaClusterPrivateLinkConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterPrivateLinkConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
