...
func (j *jsiiProxy_HdinsightKafkaClusterGatewayOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightKafkaClusterGatewayOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightKafkaClusterGatewayOutputReference {
	_init_.Initialize()
...
func NewHdinsightKafkaClusterGatewayOutputReference_Override(h HdinsightKafkaClusterGatewayOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightKafkaClusterGatewayOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightKafkaClusterGatewayOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterGatewayOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightKafkaClusterGatewayOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterGatewayOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
