...
func (j *jsiiProxy_HdinsightKafkaClusterStorageAccountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightKafkaClusterStorageAccountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightKafkaClusterStorageAccountList {
	_init_.Initialize()
...
func NewHdinsightKafkaClusterStorageAccountList_Override(h HdinsightKafkaClusterStorageAccountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightKafkaClusterStorageAccountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightKafkaClusterStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightKafkaClusterStorageAccountList) Resolve(context cdktn.IResolveContext) interface{} {
