...
func (j *jsiiProxy_HdinsightKafkaClusterSecurityProfileOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightKafkaClusterSecurityProfileOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightKafkaClusterSecurityProfileOutputReference {
	_init_.Initialize()
...
func NewHdinsightKafkaClusterSecurityProfileOutputReference_Override(h HdinsightKafkaClusterSecurityProfileOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightKafkaClusterSecurityProfileOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightKafkaClusterSecurityProfileOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterSecurityProfileOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightKafkaClusterSecurityProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterSecurityProfileOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
