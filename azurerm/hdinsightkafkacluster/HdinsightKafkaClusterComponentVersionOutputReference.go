...
func (j *jsiiProxy_HdinsightKafkaClusterComponentVersionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightKafkaClusterComponentVersionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightKafkaClusterComponentVersionOutputReference {
	_init_.Initialize()

	if err := validateNewHdinsightKafkaClusterComponentVersionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewHdinsightKafkaClusterComponentVersionOutputReference_Override(h HdinsightKafkaClusterComponentVersionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightKafkaClusterComponentVersionOutputReference)SetKafka(val *string) {
	if err := j.validateSetKafkaParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_HdinsightKafkaClusterComponentVersionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightKafkaClusterComponentVersionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterComponentVersionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightKafkaClusterComponentVersionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterComponentVersionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
