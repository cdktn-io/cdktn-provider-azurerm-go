...
func (h *jsiiProxy_HdinsightKafkaClusterComponentVersionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterComponentVersionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
