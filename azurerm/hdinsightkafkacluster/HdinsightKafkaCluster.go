...
func (j *jsiiProxy_HdinsightKafkaCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_HdinsightKafkaCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_HdinsightKafkaCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_HdinsightKafkaCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_HdinsightKafkaCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_HdinsightKafkaCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_HdinsightKafkaCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_HdinsightKafkaCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func HdinsightKafkaCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (h *jsiiProxy_HdinsightKafkaCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (h *jsiiProxy_HdinsightKafkaCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HdinsightKafkaCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HdinsightKafkaCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
