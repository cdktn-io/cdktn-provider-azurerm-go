...
func (j *jsiiProxy_HdinsightKafkaClusterDiskEncryptionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightKafkaClusterDiskEncryptionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightKafkaClusterDiskEncryptionList {
	_init_.Initialize()
...
func NewHdinsightKafkaClusterDiskEncryptionList_Override(h HdinsightKafkaClusterDiskEncryptionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightKafkaClusterDiskEncryptionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightKafkaClusterDiskEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightKafkaClusterDiskEncryptionList) Resolve(context cdktn.IResolveContext) interface{} {
