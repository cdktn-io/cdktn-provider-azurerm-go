...
func (j *jsiiProxy_HdinsightKafkaClusterComputeIsolationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightKafkaClusterComputeIsolationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightKafkaClusterComputeIsolationOutputReference {
	_init_.Initialize()
...
func NewHdinsightKafkaClusterComputeIsolationOutputReference_Override(h HdinsightKafkaClusterComputeIsolationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightKafkaClusterComputeIsolationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightKafkaClusterComputeIsolationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterComputeIsolationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightKafkaClusterComputeIsolationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterComputeIsolationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
