...
func (j *jsiiProxy_HdinsightKafkaClusterRolesKafkaManagementNodeScriptActionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightKafkaClusterRolesKafkaManagementNodeScriptActionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightKafkaClusterRolesKafkaManagementNodeScriptActionsList {
	_init_.Initialize()
...
func NewHdinsightKafkaClusterRolesKafkaManagementNodeScriptActionsList_Override(h HdinsightKafkaClusterRolesKafkaManagementNodeScriptActionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightKafkaClusterRolesKafkaManagementNodeScriptActionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightKafkaClusterRolesKafkaManagementNodeScriptActionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightKafkaClusterRolesKafkaManagementNodeScriptActionsList) Resolve(context cdktn.IResolveContext) interface{} {
