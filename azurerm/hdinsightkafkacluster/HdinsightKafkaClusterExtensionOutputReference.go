...
func (j *jsiiProxy_HdinsightKafkaClusterExtensionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightKafkaClusterExtensionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightKafkaClusterExtensionOutputReference {
	_init_.Initialize()
...
func NewHdinsightKafkaClusterExtensionOutputReference_Override(h HdinsightKafkaClusterExtensionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightKafkaClusterExtensionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightKafkaClusterExtensionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterExtensionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightKafkaClusterExtensionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterExtensionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
