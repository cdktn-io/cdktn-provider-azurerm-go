...
func (h *jsiiProxy_HdinsightKafkaClusterExtensionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterExtensionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
