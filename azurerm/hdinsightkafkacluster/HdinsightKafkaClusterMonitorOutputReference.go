...
func (h *jsiiProxy_HdinsightKafkaClusterMonitorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterMonitorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
