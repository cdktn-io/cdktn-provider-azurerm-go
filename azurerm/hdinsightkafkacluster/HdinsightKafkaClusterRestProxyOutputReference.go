...
func (h *jsiiProxy_HdinsightKafkaClusterRestProxyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterRestProxyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
