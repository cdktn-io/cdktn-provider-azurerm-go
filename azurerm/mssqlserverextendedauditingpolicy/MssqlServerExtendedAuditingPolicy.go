...
func (m *jsiiProxy_MssqlServerExtendedAuditingPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MssqlServerExtendedAuditingPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MssqlServerExtendedAuditingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
