...
func (k *jsiiProxy_KeyVaultManagedHardwareSecurityModuleRoleDefinitionPermissionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyVaultManagedHardwareSecurityModuleRoleDefinitionPermissionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
