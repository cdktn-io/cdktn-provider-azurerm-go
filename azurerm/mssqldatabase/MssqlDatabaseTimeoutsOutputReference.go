...
func (j *jsiiProxy_MssqlDatabaseTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMssqlDatabaseTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MssqlDatabaseTimeoutsOutputReference {
	_init_.Initialize()
...
func NewMssqlDatabaseTimeoutsOutputReference_Override(m MssqlDatabaseTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MssqlDatabaseTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MssqlDatabaseTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlDatabaseTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MssqlDatabaseTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlDatabaseTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
