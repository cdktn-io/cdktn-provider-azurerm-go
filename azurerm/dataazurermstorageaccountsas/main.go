...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putResourceTypes", GoMethod: "PutResourceTypes"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSignedVersion", GoMethod: "ResetSignedVersion"},
			...
			_jsii_.MemberProperty{JsiiProperty: "signedVersion", GoGetter: "SignedVersion"},
			_jsii_.MemberProperty{JsiiProperty: "signedVersionInput", GoGetter: "SignedVersionInput"},
