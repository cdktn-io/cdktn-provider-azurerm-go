...
func (d *jsiiProxy_DataAzurermStorageAccountSasResourceTypesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermStorageAccountSasResourceTypesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
