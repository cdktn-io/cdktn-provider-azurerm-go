...
func (j *jsiiProxy_WebAppActiveSlotTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebAppActiveSlotTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WebAppActiveSlotTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewWebAppActiveSlotTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WebAppActiveSlotTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.webAppActiveSlot.WebAppActiveSlotTimeoutsOutputReference",
...
func NewWebAppActiveSlotTimeoutsOutputReference_Override(w WebAppActiveSlotTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebAppActiveSlotTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebAppActiveSlotTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebAppActiveSlotTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WebAppActiveSlotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebAppActiveSlotTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
