...
func (w *jsiiProxy_WebAppActiveSlotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebAppActiveSlotTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
