...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/webappactiveslot/internal"
...
func (j *jsiiProxy_WebAppActiveSlot) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WebAppActiveSlot) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WebAppActiveSlot) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WebAppActiveSlot) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WebAppActiveSlot) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/web_app_active_slot azurerm_web_app_active_slot} Resource.
func NewWebAppActiveSlot(scope constructs.Construct, id *string, config *WebAppActiveSlotConfig) WebAppActiveSlot {
	_init_.Initialize()

	if err := validateNewWebAppActiveSlotParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WebAppActiveSlot)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WebAppActiveSlot)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WebAppActiveSlot)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WebAppActiveSlot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateWebAppActiveSlot_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WebAppActiveSlot_IsConstruct(x interface{}) *bool {
	...
	if err := validateWebAppActiveSlot_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebAppActiveSlot_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebAppActiveSlot_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebAppActiveSlot_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebAppActiveSlot_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WebAppActiveSlot) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WebAppActiveSlot) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebAppActiveSlot) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WebAppActiveSlot) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WebAppActiveSlot) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebAppActiveSlot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WebAppActiveSlot) MoveFromId(id *string) {
...
func (w *jsiiProxy_WebAppActiveSlot) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WebAppActiveSlot) MoveToId(id *string) {
...
func (w *jsiiProxy_WebAppActiveSlot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WebAppActiveSlot) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WebAppActiveSlot) ToHclTerraform() interface{} {
	var returns interface{}
