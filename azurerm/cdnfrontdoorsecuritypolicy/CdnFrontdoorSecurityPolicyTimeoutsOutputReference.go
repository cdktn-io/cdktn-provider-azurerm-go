...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicyTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicyTimeoutsOutputReference) Update() *string {
	var returns *string
	_jsii_.Get(
		j,
		"update",
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicyTimeoutsOutputReference) UpdateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateInput",
...
func NewCdnFrontdoorSecurityPolicyTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CdnFrontdoorSecurityPolicyTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewCdnFrontdoorSecurityPolicyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewCdnFrontdoorSecurityPolicyTimeoutsOutputReference_Override(c CdnFrontdoorSecurityPolicyTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicyTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicyTimeoutsOutputReference)SetUpdate(val *string) {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicyTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicyTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicyTimeoutsOutputReference) ResetUpdate() {
	_jsii_.InvokeVoid(
		c,
		"resetUpdate",
		nil, // no parameters
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicyTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
