...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/cdnfrontdoorsecuritypolicy/internal"
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/cdn_frontdoor_security_policy azurerm_cdn_frontdoor_security_policy} Resource.
func NewCdnFrontdoorSecurityPolicy(scope constructs.Construct, id *string, config *CdnFrontdoorSecurityPolicyConfig) CdnFrontdoorSecurityPolicy {
	...
	if err := validateNewCdnFrontdoorSecurityPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CdnFrontdoorSecurityPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CdnFrontdoorSecurityPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCdnFrontdoorSecurityPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CdnFrontdoorSecurityPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCdnFrontdoorSecurityPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CdnFrontdoorSecurityPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCdnFrontdoorSecurityPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CdnFrontdoorSecurityPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCdnFrontdoorSecurityPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) MoveFromId(id *string) {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) MoveToId(id *string) {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) PutSecurityPolicies(value *CdnFrontdoorSecurityPolicySecurityPolicies) {
	if err := c.validatePutSecurityPoliciesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CdnFrontdoorSecurityPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
