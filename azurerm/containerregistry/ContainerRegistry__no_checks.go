...
func (c *jsiiProxy_ContainerRegistry) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	return nil
}
...
func (c *jsiiProxy_ContainerRegistry) validatePutEncryptionParameters(value interface{}) error {
	return nil
}

func (c *jsiiProxy_ContainerRegistry) validatePutGeoreplicationsParameters(value interface{}) error {
	return nil
}

func (c *jsiiProxy_ContainerRegistry) validatePutIdentityParameters(value *ContainerRegistryIdentity) error {
	return nil
}

func (c *jsiiProxy_ContainerRegistry) validatePutNetworkRuleSetParameters(value interface{}) error {
	return nil
}
...
func (c *jsiiProxy_ContainerRegistry) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	return nil
}
...
func (j *jsiiProxy_ContainerRegistry) validateSetAdminEnabledParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_ContainerRegistry) validateSetAnonymousPullEnabledParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_ContainerRegistry) validateSetDataEndpointEnabledParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_ContainerRegistry) validateSetExportPolicyEnabledParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_ContainerRegistry) validateSetPublicNetworkAccessEnabledParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_ContainerRegistry) validateSetQuarantinePolicyEnabledParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_ContainerRegistry) validateSetResourceGroupNameParameters(val *string) error {
	return nil
}
