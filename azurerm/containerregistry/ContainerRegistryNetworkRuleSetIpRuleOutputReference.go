...
func (c *jsiiProxy_ContainerRegistryNetworkRuleSetIpRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryNetworkRuleSetIpRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
