...
func (c *jsiiProxy_ContainerRegistryTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
