...
func (j *jsiiProxy_ContainerRegistryEncryptionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerRegistryEncryptionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerRegistryEncryptionList {
	_init_.Initialize()
...
func NewContainerRegistryEncryptionList_Override(c ContainerRegistryEncryptionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerRegistryEncryptionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerRegistryEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryEncryptionList) Resolve(context cdktn.IResolveContext) interface{} {
