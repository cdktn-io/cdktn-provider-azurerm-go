...
func (c *jsiiProxy_ContainerRegistryGeoreplicationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryGeoreplicationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
