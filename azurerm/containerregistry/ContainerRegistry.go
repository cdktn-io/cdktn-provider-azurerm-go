...
func (j *jsiiProxy_ContainerRegistry) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ContainerRegistry) DataEndpointHostNames() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerRegistry) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ContainerRegistry) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ContainerRegistry) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ContainerRegistry) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/container_registry azurerm_container_registry} Resource.
...
func (j *jsiiProxy_ContainerRegistry)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ContainerRegistry)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ContainerRegistry)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ContainerRegistry_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ContainerRegistry) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerRegistry) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ContainerRegistry) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerRegistry) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ContainerRegistry) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ContainerRegistry) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
