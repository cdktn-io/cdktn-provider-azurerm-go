...
func (c *jsiiProxy_ContainerRegistryIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
