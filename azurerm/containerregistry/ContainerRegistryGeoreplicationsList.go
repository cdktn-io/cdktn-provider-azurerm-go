...
func (c *jsiiProxy_ContainerRegistryGeoreplicationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryGeoreplicationsList) Resolve(context cdktf.IResolveContext) interface{} {
