...
func (j *jsiiProxy_ContainerRegistryGeoreplicationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerRegistryGeoreplicationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerRegistryGeoreplicationsList {
	_init_.Initialize()

	if err := validateNewContainerRegistryGeoreplicationsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewContainerRegistryGeoreplicationsList_Override(c ContainerRegistryGeoreplicationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerRegistryGeoreplicationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerRegistryGeoreplicationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryGeoreplicationsList) Resolve(context cdktn.IResolveContext) interface{} {
