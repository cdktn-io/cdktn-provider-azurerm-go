...
func (c *jsiiProxy_ContainerRegistryNetworkRuleSetIpRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryNetworkRuleSetIpRuleList) Resolve(context cdktf.IResolveContext) interface{} {
