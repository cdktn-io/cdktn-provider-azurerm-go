...
func (j *jsiiProxy_ContainerRegistryNetworkRuleSetIpRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerRegistryNetworkRuleSetIpRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerRegistryNetworkRuleSetIpRuleList {
	_init_.Initialize()

	if err := validateNewContainerRegistryNetworkRuleSetIpRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewContainerRegistryNetworkRuleSetIpRuleList_Override(c ContainerRegistryNetworkRuleSetIpRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerRegistryNetworkRuleSetIpRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerRegistryNetworkRuleSetIpRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryNetworkRuleSetIpRuleList) Resolve(context cdktn.IResolveContext) interface{} {
