...
func (j *jsiiProxy_ContainerRegistryNetworkRuleSetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerRegistryNetworkRuleSetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerRegistryNetworkRuleSetList {
	_init_.Initialize()

	if err := validateNewContainerRegistryNetworkRuleSetListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewContainerRegistryNetworkRuleSetList_Override(c ContainerRegistryNetworkRuleSetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerRegistryNetworkRuleSetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerRegistryNetworkRuleSetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryNetworkRuleSetList) Resolve(context cdktn.IResolveContext) interface{} {
