...
func (c *jsiiProxy_ContainerRegistryNetworkRuleSetList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryNetworkRuleSetList) Resolve(context cdktf.IResolveContext) interface{} {
