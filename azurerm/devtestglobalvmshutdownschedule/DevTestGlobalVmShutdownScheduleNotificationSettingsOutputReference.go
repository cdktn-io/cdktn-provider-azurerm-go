...
func (d *jsiiProxy_DevTestGlobalVmShutdownScheduleNotificationSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DevTestGlobalVmShutdownScheduleNotificationSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
