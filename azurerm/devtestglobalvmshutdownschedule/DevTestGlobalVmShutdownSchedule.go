...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/devtestglobalvmshutdownschedule/internal"
...
func (j *jsiiProxy_DevTestGlobalVmShutdownSchedule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DevTestGlobalVmShutdownSchedule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DevTestGlobalVmShutdownSchedule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DevTestGlobalVmShutdownSchedule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DevTestGlobalVmShutdownSchedule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DevTestGlobalVmShutdownSchedule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DevTestGlobalVmShutdownSchedule)SetCount(val interface{}) {
...
func (j *jsiiProxy_DevTestGlobalVmShutdownSchedule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DevTestGlobalVmShutdownSchedule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DevTestGlobalVmShutdownSchedule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DevTestGlobalVmShutdownSchedule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDevTestGlobalVmShutdownSchedule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) MoveFromId(id *string) {
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) MoveToId(id *string) {
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
