...
func DevTestGlobalVmShutdownSchedule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DevTestGlobalVmShutdownSchedule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
