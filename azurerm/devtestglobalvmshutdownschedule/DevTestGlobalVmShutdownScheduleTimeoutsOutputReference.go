...
func (d *jsiiProxy_DevTestGlobalVmShutdownScheduleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DevTestGlobalVmShutdownScheduleTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
