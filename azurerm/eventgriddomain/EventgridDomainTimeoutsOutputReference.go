...
func (e *jsiiProxy_EventgridDomainTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventgridDomainTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
