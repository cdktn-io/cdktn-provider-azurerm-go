...
func (j *jsiiProxy_EventgridDomainInboundIpRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridDomainInboundIpRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridDomainInboundIpRuleList {
	_init_.Initialize()
...
func NewEventgridDomainInboundIpRuleList_Override(e EventgridDomainInboundIpRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridDomainInboundIpRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridDomainInboundIpRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridDomainInboundIpRuleList) Resolve(context cdktn.IResolveContext) interface{} {
