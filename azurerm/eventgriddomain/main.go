...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoCreateTopicWithFirstSubscription", GoGetter: "AutoCreateTopicWithFirstSubscription"},
			_jsii_.MemberProperty{JsiiProperty: "autoCreateTopicWithFirstSubscriptionInput", GoGetter: "AutoCreateTopicWithFirstSubscriptionInput"},
			_jsii_.MemberProperty{JsiiProperty: "autoDeleteTopicWithLastSubscription", GoGetter: "AutoDeleteTopicWithLastSubscription"},
			_jsii_.MemberProperty{JsiiProperty: "autoDeleteTopicWithLastSubscriptionInput", GoGetter: "AutoDeleteTopicWithLastSubscriptionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutoCreateTopicWithFirstSubscription", GoMethod: "ResetAutoCreateTopicWithFirstSubscription"},
			_jsii_.MemberMethod{JsiiMethod: "resetAutoDeleteTopicWithLastSubscription", GoMethod: "ResetAutoDeleteTopicWithLastSubscription"},
