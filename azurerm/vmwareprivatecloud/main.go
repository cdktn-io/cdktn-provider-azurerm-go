...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "networkSubnetCidrInput", GoGetter: "NetworkSubnetCidrInput"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberProperty{JsiiProperty: "nsxtCertificateThumbprint", GoGetter: "NsxtCertificateThumbprint"},
			_jsii_.MemberProperty{JsiiProperty: "nsxtManagerEndpoint", GoGetter: "NsxtManagerEndpoint"},
			_jsii_.MemberProperty{JsiiProperty: "nsxtPassword", GoGetter: "NsxtPassword"},
			_jsii_.MemberProperty{JsiiProperty: "nsxtPasswordInput", GoGetter: "NsxtPasswordInput"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberProperty{JsiiProperty: "provisioningSubnetCidr", GoGetter: "ProvisioningSubnetCidr"},
			_jsii_.MemberMethod{JsiiMethod: "putManagementCluster", GoMethod: "PutManagementCluster"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetInternetConnectionEnabled", GoMethod: "ResetInternetConnectionEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetNsxtPassword", GoMethod: "ResetNsxtPassword"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "resetVcenterPassword", GoMethod: "ResetVcenterPassword"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vcenterCertificateThumbprint", GoGetter: "VcenterCertificateThumbprint"},
			_jsii_.MemberProperty{JsiiProperty: "vcenterPassword", GoGetter: "VcenterPassword"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "expressRouteId", GoGetter: "ExpressRouteId"},
			_jsii_.MemberProperty{JsiiProperty: "expressRoutePrivatePeeringId", GoGetter: "ExpressRoutePrivatePeeringId"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "primarySubnetCidr", GoGetter: "PrimarySubnetCidr"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "secondarySubnetCidr", GoGetter: "SecondarySubnetCidr"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
