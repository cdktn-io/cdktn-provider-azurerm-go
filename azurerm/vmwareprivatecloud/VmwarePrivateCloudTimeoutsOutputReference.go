...
func (v *jsiiProxy_VmwarePrivateCloudTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VmwarePrivateCloudTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
