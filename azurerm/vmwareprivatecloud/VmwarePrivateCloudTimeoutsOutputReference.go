...
func (j *jsiiProxy_VmwarePrivateCloudTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVmwarePrivateCloudTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VmwarePrivateCloudTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewVmwarePrivateCloudTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewVmwarePrivateCloudTimeoutsOutputReference_Override(v VmwarePrivateCloudTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_VmwarePrivateCloudTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VmwarePrivateCloudTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VmwarePrivateCloudTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VmwarePrivateCloudTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VmwarePrivateCloudTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
