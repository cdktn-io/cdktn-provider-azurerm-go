...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/vmwareprivatecloud/internal"
...
func (j *jsiiProxy_VmwarePrivateCloudCircuitOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVmwarePrivateCloudCircuitOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VmwarePrivateCloudCircuitOutputReference {
	_init_.Initialize()

	if err := validateNewVmwarePrivateCloudCircuitOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewVmwarePrivateCloudCircuitOutputReference_Override(v VmwarePrivateCloudCircuitOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VmwarePrivateCloudCircuitOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VmwarePrivateCloudCircuitOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VmwarePrivateCloudCircuitOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VmwarePrivateCloudCircuitOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VmwarePrivateCloudCircuitOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
