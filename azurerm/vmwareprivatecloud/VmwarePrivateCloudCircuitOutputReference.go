...
func (v *jsiiProxy_VmwarePrivateCloudCircuitOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VmwarePrivateCloudCircuitOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
