...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/vmware_private_cloud azurerm_vmware_private_cloud} Resource.
...
func (v *jsiiProxy_VmwarePrivateCloud) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VmwarePrivateCloud) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VmwarePrivateCloud) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
