...
func (v *jsiiProxy_VirtualDesktopScalingPlanScheduleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanScheduleList) Resolve(context cdktf.IResolveContext) interface{} {
