...
func (j *jsiiProxy_VirtualDesktopScalingPlanScheduleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualDesktopScalingPlanScheduleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualDesktopScalingPlanScheduleList {
	_init_.Initialize()
...
func NewVirtualDesktopScalingPlanScheduleList_Override(v VirtualDesktopScalingPlanScheduleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualDesktopScalingPlanScheduleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanScheduleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanScheduleList) Resolve(context cdktn.IResolveContext) interface{} {
