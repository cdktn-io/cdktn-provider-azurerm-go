...
func (j *jsiiProxy_VirtualDesktopScalingPlanHostPoolList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualDesktopScalingPlanHostPoolList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualDesktopScalingPlanHostPoolList {
	_init_.Initialize()
...
func NewVirtualDesktopScalingPlanHostPoolList_Override(v VirtualDesktopScalingPlanHostPoolList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualDesktopScalingPlanHostPoolList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanHostPoolList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanHostPoolList) Resolve(context cdktn.IResolveContext) interface{} {
