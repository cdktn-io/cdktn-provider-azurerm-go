...
func (j *jsiiProxy_VirtualDesktopScalingPlanScheduleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualDesktopScalingPlanScheduleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualDesktopScalingPlanScheduleOutputReference {
	_init_.Initialize()
...
func NewVirtualDesktopScalingPlanScheduleOutputReference_Override(v VirtualDesktopScalingPlanScheduleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualDesktopScalingPlanScheduleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanScheduleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanScheduleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualDesktopScalingPlanScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanScheduleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
