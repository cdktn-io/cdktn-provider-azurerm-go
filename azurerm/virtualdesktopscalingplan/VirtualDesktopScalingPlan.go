...
func (j *jsiiProxy_VirtualDesktopScalingPlan) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VirtualDesktopScalingPlan) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VirtualDesktopScalingPlan) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VirtualDesktopScalingPlan) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VirtualDesktopScalingPlan) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VirtualDesktopScalingPlan) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/virtual_desktop_scaling_plan azurerm_virtual_desktop_scaling_plan} Resource.
func NewVirtualDesktopScalingPlan(scope constructs.Construct, id *string, config *VirtualDesktopScalingPlanConfig) VirtualDesktopScalingPlan {
	...
	if err := validateNewVirtualDesktopScalingPlanParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_VirtualDesktopScalingPlan)SetCount(val interface{}) {
...
func (j *jsiiProxy_VirtualDesktopScalingPlan)SetExclusionTag(val *string) {
	if err := j.validateSetExclusionTagParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VirtualDesktopScalingPlan)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VirtualDesktopScalingPlan)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VirtualDesktopScalingPlan)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VirtualDesktopScalingPlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateVirtualDesktopScalingPlan_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VirtualDesktopScalingPlan_IsConstruct(x interface{}) *bool {
	...
	if err := validateVirtualDesktopScalingPlan_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VirtualDesktopScalingPlan_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVirtualDesktopScalingPlan_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VirtualDesktopScalingPlan_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVirtualDesktopScalingPlan_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) MoveFromId(id *string) {
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) MoveToId(id *string) {
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) PutHostPool(value interface{}) {
	if err := v.validatePutHostPoolParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		v,
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) PutSchedule(value interface{}) {
	if err := v.validatePutScheduleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		v,
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) ToHclTerraform() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VirtualDesktopScalingPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
