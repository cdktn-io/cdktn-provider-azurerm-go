...
func (j *jsiiProxy_VirtualDesktopScalingPlanHostPoolOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualDesktopScalingPlanHostPoolOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualDesktopScalingPlanHostPoolOutputReference {
	_init_.Initialize()
...
func NewVirtualDesktopScalingPlanHostPoolOutputReference_Override(v VirtualDesktopScalingPlanHostPoolOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualDesktopScalingPlanHostPoolOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanHostPoolOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanHostPoolOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualDesktopScalingPlanHostPoolOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanHostPoolOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
