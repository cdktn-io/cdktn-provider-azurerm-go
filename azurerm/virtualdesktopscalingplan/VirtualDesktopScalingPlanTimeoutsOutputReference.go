...
func (j *jsiiProxy_VirtualDesktopScalingPlanTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualDesktopScalingPlanTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VirtualDesktopScalingPlanTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewVirtualDesktopScalingPlanTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewVirtualDesktopScalingPlanTimeoutsOutputReference_Override(v VirtualDesktopScalingPlanTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualDesktopScalingPlanTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualDesktopScalingPlanTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
