...
func (v *jsiiProxy_VirtualDesktopScalingPlanTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
