...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/mssqlelasticpool/internal"
...
func (j *jsiiProxy_MssqlElasticpool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MssqlElasticpool) EnclaveType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"enclaveType",
...
func (j *jsiiProxy_MssqlElasticpool) EnclaveTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"enclaveTypeInput",
...
func (j *jsiiProxy_MssqlElasticpool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MssqlElasticpool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MssqlElasticpool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MssqlElasticpool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/mssql_elasticpool azurerm_mssql_elasticpool} Resource.
...
func (j *jsiiProxy_MssqlElasticpool)SetEnclaveType(val *string) {
...
func (j *jsiiProxy_MssqlElasticpool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MssqlElasticpool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MssqlElasticpool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MssqlElasticpool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MssqlElasticpool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlElasticpool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MssqlElasticpool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlElasticpool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MssqlElasticpool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MssqlElasticpool) ResetEnclaveType() {
	_jsii_.InvokeVoid(
		m,
		"resetEnclaveType",
		nil, // no parameters
...
func (m *jsiiProxy_MssqlElasticpool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
