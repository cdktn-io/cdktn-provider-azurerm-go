...
func (m *jsiiProxy_MssqlElasticpoolTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MssqlElasticpoolTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
