...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enclaveTypeInput", GoGetter: "EnclaveTypeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "highAvailabilityReplicaCountInput", GoGetter: "HighAvailabilityReplicaCountInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetHighAvailabilityReplicaCount", GoMethod: "ResetHighAvailabilityReplicaCount"},
