...
func (m *jsiiProxy_MssqlElasticpoolPerDatabaseSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MssqlElasticpoolPerDatabaseSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
