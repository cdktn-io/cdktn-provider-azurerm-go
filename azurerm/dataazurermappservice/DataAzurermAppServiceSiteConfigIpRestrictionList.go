...
func (d *jsiiProxy_DataAzurermAppServiceSiteConfigIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermAppServiceSiteConfigIpRestrictionList) Resolve(context cdktf.IResolveContext) interface{} {
