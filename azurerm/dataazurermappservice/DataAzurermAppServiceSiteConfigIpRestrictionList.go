...
func (j *jsiiProxy_DataAzurermAppServiceSiteConfigIpRestrictionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermAppServiceSiteConfigIpRestrictionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermAppServiceSiteConfigIpRestrictionList {
	_init_.Initialize()
...
func NewDataAzurermAppServiceSiteConfigIpRestrictionList_Override(d DataAzurermAppServiceSiteConfigIpRestrictionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermAppServiceSiteConfigIpRestrictionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermAppServiceSiteConfigIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermAppServiceSiteConfigIpRestrictionList) Resolve(context cdktn.IResolveContext) interface{} {
