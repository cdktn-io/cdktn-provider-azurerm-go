...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.dataAzurermServicebusSubscription.DataAzurermServicebusSubscriptionConfig",
		reflect.TypeOf((*DataAzurermServicebusSubscriptionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.dataAzurermServicebusSubscription.DataAzurermServicebusSubscriptionTimeouts",
