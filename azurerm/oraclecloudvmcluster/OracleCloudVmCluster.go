...
func (j *jsiiProxy_OracleCloudVmCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_OracleCloudVmCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_OracleCloudVmCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OracleCloudVmCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_OracleCloudVmCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/oracle_cloud_vm_cluster azurerm_oracle_cloud_vm_cluster} Resource.
...
func (j *jsiiProxy_OracleCloudVmCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OracleCloudVmCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OracleCloudVmCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OracleCloudVmCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OracleCloudVmCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OracleCloudVmCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_OracleCloudVmCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OracleCloudVmCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OracleCloudVmCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OracleCloudVmCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
