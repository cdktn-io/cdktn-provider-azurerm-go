...
func (o *jsiiProxy_OracleCloudVmClusterDataCollectionOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OracleCloudVmClusterDataCollectionOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
