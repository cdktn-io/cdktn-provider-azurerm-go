...
func (j *jsiiProxy_FunctionAppFlexConsumptionSiteConfigScmIpRestrictionHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppFlexConsumptionSiteConfigScmIpRestrictionHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FunctionAppFlexConsumptionSiteConfigScmIpRestrictionHeadersList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.functionAppFlexConsumption.FunctionAppFlexConsumptionSiteConfigScmIpRestrictionHeadersList",
...
func NewFunctionAppFlexConsumptionSiteConfigScmIpRestrictionHeadersList_Override(f FunctionAppFlexConsumptionSiteConfigScmIpRestrictionHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppFlexConsumptionSiteConfigScmIpRestrictionHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppFlexConsumptionSiteConfigScmIpRestrictionHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FunctionAppFlexConsumptionSiteConfigScmIpRestrictionHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
