...
func (j *jsiiProxy_AvailabilitySet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AvailabilitySet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AvailabilitySet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AvailabilitySet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AvailabilitySet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AvailabilitySet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AvailabilitySet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AvailabilitySet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AvailabilitySet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AvailabilitySet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AvailabilitySet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AvailabilitySet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AvailabilitySet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AvailabilitySet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AvailabilitySet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
