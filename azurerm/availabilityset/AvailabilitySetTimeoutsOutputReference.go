...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/availabilityset/internal"
...
func (j *jsiiProxy_AvailabilitySetTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAvailabilitySetTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AvailabilitySetTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewAvailabilitySetTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAvailabilitySetTimeoutsOutputReference_Override(a AvailabilitySetTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AvailabilitySetTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AvailabilitySetTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AvailabilitySetTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AvailabilitySetTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AvailabilitySetTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
