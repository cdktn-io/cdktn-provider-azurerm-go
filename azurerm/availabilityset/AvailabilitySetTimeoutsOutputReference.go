...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/availabilityset/internal"
...
func (a *jsiiProxy_AvailabilitySetTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AvailabilitySetTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
