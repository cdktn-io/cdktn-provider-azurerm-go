...
func (l *jsiiProxy_LogAnalyticsDatasourceWindowsPerformanceCounter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogAnalyticsDatasourceWindowsPerformanceCounter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogAnalyticsDatasourceWindowsPerformanceCounter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
