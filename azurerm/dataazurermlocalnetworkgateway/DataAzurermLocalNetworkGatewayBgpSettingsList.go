...
func (j *jsiiProxy_DataAzurermLocalNetworkGatewayBgpSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermLocalNetworkGatewayBgpSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermLocalNetworkGatewayBgpSettingsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermLocalNetworkGateway.DataAzurermLocalNetworkGatewayBgpSettingsList",
...
func NewDataAzurermLocalNetworkGatewayBgpSettingsList_Override(d DataAzurermLocalNetworkGatewayBgpSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermLocalNetworkGatewayBgpSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermLocalNetworkGatewayBgpSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLocalNetworkGatewayBgpSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
