...
func (j *jsiiProxy_ElasticSanVolume) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ElasticSanVolume) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ElasticSanVolume) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ElasticSanVolume) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ElasticSanVolume) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/elastic_san_volume azurerm_elastic_san_volume} Resource.
...
func (j *jsiiProxy_ElasticSanVolume)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ElasticSanVolume)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ElasticSanVolume)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (e *jsiiProxy_ElasticSanVolume) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_ElasticSanVolume) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_ElasticSanVolume) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
