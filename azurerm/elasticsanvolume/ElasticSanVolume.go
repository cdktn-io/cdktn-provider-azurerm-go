...
func (e *jsiiProxy_ElasticSanVolume) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_ElasticSanVolume) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
