...
func (d *jsiiProxy_DataAzurermFirewallVirtualHubList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermFirewallVirtualHubList) Resolve(context cdktf.IResolveContext) interface{} {
