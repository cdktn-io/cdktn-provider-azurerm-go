...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/relayhybridconnectionauthorizationrule/internal"
...
func (j *jsiiProxy_RelayHybridConnectionAuthorizationRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RelayHybridConnectionAuthorizationRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RelayHybridConnectionAuthorizationRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RelayHybridConnectionAuthorizationRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RelayHybridConnectionAuthorizationRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/relay_hybrid_connection_authorization_rule azurerm_relay_hybrid_connection_authorization_rule} Resource.
...
func (j *jsiiProxy_RelayHybridConnectionAuthorizationRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RelayHybridConnectionAuthorizationRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RelayHybridConnectionAuthorizationRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RelayHybridConnectionAuthorizationRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateRelayHybridConnectionAuthorizationRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) MoveFromId(id *string) {
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) MoveToId(id *string) {
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) ToHclTerraform() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RelayHybridConnectionAuthorizationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
