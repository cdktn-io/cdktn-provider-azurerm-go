...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/apimanagementauthorizationserver/internal"
...
func (j *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementAuthorizationServerTokenBodyParameterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementAuthorizationServerTokenBodyParameterOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementAuthorizationServerTokenBodyParameterOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementAuthorizationServer.ApiManagementAuthorizationServerTokenBodyParameterOutputReference",
...
func NewApiManagementAuthorizationServerTokenBodyParameterOutputReference_Override(a ApiManagementAuthorizationServerTokenBodyParameterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
