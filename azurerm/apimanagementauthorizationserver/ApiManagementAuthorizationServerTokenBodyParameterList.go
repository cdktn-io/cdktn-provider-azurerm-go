...
func (j *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementAuthorizationServerTokenBodyParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementAuthorizationServerTokenBodyParameterList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementAuthorizationServer.ApiManagementAuthorizationServerTokenBodyParameterList",
...
func NewApiManagementAuthorizationServerTokenBodyParameterList_Override(a ApiManagementAuthorizationServerTokenBodyParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterList) Resolve(context cdktn.IResolveContext) interface{} {
