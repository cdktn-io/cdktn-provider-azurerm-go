...
func (j *jsiiProxy_SharedImage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SharedImage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SharedImage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SharedImage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SharedImage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/shared_image azurerm_shared_image} Resource.
...
func (j *jsiiProxy_SharedImage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SharedImage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SharedImage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SharedImage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SharedImage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SharedImage) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SharedImage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SharedImage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SharedImage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SharedImage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
