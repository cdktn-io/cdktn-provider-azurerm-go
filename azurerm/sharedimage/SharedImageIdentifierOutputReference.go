...
func (s *jsiiProxy_SharedImageIdentifierOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SharedImageIdentifierOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
