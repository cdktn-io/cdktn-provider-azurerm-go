...
func (s *jsiiProxy_SharedImageTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SharedImageTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
