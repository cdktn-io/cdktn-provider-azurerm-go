...
func (j *jsiiProxy_AutomationRunbookDraftParametersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AutomationRunbookDraftParametersList) InternalValue() interface{} {
...
func (j *jsiiProxy_AutomationRunbookDraftParametersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AutomationRunbookDraftParametersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewAutomationRunbookDraftParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AutomationRunbookDraftParametersList {
	...
	j := jsiiProxy_AutomationRunbookDraftParametersList{}
...
func (j *jsiiProxy_AutomationRunbookDraftParametersList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_AutomationRunbookDraftParametersList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_AutomationRunbookDraftParametersList)SetWrapsSet(val *bool) {
...
func (a *jsiiProxy_AutomationRunbookDraftParametersList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AutomationRunbookDraftParametersList) Get(index *float64) AutomationRunbookDraftParametersOutputReference {
	if err := a.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns AutomationRunbookDraftParametersOutputReference
...
func (a *jsiiProxy_AutomationRunbookDraftParametersList) ToString() *string {
	var returns *string
