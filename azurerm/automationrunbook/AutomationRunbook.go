...
func (j *jsiiProxy_AutomationRunbook) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AutomationRunbook) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_AutomationRunbook) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AutomationRunbook) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AutomationRunbook) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AutomationRunbook) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/automation_runbook azurerm_automation_runbook} Resource.
func NewAutomationRunbook(scope constructs.Construct, id *string, config *AutomationRunbookConfig) AutomationRunbook {
	_init_.Initialize()

	if err := validateNewAutomationRunbookParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AutomationRunbook)SetCount(val interface{}) {
...
func (j *jsiiProxy_AutomationRunbook)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AutomationRunbook)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AutomationRunbook)SetLogProgress(val interface{}) {
	if err := j.validateSetLogProgressParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_AutomationRunbook)SetLogVerbose(val interface{}) {
	if err := j.validateSetLogVerboseParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_AutomationRunbook)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_AutomationRunbook)SetRunbookType(val *string) {
	if err := j.validateSetRunbookTypeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func AutomationRunbook_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateAutomationRunbook_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AutomationRunbook_IsConstruct(x interface{}) *bool {
	...
	if err := validateAutomationRunbook_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AutomationRunbook_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAutomationRunbook_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AutomationRunbook_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAutomationRunbook_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AutomationRunbook) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AutomationRunbook) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationRunbook) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AutomationRunbook) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AutomationRunbook) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationRunbook) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AutomationRunbook) MoveFromId(id *string) {
...
func (a *jsiiProxy_AutomationRunbook) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AutomationRunbook) MoveToId(id *string) {
...
func (a *jsiiProxy_AutomationRunbook) PutPublishContentLink(value *AutomationRunbookPublishContentLink) {
	if err := a.validatePutPublishContentLinkParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_AutomationRunbook) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AutomationRunbook) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AutomationRunbook) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AutomationRunbook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
