...
func (j *jsiiProxy_AutomationRunbookPublishContentLinkHashOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAutomationRunbookPublishContentLinkHashOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AutomationRunbookPublishContentLinkHashOutputReference {
	_init_.Initialize()

	if err := validateNewAutomationRunbookPublishContentLinkHashOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAutomationRunbookPublishContentLinkHashOutputReference_Override(a AutomationRunbookPublishContentLinkHashOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AutomationRunbookPublishContentLinkHashOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AutomationRunbookPublishContentLinkHashOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationRunbookPublishContentLinkHashOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AutomationRunbookPublishContentLinkHashOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationRunbookPublishContentLinkHashOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
