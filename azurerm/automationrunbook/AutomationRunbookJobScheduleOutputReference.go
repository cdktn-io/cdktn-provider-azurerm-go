...
func (a *jsiiProxy_AutomationRunbookJobScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutomationRunbookJobScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
