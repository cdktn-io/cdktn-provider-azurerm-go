...
func (j *jsiiProxy_AutomationRunbookJobScheduleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAutomationRunbookJobScheduleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AutomationRunbookJobScheduleOutputReference {
	_init_.Initialize()

	if err := validateNewAutomationRunbookJobScheduleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewAutomationRunbookJobScheduleOutputReference_Override(a AutomationRunbookJobScheduleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AutomationRunbookJobScheduleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AutomationRunbookJobScheduleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationRunbookJobScheduleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AutomationRunbookJobScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationRunbookJobScheduleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
