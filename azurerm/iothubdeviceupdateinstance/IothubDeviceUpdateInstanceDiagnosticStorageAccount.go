...
type IothubDeviceUpdateInstanceDiagnosticStorageAccount struct {
	...
	ConnectionStringWo *string `field:"optional" json:"connectionStringWo" yaml:"connectionStringWo"`
	...
	ConnectionStringWoVersion *float64 `field:"optional" json:"connectionStringWoVersion" yaml:"connectionStringWoVersion"`
}
