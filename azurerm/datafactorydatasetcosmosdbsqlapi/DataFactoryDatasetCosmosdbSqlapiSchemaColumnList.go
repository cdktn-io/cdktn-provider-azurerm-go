...
func (j *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryDatasetCosmosdbSqlapiSchemaColumnList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryDatasetCosmosdbSqlapiSchemaColumnList {
	_init_.Initialize()
...
func NewDataFactoryDatasetCosmosdbSqlapiSchemaColumnList_Override(d DataFactoryDatasetCosmosdbSqlapiSchemaColumnList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnList) Resolve(context cdktn.IResolveContext) interface{} {
