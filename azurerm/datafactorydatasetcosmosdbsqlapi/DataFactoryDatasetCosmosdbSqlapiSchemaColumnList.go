...
func (d *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnList) Resolve(context cdktf.IResolveContext) interface{} {
