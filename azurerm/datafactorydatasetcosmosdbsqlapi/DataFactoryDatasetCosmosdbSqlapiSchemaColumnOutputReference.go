...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/datafactorydatasetcosmosdbsqlapi/internal"
...
func (j *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryDatasetCosmosdbSqlapi.DataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference",
...
func NewDataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference_Override(d DataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetCosmosdbSqlapiSchemaColumnOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
