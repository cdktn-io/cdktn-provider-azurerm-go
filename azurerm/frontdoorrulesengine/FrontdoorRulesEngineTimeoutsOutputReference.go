...
func (j *jsiiProxy_FrontdoorRulesEngineTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorRulesEngineTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FrontdoorRulesEngineTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewFrontdoorRulesEngineTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewFrontdoorRulesEngineTimeoutsOutputReference_Override(f FrontdoorRulesEngineTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorRulesEngineTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorRulesEngineTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorRulesEngineTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FrontdoorRulesEngineTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorRulesEngineTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
