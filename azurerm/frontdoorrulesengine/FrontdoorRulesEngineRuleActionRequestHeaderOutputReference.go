...
func (j *jsiiProxy_FrontdoorRulesEngineRuleActionRequestHeaderOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorRulesEngineRuleActionRequestHeaderOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FrontdoorRulesEngineRuleActionRequestHeaderOutputReference {
	_init_.Initialize()

	if err := validateNewFrontdoorRulesEngineRuleActionRequestHeaderOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewFrontdoorRulesEngineRuleActionRequestHeaderOutputReference_Override(f FrontdoorRulesEngineRuleActionRequestHeaderOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorRulesEngineRuleActionRequestHeaderOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorRulesEngineRuleActionRequestHeaderOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorRulesEngineRuleActionRequestHeaderOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FrontdoorRulesEngineRuleActionRequestHeaderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorRulesEngineRuleActionRequestHeaderOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
