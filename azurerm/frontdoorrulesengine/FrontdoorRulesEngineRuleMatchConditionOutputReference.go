...
func (j *jsiiProxy_FrontdoorRulesEngineRuleMatchConditionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorRulesEngineRuleMatchConditionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FrontdoorRulesEngineRuleMatchConditionOutputReference {
	_init_.Initialize()
...
func NewFrontdoorRulesEngineRuleMatchConditionOutputReference_Override(f FrontdoorRulesEngineRuleMatchConditionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorRulesEngineRuleMatchConditionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorRulesEngineRuleMatchConditionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorRulesEngineRuleMatchConditionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FrontdoorRulesEngineRuleMatchConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorRulesEngineRuleMatchConditionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
