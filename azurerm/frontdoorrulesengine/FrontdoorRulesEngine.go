...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/frontdoorrulesengine/internal"
...
func (j *jsiiProxy_FrontdoorRulesEngine) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FrontdoorRulesEngine) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FrontdoorRulesEngine) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FrontdoorRulesEngine) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FrontdoorRulesEngine) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewFrontdoorRulesEngine(scope constructs.Construct, id *string, config *FrontdoorRulesEngineConfig) FrontdoorRulesEngine {
	...
	if err := validateNewFrontdoorRulesEngineParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_FrontdoorRulesEngine)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FrontdoorRulesEngine)SetFrontdoorName(val *string) {
	if err := j.validateSetFrontdoorNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_FrontdoorRulesEngine)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FrontdoorRulesEngine)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FrontdoorRulesEngine_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateFrontdoorRulesEngine_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func FrontdoorRulesEngine_IsConstruct(x interface{}) *bool {
	...
	if err := validateFrontdoorRulesEngine_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func FrontdoorRulesEngine_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateFrontdoorRulesEngine_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func FrontdoorRulesEngine_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateFrontdoorRulesEngine_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (f *jsiiProxy_FrontdoorRulesEngine) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FrontdoorRulesEngine) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorRulesEngine) HasResourceMove() interface{} {
	var returns interface{}
...
func (f *jsiiProxy_FrontdoorRulesEngine) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FrontdoorRulesEngine) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorRulesEngine) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FrontdoorRulesEngine) MoveFromId(id *string) {
...
func (f *jsiiProxy_FrontdoorRulesEngine) MoveTo(moveTarget *string, index interface{}) {
...
func (f *jsiiProxy_FrontdoorRulesEngine) MoveToId(id *string) {
...
func (f *jsiiProxy_FrontdoorRulesEngine) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FrontdoorRulesEngine) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (f *jsiiProxy_FrontdoorRulesEngine) ToHclTerraform() interface{} {
	var returns interface{}
...
func (f *jsiiProxy_FrontdoorRulesEngine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
