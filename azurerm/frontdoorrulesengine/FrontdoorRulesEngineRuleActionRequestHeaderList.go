...
func (j *jsiiProxy_FrontdoorRulesEngineRuleActionRequestHeaderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorRulesEngineRuleActionRequestHeaderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorRulesEngineRuleActionRequestHeaderList {
	_init_.Initialize()

	if err := validateNewFrontdoorRulesEngineRuleActionRequestHeaderListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewFrontdoorRulesEngineRuleActionRequestHeaderList_Override(f FrontdoorRulesEngineRuleActionRequestHeaderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorRulesEngineRuleActionRequestHeaderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorRulesEngineRuleActionRequestHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorRulesEngineRuleActionRequestHeaderList) Resolve(context cdktn.IResolveContext) interface{} {
