...
func (s *jsiiProxy_StreamAnalyticsOutputEventhub) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StreamAnalyticsOutputEventhub) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StreamAnalyticsOutputEventhub) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
