...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/monitorscheduledqueryruleslog/internal"
...
func (j *jsiiProxy_MonitorScheduledQueryRulesLogTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorScheduledQueryRulesLogTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MonitorScheduledQueryRulesLogTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorScheduledQueryRulesLogTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_MonitorScheduledQueryRulesLogTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.monitorScheduledQueryRulesLog.MonitorScheduledQueryRulesLogTimeoutsOutputReference",
...
func NewMonitorScheduledQueryRulesLogTimeoutsOutputReference_Override(m MonitorScheduledQueryRulesLogTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorScheduledQueryRulesLogTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLogTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLogTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLogTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLogTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
