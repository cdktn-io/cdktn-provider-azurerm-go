...
func (j *jsiiProxy_MonitorScheduledQueryRulesLogCriteriaOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorScheduledQueryRulesLogCriteriaOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MonitorScheduledQueryRulesLogCriteriaOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorScheduledQueryRulesLogCriteriaOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_MonitorScheduledQueryRulesLogCriteriaOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.monitorScheduledQueryRulesLog.MonitorScheduledQueryRulesLogCriteriaOutputReference",
...
func NewMonitorScheduledQueryRulesLogCriteriaOutputReference_Override(m MonitorScheduledQueryRulesLogCriteriaOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorScheduledQueryRulesLogCriteriaOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLogCriteriaOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLogCriteriaOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLogCriteriaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLogCriteriaOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
