...
func (k *jsiiProxy_KubernetesAutomaticCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KubernetesAutomaticCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
