...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nfsServerUrlInput", GoGetter: "NfsServerUrlInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNfsServerUrl", GoMethod: "ResetNfsServerUrl"},
