...
func (j *jsiiProxy_SpringCloudAppPersistentDiskOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudAppPersistentDiskOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SpringCloudAppPersistentDiskOutputReference {
	_init_.Initialize()

	if err := validateNewSpringCloudAppPersistentDiskOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSpringCloudAppPersistentDiskOutputReference_Override(s SpringCloudAppPersistentDiskOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudAppPersistentDiskOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudAppPersistentDiskOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudAppPersistentDiskOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SpringCloudAppPersistentDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudAppPersistentDiskOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
