...
func (s *jsiiProxy_SpringCloudAppPersistentDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudAppPersistentDiskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
