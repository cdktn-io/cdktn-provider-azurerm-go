...
func (s *jsiiProxy_SpringCloudAppIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudAppIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
