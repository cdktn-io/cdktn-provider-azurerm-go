...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customPersistentDisk", GoGetter: "CustomPersistentDisk"},
			_jsii_.MemberProperty{JsiiProperty: "customPersistentDiskInput", GoGetter: "CustomPersistentDiskInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "persistentDiskInput", GoGetter: "PersistentDiskInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCustomPersistentDisk", GoMethod: "ResetCustomPersistentDisk"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "readOnlyEnabled", GoGetter: "ReadOnlyEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "readOnlyEnabledInput", GoGetter: "ReadOnlyEnabledInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetMountOptions", GoMethod: "ResetMountOptions"},
			_jsii_.MemberMethod{JsiiMethod: "resetReadOnlyEnabled", GoMethod: "ResetReadOnlyEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
