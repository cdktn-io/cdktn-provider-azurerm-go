...
func (j *jsiiProxy_SpringCloudAppCustomPersistentDiskList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudAppCustomPersistentDiskList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SpringCloudAppCustomPersistentDiskList {
	_init_.Initialize()

	if err := validateNewSpringCloudAppCustomPersistentDiskListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewSpringCloudAppCustomPersistentDiskList_Override(s SpringCloudAppCustomPersistentDiskList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudAppCustomPersistentDiskList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudAppCustomPersistentDiskList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SpringCloudAppCustomPersistentDiskList) Resolve(context cdktn.IResolveContext) interface{} {
