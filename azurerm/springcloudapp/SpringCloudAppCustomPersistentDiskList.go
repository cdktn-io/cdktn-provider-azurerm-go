...
func (s *jsiiProxy_SpringCloudAppCustomPersistentDiskList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SpringCloudAppCustomPersistentDiskList) Resolve(context cdktf.IResolveContext) interface{} {
