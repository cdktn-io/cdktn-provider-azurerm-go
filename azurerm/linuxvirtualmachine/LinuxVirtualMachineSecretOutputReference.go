...
func (j *jsiiProxy_LinuxVirtualMachineSecretOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxVirtualMachineSecretOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LinuxVirtualMachineSecretOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxVirtualMachineSecretOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewLinuxVirtualMachineSecretOutputReference_Override(l LinuxVirtualMachineSecretOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxVirtualMachineSecretOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxVirtualMachineSecretOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineSecretOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxVirtualMachineSecretOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineSecretOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
