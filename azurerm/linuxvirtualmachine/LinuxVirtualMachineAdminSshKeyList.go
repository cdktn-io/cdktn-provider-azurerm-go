...
func (j *jsiiProxy_LinuxVirtualMachineAdminSshKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxVirtualMachineAdminSshKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxVirtualMachineAdminSshKeyList {
	_init_.Initialize()
...
func NewLinuxVirtualMachineAdminSshKeyList_Override(l LinuxVirtualMachineAdminSshKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxVirtualMachineAdminSshKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxVirtualMachineAdminSshKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxVirtualMachineAdminSshKeyList) Resolve(context cdktn.IResolveContext) interface{} {
