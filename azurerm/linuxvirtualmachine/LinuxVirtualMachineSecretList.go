...
func (j *jsiiProxy_LinuxVirtualMachineSecretList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxVirtualMachineSecretList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxVirtualMachineSecretList {
	_init_.Initialize()
...
func NewLinuxVirtualMachineSecretList_Override(l LinuxVirtualMachineSecretList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxVirtualMachineSecretList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxVirtualMachineSecretList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxVirtualMachineSecretList) Resolve(context cdktn.IResolveContext) interface{} {
