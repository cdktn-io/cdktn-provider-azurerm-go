...
func (j *jsiiProxy_LinuxVirtualMachineAdminSshKeyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxVirtualMachineAdminSshKeyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LinuxVirtualMachineAdminSshKeyOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxVirtualMachineAdminSshKeyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewLinuxVirtualMachineAdminSshKeyOutputReference_Override(l LinuxVirtualMachineAdminSshKeyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxVirtualMachineAdminSshKeyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxVirtualMachineAdminSshKeyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineAdminSshKeyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxVirtualMachineAdminSshKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineAdminSshKeyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
