...
func (l *jsiiProxy_LinuxVirtualMachineTerminationNotificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineTerminationNotificationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
