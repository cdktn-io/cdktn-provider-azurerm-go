...
func (j *jsiiProxy_LinuxVirtualMachineSecretCertificateOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxVirtualMachineSecretCertificateOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LinuxVirtualMachineSecretCertificateOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxVirtualMachineSecretCertificateOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewLinuxVirtualMachineSecretCertificateOutputReference_Override(l LinuxVirtualMachineSecretCertificateOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxVirtualMachineSecretCertificateOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxVirtualMachineSecretCertificateOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineSecretCertificateOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxVirtualMachineSecretCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineSecretCertificateOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
