...
func (j *jsiiProxy_LinuxVirtualMachineGalleryApplicationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxVirtualMachineGalleryApplicationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxVirtualMachineGalleryApplicationList {
	_init_.Initialize()

	if err := validateNewLinuxVirtualMachineGalleryApplicationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewLinuxVirtualMachineGalleryApplicationList_Override(l LinuxVirtualMachineGalleryApplicationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxVirtualMachineGalleryApplicationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxVirtualMachineGalleryApplicationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxVirtualMachineGalleryApplicationList) Resolve(context cdktn.IResolveContext) interface{} {
