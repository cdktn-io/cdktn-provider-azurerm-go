...
func (l *jsiiProxy_LinuxVirtualMachineIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
