...
func (l *jsiiProxy_LinuxVirtualMachinePlanOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachinePlanOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
