...
func (l *jsiiProxy_LinuxVirtualMachineBootDiagnosticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineBootDiagnosticsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
