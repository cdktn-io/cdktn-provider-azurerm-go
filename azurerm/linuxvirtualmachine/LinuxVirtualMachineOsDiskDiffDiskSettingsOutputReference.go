...
func (l *jsiiProxy_LinuxVirtualMachineOsDiskDiffDiskSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineOsDiskDiffDiskSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
