...
func (j *jsiiProxy_WindowsVirtualMachineScaleSetSecretCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineScaleSetSecretCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsVirtualMachineScaleSetSecretCertificateList {
	_init_.Initialize()

	if err := validateNewWindowsVirtualMachineScaleSetSecretCertificateListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsVirtualMachineScaleSetSecretCertificateList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsVirtualMachineScaleSet.WindowsVirtualMachineScaleSetSecretCertificateList",
...
func NewWindowsVirtualMachineScaleSetSecretCertificateList_Override(w WindowsVirtualMachineScaleSetSecretCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineScaleSetSecretCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetSecretCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetSecretCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
