...
func (j *jsiiProxy_WindowsVirtualMachineScaleSetWinrmListenerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineScaleSetWinrmListenerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsVirtualMachineScaleSetWinrmListenerList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsVirtualMachineScaleSet.WindowsVirtualMachineScaleSetWinrmListenerList",
...
func NewWindowsVirtualMachineScaleSetWinrmListenerList_Override(w WindowsVirtualMachineScaleSetWinrmListenerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineScaleSetWinrmListenerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetWinrmListenerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetWinrmListenerList) Resolve(context cdktn.IResolveContext) interface{} {
