...
func (w *jsiiProxy_WindowsVirtualMachineScaleSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
