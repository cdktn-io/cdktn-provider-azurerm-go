...
func (j *jsiiProxy_WindowsVirtualMachineScaleSetPlanOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineScaleSetPlanOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsVirtualMachineScaleSetPlanOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsVirtualMachineScaleSetPlanOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsVirtualMachineScaleSetPlanOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsVirtualMachineScaleSet.WindowsVirtualMachineScaleSetPlanOutputReference",
...
func NewWindowsVirtualMachineScaleSetPlanOutputReference_Override(w WindowsVirtualMachineScaleSetPlanOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineScaleSetPlanOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetPlanOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetPlanOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetPlanOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetPlanOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
