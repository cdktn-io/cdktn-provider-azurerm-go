...
func (j *jsiiProxy_WindowsVirtualMachineScaleSetAdditionalUnattendContentList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineScaleSetAdditionalUnattendContentList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsVirtualMachineScaleSetAdditionalUnattendContentList {
	_init_.Initialize()

	if err := validateNewWindowsVirtualMachineScaleSetAdditionalUnattendContentListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsVirtualMachineScaleSetAdditionalUnattendContentList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsVirtualMachineScaleSet.WindowsVirtualMachineScaleSetAdditionalUnattendContentList",
...
func NewWindowsVirtualMachineScaleSetAdditionalUnattendContentList_Override(w WindowsVirtualMachineScaleSetAdditionalUnattendContentList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineScaleSetAdditionalUnattendContentList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetAdditionalUnattendContentList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetAdditionalUnattendContentList) Resolve(context cdktn.IResolveContext) interface{} {
