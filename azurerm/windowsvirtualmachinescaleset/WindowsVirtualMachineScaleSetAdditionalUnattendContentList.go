...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetAdditionalUnattendContentList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetAdditionalUnattendContentList) Resolve(context cdktf.IResolveContext) interface{} {
