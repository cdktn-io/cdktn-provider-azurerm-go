...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetWinrmListenerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetWinrmListenerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
