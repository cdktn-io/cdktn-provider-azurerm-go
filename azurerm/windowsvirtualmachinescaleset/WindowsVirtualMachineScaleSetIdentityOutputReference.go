...
func (j *jsiiProxy_WindowsVirtualMachineScaleSetIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsVirtualMachineScaleSetIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsVirtualMachineScaleSetIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsVirtualMachineScaleSetIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsVirtualMachineScaleSetIdentityOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsVirtualMachineScaleSet.WindowsVirtualMachineScaleSetIdentityOutputReference",
...
func NewWindowsVirtualMachineScaleSetIdentityOutputReference_Override(w WindowsVirtualMachineScaleSetIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsVirtualMachineScaleSetIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
