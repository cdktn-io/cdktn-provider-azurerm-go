...
func (j *jsiiProxy_CognitiveAccountProject) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CognitiveAccountProject) Default() cdktn.IResolvable {
...
func (j *jsiiProxy_CognitiveAccountProject) Endpoints() cdktn.StringMap {
...
func (j *jsiiProxy_CognitiveAccountProject) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CognitiveAccountProject) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CognitiveAccountProject) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CognitiveAccountProject) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/cognitive_account_project azurerm_cognitive_account_project} Resource.
...
func (j *jsiiProxy_CognitiveAccountProject)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CognitiveAccountProject)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CognitiveAccountProject)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CognitiveAccountProject_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CognitiveAccountProject) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountProject) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CognitiveAccountProject) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountProject) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CognitiveAccountProject) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CognitiveAccountProject) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
