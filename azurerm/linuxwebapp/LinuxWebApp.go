...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/linux_web_app azurerm_linux_web_app}.
...
func (j *jsiiProxy_LinuxWebApp) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LinuxWebApp) EndToEndTlsEncryptionEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LinuxWebApp) EndToEndTlsEncryptionEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LinuxWebApp) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LinuxWebApp) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LinuxWebApp) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LinuxWebApp) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LinuxWebApp) VirtualNetworkBackupRestoreEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LinuxWebApp) VirtualNetworkBackupRestoreEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/linux_web_app azurerm_linux_web_app} Resource.
...
func (j *jsiiProxy_LinuxWebApp)SetEndToEndTlsEncryptionEnabled(val interface{}) {
...
func (j *jsiiProxy_LinuxWebApp)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LinuxWebApp)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LinuxWebApp)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_LinuxWebApp)SetVirtualNetworkBackupRestoreEnabled(val interface{}) {
...
// Generates CDKTN code for importing a LinuxWebApp resource upon running "cdktn plan <stack-name>".
func LinuxWebApp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LinuxWebApp) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxWebApp) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LinuxWebApp) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxWebApp) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LinuxWebApp) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LinuxWebApp) ResetEndToEndTlsEncryptionEnabled() {
	_jsii_.InvokeVoid(
		l,
		"resetEndToEndTlsEncryptionEnabled",
		nil, // no parameters
...
func (l *jsiiProxy_LinuxWebApp) ResetVirtualNetworkBackupRestoreEnabled() {
	_jsii_.InvokeVoid(
		l,
		"resetVirtualNetworkBackupRestoreEnabled",
		nil, // no parameters
...
func (l *jsiiProxy_LinuxWebApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
