...
func (j *jsiiProxy_DataAzurermVpnServerConfigurationClientRevokedCertificateList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermVpnServerConfigurationClientRevokedCertificateList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermVpnServerConfigurationClientRevokedCertificateList {
	_init_.Initialize()
...
func NewDataAzurermVpnServerConfigurationClientRevokedCertificateList_Override(d DataAzurermVpnServerConfigurationClientRevokedCertificateList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermVpnServerConfigurationClientRevokedCertificateList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermVpnServerConfigurationClientRevokedCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermVpnServerConfigurationClientRevokedCertificateList) Resolve(context cdktf.IResolveContext) interface{} {
