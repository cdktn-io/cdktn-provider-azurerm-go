...
func (j *jsiiProxy_DataAzurermVpnServerConfigurationRadiusServerRootCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermVpnServerConfigurationRadiusServerRootCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermVpnServerConfigurationRadiusServerRootCertificateList {
	_init_.Initialize()
...
func NewDataAzurermVpnServerConfigurationRadiusServerRootCertificateList_Override(d DataAzurermVpnServerConfigurationRadiusServerRootCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermVpnServerConfigurationRadiusServerRootCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermVpnServerConfigurationRadiusServerRootCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermVpnServerConfigurationRadiusServerRootCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
