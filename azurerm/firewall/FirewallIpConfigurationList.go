...
func (j *jsiiProxy_FirewallIpConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallIpConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallIpConfigurationList {
	_init_.Initialize()

	if err := validateNewFirewallIpConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewFirewallIpConfigurationList_Override(f FirewallIpConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallIpConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallIpConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallIpConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
