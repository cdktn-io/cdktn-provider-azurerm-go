...
func (f *jsiiProxy_FirewallIpConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallIpConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
