...
func (f *jsiiProxy_FirewallManagementIpConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallManagementIpConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
