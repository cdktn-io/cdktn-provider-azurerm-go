...
func (j *jsiiProxy_Firewall) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Firewall) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Firewall) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Firewall) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Firewall) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/firewall azurerm_firewall} Resource.
...
func (j *jsiiProxy_Firewall)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Firewall)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Firewall)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Firewall_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_Firewall) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_Firewall) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_Firewall) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_Firewall) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_Firewall) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_Firewall) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
