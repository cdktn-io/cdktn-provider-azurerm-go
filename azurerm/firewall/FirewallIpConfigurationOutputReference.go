...
func (f *jsiiProxy_FirewallIpConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallIpConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
