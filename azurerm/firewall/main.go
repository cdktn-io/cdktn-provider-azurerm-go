...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dnsProxyEnabled", GoGetter: "DnsProxyEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "dnsProxyEnabledInput", GoGetter: "DnsProxyEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDnsProxyEnabled", GoMethod: "ResetDnsProxyEnabled"},
