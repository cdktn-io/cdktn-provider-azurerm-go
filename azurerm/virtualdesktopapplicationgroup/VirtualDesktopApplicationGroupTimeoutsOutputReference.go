...
func (v *jsiiProxy_VirtualDesktopApplicationGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopApplicationGroupTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
