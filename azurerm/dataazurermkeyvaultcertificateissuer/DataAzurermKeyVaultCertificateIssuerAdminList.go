...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateIssuerAdminList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKeyVaultCertificateIssuerAdminList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKeyVaultCertificateIssuerAdminList {
	_init_.Initialize()
...
func NewDataAzurermKeyVaultCertificateIssuerAdminList_Override(d DataAzurermKeyVaultCertificateIssuerAdminList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKeyVaultCertificateIssuerAdminList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateIssuerAdminList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateIssuerAdminList) Resolve(context cdktn.IResolveContext) interface{} {
