...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/healthcare_workspace azurerm_healthcare_workspace} Resource.
...
func (h *jsiiProxy_HealthcareWorkspace) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HealthcareWorkspace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HealthcareWorkspace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
