...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customIpPrefixIdInput", GoGetter: "CustomIpPrefixIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCustomIpPrefixId", GoMethod: "ResetCustomIpPrefixId"},
