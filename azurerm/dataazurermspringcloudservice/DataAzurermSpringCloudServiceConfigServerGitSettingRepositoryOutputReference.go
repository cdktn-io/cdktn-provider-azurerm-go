...
func (d *jsiiProxy_DataAzurermSpringCloudServiceConfigServerGitSettingRepositoryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermSpringCloudServiceConfigServerGitSettingRepositoryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
