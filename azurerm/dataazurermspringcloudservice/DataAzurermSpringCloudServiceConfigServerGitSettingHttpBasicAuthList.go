...
func (d *jsiiProxy_DataAzurermSpringCloudServiceConfigServerGitSettingHttpBasicAuthList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermSpringCloudServiceConfigServerGitSettingHttpBasicAuthList) Resolve(context cdktf.IResolveContext) interface{} {
