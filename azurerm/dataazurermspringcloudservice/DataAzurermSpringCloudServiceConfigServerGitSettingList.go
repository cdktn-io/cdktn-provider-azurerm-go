...
func (j *jsiiProxy_DataAzurermSpringCloudServiceConfigServerGitSettingList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermSpringCloudServiceConfigServerGitSettingList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermSpringCloudServiceConfigServerGitSettingList {
	_init_.Initialize()
...
func NewDataAzurermSpringCloudServiceConfigServerGitSettingList_Override(d DataAzurermSpringCloudServiceConfigServerGitSettingList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermSpringCloudServiceConfigServerGitSettingList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermSpringCloudServiceConfigServerGitSettingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermSpringCloudServiceConfigServerGitSettingList) Resolve(context cdktf.IResolveContext) interface{} {
