...
func (l *jsiiProxy_LogAnalyticsWorkspaceTableCustomLog) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogAnalyticsWorkspaceTableCustomLog) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
