...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/subscriptioncostmanagementexport/internal"
...
func (j *jsiiProxy_SubscriptionCostManagementExport) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SubscriptionCostManagementExport) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SubscriptionCostManagementExport) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SubscriptionCostManagementExport) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SubscriptionCostManagementExport) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/subscription_cost_management_export azurerm_subscription_cost_management_export} Resource.
...
func (j *jsiiProxy_SubscriptionCostManagementExport)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SubscriptionCostManagementExport)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SubscriptionCostManagementExport)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SubscriptionCostManagementExport_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SubscriptionCostManagementExport) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubscriptionCostManagementExport) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SubscriptionCostManagementExport) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubscriptionCostManagementExport) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SubscriptionCostManagementExport) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SubscriptionCostManagementExport) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
