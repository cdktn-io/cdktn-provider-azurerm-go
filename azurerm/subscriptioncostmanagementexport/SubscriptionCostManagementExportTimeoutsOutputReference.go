...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/subscriptioncostmanagementexport/internal"
...
func (s *jsiiProxy_SubscriptionCostManagementExportTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SubscriptionCostManagementExportTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
