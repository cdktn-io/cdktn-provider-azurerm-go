...
func (j *jsiiProxy_SubscriptionCostManagementExportTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSubscriptionCostManagementExportTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SubscriptionCostManagementExportTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSubscriptionCostManagementExportTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSubscriptionCostManagementExportTimeoutsOutputReference_Override(s SubscriptionCostManagementExportTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SubscriptionCostManagementExportTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SubscriptionCostManagementExportTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubscriptionCostManagementExportTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SubscriptionCostManagementExportTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubscriptionCostManagementExportTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
