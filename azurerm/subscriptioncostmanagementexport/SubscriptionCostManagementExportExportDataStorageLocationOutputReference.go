...
func (s *jsiiProxy_SubscriptionCostManagementExportExportDataStorageLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SubscriptionCostManagementExportExportDataStorageLocationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
