...
func (l *jsiiProxy_LbProbeTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbProbeTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
