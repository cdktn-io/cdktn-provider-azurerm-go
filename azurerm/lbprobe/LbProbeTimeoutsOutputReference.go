...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/lbprobe/internal"
...
func (j *jsiiProxy_LbProbeTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLbProbeTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LbProbeTimeoutsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.lbProbe.LbProbeTimeoutsOutputReference",
...
func NewLbProbeTimeoutsOutputReference_Override(l LbProbeTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LbProbeTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LbProbeTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbProbeTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LbProbeTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbProbeTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
