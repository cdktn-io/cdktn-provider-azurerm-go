...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/securitycenterassessment/internal"
...
func (j *jsiiProxy_SecurityCenterAssessmentTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSecurityCenterAssessmentTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SecurityCenterAssessmentTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSecurityCenterAssessmentTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSecurityCenterAssessmentTimeoutsOutputReference_Override(s SecurityCenterAssessmentTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecurityCenterAssessmentTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SecurityCenterAssessmentTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityCenterAssessmentTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SecurityCenterAssessmentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityCenterAssessmentTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
