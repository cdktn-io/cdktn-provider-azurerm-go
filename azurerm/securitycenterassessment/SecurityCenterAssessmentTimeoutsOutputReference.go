...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/securitycenterassessment/internal"
...
func (s *jsiiProxy_SecurityCenterAssessmentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityCenterAssessmentTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
