...
func (j *jsiiProxy_SecurityCenterAssessment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecurityCenterAssessment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecurityCenterAssessment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecurityCenterAssessment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecurityCenterAssessment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SecurityCenterAssessment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityCenterAssessment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecurityCenterAssessment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecurityCenterAssessment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecurityCenterAssessment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityCenterAssessment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecurityCenterAssessment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityCenterAssessment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecurityCenterAssessment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecurityCenterAssessment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
