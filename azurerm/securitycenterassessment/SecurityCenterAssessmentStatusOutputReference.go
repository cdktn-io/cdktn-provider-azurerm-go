...
func (s *jsiiProxy_SecurityCenterAssessmentStatusOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityCenterAssessmentStatusOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
