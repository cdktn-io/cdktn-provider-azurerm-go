...
func (j *jsiiProxy_WebPubsubNetworkAclPrivateEndpointOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebPubsubNetworkAclPrivateEndpointOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WebPubsubNetworkAclPrivateEndpointOutputReference {
	_init_.Initialize()
...
func NewWebPubsubNetworkAclPrivateEndpointOutputReference_Override(w WebPubsubNetworkAclPrivateEndpointOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebPubsubNetworkAclPrivateEndpointOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebPubsubNetworkAclPrivateEndpointOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubNetworkAclPrivateEndpointOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WebPubsubNetworkAclPrivateEndpointOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubNetworkAclPrivateEndpointOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
