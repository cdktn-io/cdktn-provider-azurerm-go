...
func (w *jsiiProxy_WebPubsubNetworkAclPrivateEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebPubsubNetworkAclPrivateEndpointList) Resolve(context cdktf.IResolveContext) interface{} {
