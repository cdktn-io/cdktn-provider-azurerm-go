...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/webpubsubnetworkacl/internal"
...
func (j *jsiiProxy_WebPubsubNetworkAcl) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WebPubsubNetworkAcl) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WebPubsubNetworkAcl) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WebPubsubNetworkAcl) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WebPubsubNetworkAcl) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/web_pubsub_network_acl azurerm_web_pubsub_network_acl} Resource.
func NewWebPubsubNetworkAcl(scope constructs.Construct, id *string, config *WebPubsubNetworkAclConfig) WebPubsubNetworkAcl {
	_init_.Initialize()

	if err := validateNewWebPubsubNetworkAclParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WebPubsubNetworkAcl)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WebPubsubNetworkAcl)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WebPubsubNetworkAcl)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WebPubsubNetworkAcl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateWebPubsubNetworkAcl_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WebPubsubNetworkAcl_IsConstruct(x interface{}) *bool {
	...
	if err := validateWebPubsubNetworkAcl_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebPubsubNetworkAcl_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebPubsubNetworkAcl_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebPubsubNetworkAcl_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebPubsubNetworkAcl_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WebPubsubNetworkAcl) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WebPubsubNetworkAcl) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubNetworkAcl) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WebPubsubNetworkAcl) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WebPubsubNetworkAcl) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubNetworkAcl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WebPubsubNetworkAcl) MoveFromId(id *string) {
...
func (w *jsiiProxy_WebPubsubNetworkAcl) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WebPubsubNetworkAcl) MoveToId(id *string) {
...
func (w *jsiiProxy_WebPubsubNetworkAcl) PutPrivateEndpoint(value interface{}) {
	if err := w.validatePutPrivateEndpointParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WebPubsubNetworkAcl) PutPublicNetwork(value *WebPubsubNetworkAclPublicNetwork) {
	if err := w.validatePutPublicNetworkParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WebPubsubNetworkAcl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WebPubsubNetworkAcl) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WebPubsubNetworkAcl) ToHclTerraform() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WebPubsubNetworkAcl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
