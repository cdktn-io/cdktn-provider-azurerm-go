...
func WebPubsubNetworkAcl_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WebPubsubNetworkAcl) ImportFrom(id *string, provider cdktf.TerraformProvider) {
