...
func (j *jsiiProxy_VirtualHubRouteTableRouteA) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VirtualHubRouteTableRouteA) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VirtualHubRouteTableRouteA) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VirtualHubRouteTableRouteA) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VirtualHubRouteTableRouteA) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VirtualHubRouteTableRouteA) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewVirtualHubRouteTableRouteA(scope constructs.Construct, id *string, config *VirtualHubRouteTableRouteAConfig) VirtualHubRouteTableRouteA {
	...
	if err := validateNewVirtualHubRouteTableRouteAParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_VirtualHubRouteTableRouteA{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.virtualHubRouteTableRoute.VirtualHubRouteTableRouteA",
...
func (j *jsiiProxy_VirtualHubRouteTableRouteA)SetCount(val interface{}) {
...
func (j *jsiiProxy_VirtualHubRouteTableRouteA)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VirtualHubRouteTableRouteA)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VirtualHubRouteTableRouteA)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VirtualHubRouteTableRouteA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateVirtualHubRouteTableRouteA_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VirtualHubRouteTableRouteA_IsConstruct(x interface{}) *bool {
	...
	if err := validateVirtualHubRouteTableRouteA_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VirtualHubRouteTableRouteA_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVirtualHubRouteTableRouteA_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VirtualHubRouteTableRouteA_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVirtualHubRouteTableRouteA_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) MoveFromId(id *string) {
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) MoveToId(id *string) {
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) ToHclTerraform() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
