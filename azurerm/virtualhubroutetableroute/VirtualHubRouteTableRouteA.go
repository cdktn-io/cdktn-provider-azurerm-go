...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/virtualhubroutetableroute/internal"
...
func VirtualHubRouteTableRouteA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VirtualHubRouteTableRouteA) ImportFrom(id *string, provider cdktf.TerraformProvider) {
