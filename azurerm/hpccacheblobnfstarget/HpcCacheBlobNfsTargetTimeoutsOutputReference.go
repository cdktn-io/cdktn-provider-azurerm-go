...
func (h *jsiiProxy_HpcCacheBlobNfsTargetTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HpcCacheBlobNfsTargetTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
