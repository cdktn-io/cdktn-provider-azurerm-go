...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.dataAzurermSubnet.DataAzurermSubnetServiceEndpoint",
		reflect.TypeOf((*DataAzurermSubnetServiceEndpoint)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azurerm.dataAzurermSubnet.DataAzurermSubnetServiceEndpointList",
		reflect.TypeOf((*DataAzurermSubnetServiceEndpointList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAzurermSubnetServiceEndpointOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
