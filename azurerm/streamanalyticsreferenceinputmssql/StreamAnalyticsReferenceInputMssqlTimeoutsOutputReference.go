...
func (j *jsiiProxy_StreamAnalyticsReferenceInputMssqlTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStreamAnalyticsReferenceInputMssqlTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StreamAnalyticsReferenceInputMssqlTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewStreamAnalyticsReferenceInputMssqlTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_StreamAnalyticsReferenceInputMssqlTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.streamAnalyticsReferenceInputMssql.StreamAnalyticsReferenceInputMssqlTimeoutsOutputReference",
...
func NewStreamAnalyticsReferenceInputMssqlTimeoutsOutputReference_Override(s StreamAnalyticsReferenceInputMssqlTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StreamAnalyticsReferenceInputMssqlTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssqlTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssqlTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssqlTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssqlTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
