...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/streamanalyticsreferenceinputmssql/internal"
...
func (j *jsiiProxy_StreamAnalyticsReferenceInputMssql) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/stream_analytics_reference_input_mssql azurerm_stream_analytics_reference_input_mssql} Resource.
func NewStreamAnalyticsReferenceInputMssql(scope constructs.Construct, id *string, config *StreamAnalyticsReferenceInputMssqlConfig) StreamAnalyticsReferenceInputMssql {
	...
	if err := validateNewStreamAnalyticsReferenceInputMssqlParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_StreamAnalyticsReferenceInputMssql)SetCount(val interface{}) {
...
func (j *jsiiProxy_StreamAnalyticsReferenceInputMssql)SetDeltaSnapshotQuery(val *string) {
	if err := j.validateSetDeltaSnapshotQueryParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_StreamAnalyticsReferenceInputMssql)SetFullSnapshotQuery(val *string) {
	if err := j.validateSetFullSnapshotQueryParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_StreamAnalyticsReferenceInputMssql)SetRefreshIntervalDuration(val *string) {
	if err := j.validateSetRefreshIntervalDurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func StreamAnalyticsReferenceInputMssql_IsConstruct(x interface{}) *bool {
	...
	if err := validateStreamAnalyticsReferenceInputMssql_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssql) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssql) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssql) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssql) MoveFromId(id *string) {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssql) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssql) MoveToId(id *string) {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssql) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssql) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssql) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputMssql) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
