...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "blobWriteMode", GoGetter: "BlobWriteMode"},
			_jsii_.MemberProperty{JsiiProperty: "blobWriteModeInput", GoGetter: "BlobWriteModeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBlobWriteMode", GoMethod: "ResetBlobWriteMode"},
