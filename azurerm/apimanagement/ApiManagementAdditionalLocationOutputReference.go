...
func (j *jsiiProxy_ApiManagementAdditionalLocationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementAdditionalLocationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementAdditionalLocationOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementAdditionalLocationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementAdditionalLocationOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagement.ApiManagementAdditionalLocationOutputReference",
...
func NewApiManagementAdditionalLocationOutputReference_Override(a ApiManagementAdditionalLocationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementAdditionalLocationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementAdditionalLocationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementAdditionalLocationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementAdditionalLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementAdditionalLocationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
