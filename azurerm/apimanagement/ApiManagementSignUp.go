...
type ApiManagementSignUp struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/api_management#enabled ApiManagement#enabled}.
