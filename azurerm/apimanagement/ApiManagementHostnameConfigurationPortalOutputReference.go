...
func (j *jsiiProxy_ApiManagementHostnameConfigurationPortalOutputReference) KeyVaultCertificateId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationPortalOutputReference) KeyVaultCertificateIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationPortalOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementHostnameConfigurationPortalOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementHostnameConfigurationPortalOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagement.ApiManagementHostnameConfigurationPortalOutputReference",
...
func NewApiManagementHostnameConfigurationPortalOutputReference_Override(a ApiManagementHostnameConfigurationPortalOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationPortalOutputReference)SetKeyVaultCertificateId(val *string) {
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationPortalOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationPortalOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationPortalOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationPortalOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationPortalOutputReference) ResetKeyVaultCertificateId() {
	_jsii_.InvokeVoid(
		a,
		"resetKeyVaultCertificateId",
		nil, // no parameters
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationPortalOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
