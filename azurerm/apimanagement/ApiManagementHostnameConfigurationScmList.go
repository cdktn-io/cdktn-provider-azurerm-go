...
func (j *jsiiProxy_ApiManagementHostnameConfigurationScmList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementHostnameConfigurationScmList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementHostnameConfigurationScmList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagement.ApiManagementHostnameConfigurationScmList",
...
func NewApiManagementHostnameConfigurationScmList_Override(a ApiManagementHostnameConfigurationScmList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationScmList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationScmList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationScmList) Resolve(context cdktn.IResolveContext) interface{} {
