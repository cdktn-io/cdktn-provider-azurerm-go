...
func (a *jsiiProxy_ApiManagementHostnameConfigurationScmList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationScmList) Resolve(context cdktf.IResolveContext) interface{} {
