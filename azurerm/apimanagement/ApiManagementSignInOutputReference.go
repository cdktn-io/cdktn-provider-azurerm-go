...
func (a *jsiiProxy_ApiManagementSignInOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementSignInOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
