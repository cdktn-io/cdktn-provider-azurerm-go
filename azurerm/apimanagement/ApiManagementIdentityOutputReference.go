...
func (a *jsiiProxy_ApiManagementIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
