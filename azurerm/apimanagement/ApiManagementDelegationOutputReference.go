...
func (a *jsiiProxy_ApiManagementDelegationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementDelegationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
