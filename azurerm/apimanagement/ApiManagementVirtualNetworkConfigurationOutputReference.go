...
func (j *jsiiProxy_ApiManagementVirtualNetworkConfigurationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementVirtualNetworkConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ApiManagementVirtualNetworkConfigurationOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementVirtualNetworkConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementVirtualNetworkConfigurationOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagement.ApiManagementVirtualNetworkConfigurationOutputReference",
...
func NewApiManagementVirtualNetworkConfigurationOutputReference_Override(a ApiManagementVirtualNetworkConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementVirtualNetworkConfigurationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementVirtualNetworkConfigurationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementVirtualNetworkConfigurationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementVirtualNetworkConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementVirtualNetworkConfigurationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
