...
func (j *jsiiProxy_ApiManagementHostnameConfigurationDeveloperPortalList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementHostnameConfigurationDeveloperPortalList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementHostnameConfigurationDeveloperPortalList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagement.ApiManagementHostnameConfigurationDeveloperPortalList",
...
func NewApiManagementHostnameConfigurationDeveloperPortalList_Override(a ApiManagementHostnameConfigurationDeveloperPortalList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationDeveloperPortalList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationDeveloperPortalList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationDeveloperPortalList) Resolve(context cdktn.IResolveContext) interface{} {
