...
func (a *jsiiProxy_ApiManagementHostnameConfigurationDeveloperPortalList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationDeveloperPortalList) Resolve(context cdktf.IResolveContext) interface{} {
