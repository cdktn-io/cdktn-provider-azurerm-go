...
func (j *jsiiProxy_ApiManagementCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementCertificateList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagement.ApiManagementCertificateList",
...
func NewApiManagementCertificateList_Override(a ApiManagementCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
