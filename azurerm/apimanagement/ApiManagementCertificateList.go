...
func (a *jsiiProxy_ApiManagementCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementCertificateList) Resolve(context cdktf.IResolveContext) interface{} {
