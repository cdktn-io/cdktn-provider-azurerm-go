...
func (a *jsiiProxy_ApiManagementHostnameConfigurationProxyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationProxyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
