...
func (j *jsiiProxy_ApiManagementSignUpOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementSignUpOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ApiManagementSignUpOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementSignUpOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementSignUpOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagement.ApiManagementSignUpOutputReference",
...
func NewApiManagementSignUpOutputReference_Override(a ApiManagementSignUpOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementSignUpOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementSignUpOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementSignUpOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementSignUpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementSignUpOutputReference) PutTermsOfService(value *ApiManagementSignUpTermsOfService) {
	if err := a.validatePutTermsOfServiceParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_ApiManagementSignUpOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
