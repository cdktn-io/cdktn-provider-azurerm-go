...
func (j *jsiiProxy_ApiManagementHostnameConfigurationManagementList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementHostnameConfigurationManagementList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementHostnameConfigurationManagementList {
	_init_.Initialize()
...
func NewApiManagementHostnameConfigurationManagementList_Override(a ApiManagementHostnameConfigurationManagementList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationManagementList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationManagementList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationManagementList) Resolve(context cdktn.IResolveContext) interface{} {
