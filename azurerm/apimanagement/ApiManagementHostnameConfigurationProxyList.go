...
func (j *jsiiProxy_ApiManagementHostnameConfigurationProxyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementHostnameConfigurationProxyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementHostnameConfigurationProxyList {
	_init_.Initialize()
...
func NewApiManagementHostnameConfigurationProxyList_Override(a ApiManagementHostnameConfigurationProxyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationProxyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationProxyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationProxyList) Resolve(context cdktn.IResolveContext) interface{} {
