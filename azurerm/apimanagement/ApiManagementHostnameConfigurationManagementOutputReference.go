...
func (j *jsiiProxy_ApiManagementHostnameConfigurationManagementOutputReference) KeyVaultCertificateId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationManagementOutputReference) KeyVaultCertificateIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationManagementOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementHostnameConfigurationManagementOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementHostnameConfigurationManagementOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagement.ApiManagementHostnameConfigurationManagementOutputReference",
...
func NewApiManagementHostnameConfigurationManagementOutputReference_Override(a ApiManagementHostnameConfigurationManagementOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationManagementOutputReference)SetKeyVaultCertificateId(val *string) {
...
func (j *jsiiProxy_ApiManagementHostnameConfigurationManagementOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationManagementOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationManagementOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationManagementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationManagementOutputReference) ResetKeyVaultCertificateId() {
	_jsii_.InvokeVoid(
		a,
		"resetKeyVaultCertificateId",
		nil, // no parameters
...
func (a *jsiiProxy_ApiManagementHostnameConfigurationManagementOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
