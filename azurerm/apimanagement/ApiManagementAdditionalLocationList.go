...
func (j *jsiiProxy_ApiManagementAdditionalLocationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementAdditionalLocationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementAdditionalLocationList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagement.ApiManagementAdditionalLocationList",
...
func NewApiManagementAdditionalLocationList_Override(a ApiManagementAdditionalLocationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementAdditionalLocationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementAdditionalLocationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementAdditionalLocationList) Resolve(context cdktn.IResolveContext) interface{} {
