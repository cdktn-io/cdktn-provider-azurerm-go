...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) MarketplaceOfferId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"marketplaceOfferId",
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) MarketplaceOfferIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) PlanId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"planId",
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) PlanIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"planIdInput",
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/palo_alto_next_generation_firewall_virtual_hub_local_rulestack azurerm_palo_alto_next_generation_firewall_virtual_hub_local_rulestack} Resource.
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack)SetMarketplaceOfferId(val *string) {
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack)SetPlanId(val *string) {
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PaloAltoNextGenerationFirewallVirtualHubLocalRulestack_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validatePaloAltoNextGenerationFirewallVirtualHubLocalRulestack_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) MoveFromId(id *string) {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) MoveToId(id *string) {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) ResetMarketplaceOfferId() {
	_jsii_.InvokeVoid(
		p,
		"resetMarketplaceOfferId",
		nil, // no parameters
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) ResetPlanId() {
	_jsii_.InvokeVoid(
		p,
		"resetPlanId",
		nil, // no parameters
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) ToHclTerraform() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualHubLocalRulestack) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
