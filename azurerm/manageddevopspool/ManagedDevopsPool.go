...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/managed_devops_pool azurerm_managed_devops_pool} Resource.
...
func (m *jsiiProxy_ManagedDevopsPool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_ManagedDevopsPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
