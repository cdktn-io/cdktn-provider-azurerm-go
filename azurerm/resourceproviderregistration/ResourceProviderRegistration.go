...
func (j *jsiiProxy_ResourceProviderRegistration) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ResourceProviderRegistration) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ResourceProviderRegistration) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ResourceProviderRegistration) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ResourceProviderRegistration) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.60.0/docs/resources/resource_provider_registration azurerm_resource_provider_registration} Resource.
...
func (j *jsiiProxy_ResourceProviderRegistration)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ResourceProviderRegistration)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ResourceProviderRegistration)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ResourceProviderRegistration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_ResourceProviderRegistration) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_ResourceProviderRegistration) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
