...
func (j *jsiiProxy_SubnetDelegationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSubnetDelegationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SubnetDelegationOutputReference {
	_init_.Initialize()
...
func NewSubnetDelegationOutputReference_Override(s SubnetDelegationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SubnetDelegationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SubnetDelegationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubnetDelegationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SubnetDelegationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubnetDelegationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
