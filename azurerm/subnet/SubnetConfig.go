...
type SubnetConfig struct {
	...
	NetworkSecurityGroupIdWo *string `field:"optional" json:"networkSecurityGroupIdWo" yaml:"networkSecurityGroupIdWo"`
	...
	NetworkSecurityGroupIdWoVersion *float64 `field:"optional" json:"networkSecurityGroupIdWoVersion" yaml:"networkSecurityGroupIdWoVersion"`
	...
	RouteTableIdWo *string `field:"optional" json:"routeTableIdWo" yaml:"routeTableIdWo"`
	...
	RouteTableIdWoVersion *float64 `field:"optional" json:"routeTableIdWoVersion" yaml:"routeTableIdWoVersion"`
	...
	ServiceEndpoint interface{} `field:"optional" json:"serviceEndpoint" yaml:"serviceEndpoint"`
