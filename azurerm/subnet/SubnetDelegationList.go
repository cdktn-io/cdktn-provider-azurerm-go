...
func (j *jsiiProxy_SubnetDelegationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSubnetDelegationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SubnetDelegationList {
	_init_.Initialize()
...
func NewSubnetDelegationList_Override(s SubnetDelegationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SubnetDelegationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SubnetDelegationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SubnetDelegationList) Resolve(context cdktn.IResolveContext) interface{} {
