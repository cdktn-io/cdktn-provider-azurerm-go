...
func (k *jsiiProxy_KustoEventhubDataConnectionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KustoEventhubDataConnectionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
