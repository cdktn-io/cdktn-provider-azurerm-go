...
func (j *jsiiProxy_KustoEventhubDataConnectionTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKustoEventhubDataConnectionTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) KustoEventhubDataConnectionTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewKustoEventhubDataConnectionTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewKustoEventhubDataConnectionTimeoutsOutputReference_Override(k KustoEventhubDataConnectionTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_KustoEventhubDataConnectionTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KustoEventhubDataConnectionTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KustoEventhubDataConnectionTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KustoEventhubDataConnectionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KustoEventhubDataConnectionTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
