...
func (v *jsiiProxy_VirtualNetworkDnsServers) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualNetworkDnsServers) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
