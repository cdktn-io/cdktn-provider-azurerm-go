...
func (j *jsiiProxy_SiteRecoveryHypervReplicationPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SiteRecoveryHypervReplicationPolicy) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SiteRecoveryHypervReplicationPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SiteRecoveryHypervReplicationPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SiteRecoveryHypervReplicationPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SiteRecoveryHypervReplicationPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/site_recovery_hyperv_replication_policy azurerm_site_recovery_hyperv_replication_policy} Resource.
func NewSiteRecoveryHypervReplicationPolicy(scope constructs.Construct, id *string, config *SiteRecoveryHypervReplicationPolicyConfig) SiteRecoveryHypervReplicationPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.siteRecoveryHypervReplicationPolicy.SiteRecoveryHypervReplicationPolicy",
...
func (j *jsiiProxy_SiteRecoveryHypervReplicationPolicy)SetCount(val interface{}) {
...
func (j *jsiiProxy_SiteRecoveryHypervReplicationPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SiteRecoveryHypervReplicationPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SiteRecoveryHypervReplicationPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SiteRecoveryHypervReplicationPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSiteRecoveryHypervReplicationPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) MoveFromId(id *string) {
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) MoveToId(id *string) {
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SiteRecoveryHypervReplicationPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
