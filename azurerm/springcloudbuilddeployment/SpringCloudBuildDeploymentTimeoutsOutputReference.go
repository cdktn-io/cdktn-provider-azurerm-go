...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/springcloudbuilddeployment/internal"
...
func (s *jsiiProxy_SpringCloudBuildDeploymentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudBuildDeploymentTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
