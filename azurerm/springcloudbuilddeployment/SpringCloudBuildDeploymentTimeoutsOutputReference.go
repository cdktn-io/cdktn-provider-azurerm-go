...
func (j *jsiiProxy_SpringCloudBuildDeploymentTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudBuildDeploymentTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SpringCloudBuildDeploymentTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSpringCloudBuildDeploymentTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SpringCloudBuildDeploymentTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.springCloudBuildDeployment.SpringCloudBuildDeploymentTimeoutsOutputReference",
...
func NewSpringCloudBuildDeploymentTimeoutsOutputReference_Override(s SpringCloudBuildDeploymentTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudBuildDeploymentTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudBuildDeploymentTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudBuildDeploymentTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SpringCloudBuildDeploymentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudBuildDeploymentTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
