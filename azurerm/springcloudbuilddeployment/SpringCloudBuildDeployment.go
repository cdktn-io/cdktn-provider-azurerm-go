...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/springcloudbuilddeployment/internal"
...
func (j *jsiiProxy_SpringCloudBuildDeployment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SpringCloudBuildDeployment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SpringCloudBuildDeployment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SpringCloudBuildDeployment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SpringCloudBuildDeployment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/spring_cloud_build_deployment azurerm_spring_cloud_build_deployment} Resource.
func NewSpringCloudBuildDeployment(scope constructs.Construct, id *string, config *SpringCloudBuildDeploymentConfig) SpringCloudBuildDeployment {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.springCloudBuildDeployment.SpringCloudBuildDeployment",
...
func (j *jsiiProxy_SpringCloudBuildDeployment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SpringCloudBuildDeployment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SpringCloudBuildDeployment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SpringCloudBuildDeployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SpringCloudBuildDeployment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudBuildDeployment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SpringCloudBuildDeployment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudBuildDeployment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SpringCloudBuildDeployment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SpringCloudBuildDeployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
