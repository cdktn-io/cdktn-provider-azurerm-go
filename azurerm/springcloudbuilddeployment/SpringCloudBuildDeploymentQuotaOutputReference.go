...
func (s *jsiiProxy_SpringCloudBuildDeploymentQuotaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudBuildDeploymentQuotaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
