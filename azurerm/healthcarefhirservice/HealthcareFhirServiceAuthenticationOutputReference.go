...
func (h *jsiiProxy_HealthcareFhirServiceAuthenticationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareFhirServiceAuthenticationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
