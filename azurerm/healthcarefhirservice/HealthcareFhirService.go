...
func (h *jsiiProxy_HealthcareFhirService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HealthcareFhirService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HealthcareFhirService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
