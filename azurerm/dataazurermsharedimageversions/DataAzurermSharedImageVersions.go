...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/dataazurermsharedimageversions/internal"
...
func (j *jsiiProxy_DataAzurermSharedImageVersions) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermSharedImageVersions) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermSharedImageVersions) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermSharedImageVersions) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermSharedImageVersions) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/shared_image_versions azurerm_shared_image_versions} Data Source.
...
func (j *jsiiProxy_DataAzurermSharedImageVersions)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermSharedImageVersions)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermSharedImageVersions)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermSharedImageVersions_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermSharedImageVersions) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermSharedImageVersions) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermSharedImageVersions) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermSharedImageVersions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
