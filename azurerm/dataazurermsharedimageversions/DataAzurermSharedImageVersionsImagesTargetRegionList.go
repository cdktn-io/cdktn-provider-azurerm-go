...
func (j *jsiiProxy_DataAzurermSharedImageVersionsImagesTargetRegionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermSharedImageVersionsImagesTargetRegionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermSharedImageVersionsImagesTargetRegionList {
	_init_.Initialize()
...
func NewDataAzurermSharedImageVersionsImagesTargetRegionList_Override(d DataAzurermSharedImageVersionsImagesTargetRegionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermSharedImageVersionsImagesTargetRegionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsImagesTargetRegionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsImagesTargetRegionList) Resolve(context cdktn.IResolveContext) interface{} {
