...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/dataazurermsharedimageversions/internal"
...
type DataAzurermSharedImageVersionsImagesOutputReference interface {
	...
	ExcludeFromLatest() cdktn.IResolvable
	// Experimental.
	Fqn() *string
	Id() *string
...
func (j *jsiiProxy_DataAzurermSharedImageVersionsImagesOutputReference) ExcludeFromLatest() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAzurermSharedImageVersionsImagesOutputReference) Tags() cdktn.StringMap {
...
func (j *jsiiProxy_DataAzurermSharedImageVersionsImagesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermSharedImageVersionsImagesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermSharedImageVersionsImagesOutputReference {
	_init_.Initialize()
...
func NewDataAzurermSharedImageVersionsImagesOutputReference_Override(d DataAzurermSharedImageVersionsImagesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermSharedImageVersionsImagesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsImagesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsImagesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsImagesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsImagesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
