...
func (j *jsiiProxy_DataAzurermSharedImageVersionsImagesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermSharedImageVersionsImagesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermSharedImageVersionsImagesList {
	_init_.Initialize()
...
func NewDataAzurermSharedImageVersionsImagesList_Override(d DataAzurermSharedImageVersionsImagesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermSharedImageVersionsImagesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsImagesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsImagesList) Resolve(context cdktn.IResolveContext) interface{} {
