...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/monitorprivatelinkscopedservice/internal"
...
func (j *jsiiProxy_MonitorPrivateLinkScopedService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MonitorPrivateLinkScopedService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MonitorPrivateLinkScopedService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MonitorPrivateLinkScopedService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MonitorPrivateLinkScopedService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/monitor_private_link_scoped_service azurerm_monitor_private_link_scoped_service} Resource.
func NewMonitorPrivateLinkScopedService(scope constructs.Construct, id *string, config *MonitorPrivateLinkScopedServiceConfig) MonitorPrivateLinkScopedService {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.monitorPrivateLinkScopedService.MonitorPrivateLinkScopedService",
...
func (j *jsiiProxy_MonitorPrivateLinkScopedService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MonitorPrivateLinkScopedService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MonitorPrivateLinkScopedService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MonitorPrivateLinkScopedService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MonitorPrivateLinkScopedService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorPrivateLinkScopedService) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MonitorPrivateLinkScopedService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorPrivateLinkScopedService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitorPrivateLinkScopedService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitorPrivateLinkScopedService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
