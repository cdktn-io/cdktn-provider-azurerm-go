...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/appserviceslotcustomhostnamebinding/internal"
...
func (j *jsiiProxy_AppServiceSlotCustomHostnameBinding) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/app_service_slot_custom_hostname_binding azurerm_app_service_slot_custom_hostname_binding} Resource.
func NewAppServiceSlotCustomHostnameBinding(scope constructs.Construct, id *string, config *AppServiceSlotCustomHostnameBindingConfig) AppServiceSlotCustomHostnameBinding {
	...
	if err := validateNewAppServiceSlotCustomHostnameBindingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AppServiceSlotCustomHostnameBinding)SetAppServiceSlotId(val *string) {
	if err := j.validateSetAppServiceSlotIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_AppServiceSlotCustomHostnameBinding)SetCount(val interface{}) {
...
func AppServiceSlotCustomHostnameBinding_IsConstruct(x interface{}) *bool {
	...
	if err := validateAppServiceSlotCustomHostnameBinding_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AppServiceSlotCustomHostnameBinding_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppServiceSlotCustomHostnameBinding_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AppServiceSlotCustomHostnameBinding_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppServiceSlotCustomHostnameBinding_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBinding) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBinding) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBinding) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBinding) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBinding) MoveToId(id *string) {
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBinding) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBinding) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
