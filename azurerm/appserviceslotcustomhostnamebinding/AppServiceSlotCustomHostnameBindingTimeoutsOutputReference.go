...
func (j *jsiiProxy_AppServiceSlotCustomHostnameBindingTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppServiceSlotCustomHostnameBindingTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppServiceSlotCustomHostnameBindingTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewAppServiceSlotCustomHostnameBindingTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_AppServiceSlotCustomHostnameBindingTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.appServiceSlotCustomHostnameBinding.AppServiceSlotCustomHostnameBindingTimeoutsOutputReference",
...
func NewAppServiceSlotCustomHostnameBindingTimeoutsOutputReference_Override(a AppServiceSlotCustomHostnameBindingTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppServiceSlotCustomHostnameBindingTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBindingTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBindingTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBindingTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotCustomHostnameBindingTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
