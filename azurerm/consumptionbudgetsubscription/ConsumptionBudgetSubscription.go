...
func (j *jsiiProxy_ConsumptionBudgetSubscription) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConsumptionBudgetSubscription) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConsumptionBudgetSubscription) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConsumptionBudgetSubscription) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConsumptionBudgetSubscription) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ConsumptionBudgetSubscription)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConsumptionBudgetSubscription)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConsumptionBudgetSubscription)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ConsumptionBudgetSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConsumptionBudgetSubscription) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConsumptionBudgetSubscription) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConsumptionBudgetSubscription) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConsumptionBudgetSubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConsumptionBudgetSubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConsumptionBudgetSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
