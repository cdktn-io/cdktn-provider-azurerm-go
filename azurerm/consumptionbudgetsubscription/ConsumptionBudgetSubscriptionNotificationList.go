...
func (c *jsiiProxy_ConsumptionBudgetSubscriptionNotificationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConsumptionBudgetSubscriptionNotificationList) Resolve(context cdktf.IResolveContext) interface{} {
