...
func (j *jsiiProxy_ConsumptionBudgetSubscriptionNotificationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConsumptionBudgetSubscriptionNotificationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConsumptionBudgetSubscriptionNotificationList {
	_init_.Initialize()
...
func NewConsumptionBudgetSubscriptionNotificationList_Override(c ConsumptionBudgetSubscriptionNotificationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConsumptionBudgetSubscriptionNotificationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConsumptionBudgetSubscriptionNotificationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConsumptionBudgetSubscriptionNotificationList) Resolve(context cdktn.IResolveContext) interface{} {
