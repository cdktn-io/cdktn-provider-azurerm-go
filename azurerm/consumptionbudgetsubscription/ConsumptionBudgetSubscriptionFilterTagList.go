...
func (j *jsiiProxy_ConsumptionBudgetSubscriptionFilterTagList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConsumptionBudgetSubscriptionFilterTagList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConsumptionBudgetSubscriptionFilterTagList {
	_init_.Initialize()

	if err := validateNewConsumptionBudgetSubscriptionFilterTagListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewConsumptionBudgetSubscriptionFilterTagList_Override(c ConsumptionBudgetSubscriptionFilterTagList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConsumptionBudgetSubscriptionFilterTagList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConsumptionBudgetSubscriptionFilterTagList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConsumptionBudgetSubscriptionFilterTagList) Resolve(context cdktn.IResolveContext) interface{} {
