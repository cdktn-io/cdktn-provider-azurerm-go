...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/mobile_network_sim_policy azurerm_mobile_network_sim_policy} Resource.
...
func MobileNetworkSimPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateMobileNetworkSimPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MobileNetworkSimPolicy) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MobileNetworkSimPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MobileNetworkSimPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MobileNetworkSimPolicy) MoveFromId(id *string) {
...
func (m *jsiiProxy_MobileNetworkSimPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MobileNetworkSimPolicy) MoveToId(id *string) {
...
func (m *jsiiProxy_MobileNetworkSimPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MobileNetworkSimPolicy) ToHclTerraform() interface{} {
	var returns interface{}
