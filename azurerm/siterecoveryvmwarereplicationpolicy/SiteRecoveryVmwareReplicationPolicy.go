...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/site_recovery_vmware_replication_policy azurerm_site_recovery_vmware_replication_policy}.
...
func (j *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/site_recovery_vmware_replication_policy azurerm_site_recovery_vmware_replication_policy} Resource.
func NewSiteRecoveryVmwareReplicationPolicy(scope constructs.Construct, id *string, config *SiteRecoveryVmwareReplicationPolicyConfig) SiteRecoveryVmwareReplicationPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.siteRecoveryVmwareReplicationPolicy.SiteRecoveryVmwareReplicationPolicy",
...
func (j *jsiiProxy_SiteRecoveryVmwareReplicationPolicy)SetCount(val interface{}) {
...
func (j *jsiiProxy_SiteRecoveryVmwareReplicationPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SiteRecoveryVmwareReplicationPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SiteRecoveryVmwareReplicationPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a SiteRecoveryVmwareReplicationPolicy resource upon running "cdktn plan <stack-name>".
func SiteRecoveryVmwareReplicationPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSiteRecoveryVmwareReplicationPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) MoveFromId(id *string) {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) MoveToId(id *string) {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicationPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
