...
func (j *jsiiProxy_IotcentralApplicationNetworkRuleSet) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/iotcentral_application_network_rule_set azurerm_iotcentral_application_network_rule_set} Resource.
...
func (j *jsiiProxy_IotcentralApplicationNetworkRuleSet)SetCount(val interface{}) {
...
// Experimental.
func IotcentralApplicationNetworkRuleSet_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotcentralApplicationNetworkRuleSet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IotcentralApplicationNetworkRuleSet_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotcentralApplicationNetworkRuleSet_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IotcentralApplicationNetworkRuleSet) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotcentralApplicationNetworkRuleSet) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IotcentralApplicationNetworkRuleSet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotcentralApplicationNetworkRuleSet) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotcentralApplicationNetworkRuleSet) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IotcentralApplicationNetworkRuleSet) MoveToId(id *string) {
...
func (i *jsiiProxy_IotcentralApplicationNetworkRuleSet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotcentralApplicationNetworkRuleSet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IotcentralApplicationNetworkRuleSet) ToHclTerraform() interface{} {
	var returns interface{}
