...
func (d *jsiiProxy_DataAzurermLinuxWebAppLogsApplicationLogsAzureBlobStorageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLinuxWebAppLogsApplicationLogsAzureBlobStorageList) Resolve(context cdktf.IResolveContext) interface{} {
