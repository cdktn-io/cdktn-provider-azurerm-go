...
func (d *jsiiProxy_DataAzurermLinuxWebAppStickySettingsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAzurermLinuxWebAppStickySettingsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermLinuxWebAppStickySettingsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermLinuxWebAppStickySettingsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
