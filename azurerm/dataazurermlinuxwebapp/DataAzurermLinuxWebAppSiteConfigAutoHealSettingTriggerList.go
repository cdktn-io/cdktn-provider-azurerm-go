...
func (d *jsiiProxy_DataAzurermLinuxWebAppSiteConfigAutoHealSettingTriggerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLinuxWebAppSiteConfigAutoHealSettingTriggerList) Resolve(context cdktf.IResolveContext) interface{} {
