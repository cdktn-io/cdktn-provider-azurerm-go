...
func (d *jsiiProxy_DataAzurermLinuxWebAppAuthSettingsActiveDirectoryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLinuxWebAppAuthSettingsActiveDirectoryList) Resolve(context cdktf.IResolveContext) interface{} {
