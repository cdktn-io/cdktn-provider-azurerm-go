...
func (d *jsiiProxy_DataAzurermLinuxFunctionApp) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermLinuxFunctionApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
