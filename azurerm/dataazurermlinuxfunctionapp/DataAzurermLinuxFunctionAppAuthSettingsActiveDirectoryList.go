...
func (d *jsiiProxy_DataAzurermLinuxFunctionAppAuthSettingsActiveDirectoryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLinuxFunctionAppAuthSettingsActiveDirectoryList) Resolve(context cdktf.IResolveContext) interface{} {
