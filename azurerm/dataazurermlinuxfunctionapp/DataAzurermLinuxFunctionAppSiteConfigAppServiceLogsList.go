...
func (j *jsiiProxy_DataAzurermLinuxFunctionAppSiteConfigAppServiceLogsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermLinuxFunctionAppSiteConfigAppServiceLogsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermLinuxFunctionAppSiteConfigAppServiceLogsList {
	_init_.Initialize()
...
func NewDataAzurermLinuxFunctionAppSiteConfigAppServiceLogsList_Override(d DataAzurermLinuxFunctionAppSiteConfigAppServiceLogsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermLinuxFunctionAppSiteConfigAppServiceLogsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermLinuxFunctionAppSiteConfigAppServiceLogsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLinuxFunctionAppSiteConfigAppServiceLogsList) Resolve(context cdktn.IResolveContext) interface{} {
