...
func (j *jsiiProxy_FabricCapacity) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FabricCapacity) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FabricCapacity) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FabricCapacity) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FabricCapacity) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_FabricCapacity)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FabricCapacity)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FabricCapacity)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FabricCapacity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FabricCapacity) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FabricCapacity) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FabricCapacity) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FabricCapacity) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FabricCapacity) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FabricCapacity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
