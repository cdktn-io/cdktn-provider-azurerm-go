...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/keyvaultcertificateissuer/internal"
...
func (j *jsiiProxy_KeyVaultCertificateIssuerTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKeyVaultCertificateIssuerTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) KeyVaultCertificateIssuerTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewKeyVaultCertificateIssuerTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_KeyVaultCertificateIssuerTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.keyVaultCertificateIssuer.KeyVaultCertificateIssuerTimeoutsOutputReference",
...
func NewKeyVaultCertificateIssuerTimeoutsOutputReference_Override(k KeyVaultCertificateIssuerTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_KeyVaultCertificateIssuerTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KeyVaultCertificateIssuerTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultCertificateIssuerTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KeyVaultCertificateIssuerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultCertificateIssuerTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
