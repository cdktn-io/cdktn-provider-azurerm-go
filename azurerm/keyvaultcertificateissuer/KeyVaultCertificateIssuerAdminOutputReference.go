...
func (j *jsiiProxy_KeyVaultCertificateIssuerAdminOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKeyVaultCertificateIssuerAdminOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) KeyVaultCertificateIssuerAdminOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.keyVaultCertificateIssuer.KeyVaultCertificateIssuerAdminOutputReference",
...
func NewKeyVaultCertificateIssuerAdminOutputReference_Override(k KeyVaultCertificateIssuerAdminOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KeyVaultCertificateIssuerAdminOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KeyVaultCertificateIssuerAdminOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultCertificateIssuerAdminOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KeyVaultCertificateIssuerAdminOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultCertificateIssuerAdminOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
