...
func (j *jsiiProxy_PimEligibleRoleAssignmentScheduleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPimEligibleRoleAssignmentScheduleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PimEligibleRoleAssignmentScheduleOutputReference {
	_init_.Initialize()
...
func NewPimEligibleRoleAssignmentScheduleOutputReference_Override(p PimEligibleRoleAssignmentScheduleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PimEligibleRoleAssignmentScheduleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PimEligibleRoleAssignmentScheduleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PimEligibleRoleAssignmentScheduleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PimEligibleRoleAssignmentScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PimEligibleRoleAssignmentScheduleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
