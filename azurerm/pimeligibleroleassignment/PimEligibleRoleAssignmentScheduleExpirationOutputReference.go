...
func (j *jsiiProxy_PimEligibleRoleAssignmentScheduleExpirationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPimEligibleRoleAssignmentScheduleExpirationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PimEligibleRoleAssignmentScheduleExpirationOutputReference {
	_init_.Initialize()
...
func NewPimEligibleRoleAssignmentScheduleExpirationOutputReference_Override(p PimEligibleRoleAssignmentScheduleExpirationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PimEligibleRoleAssignmentScheduleExpirationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PimEligibleRoleAssignmentScheduleExpirationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PimEligibleRoleAssignmentScheduleExpirationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PimEligibleRoleAssignmentScheduleExpirationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PimEligibleRoleAssignmentScheduleExpirationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
