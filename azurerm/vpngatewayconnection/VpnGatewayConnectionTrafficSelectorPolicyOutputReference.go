...
func (v *jsiiProxy_VpnGatewayConnectionTrafficSelectorPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnGatewayConnectionTrafficSelectorPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
