...
func (v *jsiiProxy_VpnGatewayConnectionRoutingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnGatewayConnectionRoutingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
