...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/vpngatewayconnection/internal"
...
func (j *jsiiProxy_VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnGatewayConnectionRoutingPropagatedRouteTableOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference {
	_init_.Initialize()

	if err := validateNewVpnGatewayConnectionRoutingPropagatedRouteTableOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.vpnGatewayConnection.VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference",
...
func NewVpnGatewayConnectionRoutingPropagatedRouteTableOutputReference_Override(v VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
