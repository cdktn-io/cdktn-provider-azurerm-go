...
func (v *jsiiProxy_VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnGatewayConnectionRoutingPropagatedRouteTableOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
