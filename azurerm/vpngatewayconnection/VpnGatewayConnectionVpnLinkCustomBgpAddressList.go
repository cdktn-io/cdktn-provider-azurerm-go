...
func (j *jsiiProxy_VpnGatewayConnectionVpnLinkCustomBgpAddressList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnGatewayConnectionVpnLinkCustomBgpAddressList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpnGatewayConnectionVpnLinkCustomBgpAddressList {
	_init_.Initialize()

	if err := validateNewVpnGatewayConnectionVpnLinkCustomBgpAddressListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_VpnGatewayConnectionVpnLinkCustomBgpAddressList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.vpnGatewayConnection.VpnGatewayConnectionVpnLinkCustomBgpAddressList",
...
func NewVpnGatewayConnectionVpnLinkCustomBgpAddressList_Override(v VpnGatewayConnectionVpnLinkCustomBgpAddressList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnGatewayConnectionVpnLinkCustomBgpAddressList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnGatewayConnectionVpnLinkCustomBgpAddressList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpnGatewayConnectionVpnLinkCustomBgpAddressList) Resolve(context cdktn.IResolveContext) interface{} {
