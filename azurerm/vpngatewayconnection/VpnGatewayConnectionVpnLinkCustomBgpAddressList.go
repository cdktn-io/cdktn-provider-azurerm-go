...
func (v *jsiiProxy_VpnGatewayConnectionVpnLinkCustomBgpAddressList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpnGatewayConnectionVpnLinkCustomBgpAddressList) Resolve(context cdktf.IResolveContext) interface{} {
