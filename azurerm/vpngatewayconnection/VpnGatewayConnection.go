...
func (v *jsiiProxy_VpnGatewayConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpnGatewayConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
