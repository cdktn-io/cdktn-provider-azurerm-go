...
func (j *jsiiProxy_VpnGatewayConnectionTrafficSelectorPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnGatewayConnectionTrafficSelectorPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpnGatewayConnectionTrafficSelectorPolicyList {
	_init_.Initialize()
...
func NewVpnGatewayConnectionTrafficSelectorPolicyList_Override(v VpnGatewayConnectionTrafficSelectorPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnGatewayConnectionTrafficSelectorPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnGatewayConnectionTrafficSelectorPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpnGatewayConnectionTrafficSelectorPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
