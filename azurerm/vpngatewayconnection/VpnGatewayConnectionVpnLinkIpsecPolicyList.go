...
func (j *jsiiProxy_VpnGatewayConnectionVpnLinkIpsecPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnGatewayConnectionVpnLinkIpsecPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpnGatewayConnectionVpnLinkIpsecPolicyList {
	_init_.Initialize()
...
func NewVpnGatewayConnectionVpnLinkIpsecPolicyList_Override(v VpnGatewayConnectionVpnLinkIpsecPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnGatewayConnectionVpnLinkIpsecPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnGatewayConnectionVpnLinkIpsecPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpnGatewayConnectionVpnLinkIpsecPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
