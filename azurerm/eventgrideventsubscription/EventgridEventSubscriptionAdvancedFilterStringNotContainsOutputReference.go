...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference {
	_init_.Initialize()

	if err := validateNewEventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridEventSubscription.EventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference",
...
func NewEventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference_Override(e EventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
