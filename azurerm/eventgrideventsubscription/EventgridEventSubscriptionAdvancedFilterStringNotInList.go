...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotInList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotInList) Resolve(context cdktf.IResolveContext) interface{} {
