...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberNotInList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridEventSubscriptionAdvancedFilterNumberNotInList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterNumberNotInList {
	_init_.Initialize()

	if err := validateNewEventgridEventSubscriptionAdvancedFilterNumberNotInListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberNotInList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridEventSubscription.EventgridEventSubscriptionAdvancedFilterNumberNotInList",
...
func NewEventgridEventSubscriptionAdvancedFilterNumberNotInList_Override(e EventgridEventSubscriptionAdvancedFilterNumberNotInList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberNotInList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberNotInList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberNotInList) Resolve(context cdktn.IResolveContext) interface{} {
