...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberNotInList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberNotInList) Resolve(context cdktf.IResolveContext) interface{} {
