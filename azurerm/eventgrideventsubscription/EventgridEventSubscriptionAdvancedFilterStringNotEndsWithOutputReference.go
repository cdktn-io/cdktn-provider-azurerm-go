...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference {
	_init_.Initialize()

	if err := validateNewEventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridEventSubscription.EventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference",
...
func NewEventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference_Override(e EventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotEndsWithOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
