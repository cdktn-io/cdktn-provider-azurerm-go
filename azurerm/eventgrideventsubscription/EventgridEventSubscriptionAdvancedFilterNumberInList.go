...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberInList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberInList) Resolve(context cdktf.IResolveContext) interface{} {
