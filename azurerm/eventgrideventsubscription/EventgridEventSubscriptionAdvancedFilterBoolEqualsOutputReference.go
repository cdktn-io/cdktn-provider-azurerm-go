...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference {
	_init_.Initialize()

	if err := validateNewEventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridEventSubscription.EventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference",
...
func NewEventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference_Override(e EventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterBoolEqualsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
