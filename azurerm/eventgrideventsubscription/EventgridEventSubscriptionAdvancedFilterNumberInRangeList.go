...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberInRangeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridEventSubscriptionAdvancedFilterNumberInRangeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterNumberInRangeList {
	_init_.Initialize()

	if err := validateNewEventgridEventSubscriptionAdvancedFilterNumberInRangeListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberInRangeList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridEventSubscription.EventgridEventSubscriptionAdvancedFilterNumberInRangeList",
...
func NewEventgridEventSubscriptionAdvancedFilterNumberInRangeList_Override(e EventgridEventSubscriptionAdvancedFilterNumberInRangeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberInRangeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberInRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberInRangeList) Resolve(context cdktn.IResolveContext) interface{} {
