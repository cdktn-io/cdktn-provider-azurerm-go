...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotBeginsWithList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridEventSubscriptionAdvancedFilterStringNotBeginsWithList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterStringNotBeginsWithList {
	_init_.Initialize()

	if err := validateNewEventgridEventSubscriptionAdvancedFilterStringNotBeginsWithListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotBeginsWithList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridEventSubscription.EventgridEventSubscriptionAdvancedFilterStringNotBeginsWithList",
...
func NewEventgridEventSubscriptionAdvancedFilterStringNotBeginsWithList_Override(e EventgridEventSubscriptionAdvancedFilterStringNotBeginsWithList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotBeginsWithList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotBeginsWithList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotBeginsWithList) Resolve(context cdktn.IResolveContext) interface{} {
