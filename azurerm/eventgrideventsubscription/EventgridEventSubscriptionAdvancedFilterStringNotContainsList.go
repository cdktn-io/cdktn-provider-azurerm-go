...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventgridEventSubscriptionAdvancedFilterStringNotContainsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterStringNotContainsList {
	_init_.Initialize()

	if err := validateNewEventgridEventSubscriptionAdvancedFilterStringNotContainsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridEventSubscription.EventgridEventSubscriptionAdvancedFilterStringNotContainsList",
...
func NewEventgridEventSubscriptionAdvancedFilterStringNotContainsList_Override(e EventgridEventSubscriptionAdvancedFilterStringNotContainsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsList) Resolve(context cdktn.IResolveContext) interface{} {
