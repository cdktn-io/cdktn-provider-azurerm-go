...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringNotContainsList) Resolve(context cdktf.IResolveContext) interface{} {
