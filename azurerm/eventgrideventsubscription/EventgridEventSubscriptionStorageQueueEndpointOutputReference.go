...
func (e *jsiiProxy_EventgridEventSubscriptionStorageQueueEndpointOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventgridEventSubscriptionStorageQueueEndpointOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
