...
func (j *jsiiProxy_SynapseSqlPoolWorkloadGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SynapseSqlPoolWorkloadGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
