...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfInputList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStreamAnalyticsFunctionJavascriptUdfInputList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StreamAnalyticsFunctionJavascriptUdfInputList {
	_init_.Initialize()
...
func NewStreamAnalyticsFunctionJavascriptUdfInputList_Override(s StreamAnalyticsFunctionJavascriptUdfInputList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfInputList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfInputList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfInputList) Resolve(context cdktn.IResolveContext) interface{} {
