...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/stream_analytics_function_javascript_udf azurerm_stream_analytics_function_javascript_udf} Resource.
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StreamAnalyticsFunctionJavascriptUdf_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdf) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
