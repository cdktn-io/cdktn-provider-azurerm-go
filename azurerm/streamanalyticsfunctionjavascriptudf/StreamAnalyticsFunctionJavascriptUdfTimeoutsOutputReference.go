...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/streamanalyticsfunctionjavascriptudf/internal"
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewStreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.streamAnalyticsFunctionJavascriptUdf.StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference",
...
func NewStreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference_Override(s StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
