...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/streamanalyticsfunctionjavascriptudf/internal"
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
