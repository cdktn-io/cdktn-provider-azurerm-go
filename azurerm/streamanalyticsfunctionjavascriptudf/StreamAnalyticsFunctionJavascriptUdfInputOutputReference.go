...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfInputOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStreamAnalyticsFunctionJavascriptUdfInputOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StreamAnalyticsFunctionJavascriptUdfInputOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.streamAnalyticsFunctionJavascriptUdf.StreamAnalyticsFunctionJavascriptUdfInputOutputReference",
...
func NewStreamAnalyticsFunctionJavascriptUdfInputOutputReference_Override(s StreamAnalyticsFunctionJavascriptUdfInputOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfInputOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfInputOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfInputOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfInputOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsFunctionJavascriptUdfInputOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
