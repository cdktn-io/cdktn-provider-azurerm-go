...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/netappbackupvault/internal"
...
func (j *jsiiProxy_NetappBackupVault) AccountName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountName",
...
func (j *jsiiProxy_NetappBackupVault) AccountNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountNameInput",
...
func (j *jsiiProxy_NetappBackupVault) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_NetappBackupVault) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetappBackupVault) Tags() *map[string]*string {
...
func (j *jsiiProxy_NetappBackupVault) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/netapp_backup_vault azurerm_netapp_backup_vault} Resource.
...
func (j *jsiiProxy_NetappBackupVault)SetAccountName(val *string) {
...
func (j *jsiiProxy_NetappBackupVault)SetResourceGroupName(val *string) {
...
func (j *jsiiProxy_NetappBackupVault)SetTags(val *map[string]*string) {
...
func (n *jsiiProxy_NetappBackupVault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetappBackupVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetappBackupVault) ResetTags() {
	_jsii_.InvokeVoid(
		n,
		"resetTags",
		nil, // no parameters
...
func (n *jsiiProxy_NetappBackupVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
