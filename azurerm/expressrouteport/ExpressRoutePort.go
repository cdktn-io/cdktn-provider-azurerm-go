...
func (e *jsiiProxy_ExpressRoutePort) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_ExpressRoutePort) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
