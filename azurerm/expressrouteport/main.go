...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "encapsulation", GoGetter: "Encapsulation"},
			_jsii_.MemberProperty{JsiiProperty: "encapsulationInput", GoGetter: "EncapsulationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "link1", GoGetter: "Link1"},
			_jsii_.MemberProperty{JsiiProperty: "link1Input", GoGetter: "Link1Input"},
			_jsii_.MemberProperty{JsiiProperty: "link2", GoGetter: "Link2"},
			_jsii_.MemberProperty{JsiiProperty: "link2Input", GoGetter: "Link2Input"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putLink1", GoMethod: "PutLink1"},
			_jsii_.MemberMethod{JsiiMethod: "putLink2", GoMethod: "PutLink2"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLink1", GoMethod: "ResetLink1"},
			_jsii_.MemberMethod{JsiiMethod: "resetLink2", GoMethod: "ResetLink2"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "macsecCakKeyvaultSecretId", GoGetter: "MacsecCakKeyvaultSecretId"},
			_jsii_.MemberProperty{JsiiProperty: "macsecCakKeyvaultSecretIdInput", GoGetter: "MacsecCakKeyvaultSecretIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "macsecCipher", GoGetter: "MacsecCipher"},
			_jsii_.MemberProperty{JsiiProperty: "macsecCipherInput", GoGetter: "MacsecCipherInput"},
			_jsii_.MemberProperty{JsiiProperty: "macsecCknKeyvaultSecretId", GoGetter: "MacsecCknKeyvaultSecretId"},
			_jsii_.MemberProperty{JsiiProperty: "macsecCknKeyvaultSecretIdInput", GoGetter: "MacsecCknKeyvaultSecretIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "macsecSciEnabled", GoGetter: "MacsecSciEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "macsecSciEnabledInput", GoGetter: "MacsecSciEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "patchPanelId", GoGetter: "PatchPanelId"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMacsecCakKeyvaultSecretId", GoMethod: "ResetMacsecCakKeyvaultSecretId"},
			_jsii_.MemberMethod{JsiiMethod: "resetMacsecCipher", GoMethod: "ResetMacsecCipher"},
			_jsii_.MemberMethod{JsiiMethod: "resetMacsecCknKeyvaultSecretId", GoMethod: "ResetMacsecCknKeyvaultSecretId"},
			_jsii_.MemberMethod{JsiiMethod: "resetMacsecSciEnabled", GoMethod: "ResetMacsecSciEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "routerName", GoGetter: "RouterName"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
