...
func (j *jsiiProxy_ServiceFabricManagedClusterLbRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricManagedClusterLbRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceFabricManagedClusterLbRuleList {
	_init_.Initialize()

	if err := validateNewServiceFabricManagedClusterLbRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ServiceFabricManagedClusterLbRuleList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.serviceFabricManagedCluster.ServiceFabricManagedClusterLbRuleList",
...
func NewServiceFabricManagedClusterLbRuleList_Override(s ServiceFabricManagedClusterLbRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricManagedClusterLbRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricManagedClusterLbRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricManagedClusterLbRuleList) Resolve(context cdktn.IResolveContext) interface{} {
