...
func (j *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricManagedClusterCustomFabricSettingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceFabricManagedClusterCustomFabricSettingList {
	_init_.Initialize()
...
func NewServiceFabricManagedClusterCustomFabricSettingList_Override(s ServiceFabricManagedClusterCustomFabricSettingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingList) Resolve(context cdktn.IResolveContext) interface{} {
