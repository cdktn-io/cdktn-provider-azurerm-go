...
func (j *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricManagedClusterNodeTypeVmSecretsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceFabricManagedClusterNodeTypeVmSecretsList {
	_init_.Initialize()

	if err := validateNewServiceFabricManagedClusterNodeTypeVmSecretsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.serviceFabricManagedCluster.ServiceFabricManagedClusterNodeTypeVmSecretsList",
...
func NewServiceFabricManagedClusterNodeTypeVmSecretsList_Override(s ServiceFabricManagedClusterNodeTypeVmSecretsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsList) Resolve(context cdktn.IResolveContext) interface{} {
