...
func (j *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricManagedClusterCustomFabricSettingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ServiceFabricManagedClusterCustomFabricSettingOutputReference {
	_init_.Initialize()
...
func NewServiceFabricManagedClusterCustomFabricSettingOutputReference_Override(s ServiceFabricManagedClusterCustomFabricSettingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
