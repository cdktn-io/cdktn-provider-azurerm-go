...
func (j *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsCertificatesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricManagedClusterNodeTypeVmSecretsCertificatesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceFabricManagedClusterNodeTypeVmSecretsCertificatesList {
	_init_.Initialize()
...
func NewServiceFabricManagedClusterNodeTypeVmSecretsCertificatesList_Override(s ServiceFabricManagedClusterNodeTypeVmSecretsCertificatesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsCertificatesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsCertificatesList) Resolve(context cdktn.IResolveContext) interface{} {
