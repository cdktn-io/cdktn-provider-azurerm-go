...
func (j *jsiiProxy_ServiceFabricManagedClusterAuthenticationCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricManagedClusterAuthenticationCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceFabricManagedClusterAuthenticationCertificateList {
	_init_.Initialize()
...
func NewServiceFabricManagedClusterAuthenticationCertificateList_Override(s ServiceFabricManagedClusterAuthenticationCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricManagedClusterAuthenticationCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricManagedClusterAuthenticationCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricManagedClusterAuthenticationCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
