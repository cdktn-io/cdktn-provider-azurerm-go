...
func (j *jsiiProxy_ServiceFabricManagedClusterNodeTypeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricManagedClusterNodeTypeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceFabricManagedClusterNodeTypeList {
	_init_.Initialize()

	if err := validateNewServiceFabricManagedClusterNodeTypeListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ServiceFabricManagedClusterNodeTypeList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.serviceFabricManagedCluster.ServiceFabricManagedClusterNodeTypeList",
...
func NewServiceFabricManagedClusterNodeTypeList_Override(s ServiceFabricManagedClusterNodeTypeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricManagedClusterNodeTypeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeList) Resolve(context cdktn.IResolveContext) interface{} {
