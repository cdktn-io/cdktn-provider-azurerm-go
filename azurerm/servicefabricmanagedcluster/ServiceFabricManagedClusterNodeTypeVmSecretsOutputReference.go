...
func (j *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricManagedClusterNodeTypeVmSecretsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference {
	_init_.Initialize()
...
func NewServiceFabricManagedClusterNodeTypeVmSecretsOutputReference_Override(s ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
