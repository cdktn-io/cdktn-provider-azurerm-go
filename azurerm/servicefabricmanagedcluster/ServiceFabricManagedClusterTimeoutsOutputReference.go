...
func (s *jsiiProxy_ServiceFabricManagedClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceFabricManagedClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
