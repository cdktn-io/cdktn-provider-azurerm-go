...
func (j *jsiiProxy_ServiceFabricManagedClusterTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricManagedClusterTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ServiceFabricManagedClusterTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewServiceFabricManagedClusterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_ServiceFabricManagedClusterTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.serviceFabricManagedCluster.ServiceFabricManagedClusterTimeoutsOutputReference",
...
func NewServiceFabricManagedClusterTimeoutsOutputReference_Override(s ServiceFabricManagedClusterTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricManagedClusterTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricManagedClusterTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricManagedClusterTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceFabricManagedClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricManagedClusterTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
