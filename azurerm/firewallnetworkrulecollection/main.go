...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "azureFirewallName", GoGetter: "AzureFirewallName"},
			_jsii_.MemberProperty{JsiiProperty: "azureFirewallNameInput", GoGetter: "AzureFirewallNameInput"},
