...
func (f *jsiiProxy_FirewallNetworkRuleCollection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FirewallNetworkRuleCollection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FirewallNetworkRuleCollection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
