...
func (f *jsiiProxy_FluidRelayServerIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FluidRelayServerIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
