...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "frsTenantId", GoGetter: "FrsTenantId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ordererEndpoints", GoGetter: "OrdererEndpoints"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetStorageSku", GoMethod: "ResetStorageSku"},
			...
			_jsii_.MemberProperty{JsiiProperty: "storageEndpoints", GoGetter: "StorageEndpoints"},
			_jsii_.MemberProperty{JsiiProperty: "storageSku", GoGetter: "StorageSku"},
			_jsii_.MemberProperty{JsiiProperty: "storageSkuInput", GoGetter: "StorageSkuInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_FluidRelayServerCustomerManagedKeyOutputReference{}
