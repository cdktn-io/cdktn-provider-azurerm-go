...
func (c *jsiiProxy_CdnFrontdoorOriginTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorOriginTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
