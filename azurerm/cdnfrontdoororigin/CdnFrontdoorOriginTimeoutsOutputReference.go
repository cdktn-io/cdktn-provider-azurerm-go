...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/cdnfrontdoororigin/internal"
...
func (j *jsiiProxy_CdnFrontdoorOriginTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorOriginTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CdnFrontdoorOriginTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewCdnFrontdoorOriginTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewCdnFrontdoorOriginTimeoutsOutputReference_Override(c CdnFrontdoorOriginTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorOriginTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorOriginTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorOriginTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CdnFrontdoorOriginTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorOriginTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
