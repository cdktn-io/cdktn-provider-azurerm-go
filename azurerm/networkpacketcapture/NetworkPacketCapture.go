...
func (j *jsiiProxy_NetworkPacketCapture) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NetworkPacketCapture) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NetworkPacketCapture) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkPacketCapture) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NetworkPacketCapture) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/network_packet_capture azurerm_network_packet_capture} Resource.
...
func (j *jsiiProxy_NetworkPacketCapture)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetworkPacketCapture)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetworkPacketCapture)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NetworkPacketCapture_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkPacketCapture) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkPacketCapture) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NetworkPacketCapture) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkPacketCapture) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkPacketCapture) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkPacketCapture) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
