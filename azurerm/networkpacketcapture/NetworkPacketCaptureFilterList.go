...
func (j *jsiiProxy_NetworkPacketCaptureFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkPacketCaptureFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkPacketCaptureFilterList {
	_init_.Initialize()

	if err := validateNewNetworkPacketCaptureFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewNetworkPacketCaptureFilterList_Override(n NetworkPacketCaptureFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkPacketCaptureFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkPacketCaptureFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkPacketCaptureFilterList) Resolve(context cdktn.IResolveContext) interface{} {
