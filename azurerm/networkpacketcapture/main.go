...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maximumCaptureDuration", GoGetter: "MaximumCaptureDuration"},
			_jsii_.MemberProperty{JsiiProperty: "maximumCaptureDurationInput", GoGetter: "MaximumCaptureDurationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaximumCaptureDuration", GoMethod: "ResetMaximumCaptureDuration"},
