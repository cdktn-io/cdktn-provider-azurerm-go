...
func (n *jsiiProxy_NetworkPacketCaptureFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkPacketCaptureFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
