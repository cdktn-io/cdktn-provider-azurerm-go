...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/networkpacketcapture/internal"
...
func (j *jsiiProxy_NetworkPacketCaptureFilterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkPacketCaptureFilterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) NetworkPacketCaptureFilterOutputReference {
	_init_.Initialize()
...
func NewNetworkPacketCaptureFilterOutputReference_Override(n NetworkPacketCaptureFilterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkPacketCaptureFilterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkPacketCaptureFilterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkPacketCaptureFilterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetworkPacketCaptureFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkPacketCaptureFilterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
