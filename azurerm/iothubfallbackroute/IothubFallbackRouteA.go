...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/iothubfallbackroute/internal"
...
func (j *jsiiProxy_IothubFallbackRouteA) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IothubFallbackRouteA) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IothubFallbackRouteA) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IothubFallbackRouteA) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IothubFallbackRouteA) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IothubFallbackRouteA) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/iothub_fallback_route azurerm_iothub_fallback_route} Resource.
func NewIothubFallbackRouteA(scope constructs.Construct, id *string, config *IothubFallbackRouteAConfig) IothubFallbackRouteA {
	_init_.Initialize()

	if err := validateNewIothubFallbackRouteAParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IothubFallbackRouteA)SetCount(val interface{}) {
...
func (j *jsiiProxy_IothubFallbackRouteA)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IothubFallbackRouteA)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IothubFallbackRouteA)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IothubFallbackRouteA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIothubFallbackRouteA_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IothubFallbackRouteA_IsConstruct(x interface{}) *bool {
	...
	if err := validateIothubFallbackRouteA_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IothubFallbackRouteA_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIothubFallbackRouteA_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IothubFallbackRouteA_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIothubFallbackRouteA_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IothubFallbackRouteA) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IothubFallbackRouteA) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubFallbackRouteA) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IothubFallbackRouteA) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IothubFallbackRouteA) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubFallbackRouteA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IothubFallbackRouteA) MoveFromId(id *string) {
...
func (i *jsiiProxy_IothubFallbackRouteA) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IothubFallbackRouteA) MoveToId(id *string) {
...
func (i *jsiiProxy_IothubFallbackRouteA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IothubFallbackRouteA) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IothubFallbackRouteA) ToHclTerraform() interface{} {
	var returns interface{}
