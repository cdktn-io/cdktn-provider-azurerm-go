...
func (i *jsiiProxy_IothubFallbackRouteTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubFallbackRouteTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
