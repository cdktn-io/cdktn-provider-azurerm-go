...
func (j *jsiiProxy_IothubFallbackRouteTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIothubFallbackRouteTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) IothubFallbackRouteTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewIothubFallbackRouteTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewIothubFallbackRouteTimeoutsOutputReference_Override(i IothubFallbackRouteTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IothubFallbackRouteTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IothubFallbackRouteTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubFallbackRouteTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_IothubFallbackRouteTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubFallbackRouteTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
