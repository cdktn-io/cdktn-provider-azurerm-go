...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/appserviceplan/internal"
...
func (j *jsiiProxy_AppServicePlan) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppServicePlan) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_AppServicePlan) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppServicePlan) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppServicePlan) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppServicePlan) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewAppServicePlan(scope constructs.Construct, id *string, config *AppServicePlanConfig) AppServicePlan {
	...
	if err := validateNewAppServicePlanParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AppServicePlan)SetCount(val interface{}) {
...
func (j *jsiiProxy_AppServicePlan)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppServicePlan)SetIsXenon(val interface{}) {
	if err := j.validateSetIsXenonParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_AppServicePlan)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppServicePlan)SetPerSiteScaling(val interface{}) {
	if err := j.validateSetPerSiteScalingParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_AppServicePlan)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AppServicePlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateAppServicePlan_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AppServicePlan_IsConstruct(x interface{}) *bool {
	...
	if err := validateAppServicePlan_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AppServicePlan_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppServicePlan_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AppServicePlan_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppServicePlan_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AppServicePlan) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AppServicePlan) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServicePlan) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AppServicePlan) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppServicePlan) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServicePlan) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppServicePlan) MoveFromId(id *string) {
...
func (a *jsiiProxy_AppServicePlan) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AppServicePlan) MoveToId(id *string) {
...
func (a *jsiiProxy_AppServicePlan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppServicePlan) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AppServicePlan) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AppServicePlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
