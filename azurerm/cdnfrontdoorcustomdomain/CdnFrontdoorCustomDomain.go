...
func (j *jsiiProxy_CdnFrontdoorCustomDomain) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CdnFrontdoorCustomDomain) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CdnFrontdoorCustomDomain) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CdnFrontdoorCustomDomain) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CdnFrontdoorCustomDomain) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewCdnFrontdoorCustomDomain(scope constructs.Construct, id *string, config *CdnFrontdoorCustomDomainConfig) CdnFrontdoorCustomDomain {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.cdnFrontdoorCustomDomain.CdnFrontdoorCustomDomain",
...
func (j *jsiiProxy_CdnFrontdoorCustomDomain)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CdnFrontdoorCustomDomain)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CdnFrontdoorCustomDomain)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CdnFrontdoorCustomDomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCdnFrontdoorCustomDomain_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) MoveFromId(id *string) {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) MoveToId(id *string) {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CdnFrontdoorCustomDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
