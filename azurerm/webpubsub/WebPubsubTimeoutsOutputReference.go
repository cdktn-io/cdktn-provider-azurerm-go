...
func (w *jsiiProxy_WebPubsubTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebPubsubTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
