...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/webpubsub/internal"
...
func (j *jsiiProxy_WebPubsubTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebPubsubTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WebPubsubTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewWebPubsubTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWebPubsubTimeoutsOutputReference_Override(w WebPubsubTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebPubsubTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebPubsubTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WebPubsubTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
