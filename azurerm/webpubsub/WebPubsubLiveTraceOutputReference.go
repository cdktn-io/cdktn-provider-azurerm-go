...
func (w *jsiiProxy_WebPubsubLiveTraceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebPubsubLiveTraceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
