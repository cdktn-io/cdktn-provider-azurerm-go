...
func (j *jsiiProxy_WebPubsubLiveTraceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebPubsubLiveTraceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WebPubsubLiveTraceOutputReference {
	_init_.Initialize()
...
func NewWebPubsubLiveTraceOutputReference_Override(w WebPubsubLiveTraceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebPubsubLiveTraceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebPubsubLiveTraceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubLiveTraceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WebPubsubLiveTraceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubLiveTraceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
