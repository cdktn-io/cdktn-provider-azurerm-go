...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/webpubsub/internal"
...
func (j *jsiiProxy_WebPubsub) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func NewWebPubsub(scope constructs.Construct, id *string, config *WebPubsubConfig) WebPubsub {
	...
	if err := validateNewWebPubsubParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WebPubsub)SetCount(val interface{}) {
...
func WebPubsub_IsConstruct(x interface{}) *bool {
	...
	if err := validateWebPubsub_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebPubsub_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebPubsub_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebPubsub_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebPubsub_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WebPubsub) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WebPubsub) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WebPubsub) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WebPubsub) MoveFromId(id *string) {
...
func (w *jsiiProxy_WebPubsub) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WebPubsub) MoveToId(id *string) {
...
func (w *jsiiProxy_WebPubsub) PutLiveTrace(value *WebPubsubLiveTrace) {
	if err := w.validatePutLiveTraceParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WebPubsub) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WebPubsub) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WebPubsub) ToHclTerraform() interface{} {
	var returns interface{}
