...
func (j *jsiiProxy_DataAzurermMonitorActionGroupAzureFunctionReceiverList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermMonitorActionGroupAzureFunctionReceiverList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermMonitorActionGroupAzureFunctionReceiverList {
	_init_.Initialize()
...
func NewDataAzurermMonitorActionGroupAzureFunctionReceiverList_Override(d DataAzurermMonitorActionGroupAzureFunctionReceiverList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermMonitorActionGroupAzureFunctionReceiverList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermMonitorActionGroupAzureFunctionReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermMonitorActionGroupAzureFunctionReceiverList) Resolve(context cdktn.IResolveContext) interface{} {
