...
func (d *jsiiProxy_DataAzurermMonitorActionGroupVoiceReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermMonitorActionGroupVoiceReceiverList) Resolve(context cdktf.IResolveContext) interface{} {
