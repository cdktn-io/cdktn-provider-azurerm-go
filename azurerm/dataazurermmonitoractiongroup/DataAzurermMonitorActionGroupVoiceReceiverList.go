...
func (j *jsiiProxy_DataAzurermMonitorActionGroupVoiceReceiverList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermMonitorActionGroupVoiceReceiverList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermMonitorActionGroupVoiceReceiverList {
	_init_.Initialize()
...
func NewDataAzurermMonitorActionGroupVoiceReceiverList_Override(d DataAzurermMonitorActionGroupVoiceReceiverList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermMonitorActionGroupVoiceReceiverList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermMonitorActionGroupVoiceReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermMonitorActionGroupVoiceReceiverList) Resolve(context cdktn.IResolveContext) interface{} {
