...
func (a *jsiiProxy_AutomationSourceControlTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutomationSourceControlTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
