...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/automationsourcecontrol/internal"
...
func (j *jsiiProxy_AutomationSourceControlTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAutomationSourceControlTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AutomationSourceControlTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewAutomationSourceControlTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAutomationSourceControlTimeoutsOutputReference_Override(a AutomationSourceControlTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AutomationSourceControlTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AutomationSourceControlTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationSourceControlTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AutomationSourceControlTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationSourceControlTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
