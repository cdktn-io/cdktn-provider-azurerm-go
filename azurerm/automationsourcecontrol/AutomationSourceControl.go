...
func (a *jsiiProxy_AutomationSourceControl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AutomationSourceControl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
