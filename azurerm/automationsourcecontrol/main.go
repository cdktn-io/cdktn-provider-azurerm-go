...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "automaticSync", GoGetter: "AutomaticSync"},
			_jsii_.MemberProperty{JsiiProperty: "automaticSyncInput", GoGetter: "AutomaticSyncInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "folderPathInput", GoGetter: "FolderPathInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "publishRunbookEnabled", GoGetter: "PublishRunbookEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "publishRunbookEnabledInput", GoGetter: "PublishRunbookEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutomaticSync", GoMethod: "ResetAutomaticSync"},
			_jsii_.MemberMethod{JsiiMethod: "resetBranch", GoMethod: "ResetBranch"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPublishRunbookEnabled", GoMethod: "ResetPublishRunbookEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceControlType", GoGetter: "SourceControlType"},
			_jsii_.MemberProperty{JsiiProperty: "sourceControlTypeInput", GoGetter: "SourceControlTypeInput"},
