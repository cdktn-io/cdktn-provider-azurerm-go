...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/automationsourcecontrol/internal"
...
func (j *jsiiProxy_AutomationSourceControlSecurityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAutomationSourceControlSecurityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AutomationSourceControlSecurityOutputReference {
	_init_.Initialize()

	if err := validateNewAutomationSourceControlSecurityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAutomationSourceControlSecurityOutputReference_Override(a AutomationSourceControlSecurityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AutomationSourceControlSecurityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AutomationSourceControlSecurityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationSourceControlSecurityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AutomationSourceControlSecurityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationSourceControlSecurityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
