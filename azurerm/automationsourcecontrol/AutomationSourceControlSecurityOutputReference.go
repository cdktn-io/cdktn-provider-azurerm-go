...
func (a *jsiiProxy_AutomationSourceControlSecurityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutomationSourceControlSecurityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
