...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "partnerTopicRoutingModeInput", GoGetter: "PartnerTopicRoutingModeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPartnerTopicRoutingMode", GoMethod: "ResetPartnerTopicRoutingMode"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_EventgridPartnerNamespaceInboundIpRuleList{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_EventgridPartnerNamespaceTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
