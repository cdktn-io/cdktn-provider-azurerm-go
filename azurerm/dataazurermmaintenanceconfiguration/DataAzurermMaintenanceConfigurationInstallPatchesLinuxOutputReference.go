...
func (d *jsiiProxy_DataAzurermMaintenanceConfigurationInstallPatchesLinuxOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermMaintenanceConfigurationInstallPatchesLinuxOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
