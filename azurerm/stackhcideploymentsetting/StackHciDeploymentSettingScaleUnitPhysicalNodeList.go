...
func (j *jsiiProxy_StackHciDeploymentSettingScaleUnitPhysicalNodeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStackHciDeploymentSettingScaleUnitPhysicalNodeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StackHciDeploymentSettingScaleUnitPhysicalNodeList {
	_init_.Initialize()
...
func NewStackHciDeploymentSettingScaleUnitPhysicalNodeList_Override(s StackHciDeploymentSettingScaleUnitPhysicalNodeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StackHciDeploymentSettingScaleUnitPhysicalNodeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StackHciDeploymentSettingScaleUnitPhysicalNodeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StackHciDeploymentSettingScaleUnitPhysicalNodeList) Resolve(context cdktn.IResolveContext) interface{} {
