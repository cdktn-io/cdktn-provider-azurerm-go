...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/stack_hci_deployment_setting azurerm_stack_hci_deployment_setting}.
...
func (j *jsiiProxy_StackHciDeploymentSetting) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StackHciDeploymentSetting) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StackHciDeploymentSetting) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StackHciDeploymentSetting) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StackHciDeploymentSetting) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/stack_hci_deployment_setting azurerm_stack_hci_deployment_setting} Resource.
...
func (j *jsiiProxy_StackHciDeploymentSetting)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StackHciDeploymentSetting)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StackHciDeploymentSetting)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StackHciDeploymentSetting_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StackHciDeploymentSetting) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StackHciDeploymentSetting) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StackHciDeploymentSetting) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StackHciDeploymentSetting) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StackHciDeploymentSetting) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StackHciDeploymentSetting) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
