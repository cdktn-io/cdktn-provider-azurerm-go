...
func (j *jsiiProxy_WebPubsubSocketio) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WebPubsubSocketio) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WebPubsubSocketio) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WebPubsubSocketio) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WebPubsubSocketio) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_WebPubsubSocketio)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WebPubsubSocketio)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WebPubsubSocketio)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WebPubsubSocketio_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WebPubsubSocketio) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubSocketio) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WebPubsubSocketio) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebPubsubSocketio) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WebPubsubSocketio) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
