...
type WebAppHybridConnectionConfig struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/web_app_hybrid_connection#id WebAppHybridConnection#id}.
	//
