...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/webapphybridconnection/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/web_app_hybrid_connection azurerm_web_app_hybrid_connection}.
...
func (j *jsiiProxy_WebAppHybridConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WebAppHybridConnection) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_WebAppHybridConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WebAppHybridConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WebAppHybridConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WebAppHybridConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/web_app_hybrid_connection azurerm_web_app_hybrid_connection} Resource.
func NewWebAppHybridConnection(scope constructs.Construct, id *string, config *WebAppHybridConnectionConfig) WebAppHybridConnection {
	...
	if err := validateNewWebAppHybridConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WebAppHybridConnection)SetCount(val interface{}) {
...
func (j *jsiiProxy_WebAppHybridConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WebAppHybridConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WebAppHybridConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WebAppHybridConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateWebAppHybridConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WebAppHybridConnection_IsConstruct(x interface{}) *bool {
	...
	if err := validateWebAppHybridConnection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebAppHybridConnection_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebAppHybridConnection_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebAppHybridConnection_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebAppHybridConnection_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WebAppHybridConnection) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WebAppHybridConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebAppHybridConnection) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WebAppHybridConnection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WebAppHybridConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebAppHybridConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WebAppHybridConnection) MoveFromId(id *string) {
...
func (w *jsiiProxy_WebAppHybridConnection) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WebAppHybridConnection) MoveToId(id *string) {
...
func (w *jsiiProxy_WebAppHybridConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WebAppHybridConnection) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WebAppHybridConnection) ToHclTerraform() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WebAppHybridConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
