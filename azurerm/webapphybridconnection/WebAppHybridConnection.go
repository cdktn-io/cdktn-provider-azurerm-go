...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/webapphybridconnection/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/resources/web_app_hybrid_connection azurerm_web_app_hybrid_connection}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/resources/web_app_hybrid_connection azurerm_web_app_hybrid_connection} Resource.
...
func WebAppHybridConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WebAppHybridConnection) ImportFrom(id *string, provider cdktf.TerraformProvider) {
