...
func (j *jsiiProxy_DataFactoryDatasetAzureSqlTableSchemaColumnList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryDatasetAzureSqlTableSchemaColumnList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryDatasetAzureSqlTableSchemaColumnList {
	_init_.Initialize()
...
func NewDataFactoryDatasetAzureSqlTableSchemaColumnList_Override(d DataFactoryDatasetAzureSqlTableSchemaColumnList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryDatasetAzureSqlTableSchemaColumnList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryDatasetAzureSqlTableSchemaColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryDatasetAzureSqlTableSchemaColumnList) Resolve(context cdktn.IResolveContext) interface{} {
