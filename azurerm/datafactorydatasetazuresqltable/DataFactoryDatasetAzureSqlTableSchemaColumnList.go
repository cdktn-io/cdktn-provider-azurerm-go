...
func (d *jsiiProxy_DataFactoryDatasetAzureSqlTableSchemaColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryDatasetAzureSqlTableSchemaColumnList) Resolve(context cdktf.IResolveContext) interface{} {
