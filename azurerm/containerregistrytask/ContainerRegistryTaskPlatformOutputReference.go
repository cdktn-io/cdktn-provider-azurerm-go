...
func (c *jsiiProxy_ContainerRegistryTaskPlatformOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryTaskPlatformOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
