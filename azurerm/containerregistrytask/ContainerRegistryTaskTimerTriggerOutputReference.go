...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/containerregistrytask/internal"
...
func (j *jsiiProxy_ContainerRegistryTaskTimerTriggerOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerRegistryTaskTimerTriggerOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerRegistryTaskTimerTriggerOutputReference {
	_init_.Initialize()

	if err := validateNewContainerRegistryTaskTimerTriggerOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ContainerRegistryTaskTimerTriggerOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.containerRegistryTask.ContainerRegistryTaskTimerTriggerOutputReference",
...
func NewContainerRegistryTaskTimerTriggerOutputReference_Override(c ContainerRegistryTaskTimerTriggerOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerRegistryTaskTimerTriggerOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerRegistryTaskTimerTriggerOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryTaskTimerTriggerOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerRegistryTaskTimerTriggerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryTaskTimerTriggerOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
