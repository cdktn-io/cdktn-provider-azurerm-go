...
func (c *jsiiProxy_ContainerRegistryTaskBaseImageTriggerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryTaskBaseImageTriggerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
