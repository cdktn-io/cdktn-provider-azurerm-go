...
func (c *jsiiProxy_ContainerRegistryTaskTimerTriggerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryTaskTimerTriggerList) Resolve(context cdktf.IResolveContext) interface{} {
