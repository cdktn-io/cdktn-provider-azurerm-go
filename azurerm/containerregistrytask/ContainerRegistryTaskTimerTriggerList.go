...
func (j *jsiiProxy_ContainerRegistryTaskTimerTriggerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerRegistryTaskTimerTriggerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerRegistryTaskTimerTriggerList {
	_init_.Initialize()

	if err := validateNewContainerRegistryTaskTimerTriggerListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewContainerRegistryTaskTimerTriggerList_Override(c ContainerRegistryTaskTimerTriggerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerRegistryTaskTimerTriggerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerRegistryTaskTimerTriggerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryTaskTimerTriggerList) Resolve(context cdktn.IResolveContext) interface{} {
