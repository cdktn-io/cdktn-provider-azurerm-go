...
func (c *jsiiProxy_ContainerRegistryTaskAgentSettingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryTaskAgentSettingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
