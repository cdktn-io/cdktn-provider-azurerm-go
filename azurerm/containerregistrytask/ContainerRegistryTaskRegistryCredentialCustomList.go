...
func (c *jsiiProxy_ContainerRegistryTaskRegistryCredentialCustomList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryTaskRegistryCredentialCustomList) Resolve(context cdktf.IResolveContext) interface{} {
