...
func (j *jsiiProxy_ContainerRegistryTaskSourceTriggerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerRegistryTaskSourceTriggerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerRegistryTaskSourceTriggerList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.containerRegistryTask.ContainerRegistryTaskSourceTriggerList",
...
func NewContainerRegistryTaskSourceTriggerList_Override(c ContainerRegistryTaskSourceTriggerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerRegistryTaskSourceTriggerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerRegistryTaskSourceTriggerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryTaskSourceTriggerList) Resolve(context cdktn.IResolveContext) interface{} {
