...
func (a *jsiiProxy_ApiManagementApiTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
