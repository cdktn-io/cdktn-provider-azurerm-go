...
func (a *jsiiProxy_ApiManagementApiImportOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiImportOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
