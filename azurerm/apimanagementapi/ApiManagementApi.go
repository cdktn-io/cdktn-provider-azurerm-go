...
func (j *jsiiProxy_ApiManagementApi) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiManagementApi) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiManagementApi) IsCurrent() cdktn.IResolvable {
...
func (j *jsiiProxy_ApiManagementApi) IsOnline() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"isOnline",
...
func (j *jsiiProxy_ApiManagementApi) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiManagementApi) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiManagementApi) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/api_management_api azurerm_api_management_api} Resource.
...
func (j *jsiiProxy_ApiManagementApi)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiManagementApi)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiManagementApi)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApiManagementApi_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApiManagementApi) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApi) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiManagementApi) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApi) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiManagementApi) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiManagementApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
