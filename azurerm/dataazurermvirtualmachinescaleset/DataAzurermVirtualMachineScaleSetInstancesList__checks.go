...
func (d *jsiiProxy_DataAzurermVirtualMachineScaleSetInstancesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAzurermVirtualMachineScaleSetInstancesList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataAzurermVirtualMachineScaleSetInstancesList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataAzurermVirtualMachineScaleSetInstancesList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
