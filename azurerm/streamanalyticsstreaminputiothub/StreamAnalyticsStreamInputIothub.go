...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/streamanalyticsstreaminputiothub/internal"
...
func (j *jsiiProxy_StreamAnalyticsStreamInputIothub) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StreamAnalyticsStreamInputIothub) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StreamAnalyticsStreamInputIothub) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StreamAnalyticsStreamInputIothub) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StreamAnalyticsStreamInputIothub) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/stream_analytics_stream_input_iothub azurerm_stream_analytics_stream_input_iothub} Resource.
...
func (j *jsiiProxy_StreamAnalyticsStreamInputIothub)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StreamAnalyticsStreamInputIothub)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StreamAnalyticsStreamInputIothub)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StreamAnalyticsStreamInputIothub_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StreamAnalyticsStreamInputIothub) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputIothub) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputIothub) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputIothub) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputIothub) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputIothub) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
