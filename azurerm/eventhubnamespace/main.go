...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoInflateEnabledInput", GoGetter: "AutoInflateEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "dedicatedClusterIdInput", GoGetter: "DedicatedClusterIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maximumThroughputUnitsInput", GoGetter: "MaximumThroughputUnitsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "networkRulesets", GoGetter: "NetworkRulesets"},
			_jsii_.MemberProperty{JsiiProperty: "networkRulesetsInput", GoGetter: "NetworkRulesetsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putNetworkRulesets", GoMethod: "PutNetworkRulesets"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAutoInflateEnabled", GoMethod: "ResetAutoInflateEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetCapacity", GoMethod: "ResetCapacity"},
			_jsii_.MemberMethod{JsiiMethod: "resetDedicatedClusterId", GoMethod: "ResetDedicatedClusterId"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaximumThroughputUnits", GoMethod: "ResetMaximumThroughputUnits"},
			_jsii_.MemberMethod{JsiiMethod: "resetMinimumTlsVersion", GoMethod: "ResetMinimumTlsVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetNetworkRulesets", GoMethod: "ResetNetworkRulesets"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPublicNetworkAccessEnabled", GoMethod: "ResetPublicNetworkAccessEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetTrustedServiceAccessEnabled", GoMethod: "ResetTrustedServiceAccessEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetVirtualNetworkRule", GoMethod: "ResetVirtualNetworkRule"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "trustedServiceAccessEnabled", GoGetter: "TrustedServiceAccessEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "trustedServiceAccessEnabledInput", GoGetter: "TrustedServiceAccessEnabledInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "ignoreMissingVirtualNetworkServiceEndpoint", GoGetter: "IgnoreMissingVirtualNetworkServiceEndpoint"},
			_jsii_.MemberProperty{JsiiProperty: "ignoreMissingVirtualNetworkServiceEndpointInput", GoGetter: "IgnoreMissingVirtualNetworkServiceEndpointInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetIgnoreMissingVirtualNetworkServiceEndpoint", GoMethod: "ResetIgnoreMissingVirtualNetworkServiceEndpoint"},
