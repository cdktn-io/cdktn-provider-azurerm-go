...
func (e *jsiiProxy_EventhubNamespace) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EventhubNamespace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EventhubNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
