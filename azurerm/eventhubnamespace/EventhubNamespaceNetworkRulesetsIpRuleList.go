...
func (j *jsiiProxy_EventhubNamespaceNetworkRulesetsIpRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventhubNamespaceNetworkRulesetsIpRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventhubNamespaceNetworkRulesetsIpRuleList {
	_init_.Initialize()

	if err := validateNewEventhubNamespaceNetworkRulesetsIpRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewEventhubNamespaceNetworkRulesetsIpRuleList_Override(e EventhubNamespaceNetworkRulesetsIpRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventhubNamespaceNetworkRulesetsIpRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventhubNamespaceNetworkRulesetsIpRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventhubNamespaceNetworkRulesetsIpRuleList) Resolve(context cdktn.IResolveContext) interface{} {
