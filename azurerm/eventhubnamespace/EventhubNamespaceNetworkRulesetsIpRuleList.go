...
func (e *jsiiProxy_EventhubNamespaceNetworkRulesetsIpRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventhubNamespaceNetworkRulesetsIpRuleList) Resolve(context cdktf.IResolveContext) interface{} {
