...
func (j *jsiiProxy_DataAzurermActiveDirectoryDomainServiceNotificationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermActiveDirectoryDomainServiceNotificationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermActiveDirectoryDomainServiceNotificationsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermActiveDirectoryDomainService.DataAzurermActiveDirectoryDomainServiceNotificationsList",
...
func NewDataAzurermActiveDirectoryDomainServiceNotificationsList_Override(d DataAzurermActiveDirectoryDomainServiceNotificationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermActiveDirectoryDomainServiceNotificationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermActiveDirectoryDomainServiceNotificationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermActiveDirectoryDomainServiceNotificationsList) Resolve(context cdktn.IResolveContext) interface{} {
