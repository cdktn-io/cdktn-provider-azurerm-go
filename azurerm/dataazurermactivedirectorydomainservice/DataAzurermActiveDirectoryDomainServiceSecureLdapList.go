...
func (j *jsiiProxy_DataAzurermActiveDirectoryDomainServiceSecureLdapList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermActiveDirectoryDomainServiceSecureLdapList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermActiveDirectoryDomainServiceSecureLdapList {
	_init_.Initialize()
...
func NewDataAzurermActiveDirectoryDomainServiceSecureLdapList_Override(d DataAzurermActiveDirectoryDomainServiceSecureLdapList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermActiveDirectoryDomainServiceSecureLdapList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermActiveDirectoryDomainServiceSecureLdapList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermActiveDirectoryDomainServiceSecureLdapList) Resolve(context cdktn.IResolveContext) interface{} {
