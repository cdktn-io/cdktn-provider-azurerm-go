...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "artifactsStorageAccountId", GoGetter: "ArtifactsStorageAccountId"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "defaultPremiumStorageAccountId", GoGetter: "DefaultPremiumStorageAccountId"},
			_jsii_.MemberProperty{JsiiProperty: "defaultStorageAccountId", GoGetter: "DefaultStorageAccountId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "premiumDataDiskStorageAccountId", GoGetter: "PremiumDataDiskStorageAccountId"},
