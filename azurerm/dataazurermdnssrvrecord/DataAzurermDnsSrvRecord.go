...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/dataazurermdnssrvrecord/internal"
...
func (j *jsiiProxy_DataAzurermDnsSrvRecord) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermDnsSrvRecord) Count() interface{} {
...
func (j *jsiiProxy_DataAzurermDnsSrvRecord) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermDnsSrvRecord) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermDnsSrvRecord) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermDnsSrvRecord) Tags() cdktn.StringMap {
...
func (j *jsiiProxy_DataAzurermDnsSrvRecord) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAzurermDnsSrvRecord(scope constructs.Construct, id *string, config *DataAzurermDnsSrvRecordConfig) DataAzurermDnsSrvRecord {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermDnsSrvRecord.DataAzurermDnsSrvRecord",
...
func (j *jsiiProxy_DataAzurermDnsSrvRecord)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataAzurermDnsSrvRecord)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermDnsSrvRecord)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermDnsSrvRecord)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermDnsSrvRecord_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAzurermDnsSrvRecord_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermDnsSrvRecord) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermDnsSrvRecord) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermDnsSrvRecord) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermDnsSrvRecord) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermDnsSrvRecord) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAzurermDnsSrvRecord) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
