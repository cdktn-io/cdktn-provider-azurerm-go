...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/springcloudconnection/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/spring_cloud_connection azurerm_spring_cloud_connection}.
...
func (j *jsiiProxy_SpringCloudConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SpringCloudConnection) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SpringCloudConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SpringCloudConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SpringCloudConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SpringCloudConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/spring_cloud_connection azurerm_spring_cloud_connection} Resource.
func NewSpringCloudConnection(scope constructs.Construct, id *string, config *SpringCloudConnectionConfig) SpringCloudConnection {
	...
	if err := validateNewSpringCloudConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SpringCloudConnection)SetCount(val interface{}) {
...
func (j *jsiiProxy_SpringCloudConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SpringCloudConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SpringCloudConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_SpringCloudConnection)SetSpringCloudId(val *string) {
	if err := j.validateSetSpringCloudIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func SpringCloudConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSpringCloudConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SpringCloudConnection_IsConstruct(x interface{}) *bool {
	...
	if err := validateSpringCloudConnection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SpringCloudConnection_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSpringCloudConnection_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SpringCloudConnection_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSpringCloudConnection_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SpringCloudConnection) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SpringCloudConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudConnection) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SpringCloudConnection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SpringCloudConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SpringCloudConnection) MoveFromId(id *string) {
...
func (s *jsiiProxy_SpringCloudConnection) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SpringCloudConnection) MoveToId(id *string) {
...
func (s *jsiiProxy_SpringCloudConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SpringCloudConnection) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SpringCloudConnection) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SpringCloudConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
