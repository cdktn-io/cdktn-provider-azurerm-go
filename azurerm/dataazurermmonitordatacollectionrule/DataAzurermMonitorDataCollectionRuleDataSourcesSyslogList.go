...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesSyslogList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesSyslogList) Resolve(context cdktf.IResolveContext) interface{} {
