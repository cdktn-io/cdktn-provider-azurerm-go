...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesExtensionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesExtensionList) Resolve(context cdktf.IResolveContext) interface{} {
