...
func (j *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesExtensionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermMonitorDataCollectionRuleDataSourcesExtensionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermMonitorDataCollectionRuleDataSourcesExtensionList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermMonitorDataCollectionRule.DataAzurermMonitorDataCollectionRuleDataSourcesExtensionList",
...
func NewDataAzurermMonitorDataCollectionRuleDataSourcesExtensionList_Override(d DataAzurermMonitorDataCollectionRuleDataSourcesExtensionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesExtensionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesExtensionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesExtensionList) Resolve(context cdktn.IResolveContext) interface{} {
