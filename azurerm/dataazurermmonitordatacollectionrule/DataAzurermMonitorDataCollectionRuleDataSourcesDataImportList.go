...
func (j *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesDataImportList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermMonitorDataCollectionRuleDataSourcesDataImportList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermMonitorDataCollectionRuleDataSourcesDataImportList {
	_init_.Initialize()
...
func NewDataAzurermMonitorDataCollectionRuleDataSourcesDataImportList_Override(d DataAzurermMonitorDataCollectionRuleDataSourcesDataImportList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesDataImportList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesDataImportList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesDataImportList) Resolve(context cdktn.IResolveContext) interface{} {
