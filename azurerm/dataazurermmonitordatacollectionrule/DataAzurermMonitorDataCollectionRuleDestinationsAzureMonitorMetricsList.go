...
func (j *jsiiProxy_DataAzurermMonitorDataCollectionRuleDestinationsAzureMonitorMetricsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermMonitorDataCollectionRuleDestinationsAzureMonitorMetricsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermMonitorDataCollectionRuleDestinationsAzureMonitorMetricsList {
	_init_.Initialize()
...
func NewDataAzurermMonitorDataCollectionRuleDestinationsAzureMonitorMetricsList_Override(d DataAzurermMonitorDataCollectionRuleDestinationsAzureMonitorMetricsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermMonitorDataCollectionRuleDestinationsAzureMonitorMetricsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDestinationsAzureMonitorMetricsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDestinationsAzureMonitorMetricsList) Resolve(context cdktn.IResolveContext) interface{} {
