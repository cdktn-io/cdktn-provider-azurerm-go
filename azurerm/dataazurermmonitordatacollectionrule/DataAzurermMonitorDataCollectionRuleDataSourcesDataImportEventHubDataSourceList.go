...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesDataImportEventHubDataSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesDataImportEventHubDataSourceList) Resolve(context cdktf.IResolveContext) interface{} {
