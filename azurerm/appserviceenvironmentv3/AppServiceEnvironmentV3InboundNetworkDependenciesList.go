...
func (j *jsiiProxy_AppServiceEnvironmentV3InboundNetworkDependenciesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppServiceEnvironmentV3InboundNetworkDependenciesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppServiceEnvironmentV3InboundNetworkDependenciesList {
	_init_.Initialize()
...
func NewAppServiceEnvironmentV3InboundNetworkDependenciesList_Override(a AppServiceEnvironmentV3InboundNetworkDependenciesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppServiceEnvironmentV3InboundNetworkDependenciesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppServiceEnvironmentV3InboundNetworkDependenciesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppServiceEnvironmentV3InboundNetworkDependenciesList) Resolve(context cdktn.IResolveContext) interface{} {
