...
func (a *jsiiProxy_AppServiceEnvironmentV3InboundNetworkDependenciesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppServiceEnvironmentV3InboundNetworkDependenciesList) Resolve(context cdktf.IResolveContext) interface{} {
