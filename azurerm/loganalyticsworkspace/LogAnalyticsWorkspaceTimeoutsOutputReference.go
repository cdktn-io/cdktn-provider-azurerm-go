...
func (j *jsiiProxy_LogAnalyticsWorkspaceTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogAnalyticsWorkspaceTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LogAnalyticsWorkspaceTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewLogAnalyticsWorkspaceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewLogAnalyticsWorkspaceTimeoutsOutputReference_Override(l LogAnalyticsWorkspaceTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogAnalyticsWorkspaceTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogAnalyticsWorkspaceTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsWorkspaceTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LogAnalyticsWorkspaceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsWorkspaceTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
