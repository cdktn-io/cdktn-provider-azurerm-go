...
func (l *jsiiProxy_LogAnalyticsWorkspaceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsWorkspaceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
