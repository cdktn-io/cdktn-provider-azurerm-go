...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dailyQuotaGbInput", GoGetter: "DailyQuotaGbInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "immediateDataPurgeOn30DaysEnabled", GoGetter: "ImmediateDataPurgeOn30DaysEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "immediateDataPurgeOn30DaysEnabledInput", GoGetter: "ImmediateDataPurgeOn30DaysEnabledInput"},
			_jsii_.MemberMethod{JsiiMethod: "importFrom", GoMethod: "ImportFrom"},
			_jsii_.MemberProperty{JsiiProperty: "internetIngestionAccessType", GoGetter: "InternetIngestionAccessType"},
			_jsii_.MemberProperty{JsiiProperty: "internetIngestionAccessTypeInput", GoGetter: "InternetIngestionAccessTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "internetQueryAccessType", GoGetter: "InternetQueryAccessType"},
			_jsii_.MemberProperty{JsiiProperty: "internetQueryAccessTypeInput", GoGetter: "InternetQueryAccessTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetImmediateDataPurgeOn30DaysEnabled", GoMethod: "ResetImmediateDataPurgeOn30DaysEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetInternetIngestionAccessType", GoMethod: "ResetInternetIngestionAccessType"},
			_jsii_.MemberMethod{JsiiMethod: "resetInternetQueryAccessType", GoMethod: "ResetInternetQueryAccessType"},
			_jsii_.MemberMethod{JsiiMethod: "resetLocalAuthenticationEnabled", GoMethod: "ResetLocalAuthenticationEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetReservationCapacityInGbPerDay", GoMethod: "ResetReservationCapacityInGbPerDay"},
