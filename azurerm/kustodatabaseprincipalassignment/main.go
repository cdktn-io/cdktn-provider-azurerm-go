...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KustoDatabasePrincipalAssignment)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_KustoDatabasePrincipalAssignment{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.kustoDatabasePrincipalAssignment.KustoDatabasePrincipalAssignmentConfig",
		reflect.TypeOf((*KustoDatabasePrincipalAssignmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.kustoDatabasePrincipalAssignment.KustoDatabasePrincipalAssignmentTimeouts",
		reflect.TypeOf((*KustoDatabasePrincipalAssignmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azurerm.kustoDatabasePrincipalAssignment.KustoDatabasePrincipalAssignmentTimeoutsOutputReference",
		reflect.TypeOf((*KustoDatabasePrincipalAssignmentTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
