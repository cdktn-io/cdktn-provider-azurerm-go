...
func (j *jsiiProxy_ConsumptionBudgetManagementGroupFilterDimensionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConsumptionBudgetManagementGroupFilterDimensionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConsumptionBudgetManagementGroupFilterDimensionList {
	_init_.Initialize()
...
func NewConsumptionBudgetManagementGroupFilterDimensionList_Override(c ConsumptionBudgetManagementGroupFilterDimensionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConsumptionBudgetManagementGroupFilterDimensionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupFilterDimensionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupFilterDimensionList) Resolve(context cdktn.IResolveContext) interface{} {
