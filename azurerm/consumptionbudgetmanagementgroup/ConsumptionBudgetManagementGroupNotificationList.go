...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupNotificationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupNotificationList) Resolve(context cdktf.IResolveContext) interface{} {
