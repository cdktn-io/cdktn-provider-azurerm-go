...
func (j *jsiiProxy_ConsumptionBudgetManagementGroupNotificationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConsumptionBudgetManagementGroupNotificationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConsumptionBudgetManagementGroupNotificationList {
	_init_.Initialize()

	if err := validateNewConsumptionBudgetManagementGroupNotificationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ConsumptionBudgetManagementGroupNotificationList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.consumptionBudgetManagementGroup.ConsumptionBudgetManagementGroupNotificationList",
...
func NewConsumptionBudgetManagementGroupNotificationList_Override(c ConsumptionBudgetManagementGroupNotificationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConsumptionBudgetManagementGroupNotificationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupNotificationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupNotificationList) Resolve(context cdktn.IResolveContext) interface{} {
