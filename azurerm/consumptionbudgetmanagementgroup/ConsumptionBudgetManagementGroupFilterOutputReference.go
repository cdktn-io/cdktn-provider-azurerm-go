...
func (j *jsiiProxy_ConsumptionBudgetManagementGroupFilterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConsumptionBudgetManagementGroupFilterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ConsumptionBudgetManagementGroupFilterOutputReference {
	_init_.Initialize()

	if err := validateNewConsumptionBudgetManagementGroupFilterOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_ConsumptionBudgetManagementGroupFilterOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.consumptionBudgetManagementGroup.ConsumptionBudgetManagementGroupFilterOutputReference",
...
func NewConsumptionBudgetManagementGroupFilterOutputReference_Override(c ConsumptionBudgetManagementGroupFilterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConsumptionBudgetManagementGroupFilterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupFilterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupFilterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupFilterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
