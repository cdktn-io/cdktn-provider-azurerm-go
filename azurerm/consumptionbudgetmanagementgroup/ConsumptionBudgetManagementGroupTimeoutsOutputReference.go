...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/consumptionbudgetmanagementgroup/internal"
...
func (j *jsiiProxy_ConsumptionBudgetManagementGroupTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConsumptionBudgetManagementGroupTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ConsumptionBudgetManagementGroupTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewConsumptionBudgetManagementGroupTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_ConsumptionBudgetManagementGroupTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.consumptionBudgetManagementGroup.ConsumptionBudgetManagementGroupTimeoutsOutputReference",
...
func NewConsumptionBudgetManagementGroupTimeoutsOutputReference_Override(c ConsumptionBudgetManagementGroupTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConsumptionBudgetManagementGroupTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
