...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "externalMapping", GoGetter: "ExternalMapping"},
			_jsii_.MemberProperty{JsiiProperty: "externalMappingInput", GoGetter: "ExternalMappingInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "internalMapping", GoGetter: "InternalMapping"},
			_jsii_.MemberProperty{JsiiProperty: "internalMappingInput", GoGetter: "InternalMappingInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putExternalMapping", GoMethod: "PutExternalMapping"},
			_jsii_.MemberMethod{JsiiMethod: "putInternalMapping", GoMethod: "PutInternalMapping"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetExternalMapping", GoMethod: "ResetExternalMapping"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetInternalMapping", GoMethod: "ResetInternalMapping"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpConfigurationId", GoMethod: "ResetIpConfigurationId"},
