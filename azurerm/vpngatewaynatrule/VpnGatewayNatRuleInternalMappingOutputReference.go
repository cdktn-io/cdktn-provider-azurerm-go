...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/vpngatewaynatrule/internal"
...
func (j *jsiiProxy_VpnGatewayNatRuleInternalMappingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnGatewayNatRuleInternalMappingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VpnGatewayNatRuleInternalMappingOutputReference {
	_init_.Initialize()

	if err := validateNewVpnGatewayNatRuleInternalMappingOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewVpnGatewayNatRuleInternalMappingOutputReference_Override(v VpnGatewayNatRuleInternalMappingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnGatewayNatRuleInternalMappingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnGatewayNatRuleInternalMappingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnGatewayNatRuleInternalMappingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VpnGatewayNatRuleInternalMappingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnGatewayNatRuleInternalMappingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
