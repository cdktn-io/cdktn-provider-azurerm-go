...
func (j *jsiiProxy_BlueprintAssignmentTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBlueprintAssignmentTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BlueprintAssignmentTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewBlueprintAssignmentTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_BlueprintAssignmentTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.blueprintAssignment.BlueprintAssignmentTimeoutsOutputReference",
...
func NewBlueprintAssignmentTimeoutsOutputReference_Override(b BlueprintAssignmentTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BlueprintAssignmentTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BlueprintAssignmentTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BlueprintAssignmentTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BlueprintAssignmentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BlueprintAssignmentTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
