...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/key_vault_managed_storage_account_sas_token_definition azurerm_key_vault_managed_storage_account_sas_token_definition} Resource.
...
func (k *jsiiProxy_KeyVaultManagedStorageAccountSasTokenDefinition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KeyVaultManagedStorageAccountSasTokenDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KeyVaultManagedStorageAccountSasTokenDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
