...
func (j *jsiiProxy_DataAzurermEventhubAuthorizationRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermEventhubAuthorizationRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermEventhubAuthorizationRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermEventhubAuthorizationRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermEventhubAuthorizationRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAzurermEventhubAuthorizationRule(scope constructs.Construct, id *string, config *DataAzurermEventhubAuthorizationRuleConfig) DataAzurermEventhubAuthorizationRule {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermEventhubAuthorizationRule.DataAzurermEventhubAuthorizationRule",
...
func (j *jsiiProxy_DataAzurermEventhubAuthorizationRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermEventhubAuthorizationRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermEventhubAuthorizationRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermEventhubAuthorizationRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermEventhubAuthorizationRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermEventhubAuthorizationRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermEventhubAuthorizationRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermEventhubAuthorizationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
