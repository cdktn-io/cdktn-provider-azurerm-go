...
func (m *jsiiProxy_MachineLearningInferenceClusterIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MachineLearningInferenceClusterIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
