...
func (j *jsiiProxy_MachineLearningInferenceCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MachineLearningInferenceCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MachineLearningInferenceCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MachineLearningInferenceCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MachineLearningInferenceCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/machine_learning_inference_cluster azurerm_machine_learning_inference_cluster} Resource.
func NewMachineLearningInferenceCluster(scope constructs.Construct, id *string, config *MachineLearningInferenceClusterConfig) MachineLearningInferenceCluster {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.machineLearningInferenceCluster.MachineLearningInferenceCluster",
...
func (j *jsiiProxy_MachineLearningInferenceCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MachineLearningInferenceCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MachineLearningInferenceCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MachineLearningInferenceCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MachineLearningInferenceCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MachineLearningInferenceCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MachineLearningInferenceCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MachineLearningInferenceCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MachineLearningInferenceCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MachineLearningInferenceCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
