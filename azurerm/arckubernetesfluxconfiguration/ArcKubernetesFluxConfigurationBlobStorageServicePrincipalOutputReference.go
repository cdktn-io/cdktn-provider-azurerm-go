...
func (a *jsiiProxy_ArcKubernetesFluxConfigurationBlobStorageServicePrincipalOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ArcKubernetesFluxConfigurationBlobStorageServicePrincipalOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
