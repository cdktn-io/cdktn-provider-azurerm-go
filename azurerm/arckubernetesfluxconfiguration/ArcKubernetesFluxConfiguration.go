...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/arc_kubernetes_flux_configuration azurerm_arc_kubernetes_flux_configuration} Resource.
...
func (a *jsiiProxy_ArcKubernetesFluxConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ArcKubernetesFluxConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ArcKubernetesFluxConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
