...
func (j *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessAList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountNetworkRulesPrivateLinkAccessAList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StorageAccountNetworkRulesPrivateLinkAccessAList {
	_init_.Initialize()

	if err := validateNewStorageAccountNetworkRulesPrivateLinkAccessAListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessAList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.storageAccountNetworkRules.StorageAccountNetworkRulesPrivateLinkAccessAList",
...
func NewStorageAccountNetworkRulesPrivateLinkAccessAList_Override(s StorageAccountNetworkRulesPrivateLinkAccessAList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessAList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessAList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessAList) Resolve(context cdktn.IResolveContext) interface{} {
