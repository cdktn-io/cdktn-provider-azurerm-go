...
func (s *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessAList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessAList) Resolve(context cdktf.IResolveContext) interface{} {
