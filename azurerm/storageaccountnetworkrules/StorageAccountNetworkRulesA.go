...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/storage_account_network_rules azurerm_storage_account_network_rules}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/storage_account_network_rules azurerm_storage_account_network_rules} Resource.
...
func (s *jsiiProxy_StorageAccountNetworkRulesA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageAccountNetworkRulesA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageAccountNetworkRulesA) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
