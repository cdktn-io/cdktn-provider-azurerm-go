...
func (j *jsiiProxy_StorageAccountNetworkRulesTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountNetworkRulesTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StorageAccountNetworkRulesTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewStorageAccountNetworkRulesTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_StorageAccountNetworkRulesTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.storageAccountNetworkRules.StorageAccountNetworkRulesTimeoutsOutputReference",
...
func NewStorageAccountNetworkRulesTimeoutsOutputReference_Override(s StorageAccountNetworkRulesTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountNetworkRulesTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountNetworkRulesTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountNetworkRulesTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageAccountNetworkRulesTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountNetworkRulesTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
