...
func (s *jsiiProxy_StorageAccountNetworkRulesTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountNetworkRulesTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
