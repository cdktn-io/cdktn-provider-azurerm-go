...
func (j *jsiiProxy_SentinelAlertRuleScheduledEntityMappingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelAlertRuleScheduledEntityMappingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SentinelAlertRuleScheduledEntityMappingOutputReference {
	_init_.Initialize()

	if err := validateNewSentinelAlertRuleScheduledEntityMappingOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewSentinelAlertRuleScheduledEntityMappingOutputReference_Override(s SentinelAlertRuleScheduledEntityMappingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelAlertRuleScheduledEntityMappingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledEntityMappingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledEntityMappingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SentinelAlertRuleScheduledEntityMappingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledEntityMappingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
