...
func (s *jsiiProxy_SentinelAlertRuleScheduledTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
