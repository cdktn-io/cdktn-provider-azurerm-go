...
func (j *jsiiProxy_SentinelAlertRuleScheduledTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelAlertRuleScheduledTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SentinelAlertRuleScheduledTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSentinelAlertRuleScheduledTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSentinelAlertRuleScheduledTimeoutsOutputReference_Override(s SentinelAlertRuleScheduledTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelAlertRuleScheduledTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SentinelAlertRuleScheduledTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
