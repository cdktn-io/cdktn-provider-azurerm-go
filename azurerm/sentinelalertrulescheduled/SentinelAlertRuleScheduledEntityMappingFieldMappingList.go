...
func (j *jsiiProxy_SentinelAlertRuleScheduledEntityMappingFieldMappingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelAlertRuleScheduledEntityMappingFieldMappingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SentinelAlertRuleScheduledEntityMappingFieldMappingList {
	_init_.Initialize()

	if err := validateNewSentinelAlertRuleScheduledEntityMappingFieldMappingListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewSentinelAlertRuleScheduledEntityMappingFieldMappingList_Override(s SentinelAlertRuleScheduledEntityMappingFieldMappingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelAlertRuleScheduledEntityMappingFieldMappingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledEntityMappingFieldMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledEntityMappingFieldMappingList) Resolve(context cdktn.IResolveContext) interface{} {
