...
func (s *jsiiProxy_SentinelAlertRuleScheduledEventGroupingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledEventGroupingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
