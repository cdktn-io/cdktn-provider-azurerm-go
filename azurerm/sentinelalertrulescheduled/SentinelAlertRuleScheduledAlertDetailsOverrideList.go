...
func (s *jsiiProxy_SentinelAlertRuleScheduledAlertDetailsOverrideList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledAlertDetailsOverrideList) Resolve(context cdktf.IResolveContext) interface{} {
