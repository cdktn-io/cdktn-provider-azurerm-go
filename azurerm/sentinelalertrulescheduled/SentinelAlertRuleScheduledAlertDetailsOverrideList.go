...
func (j *jsiiProxy_SentinelAlertRuleScheduledAlertDetailsOverrideList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelAlertRuleScheduledAlertDetailsOverrideList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SentinelAlertRuleScheduledAlertDetailsOverrideList {
	_init_.Initialize()

	if err := validateNewSentinelAlertRuleScheduledAlertDetailsOverrideListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewSentinelAlertRuleScheduledAlertDetailsOverrideList_Override(s SentinelAlertRuleScheduledAlertDetailsOverrideList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelAlertRuleScheduledAlertDetailsOverrideList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledAlertDetailsOverrideList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledAlertDetailsOverrideList) Resolve(context cdktn.IResolveContext) interface{} {
