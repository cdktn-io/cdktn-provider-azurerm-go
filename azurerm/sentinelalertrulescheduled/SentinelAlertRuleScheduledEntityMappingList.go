...
func (j *jsiiProxy_SentinelAlertRuleScheduledEntityMappingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelAlertRuleScheduledEntityMappingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SentinelAlertRuleScheduledEntityMappingList {
	_init_.Initialize()

	if err := validateNewSentinelAlertRuleScheduledEntityMappingListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewSentinelAlertRuleScheduledEntityMappingList_Override(s SentinelAlertRuleScheduledEntityMappingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelAlertRuleScheduledEntityMappingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledEntityMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledEntityMappingList) Resolve(context cdktn.IResolveContext) interface{} {
