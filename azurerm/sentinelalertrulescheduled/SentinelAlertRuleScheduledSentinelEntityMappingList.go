...
func (s *jsiiProxy_SentinelAlertRuleScheduledSentinelEntityMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledSentinelEntityMappingList) Resolve(context cdktf.IResolveContext) interface{} {
