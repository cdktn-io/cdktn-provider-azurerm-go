...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/logicappintegrationaccountcertificate/internal"
...
func (j *jsiiProxy_LogicAppIntegrationAccountCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LogicAppIntegrationAccountCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LogicAppIntegrationAccountCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LogicAppIntegrationAccountCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LogicAppIntegrationAccountCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/logic_app_integration_account_certificate azurerm_logic_app_integration_account_certificate} Resource.
func NewLogicAppIntegrationAccountCertificate(scope constructs.Construct, id *string, config *LogicAppIntegrationAccountCertificateConfig) LogicAppIntegrationAccountCertificate {
	...
	if err := validateNewLogicAppIntegrationAccountCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LogicAppIntegrationAccountCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LogicAppIntegrationAccountCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LogicAppIntegrationAccountCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LogicAppIntegrationAccountCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateLogicAppIntegrationAccountCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LogicAppIntegrationAccountCertificate_IsConstruct(x interface{}) *bool {
	...
	if err := validateLogicAppIntegrationAccountCertificate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LogicAppIntegrationAccountCertificate_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLogicAppIntegrationAccountCertificate_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LogicAppIntegrationAccountCertificate_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLogicAppIntegrationAccountCertificate_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) MoveFromId(id *string) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) MoveToId(id *string) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) PutKeyVaultKey(value *LogicAppIntegrationAccountCertificateKeyVaultKey) {
	if err := l.validatePutKeyVaultKeyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) ToHclTerraform() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
