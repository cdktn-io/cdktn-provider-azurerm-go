# CDKTN Go bindings for hashicorp/azurerm provider version 5.5.0

This repo builds and publishes the [Terraform azurerm provider](https://registry.terraform.io/providers/hashicorp/azurerm/5.5.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
* [Terraform azurerm provider](https://registry.terraform.io/providers/hashicorp/azurerm/5.5.0)
