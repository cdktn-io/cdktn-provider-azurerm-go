...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.mssqlVirtualNetworkRule.MssqlVirtualNetworkRuleConfig",
		reflect.TypeOf((*MssqlVirtualNetworkRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.mssqlVirtualNetworkRule.MssqlVirtualNetworkRuleTimeouts",
