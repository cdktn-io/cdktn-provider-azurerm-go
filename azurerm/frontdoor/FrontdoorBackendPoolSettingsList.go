...
func (j *jsiiProxy_FrontdoorBackendPoolSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorBackendPoolSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorBackendPoolSettingsList {
	_init_.Initialize()

	if err := validateNewFrontdoorBackendPoolSettingsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewFrontdoorBackendPoolSettingsList_Override(f FrontdoorBackendPoolSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorBackendPoolSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorBackendPoolSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorBackendPoolSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
