...
func (j *jsiiProxy_FrontdoorBackendPoolList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorBackendPoolList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorBackendPoolList {
	_init_.Initialize()
...
func NewFrontdoorBackendPoolList_Override(f FrontdoorBackendPoolList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorBackendPoolList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorBackendPoolList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorBackendPoolList) Resolve(context cdktn.IResolveContext) interface{} {
