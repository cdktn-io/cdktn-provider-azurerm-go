...
func (j *jsiiProxy_FrontdoorFrontendEndpointOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorFrontendEndpointOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FrontdoorFrontendEndpointOutputReference {
	_init_.Initialize()
...
func NewFrontdoorFrontendEndpointOutputReference_Override(f FrontdoorFrontendEndpointOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorFrontendEndpointOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorFrontendEndpointOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorFrontendEndpointOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FrontdoorFrontendEndpointOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorFrontendEndpointOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
