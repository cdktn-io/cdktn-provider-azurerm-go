...
func (j *jsiiProxy_FrontdoorBackendPoolHealthProbeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorBackendPoolHealthProbeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FrontdoorBackendPoolHealthProbeOutputReference {
	_init_.Initialize()
...
func NewFrontdoorBackendPoolHealthProbeOutputReference_Override(f FrontdoorBackendPoolHealthProbeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorBackendPoolHealthProbeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorBackendPoolHealthProbeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorBackendPoolHealthProbeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FrontdoorBackendPoolHealthProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorBackendPoolHealthProbeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
