...
func (j *jsiiProxy_FrontdoorRoutingRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorRoutingRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorRoutingRuleList {
	_init_.Initialize()
...
func NewFrontdoorRoutingRuleList_Override(f FrontdoorRoutingRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorRoutingRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorRoutingRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorRoutingRuleList) Resolve(context cdktn.IResolveContext) interface{} {
