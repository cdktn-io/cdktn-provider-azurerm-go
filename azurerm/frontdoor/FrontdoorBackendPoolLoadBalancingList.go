...
func (j *jsiiProxy_FrontdoorBackendPoolLoadBalancingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorBackendPoolLoadBalancingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorBackendPoolLoadBalancingList {
	_init_.Initialize()
...
func NewFrontdoorBackendPoolLoadBalancingList_Override(f FrontdoorBackendPoolLoadBalancingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorBackendPoolLoadBalancingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorBackendPoolLoadBalancingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorBackendPoolLoadBalancingList) Resolve(context cdktn.IResolveContext) interface{} {
