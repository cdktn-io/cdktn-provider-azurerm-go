...
func (j *jsiiProxy_FrontdoorFrontendEndpointList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorFrontendEndpointList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorFrontendEndpointList {
	_init_.Initialize()
...
func NewFrontdoorFrontendEndpointList_Override(f FrontdoorFrontendEndpointList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorFrontendEndpointList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorFrontendEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorFrontendEndpointList) Resolve(context cdktn.IResolveContext) interface{} {
