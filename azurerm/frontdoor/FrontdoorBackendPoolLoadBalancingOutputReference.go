...
func (j *jsiiProxy_FrontdoorBackendPoolLoadBalancingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorBackendPoolLoadBalancingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FrontdoorBackendPoolLoadBalancingOutputReference {
	_init_.Initialize()
...
func NewFrontdoorBackendPoolLoadBalancingOutputReference_Override(f FrontdoorBackendPoolLoadBalancingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorBackendPoolLoadBalancingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorBackendPoolLoadBalancingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorBackendPoolLoadBalancingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FrontdoorBackendPoolLoadBalancingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorBackendPoolLoadBalancingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
