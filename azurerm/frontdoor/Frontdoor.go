...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/frontdoor azurerm_frontdoor}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/frontdoor azurerm_frontdoor} Resource.
...
func (f *jsiiProxy_Frontdoor) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_Frontdoor) PutBackendPoolSettings(value interface{}) {
	if err := f.validatePutBackendPoolSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		f,
...
func (f *jsiiProxy_Frontdoor) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_Frontdoor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
