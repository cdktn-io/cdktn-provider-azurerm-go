...
func (j *jsiiProxy_FrontdoorExplicitResourceOrderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorExplicitResourceOrderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorExplicitResourceOrderList {
	_init_.Initialize()
...
func NewFrontdoorExplicitResourceOrderList_Override(f FrontdoorExplicitResourceOrderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorExplicitResourceOrderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorExplicitResourceOrderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorExplicitResourceOrderList) Resolve(context cdktn.IResolveContext) interface{} {
