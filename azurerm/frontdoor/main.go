...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "backendPoolSettings", GoGetter: "BackendPoolSettings"},
			_jsii_.MemberProperty{JsiiProperty: "backendPoolSettingsInput", GoGetter: "BackendPoolSettingsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putBackendPoolSettings", GoMethod: "PutBackendPoolSettings"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBackendPoolSettings", GoMethod: "ResetBackendPoolSettings"},
