...
func (j *jsiiProxy_DataAzurermApplicationGatewayHttpListenerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermApplicationGatewayHttpListenerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermApplicationGatewayHttpListenerList {
	_init_.Initialize()
...
func NewDataAzurermApplicationGatewayHttpListenerList_Override(d DataAzurermApplicationGatewayHttpListenerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermApplicationGatewayHttpListenerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermApplicationGatewayHttpListenerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermApplicationGatewayHttpListenerList) Resolve(context cdktn.IResolveContext) interface{} {
