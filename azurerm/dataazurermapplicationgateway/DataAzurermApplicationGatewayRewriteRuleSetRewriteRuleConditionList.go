...
func (j *jsiiProxy_DataAzurermApplicationGatewayRewriteRuleSetRewriteRuleConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermApplicationGatewayRewriteRuleSetRewriteRuleConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermApplicationGatewayRewriteRuleSetRewriteRuleConditionList {
	_init_.Initialize()
...
func NewDataAzurermApplicationGatewayRewriteRuleSetRewriteRuleConditionList_Override(d DataAzurermApplicationGatewayRewriteRuleSetRewriteRuleConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermApplicationGatewayRewriteRuleSetRewriteRuleConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermApplicationGatewayRewriteRuleSetRewriteRuleConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermApplicationGatewayRewriteRuleSetRewriteRuleConditionList) Resolve(context cdktn.IResolveContext) interface{} {
