...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/monitormetricalert/internal"
...
func (j *jsiiProxy_MonitorMetricAlertCriteriaDimensionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorMetricAlertCriteriaDimensionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorMetricAlertCriteriaDimensionOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorMetricAlertCriteriaDimensionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewMonitorMetricAlertCriteriaDimensionOutputReference_Override(m MonitorMetricAlertCriteriaDimensionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorMetricAlertCriteriaDimensionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorMetricAlertCriteriaDimensionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorMetricAlertCriteriaDimensionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorMetricAlertCriteriaDimensionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorMetricAlertCriteriaDimensionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
