...
func (j *jsiiProxy_MonitorMetricAlertCriteriaList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorMetricAlertCriteriaList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorMetricAlertCriteriaList {
	_init_.Initialize()

	if err := validateNewMonitorMetricAlertCriteriaListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewMonitorMetricAlertCriteriaList_Override(m MonitorMetricAlertCriteriaList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorMetricAlertCriteriaList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorMetricAlertCriteriaList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorMetricAlertCriteriaList) Resolve(context cdktn.IResolveContext) interface{} {
