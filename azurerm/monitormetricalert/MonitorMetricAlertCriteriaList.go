...
func (m *jsiiProxy_MonitorMetricAlertCriteriaList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorMetricAlertCriteriaList) Resolve(context cdktf.IResolveContext) interface{} {
