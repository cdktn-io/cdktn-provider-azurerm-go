...
func (j *jsiiProxy_MonitorMetricAlertActionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorMetricAlertActionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorMetricAlertActionList {
	_init_.Initialize()
...
func NewMonitorMetricAlertActionList_Override(m MonitorMetricAlertActionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorMetricAlertActionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorMetricAlertActionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorMetricAlertActionList) Resolve(context cdktn.IResolveContext) interface{} {
