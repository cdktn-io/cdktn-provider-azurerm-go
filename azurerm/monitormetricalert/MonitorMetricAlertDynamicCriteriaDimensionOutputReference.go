...
func (m *jsiiProxy_MonitorMetricAlertDynamicCriteriaDimensionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorMetricAlertDynamicCriteriaDimensionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
