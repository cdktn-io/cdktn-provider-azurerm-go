...
func (m *jsiiProxy_MonitorMetricAlertTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorMetricAlertTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
