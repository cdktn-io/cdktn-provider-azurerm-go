...
func (j *jsiiProxy_StorageObjectReplicationRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageObjectReplicationRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StorageObjectReplicationRulesList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.storageObjectReplication.StorageObjectReplicationRulesList",
...
func NewStorageObjectReplicationRulesList_Override(s StorageObjectReplicationRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageObjectReplicationRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageObjectReplicationRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageObjectReplicationRulesList) Resolve(context cdktn.IResolveContext) interface{} {
