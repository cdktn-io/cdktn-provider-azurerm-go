...
func (s *jsiiProxy_StorageObjectReplicationRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageObjectReplicationRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
