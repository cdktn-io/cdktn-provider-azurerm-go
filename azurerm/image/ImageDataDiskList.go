...
func (i *jsiiProxy_ImageDataDiskList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (i *jsiiProxy_ImageDataDiskList) Resolve(context cdktf.IResolveContext) interface{} {
