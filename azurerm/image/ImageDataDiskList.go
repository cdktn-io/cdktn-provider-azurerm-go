...
func (j *jsiiProxy_ImageDataDiskList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewImageDataDiskList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ImageDataDiskList {
	_init_.Initialize()

	if err := validateNewImageDataDiskListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewImageDataDiskList_Override(i ImageDataDiskList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ImageDataDiskList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_ImageDataDiskList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_ImageDataDiskList) Resolve(context cdktn.IResolveContext) interface{} {
