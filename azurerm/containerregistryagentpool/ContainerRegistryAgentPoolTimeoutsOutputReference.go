...
func (c *jsiiProxy_ContainerRegistryAgentPoolTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryAgentPoolTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
