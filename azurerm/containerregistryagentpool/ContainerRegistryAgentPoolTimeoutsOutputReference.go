...
func (j *jsiiProxy_ContainerRegistryAgentPoolTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerRegistryAgentPoolTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ContainerRegistryAgentPoolTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewContainerRegistryAgentPoolTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewContainerRegistryAgentPoolTimeoutsOutputReference_Override(c ContainerRegistryAgentPoolTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerRegistryAgentPoolTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerRegistryAgentPoolTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryAgentPoolTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerRegistryAgentPoolTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryAgentPoolTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
