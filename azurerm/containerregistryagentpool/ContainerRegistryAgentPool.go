...
func (j *jsiiProxy_ContainerRegistryAgentPool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ContainerRegistryAgentPool) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ContainerRegistryAgentPool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ContainerRegistryAgentPool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ContainerRegistryAgentPool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ContainerRegistryAgentPool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/container_registry_agent_pool azurerm_container_registry_agent_pool} Resource.
func NewContainerRegistryAgentPool(scope constructs.Construct, id *string, config *ContainerRegistryAgentPoolConfig) ContainerRegistryAgentPool {
	...
	if err := validateNewContainerRegistryAgentPoolParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ContainerRegistryAgentPool)SetCount(val interface{}) {
...
func (j *jsiiProxy_ContainerRegistryAgentPool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ContainerRegistryAgentPool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ContainerRegistryAgentPool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ContainerRegistryAgentPool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateContainerRegistryAgentPool_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ContainerRegistryAgentPool_IsConstruct(x interface{}) *bool {
	...
	if err := validateContainerRegistryAgentPool_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ContainerRegistryAgentPool_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateContainerRegistryAgentPool_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ContainerRegistryAgentPool_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateContainerRegistryAgentPool_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_ContainerRegistryAgentPool) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ContainerRegistryAgentPool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryAgentPool) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ContainerRegistryAgentPool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ContainerRegistryAgentPool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryAgentPool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ContainerRegistryAgentPool) MoveFromId(id *string) {
...
func (c *jsiiProxy_ContainerRegistryAgentPool) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ContainerRegistryAgentPool) MoveToId(id *string) {
...
func (c *jsiiProxy_ContainerRegistryAgentPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ContainerRegistryAgentPool) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ContainerRegistryAgentPool) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ContainerRegistryAgentPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
