...
func (c *jsiiProxy_ContainerAppEnvironmentDaprComponent) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ContainerAppEnvironmentDaprComponent) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
