...
func (j *jsiiProxy_DataAzurermMonitorScheduledQueryRulesLogCriteriaDimensionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermMonitorScheduledQueryRulesLogCriteriaDimensionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermMonitorScheduledQueryRulesLogCriteriaDimensionList {
	_init_.Initialize()
...
func NewDataAzurermMonitorScheduledQueryRulesLogCriteriaDimensionList_Override(d DataAzurermMonitorScheduledQueryRulesLogCriteriaDimensionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermMonitorScheduledQueryRulesLogCriteriaDimensionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermMonitorScheduledQueryRulesLogCriteriaDimensionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermMonitorScheduledQueryRulesLogCriteriaDimensionList) Resolve(context cdktn.IResolveContext) interface{} {
