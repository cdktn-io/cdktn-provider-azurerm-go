...
func (w *jsiiProxy_WindowsWebAppSlotBackupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotBackupOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
