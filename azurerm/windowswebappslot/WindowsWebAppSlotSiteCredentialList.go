...
func (j *jsiiProxy_WindowsWebAppSlotSiteCredentialList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotSiteCredentialList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSlotSiteCredentialList {
	_init_.Initialize()
...
func NewWindowsWebAppSlotSiteCredentialList_Override(w WindowsWebAppSlotSiteCredentialList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotSiteCredentialList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteCredentialList) Resolve(context cdktn.IResolveContext) interface{} {
