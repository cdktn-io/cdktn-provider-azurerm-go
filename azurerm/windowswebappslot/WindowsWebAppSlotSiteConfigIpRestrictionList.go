...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigIpRestrictionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotSiteConfigIpRestrictionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSlotSiteConfigIpRestrictionList {
	_init_.Initialize()
...
func NewWindowsWebAppSlotSiteConfigIpRestrictionList_Override(w WindowsWebAppSlotSiteConfigIpRestrictionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigIpRestrictionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigIpRestrictionList) Resolve(context cdktn.IResolveContext) interface{} {
