...
func (w *jsiiProxy_WindowsWebAppSlotIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
