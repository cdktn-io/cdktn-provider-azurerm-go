...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigCorsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotSiteConfigCorsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsWebAppSlotSiteConfigCorsOutputReference {
	_init_.Initialize()
...
func NewWindowsWebAppSlotSiteConfigCorsOutputReference_Override(w WindowsWebAppSlotSiteConfigCorsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigCorsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigCorsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigCorsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigCorsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
