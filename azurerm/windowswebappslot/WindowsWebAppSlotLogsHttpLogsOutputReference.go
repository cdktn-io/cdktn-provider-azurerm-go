...
func (j *jsiiProxy_WindowsWebAppSlotLogsHttpLogsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotLogsHttpLogsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsWebAppSlotLogsHttpLogsOutputReference {
	_init_.Initialize()
...
func NewWindowsWebAppSlotLogsHttpLogsOutputReference_Override(w WindowsWebAppSlotLogsHttpLogsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotLogsHttpLogsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotLogsHttpLogsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotLogsHttpLogsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppSlotLogsHttpLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotLogsHttpLogsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
