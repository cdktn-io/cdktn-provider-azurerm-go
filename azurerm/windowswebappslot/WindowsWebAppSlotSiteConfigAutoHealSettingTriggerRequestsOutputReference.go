...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigAutoHealSettingTriggerRequestsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigAutoHealSettingTriggerRequestsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
