...
func (w *jsiiProxy_WindowsWebAppSlotConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotConnectionStringOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
