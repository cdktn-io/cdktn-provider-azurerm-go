...
func (j *jsiiProxy_WindowsWebAppSlotConnectionStringList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotConnectionStringList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSlotConnectionStringList {
	_init_.Initialize()
...
func NewWindowsWebAppSlotConnectionStringList_Override(w WindowsWebAppSlotConnectionStringList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotConnectionStringList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSlotConnectionStringList) Resolve(context cdktn.IResolveContext) interface{} {
