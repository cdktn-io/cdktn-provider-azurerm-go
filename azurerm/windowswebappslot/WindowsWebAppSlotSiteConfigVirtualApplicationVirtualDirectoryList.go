...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryList {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebAppSlot.WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryList",
...
func NewWindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryList_Override(w WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryList) Resolve(context cdktn.IResolveContext) interface{} {
