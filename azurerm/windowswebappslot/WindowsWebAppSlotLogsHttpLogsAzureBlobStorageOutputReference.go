...
func (j *jsiiProxy_WindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebAppSlot.WindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference",
...
func NewWindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference_Override(w WindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
