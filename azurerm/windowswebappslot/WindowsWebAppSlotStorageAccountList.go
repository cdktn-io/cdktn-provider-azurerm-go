...
func (w *jsiiProxy_WindowsWebAppSlotStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSlotStorageAccountList) Resolve(context cdktf.IResolveContext) interface{} {
