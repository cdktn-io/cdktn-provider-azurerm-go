...
func (j *jsiiProxy_WindowsWebAppSlotStorageAccountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotStorageAccountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSlotStorageAccountList {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSlotStorageAccountListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSlotStorageAccountList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebAppSlot.WindowsWebAppSlotStorageAccountList",
...
func NewWindowsWebAppSlotStorageAccountList_Override(w WindowsWebAppSlotStorageAccountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotStorageAccountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSlotStorageAccountList) Resolve(context cdktn.IResolveContext) interface{} {
