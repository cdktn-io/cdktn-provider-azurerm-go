...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigScmIpRestrictionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotSiteConfigScmIpRestrictionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSlotSiteConfigScmIpRestrictionList {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSlotSiteConfigScmIpRestrictionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSlotSiteConfigScmIpRestrictionList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebAppSlot.WindowsWebAppSlotSiteConfigScmIpRestrictionList",
...
func NewWindowsWebAppSlotSiteConfigScmIpRestrictionList_Override(w WindowsWebAppSlotSiteConfigScmIpRestrictionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigScmIpRestrictionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigScmIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigScmIpRestrictionList) Resolve(context cdktn.IResolveContext) interface{} {
