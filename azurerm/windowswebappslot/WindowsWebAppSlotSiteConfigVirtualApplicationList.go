...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotSiteConfigVirtualApplicationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSlotSiteConfigVirtualApplicationList {
	_init_.Initialize()
...
func NewWindowsWebAppSlotSiteConfigVirtualApplicationList_Override(w WindowsWebAppSlotSiteConfigVirtualApplicationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationList) Resolve(context cdktn.IResolveContext) interface{} {
