...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationList) Resolve(context cdktf.IResolveContext) interface{} {
