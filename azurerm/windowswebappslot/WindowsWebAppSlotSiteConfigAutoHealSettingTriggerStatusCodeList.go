...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebAppSlot.WindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList",
...
func NewWindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList_Override(w WindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList) Resolve(context cdktn.IResolveContext) interface{} {
