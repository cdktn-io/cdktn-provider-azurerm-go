...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsWebAppSlot.WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference",
...
func NewWindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference_Override(w WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigVirtualApplicationVirtualDirectoryOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
