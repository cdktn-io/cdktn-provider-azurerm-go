...
func (d *jsiiProxy_DataProtectionBackupPolicyDataLakeStorage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataProtectionBackupPolicyDataLakeStorage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
