...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/trafficmanagerprofile/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/traffic_manager_profile azurerm_traffic_manager_profile}.
...
func (j *jsiiProxy_TrafficManagerProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_TrafficManagerProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_TrafficManagerProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TrafficManagerProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_TrafficManagerProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/traffic_manager_profile azurerm_traffic_manager_profile} Resource.
...
func (j *jsiiProxy_TrafficManagerProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_TrafficManagerProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_TrafficManagerProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func TrafficManagerProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_TrafficManagerProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TrafficManagerProfile) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (t *jsiiProxy_TrafficManagerProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TrafficManagerProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TrafficManagerProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TrafficManagerProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
