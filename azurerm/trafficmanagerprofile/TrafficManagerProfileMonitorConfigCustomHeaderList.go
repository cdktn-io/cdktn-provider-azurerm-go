...
func (j *jsiiProxy_TrafficManagerProfileMonitorConfigCustomHeaderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTrafficManagerProfileMonitorConfigCustomHeaderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TrafficManagerProfileMonitorConfigCustomHeaderList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.trafficManagerProfile.TrafficManagerProfileMonitorConfigCustomHeaderList",
...
func NewTrafficManagerProfileMonitorConfigCustomHeaderList_Override(t TrafficManagerProfileMonitorConfigCustomHeaderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TrafficManagerProfileMonitorConfigCustomHeaderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TrafficManagerProfileMonitorConfigCustomHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TrafficManagerProfileMonitorConfigCustomHeaderList) Resolve(context cdktn.IResolveContext) interface{} {
