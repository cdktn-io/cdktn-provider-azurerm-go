...
func (t *jsiiProxy_TrafficManagerProfileTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TrafficManagerProfileTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
