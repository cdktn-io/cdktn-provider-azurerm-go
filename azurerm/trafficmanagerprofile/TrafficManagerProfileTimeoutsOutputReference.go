...
func (j *jsiiProxy_TrafficManagerProfileTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTrafficManagerProfileTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) TrafficManagerProfileTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewTrafficManagerProfileTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_TrafficManagerProfileTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.trafficManagerProfile.TrafficManagerProfileTimeoutsOutputReference",
...
func NewTrafficManagerProfileTimeoutsOutputReference_Override(t TrafficManagerProfileTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_TrafficManagerProfileTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TrafficManagerProfileTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TrafficManagerProfileTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (t *jsiiProxy_TrafficManagerProfileTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TrafficManagerProfileTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
