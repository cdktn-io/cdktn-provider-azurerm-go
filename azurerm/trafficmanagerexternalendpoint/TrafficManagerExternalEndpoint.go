...
func (j *jsiiProxy_TrafficManagerExternalEndpoint) AlwaysServeEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/traffic_manager_external_endpoint azurerm_traffic_manager_external_endpoint} Resource.
...
func (j *jsiiProxy_TrafficManagerExternalEndpoint)SetAlwaysServeEnabled(val interface{}) {
...
func (t *jsiiProxy_TrafficManagerExternalEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TrafficManagerExternalEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TrafficManagerExternalEndpoint) ResetAlwaysServeEnabled() {
	_jsii_.InvokeVoid(
		t,
		"resetAlwaysServeEnabled",
		nil, // no parameters
...
func (t *jsiiProxy_TrafficManagerExternalEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
