...
func (t *jsiiProxy_TrafficManagerExternalEndpointSubnetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TrafficManagerExternalEndpointSubnetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
