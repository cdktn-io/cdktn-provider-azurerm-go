...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "endpointLocation", GoGetter: "EndpointLocation"},
			_jsii_.MemberProperty{JsiiProperty: "endpointLocationInput", GoGetter: "EndpointLocationInput"},
			_jsii_.MemberProperty{JsiiProperty: "forEach", GoGetter: "ForEach"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberProperty{JsiiProperty: "friendlyUniqueId", GoGetter: "FriendlyUniqueId"},
			_jsii_.MemberProperty{JsiiProperty: "geoMappings", GoGetter: "GeoMappings"},
			_jsii_.MemberProperty{JsiiProperty: "geoMappingsInput", GoGetter: "GeoMappingsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEndpointLocation", GoMethod: "ResetEndpointLocation"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_TrafficManagerExternalEndpointCustomHeaderOutputReference{}
