...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "highAvailabilityEnabledInput", GoGetter: "HighAvailabilityEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDefaultDatabase", GoMethod: "PutDefaultDatabase"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetHighAvailabilityEnabled", GoMethod: "ResetHighAvailabilityEnabled"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ManagedRedisDefaultDatabaseModuleOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "accessKeysAuthenticationEnabledInput", GoGetter: "AccessKeysAuthenticationEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "clusteringPolicyInput", GoGetter: "ClusteringPolicyInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberProperty{JsiiProperty: "geoReplicationGroupNameInput", GoGetter: "GeoReplicationGroupNameInput"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getListAttribute", GoMethod: "GetListAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "persistenceAppendOnlyFileBackupFrequencyInput", GoGetter: "PersistenceAppendOnlyFileBackupFrequencyInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "persistenceRedisDatabaseBackupFrequencyInput", GoGetter: "PersistenceRedisDatabaseBackupFrequencyInput"},
			_jsii_.MemberProperty{JsiiProperty: "port", GoGetter: "Port"},
			_jsii_.MemberProperty{JsiiProperty: "primaryAccessKey", GoGetter: "PrimaryAccessKey"},
			_jsii_.MemberMethod{JsiiMethod: "putModule", GoMethod: "PutModule"},
			_jsii_.MemberMethod{JsiiMethod: "resetAccessKeysAuthenticationEnabled", GoMethod: "ResetAccessKeysAuthenticationEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetClientProtocol", GoMethod: "ResetClientProtocol"},
			_jsii_.MemberMethod{JsiiMethod: "resetClusteringPolicy", GoMethod: "ResetClusteringPolicy"},
			_jsii_.MemberMethod{JsiiMethod: "resetEvictionPolicy", GoMethod: "ResetEvictionPolicy"},
			_jsii_.MemberMethod{JsiiMethod: "resetGeoReplicationGroupName", GoMethod: "ResetGeoReplicationGroupName"},
			_jsii_.MemberMethod{JsiiMethod: "resetModule", GoMethod: "ResetModule"},
			_jsii_.MemberMethod{JsiiMethod: "resetPersistenceAppendOnlyFileBackupFrequency", GoMethod: "ResetPersistenceAppendOnlyFileBackupFrequency"},
			_jsii_.MemberMethod{JsiiMethod: "resetPersistenceRedisDatabaseBackupFrequency", GoMethod: "ResetPersistenceRedisDatabaseBackupFrequency"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
