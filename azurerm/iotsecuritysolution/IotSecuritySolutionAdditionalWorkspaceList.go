...
func (j *jsiiProxy_IotSecuritySolutionAdditionalWorkspaceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIotSecuritySolutionAdditionalWorkspaceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IotSecuritySolutionAdditionalWorkspaceList {
	_init_.Initialize()

	if err := validateNewIotSecuritySolutionAdditionalWorkspaceListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewIotSecuritySolutionAdditionalWorkspaceList_Override(i IotSecuritySolutionAdditionalWorkspaceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotSecuritySolutionAdditionalWorkspaceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IotSecuritySolutionAdditionalWorkspaceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IotSecuritySolutionAdditionalWorkspaceList) Resolve(context cdktn.IResolveContext) interface{} {
