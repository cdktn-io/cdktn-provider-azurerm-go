...
func (i *jsiiProxy_IotSecuritySolution) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotSecuritySolution) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotSecuritySolution) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
