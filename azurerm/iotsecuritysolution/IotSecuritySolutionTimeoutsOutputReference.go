...
func (i *jsiiProxy_IotSecuritySolutionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotSecuritySolutionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
