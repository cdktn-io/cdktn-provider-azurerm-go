...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/managementgrouptemplatedeployment/internal"
...
func (j *jsiiProxy_ManagementGroupTemplateDeployment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ManagementGroupTemplateDeployment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ManagementGroupTemplateDeployment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ManagementGroupTemplateDeployment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ManagementGroupTemplateDeployment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ManagementGroupTemplateDeployment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ManagementGroupTemplateDeployment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ManagementGroupTemplateDeployment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ManagementGroupTemplateDeployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_ManagementGroupTemplateDeployment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagementGroupTemplateDeployment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_ManagementGroupTemplateDeployment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagementGroupTemplateDeployment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_ManagementGroupTemplateDeployment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_ManagementGroupTemplateDeployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
