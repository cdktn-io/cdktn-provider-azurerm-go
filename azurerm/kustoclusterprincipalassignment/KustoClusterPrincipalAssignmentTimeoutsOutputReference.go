...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/kustoclusterprincipalassignment/internal"
...
func (j *jsiiProxy_KustoClusterPrincipalAssignmentTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKustoClusterPrincipalAssignmentTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) KustoClusterPrincipalAssignmentTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewKustoClusterPrincipalAssignmentTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_KustoClusterPrincipalAssignmentTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.kustoClusterPrincipalAssignment.KustoClusterPrincipalAssignmentTimeoutsOutputReference",
...
func NewKustoClusterPrincipalAssignmentTimeoutsOutputReference_Override(k KustoClusterPrincipalAssignmentTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_KustoClusterPrincipalAssignmentTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignmentTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignmentTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KustoClusterPrincipalAssignmentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignmentTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
