...
func (k *jsiiProxy_KustoClusterPrincipalAssignmentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignmentTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
