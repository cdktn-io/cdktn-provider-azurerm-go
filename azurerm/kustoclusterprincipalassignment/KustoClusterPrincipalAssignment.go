...
func (j *jsiiProxy_KustoClusterPrincipalAssignment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KustoClusterPrincipalAssignment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KustoClusterPrincipalAssignment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KustoClusterPrincipalAssignment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KustoClusterPrincipalAssignment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_KustoClusterPrincipalAssignment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KustoClusterPrincipalAssignment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KustoClusterPrincipalAssignment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KustoClusterPrincipalAssignment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KustoClusterPrincipalAssignment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
