...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowedTenants", GoGetter: "AllowedTenants"},
			_jsii_.MemberProperty{JsiiProperty: "allowedTenantsInput", GoGetter: "AllowedTenantsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSigninTenant", GoMethod: "ResetSigninTenant"},
