...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/automationvariablestring/internal"
...
func (j *jsiiProxy_AutomationVariableString) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AutomationVariableString) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AutomationVariableString) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AutomationVariableString) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AutomationVariableString) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/automation_variable_string azurerm_automation_variable_string} Resource.
...
func (j *jsiiProxy_AutomationVariableString)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AutomationVariableString)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AutomationVariableString)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AutomationVariableString_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AutomationVariableString) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationVariableString) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AutomationVariableString) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationVariableString) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AutomationVariableString) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AutomationVariableString) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
