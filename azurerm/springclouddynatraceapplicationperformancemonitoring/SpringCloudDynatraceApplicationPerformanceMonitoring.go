...
func (s *jsiiProxy_SpringCloudDynatraceApplicationPerformanceMonitoring) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SpringCloudDynatraceApplicationPerformanceMonitoring) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SpringCloudDynatraceApplicationPerformanceMonitoring) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
