...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "contentEmbedded", GoGetter: "ContentEmbedded"},
			_jsii_.MemberProperty{JsiiProperty: "contentEmbeddedInput", GoGetter: "ContentEmbeddedInput"},
		...
		func() interface{} {
			j := jsiiProxy_AutomationDscNodeconfiguration{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_AutomationDscNodeconfigurationTimeoutsOutputReference{}
