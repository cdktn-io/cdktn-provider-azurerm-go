...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lastSeenDateTime", GoGetter: "LastSeenDateTime"},
			...
			_jsii_.MemberProperty{JsiiProperty: "registrationDateTime", GoGetter: "RegistrationDateTime"},
