...
func (a *jsiiProxy_AutomationHybridRunbookWorker) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AutomationHybridRunbookWorker) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
