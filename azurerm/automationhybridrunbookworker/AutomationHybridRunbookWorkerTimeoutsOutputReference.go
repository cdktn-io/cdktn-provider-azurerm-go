...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/automationhybridrunbookworker/internal"
...
func (j *jsiiProxy_AutomationHybridRunbookWorkerTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAutomationHybridRunbookWorkerTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AutomationHybridRunbookWorkerTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewAutomationHybridRunbookWorkerTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAutomationHybridRunbookWorkerTimeoutsOutputReference_Override(a AutomationHybridRunbookWorkerTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AutomationHybridRunbookWorkerTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AutomationHybridRunbookWorkerTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationHybridRunbookWorkerTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AutomationHybridRunbookWorkerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationHybridRunbookWorkerTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
