...
func (a *jsiiProxy_AutomationHybridRunbookWorkerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutomationHybridRunbookWorkerTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
