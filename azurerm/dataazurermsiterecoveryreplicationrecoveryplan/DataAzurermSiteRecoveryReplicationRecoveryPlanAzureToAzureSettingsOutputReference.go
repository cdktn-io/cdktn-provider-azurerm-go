...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsOutputReference {
	_init_.Initialize()
...
func NewDataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsOutputReference_Override(d DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
