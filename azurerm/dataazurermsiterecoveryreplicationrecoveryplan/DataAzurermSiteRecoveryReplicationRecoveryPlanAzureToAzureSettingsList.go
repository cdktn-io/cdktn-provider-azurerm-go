...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsList {
	_init_.Initialize()
...
func NewDataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsList_Override(d DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlanAzureToAzureSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
