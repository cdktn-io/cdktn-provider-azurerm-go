...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermSiteRecoveryReplicationRecoveryPlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAzurermSiteRecoveryReplicationRecoveryPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
