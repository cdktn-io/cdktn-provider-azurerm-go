...
func (j *jsiiProxy_DnsSrvRecordRecordList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DnsSrvRecordRecordList) InternalValue() interface{} {
...
func (j *jsiiProxy_DnsSrvRecordRecordList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DnsSrvRecordRecordList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewDnsSrvRecordRecordList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DnsSrvRecordRecordList {
	...
	j := jsiiProxy_DnsSrvRecordRecordList{}
...
func (j *jsiiProxy_DnsSrvRecordRecordList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_DnsSrvRecordRecordList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DnsSrvRecordRecordList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DnsSrvRecordRecordList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DnsSrvRecordRecordList) Get(index *float64) DnsSrvRecordRecordOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DnsSrvRecordRecordOutputReference
...
func (d *jsiiProxy_DnsSrvRecordRecordList) ToString() *string {
	var returns *string
