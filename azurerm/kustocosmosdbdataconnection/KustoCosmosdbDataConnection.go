...
func (k *jsiiProxy_KustoCosmosdbDataConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KustoCosmosdbDataConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
