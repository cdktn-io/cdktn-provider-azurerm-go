...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/mssqlserversecurityalertpolicy/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.67.0/docs/resources/mssql_server_security_alert_policy azurerm_mssql_server_security_alert_policy}.
...
func (j *jsiiProxy_MssqlServerSecurityAlertPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MssqlServerSecurityAlertPolicy) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_MssqlServerSecurityAlertPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MssqlServerSecurityAlertPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MssqlServerSecurityAlertPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MssqlServerSecurityAlertPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.67.0/docs/resources/mssql_server_security_alert_policy azurerm_mssql_server_security_alert_policy} Resource.
func NewMssqlServerSecurityAlertPolicy(scope constructs.Construct, id *string, config *MssqlServerSecurityAlertPolicyConfig) MssqlServerSecurityAlertPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.mssqlServerSecurityAlertPolicy.MssqlServerSecurityAlertPolicy",
...
func (j *jsiiProxy_MssqlServerSecurityAlertPolicy)SetCount(val interface{}) {
...
func (j *jsiiProxy_MssqlServerSecurityAlertPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MssqlServerSecurityAlertPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MssqlServerSecurityAlertPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MssqlServerSecurityAlertPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateMssqlServerSecurityAlertPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicy) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicy) MoveFromId(id *string) {
...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicy) MoveToId(id *string) {
...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicy) ToHclTerraform() interface{} {
	var returns interface{}
