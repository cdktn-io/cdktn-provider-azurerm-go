...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MssqlServerSecurityAlertPolicyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
