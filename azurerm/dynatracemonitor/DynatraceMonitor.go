...
func (j *jsiiProxy_DynatraceMonitor) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DynatraceMonitor) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DynatraceMonitor) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DynatraceMonitor) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DynatraceMonitor) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/dynatrace_monitor azurerm_dynatrace_monitor} Resource.
...
func (j *jsiiProxy_DynatraceMonitor)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DynatraceMonitor)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DynatraceMonitor)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DynatraceMonitor_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DynatraceMonitor) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynatraceMonitor) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DynatraceMonitor) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DynatraceMonitor) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DynatraceMonitor) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DynatraceMonitor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
