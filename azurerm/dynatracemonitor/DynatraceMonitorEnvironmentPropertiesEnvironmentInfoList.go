...
func (j *jsiiProxy_DynatraceMonitorEnvironmentPropertiesEnvironmentInfoList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDynatraceMonitorEnvironmentPropertiesEnvironmentInfoList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DynatraceMonitorEnvironmentPropertiesEnvironmentInfoList {
	_init_.Initialize()
...
func NewDynatraceMonitorEnvironmentPropertiesEnvironmentInfoList_Override(d DynatraceMonitorEnvironmentPropertiesEnvironmentInfoList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DynatraceMonitorEnvironmentPropertiesEnvironmentInfoList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DynatraceMonitorEnvironmentPropertiesEnvironmentInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DynatraceMonitorEnvironmentPropertiesEnvironmentInfoList) Resolve(context cdktf.IResolveContext) interface{} {
