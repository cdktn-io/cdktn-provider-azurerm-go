...
func (j *jsiiProxy_DataAzurermCognitiveAccount) LocalAuthEnabled() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"localAuthEnabled",
...
func DataAzurermCognitiveAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
