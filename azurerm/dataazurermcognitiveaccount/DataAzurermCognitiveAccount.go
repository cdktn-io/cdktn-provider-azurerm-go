...
type DataAzurermCognitiveAccount interface {
	...
	DynamicThrottlingEnabled() cdktn.IResolvable
	Endpoint() *string
	// Experimental.
	...
	OutboundNetworkAccessRestricted() cdktn.IResolvable
	PrimaryAccessKey() *string
	ProjectManagementEnabled() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) DynamicThrottlingEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) Identity() DataAzurermCognitiveAccountIdentityList {
	var returns DataAzurermCognitiveAccountIdentityList
	_jsii_.Get(
		j,
		"identity",
		&returns,
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) LocalAuthEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"localAuthEnabled",
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) OutboundNetworkAccessRestricted() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) ProjectManagementEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) PublicNetworkAccessEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAzurermCognitiveAccount)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermCognitiveAccount)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermCognitiveAccount)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermCognitiveAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAzurermCognitiveAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermCognitiveAccount) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermCognitiveAccount) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermCognitiveAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermCognitiveAccount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermCognitiveAccount) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAzurermCognitiveAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
