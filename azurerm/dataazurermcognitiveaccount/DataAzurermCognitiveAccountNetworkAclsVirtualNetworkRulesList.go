...
func (j *jsiiProxy_DataAzurermCognitiveAccountNetworkAclsVirtualNetworkRulesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermCognitiveAccountNetworkAclsVirtualNetworkRulesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermCognitiveAccountNetworkAclsVirtualNetworkRulesList {
	_init_.Initialize()
...
func NewDataAzurermCognitiveAccountNetworkAclsVirtualNetworkRulesList_Override(d DataAzurermCognitiveAccountNetworkAclsVirtualNetworkRulesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermCognitiveAccountNetworkAclsVirtualNetworkRulesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermCognitiveAccountNetworkAclsVirtualNetworkRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermCognitiveAccountNetworkAclsVirtualNetworkRulesList) Resolve(context cdktf.IResolveContext) interface{} {
