...
func (d *jsiiProxy_DataAzurermCognitiveAccountNetworkInjectionList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAzurermCognitiveAccountNetworkInjectionList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermCognitiveAccountNetworkInjectionList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermCognitiveAccountNetworkInjectionList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
