...
func (j *jsiiProxy_DataAzurermKubernetesClusterNodePoolUpgradeSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermKubernetesClusterNodePoolUpgradeSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterNodePoolUpgradeSettingsList {
	_init_.Initialize()
...
func NewDataAzurermKubernetesClusterNodePoolUpgradeSettingsList_Override(d DataAzurermKubernetesClusterNodePoolUpgradeSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermKubernetesClusterNodePoolUpgradeSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterNodePoolUpgradeSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterNodePoolUpgradeSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
