...
func (d *jsiiProxy_DataAzurermKubernetesClusterNodePoolUpgradeSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterNodePoolUpgradeSettingsList) Resolve(context cdktf.IResolveContext) interface{} {
