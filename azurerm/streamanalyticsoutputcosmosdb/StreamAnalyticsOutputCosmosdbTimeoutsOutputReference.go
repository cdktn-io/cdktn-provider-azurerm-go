...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/streamanalyticsoutputcosmosdb/internal"
...
func (s *jsiiProxy_StreamAnalyticsOutputCosmosdbTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsOutputCosmosdbTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
