...
func (j *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/synapse_sql_pool_extended_auditing_policy azurerm_synapse_sql_pool_extended_auditing_policy} Resource.
func NewSynapseSqlPoolExtendedAuditingPolicy(scope constructs.Construct, id *string, config *SynapseSqlPoolExtendedAuditingPolicyConfig) SynapseSqlPoolExtendedAuditingPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.synapseSqlPoolExtendedAuditingPolicy.SynapseSqlPoolExtendedAuditingPolicy",
...
func (j *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SynapseSqlPoolExtendedAuditingPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
