...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/palo_alto_next_generation_firewall_virtual_network_strata_cloud_manager azurerm_palo_alto_next_generation_firewall_virtual_network_strata_cloud_manager} Resource.
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualNetworkStrataCloudManager) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualNetworkStrataCloudManager) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
