...
func (j *jsiiProxy_DataAzurermApiManagementApiSubscriptionKeyParameterNamesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermApiManagementApiSubscriptionKeyParameterNamesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermApiManagementApiSubscriptionKeyParameterNamesList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermApiManagementApi.DataAzurermApiManagementApiSubscriptionKeyParameterNamesList",
...
func NewDataAzurermApiManagementApiSubscriptionKeyParameterNamesList_Override(d DataAzurermApiManagementApiSubscriptionKeyParameterNamesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermApiManagementApiSubscriptionKeyParameterNamesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermApiManagementApiSubscriptionKeyParameterNamesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermApiManagementApiSubscriptionKeyParameterNamesList) Resolve(context cdktn.IResolveContext) interface{} {
