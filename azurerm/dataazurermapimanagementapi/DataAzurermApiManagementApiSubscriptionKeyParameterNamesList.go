...
func (d *jsiiProxy_DataAzurermApiManagementApiSubscriptionKeyParameterNamesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermApiManagementApiSubscriptionKeyParameterNamesList) Resolve(context cdktf.IResolveContext) interface{} {
