...
func (d *jsiiProxy_DevTestLinuxVirtualMachine) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DevTestLinuxVirtualMachine) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DevTestLinuxVirtualMachine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
