...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/devtestlinuxvirtualmachine/internal"
...
func (j *jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDevTestLinuxVirtualMachineInboundNatRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DevTestLinuxVirtualMachineInboundNatRuleOutputReference {
	_init_.Initialize()

	if err := validateNewDevTestLinuxVirtualMachineInboundNatRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.devTestLinuxVirtualMachine.DevTestLinuxVirtualMachineInboundNatRuleOutputReference",
...
func NewDevTestLinuxVirtualMachineInboundNatRuleOutputReference_Override(d DevTestLinuxVirtualMachineInboundNatRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
