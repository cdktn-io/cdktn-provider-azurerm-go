...
func (j *jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDevTestLinuxVirtualMachineInboundNatRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DevTestLinuxVirtualMachineInboundNatRuleList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.devTestLinuxVirtualMachine.DevTestLinuxVirtualMachineInboundNatRuleList",
...
func NewDevTestLinuxVirtualMachineInboundNatRuleList_Override(d DevTestLinuxVirtualMachineInboundNatRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineInboundNatRuleList) Resolve(context cdktn.IResolveContext) interface{} {
