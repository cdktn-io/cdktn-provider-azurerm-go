...
func (j *jsiiProxy_DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDevTestLinuxVirtualMachineGalleryImageReferenceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference {
	_init_.Initialize()

	if err := validateNewDevTestLinuxVirtualMachineGalleryImageReferenceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.devTestLinuxVirtualMachine.DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference",
...
func NewDevTestLinuxVirtualMachineGalleryImageReferenceOutputReference_Override(d DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
