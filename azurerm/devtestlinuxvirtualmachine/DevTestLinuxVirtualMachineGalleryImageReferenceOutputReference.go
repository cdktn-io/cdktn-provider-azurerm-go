...
func (d *jsiiProxy_DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DevTestLinuxVirtualMachineGalleryImageReferenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
