...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "deviceProvisioningHostName", GoGetter: "DeviceProvisioningHostName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "idScope", GoGetter: "IdScope"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serviceOperationsHostName", GoGetter: "ServiceOperationsHostName"},
