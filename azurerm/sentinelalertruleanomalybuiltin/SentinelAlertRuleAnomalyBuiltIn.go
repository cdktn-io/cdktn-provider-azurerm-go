...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/sentinel_alert_rule_anomaly_built_in azurerm_sentinel_alert_rule_anomaly_built_in} Resource.
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyBuiltIn) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyBuiltIn) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyBuiltIn) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
