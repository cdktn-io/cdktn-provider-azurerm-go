...
func (j *jsiiProxy_SentinelAlertRuleAnomalyBuiltInRequiredDataConnectorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelAlertRuleAnomalyBuiltInRequiredDataConnectorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SentinelAlertRuleAnomalyBuiltInRequiredDataConnectorList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.sentinelAlertRuleAnomalyBuiltIn.SentinelAlertRuleAnomalyBuiltInRequiredDataConnectorList",
...
func NewSentinelAlertRuleAnomalyBuiltInRequiredDataConnectorList_Override(s SentinelAlertRuleAnomalyBuiltInRequiredDataConnectorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelAlertRuleAnomalyBuiltInRequiredDataConnectorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyBuiltInRequiredDataConnectorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyBuiltInRequiredDataConnectorList) Resolve(context cdktn.IResolveContext) interface{} {
