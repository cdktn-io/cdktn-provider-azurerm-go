...
func (s *jsiiProxy_SentinelAlertRuleAnomalyBuiltInMultiSelectObservationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyBuiltInMultiSelectObservationList) Resolve(context cdktf.IResolveContext) interface{} {
