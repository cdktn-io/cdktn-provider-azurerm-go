...
func (j *jsiiProxy_SentinelAlertRuleAnomalyBuiltInMultiSelectObservationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelAlertRuleAnomalyBuiltInMultiSelectObservationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SentinelAlertRuleAnomalyBuiltInMultiSelectObservationList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.sentinelAlertRuleAnomalyBuiltIn.SentinelAlertRuleAnomalyBuiltInMultiSelectObservationList",
...
func NewSentinelAlertRuleAnomalyBuiltInMultiSelectObservationList_Override(s SentinelAlertRuleAnomalyBuiltInMultiSelectObservationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelAlertRuleAnomalyBuiltInMultiSelectObservationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyBuiltInMultiSelectObservationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyBuiltInMultiSelectObservationList) Resolve(context cdktn.IResolveContext) interface{} {
