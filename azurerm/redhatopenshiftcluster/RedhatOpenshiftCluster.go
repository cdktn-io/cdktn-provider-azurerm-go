...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/redhat_openshift_cluster azurerm_redhat_openshift_cluster} Resource.
...
func (r *jsiiProxy_RedhatOpenshiftCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedhatOpenshiftCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedhatOpenshiftCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
