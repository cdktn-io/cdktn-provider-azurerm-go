...
func (r *jsiiProxy_RedhatOpenshiftClusterNetworkProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedhatOpenshiftClusterNetworkProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
