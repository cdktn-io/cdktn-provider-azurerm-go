...
func (d *jsiiProxy_DataFactoryCustomDatasetLinkedServiceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryCustomDatasetLinkedServiceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
