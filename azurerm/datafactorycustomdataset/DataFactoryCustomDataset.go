...
func (d *jsiiProxy_DataFactoryCustomDataset) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryCustomDataset) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
