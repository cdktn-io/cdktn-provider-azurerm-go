...
func (v *jsiiProxy_VirtualNetworkGatewayConnection) validatePutTrafficSelectorPolicyParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*VirtualNetworkGatewayConnectionTrafficSelectorPolicy; received %#v (a %T)", value, value)
		}
	}
