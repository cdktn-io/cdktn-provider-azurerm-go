...
func (v *jsiiProxy_VirtualNetworkGatewayConnectionTrafficSelectorPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualNetworkGatewayConnectionTrafficSelectorPolicyList) Resolve(context cdktf.IResolveContext) interface{} {
