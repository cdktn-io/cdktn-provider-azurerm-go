...
func (j *jsiiProxy_VirtualNetworkGatewayConnectionTrafficSelectorPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualNetworkGatewayConnectionTrafficSelectorPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualNetworkGatewayConnectionTrafficSelectorPolicyList {
	_init_.Initialize()
...
func NewVirtualNetworkGatewayConnectionTrafficSelectorPolicyList_Override(v VirtualNetworkGatewayConnectionTrafficSelectorPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualNetworkGatewayConnectionTrafficSelectorPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualNetworkGatewayConnectionTrafficSelectorPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualNetworkGatewayConnectionTrafficSelectorPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
