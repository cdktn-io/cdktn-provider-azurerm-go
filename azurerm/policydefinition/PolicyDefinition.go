...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/policy_definition azurerm_policy_definition} Resource.
...
func (p *jsiiProxy_PolicyDefinition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PolicyDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
