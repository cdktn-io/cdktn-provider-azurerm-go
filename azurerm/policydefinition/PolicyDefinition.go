...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/policydefinition/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/policy_definition azurerm_policy_definition}.
...
func (j *jsiiProxy_PolicyDefinition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PolicyDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PolicyDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PolicyDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PolicyDefinition) RoleDefinitionIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"roleDefinitionIds",
...
func (j *jsiiProxy_PolicyDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/policy_definition azurerm_policy_definition} Resource.
...
func (j *jsiiProxy_PolicyDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PolicyDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PolicyDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PolicyDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PolicyDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PolicyDefinition) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PolicyDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
