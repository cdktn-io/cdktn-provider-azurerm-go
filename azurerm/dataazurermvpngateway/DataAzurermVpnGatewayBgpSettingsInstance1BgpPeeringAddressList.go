...
func (j *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance1BgpPeeringAddressList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermVpnGatewayBgpSettingsInstance1BgpPeeringAddressList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermVpnGatewayBgpSettingsInstance1BgpPeeringAddressList {
	_init_.Initialize()
...
func NewDataAzurermVpnGatewayBgpSettingsInstance1BgpPeeringAddressList_Override(d DataAzurermVpnGatewayBgpSettingsInstance1BgpPeeringAddressList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance1BgpPeeringAddressList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance1BgpPeeringAddressList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance1BgpPeeringAddressList) Resolve(context cdktn.IResolveContext) interface{} {
