...
func (j *jsiiProxy_DataAzurermVpnGatewayBgpSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermVpnGatewayBgpSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermVpnGatewayBgpSettingsList {
	_init_.Initialize()

	if err := validateNewDataAzurermVpnGatewayBgpSettingsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAzurermVpnGatewayBgpSettingsList_Override(d DataAzurermVpnGatewayBgpSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermVpnGatewayBgpSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermVpnGatewayBgpSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermVpnGatewayBgpSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
