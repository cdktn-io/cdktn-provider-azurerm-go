...
func (j *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference {
	_init_.Initialize()

	if err := validateNewDataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewDataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference_Override(d DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
