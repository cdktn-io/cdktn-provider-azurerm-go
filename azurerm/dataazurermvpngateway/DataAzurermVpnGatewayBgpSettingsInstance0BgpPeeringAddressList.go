...
func (j *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressList {
	_init_.Initialize()
...
func NewDataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressList_Override(d DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressList) Resolve(context cdktn.IResolveContext) interface{} {
