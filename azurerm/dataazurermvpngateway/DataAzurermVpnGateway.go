...
type DataAzurermVpnGateway interface {
	...
	SetId(val *string)
	IdInput() *string
	IpConfiguration() DataAzurermVpnGatewayIpConfigurationList
	// Experimental.
...
func (j *jsiiProxy_DataAzurermVpnGateway) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermVpnGateway) Count() interface{} {
...
func (j *jsiiProxy_DataAzurermVpnGateway) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermVpnGateway) IpConfiguration() DataAzurermVpnGatewayIpConfigurationList {
	var returns DataAzurermVpnGatewayIpConfigurationList
	_jsii_.Get(
		j,
		"ipConfiguration",
		&returns,
...
func (j *jsiiProxy_DataAzurermVpnGateway) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermVpnGateway) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermVpnGateway) Tags() cdktn.StringMap {
...
func (j *jsiiProxy_DataAzurermVpnGateway) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/vpn_gateway azurerm_vpn_gateway} Data Source.
func NewDataAzurermVpnGateway(scope constructs.Construct, id *string, config *DataAzurermVpnGatewayConfig) DataAzurermVpnGateway {
	...
	if err := validateNewDataAzurermVpnGatewayParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAzurermVpnGateway)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataAzurermVpnGateway)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermVpnGateway)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermVpnGateway)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermVpnGateway_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAzurermVpnGateway_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAzurermVpnGateway_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAzurermVpnGateway_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermVpnGateway_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermVpnGateway_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermVpnGateway_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermVpnGateway_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAzurermVpnGateway) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermVpnGateway) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermVpnGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermVpnGateway) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermVpnGateway) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAzurermVpnGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
