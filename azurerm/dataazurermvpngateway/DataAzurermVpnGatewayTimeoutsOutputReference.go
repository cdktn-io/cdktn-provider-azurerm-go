...
func (d *jsiiProxy_DataAzurermVpnGatewayTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermVpnGatewayTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
