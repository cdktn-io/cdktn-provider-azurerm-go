...
func (j *jsiiProxy_SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSentinelDataConnectorAzureSecurityCenterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.sentinelDataConnectorAzureSecurityCenter.SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference",
...
func NewSentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference_Override(s SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
