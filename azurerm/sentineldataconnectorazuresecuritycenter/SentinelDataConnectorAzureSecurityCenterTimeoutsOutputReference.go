...
func (s *jsiiProxy_SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
