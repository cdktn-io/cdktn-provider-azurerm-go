...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/sentineldataconnectorazuresecuritycenter/internal"
...
func SentinelDataConnectorAzureSecurityCenter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SentinelDataConnectorAzureSecurityCenter) ImportFrom(id *string, provider cdktf.TerraformProvider) {
