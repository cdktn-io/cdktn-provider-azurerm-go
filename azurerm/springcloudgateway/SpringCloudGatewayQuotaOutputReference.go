...
func (s *jsiiProxy_SpringCloudGatewayQuotaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayQuotaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
