...
func (j *jsiiProxy_SpringCloudGatewayQuotaOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudGatewayQuotaOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SpringCloudGatewayQuotaOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.springCloudGateway.SpringCloudGatewayQuotaOutputReference",
...
func NewSpringCloudGatewayQuotaOutputReference_Override(s SpringCloudGatewayQuotaOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudGatewayQuotaOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudGatewayQuotaOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayQuotaOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SpringCloudGatewayQuotaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayQuotaOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
