...
func (s *jsiiProxy_SpringCloudGatewayLocalResponseCachePerRouteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayLocalResponseCachePerRouteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
