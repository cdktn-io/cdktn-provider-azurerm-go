...
func (s *jsiiProxy_SpringCloudGatewayTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
