...
func (s *jsiiProxy_SpringCloudGatewaySsoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewaySsoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
