...
func (j *jsiiProxy_SpringCloudGatewaySsoOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudGatewaySsoOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SpringCloudGatewaySsoOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.springCloudGateway.SpringCloudGatewaySsoOutputReference",
...
func NewSpringCloudGatewaySsoOutputReference_Override(s SpringCloudGatewaySsoOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudGatewaySsoOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudGatewaySsoOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewaySsoOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SpringCloudGatewaySsoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewaySsoOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
