...
func (s *jsiiProxy_SpringCloudGateway) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SpringCloudGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SpringCloudGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
