...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/cosmosdbcassandradatacenter/internal"
...
func (j *jsiiProxy_CosmosdbCassandraDatacenterTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbCassandraDatacenterTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CosmosdbCassandraDatacenterTimeoutsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.cosmosdbCassandraDatacenter.CosmosdbCassandraDatacenterTimeoutsOutputReference",
...
func NewCosmosdbCassandraDatacenterTimeoutsOutputReference_Override(c CosmosdbCassandraDatacenterTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbCassandraDatacenterTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbCassandraDatacenterTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraDatacenterTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CosmosdbCassandraDatacenterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraDatacenterTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
