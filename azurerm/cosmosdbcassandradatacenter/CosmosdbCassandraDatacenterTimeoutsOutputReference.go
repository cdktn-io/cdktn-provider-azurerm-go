...
func (c *jsiiProxy_CosmosdbCassandraDatacenterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraDatacenterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
