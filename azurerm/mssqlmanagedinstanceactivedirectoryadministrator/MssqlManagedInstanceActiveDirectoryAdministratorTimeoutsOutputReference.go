...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/mssqlmanagedinstanceactivedirectoryadministrator/internal"
...
func (m *jsiiProxy_MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
