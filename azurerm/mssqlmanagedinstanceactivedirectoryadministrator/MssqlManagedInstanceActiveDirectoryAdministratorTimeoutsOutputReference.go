...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/mssqlmanagedinstanceactivedirectoryadministrator/internal"
...
func (j *jsiiProxy_MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewMssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.mssqlManagedInstanceActiveDirectoryAdministrator.MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference",
...
func NewMssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference_Override(m MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
