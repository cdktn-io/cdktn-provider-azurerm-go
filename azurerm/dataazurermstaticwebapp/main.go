...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "configurationFileChangesEnabled", GoGetter: "ConfigurationFileChangesEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "previewEnvironmentsEnabled", GoGetter: "PreviewEnvironmentsEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "repositoryBranch", GoGetter: "RepositoryBranch"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermStaticWebAppBasicAuthOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermStaticWebAppIdentityOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
