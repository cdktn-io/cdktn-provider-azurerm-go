...
func (r *jsiiProxy_ResourceGroupCostManagementExportTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_ResourceGroupCostManagementExportTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
