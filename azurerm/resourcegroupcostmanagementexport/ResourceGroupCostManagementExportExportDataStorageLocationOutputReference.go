...
func (r *jsiiProxy_ResourceGroupCostManagementExportExportDataStorageLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_ResourceGroupCostManagementExportExportDataStorageLocationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
