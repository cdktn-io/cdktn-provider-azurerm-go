...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CosmosdbSqlTrigger)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.cosmosdbSqlTrigger.CosmosdbSqlTriggerConfig",
		reflect.TypeOf((*CosmosdbSqlTriggerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.cosmosdbSqlTrigger.CosmosdbSqlTriggerTimeouts",
		reflect.TypeOf((*CosmosdbSqlTriggerTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azurerm.cosmosdbSqlTrigger.CosmosdbSqlTriggerTimeoutsOutputReference",
		reflect.TypeOf((*CosmosdbSqlTriggerTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_CosmosdbSqlTriggerTimeoutsOutputReference{}
