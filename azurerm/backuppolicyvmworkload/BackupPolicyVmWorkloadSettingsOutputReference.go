...
func (j *jsiiProxy_BackupPolicyVmWorkloadSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBackupPolicyVmWorkloadSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BackupPolicyVmWorkloadSettingsOutputReference {
	_init_.Initialize()

	if err := validateNewBackupPolicyVmWorkloadSettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewBackupPolicyVmWorkloadSettingsOutputReference_Override(b BackupPolicyVmWorkloadSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BackupPolicyVmWorkloadSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BackupPolicyVmWorkloadSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
