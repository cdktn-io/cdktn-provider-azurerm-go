...
func (b *jsiiProxy_BackupPolicyVmWorkloadSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
