...
func (j *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBackupPolicyVmWorkloadProtectionPolicyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BackupPolicyVmWorkloadProtectionPolicyList {
	_init_.Initialize()

	if err := validateNewBackupPolicyVmWorkloadProtectionPolicyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewBackupPolicyVmWorkloadProtectionPolicyList_Override(b BackupPolicyVmWorkloadProtectionPolicyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicyList) Resolve(context cdktn.IResolveContext) interface{} {
