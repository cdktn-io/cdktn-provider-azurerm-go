...
func (j *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicySimpleRetentionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBackupPolicyVmWorkloadProtectionPolicySimpleRetentionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BackupPolicyVmWorkloadProtectionPolicySimpleRetentionOutputReference {
	_init_.Initialize()

	if err := validateNewBackupPolicyVmWorkloadProtectionPolicySimpleRetentionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewBackupPolicyVmWorkloadProtectionPolicySimpleRetentionOutputReference_Override(b BackupPolicyVmWorkloadProtectionPolicySimpleRetentionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicySimpleRetentionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicySimpleRetentionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicySimpleRetentionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicySimpleRetentionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicySimpleRetentionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
