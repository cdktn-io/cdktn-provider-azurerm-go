...
func (j *jsiiProxy_BackupPolicyVmWorkloadTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBackupPolicyVmWorkloadTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BackupPolicyVmWorkloadTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewBackupPolicyVmWorkloadTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewBackupPolicyVmWorkloadTimeoutsOutputReference_Override(b BackupPolicyVmWorkloadTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BackupPolicyVmWorkloadTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BackupPolicyVmWorkloadTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
