...
func (b *jsiiProxy_BackupPolicyVmWorkloadTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
