...
func (j *jsiiProxy_BackupPolicyVmWorkload) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BackupPolicyVmWorkload) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BackupPolicyVmWorkload) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BackupPolicyVmWorkload) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BackupPolicyVmWorkload) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BackupPolicyVmWorkload)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupPolicyVmWorkload)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BackupPolicyVmWorkload)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BackupPolicyVmWorkload_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BackupPolicyVmWorkload) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmWorkload) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BackupPolicyVmWorkload) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmWorkload) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupPolicyVmWorkload) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BackupPolicyVmWorkload) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
