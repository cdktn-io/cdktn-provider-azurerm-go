...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/dataazurermautomationvariableint/internal"
...
func (j *jsiiProxy_DataAzurermAutomationVariableInt) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermAutomationVariableInt) Encrypted() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAzurermAutomationVariableInt) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermAutomationVariableInt) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermAutomationVariableInt) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermAutomationVariableInt) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/automation_variable_int azurerm_automation_variable_int} Data Source.
...
func (j *jsiiProxy_DataAzurermAutomationVariableInt)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermAutomationVariableInt)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermAutomationVariableInt)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermAutomationVariableInt_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermAutomationVariableInt) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermAutomationVariableInt) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermAutomationVariableInt) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermAutomationVariableInt) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
