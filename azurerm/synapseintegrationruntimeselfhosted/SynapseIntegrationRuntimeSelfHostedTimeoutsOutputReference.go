...
func (j *jsiiProxy_SynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSynapseIntegrationRuntimeSelfHostedTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.synapseIntegrationRuntimeSelfHosted.SynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference",
...
func NewSynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference_Override(s SynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHostedTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
