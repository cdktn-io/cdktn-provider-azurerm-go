...
func SynapseIntegrationRuntimeSelfHosted_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) ImportFrom(id *string, provider cdktf.TerraformProvider) {
