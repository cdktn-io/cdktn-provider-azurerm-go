...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/synapseintegrationruntimeselfhosted/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/synapse_integration_runtime_self_hosted azurerm_synapse_integration_runtime_self_hosted}.
...
func (j *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/synapse_integration_runtime_self_hosted azurerm_synapse_integration_runtime_self_hosted} Resource.
...
func (j *jsiiProxy_SynapseIntegrationRuntimeSelfHosted)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SynapseIntegrationRuntimeSelfHosted)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SynapseIntegrationRuntimeSelfHosted)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SynapseIntegrationRuntimeSelfHosted_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSynapseIntegrationRuntimeSelfHosted_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) MoveFromId(id *string) {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) MoveToId(id *string) {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SynapseIntegrationRuntimeSelfHosted) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
