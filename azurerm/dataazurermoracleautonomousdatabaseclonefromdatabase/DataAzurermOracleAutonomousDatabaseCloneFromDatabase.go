...
func (d *jsiiProxy_DataAzurermOracleAutonomousDatabaseCloneFromDatabase) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermOracleAutonomousDatabaseCloneFromDatabase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
