...
func (j *jsiiProxy_ResourceGroupPolicyAssignmentNonComplianceMessageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResourceGroupPolicyAssignmentNonComplianceMessageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ResourceGroupPolicyAssignmentNonComplianceMessageList {
	_init_.Initialize()

	if err := validateNewResourceGroupPolicyAssignmentNonComplianceMessageListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewResourceGroupPolicyAssignmentNonComplianceMessageList_Override(r ResourceGroupPolicyAssignmentNonComplianceMessageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourceGroupPolicyAssignmentNonComplianceMessageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentNonComplianceMessageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentNonComplianceMessageList) Resolve(context cdktn.IResolveContext) interface{} {
