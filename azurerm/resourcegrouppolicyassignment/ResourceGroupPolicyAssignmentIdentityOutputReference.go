...
func (j *jsiiProxy_ResourceGroupPolicyAssignmentIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResourceGroupPolicyAssignmentIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ResourceGroupPolicyAssignmentIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewResourceGroupPolicyAssignmentIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewResourceGroupPolicyAssignmentIdentityOutputReference_Override(r ResourceGroupPolicyAssignmentIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourceGroupPolicyAssignmentIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
