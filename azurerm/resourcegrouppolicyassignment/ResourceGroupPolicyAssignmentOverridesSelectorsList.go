...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentOverridesSelectorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentOverridesSelectorsList) Resolve(context cdktf.IResolveContext) interface{} {
