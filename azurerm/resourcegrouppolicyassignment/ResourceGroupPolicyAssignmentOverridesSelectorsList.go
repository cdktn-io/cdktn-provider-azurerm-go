...
func (j *jsiiProxy_ResourceGroupPolicyAssignmentOverridesSelectorsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResourceGroupPolicyAssignmentOverridesSelectorsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ResourceGroupPolicyAssignmentOverridesSelectorsList {
	_init_.Initialize()
...
func NewResourceGroupPolicyAssignmentOverridesSelectorsList_Override(r ResourceGroupPolicyAssignmentOverridesSelectorsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourceGroupPolicyAssignmentOverridesSelectorsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentOverridesSelectorsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentOverridesSelectorsList) Resolve(context cdktn.IResolveContext) interface{} {
