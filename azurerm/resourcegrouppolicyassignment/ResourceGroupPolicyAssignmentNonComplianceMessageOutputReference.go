...
func (j *jsiiProxy_ResourceGroupPolicyAssignmentNonComplianceMessageOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResourceGroupPolicyAssignmentNonComplianceMessageOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ResourceGroupPolicyAssignmentNonComplianceMessageOutputReference {
	_init_.Initialize()

	if err := validateNewResourceGroupPolicyAssignmentNonComplianceMessageOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewResourceGroupPolicyAssignmentNonComplianceMessageOutputReference_Override(r ResourceGroupPolicyAssignmentNonComplianceMessageOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourceGroupPolicyAssignmentNonComplianceMessageOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentNonComplianceMessageOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentNonComplianceMessageOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentNonComplianceMessageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupPolicyAssignmentNonComplianceMessageOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
