...
func (d *jsiiProxy_DataAzurermPrivateDnsTxtRecordRecordList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermPrivateDnsTxtRecordRecordList) Resolve(context cdktf.IResolveContext) interface{} {
