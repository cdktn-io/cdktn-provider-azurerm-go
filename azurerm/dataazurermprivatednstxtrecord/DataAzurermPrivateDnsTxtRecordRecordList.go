...
func (j *jsiiProxy_DataAzurermPrivateDnsTxtRecordRecordList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermPrivateDnsTxtRecordRecordList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermPrivateDnsTxtRecordRecordList {
	_init_.Initialize()
...
func NewDataAzurermPrivateDnsTxtRecordRecordList_Override(d DataAzurermPrivateDnsTxtRecordRecordList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermPrivateDnsTxtRecordRecordList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermPrivateDnsTxtRecordRecordList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermPrivateDnsTxtRecordRecordList) Resolve(context cdktn.IResolveContext) interface{} {
