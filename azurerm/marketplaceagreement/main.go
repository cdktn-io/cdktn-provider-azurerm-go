...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "licenseTextLink", GoGetter: "LicenseTextLink"},
			...
			_jsii_.MemberProperty{JsiiProperty: "privacyPolicyLink", GoGetter: "PrivacyPolicyLink"},
