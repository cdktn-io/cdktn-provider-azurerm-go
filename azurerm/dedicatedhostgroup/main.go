...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "automaticPlacementEnabledInput", GoGetter: "AutomaticPlacementEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutomaticPlacementEnabled", GoMethod: "ResetAutomaticPlacementEnabled"},
