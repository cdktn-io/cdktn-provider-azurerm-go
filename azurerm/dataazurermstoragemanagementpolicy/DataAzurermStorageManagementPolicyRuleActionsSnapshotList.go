...
func (j *jsiiProxy_DataAzurermStorageManagementPolicyRuleActionsSnapshotList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermStorageManagementPolicyRuleActionsSnapshotList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermStorageManagementPolicyRuleActionsSnapshotList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermStorageManagementPolicy.DataAzurermStorageManagementPolicyRuleActionsSnapshotList",
...
func NewDataAzurermStorageManagementPolicyRuleActionsSnapshotList_Override(d DataAzurermStorageManagementPolicyRuleActionsSnapshotList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermStorageManagementPolicyRuleActionsSnapshotList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermStorageManagementPolicyRuleActionsSnapshotList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermStorageManagementPolicyRuleActionsSnapshotList) Resolve(context cdktn.IResolveContext) interface{} {
