...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/networkprofile/internal"
...
func (n *jsiiProxy_NetworkProfileContainerNetworkInterfaceIpConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkProfileContainerNetworkInterfaceIpConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
