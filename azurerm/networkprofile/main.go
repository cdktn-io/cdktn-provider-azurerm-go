...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "containerNetworkInterface", GoGetter: "ContainerNetworkInterface"},
			_jsii_.MemberProperty{JsiiProperty: "containerNetworkInterfaceIds", GoGetter: "ContainerNetworkInterfaceIds"},
			_jsii_.MemberProperty{JsiiProperty: "containerNetworkInterfaceInput", GoGetter: "ContainerNetworkInterfaceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putContainerNetworkInterface", GoMethod: "PutContainerNetworkInterface"},
