...
func (j *jsiiProxy_PublicIpTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPublicIpTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PublicIpTimeoutsOutputReference {
	_init_.Initialize()
...
func NewPublicIpTimeoutsOutputReference_Override(p PublicIpTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PublicIpTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PublicIpTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PublicIpTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PublicIpTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PublicIpTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
