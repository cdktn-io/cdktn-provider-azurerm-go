...
func (p *jsiiProxy_PublicIpTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PublicIpTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
