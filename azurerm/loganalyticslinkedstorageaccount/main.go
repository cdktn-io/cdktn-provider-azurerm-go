...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.logAnalyticsLinkedStorageAccount.LogAnalyticsLinkedStorageAccountConfig",
		reflect.TypeOf((*LogAnalyticsLinkedStorageAccountConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.logAnalyticsLinkedStorageAccount.LogAnalyticsLinkedStorageAccountTimeouts",
