...
type DataFactoryIntegrationRuntimeAzureConfig struct {
	...
	InteractiveAuthoringTimeToLiveInMinutes *float64 `field:"optional" json:"interactiveAuthoringTimeToLiveInMinutes" yaml:"interactiveAuthoringTimeToLiveInMinutes"`
	// timeouts block.
	//
