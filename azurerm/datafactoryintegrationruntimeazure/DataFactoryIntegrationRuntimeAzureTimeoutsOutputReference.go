...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/datafactoryintegrationruntimeazure/internal"
...
func (j *jsiiProxy_DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryIntegrationRuntimeAzureTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryIntegrationRuntimeAzureTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryIntegrationRuntimeAzure.DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference",
...
func NewDataFactoryIntegrationRuntimeAzureTimeoutsOutputReference_Override(d DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
