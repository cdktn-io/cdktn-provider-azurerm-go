...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/digitaltwinsendpointeventgrid/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/digital_twins_endpoint_eventgrid azurerm_digital_twins_endpoint_eventgrid} Resource.
...
func (d *jsiiProxy_DigitalTwinsEndpointEventgrid) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventgrid) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventgrid) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
