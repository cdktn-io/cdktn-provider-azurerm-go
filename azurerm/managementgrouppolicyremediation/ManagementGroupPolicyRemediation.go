...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/managementgrouppolicyremediation/internal"
...
func (j *jsiiProxy_ManagementGroupPolicyRemediation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ManagementGroupPolicyRemediation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ManagementGroupPolicyRemediation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ManagementGroupPolicyRemediation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ManagementGroupPolicyRemediation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/management_group_policy_remediation azurerm_management_group_policy_remediation} Resource.
...
func (j *jsiiProxy_ManagementGroupPolicyRemediation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ManagementGroupPolicyRemediation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ManagementGroupPolicyRemediation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ManagementGroupPolicyRemediation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_ManagementGroupPolicyRemediation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagementGroupPolicyRemediation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_ManagementGroupPolicyRemediation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagementGroupPolicyRemediation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_ManagementGroupPolicyRemediation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_ManagementGroupPolicyRemediation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
