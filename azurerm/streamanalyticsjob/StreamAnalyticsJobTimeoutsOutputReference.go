...
func (s *jsiiProxy_StreamAnalyticsJobTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsJobTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
