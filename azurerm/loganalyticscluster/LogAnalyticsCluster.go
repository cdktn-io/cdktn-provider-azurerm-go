...
func (l *jsiiProxy_LogAnalyticsCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogAnalyticsCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
