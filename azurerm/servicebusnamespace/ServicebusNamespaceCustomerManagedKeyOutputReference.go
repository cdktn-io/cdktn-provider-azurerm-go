...
func (j *jsiiProxy_ServicebusNamespaceCustomerManagedKeyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServicebusNamespaceCustomerManagedKeyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ServicebusNamespaceCustomerManagedKeyOutputReference {
	_init_.Initialize()
...
func NewServicebusNamespaceCustomerManagedKeyOutputReference_Override(s ServicebusNamespaceCustomerManagedKeyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServicebusNamespaceCustomerManagedKeyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServicebusNamespaceCustomerManagedKeyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusNamespaceCustomerManagedKeyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServicebusNamespaceCustomerManagedKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusNamespaceCustomerManagedKeyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
