...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "premiumMessagingPartitionsInput", GoGetter: "PremiumMessagingPartitionsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPremiumMessagingPartitions", GoMethod: "ResetPremiumMessagingPartitions"},
