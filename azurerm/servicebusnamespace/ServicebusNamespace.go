...
func (j *jsiiProxy_ServicebusNamespace) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServicebusNamespace) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServicebusNamespace) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicebusNamespace) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServicebusNamespace) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ServicebusNamespace)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicebusNamespace)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicebusNamespace)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ServicebusNamespace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServicebusNamespace) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusNamespace) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServicebusNamespace) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusNamespace) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicebusNamespace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicebusNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
