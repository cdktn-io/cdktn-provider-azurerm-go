...
func (c *jsiiProxy_CdnEndpointCustomDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CdnEndpointCustomDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
