...
func (j *jsiiProxy_ConsumptionBudgetResourceGroupFilterTagList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConsumptionBudgetResourceGroupFilterTagList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConsumptionBudgetResourceGroupFilterTagList {
	_init_.Initialize()
...
func NewConsumptionBudgetResourceGroupFilterTagList_Override(c ConsumptionBudgetResourceGroupFilterTagList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConsumptionBudgetResourceGroupFilterTagList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupFilterTagList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupFilterTagList) Resolve(context cdktn.IResolveContext) interface{} {
