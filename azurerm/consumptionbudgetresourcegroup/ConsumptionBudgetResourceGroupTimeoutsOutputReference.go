...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/consumptionbudgetresourcegroup/internal"
...
func (j *jsiiProxy_ConsumptionBudgetResourceGroupTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConsumptionBudgetResourceGroupTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ConsumptionBudgetResourceGroupTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewConsumptionBudgetResourceGroupTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewConsumptionBudgetResourceGroupTimeoutsOutputReference_Override(c ConsumptionBudgetResourceGroupTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConsumptionBudgetResourceGroupTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
