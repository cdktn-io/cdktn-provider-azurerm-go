...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupFilterTagOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupFilterTagOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
