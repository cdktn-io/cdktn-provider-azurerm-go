...
func (j *jsiiProxy_ConsumptionBudgetResourceGroupNotificationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConsumptionBudgetResourceGroupNotificationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConsumptionBudgetResourceGroupNotificationList {
	_init_.Initialize()
...
func NewConsumptionBudgetResourceGroupNotificationList_Override(c ConsumptionBudgetResourceGroupNotificationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConsumptionBudgetResourceGroupNotificationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupNotificationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupNotificationList) Resolve(context cdktn.IResolveContext) interface{} {
