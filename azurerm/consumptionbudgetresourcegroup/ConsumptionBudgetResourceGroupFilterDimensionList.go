...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupFilterDimensionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupFilterDimensionList) Resolve(context cdktf.IResolveContext) interface{} {
