...
func (j *jsiiProxy_ConsumptionBudgetResourceGroupFilterDimensionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConsumptionBudgetResourceGroupFilterDimensionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConsumptionBudgetResourceGroupFilterDimensionList {
	_init_.Initialize()

	if err := validateNewConsumptionBudgetResourceGroupFilterDimensionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewConsumptionBudgetResourceGroupFilterDimensionList_Override(c ConsumptionBudgetResourceGroupFilterDimensionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConsumptionBudgetResourceGroupFilterDimensionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupFilterDimensionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupFilterDimensionList) Resolve(context cdktn.IResolveContext) interface{} {
