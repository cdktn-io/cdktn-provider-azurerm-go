...
func (j *jsiiProxy_PolicySetDefinition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PolicySetDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PolicySetDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PolicySetDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PolicySetDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/policy_set_definition azurerm_policy_set_definition} Resource.
...
func (j *jsiiProxy_PolicySetDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PolicySetDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PolicySetDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PolicySetDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PolicySetDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PolicySetDefinition) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PolicySetDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PolicySetDefinition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PolicySetDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
