...
func (j *jsiiProxy_PolicySetDefinitionPolicyDefinitionGroupOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPolicySetDefinitionPolicyDefinitionGroupOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PolicySetDefinitionPolicyDefinitionGroupOutputReference {
	_init_.Initialize()

	if err := validateNewPolicySetDefinitionPolicyDefinitionGroupOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewPolicySetDefinitionPolicyDefinitionGroupOutputReference_Override(p PolicySetDefinitionPolicyDefinitionGroupOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PolicySetDefinitionPolicyDefinitionGroupOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PolicySetDefinitionPolicyDefinitionGroupOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PolicySetDefinitionPolicyDefinitionGroupOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PolicySetDefinitionPolicyDefinitionGroupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PolicySetDefinitionPolicyDefinitionGroupOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
