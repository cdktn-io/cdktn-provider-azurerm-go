...
func (p *jsiiProxy_PolicySetDefinitionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PolicySetDefinitionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
