...
func (j *jsiiProxy_PolicySetDefinitionPolicyDefinitionReferenceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPolicySetDefinitionPolicyDefinitionReferenceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PolicySetDefinitionPolicyDefinitionReferenceList {
	_init_.Initialize()

	if err := validateNewPolicySetDefinitionPolicyDefinitionReferenceListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewPolicySetDefinitionPolicyDefinitionReferenceList_Override(p PolicySetDefinitionPolicyDefinitionReferenceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PolicySetDefinitionPolicyDefinitionReferenceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PolicySetDefinitionPolicyDefinitionReferenceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PolicySetDefinitionPolicyDefinitionReferenceList) Resolve(context cdktn.IResolveContext) interface{} {
