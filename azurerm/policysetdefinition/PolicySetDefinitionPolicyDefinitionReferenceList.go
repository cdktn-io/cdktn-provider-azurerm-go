...
func (p *jsiiProxy_PolicySetDefinitionPolicyDefinitionReferenceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PolicySetDefinitionPolicyDefinitionReferenceList) Resolve(context cdktf.IResolveContext) interface{} {
