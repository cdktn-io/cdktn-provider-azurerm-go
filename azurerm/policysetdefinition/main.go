...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "policyDefinitionGroupInput", GoGetter: "PolicyDefinitionGroupInput"},
			_jsii_.MemberProperty{JsiiProperty: "policyDefinitionReference", GoGetter: "PolicyDefinitionReference"},
			_jsii_.MemberProperty{JsiiProperty: "policyDefinitionReferenceInput", GoGetter: "PolicyDefinitionReferenceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putPolicyDefinitionGroup", GoMethod: "PutPolicyDefinitionGroup"},
			_jsii_.MemberMethod{JsiiMethod: "putPolicyDefinitionReference", GoMethod: "PutPolicyDefinitionReference"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPolicyDefinitionGroup", GoMethod: "ResetPolicyDefinitionGroup"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "additionalMetadataResourceIdInput", GoGetter: "AdditionalMetadataResourceIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAdditionalMetadataResourceId", GoMethod: "ResetAdditionalMetadataResourceId"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPolicyGroupNames", GoMethod: "ResetPolicyGroupNames"},
