...
func (j *jsiiProxy_StorageShare) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StorageShare) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StorageShare) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StorageShare) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StorageShare) StorageAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageAccountId",
...
func (j *jsiiProxy_StorageShare) StorageAccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_StorageShare) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/storage_share azurerm_storage_share} Resource.
func NewStorageShare(scope constructs.Construct, id *string, config *StorageShareConfig) StorageShare {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.storageShare.StorageShare",
...
func (j *jsiiProxy_StorageShare)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StorageShare)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StorageShare)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_StorageShare)SetStorageAccountId(val *string) {
...
func StorageShare_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StorageShare) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageShare) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StorageShare) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageShare) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageShare) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageShare) ResetStorageAccountId() {
	_jsii_.InvokeVoid(
		s,
		"resetStorageAccountId",
		nil, // no parameters
...
func (s *jsiiProxy_StorageShare) ResetStorageAccountName() {
	_jsii_.InvokeVoid(
		s,
		"resetStorageAccountName",
		nil, // no parameters
...
func (s *jsiiProxy_StorageShare) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
