...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/resourcedeploymentscriptazurepowershell/internal"
...
func (j *jsiiProxy_ResourceDeploymentScriptAzurePowerShellEnvironmentVariableList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResourceDeploymentScriptAzurePowerShellEnvironmentVariableList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ResourceDeploymentScriptAzurePowerShellEnvironmentVariableList {
	_init_.Initialize()
...
func NewResourceDeploymentScriptAzurePowerShellEnvironmentVariableList_Override(r ResourceDeploymentScriptAzurePowerShellEnvironmentVariableList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourceDeploymentScriptAzurePowerShellEnvironmentVariableList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourceDeploymentScriptAzurePowerShellEnvironmentVariableList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ResourceDeploymentScriptAzurePowerShellEnvironmentVariableList) Resolve(context cdktn.IResolveContext) interface{} {
