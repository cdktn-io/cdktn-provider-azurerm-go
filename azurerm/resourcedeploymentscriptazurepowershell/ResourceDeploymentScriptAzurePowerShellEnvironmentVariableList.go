...
func (r *jsiiProxy_ResourceDeploymentScriptAzurePowerShellEnvironmentVariableList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ResourceDeploymentScriptAzurePowerShellEnvironmentVariableList) Resolve(context cdktf.IResolveContext) interface{} {
