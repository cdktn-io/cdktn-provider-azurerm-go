...
func (j *jsiiProxy_DataAzurermDynatraceMonitorEnvironmentPropertiesEnvironmentInfoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermDynatraceMonitorEnvironmentPropertiesEnvironmentInfoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermDynatraceMonitorEnvironmentPropertiesEnvironmentInfoList {
	_init_.Initialize()
...
func NewDataAzurermDynatraceMonitorEnvironmentPropertiesEnvironmentInfoList_Override(d DataAzurermDynatraceMonitorEnvironmentPropertiesEnvironmentInfoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermDynatraceMonitorEnvironmentPropertiesEnvironmentInfoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermDynatraceMonitorEnvironmentPropertiesEnvironmentInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermDynatraceMonitorEnvironmentPropertiesEnvironmentInfoList) Resolve(context cdktn.IResolveContext) interface{} {
