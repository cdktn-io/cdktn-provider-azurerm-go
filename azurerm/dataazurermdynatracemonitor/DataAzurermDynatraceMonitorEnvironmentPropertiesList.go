...
func (j *jsiiProxy_DataAzurermDynatraceMonitorEnvironmentPropertiesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermDynatraceMonitorEnvironmentPropertiesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermDynatraceMonitorEnvironmentPropertiesList {
	_init_.Initialize()
...
func NewDataAzurermDynatraceMonitorEnvironmentPropertiesList_Override(d DataAzurermDynatraceMonitorEnvironmentPropertiesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermDynatraceMonitorEnvironmentPropertiesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermDynatraceMonitorEnvironmentPropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermDynatraceMonitorEnvironmentPropertiesList) Resolve(context cdktn.IResolveContext) interface{} {
