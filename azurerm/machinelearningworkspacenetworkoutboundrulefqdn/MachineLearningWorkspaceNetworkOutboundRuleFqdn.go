...
func (m *jsiiProxy_MachineLearningWorkspaceNetworkOutboundRuleFqdn) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MachineLearningWorkspaceNetworkOutboundRuleFqdn) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MachineLearningWorkspaceNetworkOutboundRuleFqdn) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
