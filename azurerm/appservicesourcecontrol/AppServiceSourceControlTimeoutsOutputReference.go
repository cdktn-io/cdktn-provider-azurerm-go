...
func (a *jsiiProxy_AppServiceSourceControlTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppServiceSourceControlTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
