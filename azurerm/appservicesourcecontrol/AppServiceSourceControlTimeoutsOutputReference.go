...
func (j *jsiiProxy_AppServiceSourceControlTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppServiceSourceControlTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppServiceSourceControlTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewAppServiceSourceControlTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAppServiceSourceControlTimeoutsOutputReference_Override(a AppServiceSourceControlTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppServiceSourceControlTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppServiceSourceControlTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceSourceControlTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppServiceSourceControlTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppServiceSourceControlTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
