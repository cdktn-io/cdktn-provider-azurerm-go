...
func (h *jsiiProxy_HdinsightHadoopClusterExtensionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterExtensionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
