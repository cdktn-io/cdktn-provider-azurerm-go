...
func (j *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeInstallScriptActionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHadoopClusterRolesEdgeNodeInstallScriptActionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightHadoopClusterRolesEdgeNodeInstallScriptActionList {
	_init_.Initialize()
...
func NewHdinsightHadoopClusterRolesEdgeNodeInstallScriptActionList_Override(h HdinsightHadoopClusterRolesEdgeNodeInstallScriptActionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeInstallScriptActionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeInstallScriptActionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeInstallScriptActionList) Resolve(context cdktn.IResolveContext) interface{} {
