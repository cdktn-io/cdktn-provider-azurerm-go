...
func (j *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHadoopClusterGatewayOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightHadoopClusterGatewayOutputReference {
	_init_.Initialize()
...
func NewHdinsightHadoopClusterGatewayOutputReference_Override(h HdinsightHadoopClusterGatewayOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
