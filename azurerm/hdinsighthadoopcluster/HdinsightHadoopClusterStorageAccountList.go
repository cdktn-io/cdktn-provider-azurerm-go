...
func (j *jsiiProxy_HdinsightHadoopClusterStorageAccountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHadoopClusterStorageAccountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightHadoopClusterStorageAccountList {
	_init_.Initialize()
...
func NewHdinsightHadoopClusterStorageAccountList_Override(h HdinsightHadoopClusterStorageAccountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHadoopClusterStorageAccountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHadoopClusterStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHadoopClusterStorageAccountList) Resolve(context cdktn.IResolveContext) interface{} {
