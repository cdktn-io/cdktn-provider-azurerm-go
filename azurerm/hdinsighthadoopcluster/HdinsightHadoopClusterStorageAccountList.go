...
func (h *jsiiProxy_HdinsightHadoopClusterStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHadoopClusterStorageAccountList) Resolve(context cdktf.IResolveContext) interface{} {
