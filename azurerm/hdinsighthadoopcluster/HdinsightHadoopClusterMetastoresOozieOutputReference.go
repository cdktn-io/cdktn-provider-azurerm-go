...
func (h *jsiiProxy_HdinsightHadoopClusterMetastoresOozieOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterMetastoresOozieOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
