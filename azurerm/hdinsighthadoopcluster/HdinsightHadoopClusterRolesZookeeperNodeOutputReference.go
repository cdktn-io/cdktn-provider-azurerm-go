...
type HdinsightHadoopClusterRolesZookeeperNodeOutputReference interface {
	...
	ScriptActions() HdinsightHadoopClusterRolesZookeeperNodeScriptActionsList
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeOutputReference) ScriptActions() HdinsightHadoopClusterRolesZookeeperNodeScriptActionsList {
	var returns HdinsightHadoopClusterRolesZookeeperNodeScriptActionsList
	_jsii_.Get(
		j,
		"scriptActions",
		&returns,
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeOutputReference) ScriptActionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"scriptActionsInput",
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHadoopClusterRolesZookeeperNodeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightHadoopClusterRolesZookeeperNodeOutputReference {
	_init_.Initialize()

	if err := validateNewHdinsightHadoopClusterRolesZookeeperNodeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewHdinsightHadoopClusterRolesZookeeperNodeOutputReference_Override(h HdinsightHadoopClusterRolesZookeeperNodeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeOutputReference) PutScriptActions(value interface{}) {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeOutputReference) ResetScriptActions() {
	_jsii_.InvokeVoid(
		h,
		"resetScriptActions",
		nil, // no parameters
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
