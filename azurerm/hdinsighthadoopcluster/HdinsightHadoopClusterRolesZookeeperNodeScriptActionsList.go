...
func (h *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeScriptActionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeScriptActionsList) Resolve(context cdktf.IResolveContext) interface{} {
