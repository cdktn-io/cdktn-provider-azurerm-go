...
func (j *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeScriptActionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHadoopClusterRolesZookeeperNodeScriptActionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightHadoopClusterRolesZookeeperNodeScriptActionsList {
	_init_.Initialize()
...
func NewHdinsightHadoopClusterRolesZookeeperNodeScriptActionsList_Override(h HdinsightHadoopClusterRolesZookeeperNodeScriptActionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeScriptActionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeScriptActionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesZookeeperNodeScriptActionsList) Resolve(context cdktn.IResolveContext) interface{} {
