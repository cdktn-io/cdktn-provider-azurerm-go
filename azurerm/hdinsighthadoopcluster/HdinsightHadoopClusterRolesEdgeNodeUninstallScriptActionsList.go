...
func (j *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeUninstallScriptActionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHadoopClusterRolesEdgeNodeUninstallScriptActionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightHadoopClusterRolesEdgeNodeUninstallScriptActionsList {
	_init_.Initialize()
...
func NewHdinsightHadoopClusterRolesEdgeNodeUninstallScriptActionsList_Override(h HdinsightHadoopClusterRolesEdgeNodeUninstallScriptActionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeUninstallScriptActionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeUninstallScriptActionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeUninstallScriptActionsList) Resolve(context cdktn.IResolveContext) interface{} {
