...
func (h *jsiiProxy_HdinsightHadoopClusterMetastoresAmbariOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterMetastoresAmbariOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
