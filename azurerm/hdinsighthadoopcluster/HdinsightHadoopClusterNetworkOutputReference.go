...
func (j *jsiiProxy_HdinsightHadoopClusterNetworkOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHadoopClusterNetworkOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightHadoopClusterNetworkOutputReference {
	_init_.Initialize()

	if err := validateNewHdinsightHadoopClusterNetworkOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewHdinsightHadoopClusterNetworkOutputReference_Override(h HdinsightHadoopClusterNetworkOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHadoopClusterNetworkOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHadoopClusterNetworkOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterNetworkOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightHadoopClusterNetworkOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterNetworkOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
