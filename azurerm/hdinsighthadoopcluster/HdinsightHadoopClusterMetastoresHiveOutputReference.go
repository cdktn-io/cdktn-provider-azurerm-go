...
func (h *jsiiProxy_HdinsightHadoopClusterMetastoresHiveOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterMetastoresHiveOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
