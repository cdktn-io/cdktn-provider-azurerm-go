...
func (h *jsiiProxy_HdinsightHadoopClusterDiskEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHadoopClusterDiskEncryptionList) Resolve(context cdktf.IResolveContext) interface{} {
