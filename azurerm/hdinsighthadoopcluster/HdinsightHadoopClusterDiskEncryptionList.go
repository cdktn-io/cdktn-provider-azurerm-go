...
func (j *jsiiProxy_HdinsightHadoopClusterDiskEncryptionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHadoopClusterDiskEncryptionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightHadoopClusterDiskEncryptionList {
	_init_.Initialize()
...
func NewHdinsightHadoopClusterDiskEncryptionList_Override(h HdinsightHadoopClusterDiskEncryptionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHadoopClusterDiskEncryptionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHadoopClusterDiskEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHadoopClusterDiskEncryptionList) Resolve(context cdktn.IResolveContext) interface{} {
