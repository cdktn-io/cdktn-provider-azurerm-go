...
func (j *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeHttpsEndpointsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHadoopClusterRolesEdgeNodeHttpsEndpointsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightHadoopClusterRolesEdgeNodeHttpsEndpointsList {
	_init_.Initialize()

	if err := validateNewHdinsightHadoopClusterRolesEdgeNodeHttpsEndpointsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewHdinsightHadoopClusterRolesEdgeNodeHttpsEndpointsList_Override(h HdinsightHadoopClusterRolesEdgeNodeHttpsEndpointsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeHttpsEndpointsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeHttpsEndpointsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesEdgeNodeHttpsEndpointsList) Resolve(context cdktn.IResolveContext) interface{} {
