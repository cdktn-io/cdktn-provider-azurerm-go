...
func (j *jsiiProxy_FrontdoorCustomHttpsConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FrontdoorCustomHttpsConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FrontdoorCustomHttpsConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FrontdoorCustomHttpsConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FrontdoorCustomHttpsConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_FrontdoorCustomHttpsConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FrontdoorCustomHttpsConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FrontdoorCustomHttpsConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FrontdoorCustomHttpsConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FrontdoorCustomHttpsConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorCustomHttpsConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FrontdoorCustomHttpsConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorCustomHttpsConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FrontdoorCustomHttpsConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FrontdoorCustomHttpsConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
