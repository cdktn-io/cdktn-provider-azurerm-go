...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/cosmosdbsqlroleassignment/internal"
...
func (j *jsiiProxy_CosmosdbSqlRoleAssignment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CosmosdbSqlRoleAssignment) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_CosmosdbSqlRoleAssignment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CosmosdbSqlRoleAssignment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CosmosdbSqlRoleAssignment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CosmosdbSqlRoleAssignment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewCosmosdbSqlRoleAssignment(scope constructs.Construct, id *string, config *CosmosdbSqlRoleAssignmentConfig) CosmosdbSqlRoleAssignment {
	...
	if err := validateNewCosmosdbSqlRoleAssignmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CosmosdbSqlRoleAssignment)SetCount(val interface{}) {
...
func (j *jsiiProxy_CosmosdbSqlRoleAssignment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CosmosdbSqlRoleAssignment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CosmosdbSqlRoleAssignment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CosmosdbSqlRoleAssignment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateCosmosdbSqlRoleAssignment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func CosmosdbSqlRoleAssignment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCosmosdbSqlRoleAssignment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CosmosdbSqlRoleAssignment_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCosmosdbSqlRoleAssignment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CosmosdbSqlRoleAssignment_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCosmosdbSqlRoleAssignment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) MoveFromId(id *string) {
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) MoveToId(id *string) {
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
