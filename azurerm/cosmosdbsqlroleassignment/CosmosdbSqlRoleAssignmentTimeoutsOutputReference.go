...
func (c *jsiiProxy_CosmosdbSqlRoleAssignmentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlRoleAssignmentTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
