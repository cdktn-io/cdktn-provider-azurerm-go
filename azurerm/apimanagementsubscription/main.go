...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowTracing", GoGetter: "AllowTracing"},
			_jsii_.MemberProperty{JsiiProperty: "allowTracingInput", GoGetter: "AllowTracingInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAllowTracing", GoMethod: "ResetAllowTracing"},
			_jsii_.MemberMethod{JsiiMethod: "resetApiId", GoMethod: "ResetApiId"},
