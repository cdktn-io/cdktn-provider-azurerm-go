...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "infrastructureResourceGroupName", GoGetter: "InfrastructureResourceGroupName"},
			_jsii_.MemberProperty{JsiiProperty: "infrastructureResourceGroupNameInput", GoGetter: "InfrastructureResourceGroupNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "infrastructureSubnetId", GoGetter: "InfrastructureSubnetId"},
			_jsii_.MemberProperty{JsiiProperty: "infrastructureSubnetIdInput", GoGetter: "InfrastructureSubnetIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalLoadBalancerEnabled", GoGetter: "InternalLoadBalancerEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "internalLoadBalancerEnabledInput", GoGetter: "InternalLoadBalancerEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "logsDestination", GoGetter: "LogsDestination"},
			_jsii_.MemberProperty{JsiiProperty: "logsDestinationInput", GoGetter: "LogsDestinationInput"},
			_jsii_.MemberMethod{JsiiMethod: "moveFromId", GoMethod: "MoveFromId"},
			_jsii_.MemberMethod{JsiiMethod: "moveTo", GoMethod: "MoveTo"},
			_jsii_.MemberMethod{JsiiMethod: "moveToId", GoMethod: "MoveToId"},
			_jsii_.MemberProperty{JsiiProperty: "mutualTlsEnabled", GoGetter: "MutualTlsEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "mutualTlsEnabledInput", GoGetter: "MutualTlsEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putWorkloadProfile", GoMethod: "PutWorkloadProfile"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetDaprApplicationInsightsConnectionString", GoMethod: "ResetDaprApplicationInsightsConnectionString"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIdentity", GoMethod: "ResetIdentity"},
			_jsii_.MemberMethod{JsiiMethod: "resetInfrastructureResourceGroupName", GoMethod: "ResetInfrastructureResourceGroupName"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLogsDestination", GoMethod: "ResetLogsDestination"},
			_jsii_.MemberMethod{JsiiMethod: "resetMutualTlsEnabled", GoMethod: "ResetMutualTlsEnabled"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWorkloadProfile", GoMethod: "ResetWorkloadProfile"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "workloadProfileType", GoGetter: "WorkloadProfileType"},
			_jsii_.MemberProperty{JsiiProperty: "workloadProfileTypeInput", GoGetter: "WorkloadProfileTypeInput"},
		},
		func() interface{} {
