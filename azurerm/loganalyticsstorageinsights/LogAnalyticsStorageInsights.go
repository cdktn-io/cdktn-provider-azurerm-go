...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/loganalyticsstorageinsights/internal"
...
func (j *jsiiProxy_LogAnalyticsStorageInsights) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LogAnalyticsStorageInsights) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LogAnalyticsStorageInsights) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LogAnalyticsStorageInsights) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LogAnalyticsStorageInsights) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LogAnalyticsStorageInsights) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/log_analytics_storage_insights azurerm_log_analytics_storage_insights} Resource.
...
func (j *jsiiProxy_LogAnalyticsStorageInsights)SetCount(val interface{}) {
...
func (j *jsiiProxy_LogAnalyticsStorageInsights)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LogAnalyticsStorageInsights)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LogAnalyticsStorageInsights)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LogAnalyticsStorageInsights_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateLogAnalyticsStorageInsights_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) MoveFromId(id *string) {
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) MoveToId(id *string) {
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) ToHclTerraform() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogAnalyticsStorageInsights) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
