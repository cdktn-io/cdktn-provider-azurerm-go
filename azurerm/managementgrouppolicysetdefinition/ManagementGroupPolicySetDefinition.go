...
func (m *jsiiProxy_ManagementGroupPolicySetDefinition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_ManagementGroupPolicySetDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
