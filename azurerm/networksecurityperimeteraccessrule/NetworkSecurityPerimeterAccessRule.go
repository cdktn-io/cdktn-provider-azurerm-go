...
func (j *jsiiProxy_NetworkSecurityPerimeterAccessRule) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_NetworkSecurityPerimeterAccessRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_NetworkSecurityPerimeterAccessRule) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkSecurityPerimeterAccessRule) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_NetworkSecurityPerimeterAccessRule) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_NetworkSecurityPerimeterAccessRule)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetworkSecurityPerimeterAccessRule)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetworkSecurityPerimeterAccessRule)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NetworkSecurityPerimeterAccessRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkSecurityPerimeterAccessRule) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkSecurityPerimeterAccessRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NetworkSecurityPerimeterAccessRule) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
