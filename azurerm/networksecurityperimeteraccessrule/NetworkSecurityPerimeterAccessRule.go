...
func (n *jsiiProxy_NetworkSecurityPerimeterAccessRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkSecurityPerimeterAccessRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
