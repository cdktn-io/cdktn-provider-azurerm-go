...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualNetworkPanoramaPanoramaList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPaloAltoNextGenerationFirewallVirtualNetworkPanoramaPanoramaList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PaloAltoNextGenerationFirewallVirtualNetworkPanoramaPanoramaList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.paloAltoNextGenerationFirewallVirtualNetworkPanorama.PaloAltoNextGenerationFirewallVirtualNetworkPanoramaPanoramaList",
...
func NewPaloAltoNextGenerationFirewallVirtualNetworkPanoramaPanoramaList_Override(p PaloAltoNextGenerationFirewallVirtualNetworkPanoramaPanoramaList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PaloAltoNextGenerationFirewallVirtualNetworkPanoramaPanoramaList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualNetworkPanoramaPanoramaList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PaloAltoNextGenerationFirewallVirtualNetworkPanoramaPanoramaList) Resolve(context cdktn.IResolveContext) interface{} {
