...
func (j *jsiiProxy_DataAzurermBatchPoolStartTaskUserIdentityAutoUserList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermBatchPoolStartTaskUserIdentityAutoUserList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermBatchPoolStartTaskUserIdentityAutoUserList {
	_init_.Initialize()
...
func NewDataAzurermBatchPoolStartTaskUserIdentityAutoUserList_Override(d DataAzurermBatchPoolStartTaskUserIdentityAutoUserList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermBatchPoolStartTaskUserIdentityAutoUserList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermBatchPoolStartTaskUserIdentityAutoUserList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermBatchPoolStartTaskUserIdentityAutoUserList) Resolve(context cdktn.IResolveContext) interface{} {
