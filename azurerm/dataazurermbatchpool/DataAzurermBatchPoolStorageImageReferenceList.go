...
func (j *jsiiProxy_DataAzurermBatchPoolStorageImageReferenceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermBatchPoolStorageImageReferenceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermBatchPoolStorageImageReferenceList {
	_init_.Initialize()
...
func NewDataAzurermBatchPoolStorageImageReferenceList_Override(d DataAzurermBatchPoolStorageImageReferenceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermBatchPoolStorageImageReferenceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermBatchPoolStorageImageReferenceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermBatchPoolStorageImageReferenceList) Resolve(context cdktn.IResolveContext) interface{} {
