...
func (j *jsiiProxy_DataAzurermBatchPoolMountAzureBlobFileSystemList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermBatchPoolMountAzureBlobFileSystemList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermBatchPoolMountAzureBlobFileSystemList {
	_init_.Initialize()
...
func NewDataAzurermBatchPoolMountAzureBlobFileSystemList_Override(d DataAzurermBatchPoolMountAzureBlobFileSystemList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermBatchPoolMountAzureBlobFileSystemList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermBatchPoolMountAzureBlobFileSystemList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermBatchPoolMountAzureBlobFileSystemList) Resolve(context cdktn.IResolveContext) interface{} {
