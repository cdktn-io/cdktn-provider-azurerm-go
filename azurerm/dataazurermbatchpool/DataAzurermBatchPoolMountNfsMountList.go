...
func (j *jsiiProxy_DataAzurermBatchPoolMountNfsMountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermBatchPoolMountNfsMountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermBatchPoolMountNfsMountList {
	_init_.Initialize()
...
func NewDataAzurermBatchPoolMountNfsMountList_Override(d DataAzurermBatchPoolMountNfsMountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermBatchPoolMountNfsMountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermBatchPoolMountNfsMountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermBatchPoolMountNfsMountList) Resolve(context cdktn.IResolveContext) interface{} {
