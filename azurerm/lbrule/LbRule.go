...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/lb_rule azurerm_lb_rule} Resource.
...
func (l *jsiiProxy_LbRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LbRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
