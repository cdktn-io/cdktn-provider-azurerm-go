...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "microsoftAppUserAssignedIdentityId", GoGetter: "MicrosoftAppUserAssignedIdentityId"},
			_jsii_.MemberProperty{JsiiProperty: "microsoftAppUserAssignedIdentityIdInput", GoGetter: "MicrosoftAppUserAssignedIdentityIdInput"},
