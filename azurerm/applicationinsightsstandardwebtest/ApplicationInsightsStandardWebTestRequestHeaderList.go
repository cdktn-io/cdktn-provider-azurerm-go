...
func (j *jsiiProxy_ApplicationInsightsStandardWebTestRequestHeaderList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewApplicationInsightsStandardWebTestRequestHeaderList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationInsightsStandardWebTestRequestHeaderList {
	_init_.Initialize()
...
func NewApplicationInsightsStandardWebTestRequestHeaderList_Override(a ApplicationInsightsStandardWebTestRequestHeaderList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationInsightsStandardWebTestRequestHeaderList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationInsightsStandardWebTestRequestHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationInsightsStandardWebTestRequestHeaderList) Resolve(context cdktf.IResolveContext) interface{} {
