...
func (a *jsiiProxy_ApplicationInsightsStandardWebTestValidationRulesContentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationInsightsStandardWebTestValidationRulesContentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
