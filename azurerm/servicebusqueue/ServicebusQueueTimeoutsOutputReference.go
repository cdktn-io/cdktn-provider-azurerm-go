...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/servicebusqueue/internal"
...
func (j *jsiiProxy_ServicebusQueueTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServicebusQueueTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ServicebusQueueTimeoutsOutputReference {
	_init_.Initialize()
...
func NewServicebusQueueTimeoutsOutputReference_Override(s ServicebusQueueTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServicebusQueueTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServicebusQueueTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusQueueTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServicebusQueueTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServicebusQueueTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
