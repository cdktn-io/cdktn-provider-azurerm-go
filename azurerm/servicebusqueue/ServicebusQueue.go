...
func (s *jsiiProxy_ServicebusQueue) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicebusQueue) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicebusQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
