...
func (d *jsiiProxy_DatabricksWorkspace) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatabricksWorkspace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatabricksWorkspace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
