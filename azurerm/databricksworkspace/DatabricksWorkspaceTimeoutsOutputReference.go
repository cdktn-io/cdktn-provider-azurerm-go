...
func (d *jsiiProxy_DatabricksWorkspaceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatabricksWorkspaceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
