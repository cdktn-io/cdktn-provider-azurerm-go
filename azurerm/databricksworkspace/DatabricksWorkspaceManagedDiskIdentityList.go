...
func (d *jsiiProxy_DatabricksWorkspaceManagedDiskIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DatabricksWorkspaceManagedDiskIdentityList) Resolve(context cdktf.IResolveContext) interface{} {
