...
func (d *jsiiProxy_DataFactoryDatasetMysqlSchemaColumnOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetMysqlSchemaColumnOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
