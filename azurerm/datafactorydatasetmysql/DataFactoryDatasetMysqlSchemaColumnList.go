...
func (j *jsiiProxy_DataFactoryDatasetMysqlSchemaColumnList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryDatasetMysqlSchemaColumnList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryDatasetMysqlSchemaColumnList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryDatasetMysql.DataFactoryDatasetMysqlSchemaColumnList",
...
func NewDataFactoryDatasetMysqlSchemaColumnList_Override(d DataFactoryDatasetMysqlSchemaColumnList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryDatasetMysqlSchemaColumnList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryDatasetMysqlSchemaColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryDatasetMysqlSchemaColumnList) Resolve(context cdktn.IResolveContext) interface{} {
