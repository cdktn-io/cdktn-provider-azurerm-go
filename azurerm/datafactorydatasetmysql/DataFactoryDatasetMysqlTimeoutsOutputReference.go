...
func (d *jsiiProxy_DataFactoryDatasetMysqlTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetMysqlTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
