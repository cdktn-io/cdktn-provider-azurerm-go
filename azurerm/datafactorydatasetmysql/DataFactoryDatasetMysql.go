...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/datafactorydatasetmysql/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/data_factory_dataset_mysql azurerm_data_factory_dataset_mysql}.
...
func (j *jsiiProxy_DataFactoryDatasetMysql) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataFactoryDatasetMysql) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataFactoryDatasetMysql) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataFactoryDatasetMysql) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataFactoryDatasetMysql) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataFactoryDatasetMysql) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/data_factory_dataset_mysql azurerm_data_factory_dataset_mysql} Resource.
...
func (j *jsiiProxy_DataFactoryDatasetMysql)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataFactoryDatasetMysql)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataFactoryDatasetMysql)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataFactoryDatasetMysql)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataFactoryDatasetMysql_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataFactoryDatasetMysql_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataFactoryDatasetMysql) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataFactoryDatasetMysql) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetMysql) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataFactoryDatasetMysql) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DataFactoryDatasetMysql) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetMysql) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryDatasetMysql) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataFactoryDatasetMysql) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DataFactoryDatasetMysql) MoveToId(id *string) {
...
func (d *jsiiProxy_DataFactoryDatasetMysql) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataFactoryDatasetMysql) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataFactoryDatasetMysql) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataFactoryDatasetMysql) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
