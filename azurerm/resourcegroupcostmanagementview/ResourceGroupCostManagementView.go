...
func (j *jsiiProxy_ResourceGroupCostManagementView) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ResourceGroupCostManagementView) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ResourceGroupCostManagementView) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ResourceGroupCostManagementView) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ResourceGroupCostManagementView) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/resource_group_cost_management_view azurerm_resource_group_cost_management_view} Resource.
...
func (j *jsiiProxy_ResourceGroupCostManagementView)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ResourceGroupCostManagementView)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ResourceGroupCostManagementView)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ResourceGroupCostManagementView_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_ResourceGroupCostManagementView) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupCostManagementView) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_ResourceGroupCostManagementView) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupCostManagementView) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_ResourceGroupCostManagementView) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_ResourceGroupCostManagementView) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
