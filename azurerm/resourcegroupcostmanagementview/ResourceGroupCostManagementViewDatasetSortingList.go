...
func (j *jsiiProxy_ResourceGroupCostManagementViewDatasetSortingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewResourceGroupCostManagementViewDatasetSortingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ResourceGroupCostManagementViewDatasetSortingList {
	_init_.Initialize()
...
func NewResourceGroupCostManagementViewDatasetSortingList_Override(r ResourceGroupCostManagementViewDatasetSortingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ResourceGroupCostManagementViewDatasetSortingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ResourceGroupCostManagementViewDatasetSortingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ResourceGroupCostManagementViewDatasetSortingList) Resolve(context cdktn.IResolveContext) interface{} {
