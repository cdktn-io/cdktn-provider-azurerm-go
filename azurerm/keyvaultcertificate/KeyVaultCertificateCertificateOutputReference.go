...
func (k *jsiiProxy_KeyVaultCertificateCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyVaultCertificateCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
