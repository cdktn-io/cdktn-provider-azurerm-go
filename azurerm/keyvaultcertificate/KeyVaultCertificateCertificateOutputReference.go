...
func (j *jsiiProxy_KeyVaultCertificateCertificateOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKeyVaultCertificateCertificateOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) KeyVaultCertificateCertificateOutputReference {
	_init_.Initialize()

	if err := validateNewKeyVaultCertificateCertificateOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewKeyVaultCertificateCertificateOutputReference_Override(k KeyVaultCertificateCertificateOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_KeyVaultCertificateCertificateOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KeyVaultCertificateCertificateOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultCertificateCertificateOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KeyVaultCertificateCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultCertificateCertificateOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
