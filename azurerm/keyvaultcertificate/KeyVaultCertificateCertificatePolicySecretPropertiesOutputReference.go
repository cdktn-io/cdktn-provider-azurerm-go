...
func (k *jsiiProxy_KeyVaultCertificateCertificatePolicySecretPropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyVaultCertificateCertificatePolicySecretPropertiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
