...
func (j *jsiiProxy_DataFactoryFlowletDataFlowTransformationFlowletOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryFlowletDataFlowTransformationFlowletOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataFactoryFlowletDataFlowTransformationFlowletOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryFlowletDataFlowTransformationFlowletOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryFlowletDataFlowTransformationFlowletOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryFlowletDataFlow.DataFactoryFlowletDataFlowTransformationFlowletOutputReference",
...
func NewDataFactoryFlowletDataFlowTransformationFlowletOutputReference_Override(d DataFactoryFlowletDataFlowTransformationFlowletOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryFlowletDataFlowTransformationFlowletOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTransformationFlowletOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTransformationFlowletOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTransformationFlowletOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTransformationFlowletOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
