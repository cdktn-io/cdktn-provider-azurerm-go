...
func (j *jsiiProxy_DataFactoryFlowletDataFlowSourceFlowletOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryFlowletDataFlowSourceFlowletOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataFactoryFlowletDataFlowSourceFlowletOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryFlowletDataFlowSourceFlowletOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryFlowletDataFlowSourceFlowletOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryFlowletDataFlow.DataFactoryFlowletDataFlowSourceFlowletOutputReference",
...
func NewDataFactoryFlowletDataFlowSourceFlowletOutputReference_Override(d DataFactoryFlowletDataFlowSourceFlowletOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryFlowletDataFlowSourceFlowletOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceFlowletOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceFlowletOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceFlowletOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceFlowletOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
