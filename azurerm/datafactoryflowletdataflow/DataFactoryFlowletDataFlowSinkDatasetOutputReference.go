...
func (j *jsiiProxy_DataFactoryFlowletDataFlowSinkDatasetOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryFlowletDataFlowSinkDatasetOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataFactoryFlowletDataFlowSinkDatasetOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryFlowletDataFlowSinkDatasetOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryFlowletDataFlowSinkDatasetOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryFlowletDataFlow.DataFactoryFlowletDataFlowSinkDatasetOutputReference",
...
func NewDataFactoryFlowletDataFlowSinkDatasetOutputReference_Override(d DataFactoryFlowletDataFlowSinkDatasetOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryFlowletDataFlowSinkDatasetOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkDatasetOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkDatasetOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkDatasetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkDatasetOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
