...
func (j *jsiiProxy_DataFactoryFlowletDataFlowSourceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryFlowletDataFlowSourceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryFlowletDataFlowSourceList {
	_init_.Initialize()
...
func NewDataFactoryFlowletDataFlowSourceList_Override(d DataFactoryFlowletDataFlowSourceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryFlowletDataFlowSourceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceList) Resolve(context cdktn.IResolveContext) interface{} {
