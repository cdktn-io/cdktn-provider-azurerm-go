...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkList) Resolve(context cdktf.IResolveContext) interface{} {
