...
func (j *jsiiProxy_DataFactoryFlowletDataFlowSinkList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryFlowletDataFlowSinkList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryFlowletDataFlowSinkList {
	_init_.Initialize()

	if err := validateNewDataFactoryFlowletDataFlowSinkListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryFlowletDataFlowSinkList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryFlowletDataFlow.DataFactoryFlowletDataFlowSinkList",
...
func NewDataFactoryFlowletDataFlowSinkList_Override(d DataFactoryFlowletDataFlowSinkList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryFlowletDataFlowSinkList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkList) Resolve(context cdktn.IResolveContext) interface{} {
