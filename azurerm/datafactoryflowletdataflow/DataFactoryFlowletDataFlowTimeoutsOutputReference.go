...
func (j *jsiiProxy_DataFactoryFlowletDataFlowTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryFlowletDataFlowTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataFactoryFlowletDataFlowTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryFlowletDataFlowTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryFlowletDataFlowTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryFlowletDataFlow.DataFactoryFlowletDataFlowTimeoutsOutputReference",
...
func NewDataFactoryFlowletDataFlowTimeoutsOutputReference_Override(d DataFactoryFlowletDataFlowTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryFlowletDataFlowTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
