...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTransformationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTransformationList) Resolve(context cdktf.IResolveContext) interface{} {
