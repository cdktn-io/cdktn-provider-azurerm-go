...
func (j *jsiiProxy_DataFactoryFlowletDataFlowTransformationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryFlowletDataFlowTransformationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryFlowletDataFlowTransformationList {
	_init_.Initialize()

	if err := validateNewDataFactoryFlowletDataFlowTransformationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataFactoryFlowletDataFlowTransformationList_Override(d DataFactoryFlowletDataFlowTransformationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryFlowletDataFlowTransformationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTransformationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowTransformationList) Resolve(context cdktn.IResolveContext) interface{} {
