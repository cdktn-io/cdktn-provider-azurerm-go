...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/datafactoryflowletdataflow/internal"
...
func (j *jsiiProxy_DataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryFlowletDataFlow.DataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference",
...
func NewDataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference_Override(d DataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceRejectedLinkedServiceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
