...
func (s *jsiiProxy_SystemCenterVirtualMachineManagerVirtualMachineInstanceHardwareOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SystemCenterVirtualMachineManagerVirtualMachineInstanceHardwareOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
