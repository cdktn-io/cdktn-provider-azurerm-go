...
func (d *jsiiProxy_DataAzurermOracleExadataInfrastructure) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermOracleExadataInfrastructure) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
