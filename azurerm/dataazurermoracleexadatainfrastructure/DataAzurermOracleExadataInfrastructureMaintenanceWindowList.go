...
func (j *jsiiProxy_DataAzurermOracleExadataInfrastructureMaintenanceWindowList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermOracleExadataInfrastructureMaintenanceWindowList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermOracleExadataInfrastructureMaintenanceWindowList {
	_init_.Initialize()
...
func NewDataAzurermOracleExadataInfrastructureMaintenanceWindowList_Override(d DataAzurermOracleExadataInfrastructureMaintenanceWindowList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermOracleExadataInfrastructureMaintenanceWindowList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermOracleExadataInfrastructureMaintenanceWindowList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermOracleExadataInfrastructureMaintenanceWindowList) Resolve(context cdktf.IResolveContext) interface{} {
