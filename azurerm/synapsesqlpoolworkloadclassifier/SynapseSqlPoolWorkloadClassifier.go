...
func (j *jsiiProxy_SynapseSqlPoolWorkloadClassifier) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadClassifier) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadClassifier) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadClassifier) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadClassifier) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadClassifier)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadClassifier)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadClassifier)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SynapseSqlPoolWorkloadClassifier_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadClassifier) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadClassifier) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadClassifier) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadClassifier) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadClassifier) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadClassifier) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
