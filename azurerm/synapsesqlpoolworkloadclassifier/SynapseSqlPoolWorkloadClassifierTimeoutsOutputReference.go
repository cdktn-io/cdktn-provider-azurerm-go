...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/synapsesqlpoolworkloadclassifier/internal"
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadClassifierTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSynapseSqlPoolWorkloadClassifierTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SynapseSqlPoolWorkloadClassifierTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSynapseSqlPoolWorkloadClassifierTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SynapseSqlPoolWorkloadClassifierTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.synapseSqlPoolWorkloadClassifier.SynapseSqlPoolWorkloadClassifierTimeoutsOutputReference",
...
func NewSynapseSqlPoolWorkloadClassifierTimeoutsOutputReference_Override(s SynapseSqlPoolWorkloadClassifierTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SynapseSqlPoolWorkloadClassifierTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadClassifierTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadClassifierTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadClassifierTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolWorkloadClassifierTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
