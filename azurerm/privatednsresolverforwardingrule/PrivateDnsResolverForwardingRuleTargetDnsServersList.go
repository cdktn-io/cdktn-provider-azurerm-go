...
func (p *jsiiProxy_PrivateDnsResolverForwardingRuleTargetDnsServersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrivateDnsResolverForwardingRuleTargetDnsServersList) Resolve(context cdktf.IResolveContext) interface{} {
