...
func (j *jsiiProxy_KubernetesClusterExtension) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KubernetesClusterExtension) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KubernetesClusterExtension) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KubernetesClusterExtension) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KubernetesClusterExtension) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/kubernetes_cluster_extension azurerm_kubernetes_cluster_extension} Resource.
...
func (j *jsiiProxy_KubernetesClusterExtension)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KubernetesClusterExtension)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KubernetesClusterExtension)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KubernetesClusterExtension_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KubernetesClusterExtension) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterExtension) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KubernetesClusterExtension) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterExtension) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KubernetesClusterExtension) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
