...
func (n *jsiiProxy_NetappSnapshotPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetappSnapshotPolicyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
