...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/netappsnapshotpolicy/internal"
...
func (j *jsiiProxy_NetappSnapshotPolicyWeeklyScheduleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetappSnapshotPolicyWeeklyScheduleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) NetappSnapshotPolicyWeeklyScheduleOutputReference {
	_init_.Initialize()

	if err := validateNewNetappSnapshotPolicyWeeklyScheduleOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewNetappSnapshotPolicyWeeklyScheduleOutputReference_Override(n NetappSnapshotPolicyWeeklyScheduleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetappSnapshotPolicyWeeklyScheduleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetappSnapshotPolicyWeeklyScheduleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetappSnapshotPolicyWeeklyScheduleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetappSnapshotPolicyWeeklyScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetappSnapshotPolicyWeeklyScheduleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
