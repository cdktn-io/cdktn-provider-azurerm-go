...
func (n *jsiiProxy_NetappSnapshotPolicyWeeklyScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetappSnapshotPolicyWeeklyScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
