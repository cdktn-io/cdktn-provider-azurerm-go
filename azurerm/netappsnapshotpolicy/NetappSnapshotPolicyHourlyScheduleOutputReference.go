...
func (n *jsiiProxy_NetappSnapshotPolicyHourlyScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetappSnapshotPolicyHourlyScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
