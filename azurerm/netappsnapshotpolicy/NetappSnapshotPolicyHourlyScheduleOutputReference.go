...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/netappsnapshotpolicy/internal"
...
func (j *jsiiProxy_NetappSnapshotPolicyHourlyScheduleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetappSnapshotPolicyHourlyScheduleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) NetappSnapshotPolicyHourlyScheduleOutputReference {
	_init_.Initialize()

	if err := validateNewNetappSnapshotPolicyHourlyScheduleOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewNetappSnapshotPolicyHourlyScheduleOutputReference_Override(n NetappSnapshotPolicyHourlyScheduleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetappSnapshotPolicyHourlyScheduleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetappSnapshotPolicyHourlyScheduleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetappSnapshotPolicyHourlyScheduleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetappSnapshotPolicyHourlyScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetappSnapshotPolicyHourlyScheduleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
