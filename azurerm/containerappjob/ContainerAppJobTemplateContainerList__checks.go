...
func (c *jsiiProxy_ContainerAppJobTemplateContainerList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ContainerAppJobTemplateContainerList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*ContainerAppJobTemplateContainer:
		val_ := val.([]*ContainerAppJobTemplateContainer)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_ContainerAppJobTemplateContainerList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewContainerAppJobTemplateContainerListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
