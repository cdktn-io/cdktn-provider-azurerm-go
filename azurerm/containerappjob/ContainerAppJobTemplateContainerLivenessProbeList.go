...
func (j *jsiiProxy_ContainerAppJobTemplateContainerLivenessProbeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerAppJobTemplateContainerLivenessProbeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerAppJobTemplateContainerLivenessProbeList {
	_init_.Initialize()
...
func NewContainerAppJobTemplateContainerLivenessProbeList_Override(c ContainerAppJobTemplateContainerLivenessProbeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerAppJobTemplateContainerLivenessProbeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerAppJobTemplateContainerLivenessProbeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerAppJobTemplateContainerLivenessProbeList) Resolve(context cdktn.IResolveContext) interface{} {
