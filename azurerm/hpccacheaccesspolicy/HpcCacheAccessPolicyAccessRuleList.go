...
func (j *jsiiProxy_HpcCacheAccessPolicyAccessRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHpcCacheAccessPolicyAccessRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HpcCacheAccessPolicyAccessRuleList {
	_init_.Initialize()

	if err := validateNewHpcCacheAccessPolicyAccessRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewHpcCacheAccessPolicyAccessRuleList_Override(h HpcCacheAccessPolicyAccessRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HpcCacheAccessPolicyAccessRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HpcCacheAccessPolicyAccessRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HpcCacheAccessPolicyAccessRuleList) Resolve(context cdktn.IResolveContext) interface{} {
