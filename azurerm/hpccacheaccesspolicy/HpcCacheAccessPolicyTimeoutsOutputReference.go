...
func (j *jsiiProxy_HpcCacheAccessPolicyTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHpcCacheAccessPolicyTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HpcCacheAccessPolicyTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewHpcCacheAccessPolicyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewHpcCacheAccessPolicyTimeoutsOutputReference_Override(h HpcCacheAccessPolicyTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HpcCacheAccessPolicyTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HpcCacheAccessPolicyTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HpcCacheAccessPolicyTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HpcCacheAccessPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HpcCacheAccessPolicyTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
