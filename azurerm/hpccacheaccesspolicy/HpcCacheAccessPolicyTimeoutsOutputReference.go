...
func (h *jsiiProxy_HpcCacheAccessPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HpcCacheAccessPolicyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
