...
func (j *jsiiProxy_HpcCacheAccessPolicyAccessRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHpcCacheAccessPolicyAccessRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) HpcCacheAccessPolicyAccessRuleOutputReference {
	_init_.Initialize()
...
func NewHpcCacheAccessPolicyAccessRuleOutputReference_Override(h HpcCacheAccessPolicyAccessRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HpcCacheAccessPolicyAccessRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HpcCacheAccessPolicyAccessRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HpcCacheAccessPolicyAccessRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HpcCacheAccessPolicyAccessRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HpcCacheAccessPolicyAccessRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
