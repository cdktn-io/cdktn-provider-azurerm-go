...
func (j *jsiiProxy_NetworkInterfaceNatRuleAssociation) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/network_interface_nat_rule_association azurerm_network_interface_nat_rule_association} Resource.
func NewNetworkInterfaceNatRuleAssociation(scope constructs.Construct, id *string, config *NetworkInterfaceNatRuleAssociationConfig) NetworkInterfaceNatRuleAssociation {
	...
	if err := validateNewNetworkInterfaceNatRuleAssociationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_NetworkInterfaceNatRuleAssociation)SetCount(val interface{}) {
...
func (j *jsiiProxy_NetworkInterfaceNatRuleAssociation)SetNatRuleId(val *string) {
	if err := j.validateSetNatRuleIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func NetworkInterfaceNatRuleAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateNetworkInterfaceNatRuleAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func NetworkInterfaceNatRuleAssociation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNetworkInterfaceNatRuleAssociation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func NetworkInterfaceNatRuleAssociation_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNetworkInterfaceNatRuleAssociation_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (n *jsiiProxy_NetworkInterfaceNatRuleAssociation) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkInterfaceNatRuleAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkInterfaceNatRuleAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkInterfaceNatRuleAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NetworkInterfaceNatRuleAssociation) ToHclTerraform() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NetworkInterfaceNatRuleAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
