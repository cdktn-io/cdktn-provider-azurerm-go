...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/networkinterfacenatruleassociation/internal"
...
func (j *jsiiProxy_NetworkInterfaceNatRuleAssociationTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkInterfaceNatRuleAssociationTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) NetworkInterfaceNatRuleAssociationTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewNetworkInterfaceNatRuleAssociationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_NetworkInterfaceNatRuleAssociationTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.networkInterfaceNatRuleAssociation.NetworkInterfaceNatRuleAssociationTimeoutsOutputReference",
...
func NewNetworkInterfaceNatRuleAssociationTimeoutsOutputReference_Override(n NetworkInterfaceNatRuleAssociationTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkInterfaceNatRuleAssociationTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkInterfaceNatRuleAssociationTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkInterfaceNatRuleAssociationTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetworkInterfaceNatRuleAssociationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkInterfaceNatRuleAssociationTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
