...
func (j *jsiiProxy_CognitiveAccountStorageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitiveAccountStorageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CognitiveAccountStorageList {
	_init_.Initialize()

	if err := validateNewCognitiveAccountStorageListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCognitiveAccountStorageList_Override(c CognitiveAccountStorageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitiveAccountStorageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitiveAccountStorageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CognitiveAccountStorageList) Resolve(context cdktn.IResolveContext) interface{} {
