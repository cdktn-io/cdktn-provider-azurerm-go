...
func (c *jsiiProxy_CognitiveAccountStorageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CognitiveAccountStorageList) Resolve(context cdktf.IResolveContext) interface{} {
