...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/cognitive_account azurerm_cognitive_account} Resource.
...
func (c *jsiiProxy_CognitiveAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CognitiveAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CognitiveAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
