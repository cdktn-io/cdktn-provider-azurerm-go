...
func (c *jsiiProxy_CognitiveAccountIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
