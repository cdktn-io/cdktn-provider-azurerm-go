...
func (c *jsiiProxy_CognitiveAccountTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
