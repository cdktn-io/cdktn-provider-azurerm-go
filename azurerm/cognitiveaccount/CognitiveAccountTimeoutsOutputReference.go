...
func (j *jsiiProxy_CognitiveAccountTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitiveAccountTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CognitiveAccountTimeoutsOutputReference {
	_init_.Initialize()
...
func NewCognitiveAccountTimeoutsOutputReference_Override(c CognitiveAccountTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitiveAccountTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitiveAccountTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CognitiveAccountTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
