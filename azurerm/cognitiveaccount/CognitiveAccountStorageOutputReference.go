...
func (j *jsiiProxy_CognitiveAccountStorageOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitiveAccountStorageOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CognitiveAccountStorageOutputReference {
	_init_.Initialize()
...
func NewCognitiveAccountStorageOutputReference_Override(c CognitiveAccountStorageOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitiveAccountStorageOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitiveAccountStorageOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountStorageOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CognitiveAccountStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountStorageOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
