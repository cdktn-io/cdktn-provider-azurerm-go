...
func (c *jsiiProxy_CognitiveAccountNetworkAclsVirtualNetworkRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountNetworkAclsVirtualNetworkRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
