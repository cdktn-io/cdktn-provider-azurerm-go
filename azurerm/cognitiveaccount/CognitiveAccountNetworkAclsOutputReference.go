...
func (j *jsiiProxy_CognitiveAccountNetworkAclsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitiveAccountNetworkAclsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CognitiveAccountNetworkAclsOutputReference {
	_init_.Initialize()
...
func NewCognitiveAccountNetworkAclsOutputReference_Override(c CognitiveAccountNetworkAclsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitiveAccountNetworkAclsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitiveAccountNetworkAclsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountNetworkAclsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CognitiveAccountNetworkAclsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountNetworkAclsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
