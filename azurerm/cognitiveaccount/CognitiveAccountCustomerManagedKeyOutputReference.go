...
func (c *jsiiProxy_CognitiveAccountCustomerManagedKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountCustomerManagedKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
