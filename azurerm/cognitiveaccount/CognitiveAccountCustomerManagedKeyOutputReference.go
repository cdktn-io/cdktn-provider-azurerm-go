...
func (j *jsiiProxy_CognitiveAccountCustomerManagedKeyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitiveAccountCustomerManagedKeyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CognitiveAccountCustomerManagedKeyOutputReference {
	_init_.Initialize()
...
func NewCognitiveAccountCustomerManagedKeyOutputReference_Override(c CognitiveAccountCustomerManagedKeyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitiveAccountCustomerManagedKeyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitiveAccountCustomerManagedKeyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountCustomerManagedKeyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CognitiveAccountCustomerManagedKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountCustomerManagedKeyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
