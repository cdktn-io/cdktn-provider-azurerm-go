...
func (d *jsiiProxy_DataAzurermNotificationHubApnsCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermNotificationHubApnsCredentialList) Resolve(context cdktf.IResolveContext) interface{} {
