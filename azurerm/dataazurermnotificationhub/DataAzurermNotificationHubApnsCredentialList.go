...
func (j *jsiiProxy_DataAzurermNotificationHubApnsCredentialList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermNotificationHubApnsCredentialList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermNotificationHubApnsCredentialList {
	_init_.Initialize()
...
func NewDataAzurermNotificationHubApnsCredentialList_Override(d DataAzurermNotificationHubApnsCredentialList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermNotificationHubApnsCredentialList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermNotificationHubApnsCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermNotificationHubApnsCredentialList) Resolve(context cdktn.IResolveContext) interface{} {
