...
func (j *jsiiProxy_DataAzurermNotificationHubGcmCredentialList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermNotificationHubGcmCredentialList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermNotificationHubGcmCredentialList {
	_init_.Initialize()
...
func NewDataAzurermNotificationHubGcmCredentialList_Override(d DataAzurermNotificationHubGcmCredentialList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermNotificationHubGcmCredentialList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermNotificationHubGcmCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermNotificationHubGcmCredentialList) Resolve(context cdktn.IResolveContext) interface{} {
