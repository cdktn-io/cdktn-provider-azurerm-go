...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/springcloudbuildpackbinding/internal"
...
func (j *jsiiProxy_SpringCloudBuildPackBindingLaunchOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudBuildPackBindingLaunchOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SpringCloudBuildPackBindingLaunchOutputReference {
	_init_.Initialize()

	if err := validateNewSpringCloudBuildPackBindingLaunchOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SpringCloudBuildPackBindingLaunchOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.springCloudBuildPackBinding.SpringCloudBuildPackBindingLaunchOutputReference",
...
func NewSpringCloudBuildPackBindingLaunchOutputReference_Override(s SpringCloudBuildPackBindingLaunchOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudBuildPackBindingLaunchOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudBuildPackBindingLaunchOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudBuildPackBindingLaunchOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SpringCloudBuildPackBindingLaunchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudBuildPackBindingLaunchOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
