...
func (s *jsiiProxy_SpringCloudBuildPackBindingLaunchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudBuildPackBindingLaunchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
