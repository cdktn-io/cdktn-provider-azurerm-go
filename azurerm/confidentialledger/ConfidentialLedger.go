...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/confidential_ledger azurerm_confidential_ledger} Resource.
...
func ConfidentialLedger_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ConfidentialLedger) ImportFrom(id *string, provider cdktf.TerraformProvider) {
