...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/confidentialledger/internal"
...
func (j *jsiiProxy_ConfidentialLedger) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ConfidentialLedger) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ConfidentialLedger) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ConfidentialLedger) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ConfidentialLedger) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewConfidentialLedger(scope constructs.Construct, id *string, config *ConfidentialLedgerConfig) ConfidentialLedger {
	...
	if err := validateNewConfidentialLedgerParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ConfidentialLedger)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ConfidentialLedger)SetLedgerType(val *string) {
	if err := j.validateSetLedgerTypeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ConfidentialLedger)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ConfidentialLedger)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ConfidentialLedger_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateConfidentialLedger_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ConfidentialLedger_IsConstruct(x interface{}) *bool {
	...
	if err := validateConfidentialLedger_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ConfidentialLedger_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateConfidentialLedger_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ConfidentialLedger_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateConfidentialLedger_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_ConfidentialLedger) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ConfidentialLedger) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfidentialLedger) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ConfidentialLedger) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_ConfidentialLedger) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfidentialLedger) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ConfidentialLedger) MoveFromId(id *string) {
...
func (c *jsiiProxy_ConfidentialLedger) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ConfidentialLedger) MoveToId(id *string) {
...
func (c *jsiiProxy_ConfidentialLedger) PutAzureadBasedServicePrincipal(value interface{}) {
	if err := c.validatePutAzureadBasedServicePrincipalParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ConfidentialLedger) PutCertificateBasedSecurityPrincipal(value interface{}) {
	if err := c.validatePutCertificateBasedSecurityPrincipalParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ConfidentialLedger) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ConfidentialLedger) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ConfidentialLedger) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ConfidentialLedger) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
