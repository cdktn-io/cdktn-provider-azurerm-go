...
func (j *jsiiProxy_ConfidentialLedgerCertificateBasedSecurityPrincipalList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConfidentialLedgerCertificateBasedSecurityPrincipalList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConfidentialLedgerCertificateBasedSecurityPrincipalList {
	_init_.Initialize()

	if err := validateNewConfidentialLedgerCertificateBasedSecurityPrincipalListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewConfidentialLedgerCertificateBasedSecurityPrincipalList_Override(c ConfidentialLedgerCertificateBasedSecurityPrincipalList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConfidentialLedgerCertificateBasedSecurityPrincipalList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConfidentialLedgerCertificateBasedSecurityPrincipalList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConfidentialLedgerCertificateBasedSecurityPrincipalList) Resolve(context cdktn.IResolveContext) interface{} {
