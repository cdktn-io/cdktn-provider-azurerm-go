...
func (c *jsiiProxy_ConfidentialLedgerCertificateBasedSecurityPrincipalList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConfidentialLedgerCertificateBasedSecurityPrincipalList) Resolve(context cdktf.IResolveContext) interface{} {
