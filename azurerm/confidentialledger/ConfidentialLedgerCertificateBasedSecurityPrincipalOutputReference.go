...
func (c *jsiiProxy_ConfidentialLedgerCertificateBasedSecurityPrincipalOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfidentialLedgerCertificateBasedSecurityPrincipalOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
