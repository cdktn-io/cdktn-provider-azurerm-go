...
func (c *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalList) Resolve(context cdktf.IResolveContext) interface{} {
