...
func (j *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConfidentialLedgerAzureadBasedServicePrincipalList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ConfidentialLedgerAzureadBasedServicePrincipalList {
	_init_.Initialize()
...
func NewConfidentialLedgerAzureadBasedServicePrincipalList_Override(c ConfidentialLedgerAzureadBasedServicePrincipalList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalList) Resolve(context cdktn.IResolveContext) interface{} {
