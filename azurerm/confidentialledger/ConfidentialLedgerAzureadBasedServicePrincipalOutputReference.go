...
func (j *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewConfidentialLedgerAzureadBasedServicePrincipalOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ConfidentialLedgerAzureadBasedServicePrincipalOutputReference {
	_init_.Initialize()

	if err := validateNewConfidentialLedgerAzureadBasedServicePrincipalOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewConfidentialLedgerAzureadBasedServicePrincipalOutputReference_Override(c ConfidentialLedgerAzureadBasedServicePrincipalOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ConfidentialLedgerAzureadBasedServicePrincipalOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
