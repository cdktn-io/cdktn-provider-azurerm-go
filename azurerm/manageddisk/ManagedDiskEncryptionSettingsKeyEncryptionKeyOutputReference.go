...
func (j *jsiiProxy_ManagedDiskEncryptionSettingsKeyEncryptionKeyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewManagedDiskEncryptionSettingsKeyEncryptionKeyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ManagedDiskEncryptionSettingsKeyEncryptionKeyOutputReference {
	_init_.Initialize()
...
func NewManagedDiskEncryptionSettingsKeyEncryptionKeyOutputReference_Override(m ManagedDiskEncryptionSettingsKeyEncryptionKeyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ManagedDiskEncryptionSettingsKeyEncryptionKeyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_ManagedDiskEncryptionSettingsKeyEncryptionKeyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagedDiskEncryptionSettingsKeyEncryptionKeyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_ManagedDiskEncryptionSettingsKeyEncryptionKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagedDiskEncryptionSettingsKeyEncryptionKeyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
