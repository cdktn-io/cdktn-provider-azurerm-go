...
func (m *jsiiProxy_ManagedDiskTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedDiskTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
