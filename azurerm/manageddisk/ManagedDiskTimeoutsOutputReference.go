...
func (j *jsiiProxy_ManagedDiskTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewManagedDiskTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ManagedDiskTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewManagedDiskTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewManagedDiskTimeoutsOutputReference_Override(m ManagedDiskTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ManagedDiskTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_ManagedDiskTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagedDiskTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_ManagedDiskTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagedDiskTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
