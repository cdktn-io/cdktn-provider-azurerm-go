...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/netapp_account_encryption azurerm_netapp_account_encryption}.
...
func (j *jsiiProxy_NetappAccountEncryption) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NetappAccountEncryption) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NetappAccountEncryption) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetappAccountEncryption) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NetappAccountEncryption) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/netapp_account_encryption azurerm_netapp_account_encryption} Resource.
...
func (j *jsiiProxy_NetappAccountEncryption)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetappAccountEncryption)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetappAccountEncryption)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NetappAccountEncryption_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetappAccountEncryption) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetappAccountEncryption) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NetappAccountEncryption) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetappAccountEncryption) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetappAccountEncryption) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetappAccountEncryption) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
