...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsUrlFileExtensionConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsUrlFileExtensionConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsUrlFileExtensionConditionList {
	_init_.Initialize()

	if err := validateNewCdnFrontdoorRuleConditionsUrlFileExtensionConditionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCdnFrontdoorRuleConditionsUrlFileExtensionConditionList_Override(c CdnFrontdoorRuleConditionsUrlFileExtensionConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsUrlFileExtensionConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlFileExtensionConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlFileExtensionConditionList) Resolve(context cdktn.IResolveContext) interface{} {
