...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlFileExtensionConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlFileExtensionConditionList) Resolve(context cdktf.IResolveContext) interface{} {
