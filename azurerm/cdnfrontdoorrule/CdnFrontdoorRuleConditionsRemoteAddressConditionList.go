...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsRemoteAddressConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsRemoteAddressConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsRemoteAddressConditionList {
	_init_.Initialize()
...
func NewCdnFrontdoorRuleConditionsRemoteAddressConditionList_Override(c CdnFrontdoorRuleConditionsRemoteAddressConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsRemoteAddressConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRemoteAddressConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRemoteAddressConditionList) Resolve(context cdktn.IResolveContext) interface{} {
