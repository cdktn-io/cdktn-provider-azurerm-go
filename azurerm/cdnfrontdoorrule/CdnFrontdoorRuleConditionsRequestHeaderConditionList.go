...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestHeaderConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestHeaderConditionList) Resolve(context cdktf.IResolveContext) interface{} {
