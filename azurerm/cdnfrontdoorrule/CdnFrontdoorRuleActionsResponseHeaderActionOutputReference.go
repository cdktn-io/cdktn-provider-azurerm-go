...
func (c *jsiiProxy_CdnFrontdoorRuleActionsResponseHeaderActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsResponseHeaderActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
