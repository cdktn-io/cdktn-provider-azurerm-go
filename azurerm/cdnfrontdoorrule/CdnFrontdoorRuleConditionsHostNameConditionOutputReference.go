...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsHostNameConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsHostNameConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
