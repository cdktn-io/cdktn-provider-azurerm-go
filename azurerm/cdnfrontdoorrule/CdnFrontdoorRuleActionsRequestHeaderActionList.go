...
func (j *jsiiProxy_CdnFrontdoorRuleActionsRequestHeaderActionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleActionsRequestHeaderActionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleActionsRequestHeaderActionList {
	_init_.Initialize()
...
func NewCdnFrontdoorRuleActionsRequestHeaderActionList_Override(c CdnFrontdoorRuleActionsRequestHeaderActionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleActionsRequestHeaderActionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsRequestHeaderActionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsRequestHeaderActionList) Resolve(context cdktn.IResolveContext) interface{} {
