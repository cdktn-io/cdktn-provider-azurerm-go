...
func (c *jsiiProxy_CdnFrontdoorRuleActionsRequestHeaderActionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsRequestHeaderActionList) Resolve(context cdktf.IResolveContext) interface{} {
