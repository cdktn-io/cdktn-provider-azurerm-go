...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsCookiesConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsCookiesConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsCookiesConditionList {
	_init_.Initialize()

	if err := validateNewCdnFrontdoorRuleConditionsCookiesConditionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCdnFrontdoorRuleConditionsCookiesConditionList_Override(c CdnFrontdoorRuleConditionsCookiesConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsCookiesConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsCookiesConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsCookiesConditionList) Resolve(context cdktn.IResolveContext) interface{} {
