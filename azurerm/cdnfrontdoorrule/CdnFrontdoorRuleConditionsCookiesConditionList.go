...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsCookiesConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsCookiesConditionList) Resolve(context cdktf.IResolveContext) interface{} {
