...
func (c *jsiiProxy_CdnFrontdoorRuleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
