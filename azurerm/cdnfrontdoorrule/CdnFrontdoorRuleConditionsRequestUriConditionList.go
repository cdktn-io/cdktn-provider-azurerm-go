...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsRequestUriConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsRequestUriConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsRequestUriConditionList {
	_init_.Initialize()

	if err := validateNewCdnFrontdoorRuleConditionsRequestUriConditionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCdnFrontdoorRuleConditionsRequestUriConditionList_Override(c CdnFrontdoorRuleConditionsRequestUriConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsRequestUriConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestUriConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestUriConditionList) Resolve(context cdktn.IResolveContext) interface{} {
