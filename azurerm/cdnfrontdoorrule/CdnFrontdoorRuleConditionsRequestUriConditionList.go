...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestUriConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestUriConditionList) Resolve(context cdktf.IResolveContext) interface{} {
