...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsUrlFilenameConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsUrlFilenameConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsUrlFilenameConditionList {
	_init_.Initialize()
...
func NewCdnFrontdoorRuleConditionsUrlFilenameConditionList_Override(c CdnFrontdoorRuleConditionsUrlFilenameConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsUrlFilenameConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlFilenameConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlFilenameConditionList) Resolve(context cdktn.IResolveContext) interface{} {
