...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlFilenameConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlFilenameConditionList) Resolve(context cdktf.IResolveContext) interface{} {
