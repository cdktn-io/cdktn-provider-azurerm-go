...
func (j *jsiiProxy_CdnFrontdoorRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CdnFrontdoorRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CdnFrontdoorRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CdnFrontdoorRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CdnFrontdoorRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/cdn_frontdoor_rule azurerm_cdn_frontdoor_rule} Resource.
...
func (j *jsiiProxy_CdnFrontdoorRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CdnFrontdoorRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CdnFrontdoorRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CdnFrontdoorRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CdnFrontdoorRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CdnFrontdoorRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CdnFrontdoorRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
