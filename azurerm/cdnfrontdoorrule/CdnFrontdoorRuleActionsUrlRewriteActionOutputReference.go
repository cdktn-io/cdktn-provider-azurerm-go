...
func (j *jsiiProxy_CdnFrontdoorRuleActionsUrlRewriteActionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleActionsUrlRewriteActionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CdnFrontdoorRuleActionsUrlRewriteActionOutputReference {
	_init_.Initialize()
...
func NewCdnFrontdoorRuleActionsUrlRewriteActionOutputReference_Override(c CdnFrontdoorRuleActionsUrlRewriteActionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleActionsUrlRewriteActionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsUrlRewriteActionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsUrlRewriteActionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsUrlRewriteActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsUrlRewriteActionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
