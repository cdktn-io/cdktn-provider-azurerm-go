...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsRequestSchemeConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsRequestSchemeConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsRequestSchemeConditionList {
	_init_.Initialize()

	if err := validateNewCdnFrontdoorRuleConditionsRequestSchemeConditionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCdnFrontdoorRuleConditionsRequestSchemeConditionList_Override(c CdnFrontdoorRuleConditionsRequestSchemeConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsRequestSchemeConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestSchemeConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestSchemeConditionList) Resolve(context cdktn.IResolveContext) interface{} {
