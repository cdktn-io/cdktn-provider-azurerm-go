...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsSslProtocolConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsSslProtocolConditionList) Resolve(context cdktf.IResolveContext) interface{} {
