...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsSslProtocolConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsSslProtocolConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsSslProtocolConditionList {
	_init_.Initialize()
...
func NewCdnFrontdoorRuleConditionsSslProtocolConditionList_Override(c CdnFrontdoorRuleConditionsSslProtocolConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsSslProtocolConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsSslProtocolConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsSslProtocolConditionList) Resolve(context cdktn.IResolveContext) interface{} {
