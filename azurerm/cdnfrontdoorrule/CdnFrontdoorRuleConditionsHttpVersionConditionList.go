...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsHttpVersionConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsHttpVersionConditionList) Resolve(context cdktf.IResolveContext) interface{} {
