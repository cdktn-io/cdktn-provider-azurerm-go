...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsHttpVersionConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsHttpVersionConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsHttpVersionConditionList {
	_init_.Initialize()
...
func NewCdnFrontdoorRuleConditionsHttpVersionConditionList_Override(c CdnFrontdoorRuleConditionsHttpVersionConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsHttpVersionConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsHttpVersionConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsHttpVersionConditionList) Resolve(context cdktn.IResolveContext) interface{} {
