...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsRequestBodyConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsRequestBodyConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsRequestBodyConditionList {
	_init_.Initialize()
...
func NewCdnFrontdoorRuleConditionsRequestBodyConditionList_Override(c CdnFrontdoorRuleConditionsRequestBodyConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsRequestBodyConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestBodyConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestBodyConditionList) Resolve(context cdktn.IResolveContext) interface{} {
