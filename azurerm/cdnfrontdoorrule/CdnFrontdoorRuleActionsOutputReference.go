...
func (c *jsiiProxy_CdnFrontdoorRuleActionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
