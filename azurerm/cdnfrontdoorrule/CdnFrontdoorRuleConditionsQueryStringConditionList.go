...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsQueryStringConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsQueryStringConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsQueryStringConditionList {
	_init_.Initialize()
...
func NewCdnFrontdoorRuleConditionsQueryStringConditionList_Override(c CdnFrontdoorRuleConditionsQueryStringConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsQueryStringConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsQueryStringConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsQueryStringConditionList) Resolve(context cdktn.IResolveContext) interface{} {
