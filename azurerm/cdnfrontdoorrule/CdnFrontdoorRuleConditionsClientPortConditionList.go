...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsClientPortConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsClientPortConditionList) Resolve(context cdktf.IResolveContext) interface{} {
