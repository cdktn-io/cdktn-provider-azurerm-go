...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsServerPortConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsServerPortConditionList) Resolve(context cdktf.IResolveContext) interface{} {
