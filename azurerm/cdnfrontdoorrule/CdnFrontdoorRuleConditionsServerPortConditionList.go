...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsServerPortConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsServerPortConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsServerPortConditionList {
	_init_.Initialize()
...
func NewCdnFrontdoorRuleConditionsServerPortConditionList_Override(c CdnFrontdoorRuleConditionsServerPortConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsServerPortConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsServerPortConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsServerPortConditionList) Resolve(context cdktn.IResolveContext) interface{} {
