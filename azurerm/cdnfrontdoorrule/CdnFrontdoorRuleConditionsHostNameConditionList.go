...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsHostNameConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsHostNameConditionList) Resolve(context cdktf.IResolveContext) interface{} {
