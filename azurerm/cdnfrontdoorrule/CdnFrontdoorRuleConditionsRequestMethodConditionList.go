...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsRequestMethodConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsRequestMethodConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsRequestMethodConditionList {
	_init_.Initialize()

	if err := validateNewCdnFrontdoorRuleConditionsRequestMethodConditionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCdnFrontdoorRuleConditionsRequestMethodConditionList_Override(c CdnFrontdoorRuleConditionsRequestMethodConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsRequestMethodConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestMethodConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestMethodConditionList) Resolve(context cdktn.IResolveContext) interface{} {
