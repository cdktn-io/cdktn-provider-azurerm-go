...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsIsDeviceConditionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsIsDeviceConditionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CdnFrontdoorRuleConditionsIsDeviceConditionOutputReference {
	_init_.Initialize()

	if err := validateNewCdnFrontdoorRuleConditionsIsDeviceConditionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewCdnFrontdoorRuleConditionsIsDeviceConditionOutputReference_Override(c CdnFrontdoorRuleConditionsIsDeviceConditionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsIsDeviceConditionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsIsDeviceConditionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsIsDeviceConditionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsIsDeviceConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsIsDeviceConditionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
