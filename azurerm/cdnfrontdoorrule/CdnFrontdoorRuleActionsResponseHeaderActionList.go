...
func (c *jsiiProxy_CdnFrontdoorRuleActionsResponseHeaderActionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsResponseHeaderActionList) Resolve(context cdktf.IResolveContext) interface{} {
