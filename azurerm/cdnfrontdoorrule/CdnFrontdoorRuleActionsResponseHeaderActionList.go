...
func (j *jsiiProxy_CdnFrontdoorRuleActionsResponseHeaderActionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleActionsResponseHeaderActionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleActionsResponseHeaderActionList {
	_init_.Initialize()
...
func NewCdnFrontdoorRuleActionsResponseHeaderActionList_Override(c CdnFrontdoorRuleActionsResponseHeaderActionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleActionsResponseHeaderActionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsResponseHeaderActionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsResponseHeaderActionList) Resolve(context cdktn.IResolveContext) interface{} {
