...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsSocketAddressConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorRuleConditionsSocketAddressConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsSocketAddressConditionList {
	_init_.Initialize()
...
func NewCdnFrontdoorRuleConditionsSocketAddressConditionList_Override(c CdnFrontdoorRuleConditionsSocketAddressConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorRuleConditionsSocketAddressConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsSocketAddressConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsSocketAddressConditionList) Resolve(context cdktn.IResolveContext) interface{} {
