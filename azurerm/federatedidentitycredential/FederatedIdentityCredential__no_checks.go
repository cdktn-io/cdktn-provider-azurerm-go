...
func (f *jsiiProxy_FederatedIdentityCredential) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func (j *jsiiProxy_FederatedIdentityCredential) validateSetCountParameters(val interface{}) error {
	return nil
}
