...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/storagecontainer/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/storage_container azurerm_storage_container}.
type StorageContainer interface {
	...
	HasImmutabilityPolicy() cdktn.IResolvable
	HasLegalHold() cdktn.IResolvable
	Id() *string
	SetId(val *string)
	IdInput() *string
	// Experimental.
...
func (j *jsiiProxy_StorageContainer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StorageContainer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StorageContainer) HasImmutabilityPolicy() cdktn.IResolvable {
...
func (j *jsiiProxy_StorageContainer) HasLegalHold() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"hasLegalHold",
...
func (j *jsiiProxy_StorageContainer) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StorageContainer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StorageContainer) StorageAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageAccountId",
...
func (j *jsiiProxy_StorageContainer) StorageAccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_StorageContainer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/storage_container azurerm_storage_container} Resource.
...
func (j *jsiiProxy_StorageContainer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StorageContainer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StorageContainer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_StorageContainer)SetStorageAccountId(val *string) {
...
func StorageContainer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateStorageContainer_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageContainer) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StorageContainer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageContainer) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StorageContainer) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StorageContainer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageContainer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageContainer) MoveFromId(id *string) {
...
func (s *jsiiProxy_StorageContainer) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StorageContainer) MoveToId(id *string) {
...
func (s *jsiiProxy_StorageContainer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageContainer) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StorageContainer) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StorageContainer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
