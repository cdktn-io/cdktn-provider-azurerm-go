...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putTopicSpacesConfiguration", GoMethod: "PutTopicSpacesConfiguration"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTopicSpacesConfiguration", GoMethod: "ResetTopicSpacesConfiguration"},
			...
			_jsii_.MemberProperty{JsiiProperty: "topicSpacesConfiguration", GoGetter: "TopicSpacesConfiguration"},
			_jsii_.MemberProperty{JsiiProperty: "topicSpacesConfigurationInput", GoGetter: "TopicSpacesConfigurationInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_EventgridNamespaceIdentityOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_EventgridNamespaceInboundIpRuleList{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_EventgridNamespaceTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_EventgridNamespaceTopicSpacesConfigurationList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "alternativeAuthenticationNameSourceInput", GoGetter: "AlternativeAuthenticationNameSourceInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "dynamicRoutingEnrichment", GoGetter: "DynamicRoutingEnrichment"},
			_jsii_.MemberProperty{JsiiProperty: "dynamicRoutingEnrichmentInput", GoGetter: "DynamicRoutingEnrichmentInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "maximumClientSessionsPerAuthenticationName", GoGetter: "MaximumClientSessionsPerAuthenticationName"},
			_jsii_.MemberProperty{JsiiProperty: "maximumClientSessionsPerAuthenticationNameInput", GoGetter: "MaximumClientSessionsPerAuthenticationNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "maximumSessionExpiryInHours", GoGetter: "MaximumSessionExpiryInHours"},
			_jsii_.MemberProperty{JsiiProperty: "maximumSessionExpiryInHoursInput", GoGetter: "MaximumSessionExpiryInHoursInput"},
			_jsii_.MemberMethod{JsiiMethod: "putDynamicRoutingEnrichment", GoMethod: "PutDynamicRoutingEnrichment"},
			_jsii_.MemberMethod{JsiiMethod: "putStaticRoutingEnrichment", GoMethod: "PutStaticRoutingEnrichment"},
			_jsii_.MemberMethod{JsiiMethod: "resetAlternativeAuthenticationNameSource", GoMethod: "ResetAlternativeAuthenticationNameSource"},
			_jsii_.MemberMethod{JsiiMethod: "resetDynamicRoutingEnrichment", GoMethod: "ResetDynamicRoutingEnrichment"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaximumClientSessionsPerAuthenticationName", GoMethod: "ResetMaximumClientSessionsPerAuthenticationName"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaximumSessionExpiryInHours", GoMethod: "ResetMaximumSessionExpiryInHours"},
			_jsii_.MemberMethod{JsiiMethod: "resetRouteTopicId", GoMethod: "ResetRouteTopicId"},
			_jsii_.MemberMethod{JsiiMethod: "resetStaticRoutingEnrichment", GoMethod: "ResetStaticRoutingEnrichment"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "routeTopicId", GoGetter: "RouteTopicId"},
			_jsii_.MemberProperty{JsiiProperty: "routeTopicIdInput", GoGetter: "RouteTopicIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "staticRoutingEnrichment", GoGetter: "StaticRoutingEnrichment"},
			_jsii_.MemberProperty{JsiiProperty: "staticRoutingEnrichmentInput", GoGetter: "StaticRoutingEnrichmentInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
