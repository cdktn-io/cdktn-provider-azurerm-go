...
func (l *jsiiProxy_LighthouseDefinitionAuthorizationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LighthouseDefinitionAuthorizationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
