...
func (j *jsiiProxy_LighthouseDefinitionEligibleAuthorizationList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*LighthouseDefinitionEligibleAuthorization; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_LighthouseDefinitionEligibleAuthorizationList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_LighthouseDefinitionEligibleAuthorizationList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
