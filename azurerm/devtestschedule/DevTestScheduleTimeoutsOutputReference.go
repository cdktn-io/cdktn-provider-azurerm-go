...
func (d *jsiiProxy_DevTestScheduleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DevTestScheduleTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
