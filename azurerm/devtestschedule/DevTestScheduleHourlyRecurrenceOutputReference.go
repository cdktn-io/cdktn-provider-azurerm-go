...
func (d *jsiiProxy_DevTestScheduleHourlyRecurrenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DevTestScheduleHourlyRecurrenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
