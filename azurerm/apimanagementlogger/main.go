...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "applicationInsights", GoGetter: "ApplicationInsights"},
			_jsii_.MemberProperty{JsiiProperty: "applicationInsightsInput", GoGetter: "ApplicationInsightsInput"},
			_jsii_.MemberProperty{JsiiProperty: "buffered", GoGetter: "Buffered"},
			_jsii_.MemberProperty{JsiiProperty: "bufferedInput", GoGetter: "BufferedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putApplicationInsights", GoMethod: "PutApplicationInsights"},
			_jsii_.MemberMethod{JsiiMethod: "putEventhub", GoMethod: "PutEventhub"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetApplicationInsights", GoMethod: "ResetApplicationInsights"},
			_jsii_.MemberMethod{JsiiMethod: "resetBuffered", GoMethod: "ResetBuffered"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "instrumentationKeyInput", GoGetter: "InstrumentationKeyInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetConnectionString", GoMethod: "ResetConnectionString"},
			_jsii_.MemberMethod{JsiiMethod: "resetInstrumentationKey", GoMethod: "ResetInstrumentationKey"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUserAssignedIdentityClientId", GoMethod: "ResetUserAssignedIdentityClientId"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
