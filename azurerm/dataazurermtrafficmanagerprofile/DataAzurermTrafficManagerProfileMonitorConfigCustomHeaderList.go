...
func (j *jsiiProxy_DataAzurermTrafficManagerProfileMonitorConfigCustomHeaderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermTrafficManagerProfileMonitorConfigCustomHeaderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermTrafficManagerProfileMonitorConfigCustomHeaderList {
	_init_.Initialize()
...
func NewDataAzurermTrafficManagerProfileMonitorConfigCustomHeaderList_Override(d DataAzurermTrafficManagerProfileMonitorConfigCustomHeaderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermTrafficManagerProfileMonitorConfigCustomHeaderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermTrafficManagerProfileMonitorConfigCustomHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermTrafficManagerProfileMonitorConfigCustomHeaderList) Resolve(context cdktn.IResolveContext) interface{} {
