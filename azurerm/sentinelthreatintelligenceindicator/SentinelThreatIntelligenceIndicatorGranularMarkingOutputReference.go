...
func (s *jsiiProxy_SentinelThreatIntelligenceIndicatorGranularMarkingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SentinelThreatIntelligenceIndicatorGranularMarkingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
