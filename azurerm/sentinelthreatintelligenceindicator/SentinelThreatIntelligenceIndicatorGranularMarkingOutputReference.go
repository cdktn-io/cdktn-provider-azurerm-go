...
func (j *jsiiProxy_SentinelThreatIntelligenceIndicatorGranularMarkingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelThreatIntelligenceIndicatorGranularMarkingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SentinelThreatIntelligenceIndicatorGranularMarkingOutputReference {
	_init_.Initialize()
...
func NewSentinelThreatIntelligenceIndicatorGranularMarkingOutputReference_Override(s SentinelThreatIntelligenceIndicatorGranularMarkingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelThreatIntelligenceIndicatorGranularMarkingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelThreatIntelligenceIndicatorGranularMarkingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelThreatIntelligenceIndicatorGranularMarkingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SentinelThreatIntelligenceIndicatorGranularMarkingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelThreatIntelligenceIndicatorGranularMarkingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
