...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/streamanalyticsreferenceinputblob/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/stream_analytics_reference_input_blob azurerm_stream_analytics_reference_input_blob} Resource.
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputBlob) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputBlob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputBlob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
