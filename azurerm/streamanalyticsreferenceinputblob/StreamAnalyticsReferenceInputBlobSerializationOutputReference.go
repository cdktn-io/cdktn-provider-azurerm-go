...
func (s *jsiiProxy_StreamAnalyticsReferenceInputBlobSerializationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsReferenceInputBlobSerializationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
