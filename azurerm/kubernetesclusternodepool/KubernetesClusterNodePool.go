...
func (j *jsiiProxy_KubernetesClusterNodePool) AutoScalingEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KubernetesClusterNodePool) GpuDriver() *string {
	var returns *string
	_jsii_.Get(
		j,
		"gpuDriver",
...
func (j *jsiiProxy_KubernetesClusterNodePool) GpuDriverInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"gpuDriverInput",
...
func (j *jsiiProxy_KubernetesClusterNodePool) HostEncryptionEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KubernetesClusterNodePool) HostEncryptionEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KubernetesClusterNodePool) NodeImageVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nodeImageVersion",
...
func (j *jsiiProxy_KubernetesClusterNodePool) NodePublicIpEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"nodePublicIpEnabled",
...
func (j *jsiiProxy_KubernetesClusterNodePool) NodePublicIpEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KubernetesClusterNodePool)SetAutoScalingEnabled(val interface{}) {
...
func (j *jsiiProxy_KubernetesClusterNodePool)SetGpuDriver(val *string) {
...
func (j *jsiiProxy_KubernetesClusterNodePool)SetHostEncryptionEnabled(val interface{}) {
...
func (j *jsiiProxy_KubernetesClusterNodePool)SetNodePublicIpEnabled(val interface{}) {
...
func (k *jsiiProxy_KubernetesClusterNodePool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KubernetesClusterNodePool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KubernetesClusterNodePool) ResetAutoScalingEnabled() {
	_jsii_.InvokeVoid(
		k,
		"resetAutoScalingEnabled",
		nil, // no parameters
...
func (k *jsiiProxy_KubernetesClusterNodePool) ResetGpuDriver() {
	_jsii_.InvokeVoid(
		k,
		"resetGpuDriver",
		nil, // no parameters
...
func (k *jsiiProxy_KubernetesClusterNodePool) ResetHostEncryptionEnabled() {
	_jsii_.InvokeVoid(
		k,
		"resetHostEncryptionEnabled",
		nil, // no parameters
...
func (k *jsiiProxy_KubernetesClusterNodePool) ResetNodePublicIpEnabled() {
	_jsii_.InvokeVoid(
		k,
		"resetNodePublicIpEnabled",
		nil, // no parameters
...
func (k *jsiiProxy_KubernetesClusterNodePool) ResetVmSize() {
	_jsii_.InvokeVoid(
		k,
		"resetVmSize",
		nil, // no parameters
...
func (k *jsiiProxy_KubernetesClusterNodePool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
