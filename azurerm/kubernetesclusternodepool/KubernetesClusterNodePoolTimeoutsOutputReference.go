...
func (k *jsiiProxy_KubernetesClusterNodePoolTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterNodePoolTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
