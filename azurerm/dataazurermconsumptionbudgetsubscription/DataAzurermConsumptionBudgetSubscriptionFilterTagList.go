...
func (j *jsiiProxy_DataAzurermConsumptionBudgetSubscriptionFilterTagList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermConsumptionBudgetSubscriptionFilterTagList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermConsumptionBudgetSubscriptionFilterTagList {
	_init_.Initialize()
...
func NewDataAzurermConsumptionBudgetSubscriptionFilterTagList_Override(d DataAzurermConsumptionBudgetSubscriptionFilterTagList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermConsumptionBudgetSubscriptionFilterTagList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermConsumptionBudgetSubscriptionFilterTagList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermConsumptionBudgetSubscriptionFilterTagList) Resolve(context cdktn.IResolveContext) interface{} {
