...
func (j *jsiiProxy_DataAzurermConsumptionBudgetSubscriptionFilterNotTagList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermConsumptionBudgetSubscriptionFilterNotTagList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermConsumptionBudgetSubscriptionFilterNotTagList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermConsumptionBudgetSubscription.DataAzurermConsumptionBudgetSubscriptionFilterNotTagList",
...
func NewDataAzurermConsumptionBudgetSubscriptionFilterNotTagList_Override(d DataAzurermConsumptionBudgetSubscriptionFilterNotTagList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermConsumptionBudgetSubscriptionFilterNotTagList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermConsumptionBudgetSubscriptionFilterNotTagList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermConsumptionBudgetSubscriptionFilterNotTagList) Resolve(context cdktn.IResolveContext) interface{} {
