...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/apimanagementidentityprovidermicrosoft/internal"
...
func (j *jsiiProxy_ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementIdentityProviderMicrosoftTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementIdentityProviderMicrosoftTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementIdentityProviderMicrosoft.ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference",
...
func NewApiManagementIdentityProviderMicrosoftTimeoutsOutputReference_Override(a ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
