...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/api_management_identity_provider_microsoft azurerm_api_management_identity_provider_microsoft} Resource.
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoft) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoft) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiManagementIdentityProviderMicrosoft) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
