...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/frontdoorfirewallpolicy/internal"
...
func (j *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference {
	_init_.Initialize()

	if err := validateNewFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.frontdoorFirewallPolicy.FrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference",
...
func NewFrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference_Override(f FrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideExclusionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
