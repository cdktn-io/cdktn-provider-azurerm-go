...
func (j *jsiiProxy_FrontdoorFirewallPolicyManagedRuleExclusionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorFirewallPolicyManagedRuleExclusionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FrontdoorFirewallPolicyManagedRuleExclusionOutputReference {
	_init_.Initialize()
...
func NewFrontdoorFirewallPolicyManagedRuleExclusionOutputReference_Override(f FrontdoorFirewallPolicyManagedRuleExclusionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorFirewallPolicyManagedRuleExclusionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleExclusionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleExclusionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleExclusionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleExclusionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
