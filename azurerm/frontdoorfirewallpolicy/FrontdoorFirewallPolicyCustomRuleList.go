...
func (j *jsiiProxy_FrontdoorFirewallPolicyCustomRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorFirewallPolicyCustomRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorFirewallPolicyCustomRuleList {
	_init_.Initialize()

	if err := validateNewFrontdoorFirewallPolicyCustomRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_FrontdoorFirewallPolicyCustomRuleList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.frontdoorFirewallPolicy.FrontdoorFirewallPolicyCustomRuleList",
...
func NewFrontdoorFirewallPolicyCustomRuleList_Override(f FrontdoorFirewallPolicyCustomRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorFirewallPolicyCustomRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyCustomRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyCustomRuleList) Resolve(context cdktn.IResolveContext) interface{} {
