...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideExclusionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideExclusionList) Resolve(context cdktf.IResolveContext) interface{} {
