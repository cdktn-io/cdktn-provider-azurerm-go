...
func (j *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.frontdoorFirewallPolicy.FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference",
...
func NewFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference_Override(f FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
