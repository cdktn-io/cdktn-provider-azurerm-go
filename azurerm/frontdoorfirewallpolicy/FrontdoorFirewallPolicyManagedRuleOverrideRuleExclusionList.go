...
func (j *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList {
	_init_.Initialize()
...
func NewFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList_Override(f FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionList) Resolve(context cdktn.IResolveContext) interface{} {
