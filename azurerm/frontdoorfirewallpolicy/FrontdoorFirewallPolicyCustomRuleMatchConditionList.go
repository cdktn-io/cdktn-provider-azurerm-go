...
func (j *jsiiProxy_FrontdoorFirewallPolicyCustomRuleMatchConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorFirewallPolicyCustomRuleMatchConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorFirewallPolicyCustomRuleMatchConditionList {
	_init_.Initialize()
...
func NewFrontdoorFirewallPolicyCustomRuleMatchConditionList_Override(f FrontdoorFirewallPolicyCustomRuleMatchConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorFirewallPolicyCustomRuleMatchConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyCustomRuleMatchConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyCustomRuleMatchConditionList) Resolve(context cdktn.IResolveContext) interface{} {
