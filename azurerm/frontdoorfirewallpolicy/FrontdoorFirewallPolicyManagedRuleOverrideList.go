...
func (j *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrontdoorFirewallPolicyManagedRuleOverrideList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FrontdoorFirewallPolicyManagedRuleOverrideList {
	_init_.Initialize()

	if err := validateNewFrontdoorFirewallPolicyManagedRuleOverrideListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.frontdoorFirewallPolicy.FrontdoorFirewallPolicyManagedRuleOverrideList",
...
func NewFrontdoorFirewallPolicyManagedRuleOverrideList_Override(f FrontdoorFirewallPolicyManagedRuleOverrideList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideList) Resolve(context cdktn.IResolveContext) interface{} {
