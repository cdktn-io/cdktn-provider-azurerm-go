...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleOverrideList) Resolve(context cdktf.IResolveContext) interface{} {
