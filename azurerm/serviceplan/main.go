...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "premiumPlanAutoScaleEnabled", GoGetter: "PremiumPlanAutoScaleEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "premiumPlanAutoScaleEnabledInput", GoGetter: "PremiumPlanAutoScaleEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPremiumPlanAutoScaleEnabled", GoMethod: "ResetPremiumPlanAutoScaleEnabled"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.servicePlan.ServicePlanConfig",
		reflect.TypeOf((*ServicePlanConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.servicePlan.ServicePlanTimeouts",
