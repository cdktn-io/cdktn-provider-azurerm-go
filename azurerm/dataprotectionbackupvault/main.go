...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRetentionDurationInDays", GoMethod: "ResetRetentionDurationInDays"},
			_jsii_.MemberMethod{JsiiMethod: "resetSoftDelete", GoMethod: "ResetSoftDelete"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupName", GoGetter: "ResourceGroupName"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupNameInput", GoGetter: "ResourceGroupNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "retentionDurationInDays", GoGetter: "RetentionDurationInDays"},
			_jsii_.MemberProperty{JsiiProperty: "retentionDurationInDaysInput", GoGetter: "RetentionDurationInDaysInput"},
			_jsii_.MemberProperty{JsiiProperty: "softDelete", GoGetter: "SoftDelete"},
			_jsii_.MemberProperty{JsiiProperty: "softDeleteInput", GoGetter: "SoftDeleteInput"},
