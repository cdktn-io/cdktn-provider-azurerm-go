...
func (j *jsiiProxy_OrchestratedVirtualMachineScaleSetExtensionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewOrchestratedVirtualMachineScaleSetExtensionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OrchestratedVirtualMachineScaleSetExtensionList {
	_init_.Initialize()

	if err := validateNewOrchestratedVirtualMachineScaleSetExtensionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewOrchestratedVirtualMachineScaleSetExtensionList_Override(o OrchestratedVirtualMachineScaleSetExtensionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_OrchestratedVirtualMachineScaleSetExtensionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetExtensionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetExtensionList) Resolve(context cdktn.IResolveContext) interface{} {
