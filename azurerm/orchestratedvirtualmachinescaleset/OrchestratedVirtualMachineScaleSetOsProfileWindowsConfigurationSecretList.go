...
func (j *jsiiProxy_OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecretList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewOrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecretList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecretList {
	_init_.Initialize()

	if err := validateNewOrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecretListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewOrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecretList_Override(o OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecretList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecretList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecretList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecretList) Resolve(context cdktn.IResolveContext) interface{} {
