...
func (j *jsiiProxy_OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewOrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKeyList {
	_init_.Initialize()

	if err := validateNewOrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKeyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewOrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKeyList_Override(o OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationAdminSshKeyList) Resolve(context cdktn.IResolveContext) interface{} {
