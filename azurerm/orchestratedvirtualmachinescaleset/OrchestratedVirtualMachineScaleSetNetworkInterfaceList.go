...
func (j *jsiiProxy_OrchestratedVirtualMachineScaleSetNetworkInterfaceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewOrchestratedVirtualMachineScaleSetNetworkInterfaceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OrchestratedVirtualMachineScaleSetNetworkInterfaceList {
	_init_.Initialize()

	if err := validateNewOrchestratedVirtualMachineScaleSetNetworkInterfaceListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewOrchestratedVirtualMachineScaleSetNetworkInterfaceList_Override(o OrchestratedVirtualMachineScaleSetNetworkInterfaceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_OrchestratedVirtualMachineScaleSetNetworkInterfaceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetNetworkInterfaceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetNetworkInterfaceList) Resolve(context cdktn.IResolveContext) interface{} {
