...
type DataAzurermKubernetesAutomaticClusterConfig struct {
	// Experimental.
	...
	Timeouts *DataAzurermKubernetesAutomaticClusterTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
