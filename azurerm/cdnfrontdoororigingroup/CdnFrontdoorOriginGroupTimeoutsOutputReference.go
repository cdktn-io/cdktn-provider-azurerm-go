...
func (c *jsiiProxy_CdnFrontdoorOriginGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorOriginGroupTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
