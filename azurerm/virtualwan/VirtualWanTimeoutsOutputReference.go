...
func (v *jsiiProxy_VirtualWanTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualWanTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
