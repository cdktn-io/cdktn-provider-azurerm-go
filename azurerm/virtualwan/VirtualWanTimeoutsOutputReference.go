...
func (j *jsiiProxy_VirtualWanTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualWanTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VirtualWanTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewVirtualWanTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewVirtualWanTimeoutsOutputReference_Override(v VirtualWanTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualWanTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualWanTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualWanTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualWanTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualWanTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
