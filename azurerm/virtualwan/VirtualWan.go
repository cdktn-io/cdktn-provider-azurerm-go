...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/virtualwan/internal"
...
func (j *jsiiProxy_VirtualWan) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VirtualWan) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VirtualWan) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VirtualWan) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VirtualWan) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VirtualWan) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/virtual_wan azurerm_virtual_wan} Resource.
func NewVirtualWan(scope constructs.Construct, id *string, config *VirtualWanConfig) VirtualWan {
	_init_.Initialize()

	if err := validateNewVirtualWanParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_VirtualWan)SetAllowBranchToBranchTraffic(val interface{}) {
	if err := j.validateSetAllowBranchToBranchTrafficParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VirtualWan)SetCount(val interface{}) {
...
func (j *jsiiProxy_VirtualWan)SetDisableVpnEncryption(val interface{}) {
	if err := j.validateSetDisableVpnEncryptionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VirtualWan)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VirtualWan)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VirtualWan)SetOffice365LocalBreakoutCategory(val *string) {
	if err := j.validateSetOffice365LocalBreakoutCategoryParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VirtualWan)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VirtualWan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateVirtualWan_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VirtualWan_IsConstruct(x interface{}) *bool {
	...
	if err := validateVirtualWan_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VirtualWan_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVirtualWan_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VirtualWan_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVirtualWan_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VirtualWan) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VirtualWan) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualWan) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VirtualWan) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VirtualWan) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualWan) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualWan) MoveFromId(id *string) {
...
func (v *jsiiProxy_VirtualWan) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VirtualWan) MoveToId(id *string) {
...
func (v *jsiiProxy_VirtualWan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VirtualWan) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VirtualWan) ToHclTerraform() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VirtualWan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
