...
func (j *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DashboardGrafanaManagedPrivateEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DashboardGrafanaManagedPrivateEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
