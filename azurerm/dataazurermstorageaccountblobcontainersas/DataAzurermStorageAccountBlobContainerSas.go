...
func (j *jsiiProxy_DataAzurermStorageAccountBlobContainerSas) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermStorageAccountBlobContainerSas) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermStorageAccountBlobContainerSas) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermStorageAccountBlobContainerSas) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermStorageAccountBlobContainerSas) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAzurermStorageAccountBlobContainerSas)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermStorageAccountBlobContainerSas)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermStorageAccountBlobContainerSas)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermStorageAccountBlobContainerSas_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermStorageAccountBlobContainerSas) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermStorageAccountBlobContainerSas) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermStorageAccountBlobContainerSas) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermStorageAccountBlobContainerSas) ResetPermissions() {
	_jsii_.InvokeVoid(
		d,
		"resetPermissions",
		nil, // no parameters
...
func (d *jsiiProxy_DataAzurermStorageAccountBlobContainerSas) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
