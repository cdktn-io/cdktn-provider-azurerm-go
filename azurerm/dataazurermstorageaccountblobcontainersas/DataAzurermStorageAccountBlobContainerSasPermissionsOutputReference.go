...
func (d *jsiiProxy_DataAzurermStorageAccountBlobContainerSasPermissionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermStorageAccountBlobContainerSasPermissionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
