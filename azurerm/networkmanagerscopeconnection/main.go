...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "targetScopeId", GoGetter: "TargetScopeId"},
			_jsii_.MemberProperty{JsiiProperty: "targetScopeIdInput", GoGetter: "TargetScopeIdInput"},
