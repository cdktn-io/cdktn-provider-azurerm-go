...
func (j *jsiiProxy_OracleAutonomousDatabaseCloneFromBackup) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_OracleAutonomousDatabaseCloneFromBackup) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_OracleAutonomousDatabaseCloneFromBackup) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OracleAutonomousDatabaseCloneFromBackup) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_OracleAutonomousDatabaseCloneFromBackup) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_OracleAutonomousDatabaseCloneFromBackup)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OracleAutonomousDatabaseCloneFromBackup)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OracleAutonomousDatabaseCloneFromBackup)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OracleAutonomousDatabaseCloneFromBackup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OracleAutonomousDatabaseCloneFromBackup) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OracleAutonomousDatabaseCloneFromBackup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OracleAutonomousDatabaseCloneFromBackup) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
