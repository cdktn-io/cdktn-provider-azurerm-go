...
func (i *jsiiProxy_IothubEndpointEventhubTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubEndpointEventhubTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
