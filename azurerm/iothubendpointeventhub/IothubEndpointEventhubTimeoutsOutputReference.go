...
func (j *jsiiProxy_IothubEndpointEventhubTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIothubEndpointEventhubTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) IothubEndpointEventhubTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewIothubEndpointEventhubTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_IothubEndpointEventhubTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.iothubEndpointEventhub.IothubEndpointEventhubTimeoutsOutputReference",
...
func NewIothubEndpointEventhubTimeoutsOutputReference_Override(i IothubEndpointEventhubTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IothubEndpointEventhubTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IothubEndpointEventhubTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubEndpointEventhubTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_IothubEndpointEventhubTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubEndpointEventhubTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
