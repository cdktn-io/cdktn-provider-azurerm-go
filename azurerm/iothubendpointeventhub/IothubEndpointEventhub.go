...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/iothubendpointeventhub/internal"
...
func (j *jsiiProxy_IothubEndpointEventhub) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IothubEndpointEventhub) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IothubEndpointEventhub) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IothubEndpointEventhub) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IothubEndpointEventhub) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IothubEndpointEventhub) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/iothub_endpoint_eventhub azurerm_iothub_endpoint_eventhub} Resource.
...
func (j *jsiiProxy_IothubEndpointEventhub)SetCount(val interface{}) {
...
func (j *jsiiProxy_IothubEndpointEventhub)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IothubEndpointEventhub)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IothubEndpointEventhub)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IothubEndpointEventhub_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIothubEndpointEventhub_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IothubEndpointEventhub) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IothubEndpointEventhub) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubEndpointEventhub) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IothubEndpointEventhub) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IothubEndpointEventhub) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubEndpointEventhub) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IothubEndpointEventhub) MoveFromId(id *string) {
...
func (i *jsiiProxy_IothubEndpointEventhub) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IothubEndpointEventhub) MoveToId(id *string) {
...
func (i *jsiiProxy_IothubEndpointEventhub) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IothubEndpointEventhub) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IothubEndpointEventhub) ToHclTerraform() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IothubEndpointEventhub) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
