...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "consistencyType", GoGetter: "ConsistencyType"},
			_jsii_.MemberProperty{JsiiProperty: "consistencyTypeInput", GoGetter: "ConsistencyTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetConsistencyType", GoMethod: "ResetConsistencyType"},
