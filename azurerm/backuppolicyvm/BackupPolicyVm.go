...
func (j *jsiiProxy_BackupPolicyVm) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BackupPolicyVm) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BackupPolicyVm) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BackupPolicyVm) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BackupPolicyVm) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/backup_policy_vm azurerm_backup_policy_vm} Resource.
...
func (j *jsiiProxy_BackupPolicyVm)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupPolicyVm)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BackupPolicyVm)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BackupPolicyVm_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BackupPolicyVm) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVm) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BackupPolicyVm) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVm) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupPolicyVm) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BackupPolicyVm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
