...
func (b *jsiiProxy_BackupPolicyVmTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
