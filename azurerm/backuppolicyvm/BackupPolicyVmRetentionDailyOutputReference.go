...
func (b *jsiiProxy_BackupPolicyVmRetentionDailyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmRetentionDailyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
