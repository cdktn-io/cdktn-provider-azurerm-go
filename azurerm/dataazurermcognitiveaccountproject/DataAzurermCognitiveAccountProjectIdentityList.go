...
func (j *jsiiProxy_DataAzurermCognitiveAccountProjectIdentityList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermCognitiveAccountProjectIdentityList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermCognitiveAccountProjectIdentityList {
	_init_.Initialize()
...
func NewDataAzurermCognitiveAccountProjectIdentityList_Override(d DataAzurermCognitiveAccountProjectIdentityList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermCognitiveAccountProjectIdentityList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermCognitiveAccountProjectIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermCognitiveAccountProjectIdentityList) Resolve(context cdktf.IResolveContext) interface{} {
