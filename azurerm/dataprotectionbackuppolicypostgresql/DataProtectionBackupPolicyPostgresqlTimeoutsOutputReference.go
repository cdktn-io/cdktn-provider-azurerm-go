...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/dataprotectionbackuppolicypostgresql/internal"
...
func (j *jsiiProxy_DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataProtectionBackupPolicyPostgresqlTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDataProtectionBackupPolicyPostgresqlTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataProtectionBackupPolicyPostgresql.DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference",
...
func NewDataProtectionBackupPolicyPostgresqlTimeoutsOutputReference_Override(d DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
