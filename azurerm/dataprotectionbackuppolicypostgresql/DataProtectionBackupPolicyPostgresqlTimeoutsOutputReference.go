...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/dataprotectionbackuppolicypostgresql/internal"
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
