...
func (j *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataProtectionBackupPolicyPostgresqlRetentionRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataProtectionBackupPolicyPostgresqlRetentionRuleOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataProtectionBackupPolicyPostgresql.DataProtectionBackupPolicyPostgresqlRetentionRuleOutputReference",
...
func NewDataProtectionBackupPolicyPostgresqlRetentionRuleOutputReference_Override(d DataProtectionBackupPolicyPostgresqlRetentionRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
