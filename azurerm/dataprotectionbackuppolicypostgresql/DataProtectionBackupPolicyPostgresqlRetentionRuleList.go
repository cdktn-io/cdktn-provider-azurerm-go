...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleList) Resolve(context cdktf.IResolveContext) interface{} {
