...
func (j *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataProtectionBackupPolicyPostgresqlRetentionRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataProtectionBackupPolicyPostgresqlRetentionRuleList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataProtectionBackupPolicyPostgresql.DataProtectionBackupPolicyPostgresqlRetentionRuleList",
...
func NewDataProtectionBackupPolicyPostgresqlRetentionRuleList_Override(d DataProtectionBackupPolicyPostgresqlRetentionRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleList) Resolve(context cdktn.IResolveContext) interface{} {
