...
func (d *jsiiProxy_DataAzurermWindowsWebAppLogsHttpLogsFileSystemList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppLogsHttpLogsFileSystemList) Resolve(context cdktf.IResolveContext) interface{} {
