...
func (d *jsiiProxy_DataAzurermWindowsWebAppSiteConfigAutoHealSettingActionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppSiteConfigAutoHealSettingActionList) Resolve(context cdktf.IResolveContext) interface{} {
