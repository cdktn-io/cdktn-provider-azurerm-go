...
func (d *jsiiProxy_DataAzurermWindowsWebAppSiteConfigAutoHealSettingActionCustomActionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppSiteConfigAutoHealSettingActionCustomActionList) Resolve(context cdktf.IResolveContext) interface{} {
