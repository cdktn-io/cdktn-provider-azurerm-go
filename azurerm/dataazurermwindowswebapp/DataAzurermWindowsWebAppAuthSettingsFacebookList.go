...
func (j *jsiiProxy_DataAzurermWindowsWebAppAuthSettingsFacebookList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermWindowsWebAppAuthSettingsFacebookList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermWindowsWebAppAuthSettingsFacebookList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermWindowsWebApp.DataAzurermWindowsWebAppAuthSettingsFacebookList",
...
func NewDataAzurermWindowsWebAppAuthSettingsFacebookList_Override(d DataAzurermWindowsWebAppAuthSettingsFacebookList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermWindowsWebAppAuthSettingsFacebookList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppAuthSettingsFacebookList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppAuthSettingsFacebookList) Resolve(context cdktn.IResolveContext) interface{} {
