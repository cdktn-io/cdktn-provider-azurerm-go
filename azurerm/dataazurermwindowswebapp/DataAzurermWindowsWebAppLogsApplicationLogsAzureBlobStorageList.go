...
func (j *jsiiProxy_DataAzurermWindowsWebAppLogsApplicationLogsAzureBlobStorageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermWindowsWebAppLogsApplicationLogsAzureBlobStorageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermWindowsWebAppLogsApplicationLogsAzureBlobStorageList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermWindowsWebApp.DataAzurermWindowsWebAppLogsApplicationLogsAzureBlobStorageList",
...
func NewDataAzurermWindowsWebAppLogsApplicationLogsAzureBlobStorageList_Override(d DataAzurermWindowsWebAppLogsApplicationLogsAzureBlobStorageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermWindowsWebAppLogsApplicationLogsAzureBlobStorageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppLogsApplicationLogsAzureBlobStorageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppLogsApplicationLogsAzureBlobStorageList) Resolve(context cdktn.IResolveContext) interface{} {
