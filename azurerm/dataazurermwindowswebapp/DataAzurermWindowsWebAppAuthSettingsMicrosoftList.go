...
func (d *jsiiProxy_DataAzurermWindowsWebAppAuthSettingsMicrosoftList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppAuthSettingsMicrosoftList) Resolve(context cdktf.IResolveContext) interface{} {
