...
func (d *jsiiProxy_DataAzurermWindowsWebAppStickySettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppStickySettingsList) Resolve(context cdktf.IResolveContext) interface{} {
