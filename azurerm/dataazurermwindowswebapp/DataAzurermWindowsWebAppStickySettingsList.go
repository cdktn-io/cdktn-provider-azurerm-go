...
func (j *jsiiProxy_DataAzurermWindowsWebAppStickySettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermWindowsWebAppStickySettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermWindowsWebAppStickySettingsList {
	_init_.Initialize()
...
func NewDataAzurermWindowsWebAppStickySettingsList_Override(d DataAzurermWindowsWebAppStickySettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermWindowsWebAppStickySettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppStickySettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppStickySettingsList) Resolve(context cdktn.IResolveContext) interface{} {
