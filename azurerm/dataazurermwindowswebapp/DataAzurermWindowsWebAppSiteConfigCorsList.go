...
func (j *jsiiProxy_DataAzurermWindowsWebAppSiteConfigCorsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermWindowsWebAppSiteConfigCorsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermWindowsWebAppSiteConfigCorsList {
	_init_.Initialize()
...
func NewDataAzurermWindowsWebAppSiteConfigCorsList_Override(d DataAzurermWindowsWebAppSiteConfigCorsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermWindowsWebAppSiteConfigCorsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppSiteConfigCorsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppSiteConfigCorsList) Resolve(context cdktn.IResolveContext) interface{} {
