...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allocatedOutboundPorts", GoGetter: "AllocatedOutboundPorts"},
			_jsii_.MemberProperty{JsiiProperty: "allocatedOutboundPortsInput", GoGetter: "AllocatedOutboundPortsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAllocatedOutboundPorts", GoMethod: "ResetAllocatedOutboundPorts"},
