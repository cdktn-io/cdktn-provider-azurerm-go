...
func (j *jsiiProxy_BotChannelDirectline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BotChannelDirectline) ExtensionKey1() *string {
	var returns *string
	_jsii_.Get(
		j,
		"extensionKey1",
...
func (j *jsiiProxy_BotChannelDirectline) ExtensionKey2() *string {
	var returns *string
	_jsii_.Get(
		j,
		"extensionKey2",
...
func (j *jsiiProxy_BotChannelDirectline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BotChannelDirectline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BotChannelDirectline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BotChannelDirectline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BotChannelDirectline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BotChannelDirectline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BotChannelDirectline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BotChannelDirectline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BotChannelDirectline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelDirectline) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BotChannelDirectline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelDirectline) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BotChannelDirectline) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BotChannelDirectline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
