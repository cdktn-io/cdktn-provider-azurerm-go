...
func (j *jsiiProxy_BotChannelDirectlineSiteList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBotChannelDirectlineSiteList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BotChannelDirectlineSiteList {
	_init_.Initialize()
...
func NewBotChannelDirectlineSiteList_Override(b BotChannelDirectlineSiteList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BotChannelDirectlineSiteList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BotChannelDirectlineSiteList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BotChannelDirectlineSiteList) Resolve(context cdktn.IResolveContext) interface{} {
