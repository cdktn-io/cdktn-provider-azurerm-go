...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeSelfHostedRbacAuthorizationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeSelfHostedRbacAuthorizationList) Resolve(context cdktf.IResolveContext) interface{} {
