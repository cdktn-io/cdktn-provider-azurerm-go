...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "monitorMetricsAfterDuration", GoGetter: "MonitorMetricsAfterDuration"},
			_jsii_.MemberProperty{JsiiProperty: "monitorMetricsAfterDurationInput", GoGetter: "MonitorMetricsAfterDurationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMonitorMetricsAfterDuration", GoMethod: "ResetMonitorMetricsAfterDuration"},
