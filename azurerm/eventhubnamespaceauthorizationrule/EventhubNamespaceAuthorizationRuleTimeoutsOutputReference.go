...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/eventhubnamespaceauthorizationrule/internal"
...
func (j *jsiiProxy_EventhubNamespaceAuthorizationRuleTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEventhubNamespaceAuthorizationRuleTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) EventhubNamespaceAuthorizationRuleTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewEventhubNamespaceAuthorizationRuleTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_EventhubNamespaceAuthorizationRuleTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.eventhubNamespaceAuthorizationRule.EventhubNamespaceAuthorizationRuleTimeoutsOutputReference",
...
func NewEventhubNamespaceAuthorizationRuleTimeoutsOutputReference_Override(e EventhubNamespaceAuthorizationRuleTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_EventhubNamespaceAuthorizationRuleTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EventhubNamespaceAuthorizationRuleTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventhubNamespaceAuthorizationRuleTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EventhubNamespaceAuthorizationRuleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventhubNamespaceAuthorizationRuleTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
