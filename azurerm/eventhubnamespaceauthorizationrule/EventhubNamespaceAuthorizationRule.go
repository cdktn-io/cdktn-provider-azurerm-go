...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/eventhub_namespace_authorization_rule azurerm_eventhub_namespace_authorization_rule} Resource.
...
func (e *jsiiProxy_EventhubNamespaceAuthorizationRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EventhubNamespaceAuthorizationRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EventhubNamespaceAuthorizationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
