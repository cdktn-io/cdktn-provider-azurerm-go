...
func (m *jsiiProxy_MssqlManagedInstanceFailoverGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MssqlManagedInstanceFailoverGroupTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
