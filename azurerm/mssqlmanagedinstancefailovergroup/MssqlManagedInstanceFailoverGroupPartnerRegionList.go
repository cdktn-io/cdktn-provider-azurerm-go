...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/mssqlmanagedinstancefailovergroup/internal"
...
func (j *jsiiProxy_MssqlManagedInstanceFailoverGroupPartnerRegionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMssqlManagedInstanceFailoverGroupPartnerRegionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MssqlManagedInstanceFailoverGroupPartnerRegionList {
	_init_.Initialize()
...
func NewMssqlManagedInstanceFailoverGroupPartnerRegionList_Override(m MssqlManagedInstanceFailoverGroupPartnerRegionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MssqlManagedInstanceFailoverGroupPartnerRegionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MssqlManagedInstanceFailoverGroupPartnerRegionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MssqlManagedInstanceFailoverGroupPartnerRegionList) Resolve(context cdktn.IResolveContext) interface{} {
