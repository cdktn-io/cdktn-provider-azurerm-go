...
func (j *jsiiProxy_ServiceFabricClusterNodeTypeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricClusterNodeTypeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceFabricClusterNodeTypeList {
	_init_.Initialize()

	if err := validateNewServiceFabricClusterNodeTypeListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewServiceFabricClusterNodeTypeList_Override(s ServiceFabricClusterNodeTypeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricClusterNodeTypeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricClusterNodeTypeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricClusterNodeTypeList) Resolve(context cdktn.IResolveContext) interface{} {
