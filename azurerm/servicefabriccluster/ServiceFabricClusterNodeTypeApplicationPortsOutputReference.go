...
func (j *jsiiProxy_ServiceFabricClusterNodeTypeApplicationPortsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricClusterNodeTypeApplicationPortsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ServiceFabricClusterNodeTypeApplicationPortsOutputReference {
	_init_.Initialize()
...
func NewServiceFabricClusterNodeTypeApplicationPortsOutputReference_Override(s ServiceFabricClusterNodeTypeApplicationPortsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricClusterNodeTypeApplicationPortsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricClusterNodeTypeApplicationPortsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterNodeTypeApplicationPortsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceFabricClusterNodeTypeApplicationPortsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterNodeTypeApplicationPortsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
