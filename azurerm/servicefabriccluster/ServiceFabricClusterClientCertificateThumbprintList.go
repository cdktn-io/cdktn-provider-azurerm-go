...
func (j *jsiiProxy_ServiceFabricClusterClientCertificateThumbprintList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricClusterClientCertificateThumbprintList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceFabricClusterClientCertificateThumbprintList {
	_init_.Initialize()

	if err := validateNewServiceFabricClusterClientCertificateThumbprintListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewServiceFabricClusterClientCertificateThumbprintList_Override(s ServiceFabricClusterClientCertificateThumbprintList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricClusterClientCertificateThumbprintList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricClusterClientCertificateThumbprintList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricClusterClientCertificateThumbprintList) Resolve(context cdktn.IResolveContext) interface{} {
