...
func (s *jsiiProxy_ServiceFabricClusterClientCertificateThumbprintList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricClusterClientCertificateThumbprintList) Resolve(context cdktf.IResolveContext) interface{} {
