...
func (j *jsiiProxy_ServiceFabricClusterNodeTypeEphemeralPortsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricClusterNodeTypeEphemeralPortsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ServiceFabricClusterNodeTypeEphemeralPortsOutputReference {
	_init_.Initialize()
...
func NewServiceFabricClusterNodeTypeEphemeralPortsOutputReference_Override(s ServiceFabricClusterNodeTypeEphemeralPortsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricClusterNodeTypeEphemeralPortsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricClusterNodeTypeEphemeralPortsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterNodeTypeEphemeralPortsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceFabricClusterNodeTypeEphemeralPortsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterNodeTypeEphemeralPortsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
