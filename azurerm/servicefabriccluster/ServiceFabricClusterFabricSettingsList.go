...
func (j *jsiiProxy_ServiceFabricClusterFabricSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricClusterFabricSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceFabricClusterFabricSettingsList {
	_init_.Initialize()
...
func NewServiceFabricClusterFabricSettingsList_Override(s ServiceFabricClusterFabricSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricClusterFabricSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricClusterFabricSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricClusterFabricSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
