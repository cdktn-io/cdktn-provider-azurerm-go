...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesList) Resolve(context cdktf.IResolveContext) interface{} {
