...
func (j *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricClusterCertificateCommonNamesCommonNamesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceFabricClusterCertificateCommonNamesCommonNamesList {
	_init_.Initialize()

	if err := validateNewServiceFabricClusterCertificateCommonNamesCommonNamesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewServiceFabricClusterCertificateCommonNamesCommonNamesList_Override(s ServiceFabricClusterCertificateCommonNamesCommonNamesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesList) Resolve(context cdktn.IResolveContext) interface{} {
