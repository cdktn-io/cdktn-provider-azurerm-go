...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/servicefabriccluster/internal"
...
func (j *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricClusterCertificateCommonNamesCommonNamesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ServiceFabricClusterCertificateCommonNamesCommonNamesOutputReference {
	_init_.Initialize()

	if err := validateNewServiceFabricClusterCertificateCommonNamesCommonNamesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewServiceFabricClusterCertificateCommonNamesCommonNamesOutputReference_Override(s ServiceFabricClusterCertificateCommonNamesCommonNamesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesCommonNamesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
