...
func (j *jsiiProxy_ServiceFabricCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ServiceFabricCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ServiceFabricCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServiceFabricCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ServiceFabricCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ServiceFabricCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServiceFabricCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServiceFabricCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ServiceFabricCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_ServiceFabricCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_ServiceFabricCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServiceFabricCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServiceFabricCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
