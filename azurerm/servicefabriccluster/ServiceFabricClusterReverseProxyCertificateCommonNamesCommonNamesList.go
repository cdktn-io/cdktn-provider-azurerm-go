...
func (j *jsiiProxy_ServiceFabricClusterReverseProxyCertificateCommonNamesCommonNamesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricClusterReverseProxyCertificateCommonNamesCommonNamesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServiceFabricClusterReverseProxyCertificateCommonNamesCommonNamesList {
	_init_.Initialize()

	if err := validateNewServiceFabricClusterReverseProxyCertificateCommonNamesCommonNamesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewServiceFabricClusterReverseProxyCertificateCommonNamesCommonNamesList_Override(s ServiceFabricClusterReverseProxyCertificateCommonNamesCommonNamesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricClusterReverseProxyCertificateCommonNamesCommonNamesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricClusterReverseProxyCertificateCommonNamesCommonNamesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceFabricClusterReverseProxyCertificateCommonNamesCommonNamesList) Resolve(context cdktn.IResolveContext) interface{} {
