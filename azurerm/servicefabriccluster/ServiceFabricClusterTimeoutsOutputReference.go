...
func (s *jsiiProxy_ServiceFabricClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
