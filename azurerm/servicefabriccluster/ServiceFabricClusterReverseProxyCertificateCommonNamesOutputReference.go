...
func (s *jsiiProxy_ServiceFabricClusterReverseProxyCertificateCommonNamesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterReverseProxyCertificateCommonNamesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
