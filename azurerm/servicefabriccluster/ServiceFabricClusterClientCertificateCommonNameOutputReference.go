...
func (j *jsiiProxy_ServiceFabricClusterClientCertificateCommonNameOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricClusterClientCertificateCommonNameOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ServiceFabricClusterClientCertificateCommonNameOutputReference {
	_init_.Initialize()
...
func NewServiceFabricClusterClientCertificateCommonNameOutputReference_Override(s ServiceFabricClusterClientCertificateCommonNameOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricClusterClientCertificateCommonNameOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricClusterClientCertificateCommonNameOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterClientCertificateCommonNameOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceFabricClusterClientCertificateCommonNameOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterClientCertificateCommonNameOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
