...
func (j *jsiiProxy_ServiceFabricClusterFabricSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricClusterFabricSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ServiceFabricClusterFabricSettingsOutputReference {
	_init_.Initialize()

	if err := validateNewServiceFabricClusterFabricSettingsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewServiceFabricClusterFabricSettingsOutputReference_Override(s ServiceFabricClusterFabricSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricClusterFabricSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricClusterFabricSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterFabricSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceFabricClusterFabricSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterFabricSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
