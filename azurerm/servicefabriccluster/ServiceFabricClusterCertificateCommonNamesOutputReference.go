...
func (j *jsiiProxy_ServiceFabricClusterCertificateCommonNamesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceFabricClusterCertificateCommonNamesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ServiceFabricClusterCertificateCommonNamesOutputReference {
	_init_.Initialize()
...
func NewServiceFabricClusterCertificateCommonNamesOutputReference_Override(s ServiceFabricClusterCertificateCommonNamesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceFabricClusterCertificateCommonNamesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceFabricClusterCertificateCommonNamesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
