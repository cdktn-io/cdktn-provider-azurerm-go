...
func (v *jsiiProxy_VpnServerConfigurationAzureActiveDirectoryAuthenticationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationAzureActiveDirectoryAuthenticationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
