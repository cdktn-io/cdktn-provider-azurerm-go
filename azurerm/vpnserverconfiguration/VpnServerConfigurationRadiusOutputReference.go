...
func (v *jsiiProxy_VpnServerConfigurationRadiusOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationRadiusOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
