...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/vpn_server_configuration azurerm_vpn_server_configuration} Resource.
...
func (v *jsiiProxy_VpnServerConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpnServerConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpnServerConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
