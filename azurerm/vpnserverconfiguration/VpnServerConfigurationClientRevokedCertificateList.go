...
func (j *jsiiProxy_VpnServerConfigurationClientRevokedCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnServerConfigurationClientRevokedCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpnServerConfigurationClientRevokedCertificateList {
	_init_.Initialize()

	if err := validateNewVpnServerConfigurationClientRevokedCertificateListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewVpnServerConfigurationClientRevokedCertificateList_Override(v VpnServerConfigurationClientRevokedCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnServerConfigurationClientRevokedCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnServerConfigurationClientRevokedCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpnServerConfigurationClientRevokedCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
