...
func (j *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnServerConfigurationRadiusServerRootCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpnServerConfigurationRadiusServerRootCertificateList {
	_init_.Initialize()
...
func NewVpnServerConfigurationRadiusServerRootCertificateList_Override(v VpnServerConfigurationRadiusServerRootCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
