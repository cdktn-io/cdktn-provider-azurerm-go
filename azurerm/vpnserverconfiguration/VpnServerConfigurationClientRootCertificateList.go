...
func (j *jsiiProxy_VpnServerConfigurationClientRootCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnServerConfigurationClientRootCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpnServerConfigurationClientRootCertificateList {
	_init_.Initialize()
...
func NewVpnServerConfigurationClientRootCertificateList_Override(v VpnServerConfigurationClientRootCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnServerConfigurationClientRootCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnServerConfigurationClientRootCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpnServerConfigurationClientRootCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
