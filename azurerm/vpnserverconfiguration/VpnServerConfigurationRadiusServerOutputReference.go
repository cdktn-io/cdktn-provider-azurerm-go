...
func (j *jsiiProxy_VpnServerConfigurationRadiusServerOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnServerConfigurationRadiusServerOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VpnServerConfigurationRadiusServerOutputReference {
	_init_.Initialize()

	if err := validateNewVpnServerConfigurationRadiusServerOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewVpnServerConfigurationRadiusServerOutputReference_Override(v VpnServerConfigurationRadiusServerOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnServerConfigurationRadiusServerOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
