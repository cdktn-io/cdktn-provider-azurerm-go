...
func (v *jsiiProxy_VpnServerConfigurationRadiusClientRootCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationRadiusClientRootCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
