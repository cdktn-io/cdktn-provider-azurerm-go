...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/vpnserverconfiguration/internal"
...
func (j *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnServerConfigurationRadiusServerRootCertificateOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VpnServerConfigurationRadiusServerRootCertificateOutputReference {
	_init_.Initialize()

	if err := validateNewVpnServerConfigurationRadiusServerRootCertificateOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewVpnServerConfigurationRadiusServerRootCertificateOutputReference_Override(v VpnServerConfigurationRadiusServerRootCertificateOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
