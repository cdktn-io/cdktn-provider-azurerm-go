...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationRadiusServerRootCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
