...
func (j *jsiiProxy_LbBackendAddressPoolAddressInboundNatRulePortMappingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLbBackendAddressPoolAddressInboundNatRulePortMappingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LbBackendAddressPoolAddressInboundNatRulePortMappingList {
	_init_.Initialize()
...
func NewLbBackendAddressPoolAddressInboundNatRulePortMappingList_Override(l LbBackendAddressPoolAddressInboundNatRulePortMappingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LbBackendAddressPoolAddressInboundNatRulePortMappingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LbBackendAddressPoolAddressInboundNatRulePortMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LbBackendAddressPoolAddressInboundNatRulePortMappingList) Resolve(context cdktn.IResolveContext) interface{} {
