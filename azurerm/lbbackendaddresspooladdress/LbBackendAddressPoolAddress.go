...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/lbbackendaddresspooladdress/internal"
...
func (j *jsiiProxy_LbBackendAddressPoolAddress) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LbBackendAddressPoolAddress) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LbBackendAddressPoolAddress) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LbBackendAddressPoolAddress) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LbBackendAddressPoolAddress) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LbBackendAddressPoolAddress) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/lb_backend_address_pool_address azurerm_lb_backend_address_pool_address} Resource.
func NewLbBackendAddressPoolAddress(scope constructs.Construct, id *string, config *LbBackendAddressPoolAddressConfig) LbBackendAddressPoolAddress {
	...
	if err := validateNewLbBackendAddressPoolAddressParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_LbBackendAddressPoolAddress{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.lbBackendAddressPoolAddress.LbBackendAddressPoolAddress",
...
func (j *jsiiProxy_LbBackendAddressPoolAddress)SetCount(val interface{}) {
...
func (j *jsiiProxy_LbBackendAddressPoolAddress)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LbBackendAddressPoolAddress)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LbBackendAddressPoolAddress)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LbBackendAddressPoolAddress_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateLbBackendAddressPoolAddress_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LbBackendAddressPoolAddress_IsConstruct(x interface{}) *bool {
	...
	if err := validateLbBackendAddressPoolAddress_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LbBackendAddressPoolAddress_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLbBackendAddressPoolAddress_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LbBackendAddressPoolAddress_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLbBackendAddressPoolAddress_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) MoveFromId(id *string) {
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) MoveToId(id *string) {
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) ToHclTerraform() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LbBackendAddressPoolAddress) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
