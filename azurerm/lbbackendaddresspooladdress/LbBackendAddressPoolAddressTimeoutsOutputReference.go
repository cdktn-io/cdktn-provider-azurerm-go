...
func (l *jsiiProxy_LbBackendAddressPoolAddressTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbBackendAddressPoolAddressTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
