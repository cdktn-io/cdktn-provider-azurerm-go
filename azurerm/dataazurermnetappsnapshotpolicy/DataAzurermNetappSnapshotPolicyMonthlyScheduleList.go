...
func (d *jsiiProxy_DataAzurermNetappSnapshotPolicyMonthlyScheduleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermNetappSnapshotPolicyMonthlyScheduleList) Resolve(context cdktf.IResolveContext) interface{} {
