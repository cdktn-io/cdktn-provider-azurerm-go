...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/synapseworkspacesecurityalertpolicy/internal"
...
func (j *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewSynapseWorkspaceSecurityAlertPolicy(scope constructs.Construct, id *string, config *SynapseWorkspaceSecurityAlertPolicyConfig) SynapseWorkspaceSecurityAlertPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.synapseWorkspaceSecurityAlertPolicy.SynapseWorkspaceSecurityAlertPolicy",
...
func (j *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SynapseWorkspaceSecurityAlertPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
