...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetShortTermRetentionDays", GoMethod: "ResetShortTermRetentionDays"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "shortTermRetentionDays", GoGetter: "ShortTermRetentionDays"},
			_jsii_.MemberProperty{JsiiProperty: "shortTermRetentionDaysInput", GoGetter: "ShortTermRetentionDaysInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "immutableBackupsEnabled", GoGetter: "ImmutableBackupsEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "immutableBackupsEnabledInput", GoGetter: "ImmutableBackupsEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetImmutableBackupsEnabled", GoMethod: "ResetImmutableBackupsEnabled"},
