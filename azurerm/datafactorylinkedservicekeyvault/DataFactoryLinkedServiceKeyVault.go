...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/datafactorylinkedservicekeyvault/internal"
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataFactoryLinkedServiceKeyVault(scope constructs.Construct, id *string, config *DataFactoryLinkedServiceKeyVaultConfig) DataFactoryLinkedServiceKeyVault {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryLinkedServiceKeyVault.DataFactoryLinkedServiceKeyVault",
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataFactoryLinkedServiceKeyVault)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataFactoryLinkedServiceKeyVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVault) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVault) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVault) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
