...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApiManagementEmailTemplate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.apiManagementEmailTemplate.ApiManagementEmailTemplateConfig",
		reflect.TypeOf((*ApiManagementEmailTemplateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.apiManagementEmailTemplate.ApiManagementEmailTemplateTimeouts",
		reflect.TypeOf((*ApiManagementEmailTemplateTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azurerm.apiManagementEmailTemplate.ApiManagementEmailTemplateTimeoutsOutputReference",
		reflect.TypeOf((*ApiManagementEmailTemplateTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_ApiManagementEmailTemplateTimeoutsOutputReference{}
