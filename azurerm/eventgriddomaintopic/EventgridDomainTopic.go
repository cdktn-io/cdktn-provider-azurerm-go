...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/eventgriddomaintopic/internal"
...
func (j *jsiiProxy_EventgridDomainTopic) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EventgridDomainTopic) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EventgridDomainTopic) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EventgridDomainTopic) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EventgridDomainTopic) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/eventgrid_domain_topic azurerm_eventgrid_domain_topic} Resource.
func NewEventgridDomainTopic(scope constructs.Construct, id *string, config *EventgridDomainTopicConfig) EventgridDomainTopic {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.eventgridDomainTopic.EventgridDomainTopic",
...
func (j *jsiiProxy_EventgridDomainTopic)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EventgridDomainTopic)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EventgridDomainTopic)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EventgridDomainTopic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EventgridDomainTopic) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridDomainTopic) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EventgridDomainTopic) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridDomainTopic) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EventgridDomainTopic) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
