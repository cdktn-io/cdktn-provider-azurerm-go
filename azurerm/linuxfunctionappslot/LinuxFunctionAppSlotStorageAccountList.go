...
func (j *jsiiProxy_LinuxFunctionAppSlotStorageAccountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxFunctionAppSlotStorageAccountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxFunctionAppSlotStorageAccountList {
	_init_.Initialize()
...
func NewLinuxFunctionAppSlotStorageAccountList_Override(l LinuxFunctionAppSlotStorageAccountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxFunctionAppSlotStorageAccountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxFunctionAppSlotStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxFunctionAppSlotStorageAccountList) Resolve(context cdktn.IResolveContext) interface{} {
