...
func (l *jsiiProxy_LinuxFunctionAppSlotSiteConfigAppServiceLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppSlotSiteConfigAppServiceLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
