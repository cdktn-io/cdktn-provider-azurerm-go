...
func (j *jsiiProxy_LinuxFunctionAppSlot) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LinuxFunctionAppSlot) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LinuxFunctionAppSlot) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LinuxFunctionAppSlot) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LinuxFunctionAppSlot) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LinuxFunctionAppSlot)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LinuxFunctionAppSlot)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LinuxFunctionAppSlot)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LinuxFunctionAppSlot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LinuxFunctionAppSlot) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppSlot) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LinuxFunctionAppSlot) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppSlot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LinuxFunctionAppSlot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LinuxFunctionAppSlot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
