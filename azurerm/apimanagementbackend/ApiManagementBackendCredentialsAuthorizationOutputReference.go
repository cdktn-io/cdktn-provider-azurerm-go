...
func (a *jsiiProxy_ApiManagementBackendCredentialsAuthorizationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementBackendCredentialsAuthorizationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
