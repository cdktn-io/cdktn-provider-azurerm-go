...
func (a *jsiiProxy_ApiManagementBackendCircuitBreakerRuleFailureConditionStatusCodeRangeList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ApiManagementBackendCircuitBreakerRuleFailureConditionStatusCodeRangeList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewApiManagementBackendCircuitBreakerRuleFailureConditionStatusCodeRangeListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
