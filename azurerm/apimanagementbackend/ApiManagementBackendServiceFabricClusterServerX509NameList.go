...
func (j *jsiiProxy_ApiManagementBackendServiceFabricClusterServerX509NameList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementBackendServiceFabricClusterServerX509NameList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementBackendServiceFabricClusterServerX509NameList {
	_init_.Initialize()
...
func NewApiManagementBackendServiceFabricClusterServerX509NameList_Override(a ApiManagementBackendServiceFabricClusterServerX509NameList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementBackendServiceFabricClusterServerX509NameList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementBackendServiceFabricClusterServerX509NameList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementBackendServiceFabricClusterServerX509NameList) Resolve(context cdktn.IResolveContext) interface{} {
