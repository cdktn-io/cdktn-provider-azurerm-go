...
func (a *jsiiProxy_ApiManagementBackendTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementBackendTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
