...
func (j *jsiiProxy_ApiManagementBackendTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementBackendTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ApiManagementBackendTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementBackendTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewApiManagementBackendTimeoutsOutputReference_Override(a ApiManagementBackendTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementBackendTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementBackendTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementBackendTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementBackendTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementBackendTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
