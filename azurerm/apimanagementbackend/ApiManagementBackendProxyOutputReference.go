...
func (j *jsiiProxy_ApiManagementBackendProxyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementBackendProxyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ApiManagementBackendProxyOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementBackendProxyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewApiManagementBackendProxyOutputReference_Override(a ApiManagementBackendProxyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementBackendProxyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementBackendProxyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementBackendProxyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementBackendProxyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementBackendProxyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
