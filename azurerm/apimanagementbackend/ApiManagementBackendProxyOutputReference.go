...
func (a *jsiiProxy_ApiManagementBackendProxyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementBackendProxyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
