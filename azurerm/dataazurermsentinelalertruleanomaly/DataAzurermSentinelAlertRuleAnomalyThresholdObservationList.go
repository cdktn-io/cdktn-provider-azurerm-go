...
func (d *jsiiProxy_DataAzurermSentinelAlertRuleAnomalyThresholdObservationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermSentinelAlertRuleAnomalyThresholdObservationList) Resolve(context cdktf.IResolveContext) interface{} {
