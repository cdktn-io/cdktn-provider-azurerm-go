...
func (j *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup) Automatic() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup) Restorable() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"restorable",
...
func (j *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAzurermOracleAutonomousDatabaseBackup(scope constructs.Construct, id *string, config *DataAzurermOracleAutonomousDatabaseBackupConfig) DataAzurermOracleAutonomousDatabaseBackup {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermOracleAutonomousDatabaseBackup.DataAzurermOracleAutonomousDatabaseBackup",
...
func (j *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermOracleAutonomousDatabaseBackup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermOracleAutonomousDatabaseBackup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
