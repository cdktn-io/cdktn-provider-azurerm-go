...
func (s *jsiiProxy_SubscriptionPolicyRemediationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SubscriptionPolicyRemediationTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
