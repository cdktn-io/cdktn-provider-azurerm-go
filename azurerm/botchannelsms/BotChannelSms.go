...
func (j *jsiiProxy_BotChannelSms) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BotChannelSms) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BotChannelSms) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BotChannelSms) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BotChannelSms) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BotChannelSms)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BotChannelSms)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BotChannelSms)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BotChannelSms_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BotChannelSms) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelSms) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BotChannelSms) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelSms) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BotChannelSms) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BotChannelSms) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
