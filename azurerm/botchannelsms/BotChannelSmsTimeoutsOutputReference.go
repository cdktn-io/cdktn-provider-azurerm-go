...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/botchannelsms/internal"
...
func (j *jsiiProxy_BotChannelSmsTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBotChannelSmsTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BotChannelSmsTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewBotChannelSmsTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_BotChannelSmsTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.botChannelSms.BotChannelSmsTimeoutsOutputReference",
...
func NewBotChannelSmsTimeoutsOutputReference_Override(b BotChannelSmsTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BotChannelSmsTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BotChannelSmsTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelSmsTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BotChannelSmsTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelSmsTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
