...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/botchannelsms/internal"
...
func (b *jsiiProxy_BotChannelSmsTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BotChannelSmsTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
