...
func (j *jsiiProxy_NetworkConnectionMonitorEndpointList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkConnectionMonitorEndpointList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkConnectionMonitorEndpointList {
	_init_.Initialize()
...
func NewNetworkConnectionMonitorEndpointList_Override(n NetworkConnectionMonitorEndpointList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkConnectionMonitorEndpointList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointList) Resolve(context cdktn.IResolveContext) interface{} {
