...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/networkconnectionmonitor/internal"
...
func (j *jsiiProxy_NetworkConnectionMonitorTestGroupOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkConnectionMonitorTestGroupOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) NetworkConnectionMonitorTestGroupOutputReference {
	_init_.Initialize()

	if err := validateNewNetworkConnectionMonitorTestGroupOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewNetworkConnectionMonitorTestGroupOutputReference_Override(n NetworkConnectionMonitorTestGroupOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkConnectionMonitorTestGroupOutputReference)SetDestinationEndpoints(val *[]*string) {
	if err := j.validateSetDestinationEndpointsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_NetworkConnectionMonitorTestGroupOutputReference)SetSourceEndpoints(val *[]*string) {
	if err := j.validateSetSourceEndpointsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_NetworkConnectionMonitorTestGroupOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_NetworkConnectionMonitorTestGroupOutputReference)SetTestConfigurationNames(val *[]*string) {
	if err := j.validateSetTestConfigurationNamesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (n *jsiiProxy_NetworkConnectionMonitorTestGroupOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkConnectionMonitorTestGroupOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetworkConnectionMonitorTestGroupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkConnectionMonitorTestGroupOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
