...
func (j *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkConnectionMonitorEndpointFilterItemList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkConnectionMonitorEndpointFilterItemList {
	_init_.Initialize()

	if err := validateNewNetworkConnectionMonitorEndpointFilterItemListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewNetworkConnectionMonitorEndpointFilterItemList_Override(n NetworkConnectionMonitorEndpointFilterItemList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemList) Resolve(context cdktn.IResolveContext) interface{} {
