...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemList) Resolve(context cdktf.IResolveContext) interface{} {
