...
func (j *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkConnectionMonitorEndpointFilterItemOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) NetworkConnectionMonitorEndpointFilterItemOutputReference {
	_init_.Initialize()

	if err := validateNewNetworkConnectionMonitorEndpointFilterItemOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewNetworkConnectionMonitorEndpointFilterItemOutputReference_Override(n NetworkConnectionMonitorEndpointFilterItemOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointFilterItemOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
