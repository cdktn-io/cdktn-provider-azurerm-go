...
func (n *jsiiProxy_NetworkConnectionMonitorTestConfigurationSuccessThresholdOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkConnectionMonitorTestConfigurationSuccessThresholdOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
