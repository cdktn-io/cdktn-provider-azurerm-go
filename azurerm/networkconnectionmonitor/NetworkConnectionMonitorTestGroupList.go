...
func (j *jsiiProxy_NetworkConnectionMonitorTestGroupList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkConnectionMonitorTestGroupList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkConnectionMonitorTestGroupList {
	_init_.Initialize()

	if err := validateNewNetworkConnectionMonitorTestGroupListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewNetworkConnectionMonitorTestGroupList_Override(n NetworkConnectionMonitorTestGroupList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkConnectionMonitorTestGroupList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkConnectionMonitorTestGroupList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkConnectionMonitorTestGroupList) Resolve(context cdktn.IResolveContext) interface{} {
