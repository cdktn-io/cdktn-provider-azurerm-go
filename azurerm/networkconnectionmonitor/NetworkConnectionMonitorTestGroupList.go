...
func (n *jsiiProxy_NetworkConnectionMonitorTestGroupList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkConnectionMonitorTestGroupList) Resolve(context cdktf.IResolveContext) interface{} {
