...
func (j *jsiiProxy_NetworkConnectionMonitorTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkConnectionMonitorTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) NetworkConnectionMonitorTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewNetworkConnectionMonitorTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewNetworkConnectionMonitorTimeoutsOutputReference_Override(n NetworkConnectionMonitorTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkConnectionMonitorTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkConnectionMonitorTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkConnectionMonitorTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetworkConnectionMonitorTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkConnectionMonitorTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
