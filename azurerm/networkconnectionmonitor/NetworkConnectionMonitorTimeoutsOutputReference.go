...
func (n *jsiiProxy_NetworkConnectionMonitorTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkConnectionMonitorTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
