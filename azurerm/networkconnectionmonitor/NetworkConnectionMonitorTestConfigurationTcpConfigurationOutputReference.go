...
func (n *jsiiProxy_NetworkConnectionMonitorTestConfigurationTcpConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkConnectionMonitorTestConfigurationTcpConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
