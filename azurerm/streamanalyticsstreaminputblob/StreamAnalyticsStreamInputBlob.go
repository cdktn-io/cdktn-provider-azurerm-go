...
func (j *jsiiProxy_StreamAnalyticsStreamInputBlob) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StreamAnalyticsStreamInputBlob) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StreamAnalyticsStreamInputBlob) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StreamAnalyticsStreamInputBlob) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StreamAnalyticsStreamInputBlob) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/stream_analytics_stream_input_blob azurerm_stream_analytics_stream_input_blob} Resource.
func NewStreamAnalyticsStreamInputBlob(scope constructs.Construct, id *string, config *StreamAnalyticsStreamInputBlobConfig) StreamAnalyticsStreamInputBlob {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.streamAnalyticsStreamInputBlob.StreamAnalyticsStreamInputBlob",
...
func (j *jsiiProxy_StreamAnalyticsStreamInputBlob)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StreamAnalyticsStreamInputBlob)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StreamAnalyticsStreamInputBlob)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StreamAnalyticsStreamInputBlob_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StreamAnalyticsStreamInputBlob) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputBlob) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputBlob) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputBlob) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputBlob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputBlob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
