...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionMonitorConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionMonitorConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
