...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/monitoralertprocessingruleactiongroup/internal"
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.monitorAlertProcessingRuleActionGroup.MonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference",
...
func NewMonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference_Override(m MonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionTargetResourceGroupOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
