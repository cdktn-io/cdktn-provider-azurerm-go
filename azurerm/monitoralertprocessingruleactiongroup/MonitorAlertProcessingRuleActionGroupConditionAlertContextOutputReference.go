...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionAlertContextOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionAlertContextOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
