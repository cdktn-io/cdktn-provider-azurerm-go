...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionAlertRuleIdOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionAlertRuleIdOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
