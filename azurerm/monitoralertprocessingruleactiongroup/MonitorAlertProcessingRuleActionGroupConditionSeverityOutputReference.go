...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorAlertProcessingRuleActionGroupConditionSeverityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference_Override(m MonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
