...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionSeverityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
