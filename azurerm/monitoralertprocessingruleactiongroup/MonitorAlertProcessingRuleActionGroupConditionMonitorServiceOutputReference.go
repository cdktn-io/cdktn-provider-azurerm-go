...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionMonitorServiceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionMonitorServiceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
