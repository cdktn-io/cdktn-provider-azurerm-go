...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroupTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAlertProcessingRuleActionGroupTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MonitorAlertProcessingRuleActionGroupTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorAlertProcessingRuleActionGroupTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMonitorAlertProcessingRuleActionGroupTimeoutsOutputReference_Override(m MonitorAlertProcessingRuleActionGroupTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroupTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
