...
func MonitorAlertProcessingRuleActionGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
