...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroup) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewMonitorAlertProcessingRuleActionGroup(scope constructs.Construct, id *string, config *MonitorAlertProcessingRuleActionGroupConfig) MonitorAlertProcessingRuleActionGroup {
	...
	if err := validateNewMonitorAlertProcessingRuleActionGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroup)SetAddActionGroupIds(val *[]*string) {
	if err := j.validateSetAddActionGroupIdsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroup)SetCount(val interface{}) {
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MonitorAlertProcessingRuleActionGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateMonitorAlertProcessingRuleActionGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MonitorAlertProcessingRuleActionGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateMonitorAlertProcessingRuleActionGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MonitorAlertProcessingRuleActionGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMonitorAlertProcessingRuleActionGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MonitorAlertProcessingRuleActionGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMonitorAlertProcessingRuleActionGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) MoveFromId(id *string) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) MoveToId(id *string) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
