...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroupScheduleRecurrenceDailyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAlertProcessingRuleActionGroupScheduleRecurrenceDailyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorAlertProcessingRuleActionGroupScheduleRecurrenceDailyList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.monitorAlertProcessingRuleActionGroup.MonitorAlertProcessingRuleActionGroupScheduleRecurrenceDailyList",
...
func NewMonitorAlertProcessingRuleActionGroupScheduleRecurrenceDailyList_Override(m MonitorAlertProcessingRuleActionGroupScheduleRecurrenceDailyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroupScheduleRecurrenceDailyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupScheduleRecurrenceDailyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupScheduleRecurrenceDailyList) Resolve(context cdktn.IResolveContext) interface{} {
