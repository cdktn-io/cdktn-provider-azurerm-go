...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroupScheduleRecurrenceWeeklyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorAlertProcessingRuleActionGroupScheduleRecurrenceWeeklyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorAlertProcessingRuleActionGroupScheduleRecurrenceWeeklyList {
	_init_.Initialize()

	if err := validateNewMonitorAlertProcessingRuleActionGroupScheduleRecurrenceWeeklyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_MonitorAlertProcessingRuleActionGroupScheduleRecurrenceWeeklyList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.monitorAlertProcessingRuleActionGroup.MonitorAlertProcessingRuleActionGroupScheduleRecurrenceWeeklyList",
...
func NewMonitorAlertProcessingRuleActionGroupScheduleRecurrenceWeeklyList_Override(m MonitorAlertProcessingRuleActionGroupScheduleRecurrenceWeeklyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorAlertProcessingRuleActionGroupScheduleRecurrenceWeeklyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupScheduleRecurrenceWeeklyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupScheduleRecurrenceWeeklyList) Resolve(context cdktn.IResolveContext) interface{} {
