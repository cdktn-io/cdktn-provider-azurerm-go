...
func (j *jsiiProxy_DataAzurermManagedRedisAccessPolicyAssignment) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataAzurermManagedRedisAccessPolicyAssignment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermManagedRedisAccessPolicyAssignment) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermManagedRedisAccessPolicyAssignment) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermManagedRedisAccessPolicyAssignment) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAzurermManagedRedisAccessPolicyAssignment)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermManagedRedisAccessPolicyAssignment)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermManagedRedisAccessPolicyAssignment)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermManagedRedisAccessPolicyAssignment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermManagedRedisAccessPolicyAssignment) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermManagedRedisAccessPolicyAssignment) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
