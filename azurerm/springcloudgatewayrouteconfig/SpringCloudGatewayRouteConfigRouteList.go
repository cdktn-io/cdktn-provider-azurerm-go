...
func (j *jsiiProxy_SpringCloudGatewayRouteConfigRouteList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudGatewayRouteConfigRouteList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SpringCloudGatewayRouteConfigRouteList {
	_init_.Initialize()

	if err := validateNewSpringCloudGatewayRouteConfigRouteListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_SpringCloudGatewayRouteConfigRouteList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.springCloudGatewayRouteConfig.SpringCloudGatewayRouteConfigRouteList",
...
func NewSpringCloudGatewayRouteConfigRouteList_Override(s SpringCloudGatewayRouteConfigRouteList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfigRouteList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigRouteList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigRouteList) Resolve(context cdktn.IResolveContext) interface{} {
