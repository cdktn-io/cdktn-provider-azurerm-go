...
func (j *jsiiProxy_SpringCloudGatewayRouteConfigOpenApiOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudGatewayRouteConfigOpenApiOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SpringCloudGatewayRouteConfigOpenApiOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.springCloudGatewayRouteConfig.SpringCloudGatewayRouteConfigOpenApiOutputReference",
...
func NewSpringCloudGatewayRouteConfigOpenApiOutputReference_Override(s SpringCloudGatewayRouteConfigOpenApiOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfigOpenApiOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigOpenApiOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigOpenApiOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigOpenApiOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigOpenApiOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
