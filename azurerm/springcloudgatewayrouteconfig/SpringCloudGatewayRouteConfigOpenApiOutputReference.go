...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigOpenApiOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigOpenApiOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
