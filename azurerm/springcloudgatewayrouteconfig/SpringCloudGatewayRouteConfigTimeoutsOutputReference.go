...
func (j *jsiiProxy_SpringCloudGatewayRouteConfigTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudGatewayRouteConfigTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SpringCloudGatewayRouteConfigTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSpringCloudGatewayRouteConfigTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SpringCloudGatewayRouteConfigTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.springCloudGatewayRouteConfig.SpringCloudGatewayRouteConfigTimeoutsOutputReference",
...
func NewSpringCloudGatewayRouteConfigTimeoutsOutputReference_Override(s SpringCloudGatewayRouteConfigTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfigTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfigTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
