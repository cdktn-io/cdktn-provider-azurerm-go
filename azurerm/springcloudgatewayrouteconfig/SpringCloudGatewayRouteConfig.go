...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/springcloudgatewayrouteconfig/internal"
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfig) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfig)SetCount(val interface{}) {
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SpringCloudGatewayRouteConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SpringCloudGatewayRouteConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSpringCloudGatewayRouteConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) MoveFromId(id *string) {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) MoveToId(id *string) {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SpringCloudGatewayRouteConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
