...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "storageFileshareId", GoGetter: "StorageFileshareId"},
			_jsii_.MemberProperty{JsiiProperty: "storageFileshareIdInput", GoGetter: "StorageFileshareIdInput"},
