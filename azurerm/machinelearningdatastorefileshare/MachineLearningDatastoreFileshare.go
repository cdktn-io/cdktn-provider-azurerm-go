...
func (m *jsiiProxy_MachineLearningDatastoreFileshare) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MachineLearningDatastoreFileshare) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MachineLearningDatastoreFileshare) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MachineLearningDatastoreFileshare) MoveFromId(id *string) {
...
func (m *jsiiProxy_MachineLearningDatastoreFileshare) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MachineLearningDatastoreFileshare) MoveToId(id *string) {
...
func (m *jsiiProxy_MachineLearningDatastoreFileshare) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MachineLearningDatastoreFileshare) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MachineLearningDatastoreFileshare) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MachineLearningDatastoreFileshare) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
