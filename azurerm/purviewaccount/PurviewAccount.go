...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/purviewaccount/internal"
...
func (j *jsiiProxy_PurviewAccount) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PurviewAccount) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_PurviewAccount) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PurviewAccount) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PurviewAccount) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PurviewAccount) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/purview_account azurerm_purview_account} Resource.
func NewPurviewAccount(scope constructs.Construct, id *string, config *PurviewAccountConfig) PurviewAccount {
	_init_.Initialize()

	if err := validateNewPurviewAccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_PurviewAccount)SetCount(val interface{}) {
...
func (j *jsiiProxy_PurviewAccount)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PurviewAccount)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PurviewAccount)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PurviewAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validatePurviewAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func PurviewAccount_IsConstruct(x interface{}) *bool {
	...
	if err := validatePurviewAccount_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func PurviewAccount_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePurviewAccount_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func PurviewAccount_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validatePurviewAccount_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PurviewAccount) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PurviewAccount) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PurviewAccount) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PurviewAccount) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PurviewAccount) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PurviewAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PurviewAccount) MoveFromId(id *string) {
...
func (p *jsiiProxy_PurviewAccount) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PurviewAccount) MoveToId(id *string) {
...
func (p *jsiiProxy_PurviewAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PurviewAccount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PurviewAccount) ToHclTerraform() interface{} {
	var returns interface{}
