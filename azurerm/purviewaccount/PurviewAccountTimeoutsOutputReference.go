...
func (p *jsiiProxy_PurviewAccountTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PurviewAccountTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
