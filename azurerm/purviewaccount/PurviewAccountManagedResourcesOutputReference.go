...
func (p *jsiiProxy_PurviewAccountManagedResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PurviewAccountManagedResourcesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
