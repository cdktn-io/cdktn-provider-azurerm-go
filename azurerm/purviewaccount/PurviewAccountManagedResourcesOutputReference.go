...
func (j *jsiiProxy_PurviewAccountManagedResourcesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPurviewAccountManagedResourcesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PurviewAccountManagedResourcesOutputReference {
	_init_.Initialize()

	if err := validateNewPurviewAccountManagedResourcesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewPurviewAccountManagedResourcesOutputReference_Override(p PurviewAccountManagedResourcesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PurviewAccountManagedResourcesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PurviewAccountManagedResourcesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PurviewAccountManagedResourcesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PurviewAccountManagedResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PurviewAccountManagedResourcesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
