...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "managedEventHubEnabled", GoGetter: "ManagedEventHubEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "managedEventHubEnabledInput", GoGetter: "ManagedEventHubEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetManagedEventHubEnabled", GoMethod: "ResetManagedEventHubEnabled"},
