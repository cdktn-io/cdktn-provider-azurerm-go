...
func (j *jsiiProxy_PurviewAccountManagedResourcesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPurviewAccountManagedResourcesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PurviewAccountManagedResourcesList {
	_init_.Initialize()
...
func NewPurviewAccountManagedResourcesList_Override(p PurviewAccountManagedResourcesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PurviewAccountManagedResourcesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PurviewAccountManagedResourcesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PurviewAccountManagedResourcesList) Resolve(context cdktn.IResolveContext) interface{} {
