...
func (j *jsiiProxy_StorageAccountCustomerManagedKeyA) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StorageAccountCustomerManagedKeyA) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StorageAccountCustomerManagedKeyA) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StorageAccountCustomerManagedKeyA) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/storage_account_customer_managed_key azurerm_storage_account_customer_managed_key} Resource.
...
func (j *jsiiProxy_StorageAccountCustomerManagedKeyA)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StorageAccountCustomerManagedKeyA)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StorageAccountCustomerManagedKeyA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateStorageAccountCustomerManagedKeyA_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) MoveFromId(id *string) {
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) MoveToId(id *string) {
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyA) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
