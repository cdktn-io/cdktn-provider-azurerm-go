...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "federatedIdentityClientId", GoGetter: "FederatedIdentityClientId"},
			_jsii_.MemberProperty{JsiiProperty: "federatedIdentityClientIdInput", GoGetter: "FederatedIdentityClientIdInput"},
