...
func (j *jsiiProxy_MssqlServer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MssqlServer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MssqlServer) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MssqlServer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MssqlServer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/mssql_server azurerm_mssql_server} Resource.
...
func (j *jsiiProxy_MssqlServer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MssqlServer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MssqlServer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MssqlServer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MssqlServer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlServer) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MssqlServer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlServer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MssqlServer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MssqlServer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
