...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "authenticationFailureMode", GoGetter: "AuthenticationFailureMode"},
			_jsii_.MemberProperty{JsiiProperty: "authenticationFailureModeInput", GoGetter: "AuthenticationFailureModeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "customerManagedKeyEnforcementEnabled", GoGetter: "CustomerManagedKeyEnforcementEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "customerManagedKeyEnforcementEnabledInput", GoGetter: "CustomerManagedKeyEnforcementEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "hostingMode", GoGetter: "HostingMode"},
			_jsii_.MemberProperty{JsiiProperty: "hostingModeInput", GoGetter: "HostingModeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAuthenticationFailureMode", GoMethod: "ResetAuthenticationFailureMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetCustomerManagedKeyEnforcementEnabled", GoMethod: "ResetCustomerManagedKeyEnforcementEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetHostingMode", GoMethod: "ResetHostingMode"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSemanticSearchSku", GoMethod: "ResetSemanticSearchSku"},
			...
			_jsii_.MemberProperty{JsiiProperty: "semanticSearchSku", GoGetter: "SemanticSearchSku"},
			_jsii_.MemberProperty{JsiiProperty: "semanticSearchSkuInput", GoGetter: "SemanticSearchSkuInput"},
