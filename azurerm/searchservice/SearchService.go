...
func (j *jsiiProxy_SearchService) Endpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpoint",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/search_service azurerm_search_service} Resource.
...
func (s *jsiiProxy_SearchService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SearchService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SearchService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
