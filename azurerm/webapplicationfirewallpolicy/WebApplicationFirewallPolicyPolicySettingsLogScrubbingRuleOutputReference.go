...
func (w *jsiiProxy_WebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
