...
func (j *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebApplicationFirewallPolicyManagedRulesManagedRuleSetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WebApplicationFirewallPolicyManagedRulesManagedRuleSetList {
	_init_.Initialize()
...
func NewWebApplicationFirewallPolicyManagedRulesManagedRuleSetList_Override(w WebApplicationFirewallPolicyManagedRulesManagedRuleSetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetList) Resolve(context cdktn.IResolveContext) interface{} {
