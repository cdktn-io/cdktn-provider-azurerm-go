...
func (w *jsiiProxy_WebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleList) Resolve(context cdktf.IResolveContext) interface{} {
