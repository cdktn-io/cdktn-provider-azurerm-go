...
func (j *jsiiProxy_WebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleList {
	_init_.Initialize()
...
func NewWebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleList_Override(w WebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyPolicySettingsLogScrubbingRuleList) Resolve(context cdktn.IResolveContext) interface{} {
