...
func (j *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebApplicationFirewallPolicyCustomRulesMatchConditionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WebApplicationFirewallPolicyCustomRulesMatchConditionsList {
	_init_.Initialize()
...
func NewWebApplicationFirewallPolicyCustomRulesMatchConditionsList_Override(w WebApplicationFirewallPolicyCustomRulesMatchConditionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsList) Resolve(context cdktn.IResolveContext) interface{} {
