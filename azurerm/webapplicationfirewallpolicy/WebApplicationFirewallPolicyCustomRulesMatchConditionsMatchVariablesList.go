...
func (j *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList {
	_init_.Initialize()
...
func NewWebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList_Override(w WebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList) Resolve(context cdktn.IResolveContext) interface{} {
