...
func (w *jsiiProxy_WebApplicationFirewallPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
