...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionList) Resolve(context cdktf.IResolveContext) interface{} {
