...
func (j *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebApplicationFirewallPolicyManagedRulesExclusionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WebApplicationFirewallPolicyManagedRulesExclusionList {
	_init_.Initialize()

	if err := validateNewWebApplicationFirewallPolicyManagedRulesExclusionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewWebApplicationFirewallPolicyManagedRulesExclusionList_Override(w WebApplicationFirewallPolicyManagedRulesExclusionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionList) Resolve(context cdktn.IResolveContext) interface{} {
