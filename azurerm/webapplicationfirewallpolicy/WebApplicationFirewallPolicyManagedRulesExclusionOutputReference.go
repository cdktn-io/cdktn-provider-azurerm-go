...
func (j *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebApplicationFirewallPolicyManagedRulesExclusionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WebApplicationFirewallPolicyManagedRulesExclusionOutputReference {
	_init_.Initialize()
...
func NewWebApplicationFirewallPolicyManagedRulesExclusionOutputReference_Override(w WebApplicationFirewallPolicyManagedRulesExclusionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
