...
func (j *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWebApplicationFirewallPolicyManagedRulesManagedRuleSetOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WebApplicationFirewallPolicyManagedRulesManagedRuleSetOutputReference {
	_init_.Initialize()
...
func NewWebApplicationFirewallPolicyManagedRulesManagedRuleSetOutputReference_Override(w WebApplicationFirewallPolicyManagedRulesManagedRuleSetOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
