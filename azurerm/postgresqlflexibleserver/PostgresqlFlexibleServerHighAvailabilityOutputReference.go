...
func (p *jsiiProxy_PostgresqlFlexibleServerHighAvailabilityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PostgresqlFlexibleServerHighAvailabilityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
