...
func (j *jsiiProxy_PostgresqlFlexibleServerHighAvailabilityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPostgresqlFlexibleServerHighAvailabilityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PostgresqlFlexibleServerHighAvailabilityOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.postgresqlFlexibleServer.PostgresqlFlexibleServerHighAvailabilityOutputReference",
...
func NewPostgresqlFlexibleServerHighAvailabilityOutputReference_Override(p PostgresqlFlexibleServerHighAvailabilityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PostgresqlFlexibleServerHighAvailabilityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PostgresqlFlexibleServerHighAvailabilityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PostgresqlFlexibleServerHighAvailabilityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PostgresqlFlexibleServerHighAvailabilityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PostgresqlFlexibleServerHighAvailabilityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
