...
func (j *jsiiProxy_PostgresqlFlexibleServer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PostgresqlFlexibleServer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PostgresqlFlexibleServer) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PostgresqlFlexibleServer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PostgresqlFlexibleServer) StorageIops() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"storageIops",
...
func (j *jsiiProxy_PostgresqlFlexibleServer) StorageIopsInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"storageIopsInput",
...
func (j *jsiiProxy_PostgresqlFlexibleServer) StorageThroughput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"storageThroughput",
...
func (j *jsiiProxy_PostgresqlFlexibleServer) StorageThroughputInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PostgresqlFlexibleServer) StorageType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageType",
...
func (j *jsiiProxy_PostgresqlFlexibleServer) StorageTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageTypeInput",
...
func (j *jsiiProxy_PostgresqlFlexibleServer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/postgresql_flexible_server azurerm_postgresql_flexible_server} Resource.
...
func (j *jsiiProxy_PostgresqlFlexibleServer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PostgresqlFlexibleServer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PostgresqlFlexibleServer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_PostgresqlFlexibleServer)SetStorageIops(val *float64) {
...
func (j *jsiiProxy_PostgresqlFlexibleServer)SetStorageThroughput(val *float64) {
...
func (j *jsiiProxy_PostgresqlFlexibleServer)SetStorageType(val *string) {
...
func PostgresqlFlexibleServer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PostgresqlFlexibleServer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PostgresqlFlexibleServer) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PostgresqlFlexibleServer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PostgresqlFlexibleServer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PostgresqlFlexibleServer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PostgresqlFlexibleServer) ResetStorageIops() {
	_jsii_.InvokeVoid(
		p,
		"resetStorageIops",
		nil, // no parameters
...
func (p *jsiiProxy_PostgresqlFlexibleServer) ResetStorageThroughput() {
	_jsii_.InvokeVoid(
		p,
		"resetStorageThroughput",
		nil, // no parameters
...
func (p *jsiiProxy_PostgresqlFlexibleServer) ResetStorageType() {
	_jsii_.InvokeVoid(
		p,
		"resetStorageType",
		nil, // no parameters
...
func (p *jsiiProxy_PostgresqlFlexibleServer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
