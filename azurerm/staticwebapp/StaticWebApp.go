...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/staticwebapp/internal"
...
func (s *jsiiProxy_StaticWebApp) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StaticWebApp) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StaticWebApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
