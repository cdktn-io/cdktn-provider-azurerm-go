...
func (j *jsiiProxy_RedisEnterpriseDatabaseTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedisEnterpriseDatabaseTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) RedisEnterpriseDatabaseTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewRedisEnterpriseDatabaseTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewRedisEnterpriseDatabaseTimeoutsOutputReference_Override(r RedisEnterpriseDatabaseTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedisEnterpriseDatabaseTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedisEnterpriseDatabaseTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedisEnterpriseDatabaseTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_RedisEnterpriseDatabaseTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedisEnterpriseDatabaseTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
