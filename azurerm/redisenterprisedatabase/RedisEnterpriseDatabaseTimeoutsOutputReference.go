...
func (r *jsiiProxy_RedisEnterpriseDatabaseTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedisEnterpriseDatabaseTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
