...
func (j *jsiiProxy_RedisEnterpriseDatabaseModuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedisEnterpriseDatabaseModuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedisEnterpriseDatabaseModuleList {
	_init_.Initialize()

	if err := validateNewRedisEnterpriseDatabaseModuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewRedisEnterpriseDatabaseModuleList_Override(r RedisEnterpriseDatabaseModuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedisEnterpriseDatabaseModuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedisEnterpriseDatabaseModuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedisEnterpriseDatabaseModuleList) Resolve(context cdktn.IResolveContext) interface{} {
