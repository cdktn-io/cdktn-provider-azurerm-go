...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/redisenterprisedatabase/internal"
...
func (j *jsiiProxy_RedisEnterpriseDatabase) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RedisEnterpriseDatabase) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RedisEnterpriseDatabase) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedisEnterpriseDatabase) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RedisEnterpriseDatabase) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/redis_enterprise_database azurerm_redis_enterprise_database} Resource.
...
func (j *jsiiProxy_RedisEnterpriseDatabase)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedisEnterpriseDatabase)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedisEnterpriseDatabase)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RedisEnterpriseDatabase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RedisEnterpriseDatabase) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedisEnterpriseDatabase) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RedisEnterpriseDatabase) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RedisEnterpriseDatabase) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RedisEnterpriseDatabase) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RedisEnterpriseDatabase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
