...
func (j *jsiiProxy_VirtualHubConnection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VirtualHubConnection) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VirtualHubConnection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VirtualHubConnection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VirtualHubConnection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VirtualHubConnection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewVirtualHubConnection(scope constructs.Construct, id *string, config *VirtualHubConnectionConfig) VirtualHubConnection {
	...
	if err := validateNewVirtualHubConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_VirtualHubConnection)SetCount(val interface{}) {
...
func (j *jsiiProxy_VirtualHubConnection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VirtualHubConnection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VirtualHubConnection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VirtualHubConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateVirtualHubConnection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VirtualHubConnection_IsConstruct(x interface{}) *bool {
	...
	if err := validateVirtualHubConnection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func VirtualHubConnection_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateVirtualHubConnection_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func VirtualHubConnection_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateVirtualHubConnection_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VirtualHubConnection) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VirtualHubConnection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualHubConnection) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VirtualHubConnection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VirtualHubConnection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualHubConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualHubConnection) MoveFromId(id *string) {
...
func (v *jsiiProxy_VirtualHubConnection) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VirtualHubConnection) MoveToId(id *string) {
...
func (v *jsiiProxy_VirtualHubConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VirtualHubConnection) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VirtualHubConnection) ToHclTerraform() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VirtualHubConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
