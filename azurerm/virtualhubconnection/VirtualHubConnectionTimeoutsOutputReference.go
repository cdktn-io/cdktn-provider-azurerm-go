...
func (v *jsiiProxy_VirtualHubConnectionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualHubConnectionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
