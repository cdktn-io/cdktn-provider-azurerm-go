...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putStaticVnetRoute", GoMethod: "PutStaticVnetRoute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetStaticVnetLocalRouteOverrideCriteria", GoMethod: "ResetStaticVnetLocalRouteOverrideCriteria"},
			_jsii_.MemberMethod{JsiiMethod: "resetStaticVnetPropagateStaticRoutesEnabled", GoMethod: "ResetStaticVnetPropagateStaticRoutesEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetStaticVnetRoute", GoMethod: "ResetStaticVnetRoute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "staticVnetLocalRouteOverrideCriteriaInput", GoGetter: "StaticVnetLocalRouteOverrideCriteriaInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "staticVnetPropagateStaticRoutesEnabledInput", GoGetter: "StaticVnetPropagateStaticRoutesEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "staticVnetRoute", GoGetter: "StaticVnetRoute"},
			_jsii_.MemberProperty{JsiiProperty: "staticVnetRouteInput", GoGetter: "StaticVnetRouteInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNextHopIpAddress", GoMethod: "ResetNextHopIpAddress"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
