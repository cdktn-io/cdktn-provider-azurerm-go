...
func (f *jsiiProxy_FunctionAppFunctionFileList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FunctionAppFunctionFileList) Resolve(context cdktf.IResolveContext) interface{} {
