...
func (j *jsiiProxy_FunctionAppFunctionFileList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppFunctionFileList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FunctionAppFunctionFileList {
	_init_.Initialize()

	if err := validateNewFunctionAppFunctionFileListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewFunctionAppFunctionFileList_Override(f FunctionAppFunctionFileList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppFunctionFileList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppFunctionFileList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FunctionAppFunctionFileList) Resolve(context cdktn.IResolveContext) interface{} {
