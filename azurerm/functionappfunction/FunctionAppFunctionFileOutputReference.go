...
func (j *jsiiProxy_FunctionAppFunctionFileOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionAppFunctionFileOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FunctionAppFunctionFileOutputReference {
	_init_.Initialize()
...
func NewFunctionAppFunctionFileOutputReference_Override(f FunctionAppFunctionFileOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionAppFunctionFileOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionAppFunctionFileOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppFunctionFileOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FunctionAppFunctionFileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppFunctionFileOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
