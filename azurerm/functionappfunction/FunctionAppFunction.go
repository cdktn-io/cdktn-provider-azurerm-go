...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/functionappfunction/internal"
...
func (j *jsiiProxy_FunctionAppFunction) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FunctionAppFunction) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_FunctionAppFunction) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FunctionAppFunction) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FunctionAppFunction) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FunctionAppFunction) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/function_app_function azurerm_function_app_function} Resource.
func NewFunctionAppFunction(scope constructs.Construct, id *string, config *FunctionAppFunctionConfig) FunctionAppFunction {
	_init_.Initialize()

	if err := validateNewFunctionAppFunctionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_FunctionAppFunction)SetCount(val interface{}) {
...
func (j *jsiiProxy_FunctionAppFunction)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FunctionAppFunction)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FunctionAppFunction)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_FunctionAppFunction)SetTestData(val *string) {
	if err := j.validateSetTestDataParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func FunctionAppFunction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateFunctionAppFunction_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func FunctionAppFunction_IsConstruct(x interface{}) *bool {
	...
	if err := validateFunctionAppFunction_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func FunctionAppFunction_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateFunctionAppFunction_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func FunctionAppFunction_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateFunctionAppFunction_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (f *jsiiProxy_FunctionAppFunction) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FunctionAppFunction) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppFunction) HasResourceMove() interface{} {
	var returns interface{}
...
func (f *jsiiProxy_FunctionAppFunction) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FunctionAppFunction) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionAppFunction) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FunctionAppFunction) MoveFromId(id *string) {
...
func (f *jsiiProxy_FunctionAppFunction) MoveTo(moveTarget *string, index interface{}) {
...
func (f *jsiiProxy_FunctionAppFunction) MoveToId(id *string) {
...
func (f *jsiiProxy_FunctionAppFunction) PutFile(value interface{}) {
	if err := f.validatePutFileParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		f,
...
func (f *jsiiProxy_FunctionAppFunction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FunctionAppFunction) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (f *jsiiProxy_FunctionAppFunction) ToHclTerraform() interface{} {
	var returns interface{}
...
func (f *jsiiProxy_FunctionAppFunction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
