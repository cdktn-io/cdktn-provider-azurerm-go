...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "configJsonInput", GoGetter: "ConfigJsonInput"},
			_jsii_.MemberProperty{JsiiProperty: "configUrl", GoGetter: "ConfigUrl"},
			...
			_jsii_.MemberProperty{JsiiProperty: "invocationUrl", GoGetter: "InvocationUrl"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTestData", GoMethod: "ResetTestData"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "scriptRootPathUrl", GoGetter: "ScriptRootPathUrl"},
			_jsii_.MemberProperty{JsiiProperty: "scriptUrl", GoGetter: "ScriptUrl"},
			_jsii_.MemberProperty{JsiiProperty: "secretsFileUrl", GoGetter: "SecretsFileUrl"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeAttributes", GoMethod: "SynthesizeAttributes"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeHclAttributes", GoMethod: "SynthesizeHclAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "terraformGeneratorMetadata", GoGetter: "TerraformGeneratorMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "terraformMetaArguments", GoGetter: "TerraformMetaArguments"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResourceType", GoGetter: "TerraformResourceType"},
			_jsii_.MemberProperty{JsiiProperty: "testData", GoGetter: "TestData"},
			_jsii_.MemberProperty{JsiiProperty: "testDataInput", GoGetter: "TestDataInput"},
			_jsii_.MemberProperty{JsiiProperty: "testDataUrl", GoGetter: "TestDataUrl"},
