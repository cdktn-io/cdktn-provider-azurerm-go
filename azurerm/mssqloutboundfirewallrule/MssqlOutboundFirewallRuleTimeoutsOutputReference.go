...
func (m *jsiiProxy_MssqlOutboundFirewallRuleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MssqlOutboundFirewallRuleTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
