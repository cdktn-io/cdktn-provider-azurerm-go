...
func (d *jsiiProxy_DataAzurermVirtualNetworkPeering) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermVirtualNetworkPeering) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
