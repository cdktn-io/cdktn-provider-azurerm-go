...
func (j *jsiiProxy_MssqlVirtualMachineAvailabilityGroupListenerMultiSubnetIpConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMssqlVirtualMachineAvailabilityGroupListenerMultiSubnetIpConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MssqlVirtualMachineAvailabilityGroupListenerMultiSubnetIpConfigurationList {
	_init_.Initialize()
...
func NewMssqlVirtualMachineAvailabilityGroupListenerMultiSubnetIpConfigurationList_Override(m MssqlVirtualMachineAvailabilityGroupListenerMultiSubnetIpConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MssqlVirtualMachineAvailabilityGroupListenerMultiSubnetIpConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MssqlVirtualMachineAvailabilityGroupListenerMultiSubnetIpConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MssqlVirtualMachineAvailabilityGroupListenerMultiSubnetIpConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
