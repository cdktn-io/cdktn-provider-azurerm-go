...
func (d *jsiiProxy_DataAzurermArcMachineAgentExtensionsBlockListStructList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermArcMachineAgentExtensionsBlockListStructList) Resolve(context cdktf.IResolveContext) interface{} {
