...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference) IncomingConnectionsPorts() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference) InternalValue() *DataAzurermArcMachineAgent {
	var returns *DataAzurermArcMachineAgent
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference) ProxyBypass() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"proxyBypass",
...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference) ProxyUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"proxyUrl",
...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func NewDataAzurermArcMachineAgentOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermArcMachineAgentOutputReference {
	...
	j := jsiiProxy_DataAzurermArcMachineAgentOutputReference{}
...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference)SetInternalValue(val *DataAzurermArcMachineAgent) {
...
func (j *jsiiProxy_DataAzurermArcMachineAgentOutputReference)SetTerraformAttribute(val *string) {
...
func (d *jsiiProxy_DataAzurermArcMachineAgentOutputReference) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataAzurermArcMachineAgentOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DataAzurermArcMachineAgentOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataAzurermArcMachineAgentOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataAzurermArcMachineAgentOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataAzurermArcMachineAgentOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataAzurermArcMachineAgentOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataAzurermArcMachineAgentOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataAzurermArcMachineAgentOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataAzurermArcMachineAgentOutputReference) ToString() *string {
	var returns *string
