...
func (j *jsiiProxy_DataAzurermArcMachineOsProfileWindowsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermArcMachineOsProfileWindowsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermArcMachineOsProfileWindowsList {
	_init_.Initialize()
...
func NewDataAzurermArcMachineOsProfileWindowsList_Override(d DataAzurermArcMachineOsProfileWindowsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermArcMachineOsProfileWindowsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermArcMachineOsProfileWindowsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermArcMachineOsProfileWindowsList) Resolve(context cdktn.IResolveContext) interface{} {
