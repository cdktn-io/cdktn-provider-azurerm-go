...
func (j *jsiiProxy_OrbitalContactProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_OrbitalContactProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_OrbitalContactProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OrbitalContactProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_OrbitalContactProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/orbital_contact_profile azurerm_orbital_contact_profile} Resource.
...
func (j *jsiiProxy_OrbitalContactProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OrbitalContactProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OrbitalContactProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OrbitalContactProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OrbitalContactProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrbitalContactProfile) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_OrbitalContactProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OrbitalContactProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OrbitalContactProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OrbitalContactProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
