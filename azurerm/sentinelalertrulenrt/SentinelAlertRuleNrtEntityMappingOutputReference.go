...
func (j *jsiiProxy_SentinelAlertRuleNrtEntityMappingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelAlertRuleNrtEntityMappingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SentinelAlertRuleNrtEntityMappingOutputReference {
	_init_.Initialize()
...
func NewSentinelAlertRuleNrtEntityMappingOutputReference_Override(s SentinelAlertRuleNrtEntityMappingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelAlertRuleNrtEntityMappingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
