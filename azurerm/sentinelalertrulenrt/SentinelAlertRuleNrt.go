...
func (s *jsiiProxy_SentinelAlertRuleNrt) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SentinelAlertRuleNrt) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SentinelAlertRuleNrt) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
