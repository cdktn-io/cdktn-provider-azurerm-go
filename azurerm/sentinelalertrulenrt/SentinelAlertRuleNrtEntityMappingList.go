...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingList) Resolve(context cdktf.IResolveContext) interface{} {
