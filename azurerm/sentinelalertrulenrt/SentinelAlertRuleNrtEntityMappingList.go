...
func (j *jsiiProxy_SentinelAlertRuleNrtEntityMappingList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelAlertRuleNrtEntityMappingList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SentinelAlertRuleNrtEntityMappingList {
	_init_.Initialize()
...
func NewSentinelAlertRuleNrtEntityMappingList_Override(s SentinelAlertRuleNrtEntityMappingList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelAlertRuleNrtEntityMappingList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingList) Resolve(context cdktn.IResolveContext) interface{} {
