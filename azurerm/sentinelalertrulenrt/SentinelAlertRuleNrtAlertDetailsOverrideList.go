...
func (s *jsiiProxy_SentinelAlertRuleNrtAlertDetailsOverrideList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleNrtAlertDetailsOverrideList) Resolve(context cdktf.IResolveContext) interface{} {
