...
func (j *jsiiProxy_SentinelAlertRuleNrtEntityMappingFieldMappingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSentinelAlertRuleNrtEntityMappingFieldMappingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SentinelAlertRuleNrtEntityMappingFieldMappingOutputReference {
	_init_.Initialize()

	if err := validateNewSentinelAlertRuleNrtEntityMappingFieldMappingOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewSentinelAlertRuleNrtEntityMappingFieldMappingOutputReference_Override(s SentinelAlertRuleNrtEntityMappingFieldMappingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SentinelAlertRuleNrtEntityMappingFieldMappingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingFieldMappingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingFieldMappingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingFieldMappingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingFieldMappingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
