...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/streamanalyticsoutputservicebustopic/internal"
...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopicSerializationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStreamAnalyticsOutputServicebusTopicSerializationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StreamAnalyticsOutputServicebusTopicSerializationOutputReference {
	_init_.Initialize()

	if err := validateNewStreamAnalyticsOutputServicebusTopicSerializationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_StreamAnalyticsOutputServicebusTopicSerializationOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.streamAnalyticsOutputServicebusTopic.StreamAnalyticsOutputServicebusTopicSerializationOutputReference",
...
func NewStreamAnalyticsOutputServicebusTopicSerializationOutputReference_Override(s StreamAnalyticsOutputServicebusTopicSerializationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopicSerializationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopicSerializationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopicSerializationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopicSerializationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopicSerializationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
