...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/streamanalyticsoutputservicebustopic/internal"
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopicSerializationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopicSerializationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
