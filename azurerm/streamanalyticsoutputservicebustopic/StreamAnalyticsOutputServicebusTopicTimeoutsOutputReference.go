...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopicTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStreamAnalyticsOutputServicebusTopicTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StreamAnalyticsOutputServicebusTopicTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewStreamAnalyticsOutputServicebusTopicTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_StreamAnalyticsOutputServicebusTopicTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.streamAnalyticsOutputServicebusTopic.StreamAnalyticsOutputServicebusTopicTimeoutsOutputReference",
...
func NewStreamAnalyticsOutputServicebusTopicTimeoutsOutputReference_Override(s StreamAnalyticsOutputServicebusTopicTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopicTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopicTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopicTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopicTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopicTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
