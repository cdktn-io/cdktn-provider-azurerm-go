...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopic) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopic) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopic) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopic) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopic) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/stream_analytics_output_servicebus_topic azurerm_stream_analytics_output_servicebus_topic} Resource.
...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopic)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopic)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StreamAnalyticsOutputServicebusTopic)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StreamAnalyticsOutputServicebusTopic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopic) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopic) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopic) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopic) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopic) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusTopic) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
