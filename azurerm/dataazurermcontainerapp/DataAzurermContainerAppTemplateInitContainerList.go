...
func (d *jsiiProxy_DataAzurermContainerAppTemplateInitContainerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermContainerAppTemplateInitContainerList) Resolve(context cdktf.IResolveContext) interface{} {
