...
func IotcentralApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotcentralApplication) ImportFrom(id *string, provider cdktf.TerraformProvider) {
