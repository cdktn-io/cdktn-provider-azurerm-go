...
func (j *jsiiProxy_IotcentralApplicationTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIotcentralApplicationTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) IotcentralApplicationTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewIotcentralApplicationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewIotcentralApplicationTimeoutsOutputReference_Override(i IotcentralApplicationTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotcentralApplicationTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IotcentralApplicationTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotcentralApplicationTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_IotcentralApplicationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotcentralApplicationTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
