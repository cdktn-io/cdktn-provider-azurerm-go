...
func (i *jsiiProxy_IotcentralApplicationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotcentralApplicationTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
