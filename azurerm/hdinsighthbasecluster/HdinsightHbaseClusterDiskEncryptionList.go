...
func (j *jsiiProxy_HdinsightHbaseClusterDiskEncryptionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHbaseClusterDiskEncryptionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightHbaseClusterDiskEncryptionList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightHbaseCluster.HdinsightHbaseClusterDiskEncryptionList",
...
func NewHdinsightHbaseClusterDiskEncryptionList_Override(h HdinsightHbaseClusterDiskEncryptionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHbaseClusterDiskEncryptionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHbaseClusterDiskEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHbaseClusterDiskEncryptionList) Resolve(context cdktn.IResolveContext) interface{} {
