...
func (j *jsiiProxy_HdinsightHbaseClusterTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHbaseClusterTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightHbaseClusterTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewHdinsightHbaseClusterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_HdinsightHbaseClusterTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightHbaseCluster.HdinsightHbaseClusterTimeoutsOutputReference",
...
func NewHdinsightHbaseClusterTimeoutsOutputReference_Override(h HdinsightHbaseClusterTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHbaseClusterTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHbaseClusterTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightHbaseClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
