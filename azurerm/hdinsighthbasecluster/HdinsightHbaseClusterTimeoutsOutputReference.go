...
func (h *jsiiProxy_HdinsightHbaseClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
