...
func (j *jsiiProxy_HdinsightHbaseClusterComponentVersionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHbaseClusterComponentVersionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightHbaseClusterComponentVersionOutputReference {
	_init_.Initialize()

	if err := validateNewHdinsightHbaseClusterComponentVersionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_HdinsightHbaseClusterComponentVersionOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightHbaseCluster.HdinsightHbaseClusterComponentVersionOutputReference",
...
func NewHdinsightHbaseClusterComponentVersionOutputReference_Override(h HdinsightHbaseClusterComponentVersionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHbaseClusterComponentVersionOutputReference)SetHbase(val *string) {
	if err := j.validateSetHbaseParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_HdinsightHbaseClusterComponentVersionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHbaseClusterComponentVersionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterComponentVersionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightHbaseClusterComponentVersionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterComponentVersionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
