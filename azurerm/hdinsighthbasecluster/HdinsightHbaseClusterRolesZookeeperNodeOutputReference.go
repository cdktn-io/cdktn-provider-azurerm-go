...
type HdinsightHbaseClusterRolesZookeeperNodeOutputReference interface {
	...
	ScriptActions() HdinsightHbaseClusterRolesZookeeperNodeScriptActionsList
...
func (j *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeOutputReference) ScriptActions() HdinsightHbaseClusterRolesZookeeperNodeScriptActionsList {
	var returns HdinsightHbaseClusterRolesZookeeperNodeScriptActionsList
	_jsii_.Get(
		j,
		"scriptActions",
		&returns,
...
func (j *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeOutputReference) ScriptActionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"scriptActionsInput",
...
func (j *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHbaseClusterRolesZookeeperNodeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightHbaseClusterRolesZookeeperNodeOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightHbaseCluster.HdinsightHbaseClusterRolesZookeeperNodeOutputReference",
...
func NewHdinsightHbaseClusterRolesZookeeperNodeOutputReference_Override(h HdinsightHbaseClusterRolesZookeeperNodeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeOutputReference) PutScriptActions(value interface{}) {
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeOutputReference) ResetScriptActions() {
	_jsii_.InvokeVoid(
		h,
		"resetScriptActions",
		nil, // no parameters
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
