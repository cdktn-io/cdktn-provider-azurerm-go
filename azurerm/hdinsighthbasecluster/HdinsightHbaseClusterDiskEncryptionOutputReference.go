...
func (h *jsiiProxy_HdinsightHbaseClusterDiskEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterDiskEncryptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
