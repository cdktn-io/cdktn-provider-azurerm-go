...
func (j *jsiiProxy_HdinsightHbaseClusterStorageAccountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHbaseClusterStorageAccountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightHbaseClusterStorageAccountList {
	_init_.Initialize()

	if err := validateNewHdinsightHbaseClusterStorageAccountListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_HdinsightHbaseClusterStorageAccountList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightHbaseCluster.HdinsightHbaseClusterStorageAccountList",
...
func NewHdinsightHbaseClusterStorageAccountList_Override(h HdinsightHbaseClusterStorageAccountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHbaseClusterStorageAccountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHbaseClusterStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHbaseClusterStorageAccountList) Resolve(context cdktn.IResolveContext) interface{} {
