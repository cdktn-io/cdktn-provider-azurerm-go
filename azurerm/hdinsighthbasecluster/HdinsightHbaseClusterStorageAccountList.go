...
func (h *jsiiProxy_HdinsightHbaseClusterStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightHbaseClusterStorageAccountList) Resolve(context cdktf.IResolveContext) interface{} {
