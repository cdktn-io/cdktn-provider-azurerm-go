...
func (h *jsiiProxy_HdinsightHbaseClusterExtensionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterExtensionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
