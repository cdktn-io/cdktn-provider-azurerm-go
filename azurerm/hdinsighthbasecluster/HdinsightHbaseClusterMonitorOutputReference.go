...
func (j *jsiiProxy_HdinsightHbaseClusterMonitorOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHbaseClusterMonitorOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightHbaseClusterMonitorOutputReference {
	_init_.Initialize()

	if err := validateNewHdinsightHbaseClusterMonitorOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_HdinsightHbaseClusterMonitorOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightHbaseCluster.HdinsightHbaseClusterMonitorOutputReference",
...
func NewHdinsightHbaseClusterMonitorOutputReference_Override(h HdinsightHbaseClusterMonitorOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHbaseClusterMonitorOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHbaseClusterMonitorOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterMonitorOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightHbaseClusterMonitorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterMonitorOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
