...
func (h *jsiiProxy_HdinsightHbaseClusterMonitorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterMonitorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
