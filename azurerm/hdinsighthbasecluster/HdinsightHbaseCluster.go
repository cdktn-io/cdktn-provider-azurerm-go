...
type HdinsightHbaseCluster interface {
	...
	PrivateLinkConfiguration() HdinsightHbaseClusterPrivateLinkConfigurationOutputReference
	PrivateLinkConfigurationInput() *HdinsightHbaseClusterPrivateLinkConfiguration
	// Experimental.
	...
	PutPrivateLinkConfiguration(value *HdinsightHbaseClusterPrivateLinkConfiguration)
...
func (j *jsiiProxy_HdinsightHbaseCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_HdinsightHbaseCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_HdinsightHbaseCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_HdinsightHbaseCluster) PrivateLinkConfiguration() HdinsightHbaseClusterPrivateLinkConfigurationOutputReference {
	var returns HdinsightHbaseClusterPrivateLinkConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_HdinsightHbaseCluster) PrivateLinkConfigurationInput() *HdinsightHbaseClusterPrivateLinkConfiguration {
...
func (j *jsiiProxy_HdinsightHbaseCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_HdinsightHbaseCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/hdinsight_hbase_cluster azurerm_hdinsight_hbase_cluster} Resource.
...
func (j *jsiiProxy_HdinsightHbaseCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_HdinsightHbaseCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_HdinsightHbaseCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func HdinsightHbaseCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (h *jsiiProxy_HdinsightHbaseCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (h *jsiiProxy_HdinsightHbaseCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HdinsightHbaseCluster) PutPrivateLinkConfiguration(value *HdinsightHbaseClusterPrivateLinkConfiguration) {
...
func (h *jsiiProxy_HdinsightHbaseCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HdinsightHbaseCluster) ResetPrivateLinkConfiguration() {
	_jsii_.InvokeVoid(
		h,
		"resetPrivateLinkConfiguration",
		nil, // no parameters
...
func (h *jsiiProxy_HdinsightHbaseCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
