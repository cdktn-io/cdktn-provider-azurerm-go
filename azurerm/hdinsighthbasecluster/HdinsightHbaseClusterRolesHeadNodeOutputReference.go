...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/hdinsighthbasecluster/internal"
...
type HdinsightHbaseClusterRolesHeadNodeOutputReference interface {
	...
	ScriptActions() HdinsightHbaseClusterRolesHeadNodeScriptActionsList
...
func (j *jsiiProxy_HdinsightHbaseClusterRolesHeadNodeOutputReference) ScriptActions() HdinsightHbaseClusterRolesHeadNodeScriptActionsList {
	var returns HdinsightHbaseClusterRolesHeadNodeScriptActionsList
	_jsii_.Get(
		j,
		"scriptActions",
		&returns,
...
func (j *jsiiProxy_HdinsightHbaseClusterRolesHeadNodeOutputReference) ScriptActionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"scriptActionsInput",
...
func (j *jsiiProxy_HdinsightHbaseClusterRolesHeadNodeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHdinsightHbaseClusterRolesHeadNodeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HdinsightHbaseClusterRolesHeadNodeOutputReference {
	_init_.Initialize()

	if err := validateNewHdinsightHbaseClusterRolesHeadNodeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_HdinsightHbaseClusterRolesHeadNodeOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.hdinsightHbaseCluster.HdinsightHbaseClusterRolesHeadNodeOutputReference",
...
func NewHdinsightHbaseClusterRolesHeadNodeOutputReference_Override(h HdinsightHbaseClusterRolesHeadNodeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HdinsightHbaseClusterRolesHeadNodeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesHeadNodeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesHeadNodeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesHeadNodeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesHeadNodeOutputReference) PutScriptActions(value interface{}) {
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesHeadNodeOutputReference) ResetScriptActions() {
	_jsii_.InvokeVoid(
		h,
		"resetScriptActions",
		nil, // no parameters
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesHeadNodeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
