...
func (j *jsiiProxy_ArcKubernetesClusterExtension) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ArcKubernetesClusterExtension) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ArcKubernetesClusterExtension) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ArcKubernetesClusterExtension) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ArcKubernetesClusterExtension) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/arc_kubernetes_cluster_extension azurerm_arc_kubernetes_cluster_extension} Resource.
...
func (j *jsiiProxy_ArcKubernetesClusterExtension)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ArcKubernetesClusterExtension)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ArcKubernetesClusterExtension)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ArcKubernetesClusterExtension_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ArcKubernetesClusterExtension) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ArcKubernetesClusterExtension) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ArcKubernetesClusterExtension) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ArcKubernetesClusterExtension) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ArcKubernetesClusterExtension) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ArcKubernetesClusterExtension) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
