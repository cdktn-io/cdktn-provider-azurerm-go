...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/virtualmachinerestorepointcollection/internal"
...
func (j *jsiiProxy_VirtualMachineRestorePointCollection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VirtualMachineRestorePointCollection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VirtualMachineRestorePointCollection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VirtualMachineRestorePointCollection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VirtualMachineRestorePointCollection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/virtual_machine_restore_point_collection azurerm_virtual_machine_restore_point_collection} Resource.
func NewVirtualMachineRestorePointCollection(scope constructs.Construct, id *string, config *VirtualMachineRestorePointCollectionConfig) VirtualMachineRestorePointCollection {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.virtualMachineRestorePointCollection.VirtualMachineRestorePointCollection",
...
func (j *jsiiProxy_VirtualMachineRestorePointCollection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VirtualMachineRestorePointCollection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VirtualMachineRestorePointCollection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VirtualMachineRestorePointCollection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VirtualMachineRestorePointCollection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineRestorePointCollection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VirtualMachineRestorePointCollection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineRestorePointCollection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualMachineRestorePointCollection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VirtualMachineRestorePointCollection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
