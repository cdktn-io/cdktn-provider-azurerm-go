...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/machinelearningcomputecluster/internal"
...
func (j *jsiiProxy_MachineLearningComputeClusterTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_MachineLearningComputeClusterTimeoutsOutputReference) Update() *string {
	var returns *string
	_jsii_.Get(
		j,
		"update",
...
func (j *jsiiProxy_MachineLearningComputeClusterTimeoutsOutputReference) UpdateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateInput",
...
func NewMachineLearningComputeClusterTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MachineLearningComputeClusterTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewMachineLearningComputeClusterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMachineLearningComputeClusterTimeoutsOutputReference_Override(m MachineLearningComputeClusterTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MachineLearningComputeClusterTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_MachineLearningComputeClusterTimeoutsOutputReference)SetUpdate(val *string) {
...
func (m *jsiiProxy_MachineLearningComputeClusterTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MachineLearningComputeClusterTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MachineLearningComputeClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MachineLearningComputeClusterTimeoutsOutputReference) ResetUpdate() {
	_jsii_.InvokeVoid(
		m,
		"resetUpdate",
		nil, // no parameters
...
func (m *jsiiProxy_MachineLearningComputeClusterTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
