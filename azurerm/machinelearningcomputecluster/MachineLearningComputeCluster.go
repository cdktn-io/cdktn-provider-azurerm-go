...
func (j *jsiiProxy_MachineLearningComputeCluster) NodePublicIpEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"nodePublicIpEnabled",
...
func (j *jsiiProxy_MachineLearningComputeCluster) NodePublicIpEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/machine_learning_compute_cluster azurerm_machine_learning_compute_cluster} Resource.
...
func (j *jsiiProxy_MachineLearningComputeCluster)SetNodePublicIpEnabled(val interface{}) {
...
func (m *jsiiProxy_MachineLearningComputeCluster) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MachineLearningComputeCluster) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MachineLearningComputeCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MachineLearningComputeCluster) MoveFromId(id *string) {
...
func (m *jsiiProxy_MachineLearningComputeCluster) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MachineLearningComputeCluster) MoveToId(id *string) {
...
func (m *jsiiProxy_MachineLearningComputeCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MachineLearningComputeCluster) ResetNodePublicIpEnabled() {
	_jsii_.InvokeVoid(
		m,
		"resetNodePublicIpEnabled",
		nil, // no parameters
...
func (m *jsiiProxy_MachineLearningComputeCluster) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MachineLearningComputeCluster) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MachineLearningComputeCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
