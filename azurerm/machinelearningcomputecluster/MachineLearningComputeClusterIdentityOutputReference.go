...
func (m *jsiiProxy_MachineLearningComputeClusterIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MachineLearningComputeClusterIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
