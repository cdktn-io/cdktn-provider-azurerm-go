...
func (j *jsiiProxy_MachineLearningComputeClusterSshOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMachineLearningComputeClusterSshOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MachineLearningComputeClusterSshOutputReference {
	_init_.Initialize()

	if err := validateNewMachineLearningComputeClusterSshOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMachineLearningComputeClusterSshOutputReference_Override(m MachineLearningComputeClusterSshOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MachineLearningComputeClusterSshOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MachineLearningComputeClusterSshOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MachineLearningComputeClusterSshOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MachineLearningComputeClusterSshOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MachineLearningComputeClusterSshOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
