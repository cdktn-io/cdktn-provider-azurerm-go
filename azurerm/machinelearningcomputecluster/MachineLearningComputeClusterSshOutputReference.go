...
func (m *jsiiProxy_MachineLearningComputeClusterSshOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MachineLearningComputeClusterSshOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
