...
func (j *jsiiProxy_StorageAccountLocalUser) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StorageAccountLocalUser) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StorageAccountLocalUser) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StorageAccountLocalUser) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StorageAccountLocalUser) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/storage_account_local_user azurerm_storage_account_local_user} Resource.
...
func (j *jsiiProxy_StorageAccountLocalUser)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StorageAccountLocalUser)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StorageAccountLocalUser)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StorageAccountLocalUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StorageAccountLocalUser) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountLocalUser) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StorageAccountLocalUser) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountLocalUser) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageAccountLocalUser) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageAccountLocalUser) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
