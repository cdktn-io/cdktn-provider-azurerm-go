...
func (j *jsiiProxy_ActiveDirectoryDomainService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ActiveDirectoryDomainService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ActiveDirectoryDomainService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ActiveDirectoryDomainService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ActiveDirectoryDomainService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/active_directory_domain_service azurerm_active_directory_domain_service} Resource.
...
func (j *jsiiProxy_ActiveDirectoryDomainService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ActiveDirectoryDomainService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ActiveDirectoryDomainService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ActiveDirectoryDomainService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ActiveDirectoryDomainService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ActiveDirectoryDomainService) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ActiveDirectoryDomainService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ActiveDirectoryDomainService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ActiveDirectoryDomainService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ActiveDirectoryDomainService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
