...
func (j *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigIpRestrictionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermWindowsFunctionAppSiteConfigIpRestrictionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermWindowsFunctionAppSiteConfigIpRestrictionList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermWindowsFunctionApp.DataAzurermWindowsFunctionAppSiteConfigIpRestrictionList",
...
func NewDataAzurermWindowsFunctionAppSiteConfigIpRestrictionList_Override(d DataAzurermWindowsFunctionAppSiteConfigIpRestrictionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigIpRestrictionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigIpRestrictionList) Resolve(context cdktn.IResolveContext) interface{} {
