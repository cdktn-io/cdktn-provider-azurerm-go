...
func (j *jsiiProxy_DataAzurermWindowsFunctionAppAuthSettingsMicrosoftList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermWindowsFunctionAppAuthSettingsMicrosoftList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermWindowsFunctionAppAuthSettingsMicrosoftList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermWindowsFunctionApp.DataAzurermWindowsFunctionAppAuthSettingsMicrosoftList",
...
func NewDataAzurermWindowsFunctionAppAuthSettingsMicrosoftList_Override(d DataAzurermWindowsFunctionAppAuthSettingsMicrosoftList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermWindowsFunctionAppAuthSettingsMicrosoftList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermWindowsFunctionAppAuthSettingsMicrosoftList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsFunctionAppAuthSettingsMicrosoftList) Resolve(context cdktn.IResolveContext) interface{} {
