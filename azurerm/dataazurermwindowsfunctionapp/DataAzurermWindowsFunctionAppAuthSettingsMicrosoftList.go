...
func (d *jsiiProxy_DataAzurermWindowsFunctionAppAuthSettingsMicrosoftList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermWindowsFunctionAppAuthSettingsMicrosoftList) Resolve(context cdktf.IResolveContext) interface{} {
