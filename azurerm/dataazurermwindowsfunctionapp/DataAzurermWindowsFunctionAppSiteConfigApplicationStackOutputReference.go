...
type DataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference interface {
	...
	UseCustomRuntime() cdktn.IResolvable
	UseDotnetIsolatedRuntime() cdktn.IResolvable
	// Experimental.
	ComputeFqn() *string
	// Experimental.
...
func (j *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference) UseCustomRuntime() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference) UseDotnetIsolatedRuntime() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func NewDataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference {
	_init_.Initialize()
...
func NewDataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference_Override(d DataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermWindowsFunctionAppSiteConfigApplicationStackOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
