...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/kusto_cluster azurerm_kusto_cluster} Resource.
...
func (k *jsiiProxy_KustoCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KustoCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KustoCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
