...
func (k *jsiiProxy_KustoClusterOptimizedAutoScaleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KustoClusterOptimizedAutoScaleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
