...
func (k *jsiiProxy_KustoClusterVirtualNetworkConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KustoClusterVirtualNetworkConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
