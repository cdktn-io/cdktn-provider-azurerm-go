...
func (k *jsiiProxy_KustoClusterIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KustoClusterIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
