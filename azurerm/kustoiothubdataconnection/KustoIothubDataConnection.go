...
func (k *jsiiProxy_KustoIothubDataConnection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KustoIothubDataConnection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
