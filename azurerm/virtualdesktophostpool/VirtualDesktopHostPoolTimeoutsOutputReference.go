...
func (v *jsiiProxy_VirtualDesktopHostPoolTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopHostPoolTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
