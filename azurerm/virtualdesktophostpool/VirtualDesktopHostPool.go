...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/virtualdesktophostpool/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/virtual_desktop_host_pool azurerm_virtual_desktop_host_pool}.
...
func (j *jsiiProxy_VirtualDesktopHostPool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VirtualDesktopHostPool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VirtualDesktopHostPool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VirtualDesktopHostPool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VirtualDesktopHostPool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/virtual_desktop_host_pool azurerm_virtual_desktop_host_pool} Resource.
...
func (j *jsiiProxy_VirtualDesktopHostPool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VirtualDesktopHostPool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VirtualDesktopHostPool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VirtualDesktopHostPool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VirtualDesktopHostPool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopHostPool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VirtualDesktopHostPool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopHostPool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualDesktopHostPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VirtualDesktopHostPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
