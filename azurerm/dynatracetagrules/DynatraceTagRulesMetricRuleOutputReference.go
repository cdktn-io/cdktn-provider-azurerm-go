...
func (d *jsiiProxy_DynatraceTagRulesMetricRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DynatraceTagRulesMetricRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
