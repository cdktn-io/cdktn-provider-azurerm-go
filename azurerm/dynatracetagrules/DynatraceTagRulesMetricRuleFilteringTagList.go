...
func (j *jsiiProxy_DynatraceTagRulesMetricRuleFilteringTagList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DynatraceTagRulesMetricRuleFilteringTagList) InternalValue() interface{} {
...
func (j *jsiiProxy_DynatraceTagRulesMetricRuleFilteringTagList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DynatraceTagRulesMetricRuleFilteringTagList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewDynatraceTagRulesMetricRuleFilteringTagList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DynatraceTagRulesMetricRuleFilteringTagList {
	...
	j := jsiiProxy_DynatraceTagRulesMetricRuleFilteringTagList{}
...
func (j *jsiiProxy_DynatraceTagRulesMetricRuleFilteringTagList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_DynatraceTagRulesMetricRuleFilteringTagList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DynatraceTagRulesMetricRuleFilteringTagList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DynatraceTagRulesMetricRuleFilteringTagList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DynatraceTagRulesMetricRuleFilteringTagList) Get(index *float64) DynatraceTagRulesMetricRuleFilteringTagOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DynatraceTagRulesMetricRuleFilteringTagOutputReference
...
func (d *jsiiProxy_DynatraceTagRulesMetricRuleFilteringTagList) ToString() *string {
	var returns *string
