...
func (j *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey) Tags() cdktn.StringMap {
...
func (j *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/data-sources/key_vault_managed_hardware_security_module_key azurerm_key_vault_managed_hardware_security_module_key} Data Source.
...
func (j *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermKeyVaultManagedHardwareSecurityModuleKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermKeyVaultManagedHardwareSecurityModuleKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
