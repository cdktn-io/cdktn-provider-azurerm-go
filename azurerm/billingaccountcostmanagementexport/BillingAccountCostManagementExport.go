...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/billing_account_cost_management_export azurerm_billing_account_cost_management_export} Resource.
...
func (b *jsiiProxy_BillingAccountCostManagementExport) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BillingAccountCostManagementExport) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BillingAccountCostManagementExport) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
