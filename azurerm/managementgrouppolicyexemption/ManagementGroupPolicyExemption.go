...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/managementgrouppolicyexemption/internal"
...
func (j *jsiiProxy_ManagementGroupPolicyExemption) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ManagementGroupPolicyExemption) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ManagementGroupPolicyExemption) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ManagementGroupPolicyExemption) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ManagementGroupPolicyExemption) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/management_group_policy_exemption azurerm_management_group_policy_exemption} Resource.
func NewManagementGroupPolicyExemption(scope constructs.Construct, id *string, config *ManagementGroupPolicyExemptionConfig) ManagementGroupPolicyExemption {
	...
	if err := validateNewManagementGroupPolicyExemptionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ManagementGroupPolicyExemption)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ManagementGroupPolicyExemption)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ManagementGroupPolicyExemption)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ManagementGroupPolicyExemption_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateManagementGroupPolicyExemption_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ManagementGroupPolicyExemption_IsConstruct(x interface{}) *bool {
	...
	if err := validateManagementGroupPolicyExemption_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ManagementGroupPolicyExemption_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateManagementGroupPolicyExemption_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ManagementGroupPolicyExemption_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateManagementGroupPolicyExemption_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_ManagementGroupPolicyExemption) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_ManagementGroupPolicyExemption) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagementGroupPolicyExemption) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_ManagementGroupPolicyExemption) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ManagementGroupPolicyExemption) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_ManagementGroupPolicyExemption) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_ManagementGroupPolicyExemption) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_ManagementGroupPolicyExemption) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_ManagementGroupPolicyExemption) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
