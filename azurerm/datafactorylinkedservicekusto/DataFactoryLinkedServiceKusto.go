...
func (d *jsiiProxy_DataFactoryLinkedServiceKusto) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DataFactoryLinkedServiceKusto) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
