...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/datafactorylinkedservicekusto/internal"
...
func (j *jsiiProxy_DataFactoryLinkedServiceKustoTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryLinkedServiceKustoTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataFactoryLinkedServiceKustoTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryLinkedServiceKustoTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataFactoryLinkedServiceKustoTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataFactoryLinkedServiceKusto.DataFactoryLinkedServiceKustoTimeoutsOutputReference",
...
func NewDataFactoryLinkedServiceKustoTimeoutsOutputReference_Override(d DataFactoryLinkedServiceKustoTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryLinkedServiceKustoTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceKustoTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceKustoTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryLinkedServiceKustoTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceKustoTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
