...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/iothubendpointcosmosdbaccount/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/iothub_endpoint_cosmosdb_account azurerm_iothub_endpoint_cosmosdb_account} Resource.
...
func (i *jsiiProxy_IothubEndpointCosmosdbAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IothubEndpointCosmosdbAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IothubEndpointCosmosdbAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
