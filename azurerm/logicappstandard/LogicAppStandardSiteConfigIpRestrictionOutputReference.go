...
func (l *jsiiProxy_LogicAppStandardSiteConfigIpRestrictionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppStandardSiteConfigIpRestrictionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
