...
func (l *jsiiProxy_LogicAppStandardIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppStandardIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
