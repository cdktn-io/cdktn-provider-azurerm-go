...
func (l *jsiiProxy_LogicAppStandardSiteCredentialOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppStandardSiteCredentialOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
