...
func (l *jsiiProxy_LogicAppStandardSiteConfigCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppStandardSiteConfigCorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
