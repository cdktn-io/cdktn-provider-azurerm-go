...
func (l *jsiiProxy_LogicAppStandardTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppStandardTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
