...
func (l *jsiiProxy_LogicAppStandardConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppStandardConnectionStringOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
