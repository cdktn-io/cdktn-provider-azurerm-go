...
func (j *jsiiProxy_LogicAppStandardConnectionStringOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogicAppStandardConnectionStringOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LogicAppStandardConnectionStringOutputReference {
	_init_.Initialize()

	if err := validateNewLogicAppStandardConnectionStringOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewLogicAppStandardConnectionStringOutputReference_Override(l LogicAppStandardConnectionStringOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogicAppStandardConnectionStringOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogicAppStandardConnectionStringOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppStandardConnectionStringOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LogicAppStandardConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogicAppStandardConnectionStringOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
