...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/logic_app_standard azurerm_logic_app_standard} Resource.
...
func (l *jsiiProxy_LogicAppStandard) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogicAppStandard) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogicAppStandard) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
