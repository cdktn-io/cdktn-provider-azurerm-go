...
func (l *jsiiProxy_LogicAppStandardConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LogicAppStandardConnectionStringList) Resolve(context cdktf.IResolveContext) interface{} {
