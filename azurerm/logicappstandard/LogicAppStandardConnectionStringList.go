...
func (j *jsiiProxy_LogicAppStandardConnectionStringList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogicAppStandardConnectionStringList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LogicAppStandardConnectionStringList {
	_init_.Initialize()
...
func NewLogicAppStandardConnectionStringList_Override(l LogicAppStandardConnectionStringList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogicAppStandardConnectionStringList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogicAppStandardConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LogicAppStandardConnectionStringList) Resolve(context cdktn.IResolveContext) interface{} {
