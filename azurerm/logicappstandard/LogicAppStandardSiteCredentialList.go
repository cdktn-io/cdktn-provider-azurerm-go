...
func (j *jsiiProxy_LogicAppStandardSiteCredentialList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLogicAppStandardSiteCredentialList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LogicAppStandardSiteCredentialList {
	_init_.Initialize()
...
func NewLogicAppStandardSiteCredentialList_Override(l LogicAppStandardSiteCredentialList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LogicAppStandardSiteCredentialList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LogicAppStandardSiteCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LogicAppStandardSiteCredentialList) Resolve(context cdktn.IResolveContext) interface{} {
