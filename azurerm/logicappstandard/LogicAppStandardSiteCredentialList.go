...
func (l *jsiiProxy_LogicAppStandardSiteCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LogicAppStandardSiteCredentialList) Resolve(context cdktf.IResolveContext) interface{} {
