...
func (j *jsiiProxy_SubscriptionPolicyAssignmentOverridesSelectorsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_SubscriptionPolicyAssignmentOverridesSelectorsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SubscriptionPolicyAssignmentOverridesSelectorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SubscriptionPolicyAssignmentOverridesSelectorsList) Resolve(context cdktf.IResolveContext) interface{} {
