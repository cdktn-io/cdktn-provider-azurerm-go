...
func (j *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsList) Resolve(context cdktf.IResolveContext) interface{} {
