...
func (j *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.subscriptionPolicyAssignment.SubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference",
...
func NewSubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference_Override(s SubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
