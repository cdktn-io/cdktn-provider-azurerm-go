...
func (j *jsiiProxy_SubscriptionPolicyAssignment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SubscriptionPolicyAssignment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SubscriptionPolicyAssignment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SubscriptionPolicyAssignment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SubscriptionPolicyAssignment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewSubscriptionPolicyAssignment(scope constructs.Construct, id *string, config *SubscriptionPolicyAssignmentConfig) SubscriptionPolicyAssignment {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.subscriptionPolicyAssignment.SubscriptionPolicyAssignment",
...
func (j *jsiiProxy_SubscriptionPolicyAssignment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SubscriptionPolicyAssignment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SubscriptionPolicyAssignment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SubscriptionPolicyAssignment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SubscriptionPolicyAssignment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubscriptionPolicyAssignment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SubscriptionPolicyAssignment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SubscriptionPolicyAssignment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SubscriptionPolicyAssignment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SubscriptionPolicyAssignment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
