...
func (j *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/workloads_sap_discovery_virtual_instance azurerm_workloads_sap_discovery_virtual_instance} Resource.
...
func (j *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WorkloadsSapDiscoveryVirtualInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WorkloadsSapDiscoveryVirtualInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
