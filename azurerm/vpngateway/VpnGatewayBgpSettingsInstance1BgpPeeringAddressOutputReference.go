...
func (j *jsiiProxy_VpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference {
	_init_.Initialize()

	if err := validateNewVpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewVpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference_Override(v VpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
