...
func (v *jsiiProxy_VpnGatewayTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnGatewayTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
