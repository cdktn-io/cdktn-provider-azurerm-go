...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/resourcegrouppolicyexemption/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/resource_group_policy_exemption azurerm_resource_group_policy_exemption}.
...
func (j *jsiiProxy_ResourceGroupPolicyExemption) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ResourceGroupPolicyExemption) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ResourceGroupPolicyExemption) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ResourceGroupPolicyExemption) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ResourceGroupPolicyExemption) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ResourceGroupPolicyExemption) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/resource_group_policy_exemption azurerm_resource_group_policy_exemption} Resource.
func NewResourceGroupPolicyExemption(scope constructs.Construct, id *string, config *ResourceGroupPolicyExemptionConfig) ResourceGroupPolicyExemption {
	...
	if err := validateNewResourceGroupPolicyExemptionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ResourceGroupPolicyExemption)SetCount(val interface{}) {
...
func (j *jsiiProxy_ResourceGroupPolicyExemption)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ResourceGroupPolicyExemption)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ResourceGroupPolicyExemption)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ResourceGroupPolicyExemption_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateResourceGroupPolicyExemption_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ResourceGroupPolicyExemption_IsConstruct(x interface{}) *bool {
	...
	if err := validateResourceGroupPolicyExemption_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ResourceGroupPolicyExemption_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateResourceGroupPolicyExemption_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ResourceGroupPolicyExemption_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateResourceGroupPolicyExemption_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) MoveFromId(id *string) {
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) MoveToId(id *string) {
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_ResourceGroupPolicyExemption) ToHclTerraform() interface{} {
	var returns interface{}
