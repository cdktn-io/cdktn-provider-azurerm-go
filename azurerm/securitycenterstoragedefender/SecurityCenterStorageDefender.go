...
func (j *jsiiProxy_SecurityCenterStorageDefender) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SecurityCenterStorageDefender) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SecurityCenterStorageDefender) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecurityCenterStorageDefender) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SecurityCenterStorageDefender) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/security_center_storage_defender azurerm_security_center_storage_defender} Resource.
...
func (j *jsiiProxy_SecurityCenterStorageDefender)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SecurityCenterStorageDefender)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SecurityCenterStorageDefender)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SecurityCenterStorageDefender_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecurityCenterStorageDefender) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityCenterStorageDefender) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SecurityCenterStorageDefender) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SecurityCenterStorageDefender) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SecurityCenterStorageDefender) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SecurityCenterStorageDefender) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
