...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "certificateVersion", GoGetter: "CertificateVersion"},
			_jsii_.MemberProperty{JsiiProperty: "connection", GoGetter: "Connection"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "customCertificateId", GoGetter: "CustomCertificateId"},
			_jsii_.MemberProperty{JsiiProperty: "customCertificateIdInput", GoGetter: "CustomCertificateIdInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_SignalrServiceCustomCertificateTimeoutsOutputReference{}
