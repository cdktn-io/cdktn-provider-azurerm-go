...
func (j *jsiiProxy_FirewallApplicationRuleCollectionRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallApplicationRuleCollectionRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FirewallApplicationRuleCollectionRuleOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.firewallApplicationRuleCollection.FirewallApplicationRuleCollectionRuleOutputReference",
...
func NewFirewallApplicationRuleCollectionRuleOutputReference_Override(f FirewallApplicationRuleCollectionRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallApplicationRuleCollectionRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallApplicationRuleCollectionRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallApplicationRuleCollectionRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FirewallApplicationRuleCollectionRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallApplicationRuleCollectionRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
