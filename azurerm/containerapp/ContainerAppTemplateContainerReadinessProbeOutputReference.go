...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeOutputReference) InitialDelay() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"initialDelay",
...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeOutputReference) InitialDelayInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"initialDelayInput",
...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerAppTemplateContainerReadinessProbeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerAppTemplateContainerReadinessProbeOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.containerApp.ContainerAppTemplateContainerReadinessProbeOutputReference",
...
func NewContainerAppTemplateContainerReadinessProbeOutputReference_Override(c ContainerAppTemplateContainerReadinessProbeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeOutputReference)SetInitialDelay(val *float64) {
...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerAppTemplateContainerReadinessProbeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerAppTemplateContainerReadinessProbeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerAppTemplateContainerReadinessProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerAppTemplateContainerReadinessProbeOutputReference) ResetInitialDelay() {
	_jsii_.InvokeVoid(
		c,
		"resetInitialDelay",
		nil, // no parameters
...
func (c *jsiiProxy_ContainerAppTemplateContainerReadinessProbeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
