...
func (j *jsiiProxy_ContainerAppTemplateContainerOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewContainerAppTemplateContainerOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerAppTemplateContainerOutputReference {
	_init_.Initialize()
...
func NewContainerAppTemplateContainerOutputReference_Override(c ContainerAppTemplateContainerOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerAppTemplateContainerOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_ContainerAppTemplateContainerOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerAppTemplateContainerOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_ContainerAppTemplateContainerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_ContainerAppTemplateContainerOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
