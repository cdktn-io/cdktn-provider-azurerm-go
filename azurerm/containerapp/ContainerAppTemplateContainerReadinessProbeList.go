...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeList) InternalValue() interface{} {
...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewContainerAppTemplateContainerReadinessProbeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerAppTemplateContainerReadinessProbeList {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.containerApp.ContainerAppTemplateContainerReadinessProbeList",
...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ContainerAppTemplateContainerReadinessProbeList)SetWrapsSet(val *bool) {
...
func (c *jsiiProxy_ContainerAppTemplateContainerReadinessProbeList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ContainerAppTemplateContainerReadinessProbeList) Get(index *float64) ContainerAppTemplateContainerReadinessProbeOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ContainerAppTemplateContainerReadinessProbeOutputReference
...
func (c *jsiiProxy_ContainerAppTemplateContainerReadinessProbeList) ToString() *string {
	var returns *string
