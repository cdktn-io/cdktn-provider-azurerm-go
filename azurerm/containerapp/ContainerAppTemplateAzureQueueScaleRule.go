...
type ContainerAppTemplateAzureQueueScaleRule struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/container_app#queue_length ContainerApp#queue_length}.
	QueueLength *float64 `field:"required" json:"queueLength" yaml:"queueLength"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/container_app#queue_name ContainerApp#queue_name}.
