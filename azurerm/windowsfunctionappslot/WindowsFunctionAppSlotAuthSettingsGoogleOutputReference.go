...
func (j *jsiiProxy_WindowsFunctionAppSlotAuthSettingsGoogleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSlotAuthSettingsGoogleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsFunctionAppSlotAuthSettingsGoogleOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsFunctionAppSlotAuthSettingsGoogleOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWindowsFunctionAppSlotAuthSettingsGoogleOutputReference_Override(w WindowsFunctionAppSlotAuthSettingsGoogleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSlotAuthSettingsGoogleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSlotAuthSettingsGoogleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSlotAuthSettingsGoogleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsFunctionAppSlotAuthSettingsGoogleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSlotAuthSettingsGoogleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
