...
func (j *jsiiProxy_WindowsFunctionAppSlotStorageAccountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSlotStorageAccountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsFunctionAppSlotStorageAccountList {
	_init_.Initialize()
...
func NewWindowsFunctionAppSlotStorageAccountList_Override(w WindowsFunctionAppSlotStorageAccountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSlotStorageAccountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSlotStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsFunctionAppSlotStorageAccountList) Resolve(context cdktn.IResolveContext) interface{} {
