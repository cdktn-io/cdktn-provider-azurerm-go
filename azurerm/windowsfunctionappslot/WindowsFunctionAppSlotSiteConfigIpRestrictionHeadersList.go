...
func (j *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSlotSiteConfigIpRestrictionHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsFunctionAppSlotSiteConfigIpRestrictionHeadersList {
	_init_.Initialize()
...
func NewWindowsFunctionAppSlotSiteConfigIpRestrictionHeadersList_Override(w WindowsFunctionAppSlotSiteConfigIpRestrictionHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
