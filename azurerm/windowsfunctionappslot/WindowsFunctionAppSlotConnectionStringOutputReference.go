...
func (w *jsiiProxy_WindowsFunctionAppSlotConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSlotConnectionStringOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
