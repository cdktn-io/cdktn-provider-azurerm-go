...
func (w *jsiiProxy_WindowsFunctionAppSlotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSlotTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
