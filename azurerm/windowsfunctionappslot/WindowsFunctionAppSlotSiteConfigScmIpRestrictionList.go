...
func (j *jsiiProxy_WindowsFunctionAppSlotSiteConfigScmIpRestrictionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSlotSiteConfigScmIpRestrictionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsFunctionAppSlotSiteConfigScmIpRestrictionList {
	_init_.Initialize()

	if err := validateNewWindowsFunctionAppSlotSiteConfigScmIpRestrictionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewWindowsFunctionAppSlotSiteConfigScmIpRestrictionList_Override(w WindowsFunctionAppSlotSiteConfigScmIpRestrictionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSlotSiteConfigScmIpRestrictionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigScmIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigScmIpRestrictionList) Resolve(context cdktn.IResolveContext) interface{} {
