...
func (w *jsiiProxy_WindowsFunctionAppSlotIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSlotIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
