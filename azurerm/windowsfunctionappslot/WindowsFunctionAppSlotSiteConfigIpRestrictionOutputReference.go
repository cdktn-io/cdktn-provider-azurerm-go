...
func (j *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference {
	_init_.Initialize()
...
func NewWindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference_Override(w WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference)SetDescription(val *string) {
...
func (j *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference) ResetDescription() {
	_jsii_.InvokeVoid(
		w,
		"resetDescription",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigIpRestrictionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
