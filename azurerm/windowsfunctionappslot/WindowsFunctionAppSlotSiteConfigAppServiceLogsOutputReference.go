...
func (j *jsiiProxy_WindowsFunctionAppSlotSiteConfigAppServiceLogsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSlotSiteConfigAppServiceLogsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsFunctionAppSlotSiteConfigAppServiceLogsOutputReference {
	_init_.Initialize()
...
func NewWindowsFunctionAppSlotSiteConfigAppServiceLogsOutputReference_Override(w WindowsFunctionAppSlotSiteConfigAppServiceLogsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSlotSiteConfigAppServiceLogsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigAppServiceLogsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigAppServiceLogsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigAppServiceLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSlotSiteConfigAppServiceLogsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
