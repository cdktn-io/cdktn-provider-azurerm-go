...
func (j *jsiiProxy_WindowsFunctionAppSlotConnectionStringList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSlotConnectionStringList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsFunctionAppSlotConnectionStringList {
	_init_.Initialize()
...
func NewWindowsFunctionAppSlotConnectionStringList_Override(w WindowsFunctionAppSlotConnectionStringList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSlotConnectionStringList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSlotConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsFunctionAppSlotConnectionStringList) Resolve(context cdktn.IResolveContext) interface{} {
