...
func (w *jsiiProxy_WindowsFunctionAppSlotConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsFunctionAppSlotConnectionStringList) Resolve(context cdktf.IResolveContext) interface{} {
