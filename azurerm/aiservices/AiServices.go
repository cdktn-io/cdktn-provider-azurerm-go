...
func (j *jsiiProxy_AiServices) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AiServices) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AiServices) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AiServices) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AiServices) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AiServices)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AiServices)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AiServices)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AiServices_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AiServices) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AiServices) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AiServices) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AiServices) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AiServices) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
