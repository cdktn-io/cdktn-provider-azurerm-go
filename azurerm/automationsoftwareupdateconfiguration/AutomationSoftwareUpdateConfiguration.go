...
func (j *jsiiProxy_AutomationSoftwareUpdateConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AutomationSoftwareUpdateConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AutomationSoftwareUpdateConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AutomationSoftwareUpdateConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AutomationSoftwareUpdateConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/automation_software_update_configuration azurerm_automation_software_update_configuration} Resource.
...
func (j *jsiiProxy_AutomationSoftwareUpdateConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AutomationSoftwareUpdateConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AutomationSoftwareUpdateConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AutomationSoftwareUpdateConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
