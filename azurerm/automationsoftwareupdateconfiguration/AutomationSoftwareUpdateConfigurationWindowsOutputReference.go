...
func (a *jsiiProxy_AutomationSoftwareUpdateConfigurationWindowsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfigurationWindowsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
