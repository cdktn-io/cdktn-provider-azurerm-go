...
func (a *jsiiProxy_AutomationSoftwareUpdateConfigurationPostTaskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfigurationPostTaskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
