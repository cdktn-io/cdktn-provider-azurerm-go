...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/dataazurermprivatednszonevirtualnetworklink/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/data-sources/private_dns_zone_virtual_network_link azurerm_private_dns_zone_virtual_network_link}.
type DataAzurermPrivateDnsZoneVirtualNetworkLink interface {
	...
	RegistrationEnabled() cdktn.IResolvable
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) Count() interface{} {
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) RegistrationEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) ResolutionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resolutionPolicy",
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) Tags() cdktn.StringMap {
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/data-sources/private_dns_zone_virtual_network_link azurerm_private_dns_zone_virtual_network_link} Data Source.
func NewDataAzurermPrivateDnsZoneVirtualNetworkLink(scope constructs.Construct, id *string, config *DataAzurermPrivateDnsZoneVirtualNetworkLinkConfig) DataAzurermPrivateDnsZoneVirtualNetworkLink {
	...
	if err := validateNewDataAzurermPrivateDnsZoneVirtualNetworkLinkParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermPrivateDnsZoneVirtualNetworkLink.DataAzurermPrivateDnsZoneVirtualNetworkLink",
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermPrivateDnsZoneVirtualNetworkLink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAzurermPrivateDnsZoneVirtualNetworkLink_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAzurermPrivateDnsZoneVirtualNetworkLink_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAzurermPrivateDnsZoneVirtualNetworkLink_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermPrivateDnsZoneVirtualNetworkLink_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermPrivateDnsZoneVirtualNetworkLink_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermPrivateDnsZoneVirtualNetworkLink_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermPrivateDnsZoneVirtualNetworkLink_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAzurermPrivateDnsZoneVirtualNetworkLink) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
