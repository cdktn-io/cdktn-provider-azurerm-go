...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/networksecuritygroup/internal"
...
func (j *jsiiProxy_NetworkSecurityGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NetworkSecurityGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NetworkSecurityGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkSecurityGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NetworkSecurityGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewNetworkSecurityGroup(scope constructs.Construct, id *string, config *NetworkSecurityGroupConfig) NetworkSecurityGroup {
	...
	if err := validateNewNetworkSecurityGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_NetworkSecurityGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NetworkSecurityGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NetworkSecurityGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NetworkSecurityGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateNetworkSecurityGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func NetworkSecurityGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateNetworkSecurityGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func NetworkSecurityGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNetworkSecurityGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func NetworkSecurityGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNetworkSecurityGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (n *jsiiProxy_NetworkSecurityGroup) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkSecurityGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkSecurityGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NetworkSecurityGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NetworkSecurityGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkSecurityGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkSecurityGroup) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkSecurityGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (n *jsiiProxy_NetworkSecurityGroup) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkSecurityGroup) PutSecurityRule(value interface{}) {
	if err := n.validatePutSecurityRuleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
...
func (n *jsiiProxy_NetworkSecurityGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkSecurityGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NetworkSecurityGroup) ToHclTerraform() interface{} {
	var returns interface{}
