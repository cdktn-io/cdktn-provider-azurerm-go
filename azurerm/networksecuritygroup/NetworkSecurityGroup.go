...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/network_security_group azurerm_network_security_group} Resource.
...
func NetworkSecurityGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkSecurityGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
