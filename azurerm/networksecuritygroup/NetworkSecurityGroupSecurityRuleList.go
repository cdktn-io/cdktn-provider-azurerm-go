...
func (j *jsiiProxy_NetworkSecurityGroupSecurityRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkSecurityGroupSecurityRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkSecurityGroupSecurityRuleList {
	_init_.Initialize()

	if err := validateNewNetworkSecurityGroupSecurityRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewNetworkSecurityGroupSecurityRuleList_Override(n NetworkSecurityGroupSecurityRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkSecurityGroupSecurityRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkSecurityGroupSecurityRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkSecurityGroupSecurityRuleList) Resolve(context cdktn.IResolveContext) interface{} {
