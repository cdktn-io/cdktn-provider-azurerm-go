...
func (n *jsiiProxy_NetworkSecurityGroupSecurityRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkSecurityGroupSecurityRuleList) Resolve(context cdktf.IResolveContext) interface{} {
