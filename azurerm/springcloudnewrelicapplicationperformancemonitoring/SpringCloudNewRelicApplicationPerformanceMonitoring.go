...
func (j *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/spring_cloud_new_relic_application_performance_monitoring azurerm_spring_cloud_new_relic_application_performance_monitoring} Resource.
...
func (j *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SpringCloudNewRelicApplicationPerformanceMonitoring_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SpringCloudNewRelicApplicationPerformanceMonitoring) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
