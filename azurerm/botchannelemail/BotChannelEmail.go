...
func (j *jsiiProxy_BotChannelEmail) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BotChannelEmail) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_BotChannelEmail) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BotChannelEmail) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BotChannelEmail) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BotChannelEmail) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewBotChannelEmail(scope constructs.Construct, id *string, config *BotChannelEmailConfig) BotChannelEmail {
	...
	if err := validateNewBotChannelEmailParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_BotChannelEmail)SetCount(val interface{}) {
...
func (j *jsiiProxy_BotChannelEmail)SetEmailPassword(val *string) {
	if err := j.validateSetEmailPasswordParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_BotChannelEmail)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BotChannelEmail)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BotChannelEmail)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BotChannelEmail_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateBotChannelEmail_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func BotChannelEmail_IsConstruct(x interface{}) *bool {
	...
	if err := validateBotChannelEmail_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func BotChannelEmail_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateBotChannelEmail_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func BotChannelEmail_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateBotChannelEmail_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (b *jsiiProxy_BotChannelEmail) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BotChannelEmail) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelEmail) HasResourceMove() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BotChannelEmail) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BotChannelEmail) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelEmail) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BotChannelEmail) MoveFromId(id *string) {
...
func (b *jsiiProxy_BotChannelEmail) MoveTo(moveTarget *string, index interface{}) {
...
func (b *jsiiProxy_BotChannelEmail) MoveToId(id *string) {
...
func (b *jsiiProxy_BotChannelEmail) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BotChannelEmail) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BotChannelEmail) ToHclTerraform() interface{} {
	var returns interface{}
