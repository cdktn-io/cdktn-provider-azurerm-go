...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "magicCode", GoGetter: "MagicCode"},
			_jsii_.MemberProperty{JsiiProperty: "magicCodeInput", GoGetter: "MagicCodeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEmailPassword", GoMethod: "ResetEmailPassword"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetMagicCode", GoMethod: "ResetMagicCode"},
