...
func (j *jsiiProxy_DataAzurermApiManagementGatewayLocationDataList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermApiManagementGatewayLocationDataList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermApiManagementGatewayLocationDataList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermApiManagementGateway.DataAzurermApiManagementGatewayLocationDataList",
...
func NewDataAzurermApiManagementGatewayLocationDataList_Override(d DataAzurermApiManagementGatewayLocationDataList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermApiManagementGatewayLocationDataList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermApiManagementGatewayLocationDataList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermApiManagementGatewayLocationDataList) Resolve(context cdktn.IResolveContext) interface{} {
