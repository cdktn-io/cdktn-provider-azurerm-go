...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "mongoClusterId", GoGetter: "MongoClusterId"},
			_jsii_.MemberProperty{JsiiProperty: "mongoClusterIdInput", GoGetter: "MongoClusterIdInput"},
