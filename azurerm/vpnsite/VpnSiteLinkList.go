...
func (j *jsiiProxy_VpnSiteLinkList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnSiteLinkList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpnSiteLinkList {
	_init_.Initialize()

	if err := validateNewVpnSiteLinkListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewVpnSiteLinkList_Override(v VpnSiteLinkList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnSiteLinkList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnSiteLinkList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpnSiteLinkList) Resolve(context cdktn.IResolveContext) interface{} {
