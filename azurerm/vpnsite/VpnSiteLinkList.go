...
func (v *jsiiProxy_VpnSiteLinkList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpnSiteLinkList) Resolve(context cdktf.IResolveContext) interface{} {
