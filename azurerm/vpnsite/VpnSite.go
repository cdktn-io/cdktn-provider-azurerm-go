...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/vpnsite/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/vpn_site azurerm_vpn_site}.
...
func (j *jsiiProxy_VpnSite) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VpnSite) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VpnSite) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VpnSite) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpnSite) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VpnSite) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/vpn_site azurerm_vpn_site} Resource.
func NewVpnSite(scope constructs.Construct, id *string, config *VpnSiteConfig) VpnSite {
	_init_.Initialize()

	if err := validateNewVpnSiteParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_VpnSite{}
...
func (j *jsiiProxy_VpnSite)SetAddressCidrs(val *[]*string) {
	if err := j.validateSetAddressCidrsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VpnSite)SetCount(val interface{}) {
...
func (j *jsiiProxy_VpnSite)SetDeviceModel(val *string) {
	if err := j.validateSetDeviceModelParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VpnSite)SetDeviceVendor(val *string) {
	if err := j.validateSetDeviceVendorParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VpnSite)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VpnSite)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VpnSite)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VpnSite_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateVpnSite_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VpnSite_IsConstruct(x interface{}) *bool {
	...
	if err := validateVpnSite_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VpnSite_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVpnSite_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VpnSite_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVpnSite_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VpnSite) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpnSite) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnSite) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VpnSite) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VpnSite) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnSite) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VpnSite) MoveFromId(id *string) {
...
func (v *jsiiProxy_VpnSite) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VpnSite) MoveToId(id *string) {
...
func (v *jsiiProxy_VpnSite) PutLink(value interface{}) {
	if err := v.validatePutLinkParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		v,
...
func (v *jsiiProxy_VpnSite) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VpnSite) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VpnSite) ToHclTerraform() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VpnSite) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
