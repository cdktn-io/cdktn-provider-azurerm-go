...
func (v *jsiiProxy_VpnSiteLinkBgpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnSiteLinkBgpOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
