...
func (j *jsiiProxy_VpnSiteLinkBgpOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVpnSiteLinkBgpOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VpnSiteLinkBgpOutputReference {
	_init_.Initialize()

	if err := validateNewVpnSiteLinkBgpOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewVpnSiteLinkBgpOutputReference_Override(v VpnSiteLinkBgpOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_VpnSiteLinkBgpOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VpnSiteLinkBgpOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnSiteLinkBgpOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VpnSiteLinkBgpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VpnSiteLinkBgpOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
