...
func (d *jsiiProxy_DataAzurermLogicAppStandardSiteConfigIpRestrictionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardSiteConfigIpRestrictionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
