...
type DataAzurermLogicAppStandard interface {
	...
	ScmPublishBasicAuthenticationEnabled() cdktn.IResolvable
	...
	UseExtensionBundle() cdktn.IResolvable
	Version() *string
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) AppSettings() cdktn.StringMap {
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) ClientAffinityEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) Count() interface{} {
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) Enabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) FtpPublishBasicAuthenticationEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) HttpsOnly() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"httpsOnly",
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) ScmPublishBasicAuthenticationEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAzurermLogicAppStandard) UseExtensionBundle() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"useExtensionBundle",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/data-sources/logic_app_standard azurerm_logic_app_standard} Data Source.
func NewDataAzurermLogicAppStandard(scope constructs.Construct, id *string, config *DataAzurermLogicAppStandardConfig) DataAzurermLogicAppStandard {
	...
	if err := validateNewDataAzurermLogicAppStandardParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataAzurermLogicAppStandard)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataAzurermLogicAppStandard)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermLogicAppStandard)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermLogicAppStandard)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermLogicAppStandard_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAzurermLogicAppStandard_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAzurermLogicAppStandard_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAzurermLogicAppStandard_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAzurermLogicAppStandard) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermLogicAppStandard) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermLogicAppStandard) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermLogicAppStandard) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermLogicAppStandard) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAzurermLogicAppStandard) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
