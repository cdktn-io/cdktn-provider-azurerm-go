...
func (j *jsiiProxy_DataAzurermLogicAppStandardTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermLogicAppStandardTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataAzurermLogicAppStandardTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDataAzurermLogicAppStandardTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewDataAzurermLogicAppStandardTimeoutsOutputReference_Override(d DataAzurermLogicAppStandardTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermLogicAppStandardTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAzurermLogicAppStandardTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
