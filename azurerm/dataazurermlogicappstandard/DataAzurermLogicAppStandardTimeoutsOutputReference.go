...
func (d *jsiiProxy_DataAzurermLogicAppStandardTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
