...
func (j *jsiiProxy_DataAzurermLogicAppStandardSiteCredentialList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermLogicAppStandardSiteCredentialList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermLogicAppStandardSiteCredentialList {
	_init_.Initialize()

	if err := validateNewDataAzurermLogicAppStandardSiteCredentialListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAzurermLogicAppStandardSiteCredentialList_Override(d DataAzurermLogicAppStandardSiteCredentialList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermLogicAppStandardSiteCredentialList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardSiteCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardSiteCredentialList) Resolve(context cdktn.IResolveContext) interface{} {
