...
func (d *jsiiProxy_DataAzurermLogicAppStandardIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
