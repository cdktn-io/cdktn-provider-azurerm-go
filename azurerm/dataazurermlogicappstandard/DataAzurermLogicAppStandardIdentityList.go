...
func (j *jsiiProxy_DataAzurermLogicAppStandardIdentityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermLogicAppStandardIdentityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermLogicAppStandardIdentityList {
	_init_.Initialize()

	if err := validateNewDataAzurermLogicAppStandardIdentityListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAzurermLogicAppStandardIdentityList_Override(d DataAzurermLogicAppStandardIdentityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermLogicAppStandardIdentityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardIdentityList) Resolve(context cdktn.IResolveContext) interface{} {
