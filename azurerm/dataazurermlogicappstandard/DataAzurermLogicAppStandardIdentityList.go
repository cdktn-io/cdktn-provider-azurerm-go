...
func (d *jsiiProxy_DataAzurermLogicAppStandardIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardIdentityList) Resolve(context cdktf.IResolveContext) interface{} {
