...
func (d *jsiiProxy_DataAzurermLogicAppStandardConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardConnectionStringList) Resolve(context cdktf.IResolveContext) interface{} {
