...
func (j *jsiiProxy_DataAzurermLogicAppStandardConnectionStringList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermLogicAppStandardConnectionStringList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermLogicAppStandardConnectionStringList {
	_init_.Initialize()

	if err := validateNewDataAzurermLogicAppStandardConnectionStringListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewDataAzurermLogicAppStandardConnectionStringList_Override(d DataAzurermLogicAppStandardConnectionStringList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermLogicAppStandardConnectionStringList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardConnectionStringList) Resolve(context cdktn.IResolveContext) interface{} {
