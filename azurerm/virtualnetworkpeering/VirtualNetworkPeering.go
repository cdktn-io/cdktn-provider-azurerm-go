...
func (v *jsiiProxy_VirtualNetworkPeering) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualNetworkPeering) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VirtualNetworkPeering) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
