...
func (v *jsiiProxy_VirtualNetworkPeeringTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkPeeringTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
