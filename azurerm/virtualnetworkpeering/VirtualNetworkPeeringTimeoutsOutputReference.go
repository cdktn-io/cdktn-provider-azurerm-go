...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/virtualnetworkpeering/internal"
...
func (j *jsiiProxy_VirtualNetworkPeeringTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualNetworkPeeringTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VirtualNetworkPeeringTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewVirtualNetworkPeeringTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewVirtualNetworkPeeringTimeoutsOutputReference_Override(v VirtualNetworkPeeringTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualNetworkPeeringTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualNetworkPeeringTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkPeeringTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualNetworkPeeringTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkPeeringTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
