...
func (j *jsiiProxy_StackHciVirtualHardDisk) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StackHciVirtualHardDisk) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StackHciVirtualHardDisk) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StackHciVirtualHardDisk) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StackHciVirtualHardDisk) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_StackHciVirtualHardDisk)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StackHciVirtualHardDisk)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StackHciVirtualHardDisk)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StackHciVirtualHardDisk_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StackHciVirtualHardDisk) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StackHciVirtualHardDisk) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StackHciVirtualHardDisk) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StackHciVirtualHardDisk) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StackHciVirtualHardDisk) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StackHciVirtualHardDisk) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
