...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/mssqljobcredential/internal"
...
func (j *jsiiProxy_MssqlJobCredential) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MssqlJobCredential) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MssqlJobCredential) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MssqlJobCredential) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MssqlJobCredential) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MssqlJobCredential)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MssqlJobCredential)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MssqlJobCredential)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MssqlJobCredential_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MssqlJobCredential) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlJobCredential) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MssqlJobCredential) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlJobCredential) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MssqlJobCredential) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MssqlJobCredential) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
