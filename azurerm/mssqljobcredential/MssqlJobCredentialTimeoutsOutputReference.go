...
func (j *jsiiProxy_MssqlJobCredentialTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMssqlJobCredentialTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MssqlJobCredentialTimeoutsOutputReference {
	_init_.Initialize()
...
func NewMssqlJobCredentialTimeoutsOutputReference_Override(m MssqlJobCredentialTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MssqlJobCredentialTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MssqlJobCredentialTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlJobCredentialTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MssqlJobCredentialTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlJobCredentialTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
