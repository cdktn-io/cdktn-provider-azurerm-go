...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/sentineldataconnectormicrosoftdefenderadvancedthreatprotection/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/sentinel_data_connector_microsoft_defender_advanced_threat_protection azurerm_sentinel_data_connector_microsoft_defender_advanced_threat_protection}.
...
func (j *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/sentinel_data_connector_microsoft_defender_advanced_threat_protection azurerm_sentinel_data_connector_microsoft_defender_advanced_threat_protection} Resource.
func NewSentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection(scope constructs.Construct, id *string, config *SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtectionConfig) SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.sentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection.SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection",
...
func (j *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection)SetCount(val interface{}) {
...
func (j *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection resource upon running "cdktn plan <stack-name>".
func SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) MoveFromId(id *string) {
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) MoveToId(id *string) {
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
