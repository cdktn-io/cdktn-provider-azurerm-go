...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/loganalyticsclustercustomermanagedkey/internal"
...
func (j *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/log_analytics_cluster_customer_managed_key azurerm_log_analytics_cluster_customer_managed_key} Resource.
func NewLogAnalyticsClusterCustomerManagedKey(scope constructs.Construct, id *string, config *LogAnalyticsClusterCustomerManagedKeyConfig) LogAnalyticsClusterCustomerManagedKey {
	...
	if err := validateNewLogAnalyticsClusterCustomerManagedKeyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_LogAnalyticsClusterCustomerManagedKey{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.logAnalyticsClusterCustomerManagedKey.LogAnalyticsClusterCustomerManagedKey",
...
func (j *jsiiProxy_LogAnalyticsClusterCustomerManagedKey)SetCount(val interface{}) {
...
func (j *jsiiProxy_LogAnalyticsClusterCustomerManagedKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LogAnalyticsClusterCustomerManagedKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LogAnalyticsClusterCustomerManagedKey)SetLogAnalyticsClusterId(val *string) {
	if err := j.validateSetLogAnalyticsClusterIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_LogAnalyticsClusterCustomerManagedKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LogAnalyticsClusterCustomerManagedKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateLogAnalyticsClusterCustomerManagedKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LogAnalyticsClusterCustomerManagedKey_IsConstruct(x interface{}) *bool {
	...
	if err := validateLogAnalyticsClusterCustomerManagedKey_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LogAnalyticsClusterCustomerManagedKey_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLogAnalyticsClusterCustomerManagedKey_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LogAnalyticsClusterCustomerManagedKey_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLogAnalyticsClusterCustomerManagedKey_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) MoveFromId(id *string) {
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) MoveToId(id *string) {
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) ToHclTerraform() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LogAnalyticsClusterCustomerManagedKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
