...
func (c *jsiiProxy_CosmosdbGremlinGraphAutoscaleSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbGremlinGraphAutoscaleSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
