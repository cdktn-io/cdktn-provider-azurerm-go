...
func (j *jsiiProxy_CosmosdbGremlinGraphAutoscaleSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbGremlinGraphAutoscaleSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CosmosdbGremlinGraphAutoscaleSettingsOutputReference {
	_init_.Initialize()

	if err := validateNewCosmosdbGremlinGraphAutoscaleSettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_CosmosdbGremlinGraphAutoscaleSettingsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.cosmosdbGremlinGraph.CosmosdbGremlinGraphAutoscaleSettingsOutputReference",
...
func NewCosmosdbGremlinGraphAutoscaleSettingsOutputReference_Override(c CosmosdbGremlinGraphAutoscaleSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbGremlinGraphAutoscaleSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbGremlinGraphAutoscaleSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbGremlinGraphAutoscaleSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CosmosdbGremlinGraphAutoscaleSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbGremlinGraphAutoscaleSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
