...
func (j *jsiiProxy_CosmosdbGremlinGraph) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CosmosdbGremlinGraph) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CosmosdbGremlinGraph) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CosmosdbGremlinGraph) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CosmosdbGremlinGraph) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CosmosdbGremlinGraph)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CosmosdbGremlinGraph)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CosmosdbGremlinGraph)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CosmosdbGremlinGraph_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CosmosdbGremlinGraph) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbGremlinGraph) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CosmosdbGremlinGraph) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbGremlinGraph) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CosmosdbGremlinGraph) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CosmosdbGremlinGraph) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
