...
func (j *jsiiProxy_CosmosdbGremlinGraphIndexPolicyCompositeIndexList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbGremlinGraphIndexPolicyCompositeIndexList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbGremlinGraphIndexPolicyCompositeIndexList {
	_init_.Initialize()

	if err := validateNewCosmosdbGremlinGraphIndexPolicyCompositeIndexListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_CosmosdbGremlinGraphIndexPolicyCompositeIndexList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.cosmosdbGremlinGraph.CosmosdbGremlinGraphIndexPolicyCompositeIndexList",
...
func NewCosmosdbGremlinGraphIndexPolicyCompositeIndexList_Override(c CosmosdbGremlinGraphIndexPolicyCompositeIndexList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbGremlinGraphIndexPolicyCompositeIndexList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbGremlinGraphIndexPolicyCompositeIndexList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbGremlinGraphIndexPolicyCompositeIndexList) Resolve(context cdktn.IResolveContext) interface{} {
