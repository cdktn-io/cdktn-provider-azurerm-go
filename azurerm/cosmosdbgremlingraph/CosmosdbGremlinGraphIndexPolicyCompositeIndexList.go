...
func (c *jsiiProxy_CosmosdbGremlinGraphIndexPolicyCompositeIndexList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbGremlinGraphIndexPolicyCompositeIndexList) Resolve(context cdktf.IResolveContext) interface{} {
