...
func (j *jsiiProxy_CosmosdbGremlinGraphUniqueKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbGremlinGraphUniqueKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbGremlinGraphUniqueKeyList {
	_init_.Initialize()
...
func NewCosmosdbGremlinGraphUniqueKeyList_Override(c CosmosdbGremlinGraphUniqueKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbGremlinGraphUniqueKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbGremlinGraphUniqueKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbGremlinGraphUniqueKeyList) Resolve(context cdktn.IResolveContext) interface{} {
