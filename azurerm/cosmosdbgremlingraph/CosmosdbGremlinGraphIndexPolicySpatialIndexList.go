...
func (j *jsiiProxy_CosmosdbGremlinGraphIndexPolicySpatialIndexList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbGremlinGraphIndexPolicySpatialIndexList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbGremlinGraphIndexPolicySpatialIndexList {
	_init_.Initialize()
...
func NewCosmosdbGremlinGraphIndexPolicySpatialIndexList_Override(c CosmosdbGremlinGraphIndexPolicySpatialIndexList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbGremlinGraphIndexPolicySpatialIndexList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbGremlinGraphIndexPolicySpatialIndexList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbGremlinGraphIndexPolicySpatialIndexList) Resolve(context cdktn.IResolveContext) interface{} {
