...
func (c *jsiiProxy_CosmosdbGremlinGraphConflictResolutionPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbGremlinGraphConflictResolutionPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
