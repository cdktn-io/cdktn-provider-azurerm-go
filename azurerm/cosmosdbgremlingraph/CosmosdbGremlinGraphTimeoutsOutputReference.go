...
func (j *jsiiProxy_CosmosdbGremlinGraphTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbGremlinGraphTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CosmosdbGremlinGraphTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewCosmosdbGremlinGraphTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_CosmosdbGremlinGraphTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.cosmosdbGremlinGraph.CosmosdbGremlinGraphTimeoutsOutputReference",
...
func NewCosmosdbGremlinGraphTimeoutsOutputReference_Override(c CosmosdbGremlinGraphTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbGremlinGraphTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbGremlinGraphTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbGremlinGraphTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CosmosdbGremlinGraphTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbGremlinGraphTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
