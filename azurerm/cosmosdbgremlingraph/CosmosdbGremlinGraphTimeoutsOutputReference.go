...
func (c *jsiiProxy_CosmosdbGremlinGraphTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbGremlinGraphTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
