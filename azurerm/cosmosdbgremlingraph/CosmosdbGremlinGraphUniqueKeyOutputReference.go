...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/cosmosdbgremlingraph/internal"
...
func (j *jsiiProxy_CosmosdbGremlinGraphUniqueKeyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbGremlinGraphUniqueKeyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CosmosdbGremlinGraphUniqueKeyOutputReference {
	_init_.Initialize()

	if err := validateNewCosmosdbGremlinGraphUniqueKeyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_CosmosdbGremlinGraphUniqueKeyOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.cosmosdbGremlinGraph.CosmosdbGremlinGraphUniqueKeyOutputReference",
...
func NewCosmosdbGremlinGraphUniqueKeyOutputReference_Override(c CosmosdbGremlinGraphUniqueKeyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbGremlinGraphUniqueKeyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbGremlinGraphUniqueKeyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbGremlinGraphUniqueKeyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CosmosdbGremlinGraphUniqueKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbGremlinGraphUniqueKeyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
