...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/dataazurermservicebusqueueauthorizationrule/internal"
...
func (j *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) Listen() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) Manage() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"manage",
...
func (j *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) Send() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"send",
...
func (j *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/servicebus_queue_authorization_rule azurerm_servicebus_queue_authorization_rule} Data Source.
func NewDataAzurermServicebusQueueAuthorizationRule(scope constructs.Construct, id *string, config *DataAzurermServicebusQueueAuthorizationRuleConfig) DataAzurermServicebusQueueAuthorizationRule {
	...
	if err := validateNewDataAzurermServicebusQueueAuthorizationRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataAzurermServicebusQueueAuthorizationRule{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermServicebusQueueAuthorizationRule.DataAzurermServicebusQueueAuthorizationRule",
...
func (j *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermServicebusQueueAuthorizationRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataAzurermServicebusQueueAuthorizationRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAzurermServicebusQueueAuthorizationRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAzurermServicebusQueueAuthorizationRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermServicebusQueueAuthorizationRule_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermServicebusQueueAuthorizationRule_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermServicebusQueueAuthorizationRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermServicebusQueueAuthorizationRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAzurermServicebusQueueAuthorizationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
