...
func (h *jsiiProxy_HealthcareServiceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareServiceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
