...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v14/healthcareservice/internal"
...
func (h *jsiiProxy_HealthcareServiceAuthenticationConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareServiceAuthenticationConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
