...
func (s *jsiiProxy_SpringCloudJavaDeploymentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudJavaDeploymentTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
