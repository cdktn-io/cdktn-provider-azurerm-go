...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/springcloudjavadeployment/internal"
...
func (j *jsiiProxy_SpringCloudJavaDeploymentTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudJavaDeploymentTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SpringCloudJavaDeploymentTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSpringCloudJavaDeploymentTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SpringCloudJavaDeploymentTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.springCloudJavaDeployment.SpringCloudJavaDeploymentTimeoutsOutputReference",
...
func NewSpringCloudJavaDeploymentTimeoutsOutputReference_Override(s SpringCloudJavaDeploymentTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudJavaDeploymentTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudJavaDeploymentTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudJavaDeploymentTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SpringCloudJavaDeploymentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudJavaDeploymentTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
