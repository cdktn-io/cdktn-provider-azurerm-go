...
func (l *jsiiProxy_LogicAppTriggerRecurrenceScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppTriggerRecurrenceScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
