...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "atTheseHoursInput", GoGetter: "AtTheseHoursInput"},
			_jsii_.MemberProperty{JsiiProperty: "atTheseMinutes", GoGetter: "AtTheseMinutes"},
			_jsii_.MemberProperty{JsiiProperty: "atTheseMinutesInput", GoGetter: "AtTheseMinutesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "onTheseDays", GoGetter: "OnTheseDays"},
			_jsii_.MemberProperty{JsiiProperty: "onTheseDaysInput", GoGetter: "OnTheseDaysInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAtTheseHours", GoMethod: "ResetAtTheseHours"},
			_jsii_.MemberMethod{JsiiMethod: "resetAtTheseMinutes", GoMethod: "ResetAtTheseMinutes"},
			_jsii_.MemberMethod{JsiiMethod: "resetOnTheseDays", GoMethod: "ResetOnTheseDays"},
