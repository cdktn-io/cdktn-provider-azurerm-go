...
func (b *jsiiProxy_BatchPoolMountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchPoolMountOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
