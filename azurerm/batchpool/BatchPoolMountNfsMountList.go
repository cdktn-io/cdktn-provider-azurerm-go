...
func (j *jsiiProxy_BatchPoolMountNfsMountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolMountNfsMountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolMountNfsMountList {
	_init_.Initialize()

	if err := validateNewBatchPoolMountNfsMountListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewBatchPoolMountNfsMountList_Override(b BatchPoolMountNfsMountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolMountNfsMountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolMountNfsMountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolMountNfsMountList) Resolve(context cdktn.IResolveContext) interface{} {
