...
func (b *jsiiProxy_BatchPoolMountNfsMountList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolMountNfsMountList) Resolve(context cdktf.IResolveContext) interface{} {
