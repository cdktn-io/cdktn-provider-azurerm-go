...
func (j *jsiiProxy_BatchPoolMountCifsMountOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolMountCifsMountOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchPoolMountCifsMountOutputReference {
	_init_.Initialize()
...
func NewBatchPoolMountCifsMountOutputReference_Override(b BatchPoolMountCifsMountOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolMountCifsMountOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolMountCifsMountOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolMountCifsMountOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchPoolMountCifsMountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolMountCifsMountOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
