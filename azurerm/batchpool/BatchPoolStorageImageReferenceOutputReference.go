...
func (j *jsiiProxy_BatchPoolStorageImageReferenceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolStorageImageReferenceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BatchPoolStorageImageReferenceOutputReference {
	_init_.Initialize()

	if err := validateNewBatchPoolStorageImageReferenceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewBatchPoolStorageImageReferenceOutputReference_Override(b BatchPoolStorageImageReferenceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolStorageImageReferenceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolStorageImageReferenceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolStorageImageReferenceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchPoolStorageImageReferenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolStorageImageReferenceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
