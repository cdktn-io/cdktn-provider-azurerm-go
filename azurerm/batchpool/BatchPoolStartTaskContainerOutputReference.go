...
func (j *jsiiProxy_BatchPoolStartTaskContainerOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolStartTaskContainerOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchPoolStartTaskContainerOutputReference {
	_init_.Initialize()
...
func NewBatchPoolStartTaskContainerOutputReference_Override(b BatchPoolStartTaskContainerOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolStartTaskContainerOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolStartTaskContainerOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolStartTaskContainerOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchPoolStartTaskContainerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolStartTaskContainerOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
