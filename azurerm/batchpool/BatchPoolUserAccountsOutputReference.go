...
func (j *jsiiProxy_BatchPoolUserAccountsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolUserAccountsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchPoolUserAccountsOutputReference {
	_init_.Initialize()
...
func NewBatchPoolUserAccountsOutputReference_Override(b BatchPoolUserAccountsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolUserAccountsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolUserAccountsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolUserAccountsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchPoolUserAccountsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolUserAccountsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
