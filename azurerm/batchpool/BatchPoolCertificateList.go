...
func (j *jsiiProxy_BatchPoolCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolCertificateList {
	_init_.Initialize()
...
func NewBatchPoolCertificateList_Override(b BatchPoolCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
