...
func (j *jsiiProxy_BatchPoolMountNfsMountOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolMountNfsMountOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchPoolMountNfsMountOutputReference {
	_init_.Initialize()
...
func NewBatchPoolMountNfsMountOutputReference_Override(b BatchPoolMountNfsMountOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolMountNfsMountOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolMountNfsMountOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolMountNfsMountOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchPoolMountNfsMountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolMountNfsMountOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
