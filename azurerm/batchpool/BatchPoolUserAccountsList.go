...
func (j *jsiiProxy_BatchPoolUserAccountsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolUserAccountsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolUserAccountsList {
	_init_.Initialize()
...
func NewBatchPoolUserAccountsList_Override(b BatchPoolUserAccountsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolUserAccountsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolUserAccountsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolUserAccountsList) Resolve(context cdktn.IResolveContext) interface{} {
