...
func (b *jsiiProxy_BatchPoolUserAccountsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolUserAccountsList) Resolve(context cdktf.IResolveContext) interface{} {
