...
func (j *jsiiProxy_BatchPoolDiskEncryptionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolDiskEncryptionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolDiskEncryptionList {
	_init_.Initialize()
...
func NewBatchPoolDiskEncryptionList_Override(b BatchPoolDiskEncryptionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolDiskEncryptionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolDiskEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolDiskEncryptionList) Resolve(context cdktn.IResolveContext) interface{} {
