...
func (b *jsiiProxy_BatchPoolDiskEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolDiskEncryptionList) Resolve(context cdktf.IResolveContext) interface{} {
