...
func (b *jsiiProxy_BatchPoolNodePlacementList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolNodePlacementList) Resolve(context cdktf.IResolveContext) interface{} {
