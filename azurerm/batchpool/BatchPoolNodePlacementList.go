...
func (j *jsiiProxy_BatchPoolNodePlacementList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolNodePlacementList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolNodePlacementList {
	_init_.Initialize()

	if err := validateNewBatchPoolNodePlacementListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewBatchPoolNodePlacementList_Override(b BatchPoolNodePlacementList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolNodePlacementList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolNodePlacementList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolNodePlacementList) Resolve(context cdktn.IResolveContext) interface{} {
