...
func (b *jsiiProxy_BatchPoolTaskSchedulingPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchPoolTaskSchedulingPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
