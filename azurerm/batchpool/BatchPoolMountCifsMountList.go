...
func (j *jsiiProxy_BatchPoolMountCifsMountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolMountCifsMountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolMountCifsMountList {
	_init_.Initialize()
...
func NewBatchPoolMountCifsMountList_Override(b BatchPoolMountCifsMountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolMountCifsMountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolMountCifsMountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolMountCifsMountList) Resolve(context cdktn.IResolveContext) interface{} {
