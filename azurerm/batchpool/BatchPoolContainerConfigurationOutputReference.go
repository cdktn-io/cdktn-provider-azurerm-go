...
func (b *jsiiProxy_BatchPoolContainerConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchPoolContainerConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
