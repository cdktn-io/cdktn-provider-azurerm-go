...
func (j *jsiiProxy_BatchPoolWindowsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolWindowsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolWindowsList {
	_init_.Initialize()
...
func NewBatchPoolWindowsList_Override(b BatchPoolWindowsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolWindowsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolWindowsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolWindowsList) Resolve(context cdktn.IResolveContext) interface{} {
