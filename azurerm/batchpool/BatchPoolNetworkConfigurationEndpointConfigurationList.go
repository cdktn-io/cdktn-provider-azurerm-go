...
func (j *jsiiProxy_BatchPoolNetworkConfigurationEndpointConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolNetworkConfigurationEndpointConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolNetworkConfigurationEndpointConfigurationList {
	_init_.Initialize()
...
func NewBatchPoolNetworkConfigurationEndpointConfigurationList_Override(b BatchPoolNetworkConfigurationEndpointConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolNetworkConfigurationEndpointConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolNetworkConfigurationEndpointConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolNetworkConfigurationEndpointConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
