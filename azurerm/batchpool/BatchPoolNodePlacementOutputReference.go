...
func (j *jsiiProxy_BatchPoolNodePlacementOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolNodePlacementOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchPoolNodePlacementOutputReference {
	_init_.Initialize()
...
func NewBatchPoolNodePlacementOutputReference_Override(b BatchPoolNodePlacementOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolNodePlacementOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolNodePlacementOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolNodePlacementOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchPoolNodePlacementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolNodePlacementOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
