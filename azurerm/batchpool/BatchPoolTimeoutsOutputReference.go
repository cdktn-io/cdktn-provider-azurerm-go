...
func (j *jsiiProxy_BatchPoolTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BatchPoolTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewBatchPoolTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewBatchPoolTimeoutsOutputReference_Override(b BatchPoolTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchPoolTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
