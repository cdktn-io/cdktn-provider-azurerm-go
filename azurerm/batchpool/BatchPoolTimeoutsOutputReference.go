...
func (b *jsiiProxy_BatchPoolTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchPoolTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
