...
func (j *jsiiProxy_BatchPoolMountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolMountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolMountList {
	_init_.Initialize()
...
func NewBatchPoolMountList_Override(b BatchPoolMountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolMountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolMountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolMountList) Resolve(context cdktn.IResolveContext) interface{} {
