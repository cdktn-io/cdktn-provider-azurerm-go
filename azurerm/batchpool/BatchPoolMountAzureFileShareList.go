...
func (j *jsiiProxy_BatchPoolMountAzureFileShareList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolMountAzureFileShareList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolMountAzureFileShareList {
	_init_.Initialize()
...
func NewBatchPoolMountAzureFileShareList_Override(b BatchPoolMountAzureFileShareList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolMountAzureFileShareList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolMountAzureFileShareList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolMountAzureFileShareList) Resolve(context cdktn.IResolveContext) interface{} {
