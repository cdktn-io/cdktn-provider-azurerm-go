...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/batch_pool azurerm_batch_pool} Resource.
...
func (b *jsiiProxy_BatchPool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BatchPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
