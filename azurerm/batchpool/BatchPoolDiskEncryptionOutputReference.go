...
func (b *jsiiProxy_BatchPoolDiskEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchPoolDiskEncryptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
