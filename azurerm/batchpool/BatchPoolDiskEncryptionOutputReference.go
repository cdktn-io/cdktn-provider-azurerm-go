...
func (j *jsiiProxy_BatchPoolDiskEncryptionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolDiskEncryptionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchPoolDiskEncryptionOutputReference {
	_init_.Initialize()
...
func NewBatchPoolDiskEncryptionOutputReference_Override(b BatchPoolDiskEncryptionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolDiskEncryptionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolDiskEncryptionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolDiskEncryptionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchPoolDiskEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolDiskEncryptionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
