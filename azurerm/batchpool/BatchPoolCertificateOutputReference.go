...
func (b *jsiiProxy_BatchPoolCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchPoolCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
