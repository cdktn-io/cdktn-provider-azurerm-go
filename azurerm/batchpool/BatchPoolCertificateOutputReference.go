...
func (j *jsiiProxy_BatchPoolCertificateOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolCertificateOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchPoolCertificateOutputReference {
	_init_.Initialize()
...
func NewBatchPoolCertificateOutputReference_Override(b BatchPoolCertificateOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolCertificateOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolCertificateOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolCertificateOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchPoolCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchPoolCertificateOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
