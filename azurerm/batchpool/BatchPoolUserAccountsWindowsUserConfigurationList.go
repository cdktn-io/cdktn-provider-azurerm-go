...
func (j *jsiiProxy_BatchPoolUserAccountsWindowsUserConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolUserAccountsWindowsUserConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolUserAccountsWindowsUserConfigurationList {
	_init_.Initialize()
...
func NewBatchPoolUserAccountsWindowsUserConfigurationList_Override(b BatchPoolUserAccountsWindowsUserConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolUserAccountsWindowsUserConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolUserAccountsWindowsUserConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolUserAccountsWindowsUserConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
