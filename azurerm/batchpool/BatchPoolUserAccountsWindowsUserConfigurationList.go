...
func (b *jsiiProxy_BatchPoolUserAccountsWindowsUserConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolUserAccountsWindowsUserConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
