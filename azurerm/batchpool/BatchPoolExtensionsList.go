...
func (j *jsiiProxy_BatchPoolExtensionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolExtensionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolExtensionsList {
	_init_.Initialize()

	if err := validateNewBatchPoolExtensionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewBatchPoolExtensionsList_Override(b BatchPoolExtensionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolExtensionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolExtensionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolExtensionsList) Resolve(context cdktn.IResolveContext) interface{} {
