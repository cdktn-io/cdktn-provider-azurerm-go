...
func (b *jsiiProxy_BatchPoolExtensionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolExtensionsList) Resolve(context cdktf.IResolveContext) interface{} {
