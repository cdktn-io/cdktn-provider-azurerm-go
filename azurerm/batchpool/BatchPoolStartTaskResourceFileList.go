...
func (j *jsiiProxy_BatchPoolStartTaskResourceFileList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolStartTaskResourceFileList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolStartTaskResourceFileList {
	_init_.Initialize()
...
func NewBatchPoolStartTaskResourceFileList_Override(b BatchPoolStartTaskResourceFileList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolStartTaskResourceFileList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolStartTaskResourceFileList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolStartTaskResourceFileList) Resolve(context cdktn.IResolveContext) interface{} {
