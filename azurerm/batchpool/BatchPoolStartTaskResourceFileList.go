...
func (b *jsiiProxy_BatchPoolStartTaskResourceFileList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolStartTaskResourceFileList) Resolve(context cdktf.IResolveContext) interface{} {
