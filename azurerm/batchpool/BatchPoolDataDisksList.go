...
func (b *jsiiProxy_BatchPoolDataDisksList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolDataDisksList) Resolve(context cdktf.IResolveContext) interface{} {
