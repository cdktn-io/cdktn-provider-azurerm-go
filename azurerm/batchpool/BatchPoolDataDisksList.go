...
func (j *jsiiProxy_BatchPoolDataDisksList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchPoolDataDisksList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolDataDisksList {
	_init_.Initialize()

	if err := validateNewBatchPoolDataDisksListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewBatchPoolDataDisksList_Override(b BatchPoolDataDisksList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchPoolDataDisksList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchPoolDataDisksList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolDataDisksList) Resolve(context cdktn.IResolveContext) interface{} {
