...
func (v *jsiiProxy_VirtualNetworkGateway) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (v *jsiiProxy_VirtualNetworkGateway) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (v *jsiiProxy_VirtualNetworkGateway) validatePutIpConfigurationParameters(value interface{}) error {
	...
	case *[]*VirtualNetworkGatewayIpConfiguration:
		value := value.(*[]*VirtualNetworkGatewayIpConfiguration)
	...
	case []*VirtualNetworkGatewayIpConfiguration:
		value_ := value.([]*VirtualNetworkGatewayIpConfiguration)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*VirtualNetworkGatewayIpConfiguration; received %#v (a %T)", value, value)
		}
	}
...
func (v *jsiiProxy_VirtualNetworkGateway) validatePutPolicyGroupParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*VirtualNetworkGatewayPolicyGroup; received %#v (a %T)", value, value)
		}
	}
...
func validateVirtualNetworkGateway_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func (j *jsiiProxy_VirtualNetworkGateway) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
