...
func (v *jsiiProxy_VirtualNetworkGatewayBgpSettingsPeeringAddressesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkGatewayBgpSettingsPeeringAddressesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
