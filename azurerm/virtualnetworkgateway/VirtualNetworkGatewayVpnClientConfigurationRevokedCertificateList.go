...
func (j *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList {
	_init_.Initialize()
...
func NewVirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList_Override(v VirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRevokedCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
