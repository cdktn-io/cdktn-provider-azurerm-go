...
func (j *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRootCertificateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualNetworkGatewayVpnClientConfigurationRootCertificateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualNetworkGatewayVpnClientConfigurationRootCertificateList {
	_init_.Initialize()
...
func NewVirtualNetworkGatewayVpnClientConfigurationRootCertificateList_Override(v VirtualNetworkGatewayVpnClientConfigurationRootCertificateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRootCertificateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRootCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRootCertificateList) Resolve(context cdktn.IResolveContext) interface{} {
