...
func (v *jsiiProxy_VirtualNetworkGatewayTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkGatewayTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
