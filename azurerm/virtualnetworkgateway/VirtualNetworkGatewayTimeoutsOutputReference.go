...
func (j *jsiiProxy_VirtualNetworkGatewayTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualNetworkGatewayTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VirtualNetworkGatewayTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewVirtualNetworkGatewayTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_VirtualNetworkGatewayTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.virtualNetworkGateway.VirtualNetworkGatewayTimeoutsOutputReference",
...
func NewVirtualNetworkGatewayTimeoutsOutputReference_Override(v VirtualNetworkGatewayTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualNetworkGatewayTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualNetworkGatewayTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkGatewayTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualNetworkGatewayTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkGatewayTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
