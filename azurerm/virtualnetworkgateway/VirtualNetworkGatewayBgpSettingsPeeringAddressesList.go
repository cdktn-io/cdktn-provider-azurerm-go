...
func (v *jsiiProxy_VirtualNetworkGatewayBgpSettingsPeeringAddressesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualNetworkGatewayBgpSettingsPeeringAddressesList) Resolve(context cdktf.IResolveContext) interface{} {
