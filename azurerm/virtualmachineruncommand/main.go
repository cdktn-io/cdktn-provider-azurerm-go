...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "errorBlobManagedIdentity", GoGetter: "ErrorBlobManagedIdentity"},
			_jsii_.MemberProperty{JsiiProperty: "errorBlobManagedIdentityInput", GoGetter: "ErrorBlobManagedIdentityInput"},
			_jsii_.MemberProperty{JsiiProperty: "errorBlobUri", GoGetter: "ErrorBlobUri"},
			_jsii_.MemberProperty{JsiiProperty: "errorBlobUriInput", GoGetter: "ErrorBlobUriInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "instanceView", GoGetter: "InstanceView"},
			...
			_jsii_.MemberProperty{JsiiProperty: "outputBlobManagedIdentity", GoGetter: "OutputBlobManagedIdentity"},
			_jsii_.MemberProperty{JsiiProperty: "outputBlobManagedIdentityInput", GoGetter: "OutputBlobManagedIdentityInput"},
			_jsii_.MemberProperty{JsiiProperty: "outputBlobUri", GoGetter: "OutputBlobUri"},
			_jsii_.MemberProperty{JsiiProperty: "outputBlobUriInput", GoGetter: "OutputBlobUriInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "protectedParameter", GoGetter: "ProtectedParameter"},
			_jsii_.MemberProperty{JsiiProperty: "protectedParameterInput", GoGetter: "ProtectedParameterInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putErrorBlobManagedIdentity", GoMethod: "PutErrorBlobManagedIdentity"},
			_jsii_.MemberMethod{JsiiMethod: "putOutputBlobManagedIdentity", GoMethod: "PutOutputBlobManagedIdentity"},
			_jsii_.MemberMethod{JsiiMethod: "putParameter", GoMethod: "PutParameter"},
			_jsii_.MemberMethod{JsiiMethod: "putProtectedParameter", GoMethod: "PutProtectedParameter"},
			_jsii_.MemberMethod{JsiiMethod: "putSource", GoMethod: "PutSource"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "registerProviderFeatureUsage", GoMethod: "RegisterProviderFeatureUsage"},
			_jsii_.MemberMethod{JsiiMethod: "resetErrorBlobManagedIdentity", GoMethod: "ResetErrorBlobManagedIdentity"},
			_jsii_.MemberMethod{JsiiMethod: "resetErrorBlobUri", GoMethod: "ResetErrorBlobUri"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOutputBlobManagedIdentity", GoMethod: "ResetOutputBlobManagedIdentity"},
			_jsii_.MemberMethod{JsiiMethod: "resetOutputBlobUri", GoMethod: "ResetOutputBlobUri"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetParameter", GoMethod: "ResetParameter"},
			_jsii_.MemberMethod{JsiiMethod: "resetProtectedParameter", GoMethod: "ResetProtectedParameter"},
			_jsii_.MemberMethod{JsiiMethod: "resetRunAsPassword", GoMethod: "ResetRunAsPassword"},
			_jsii_.MemberMethod{JsiiMethod: "resetRunAsUser", GoMethod: "ResetRunAsUser"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "runAsPassword", GoGetter: "RunAsPassword"},
			_jsii_.MemberProperty{JsiiProperty: "runAsPasswordInput", GoGetter: "RunAsPasswordInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_VirtualMachineRunCommandInstanceViewList{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "executionMessage", GoGetter: "ExecutionMessage"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_VirtualMachineRunCommandParameterList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_VirtualMachineRunCommandProtectedParameterList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putScriptUriManagedIdentity", GoMethod: "PutScriptUriManagedIdentity"},
			_jsii_.MemberMethod{JsiiMethod: "resetCommandId", GoMethod: "ResetCommandId"},
			_jsii_.MemberMethod{JsiiMethod: "resetScript", GoMethod: "ResetScript"},
			_jsii_.MemberMethod{JsiiMethod: "resetScriptUri", GoMethod: "ResetScriptUri"},
			_jsii_.MemberMethod{JsiiMethod: "resetScriptUriManagedIdentity", GoMethod: "ResetScriptUriManagedIdentity"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			...
			_jsii_.MemberProperty{JsiiProperty: "scriptUri", GoGetter: "ScriptUri"},
			_jsii_.MemberProperty{JsiiProperty: "scriptUriInput", GoGetter: "ScriptUriInput"},
			_jsii_.MemberProperty{JsiiProperty: "scriptUriManagedIdentity", GoGetter: "ScriptUriManagedIdentity"},
			_jsii_.MemberProperty{JsiiProperty: "scriptUriManagedIdentityInput", GoGetter: "ScriptUriManagedIdentityInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
