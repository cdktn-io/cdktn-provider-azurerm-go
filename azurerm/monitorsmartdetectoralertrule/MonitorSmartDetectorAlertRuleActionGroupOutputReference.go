...
func (m *jsiiProxy_MonitorSmartDetectorAlertRuleActionGroupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRuleActionGroupOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
