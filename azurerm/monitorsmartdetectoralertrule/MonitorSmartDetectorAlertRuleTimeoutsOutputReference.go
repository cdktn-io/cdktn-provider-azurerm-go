...
func (m *jsiiProxy_MonitorSmartDetectorAlertRuleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRuleTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
