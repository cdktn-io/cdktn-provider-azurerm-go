...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/monitorsmartdetectoralertrule/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/monitor_smart_detector_alert_rule azurerm_monitor_smart_detector_alert_rule}.
...
func (j *jsiiProxy_MonitorSmartDetectorAlertRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/monitor_smart_detector_alert_rule azurerm_monitor_smart_detector_alert_rule} Resource.
func NewMonitorSmartDetectorAlertRule(scope constructs.Construct, id *string, config *MonitorSmartDetectorAlertRuleConfig) MonitorSmartDetectorAlertRule {
	...
	if err := validateNewMonitorSmartDetectorAlertRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MonitorSmartDetectorAlertRule)SetCount(val interface{}) {
...
func (j *jsiiProxy_MonitorSmartDetectorAlertRule)SetScopeResourceIds(val *[]*string) {
	if err := j.validateSetScopeResourceIdsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_MonitorSmartDetectorAlertRule)SetThrottlingDuration(val *string) {
	if err := j.validateSetThrottlingDurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func MonitorSmartDetectorAlertRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateMonitorSmartDetectorAlertRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MonitorSmartDetectorAlertRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMonitorSmartDetectorAlertRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MonitorSmartDetectorAlertRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMonitorSmartDetectorAlertRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRule) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRule) MoveFromId(id *string) {
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRule) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRule) MoveToId(id *string) {
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRule) PutActionGroup(value *MonitorSmartDetectorAlertRuleActionGroup) {
	if err := m.validatePutActionGroupParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRule) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MonitorSmartDetectorAlertRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
