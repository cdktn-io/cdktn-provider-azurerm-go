...
func (i *jsiiProxy_IothubEndpointStorageContainerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubEndpointStorageContainerTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
