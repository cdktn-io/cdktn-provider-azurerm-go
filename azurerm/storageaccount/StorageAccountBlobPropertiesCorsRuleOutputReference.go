...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/storageaccount/internal"
...
func (j *jsiiProxy_StorageAccountBlobPropertiesCorsRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountBlobPropertiesCorsRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StorageAccountBlobPropertiesCorsRuleOutputReference {
	_init_.Initialize()

	if err := validateNewStorageAccountBlobPropertiesCorsRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewStorageAccountBlobPropertiesCorsRuleOutputReference_Override(s StorageAccountBlobPropertiesCorsRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountBlobPropertiesCorsRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountBlobPropertiesCorsRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountBlobPropertiesCorsRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageAccountBlobPropertiesCorsRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountBlobPropertiesCorsRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
