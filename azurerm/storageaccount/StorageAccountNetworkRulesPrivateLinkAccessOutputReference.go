...
func (j *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountNetworkRulesPrivateLinkAccessOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StorageAccountNetworkRulesPrivateLinkAccessOutputReference {
	_init_.Initialize()
...
func NewStorageAccountNetworkRulesPrivateLinkAccessOutputReference_Override(s StorageAccountNetworkRulesPrivateLinkAccessOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
