...
func (s *jsiiProxy_StorageAccountNetworkRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountNetworkRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
