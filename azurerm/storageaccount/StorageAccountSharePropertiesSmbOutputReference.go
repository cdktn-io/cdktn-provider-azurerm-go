...
func (s *jsiiProxy_StorageAccountSharePropertiesSmbOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountSharePropertiesSmbOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
