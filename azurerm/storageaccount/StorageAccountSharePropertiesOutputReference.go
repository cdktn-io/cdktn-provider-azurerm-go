...
func (j *jsiiProxy_StorageAccountSharePropertiesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountSharePropertiesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StorageAccountSharePropertiesOutputReference {
	_init_.Initialize()

	if err := validateNewStorageAccountSharePropertiesOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewStorageAccountSharePropertiesOutputReference_Override(s StorageAccountSharePropertiesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountSharePropertiesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountSharePropertiesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountSharePropertiesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageAccountSharePropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountSharePropertiesOutputReference) PutSmb(value *StorageAccountSharePropertiesSmb) {
	if err := s.validatePutSmbParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_StorageAccountSharePropertiesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
