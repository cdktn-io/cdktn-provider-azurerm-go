...
func (s *jsiiProxy_StorageAccountBlobPropertiesContainerDeleteRetentionPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountBlobPropertiesContainerDeleteRetentionPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
