...
func (s *jsiiProxy_StorageAccountQueuePropertiesHourMetricsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountQueuePropertiesHourMetricsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
