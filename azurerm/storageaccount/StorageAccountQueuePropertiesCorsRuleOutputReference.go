...
func (j *jsiiProxy_StorageAccountQueuePropertiesCorsRuleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountQueuePropertiesCorsRuleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StorageAccountQueuePropertiesCorsRuleOutputReference {
	_init_.Initialize()
...
func NewStorageAccountQueuePropertiesCorsRuleOutputReference_Override(s StorageAccountQueuePropertiesCorsRuleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountQueuePropertiesCorsRuleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountQueuePropertiesCorsRuleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountQueuePropertiesCorsRuleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageAccountQueuePropertiesCorsRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountQueuePropertiesCorsRuleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
