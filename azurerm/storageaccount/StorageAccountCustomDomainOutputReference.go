...
func (j *jsiiProxy_StorageAccountCustomDomainOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountCustomDomainOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StorageAccountCustomDomainOutputReference {
	_init_.Initialize()
...
func NewStorageAccountCustomDomainOutputReference_Override(s StorageAccountCustomDomainOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountCustomDomainOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountCustomDomainOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountCustomDomainOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageAccountCustomDomainOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountCustomDomainOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
