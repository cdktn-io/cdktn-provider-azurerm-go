...
func (s *jsiiProxy_StorageAccountCustomDomainOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountCustomDomainOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
