...
func (j *jsiiProxy_StorageAccountStaticWebsiteOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountStaticWebsiteOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) StorageAccountStaticWebsiteOutputReference {
	_init_.Initialize()

	if err := validateNewStorageAccountStaticWebsiteOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewStorageAccountStaticWebsiteOutputReference_Override(s StorageAccountStaticWebsiteOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountStaticWebsiteOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountStaticWebsiteOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountStaticWebsiteOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_StorageAccountStaticWebsiteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageAccountStaticWebsiteOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
