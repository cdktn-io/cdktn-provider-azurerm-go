...
func (s *jsiiProxy_StorageAccountStaticWebsiteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountStaticWebsiteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
