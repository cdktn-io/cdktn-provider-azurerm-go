...
func (s *jsiiProxy_StorageAccountSharePropertiesRetentionPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountSharePropertiesRetentionPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
