...
type StorageAccount interface {
	...
	AccountReplicationTypeMigratingTo() *string
	AccountReplicationTypeMigrationInProgress() cdktn.IResolvable
	AccountTier() *string
...
func (j *jsiiProxy_StorageAccount) AccountReplicationTypeMigratingTo() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountReplicationTypeMigratingTo",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_StorageAccount) AccountReplicationTypeMigrationInProgress() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"accountReplicationTypeMigrationInProgress",
		&returns,
	)
	return returns
}
...
func (s *jsiiProxy_StorageAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
