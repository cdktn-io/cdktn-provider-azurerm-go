...
func (j *jsiiProxy_StorageAccountSharePropertiesCorsRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountSharePropertiesCorsRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StorageAccountSharePropertiesCorsRuleList {
	_init_.Initialize()
...
func NewStorageAccountSharePropertiesCorsRuleList_Override(s StorageAccountSharePropertiesCorsRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountSharePropertiesCorsRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountSharePropertiesCorsRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageAccountSharePropertiesCorsRuleList) Resolve(context cdktn.IResolveContext) interface{} {
