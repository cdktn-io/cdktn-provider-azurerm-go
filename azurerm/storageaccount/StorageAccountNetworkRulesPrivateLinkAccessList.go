...
func (j *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountNetworkRulesPrivateLinkAccessList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StorageAccountNetworkRulesPrivateLinkAccessList {
	_init_.Initialize()

	if err := validateNewStorageAccountNetworkRulesPrivateLinkAccessListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewStorageAccountNetworkRulesPrivateLinkAccessList_Override(s StorageAccountNetworkRulesPrivateLinkAccessList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageAccountNetworkRulesPrivateLinkAccessList) Resolve(context cdktn.IResolveContext) interface{} {
