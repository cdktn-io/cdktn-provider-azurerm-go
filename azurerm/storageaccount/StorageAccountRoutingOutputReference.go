...
func (s *jsiiProxy_StorageAccountRoutingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountRoutingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
