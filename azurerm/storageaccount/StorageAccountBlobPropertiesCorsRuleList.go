...
func (s *jsiiProxy_StorageAccountBlobPropertiesCorsRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageAccountBlobPropertiesCorsRuleList) Resolve(context cdktf.IResolveContext) interface{} {
