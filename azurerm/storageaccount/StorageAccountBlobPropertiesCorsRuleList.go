...
func (j *jsiiProxy_StorageAccountBlobPropertiesCorsRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewStorageAccountBlobPropertiesCorsRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StorageAccountBlobPropertiesCorsRuleList {
	_init_.Initialize()

	if err := validateNewStorageAccountBlobPropertiesCorsRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewStorageAccountBlobPropertiesCorsRuleList_Override(s StorageAccountBlobPropertiesCorsRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_StorageAccountBlobPropertiesCorsRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_StorageAccountBlobPropertiesCorsRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageAccountBlobPropertiesCorsRuleList) Resolve(context cdktn.IResolveContext) interface{} {
