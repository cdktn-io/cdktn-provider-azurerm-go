...
func (c *jsiiProxy_CdnEndpointDeliveryRuleUrlFileNameConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnEndpointDeliveryRuleUrlFileNameConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
