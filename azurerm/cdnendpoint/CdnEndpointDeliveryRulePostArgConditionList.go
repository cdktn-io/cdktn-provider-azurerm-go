...
func (j *jsiiProxy_CdnEndpointDeliveryRulePostArgConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnEndpointDeliveryRulePostArgConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnEndpointDeliveryRulePostArgConditionList {
	_init_.Initialize()
...
func NewCdnEndpointDeliveryRulePostArgConditionList_Override(c CdnEndpointDeliveryRulePostArgConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnEndpointDeliveryRulePostArgConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnEndpointDeliveryRulePostArgConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnEndpointDeliveryRulePostArgConditionList) Resolve(context cdktn.IResolveContext) interface{} {
