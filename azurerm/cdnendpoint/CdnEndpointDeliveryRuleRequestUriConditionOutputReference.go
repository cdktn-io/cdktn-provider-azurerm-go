...
func (c *jsiiProxy_CdnEndpointDeliveryRuleRequestUriConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnEndpointDeliveryRuleRequestUriConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
