...
func (c *jsiiProxy_CdnEndpointGlobalDeliveryRuleUrlRewriteActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnEndpointGlobalDeliveryRuleUrlRewriteActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
