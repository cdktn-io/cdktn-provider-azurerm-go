...
func (c *jsiiProxy_CdnEndpointDeliveryRuleUrlFileExtensionConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnEndpointDeliveryRuleUrlFileExtensionConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
