...
func (c *jsiiProxy_CdnEndpointDeliveryRulePostArgConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnEndpointDeliveryRulePostArgConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
