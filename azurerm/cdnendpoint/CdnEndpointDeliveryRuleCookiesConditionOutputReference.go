...
func (c *jsiiProxy_CdnEndpointDeliveryRuleCookiesConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnEndpointDeliveryRuleCookiesConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
