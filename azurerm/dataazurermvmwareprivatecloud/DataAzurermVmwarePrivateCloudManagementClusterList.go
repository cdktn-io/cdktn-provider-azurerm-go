...
func (j *jsiiProxy_DataAzurermVmwarePrivateCloudManagementClusterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermVmwarePrivateCloudManagementClusterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermVmwarePrivateCloudManagementClusterList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermVmwarePrivateCloud.DataAzurermVmwarePrivateCloudManagementClusterList",
...
func NewDataAzurermVmwarePrivateCloudManagementClusterList_Override(d DataAzurermVmwarePrivateCloudManagementClusterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermVmwarePrivateCloudManagementClusterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermVmwarePrivateCloudManagementClusterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermVmwarePrivateCloudManagementClusterList) Resolve(context cdktn.IResolveContext) interface{} {
