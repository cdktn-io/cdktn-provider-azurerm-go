...
func (j *jsiiProxy_DataAzurermDataFactoryIdentityList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermDataFactoryIdentityList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermDataFactoryIdentityList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermDataFactory.DataAzurermDataFactoryIdentityList",
...
func NewDataAzurermDataFactoryIdentityList_Override(d DataAzurermDataFactoryIdentityList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermDataFactoryIdentityList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermDataFactoryIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermDataFactoryIdentityList) Resolve(context cdktn.IResolveContext) interface{} {
