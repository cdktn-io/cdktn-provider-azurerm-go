...
func (l *jsiiProxy_LogicAppIntegrationAccountAssembly) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogicAppIntegrationAccountAssembly) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogicAppIntegrationAccountAssembly) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
