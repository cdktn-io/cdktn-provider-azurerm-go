...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "backendSubnetId", GoGetter: "BackendSubnetId"},
			_jsii_.MemberProperty{JsiiProperty: "backendSubnetIdInput", GoGetter: "BackendSubnetIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBackendSubnetId", GoMethod: "ResetBackendSubnetId"},
