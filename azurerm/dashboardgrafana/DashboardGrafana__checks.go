...
func (d *jsiiProxy_DashboardGrafana) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (d *jsiiProxy_DashboardGrafana) validatePutAzureMonitorWorkspaceIntegrationsParameters(value interface{}) error {
	...
	case *[]*DashboardGrafanaAzureMonitorWorkspaceIntegrations:
		value := value.(*[]*DashboardGrafanaAzureMonitorWorkspaceIntegrations)
	...
	case []*DashboardGrafanaAzureMonitorWorkspaceIntegrations:
		value_ := value.([]*DashboardGrafanaAzureMonitorWorkspaceIntegrations)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*DashboardGrafanaAzureMonitorWorkspaceIntegrations; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_DashboardGrafana) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
