...
func (j *jsiiProxy_DashboardGrafanaAzureMonitorWorkspaceIntegrationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDashboardGrafanaAzureMonitorWorkspaceIntegrationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardGrafanaAzureMonitorWorkspaceIntegrationsList {
	_init_.Initialize()
...
func NewDashboardGrafanaAzureMonitorWorkspaceIntegrationsList_Override(d DashboardGrafanaAzureMonitorWorkspaceIntegrationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DashboardGrafanaAzureMonitorWorkspaceIntegrationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DashboardGrafanaAzureMonitorWorkspaceIntegrationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardGrafanaAzureMonitorWorkspaceIntegrationsList) Resolve(context cdktn.IResolveContext) interface{} {
