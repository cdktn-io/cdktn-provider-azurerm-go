...
func (d *jsiiProxy_DashboardGrafanaAzureMonitorWorkspaceIntegrationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardGrafanaAzureMonitorWorkspaceIntegrationsList) Resolve(context cdktf.IResolveContext) interface{} {
