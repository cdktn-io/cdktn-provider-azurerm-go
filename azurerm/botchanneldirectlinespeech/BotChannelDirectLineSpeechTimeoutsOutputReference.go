...
func (b *jsiiProxy_BotChannelDirectLineSpeechTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BotChannelDirectLineSpeechTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
