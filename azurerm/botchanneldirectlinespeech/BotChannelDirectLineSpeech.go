...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/botchanneldirectlinespeech/internal"
...
type BotChannelDirectLineSpeech interface {
	...
	ResetCognitiveServiceAccessKey()
	ResetCognitiveServiceLocation()
...
func (j *jsiiProxy_BotChannelDirectLineSpeech) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BotChannelDirectLineSpeech) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BotChannelDirectLineSpeech) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BotChannelDirectLineSpeech) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BotChannelDirectLineSpeech) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BotChannelDirectLineSpeech)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BotChannelDirectLineSpeech)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BotChannelDirectLineSpeech)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BotChannelDirectLineSpeech_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) ResetCognitiveServiceAccessKey() {
	_jsii_.InvokeVoid(
		b,
		"resetCognitiveServiceAccessKey",
		nil, // no parameters
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) ResetCognitiveServiceLocation() {
	_jsii_.InvokeVoid(
		b,
		"resetCognitiveServiceLocation",
		nil, // no parameters
...
func (b *jsiiProxy_BotChannelDirectLineSpeech) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
