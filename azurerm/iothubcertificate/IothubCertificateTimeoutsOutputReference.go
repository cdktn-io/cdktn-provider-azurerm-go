...
func (i *jsiiProxy_IothubCertificateTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubCertificateTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
