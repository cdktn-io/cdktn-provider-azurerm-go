...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/iothubcertificate/internal"
...
func (j *jsiiProxy_IothubCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IothubCertificate) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IothubCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IothubCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IothubCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IothubCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewIothubCertificate(scope constructs.Construct, id *string, config *IothubCertificateConfig) IothubCertificate {
	...
	if err := validateNewIothubCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IothubCertificate)SetCount(val interface{}) {
...
func (j *jsiiProxy_IothubCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IothubCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IothubCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IothubCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateIothubCertificate_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IothubCertificate_IsConstruct(x interface{}) *bool {
	...
	if err := validateIothubCertificate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IothubCertificate_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIothubCertificate_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IothubCertificate_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIothubCertificate_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IothubCertificate) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IothubCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubCertificate) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IothubCertificate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IothubCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IothubCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IothubCertificate) MoveFromId(id *string) {
...
func (i *jsiiProxy_IothubCertificate) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IothubCertificate) MoveToId(id *string) {
...
func (i *jsiiProxy_IothubCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IothubCertificate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IothubCertificate) ToHclTerraform() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IothubCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
