...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "accountCreationSourceInput", GoGetter: "AccountCreationSourceInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ingestionKey", GoGetter: "IngestionKey"},
			_jsii_.MemberProperty{JsiiProperty: "ingestionKeyInput", GoGetter: "IngestionKeyInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "orgCreationSource", GoGetter: "OrgCreationSource"},
			_jsii_.MemberProperty{JsiiProperty: "orgCreationSourceInput", GoGetter: "OrgCreationSourceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAccountCreationSource", GoMethod: "ResetAccountCreationSource"},
			_jsii_.MemberMethod{JsiiMethod: "resetAccountId", GoMethod: "ResetAccountId"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIdentity", GoMethod: "ResetIdentity"},
			_jsii_.MemberMethod{JsiiMethod: "resetIngestionKey", GoMethod: "ResetIngestionKey"},
			_jsii_.MemberMethod{JsiiMethod: "resetOrganizationId", GoMethod: "ResetOrganizationId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOrgCreationSource", GoMethod: "ResetOrgCreationSource"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBillingCycle", GoMethod: "ResetBillingCycle"},
			_jsii_.MemberMethod{JsiiMethod: "resetPlanId", GoMethod: "ResetPlanId"},
			_jsii_.MemberMethod{JsiiMethod: "resetUsageType", GoMethod: "ResetUsageType"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
