...
func (j *jsiiProxy_NewRelicMonitor) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NewRelicMonitor) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NewRelicMonitor) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NewRelicMonitor) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NewRelicMonitor) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/new_relic_monitor azurerm_new_relic_monitor} Resource.
...
func (j *jsiiProxy_NewRelicMonitor)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NewRelicMonitor)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NewRelicMonitor)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NewRelicMonitor_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NewRelicMonitor) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NewRelicMonitor) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NewRelicMonitor) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NewRelicMonitor) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NewRelicMonitor) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NewRelicMonitor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
