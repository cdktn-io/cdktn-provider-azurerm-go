...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "highBusinessImpact", GoGetter: "HighBusinessImpact"},
			_jsii_.MemberProperty{JsiiProperty: "highBusinessImpactInput", GoGetter: "HighBusinessImpactInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "imageBuildComputeName", GoGetter: "ImageBuildComputeName"},
			_jsii_.MemberProperty{JsiiProperty: "imageBuildComputeNameInput", GoGetter: "ImageBuildComputeNameInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "managedNetwork", GoGetter: "ManagedNetwork"},
			_jsii_.MemberProperty{JsiiProperty: "managedNetworkInput", GoGetter: "ManagedNetworkInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFeatureStore", GoMethod: "ResetFeatureStore"},
			_jsii_.MemberMethod{JsiiMethod: "resetFriendlyName", GoMethod: "ResetFriendlyName"},
			_jsii_.MemberMethod{JsiiMethod: "resetHighBusinessImpact", GoMethod: "ResetHighBusinessImpact"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetImageBuildComputeName", GoMethod: "ResetImageBuildComputeName"},
			_jsii_.MemberMethod{JsiiMethod: "resetKind", GoMethod: "ResetKind"},
			_jsii_.MemberMethod{JsiiMethod: "resetManagedNetwork", GoMethod: "ResetManagedNetwork"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServiceSideEncryptionEnabled", GoMethod: "ResetServiceSideEncryptionEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetSkuName", GoMethod: "ResetSkuName"},
			_jsii_.MemberMethod{JsiiMethod: "resetStorageAccountAccessType", GoMethod: "ResetStorageAccountAccessType"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serviceSideEncryptionEnabled", GoGetter: "ServiceSideEncryptionEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "serviceSideEncryptionEnabledInput", GoGetter: "ServiceSideEncryptionEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "storageAccountAccessType", GoGetter: "StorageAccountAccessType"},
			_jsii_.MemberProperty{JsiiProperty: "storageAccountAccessTypeInput", GoGetter: "StorageAccountAccessTypeInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "computerSparkRuntimeVersion", GoGetter: "ComputerSparkRuntimeVersion"},
			_jsii_.MemberProperty{JsiiProperty: "computerSparkRuntimeVersionInput", GoGetter: "ComputerSparkRuntimeVersionInput"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "offlineConnectionName", GoGetter: "OfflineConnectionName"},
			_jsii_.MemberProperty{JsiiProperty: "offlineConnectionNameInput", GoGetter: "OfflineConnectionNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "onlineConnectionName", GoGetter: "OnlineConnectionName"},
			_jsii_.MemberProperty{JsiiProperty: "onlineConnectionNameInput", GoGetter: "OnlineConnectionNameInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetComputerSparkRuntimeVersion", GoMethod: "ResetComputerSparkRuntimeVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetOfflineConnectionName", GoMethod: "ResetOfflineConnectionName"},
			_jsii_.MemberMethod{JsiiMethod: "resetOnlineConnectionName", GoMethod: "ResetOnlineConnectionName"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "provisionOnCreationEnabled", GoGetter: "ProvisionOnCreationEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "provisionOnCreationEnabledInput", GoGetter: "ProvisionOnCreationEnabledInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetIsolationMode", GoMethod: "ResetIsolationMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetProvisionOnCreationEnabled", GoMethod: "ResetProvisionOnCreationEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
