...
func (j *jsiiProxy_MachineLearningWorkspaceEncryptionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMachineLearningWorkspaceEncryptionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MachineLearningWorkspaceEncryptionOutputReference {
	_init_.Initialize()
...
func NewMachineLearningWorkspaceEncryptionOutputReference_Override(m MachineLearningWorkspaceEncryptionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MachineLearningWorkspaceEncryptionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MachineLearningWorkspaceEncryptionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MachineLearningWorkspaceEncryptionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MachineLearningWorkspaceEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MachineLearningWorkspaceEncryptionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
