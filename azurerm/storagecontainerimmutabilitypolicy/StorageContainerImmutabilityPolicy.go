...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/storage_container_immutability_policy azurerm_storage_container_immutability_policy} Resource.
...
func (s *jsiiProxy_StorageContainerImmutabilityPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageContainerImmutabilityPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageContainerImmutabilityPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
