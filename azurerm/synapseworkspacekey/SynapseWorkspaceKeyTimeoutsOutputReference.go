...
func (s *jsiiProxy_SynapseWorkspaceKeyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SynapseWorkspaceKeyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
