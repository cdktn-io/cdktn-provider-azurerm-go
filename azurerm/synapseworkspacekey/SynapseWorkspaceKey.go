...
func (s *jsiiProxy_SynapseWorkspaceKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SynapseWorkspaceKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SynapseWorkspaceKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
