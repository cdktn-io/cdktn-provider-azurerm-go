...
func (j *jsiiProxy_DataAzurermAppConfigurationSecondaryWriteKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermAppConfigurationSecondaryWriteKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermAppConfigurationSecondaryWriteKeyList {
	_init_.Initialize()
...
func NewDataAzurermAppConfigurationSecondaryWriteKeyList_Override(d DataAzurermAppConfigurationSecondaryWriteKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermAppConfigurationSecondaryWriteKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermAppConfigurationSecondaryWriteKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermAppConfigurationSecondaryWriteKeyList) Resolve(context cdktn.IResolveContext) interface{} {
