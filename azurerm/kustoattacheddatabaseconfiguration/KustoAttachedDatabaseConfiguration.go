...
func (j *jsiiProxy_KustoAttachedDatabaseConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KustoAttachedDatabaseConfiguration) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_KustoAttachedDatabaseConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KustoAttachedDatabaseConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KustoAttachedDatabaseConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KustoAttachedDatabaseConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewKustoAttachedDatabaseConfiguration(scope constructs.Construct, id *string, config *KustoAttachedDatabaseConfigurationConfig) KustoAttachedDatabaseConfiguration {
	...
	if err := validateNewKustoAttachedDatabaseConfigurationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_KustoAttachedDatabaseConfiguration)SetCount(val interface{}) {
...
func (j *jsiiProxy_KustoAttachedDatabaseConfiguration)SetDefaultPrincipalModificationKind(val *string) {
	if err := j.validateSetDefaultPrincipalModificationKindParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_KustoAttachedDatabaseConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KustoAttachedDatabaseConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KustoAttachedDatabaseConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KustoAttachedDatabaseConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateKustoAttachedDatabaseConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func KustoAttachedDatabaseConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateKustoAttachedDatabaseConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KustoAttachedDatabaseConfiguration_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateKustoAttachedDatabaseConfiguration_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KustoAttachedDatabaseConfiguration_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateKustoAttachedDatabaseConfiguration_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) HasResourceMove() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) MoveFromId(id *string) {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) MoveTo(moveTarget *string, index interface{}) {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) MoveToId(id *string) {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) PutSharing(value *KustoAttachedDatabaseConfigurationSharing) {
	if err := k.validatePutSharingParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		k,
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) ToHclTerraform() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KustoAttachedDatabaseConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
