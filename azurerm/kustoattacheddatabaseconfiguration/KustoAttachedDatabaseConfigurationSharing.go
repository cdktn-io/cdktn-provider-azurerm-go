...
type KustoAttachedDatabaseConfigurationSharing struct {
	...
	FunctionsToExclude *[]*string `field:"optional" json:"functionsToExclude" yaml:"functionsToExclude"`
	...
	FunctionsToInclude *[]*string `field:"optional" json:"functionsToInclude" yaml:"functionsToInclude"`
