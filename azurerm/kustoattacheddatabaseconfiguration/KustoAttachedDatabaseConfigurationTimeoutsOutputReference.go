...
func (j *jsiiProxy_KustoAttachedDatabaseConfigurationTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKustoAttachedDatabaseConfigurationTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) KustoAttachedDatabaseConfigurationTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewKustoAttachedDatabaseConfigurationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_KustoAttachedDatabaseConfigurationTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.kustoAttachedDatabaseConfiguration.KustoAttachedDatabaseConfigurationTimeoutsOutputReference",
...
func NewKustoAttachedDatabaseConfigurationTimeoutsOutputReference_Override(k KustoAttachedDatabaseConfigurationTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_KustoAttachedDatabaseConfigurationTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfigurationTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfigurationTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KustoAttachedDatabaseConfigurationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KustoAttachedDatabaseConfigurationTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
