...
func (j *jsiiProxy_DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.dataAzurermVirtualDesktopHostPool.DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList",
...
func NewDataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList_Override(d DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList) Resolve(context cdktn.IResolveContext) interface{} {
