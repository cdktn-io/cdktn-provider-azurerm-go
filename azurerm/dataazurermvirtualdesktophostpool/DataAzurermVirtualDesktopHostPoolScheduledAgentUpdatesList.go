...
func (d *jsiiProxy_DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList) Resolve(context cdktf.IResolveContext) interface{} {
