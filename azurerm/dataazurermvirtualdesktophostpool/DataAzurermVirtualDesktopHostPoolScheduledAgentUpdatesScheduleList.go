...
func (d *jsiiProxy_DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesScheduleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesScheduleList) Resolve(context cdktf.IResolveContext) interface{} {
