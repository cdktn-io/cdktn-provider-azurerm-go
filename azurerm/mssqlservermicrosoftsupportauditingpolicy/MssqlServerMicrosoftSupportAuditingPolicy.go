...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/mssqlservermicrosoftsupportauditingpolicy/internal"
...
func (j *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewMssqlServerMicrosoftSupportAuditingPolicy(scope constructs.Construct, id *string, config *MssqlServerMicrosoftSupportAuditingPolicyConfig) MssqlServerMicrosoftSupportAuditingPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.mssqlServerMicrosoftSupportAuditingPolicy.MssqlServerMicrosoftSupportAuditingPolicy",
...
func (j *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MssqlServerMicrosoftSupportAuditingPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MssqlServerMicrosoftSupportAuditingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
