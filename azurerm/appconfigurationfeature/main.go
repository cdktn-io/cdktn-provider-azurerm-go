...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customFilter", GoGetter: "CustomFilter"},
			_jsii_.MemberProperty{JsiiProperty: "customFilterInput", GoGetter: "CustomFilterInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "percentageFilterValue", GoGetter: "PercentageFilterValue"},
			_jsii_.MemberProperty{JsiiProperty: "percentageFilterValueInput", GoGetter: "PercentageFilterValueInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putCustomFilter", GoMethod: "PutCustomFilter"},
			_jsii_.MemberMethod{JsiiMethod: "putTargetingFilter", GoMethod: "PutTargetingFilter"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "putTimewindowFilter", GoMethod: "PutTimewindowFilter"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetCustomFilter", GoMethod: "ResetCustomFilter"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPercentageFilterValue", GoMethod: "ResetPercentageFilterValue"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTargetingFilter", GoMethod: "ResetTargetingFilter"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimewindowFilter", GoMethod: "ResetTimewindowFilter"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeAttributes", GoMethod: "SynthesizeAttributes"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeHclAttributes", GoMethod: "SynthesizeHclAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "tags", GoGetter: "Tags"},
			_jsii_.MemberProperty{JsiiProperty: "tagsInput", GoGetter: "TagsInput"},
			_jsii_.MemberProperty{JsiiProperty: "targetingFilter", GoGetter: "TargetingFilter"},
			_jsii_.MemberProperty{JsiiProperty: "targetingFilterInput", GoGetter: "TargetingFilterInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformGeneratorMetadata", GoGetter: "TerraformGeneratorMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "terraformMetaArguments", GoGetter: "TerraformMetaArguments"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResourceType", GoGetter: "TerraformResourceType"},
			_jsii_.MemberProperty{JsiiProperty: "timeouts", GoGetter: "Timeouts"},
			_jsii_.MemberProperty{JsiiProperty: "timeoutsInput", GoGetter: "TimeoutsInput"},
			_jsii_.MemberProperty{JsiiProperty: "timewindowFilter", GoGetter: "TimewindowFilter"},
			_jsii_.MemberProperty{JsiiProperty: "timewindowFilterInput", GoGetter: "TimewindowFilterInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azurerm.appConfigurationFeature.AppConfigurationFeatureCustomFilter",
		reflect.TypeOf((*AppConfigurationFeatureCustomFilter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azurerm.appConfigurationFeature.AppConfigurationFeatureCustomFilterList",
		reflect.TypeOf((*AppConfigurationFeatureCustomFilterList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_AppConfigurationFeatureCustomFilterList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azurerm.appConfigurationFeature.AppConfigurationFeatureCustomFilterOutputReference",
		reflect.TypeOf((*AppConfigurationFeatureCustomFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_AppConfigurationFeatureCustomFilterOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "rolloutPercentage", GoGetter: "RolloutPercentage"},
			_jsii_.MemberProperty{JsiiProperty: "rolloutPercentageInput", GoGetter: "RolloutPercentageInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "defaultRolloutPercentage", GoGetter: "DefaultRolloutPercentage"},
			_jsii_.MemberProperty{JsiiProperty: "defaultRolloutPercentageInput", GoGetter: "DefaultRolloutPercentageInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
