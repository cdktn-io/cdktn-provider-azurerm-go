...
func (a *jsiiProxy_AppConfigurationFeature) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppConfigurationFeature) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppConfigurationFeature) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
