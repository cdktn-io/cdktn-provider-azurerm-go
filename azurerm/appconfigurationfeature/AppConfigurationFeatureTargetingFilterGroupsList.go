...
func (j *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppConfigurationFeatureTargetingFilterGroupsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppConfigurationFeatureTargetingFilterGroupsList {
	_init_.Initialize()
...
func NewAppConfigurationFeatureTargetingFilterGroupsList_Override(a AppConfigurationFeatureTargetingFilterGroupsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsList) Resolve(context cdktn.IResolveContext) interface{} {
