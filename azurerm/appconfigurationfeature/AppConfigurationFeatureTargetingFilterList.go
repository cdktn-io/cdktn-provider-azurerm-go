...
func (j *jsiiProxy_AppConfigurationFeatureTargetingFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppConfigurationFeatureTargetingFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppConfigurationFeatureTargetingFilterList {
	_init_.Initialize()

	if err := validateNewAppConfigurationFeatureTargetingFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewAppConfigurationFeatureTargetingFilterList_Override(a AppConfigurationFeatureTargetingFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppConfigurationFeatureTargetingFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppConfigurationFeatureTargetingFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppConfigurationFeatureTargetingFilterList) Resolve(context cdktn.IResolveContext) interface{} {
