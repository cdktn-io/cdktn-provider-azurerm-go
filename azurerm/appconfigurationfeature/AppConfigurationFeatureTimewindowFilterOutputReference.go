...
func (j *jsiiProxy_AppConfigurationFeatureTimewindowFilterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppConfigurationFeatureTimewindowFilterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AppConfigurationFeatureTimewindowFilterOutputReference {
	_init_.Initialize()

	if err := validateNewAppConfigurationFeatureTimewindowFilterOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewAppConfigurationFeatureTimewindowFilterOutputReference_Override(a AppConfigurationFeatureTimewindowFilterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppConfigurationFeatureTimewindowFilterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppConfigurationFeatureTimewindowFilterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppConfigurationFeatureTimewindowFilterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppConfigurationFeatureTimewindowFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppConfigurationFeatureTimewindowFilterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
