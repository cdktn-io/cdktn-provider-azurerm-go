...
func (j *jsiiProxy_AppConfigurationFeatureTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppConfigurationFeatureTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppConfigurationFeatureTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewAppConfigurationFeatureTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewAppConfigurationFeatureTimeoutsOutputReference_Override(a AppConfigurationFeatureTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppConfigurationFeatureTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppConfigurationFeatureTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppConfigurationFeatureTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppConfigurationFeatureTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppConfigurationFeatureTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
