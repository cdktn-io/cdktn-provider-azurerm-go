...
func (a *jsiiProxy_AppConfigurationFeatureTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppConfigurationFeatureTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
