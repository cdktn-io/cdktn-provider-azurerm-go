...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/appconfigurationfeature/internal"
...
func (j *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppConfigurationFeatureTargetingFilterGroupsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AppConfigurationFeatureTargetingFilterGroupsOutputReference {
	_init_.Initialize()

	if err := validateNewAppConfigurationFeatureTargetingFilterGroupsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewAppConfigurationFeatureTargetingFilterGroupsOutputReference_Override(a AppConfigurationFeatureTargetingFilterGroupsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsOutputReference)SetRolloutPercentage(val *float64) {
	if err := j.validateSetRolloutPercentageParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppConfigurationFeatureTargetingFilterGroupsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
