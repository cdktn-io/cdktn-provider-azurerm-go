...
func (v *jsiiProxy_VirtualHubTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualHubTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
