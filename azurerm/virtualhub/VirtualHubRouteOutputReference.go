...
func (v *jsiiProxy_VirtualHubRouteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualHubRouteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
