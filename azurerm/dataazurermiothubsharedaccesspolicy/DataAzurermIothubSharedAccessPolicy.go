...
func (j *jsiiProxy_DataAzurermIothubSharedAccessPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzurermIothubSharedAccessPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzurermIothubSharedAccessPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzurermIothubSharedAccessPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzurermIothubSharedAccessPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAzurermIothubSharedAccessPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzurermIothubSharedAccessPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzurermIothubSharedAccessPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzurermIothubSharedAccessPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzurermIothubSharedAccessPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermIothubSharedAccessPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzurermIothubSharedAccessPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAzurermIothubSharedAccessPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
