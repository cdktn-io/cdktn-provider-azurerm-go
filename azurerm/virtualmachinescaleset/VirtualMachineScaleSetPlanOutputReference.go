...
func (j *jsiiProxy_VirtualMachineScaleSetPlanOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetPlanOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VirtualMachineScaleSetPlanOutputReference {
	_init_.Initialize()

	if err := validateNewVirtualMachineScaleSetPlanOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewVirtualMachineScaleSetPlanOutputReference_Override(v VirtualMachineScaleSetPlanOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetPlanOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetPlanOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetPlanOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualMachineScaleSetPlanOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetPlanOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
