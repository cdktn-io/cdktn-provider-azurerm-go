...
func (v *jsiiProxy_VirtualMachineScaleSetPlanOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetPlanOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
