...
func (j *jsiiProxy_VirtualMachineScaleSetStorageProfileDataDiskList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetStorageProfileDataDiskList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineScaleSetStorageProfileDataDiskList {
	_init_.Initialize()
...
func NewVirtualMachineScaleSetStorageProfileDataDiskList_Override(v VirtualMachineScaleSetStorageProfileDataDiskList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetStorageProfileDataDiskList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetStorageProfileDataDiskList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineScaleSetStorageProfileDataDiskList) Resolve(context cdktn.IResolveContext) interface{} {
