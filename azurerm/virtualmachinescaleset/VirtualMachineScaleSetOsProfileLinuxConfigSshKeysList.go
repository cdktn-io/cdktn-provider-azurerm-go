...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileLinuxConfigSshKeysList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetOsProfileLinuxConfigSshKeysList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineScaleSetOsProfileLinuxConfigSshKeysList {
	_init_.Initialize()

	if err := validateNewVirtualMachineScaleSetOsProfileLinuxConfigSshKeysListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewVirtualMachineScaleSetOsProfileLinuxConfigSshKeysList_Override(v VirtualMachineScaleSetOsProfileLinuxConfigSshKeysList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileLinuxConfigSshKeysList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileLinuxConfigSshKeysList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileLinuxConfigSshKeysList) Resolve(context cdktn.IResolveContext) interface{} {
