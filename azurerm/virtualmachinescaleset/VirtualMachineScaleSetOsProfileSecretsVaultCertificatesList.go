...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetOsProfileSecretsVaultCertificatesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineScaleSetOsProfileSecretsVaultCertificatesList {
	_init_.Initialize()

	if err := validateNewVirtualMachineScaleSetOsProfileSecretsVaultCertificatesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewVirtualMachineScaleSetOsProfileSecretsVaultCertificatesList_Override(v VirtualMachineScaleSetOsProfileSecretsVaultCertificatesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesList) Resolve(context cdktn.IResolveContext) interface{} {
