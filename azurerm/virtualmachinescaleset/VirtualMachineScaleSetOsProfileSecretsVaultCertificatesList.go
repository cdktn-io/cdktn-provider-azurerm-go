...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesList) Resolve(context cdktf.IResolveContext) interface{} {
