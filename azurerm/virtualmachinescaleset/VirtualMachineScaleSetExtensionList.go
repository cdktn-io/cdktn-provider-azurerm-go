...
func (j *jsiiProxy_VirtualMachineScaleSetExtensionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetExtensionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineScaleSetExtensionList {
	_init_.Initialize()
...
func NewVirtualMachineScaleSetExtensionList_Override(v VirtualMachineScaleSetExtensionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetExtensionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetExtensionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineScaleSetExtensionList) Resolve(context cdktn.IResolveContext) interface{} {
