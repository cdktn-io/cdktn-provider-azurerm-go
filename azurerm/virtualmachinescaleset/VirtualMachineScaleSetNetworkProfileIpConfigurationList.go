...
func (j *jsiiProxy_VirtualMachineScaleSetNetworkProfileIpConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetNetworkProfileIpConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineScaleSetNetworkProfileIpConfigurationList {
	_init_.Initialize()
...
func NewVirtualMachineScaleSetNetworkProfileIpConfigurationList_Override(v VirtualMachineScaleSetNetworkProfileIpConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetNetworkProfileIpConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetNetworkProfileIpConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineScaleSetNetworkProfileIpConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
