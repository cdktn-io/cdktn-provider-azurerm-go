...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/virtualmachinescaleset/internal"
...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetOsProfileSecretsVaultCertificatesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualMachineScaleSetOsProfileSecretsVaultCertificatesOutputReference {
	_init_.Initialize()

	if err := validateNewVirtualMachineScaleSetOsProfileSecretsVaultCertificatesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewVirtualMachineScaleSetOsProfileSecretsVaultCertificatesOutputReference_Override(v VirtualMachineScaleSetOsProfileSecretsVaultCertificatesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsVaultCertificatesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
