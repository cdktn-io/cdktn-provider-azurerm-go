...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileWindowsConfigWinrmList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetOsProfileWindowsConfigWinrmList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineScaleSetOsProfileWindowsConfigWinrmList {
	_init_.Initialize()
...
func NewVirtualMachineScaleSetOsProfileWindowsConfigWinrmList_Override(v VirtualMachineScaleSetOsProfileWindowsConfigWinrmList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileWindowsConfigWinrmList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileWindowsConfigWinrmList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileWindowsConfigWinrmList) Resolve(context cdktn.IResolveContext) interface{} {
