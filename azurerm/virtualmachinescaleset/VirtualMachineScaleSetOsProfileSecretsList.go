...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetOsProfileSecretsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineScaleSetOsProfileSecretsList {
	_init_.Initialize()
...
func NewVirtualMachineScaleSetOsProfileSecretsList_Override(v VirtualMachineScaleSetOsProfileSecretsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileSecretsList) Resolve(context cdktn.IResolveContext) interface{} {
