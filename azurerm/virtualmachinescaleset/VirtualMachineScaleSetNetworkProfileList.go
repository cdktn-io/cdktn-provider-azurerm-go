...
func (j *jsiiProxy_VirtualMachineScaleSetNetworkProfileList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetNetworkProfileList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineScaleSetNetworkProfileList {
	_init_.Initialize()
...
func NewVirtualMachineScaleSetNetworkProfileList_Override(v VirtualMachineScaleSetNetworkProfileList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetNetworkProfileList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetNetworkProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineScaleSetNetworkProfileList) Resolve(context cdktn.IResolveContext) interface{} {
