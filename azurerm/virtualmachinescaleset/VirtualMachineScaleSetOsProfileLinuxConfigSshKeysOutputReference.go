...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReference {
	_init_.Initialize()

	if err := validateNewVirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewVirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReference_Override(v VirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReference)SetKeyData(val *string) {
	if err := j.validateSetKeyDataParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileLinuxConfigSshKeysOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
