...
func (j *jsiiProxy_VirtualMachineScaleSetStorageProfileDataDiskOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineScaleSetStorageProfileDataDiskOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualMachineScaleSetStorageProfileDataDiskOutputReference {
	_init_.Initialize()
...
func NewVirtualMachineScaleSetStorageProfileDataDiskOutputReference_Override(v VirtualMachineScaleSetStorageProfileDataDiskOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineScaleSetStorageProfileDataDiskOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineScaleSetStorageProfileDataDiskOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetStorageProfileDataDiskOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualMachineScaleSetStorageProfileDataDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetStorageProfileDataDiskOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
