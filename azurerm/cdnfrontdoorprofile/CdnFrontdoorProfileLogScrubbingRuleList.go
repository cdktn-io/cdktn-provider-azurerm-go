...
func (j *jsiiProxy_CdnFrontdoorProfileLogScrubbingRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCdnFrontdoorProfileLogScrubbingRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorProfileLogScrubbingRuleList {
	_init_.Initialize()
...
func NewCdnFrontdoorProfileLogScrubbingRuleList_Override(c CdnFrontdoorProfileLogScrubbingRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CdnFrontdoorProfileLogScrubbingRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CdnFrontdoorProfileLogScrubbingRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorProfileLogScrubbingRuleList) Resolve(context cdktn.IResolveContext) interface{} {
