...
func (j *jsiiProxy_BotChannelWebChat) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BotChannelWebChat) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BotChannelWebChat) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BotChannelWebChat) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BotChannelWebChat) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BotChannelWebChat)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BotChannelWebChat)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BotChannelWebChat)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BotChannelWebChat_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BotChannelWebChat) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelWebChat) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BotChannelWebChat) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotChannelWebChat) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BotChannelWebChat) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BotChannelWebChat) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
