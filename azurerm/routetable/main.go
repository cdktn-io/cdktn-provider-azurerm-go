...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberProperty{JsiiProperty: "nextHopInIpAddress", GoGetter: "NextHopInIpAddress"},
			_jsii_.MemberProperty{JsiiProperty: "nextHopInIpAddressInput", GoGetter: "NextHopInIpAddressInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNextHopInIpAddress", GoMethod: "ResetNextHopInIpAddress"},
