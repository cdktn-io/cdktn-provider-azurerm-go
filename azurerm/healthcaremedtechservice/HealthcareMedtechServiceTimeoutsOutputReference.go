...
func (j *jsiiProxy_HealthcareMedtechServiceTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHealthcareMedtechServiceTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HealthcareMedtechServiceTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewHealthcareMedtechServiceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewHealthcareMedtechServiceTimeoutsOutputReference_Override(h HealthcareMedtechServiceTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HealthcareMedtechServiceTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HealthcareMedtechServiceTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareMedtechServiceTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HealthcareMedtechServiceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareMedtechServiceTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
