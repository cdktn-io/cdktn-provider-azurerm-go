...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/healthcaremedtechservice/internal"
...
func (j *jsiiProxy_HealthcareMedtechServiceIdentityOutputReference) IdentityIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"identityIds",
...
func (j *jsiiProxy_HealthcareMedtechServiceIdentityOutputReference) IdentityIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"identityIdsInput",
...
func (j *jsiiProxy_HealthcareMedtechServiceIdentityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHealthcareMedtechServiceIdentityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HealthcareMedtechServiceIdentityOutputReference {
	_init_.Initialize()

	if err := validateNewHealthcareMedtechServiceIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewHealthcareMedtechServiceIdentityOutputReference_Override(h HealthcareMedtechServiceIdentityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HealthcareMedtechServiceIdentityOutputReference)SetIdentityIds(val *[]*string) {
...
func (j *jsiiProxy_HealthcareMedtechServiceIdentityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HealthcareMedtechServiceIdentityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareMedtechServiceIdentityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HealthcareMedtechServiceIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HealthcareMedtechServiceIdentityOutputReference) ResetIdentityIds() {
	_jsii_.InvokeVoid(
		h,
		"resetIdentityIds",
		nil, // no parameters
...
func (h *jsiiProxy_HealthcareMedtechServiceIdentityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
