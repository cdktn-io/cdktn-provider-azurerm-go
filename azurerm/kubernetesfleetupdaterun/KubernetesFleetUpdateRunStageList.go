...
func (j *jsiiProxy_KubernetesFleetUpdateRunStageList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewKubernetesFleetUpdateRunStageList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KubernetesFleetUpdateRunStageList {
	_init_.Initialize()
...
func NewKubernetesFleetUpdateRunStageList_Override(k KubernetesFleetUpdateRunStageList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KubernetesFleetUpdateRunStageList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (k *jsiiProxy_KubernetesFleetUpdateRunStageList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KubernetesFleetUpdateRunStageList) Resolve(context cdktf.IResolveContext) interface{} {
