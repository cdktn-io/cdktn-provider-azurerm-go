...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/keyvaultaccesspolicy/internal"
...
func (j *jsiiProxy_KeyVaultAccessPolicyA) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_KeyVaultAccessPolicyA) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_KeyVaultAccessPolicyA) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KeyVaultAccessPolicyA) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_KeyVaultAccessPolicyA) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/key_vault_access_policy azurerm_key_vault_access_policy} Resource.
...
func (j *jsiiProxy_KeyVaultAccessPolicyA)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KeyVaultAccessPolicyA)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KeyVaultAccessPolicyA)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KeyVaultAccessPolicyA_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KeyVaultAccessPolicyA) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultAccessPolicyA) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (k *jsiiProxy_KeyVaultAccessPolicyA) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KeyVaultAccessPolicyA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (k *jsiiProxy_KeyVaultAccessPolicyA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (k *jsiiProxy_KeyVaultAccessPolicyA) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
