...
func (s *jsiiProxy_StorageBlobTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageBlobTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
