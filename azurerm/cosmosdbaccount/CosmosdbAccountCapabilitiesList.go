...
func (j *jsiiProxy_CosmosdbAccountCapabilitiesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbAccountCapabilitiesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbAccountCapabilitiesList {
	_init_.Initialize()
...
func NewCosmosdbAccountCapabilitiesList_Override(c CosmosdbAccountCapabilitiesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbAccountCapabilitiesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbAccountCapabilitiesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbAccountCapabilitiesList) Resolve(context cdktn.IResolveContext) interface{} {
