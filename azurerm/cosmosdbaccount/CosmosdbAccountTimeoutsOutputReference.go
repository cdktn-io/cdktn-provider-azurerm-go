...
func (c *jsiiProxy_CosmosdbAccountTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbAccountTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
