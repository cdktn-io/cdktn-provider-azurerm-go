...
func (j *jsiiProxy_CosmosdbAccountRestoreDatabaseList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbAccountRestoreDatabaseList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbAccountRestoreDatabaseList {
	_init_.Initialize()
...
func NewCosmosdbAccountRestoreDatabaseList_Override(c CosmosdbAccountRestoreDatabaseList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbAccountRestoreDatabaseList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbAccountRestoreDatabaseList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbAccountRestoreDatabaseList) Resolve(context cdktn.IResolveContext) interface{} {
