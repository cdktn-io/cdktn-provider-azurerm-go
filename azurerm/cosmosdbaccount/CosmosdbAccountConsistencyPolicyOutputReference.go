...
func (c *jsiiProxy_CosmosdbAccountConsistencyPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbAccountConsistencyPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
