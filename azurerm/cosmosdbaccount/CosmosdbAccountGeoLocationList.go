...
func (j *jsiiProxy_CosmosdbAccountGeoLocationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbAccountGeoLocationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbAccountGeoLocationList {
	_init_.Initialize()

	if err := validateNewCosmosdbAccountGeoLocationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewCosmosdbAccountGeoLocationList_Override(c CosmosdbAccountGeoLocationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbAccountGeoLocationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbAccountGeoLocationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbAccountGeoLocationList) Resolve(context cdktn.IResolveContext) interface{} {
