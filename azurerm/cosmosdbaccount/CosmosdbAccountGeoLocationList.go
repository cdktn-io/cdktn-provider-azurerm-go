...
func (c *jsiiProxy_CosmosdbAccountGeoLocationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbAccountGeoLocationList) Resolve(context cdktf.IResolveContext) interface{} {
