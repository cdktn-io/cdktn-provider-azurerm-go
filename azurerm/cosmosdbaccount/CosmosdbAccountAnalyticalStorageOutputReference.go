...
func (c *jsiiProxy_CosmosdbAccountAnalyticalStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbAccountAnalyticalStorageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
