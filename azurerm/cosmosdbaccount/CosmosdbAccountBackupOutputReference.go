...
func (c *jsiiProxy_CosmosdbAccountBackupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbAccountBackupOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
