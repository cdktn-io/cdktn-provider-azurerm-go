...
func (j *jsiiProxy_CosmosdbAccountVirtualNetworkRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbAccountVirtualNetworkRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbAccountVirtualNetworkRuleList {
	_init_.Initialize()
...
func NewCosmosdbAccountVirtualNetworkRuleList_Override(c CosmosdbAccountVirtualNetworkRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbAccountVirtualNetworkRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbAccountVirtualNetworkRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbAccountVirtualNetworkRuleList) Resolve(context cdktn.IResolveContext) interface{} {
