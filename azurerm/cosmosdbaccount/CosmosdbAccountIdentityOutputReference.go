...
func (c *jsiiProxy_CosmosdbAccountIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbAccountIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
