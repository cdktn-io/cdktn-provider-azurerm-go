...
func (j *jsiiProxy_PrivateEndpointNetworkInterfaceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivateEndpointNetworkInterfaceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PrivateEndpointNetworkInterfaceOutputReference {
	_init_.Initialize()
...
func NewPrivateEndpointNetworkInterfaceOutputReference_Override(p PrivateEndpointNetworkInterfaceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivateEndpointNetworkInterfaceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivateEndpointNetworkInterfaceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateEndpointNetworkInterfaceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PrivateEndpointNetworkInterfaceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateEndpointNetworkInterfaceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
