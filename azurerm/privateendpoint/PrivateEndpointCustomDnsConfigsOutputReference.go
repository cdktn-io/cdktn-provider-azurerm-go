...
func (j *jsiiProxy_PrivateEndpointCustomDnsConfigsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivateEndpointCustomDnsConfigsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PrivateEndpointCustomDnsConfigsOutputReference {
	_init_.Initialize()

	if err := validateNewPrivateEndpointCustomDnsConfigsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewPrivateEndpointCustomDnsConfigsOutputReference_Override(p PrivateEndpointCustomDnsConfigsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivateEndpointCustomDnsConfigsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivateEndpointCustomDnsConfigsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateEndpointCustomDnsConfigsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PrivateEndpointCustomDnsConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateEndpointCustomDnsConfigsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
