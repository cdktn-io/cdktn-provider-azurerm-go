...
func (j *jsiiProxy_PrivateEndpointPrivateDnsZoneGroupOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivateEndpointPrivateDnsZoneGroupOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PrivateEndpointPrivateDnsZoneGroupOutputReference {
	_init_.Initialize()

	if err := validateNewPrivateEndpointPrivateDnsZoneGroupOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewPrivateEndpointPrivateDnsZoneGroupOutputReference_Override(p PrivateEndpointPrivateDnsZoneGroupOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivateEndpointPrivateDnsZoneGroupOutputReference)SetPrivateDnsZoneIds(val *[]*string) {
	if err := j.validateSetPrivateDnsZoneIdsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_PrivateEndpointPrivateDnsZoneGroupOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneGroupOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneGroupOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneGroupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneGroupOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
