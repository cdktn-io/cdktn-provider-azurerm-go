...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/privateendpoint/internal"
...
func (j *jsiiProxy_PrivateEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PrivateEndpoint) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_PrivateEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PrivateEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PrivateEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PrivateEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/private_endpoint azurerm_private_endpoint} Resource.
...
func (j *jsiiProxy_PrivateEndpoint)SetCount(val interface{}) {
...
func (j *jsiiProxy_PrivateEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PrivateEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PrivateEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PrivateEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validatePrivateEndpoint_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PrivateEndpoint) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PrivateEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateEndpoint) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PrivateEndpoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PrivateEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PrivateEndpoint) MoveFromId(id *string) {
...
func (p *jsiiProxy_PrivateEndpoint) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PrivateEndpoint) MoveToId(id *string) {
...
func (p *jsiiProxy_PrivateEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PrivateEndpoint) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PrivateEndpoint) ToHclTerraform() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PrivateEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
