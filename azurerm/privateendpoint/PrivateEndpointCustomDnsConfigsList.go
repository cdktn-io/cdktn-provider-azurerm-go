...
func (j *jsiiProxy_PrivateEndpointCustomDnsConfigsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivateEndpointCustomDnsConfigsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PrivateEndpointCustomDnsConfigsList {
	_init_.Initialize()

	if err := validateNewPrivateEndpointCustomDnsConfigsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewPrivateEndpointCustomDnsConfigsList_Override(p PrivateEndpointCustomDnsConfigsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivateEndpointCustomDnsConfigsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivateEndpointCustomDnsConfigsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrivateEndpointCustomDnsConfigsList) Resolve(context cdktn.IResolveContext) interface{} {
