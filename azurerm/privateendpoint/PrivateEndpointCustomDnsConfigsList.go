...
func (p *jsiiProxy_PrivateEndpointCustomDnsConfigsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrivateEndpointCustomDnsConfigsList) Resolve(context cdktf.IResolveContext) interface{} {
