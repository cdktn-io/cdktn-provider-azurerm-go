...
func (j *jsiiProxy_PrivateEndpointNetworkInterfaceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivateEndpointNetworkInterfaceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PrivateEndpointNetworkInterfaceList {
	_init_.Initialize()
...
func NewPrivateEndpointNetworkInterfaceList_Override(p PrivateEndpointNetworkInterfaceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivateEndpointNetworkInterfaceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivateEndpointNetworkInterfaceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrivateEndpointNetworkInterfaceList) Resolve(context cdktn.IResolveContext) interface{} {
