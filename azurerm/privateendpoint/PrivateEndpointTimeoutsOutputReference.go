...
func (p *jsiiProxy_PrivateEndpointTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivateEndpointTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
