...
func (p *jsiiProxy_PrivateEndpointPrivateServiceConnectionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivateEndpointPrivateServiceConnectionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
