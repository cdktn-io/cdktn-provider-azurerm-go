...
func (j *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivateEndpointPrivateDnsZoneConfigsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PrivateEndpointPrivateDnsZoneConfigsList {
	_init_.Initialize()
...
func NewPrivateEndpointPrivateDnsZoneConfigsList_Override(p PrivateEndpointPrivateDnsZoneConfigsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsList) Resolve(context cdktn.IResolveContext) interface{} {
