...
func (j *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivateEndpointPrivateDnsZoneConfigsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PrivateEndpointPrivateDnsZoneConfigsOutputReference {
	_init_.Initialize()

	if err := validateNewPrivateEndpointPrivateDnsZoneConfigsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewPrivateEndpointPrivateDnsZoneConfigsOutputReference_Override(p PrivateEndpointPrivateDnsZoneConfigsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
