...
func (j *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsRecordSetsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPrivateEndpointPrivateDnsZoneConfigsRecordSetsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PrivateEndpointPrivateDnsZoneConfigsRecordSetsList {
	_init_.Initialize()
...
func NewPrivateEndpointPrivateDnsZoneConfigsRecordSetsList_Override(p PrivateEndpointPrivateDnsZoneConfigsRecordSetsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsRecordSetsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsRecordSetsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsRecordSetsList) Resolve(context cdktn.IResolveContext) interface{} {
