...
func (j *jsiiProxy_ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList {
	_init_.Initialize()
...
func NewApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList_Override(a ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
