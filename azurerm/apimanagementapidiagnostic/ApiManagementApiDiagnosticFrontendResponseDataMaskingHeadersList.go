...
func (j *jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersList {
	_init_.Initialize()

	if err := validateNewApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementApiDiagnostic.ApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersList",
...
func NewApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersList_Override(a ApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
