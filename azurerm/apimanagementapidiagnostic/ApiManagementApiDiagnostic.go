...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/api_management_api_diagnostic azurerm_api_management_api_diagnostic} Resource.
...
func (a *jsiiProxy_ApiManagementApiDiagnostic) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiManagementApiDiagnostic) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiManagementApiDiagnostic) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
