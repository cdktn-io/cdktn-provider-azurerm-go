...
func (j *jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingQueryParamsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiDiagnosticFrontendResponseDataMaskingQueryParamsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiDiagnosticFrontendResponseDataMaskingQueryParamsList {
	_init_.Initialize()

	if err := validateNewApiManagementApiDiagnosticFrontendResponseDataMaskingQueryParamsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingQueryParamsList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementApiDiagnostic.ApiManagementApiDiagnosticFrontendResponseDataMaskingQueryParamsList",
...
func NewApiManagementApiDiagnosticFrontendResponseDataMaskingQueryParamsList_Override(a ApiManagementApiDiagnosticFrontendResponseDataMaskingQueryParamsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingQueryParamsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingQueryParamsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingQueryParamsList) Resolve(context cdktn.IResolveContext) interface{} {
