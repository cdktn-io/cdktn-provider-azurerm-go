...
func (j *jsiiProxy_ApiManagementApiDiagnosticFrontendRequestDataMaskingQueryParamsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiDiagnosticFrontendRequestDataMaskingQueryParamsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiDiagnosticFrontendRequestDataMaskingQueryParamsList {
	_init_.Initialize()

	if err := validateNewApiManagementApiDiagnosticFrontendRequestDataMaskingQueryParamsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementApiDiagnosticFrontendRequestDataMaskingQueryParamsList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementApiDiagnostic.ApiManagementApiDiagnosticFrontendRequestDataMaskingQueryParamsList",
...
func NewApiManagementApiDiagnosticFrontendRequestDataMaskingQueryParamsList_Override(a ApiManagementApiDiagnosticFrontendRequestDataMaskingQueryParamsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiDiagnosticFrontendRequestDataMaskingQueryParamsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticFrontendRequestDataMaskingQueryParamsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticFrontendRequestDataMaskingQueryParamsList) Resolve(context cdktn.IResolveContext) interface{} {
