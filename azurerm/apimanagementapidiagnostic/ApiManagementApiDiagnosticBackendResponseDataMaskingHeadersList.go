...
func (j *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiDiagnosticBackendResponseDataMaskingHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementApiDiagnostic.ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersList",
...
func NewApiManagementApiDiagnosticBackendResponseDataMaskingHeadersList_Override(a ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
