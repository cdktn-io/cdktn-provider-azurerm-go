...
func (j *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementApiDiagnostic.ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference",
...
func NewApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference_Override(a ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingHeadersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
