...
func (j *jsiiProxy_ApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersList {
	_init_.Initialize()

	if err := validateNewApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementApiDiagnostic.ApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersList",
...
func NewApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersList_Override(a ApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
