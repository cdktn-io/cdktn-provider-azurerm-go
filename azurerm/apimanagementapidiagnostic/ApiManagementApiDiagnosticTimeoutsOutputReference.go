...
func (a *jsiiProxy_ApiManagementApiDiagnosticTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
