...
func (j *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingQueryParamsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiDiagnosticBackendResponseDataMaskingQueryParamsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiDiagnosticBackendResponseDataMaskingQueryParamsList {
	_init_.Initialize()

	if err := validateNewApiManagementApiDiagnosticBackendResponseDataMaskingQueryParamsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingQueryParamsList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.apiManagementApiDiagnostic.ApiManagementApiDiagnosticBackendResponseDataMaskingQueryParamsList",
...
func NewApiManagementApiDiagnosticBackendResponseDataMaskingQueryParamsList_Override(a ApiManagementApiDiagnosticBackendResponseDataMaskingQueryParamsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingQueryParamsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingQueryParamsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendResponseDataMaskingQueryParamsList) Resolve(context cdktn.IResolveContext) interface{} {
