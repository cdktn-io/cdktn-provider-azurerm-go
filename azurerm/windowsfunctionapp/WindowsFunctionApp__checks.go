...
func (w *jsiiProxy_WindowsFunctionApp) validatePutConnectionStringParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*WindowsFunctionAppConnectionString; received %#v (a %T)", value, value)
		}
	}
...
func (w *jsiiProxy_WindowsFunctionApp) validatePutStorageAccountParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*WindowsFunctionAppStorageAccount; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_WindowsFunctionApp) validateSetLifecycleParameters(val *cdktf.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
