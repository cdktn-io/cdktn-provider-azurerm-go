...
func (j *jsiiProxy_WindowsFunctionAppSiteCredentialList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSiteCredentialList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsFunctionAppSiteCredentialList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsFunctionApp.WindowsFunctionAppSiteCredentialList",
...
func NewWindowsFunctionAppSiteCredentialList_Override(w WindowsFunctionAppSiteCredentialList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSiteCredentialList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSiteCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsFunctionAppSiteCredentialList) Resolve(context cdktn.IResolveContext) interface{} {
