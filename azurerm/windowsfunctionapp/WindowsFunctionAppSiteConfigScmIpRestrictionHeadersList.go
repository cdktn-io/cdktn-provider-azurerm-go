...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionHeadersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSiteConfigScmIpRestrictionHeadersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsFunctionAppSiteConfigScmIpRestrictionHeadersList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigScmIpRestrictionHeadersList",
...
func NewWindowsFunctionAppSiteConfigScmIpRestrictionHeadersList_Override(w WindowsFunctionAppSiteConfigScmIpRestrictionHeadersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionHeadersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionHeadersList) Resolve(context cdktn.IResolveContext) interface{} {
