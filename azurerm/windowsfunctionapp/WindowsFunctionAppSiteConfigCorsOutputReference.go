...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigCorsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSiteConfigCorsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsFunctionAppSiteConfigCorsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigCorsOutputReference",
...
func NewWindowsFunctionAppSiteConfigCorsOutputReference_Override(w WindowsFunctionAppSiteConfigCorsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigCorsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigCorsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigCorsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigCorsOutputReference) ResetAllowedOrigins() {
	_jsii_.InvokeVoid(
		w,
		"resetAllowedOrigins",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigCorsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
