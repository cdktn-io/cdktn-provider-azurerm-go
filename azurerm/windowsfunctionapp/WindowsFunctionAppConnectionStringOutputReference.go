...
func (j *jsiiProxy_WindowsFunctionAppConnectionStringOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppConnectionStringOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsFunctionAppConnectionStringOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsFunctionApp.WindowsFunctionAppConnectionStringOutputReference",
...
func NewWindowsFunctionAppConnectionStringOutputReference_Override(w WindowsFunctionAppConnectionStringOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppConnectionStringOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppConnectionStringOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppConnectionStringOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsFunctionAppConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppConnectionStringOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
