...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSiteConfigScmIpRestrictionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsFunctionAppSiteConfigScmIpRestrictionList {
	_init_.Initialize()

	if err := validateNewWindowsFunctionAppSiteConfigScmIpRestrictionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigScmIpRestrictionList",
...
func NewWindowsFunctionAppSiteConfigScmIpRestrictionList_Override(w WindowsFunctionAppSiteConfigScmIpRestrictionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionList) Resolve(context cdktn.IResolveContext) interface{} {
