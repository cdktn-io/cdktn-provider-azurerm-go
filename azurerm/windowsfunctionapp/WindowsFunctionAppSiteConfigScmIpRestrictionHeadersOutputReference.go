...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference",
...
func NewWindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference_Override(w WindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
