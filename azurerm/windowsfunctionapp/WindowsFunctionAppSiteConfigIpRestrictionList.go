...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigIpRestrictionList) Resolve(context cdktf.IResolveContext) interface{} {
