...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigIpRestrictionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppSiteConfigIpRestrictionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsFunctionAppSiteConfigIpRestrictionList {
	_init_.Initialize()

	if err := validateNewWindowsFunctionAppSiteConfigIpRestrictionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsFunctionAppSiteConfigIpRestrictionList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigIpRestrictionList",
...
func NewWindowsFunctionAppSiteConfigIpRestrictionList_Override(w WindowsFunctionAppSiteConfigIpRestrictionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigIpRestrictionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigIpRestrictionList) Resolve(context cdktn.IResolveContext) interface{} {
