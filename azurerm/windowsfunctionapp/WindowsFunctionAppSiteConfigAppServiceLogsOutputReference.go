...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigAppServiceLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigAppServiceLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
