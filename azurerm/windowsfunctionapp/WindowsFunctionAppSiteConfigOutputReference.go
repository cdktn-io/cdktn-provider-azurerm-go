...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference) IpRestrictionDefaultAction() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference) IpRestrictionDefaultActionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference) MinimumTlsCipherSuite() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference) MinimumTlsCipherSuiteInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference) ScmIpRestrictionDefaultAction() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference) ScmIpRestrictionDefaultActionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewWindowsFunctionAppSiteConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsFunctionAppSiteConfigOutputReference {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsFunctionApp.WindowsFunctionAppSiteConfigOutputReference",
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference)SetIpRestrictionDefaultAction(val *string) {
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference)SetMinimumTlsCipherSuite(val *string) {
...
func (j *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference)SetScmIpRestrictionDefaultAction(val *string) {
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference) ResetIpRestrictionDefaultAction() {
	_jsii_.InvokeVoid(
		w,
		"resetIpRestrictionDefaultAction",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference) ResetMinimumTlsCipherSuite() {
	_jsii_.InvokeVoid(
		w,
		"resetMinimumTlsCipherSuite",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsFunctionAppSiteConfigOutputReference) ResetScmIpRestrictionDefaultAction() {
	_jsii_.InvokeVoid(
		w,
		"resetScmIpRestrictionDefaultAction",
		nil, // no parameters
