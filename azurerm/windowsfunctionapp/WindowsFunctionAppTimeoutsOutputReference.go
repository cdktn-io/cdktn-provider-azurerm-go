...
func (w *jsiiProxy_WindowsFunctionAppTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
