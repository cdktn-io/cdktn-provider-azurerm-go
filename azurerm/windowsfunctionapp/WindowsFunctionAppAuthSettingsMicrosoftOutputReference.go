...
func (j *jsiiProxy_WindowsFunctionAppAuthSettingsMicrosoftOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWindowsFunctionAppAuthSettingsMicrosoftOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WindowsFunctionAppAuthSettingsMicrosoftOutputReference {
	_init_.Initialize()

	if err := validateNewWindowsFunctionAppAuthSettingsMicrosoftOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_WindowsFunctionAppAuthSettingsMicrosoftOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.windowsFunctionApp.WindowsFunctionAppAuthSettingsMicrosoftOutputReference",
...
func NewWindowsFunctionAppAuthSettingsMicrosoftOutputReference_Override(w WindowsFunctionAppAuthSettingsMicrosoftOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_WindowsFunctionAppAuthSettingsMicrosoftOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WindowsFunctionAppAuthSettingsMicrosoftOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppAuthSettingsMicrosoftOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (w *jsiiProxy_WindowsFunctionAppAuthSettingsMicrosoftOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppAuthSettingsMicrosoftOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
