...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "searchServiceId", GoGetter: "SearchServiceId"},
			_jsii_.MemberProperty{JsiiProperty: "searchServiceIdInput", GoGetter: "SearchServiceIdInput"},
