...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/servicebus_namespace_disaster_recovery_config azurerm_servicebus_namespace_disaster_recovery_config} Resource.
...
func (s *jsiiProxy_ServicebusNamespaceDisasterRecoveryConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_ServicebusNamespaceDisasterRecoveryConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_ServicebusNamespaceDisasterRecoveryConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
