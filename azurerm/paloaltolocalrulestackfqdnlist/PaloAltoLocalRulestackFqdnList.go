...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/paloaltolocalrulestackfqdnlist/internal"
...
func (j *jsiiProxy_PaloAltoLocalRulestackFqdnList) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PaloAltoLocalRulestackFqdnList) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PaloAltoLocalRulestackFqdnList) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PaloAltoLocalRulestackFqdnList) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PaloAltoLocalRulestackFqdnList) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/palo_alto_local_rulestack_fqdn_list azurerm_palo_alto_local_rulestack_fqdn_list} Resource.
func NewPaloAltoLocalRulestackFqdnList(scope constructs.Construct, id *string, config *PaloAltoLocalRulestackFqdnListConfig) PaloAltoLocalRulestackFqdnList {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.paloAltoLocalRulestackFqdnList.PaloAltoLocalRulestackFqdnList",
...
func (j *jsiiProxy_PaloAltoLocalRulestackFqdnList)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PaloAltoLocalRulestackFqdnList)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PaloAltoLocalRulestackFqdnList)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PaloAltoLocalRulestackFqdnList_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PaloAltoLocalRulestackFqdnList) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PaloAltoLocalRulestackFqdnList) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PaloAltoLocalRulestackFqdnList) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PaloAltoLocalRulestackFqdnList) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PaloAltoLocalRulestackFqdnList) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PaloAltoLocalRulestackFqdnList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
