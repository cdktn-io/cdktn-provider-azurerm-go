...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/sentinel_data_connector_microsoft_cloud_app_security azurerm_sentinel_data_connector_microsoft_cloud_app_security} Resource.
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftCloudAppSecurity) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftCloudAppSecurity) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SentinelDataConnectorMicrosoftCloudAppSecurity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
