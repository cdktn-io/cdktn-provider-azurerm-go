...
func (j *jsiiProxy_NetappVolumeExportPolicyRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetappVolumeExportPolicyRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetappVolumeExportPolicyRuleList {
	_init_.Initialize()
...
func NewNetappVolumeExportPolicyRuleList_Override(n NetappVolumeExportPolicyRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetappVolumeExportPolicyRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetappVolumeExportPolicyRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetappVolumeExportPolicyRuleList) Resolve(context cdktn.IResolveContext) interface{} {
