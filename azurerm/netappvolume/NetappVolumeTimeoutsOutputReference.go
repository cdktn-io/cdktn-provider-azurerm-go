...
func (n *jsiiProxy_NetappVolumeTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetappVolumeTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
