...
func (n *jsiiProxy_NetappVolumeDataProtectionSnapshotPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetappVolumeDataProtectionSnapshotPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
