...
func (j *jsiiProxy_NetappVolumeDataProtectionSnapshotPolicyOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetappVolumeDataProtectionSnapshotPolicyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) NetappVolumeDataProtectionSnapshotPolicyOutputReference {
	_init_.Initialize()

	if err := validateNewNetappVolumeDataProtectionSnapshotPolicyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewNetappVolumeDataProtectionSnapshotPolicyOutputReference_Override(n NetappVolumeDataProtectionSnapshotPolicyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetappVolumeDataProtectionSnapshotPolicyOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetappVolumeDataProtectionSnapshotPolicyOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetappVolumeDataProtectionSnapshotPolicyOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetappVolumeDataProtectionSnapshotPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetappVolumeDataProtectionSnapshotPolicyOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
