...
func (n *jsiiProxy_NetappVolumeCoolAccessOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetappVolumeCoolAccessOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
