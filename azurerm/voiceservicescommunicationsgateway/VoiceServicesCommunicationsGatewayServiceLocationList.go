...
func (v *jsiiProxy_VoiceServicesCommunicationsGatewayServiceLocationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VoiceServicesCommunicationsGatewayServiceLocationList) Resolve(context cdktf.IResolveContext) interface{} {
