...
func (j *jsiiProxy_VoiceServicesCommunicationsGatewayServiceLocationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVoiceServicesCommunicationsGatewayServiceLocationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VoiceServicesCommunicationsGatewayServiceLocationList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.voiceServicesCommunicationsGateway.VoiceServicesCommunicationsGatewayServiceLocationList",
...
func NewVoiceServicesCommunicationsGatewayServiceLocationList_Override(v VoiceServicesCommunicationsGatewayServiceLocationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VoiceServicesCommunicationsGatewayServiceLocationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VoiceServicesCommunicationsGatewayServiceLocationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VoiceServicesCommunicationsGatewayServiceLocationList) Resolve(context cdktn.IResolveContext) interface{} {
