...
func (j *jsiiProxy_DatadogMonitor) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DatadogMonitor) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DatadogMonitor) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DatadogMonitor) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DatadogMonitor) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/datadog_monitor azurerm_datadog_monitor} Resource.
...
func (j *jsiiProxy_DatadogMonitor)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DatadogMonitor)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatadogMonitor)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DatadogMonitor_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDatadogMonitor_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DatadogMonitor) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DatadogMonitor) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatadogMonitor) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DatadogMonitor) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DatadogMonitor) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatadogMonitor) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatadogMonitor) MoveFromId(id *string) {
...
func (d *jsiiProxy_DatadogMonitor) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DatadogMonitor) MoveToId(id *string) {
...
func (d *jsiiProxy_DatadogMonitor) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatadogMonitor) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DatadogMonitor) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DatadogMonitor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
