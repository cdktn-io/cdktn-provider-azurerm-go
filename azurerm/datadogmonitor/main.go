...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "datadogOrganization", GoGetter: "DatadogOrganization"},
			_jsii_.MemberProperty{JsiiProperty: "datadogOrganizationInput", GoGetter: "DatadogOrganizationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "marketplaceSubscriptionStatus", GoGetter: "MarketplaceSubscriptionStatus"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDatadogOrganization", GoMethod: "PutDatadogOrganization"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "linkingAuthCode", GoGetter: "LinkingAuthCode"},
			_jsii_.MemberProperty{JsiiProperty: "linkingAuthCodeInput", GoGetter: "LinkingAuthCodeInput"},
			_jsii_.MemberProperty{JsiiProperty: "linkingClientId", GoGetter: "LinkingClientId"},
			_jsii_.MemberProperty{JsiiProperty: "linkingClientIdInput", GoGetter: "LinkingClientIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLinkingAuthCode", GoMethod: "ResetLinkingAuthCode"},
			_jsii_.MemberMethod{JsiiMethod: "resetLinkingClientId", GoMethod: "ResetLinkingClientId"},
