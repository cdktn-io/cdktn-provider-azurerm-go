...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/datadogmonitor/internal"
...
func (j *jsiiProxy_DatadogMonitorTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDatadogMonitorTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DatadogMonitorTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewDatadogMonitorTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewDatadogMonitorTimeoutsOutputReference_Override(d DatadogMonitorTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DatadogMonitorTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DatadogMonitorTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatadogMonitorTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DatadogMonitorTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatadogMonitorTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
