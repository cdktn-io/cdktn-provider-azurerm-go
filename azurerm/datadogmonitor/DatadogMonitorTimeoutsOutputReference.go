...
func (d *jsiiProxy_DatadogMonitorTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatadogMonitorTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
