...
func (m *jsiiProxy_MonitorActionGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
