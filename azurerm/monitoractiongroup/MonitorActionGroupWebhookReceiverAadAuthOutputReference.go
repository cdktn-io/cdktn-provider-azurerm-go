...
func (j *jsiiProxy_MonitorActionGroupWebhookReceiverAadAuthOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupWebhookReceiverAadAuthOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MonitorActionGroupWebhookReceiverAadAuthOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorActionGroupWebhookReceiverAadAuthOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewMonitorActionGroupWebhookReceiverAadAuthOutputReference_Override(m MonitorActionGroupWebhookReceiverAadAuthOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupWebhookReceiverAadAuthOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupWebhookReceiverAadAuthOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupWebhookReceiverAadAuthOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorActionGroupWebhookReceiverAadAuthOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupWebhookReceiverAadAuthOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
