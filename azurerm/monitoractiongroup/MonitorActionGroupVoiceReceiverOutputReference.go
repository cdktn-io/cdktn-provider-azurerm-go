...
func (m *jsiiProxy_MonitorActionGroupVoiceReceiverOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupVoiceReceiverOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
