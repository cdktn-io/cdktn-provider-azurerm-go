...
func (j *jsiiProxy_MonitorActionGroupAutomationRunbookReceiverOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupAutomationRunbookReceiverOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorActionGroupAutomationRunbookReceiverOutputReference {
	_init_.Initialize()
...
func NewMonitorActionGroupAutomationRunbookReceiverOutputReference_Override(m MonitorActionGroupAutomationRunbookReceiverOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupAutomationRunbookReceiverOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupAutomationRunbookReceiverOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupAutomationRunbookReceiverOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorActionGroupAutomationRunbookReceiverOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupAutomationRunbookReceiverOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
