...
func (m *jsiiProxy_MonitorActionGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MonitorActionGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
