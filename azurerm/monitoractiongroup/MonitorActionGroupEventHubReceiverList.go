...
func (j *jsiiProxy_MonitorActionGroupEventHubReceiverList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupEventHubReceiverList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupEventHubReceiverList {
	_init_.Initialize()

	if err := validateNewMonitorActionGroupEventHubReceiverListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewMonitorActionGroupEventHubReceiverList_Override(m MonitorActionGroupEventHubReceiverList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupEventHubReceiverList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupEventHubReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupEventHubReceiverList) Resolve(context cdktn.IResolveContext) interface{} {
