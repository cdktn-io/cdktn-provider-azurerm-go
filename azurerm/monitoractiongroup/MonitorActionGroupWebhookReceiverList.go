...
func (j *jsiiProxy_MonitorActionGroupWebhookReceiverList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupWebhookReceiverList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupWebhookReceiverList {
	_init_.Initialize()
...
func NewMonitorActionGroupWebhookReceiverList_Override(m MonitorActionGroupWebhookReceiverList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupWebhookReceiverList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupWebhookReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupWebhookReceiverList) Resolve(context cdktn.IResolveContext) interface{} {
