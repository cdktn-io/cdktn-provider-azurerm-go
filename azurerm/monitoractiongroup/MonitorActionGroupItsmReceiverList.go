...
func (m *jsiiProxy_MonitorActionGroupItsmReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupItsmReceiverList) Resolve(context cdktf.IResolveContext) interface{} {
