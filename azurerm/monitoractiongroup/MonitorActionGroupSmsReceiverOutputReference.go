...
func (j *jsiiProxy_MonitorActionGroupSmsReceiverOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupSmsReceiverOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorActionGroupSmsReceiverOutputReference {
	_init_.Initialize()
...
func NewMonitorActionGroupSmsReceiverOutputReference_Override(m MonitorActionGroupSmsReceiverOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupSmsReceiverOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupSmsReceiverOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupSmsReceiverOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorActionGroupSmsReceiverOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupSmsReceiverOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
