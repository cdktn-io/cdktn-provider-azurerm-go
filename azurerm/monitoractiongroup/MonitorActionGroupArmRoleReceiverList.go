...
func (j *jsiiProxy_MonitorActionGroupArmRoleReceiverList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupArmRoleReceiverList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupArmRoleReceiverList {
	_init_.Initialize()
...
func NewMonitorActionGroupArmRoleReceiverList_Override(m MonitorActionGroupArmRoleReceiverList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupArmRoleReceiverList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupArmRoleReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupArmRoleReceiverList) Resolve(context cdktn.IResolveContext) interface{} {
