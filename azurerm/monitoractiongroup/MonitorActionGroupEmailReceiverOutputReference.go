...
func (j *jsiiProxy_MonitorActionGroupEmailReceiverOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupEmailReceiverOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorActionGroupEmailReceiverOutputReference {
	_init_.Initialize()
...
func NewMonitorActionGroupEmailReceiverOutputReference_Override(m MonitorActionGroupEmailReceiverOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupEmailReceiverOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupEmailReceiverOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupEmailReceiverOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorActionGroupEmailReceiverOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupEmailReceiverOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
