...
func (j *jsiiProxy_MonitorActionGroupAutomationRunbookReceiverList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupAutomationRunbookReceiverList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupAutomationRunbookReceiverList {
	_init_.Initialize()

	if err := validateNewMonitorActionGroupAutomationRunbookReceiverListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewMonitorActionGroupAutomationRunbookReceiverList_Override(m MonitorActionGroupAutomationRunbookReceiverList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupAutomationRunbookReceiverList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupAutomationRunbookReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupAutomationRunbookReceiverList) Resolve(context cdktn.IResolveContext) interface{} {
