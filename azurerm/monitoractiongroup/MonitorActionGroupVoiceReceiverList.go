...
func (m *jsiiProxy_MonitorActionGroupVoiceReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupVoiceReceiverList) Resolve(context cdktf.IResolveContext) interface{} {
