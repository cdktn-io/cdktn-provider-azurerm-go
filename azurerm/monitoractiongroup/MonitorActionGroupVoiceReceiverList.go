...
func (j *jsiiProxy_MonitorActionGroupVoiceReceiverList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupVoiceReceiverList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupVoiceReceiverList {
	_init_.Initialize()

	if err := validateNewMonitorActionGroupVoiceReceiverListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewMonitorActionGroupVoiceReceiverList_Override(m MonitorActionGroupVoiceReceiverList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupVoiceReceiverList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupVoiceReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupVoiceReceiverList) Resolve(context cdktn.IResolveContext) interface{} {
