...
func (j *jsiiProxy_MonitorActionGroupAzureAppPushReceiverList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupAzureAppPushReceiverList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupAzureAppPushReceiverList {
	_init_.Initialize()
...
func NewMonitorActionGroupAzureAppPushReceiverList_Override(m MonitorActionGroupAzureAppPushReceiverList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupAzureAppPushReceiverList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupAzureAppPushReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupAzureAppPushReceiverList) Resolve(context cdktn.IResolveContext) interface{} {
