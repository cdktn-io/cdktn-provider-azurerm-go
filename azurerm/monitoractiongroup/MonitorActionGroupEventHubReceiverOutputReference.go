...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/monitoractiongroup/internal"
...
func (j *jsiiProxy_MonitorActionGroupEventHubReceiverOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupEventHubReceiverOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorActionGroupEventHubReceiverOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorActionGroupEventHubReceiverOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewMonitorActionGroupEventHubReceiverOutputReference_Override(m MonitorActionGroupEventHubReceiverOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupEventHubReceiverOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupEventHubReceiverOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupEventHubReceiverOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorActionGroupEventHubReceiverOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupEventHubReceiverOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
