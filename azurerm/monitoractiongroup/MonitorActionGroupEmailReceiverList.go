...
func (j *jsiiProxy_MonitorActionGroupEmailReceiverList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupEmailReceiverList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupEmailReceiverList {
	_init_.Initialize()
...
func NewMonitorActionGroupEmailReceiverList_Override(m MonitorActionGroupEmailReceiverList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupEmailReceiverList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupEmailReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupEmailReceiverList) Resolve(context cdktn.IResolveContext) interface{} {
