...
func (j *jsiiProxy_MonitorActionGroupAzureFunctionReceiverList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupAzureFunctionReceiverList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupAzureFunctionReceiverList {
	_init_.Initialize()
...
func NewMonitorActionGroupAzureFunctionReceiverList_Override(m MonitorActionGroupAzureFunctionReceiverList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupAzureFunctionReceiverList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupAzureFunctionReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupAzureFunctionReceiverList) Resolve(context cdktn.IResolveContext) interface{} {
