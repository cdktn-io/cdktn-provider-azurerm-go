...
func (j *jsiiProxy_MonitorActionGroupLogicAppReceiverList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorActionGroupLogicAppReceiverList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupLogicAppReceiverList {
	_init_.Initialize()
...
func NewMonitorActionGroupLogicAppReceiverList_Override(m MonitorActionGroupLogicAppReceiverList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorActionGroupLogicAppReceiverList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorActionGroupLogicAppReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupLogicAppReceiverList) Resolve(context cdktn.IResolveContext) interface{} {
