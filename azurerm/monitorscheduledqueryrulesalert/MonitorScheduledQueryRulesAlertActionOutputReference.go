...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/monitorscheduledqueryrulesalert/internal"
...
func (j *jsiiProxy_MonitorScheduledQueryRulesAlertActionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMonitorScheduledQueryRulesAlertActionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MonitorScheduledQueryRulesAlertActionOutputReference {
	_init_.Initialize()

	if err := validateNewMonitorScheduledQueryRulesAlertActionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_MonitorScheduledQueryRulesAlertActionOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.monitorScheduledQueryRulesAlert.MonitorScheduledQueryRulesAlertActionOutputReference",
...
func NewMonitorScheduledQueryRulesAlertActionOutputReference_Override(m MonitorScheduledQueryRulesAlertActionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorScheduledQueryRulesAlertActionOutputReference)SetActionGroup(val *[]*string) {
	if err := j.validateSetActionGroupParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_MonitorScheduledQueryRulesAlertActionOutputReference)SetCustomWebhookPayload(val *string) {
	if err := j.validateSetCustomWebhookPayloadParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_MonitorScheduledQueryRulesAlertActionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesAlertActionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesAlertActionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MonitorScheduledQueryRulesAlertActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesAlertActionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
