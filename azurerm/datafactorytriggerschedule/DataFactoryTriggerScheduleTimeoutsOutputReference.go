...
func (d *jsiiProxy_DataFactoryTriggerScheduleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryTriggerScheduleTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
