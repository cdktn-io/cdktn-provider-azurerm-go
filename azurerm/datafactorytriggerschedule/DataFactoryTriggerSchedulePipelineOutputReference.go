...
func (j *jsiiProxy_DataFactoryTriggerSchedulePipelineOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataFactoryTriggerSchedulePipelineOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataFactoryTriggerSchedulePipelineOutputReference {
	_init_.Initialize()

	if err := validateNewDataFactoryTriggerSchedulePipelineOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewDataFactoryTriggerSchedulePipelineOutputReference_Override(d DataFactoryTriggerSchedulePipelineOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataFactoryTriggerSchedulePipelineOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataFactoryTriggerSchedulePipelineOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryTriggerSchedulePipelineOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataFactoryTriggerSchedulePipelineOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataFactoryTriggerSchedulePipelineOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
