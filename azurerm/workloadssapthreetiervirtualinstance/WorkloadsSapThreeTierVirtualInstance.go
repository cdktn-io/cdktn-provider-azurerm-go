...
func (w *jsiiProxy_WorkloadsSapThreeTierVirtualInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WorkloadsSapThreeTierVirtualInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WorkloadsSapThreeTierVirtualInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
