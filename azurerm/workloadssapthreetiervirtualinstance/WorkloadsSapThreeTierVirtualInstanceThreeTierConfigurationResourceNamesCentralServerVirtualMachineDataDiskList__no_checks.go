...
func (w *jsiiProxy_WorkloadsSapThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineDataDiskList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
