...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusQueueSerializationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsOutputServicebusQueueSerializationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
