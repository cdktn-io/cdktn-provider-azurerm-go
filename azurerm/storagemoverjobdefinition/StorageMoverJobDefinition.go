...
func (j *jsiiProxy_StorageMoverJobDefinition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StorageMoverJobDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StorageMoverJobDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StorageMoverJobDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StorageMoverJobDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/storage_mover_job_definition azurerm_storage_mover_job_definition} Resource.
...
func (j *jsiiProxy_StorageMoverJobDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StorageMoverJobDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StorageMoverJobDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StorageMoverJobDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StorageMoverJobDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageMoverJobDefinition) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StorageMoverJobDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StorageMoverJobDefinition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageMoverJobDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
