...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/hpccachenfstarget/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/hpc_cache_nfs_target azurerm_hpc_cache_nfs_target} Resource.
...
func (h *jsiiProxy_HpcCacheNfsTarget) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HpcCacheNfsTarget) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
