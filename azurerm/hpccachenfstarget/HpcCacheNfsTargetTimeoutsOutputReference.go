...
func (h *jsiiProxy_HpcCacheNfsTargetTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HpcCacheNfsTargetTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
