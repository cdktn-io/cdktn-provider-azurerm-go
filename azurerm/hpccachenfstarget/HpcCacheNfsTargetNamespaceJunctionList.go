...
func (j *jsiiProxy_HpcCacheNfsTargetNamespaceJunctionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHpcCacheNfsTargetNamespaceJunctionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HpcCacheNfsTargetNamespaceJunctionList {
	_init_.Initialize()
...
func NewHpcCacheNfsTargetNamespaceJunctionList_Override(h HpcCacheNfsTargetNamespaceJunctionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HpcCacheNfsTargetNamespaceJunctionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HpcCacheNfsTargetNamespaceJunctionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HpcCacheNfsTargetNamespaceJunctionList) Resolve(context cdktn.IResolveContext) interface{} {
