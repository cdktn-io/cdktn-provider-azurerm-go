...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/new_relic_tag_rule azurerm_new_relic_tag_rule} Resource.
...
func (n *jsiiProxy_NewRelicTagRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NewRelicTagRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NewRelicTagRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
