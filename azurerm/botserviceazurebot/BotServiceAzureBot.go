...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/botserviceazurebot/internal"
...
func (j *jsiiProxy_BotServiceAzureBot) CmkKeyVaultKeyUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cmkKeyVaultKeyUrl",
...
func (j *jsiiProxy_BotServiceAzureBot) CmkKeyVaultKeyUrlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cmkKeyVaultKeyUrlInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_BotServiceAzureBot) LocalAuthenticationEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BotServiceAzureBot) LocalAuthenticationEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BotServiceAzureBot) PublicNetworkAccessEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BotServiceAzureBot) PublicNetworkAccessEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/bot_service_azure_bot azurerm_bot_service_azure_bot} Resource.
...
func (j *jsiiProxy_BotServiceAzureBot)SetCmkKeyVaultKeyUrl(val *string) {
	if err := j.validateSetCmkKeyVaultKeyUrlParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_BotServiceAzureBot)SetLocalAuthenticationEnabled(val interface{}) {
...
func (j *jsiiProxy_BotServiceAzureBot)SetPublicNetworkAccessEnabled(val interface{}) {
...
func (b *jsiiProxy_BotServiceAzureBot) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BotServiceAzureBot) HasResourceMove() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BotServiceAzureBot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BotServiceAzureBot) MoveFromId(id *string) {
...
func (b *jsiiProxy_BotServiceAzureBot) MoveTo(moveTarget *string, index interface{}) {
...
func (b *jsiiProxy_BotServiceAzureBot) MoveToId(id *string) {
...
func (b *jsiiProxy_BotServiceAzureBot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BotServiceAzureBot) ResetCmkKeyVaultKeyUrl() {
	_jsii_.InvokeVoid(
		b,
		"resetCmkKeyVaultKeyUrl",
		nil, // no parameters
...
func (b *jsiiProxy_BotServiceAzureBot) ResetLocalAuthenticationEnabled() {
	_jsii_.InvokeVoid(
		b,
		"resetLocalAuthenticationEnabled",
		nil, // no parameters
...
func (b *jsiiProxy_BotServiceAzureBot) ResetPublicNetworkAccessEnabled() {
	_jsii_.InvokeVoid(
		b,
		"resetPublicNetworkAccessEnabled",
		nil, // no parameters
...
func (b *jsiiProxy_BotServiceAzureBot) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BotServiceAzureBot) ToHclTerraform() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BotServiceAzureBot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
