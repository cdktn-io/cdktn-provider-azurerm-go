...
func (b *jsiiProxy_BotServiceAzureBotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BotServiceAzureBotTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
