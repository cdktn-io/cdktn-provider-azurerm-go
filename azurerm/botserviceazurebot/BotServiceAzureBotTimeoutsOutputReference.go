...
func (j *jsiiProxy_BotServiceAzureBotTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBotServiceAzureBotTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BotServiceAzureBotTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewBotServiceAzureBotTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewBotServiceAzureBotTimeoutsOutputReference_Override(b BotServiceAzureBotTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_BotServiceAzureBotTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BotServiceAzureBotTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotServiceAzureBotTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BotServiceAzureBotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotServiceAzureBotTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
