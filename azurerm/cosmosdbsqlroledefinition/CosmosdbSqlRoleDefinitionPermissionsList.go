...
func (j *jsiiProxy_CosmosdbSqlRoleDefinitionPermissionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbSqlRoleDefinitionPermissionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbSqlRoleDefinitionPermissionsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.cosmosdbSqlRoleDefinition.CosmosdbSqlRoleDefinitionPermissionsList",
...
func NewCosmosdbSqlRoleDefinitionPermissionsList_Override(c CosmosdbSqlRoleDefinitionPermissionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbSqlRoleDefinitionPermissionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinitionPermissionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinitionPermissionsList) Resolve(context cdktn.IResolveContext) interface{} {
