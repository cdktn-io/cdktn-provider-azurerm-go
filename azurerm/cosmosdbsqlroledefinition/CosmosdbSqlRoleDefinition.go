...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/cosmosdbsqlroledefinition/internal"
...
func (j *jsiiProxy_CosmosdbSqlRoleDefinition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CosmosdbSqlRoleDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CosmosdbSqlRoleDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CosmosdbSqlRoleDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CosmosdbSqlRoleDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/cosmosdb_sql_role_definition azurerm_cosmosdb_sql_role_definition} Resource.
func NewCosmosdbSqlRoleDefinition(scope constructs.Construct, id *string, config *CosmosdbSqlRoleDefinitionConfig) CosmosdbSqlRoleDefinition {
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.cosmosdbSqlRoleDefinition.CosmosdbSqlRoleDefinition",
...
func (j *jsiiProxy_CosmosdbSqlRoleDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CosmosdbSqlRoleDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CosmosdbSqlRoleDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CosmosdbSqlRoleDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinition) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
