...
func (l *jsiiProxy_LinuxWebAppSlotBackupScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotBackupScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
