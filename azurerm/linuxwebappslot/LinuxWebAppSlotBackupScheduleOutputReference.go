...
func (j *jsiiProxy_LinuxWebAppSlotBackupScheduleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxWebAppSlotBackupScheduleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LinuxWebAppSlotBackupScheduleOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxWebAppSlotBackupScheduleOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxWebAppSlotBackupScheduleOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxWebAppSlot.LinuxWebAppSlotBackupScheduleOutputReference",
...
func NewLinuxWebAppSlotBackupScheduleOutputReference_Override(l LinuxWebAppSlotBackupScheduleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxWebAppSlotBackupScheduleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxWebAppSlotBackupScheduleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotBackupScheduleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxWebAppSlotBackupScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotBackupScheduleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
