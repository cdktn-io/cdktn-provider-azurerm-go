...
func (j *jsiiProxy_LinuxWebAppSlot) EndToEndTlsEncryptionEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LinuxWebAppSlot) EndToEndTlsEncryptionEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LinuxWebAppSlot) VnetImagePullEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LinuxWebAppSlot) VnetImagePullEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LinuxWebAppSlot)SetEndToEndTlsEncryptionEnabled(val interface{}) {
...
func (j *jsiiProxy_LinuxWebAppSlot)SetVnetImagePullEnabled(val interface{}) {
...
func (l *jsiiProxy_LinuxWebAppSlot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LinuxWebAppSlot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LinuxWebAppSlot) ResetEndToEndTlsEncryptionEnabled() {
	_jsii_.InvokeVoid(
		l,
		"resetEndToEndTlsEncryptionEnabled",
		nil, // no parameters
...
func (l *jsiiProxy_LinuxWebAppSlot) ResetVnetImagePullEnabled() {
	_jsii_.InvokeVoid(
		l,
		"resetVnetImagePullEnabled",
		nil, // no parameters
...
func (l *jsiiProxy_LinuxWebAppSlot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
