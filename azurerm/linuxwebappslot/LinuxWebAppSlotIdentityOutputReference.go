...
func (l *jsiiProxy_LinuxWebAppSlotIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
