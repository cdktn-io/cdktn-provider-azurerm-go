...
func (l *jsiiProxy_LinuxWebAppSlotSiteCredentialOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotSiteCredentialOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
