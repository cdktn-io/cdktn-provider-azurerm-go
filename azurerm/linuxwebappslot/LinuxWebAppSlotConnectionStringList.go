...
func (j *jsiiProxy_LinuxWebAppSlotConnectionStringList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxWebAppSlotConnectionStringList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxWebAppSlotConnectionStringList {
	_init_.Initialize()

	if err := validateNewLinuxWebAppSlotConnectionStringListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxWebAppSlotConnectionStringList{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxWebAppSlot.LinuxWebAppSlotConnectionStringList",
...
func NewLinuxWebAppSlotConnectionStringList_Override(l LinuxWebAppSlotConnectionStringList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxWebAppSlotConnectionStringList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxWebAppSlotConnectionStringList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxWebAppSlotConnectionStringList) Resolve(context cdktn.IResolveContext) interface{} {
