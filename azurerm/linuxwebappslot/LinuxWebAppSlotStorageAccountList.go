...
func (j *jsiiProxy_LinuxWebAppSlotStorageAccountList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxWebAppSlotStorageAccountList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxWebAppSlotStorageAccountList {
	_init_.Initialize()
...
func NewLinuxWebAppSlotStorageAccountList_Override(l LinuxWebAppSlotStorageAccountList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxWebAppSlotStorageAccountList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxWebAppSlotStorageAccountList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxWebAppSlotStorageAccountList) Resolve(context cdktn.IResolveContext) interface{} {
