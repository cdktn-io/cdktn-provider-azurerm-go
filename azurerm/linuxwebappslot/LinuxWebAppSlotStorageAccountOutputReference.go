...
func (l *jsiiProxy_LinuxWebAppSlotStorageAccountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotStorageAccountOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
