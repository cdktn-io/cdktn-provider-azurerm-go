...
func (j *jsiiProxy_LinuxWebAppSlotAuthSettingsGithubOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxWebAppSlotAuthSettingsGithubOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LinuxWebAppSlotAuthSettingsGithubOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxWebAppSlotAuthSettingsGithubOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxWebAppSlotAuthSettingsGithubOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxWebAppSlot.LinuxWebAppSlotAuthSettingsGithubOutputReference",
...
func NewLinuxWebAppSlotAuthSettingsGithubOutputReference_Override(l LinuxWebAppSlotAuthSettingsGithubOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxWebAppSlotAuthSettingsGithubOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxWebAppSlotAuthSettingsGithubOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotAuthSettingsGithubOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxWebAppSlotAuthSettingsGithubOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotAuthSettingsGithubOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
