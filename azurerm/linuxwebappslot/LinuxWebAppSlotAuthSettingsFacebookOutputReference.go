...
func (j *jsiiProxy_LinuxWebAppSlotAuthSettingsFacebookOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxWebAppSlotAuthSettingsFacebookOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LinuxWebAppSlotAuthSettingsFacebookOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxWebAppSlotAuthSettingsFacebookOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxWebAppSlotAuthSettingsFacebookOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxWebAppSlot.LinuxWebAppSlotAuthSettingsFacebookOutputReference",
...
func NewLinuxWebAppSlotAuthSettingsFacebookOutputReference_Override(l LinuxWebAppSlotAuthSettingsFacebookOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxWebAppSlotAuthSettingsFacebookOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxWebAppSlotAuthSettingsFacebookOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotAuthSettingsFacebookOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxWebAppSlotAuthSettingsFacebookOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotAuthSettingsFacebookOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
