...
func (j *jsiiProxy_LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxWebAppSlot.LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList",
...
func NewLinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList_Override(l LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeList) Resolve(context cdktn.IResolveContext) interface{} {
