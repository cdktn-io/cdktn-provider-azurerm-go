...
func (j *jsiiProxy_LinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference {
	_init_.Initialize()

	if err := validateNewLinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_LinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.linuxWebAppSlot.LinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference",
...
func NewLinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference_Override(l LinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotLogsHttpLogsAzureBlobStorageOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
