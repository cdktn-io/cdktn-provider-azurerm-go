...
func (j *jsiiProxy_CosmosdbCassandraTableSchemaColumnOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbCassandraTableSchemaColumnOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CosmosdbCassandraTableSchemaColumnOutputReference {
	_init_.Initialize()

	if err := validateNewCosmosdbCassandraTableSchemaColumnOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewCosmosdbCassandraTableSchemaColumnOutputReference_Override(c CosmosdbCassandraTableSchemaColumnOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbCassandraTableSchemaColumnOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaColumnOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaColumnOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaColumnOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaColumnOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
