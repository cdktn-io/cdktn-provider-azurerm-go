...
func (j *jsiiProxy_CosmosdbCassandraTableSchemaColumnList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbCassandraTableSchemaColumnList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbCassandraTableSchemaColumnList {
	_init_.Initialize()
...
func NewCosmosdbCassandraTableSchemaColumnList_Override(c CosmosdbCassandraTableSchemaColumnList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbCassandraTableSchemaColumnList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaColumnList) Resolve(context cdktn.IResolveContext) interface{} {
