...
func (j *jsiiProxy_CosmosdbCassandraTableSchemaPartitionKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbCassandraTableSchemaPartitionKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbCassandraTableSchemaPartitionKeyList {
	_init_.Initialize()
...
func NewCosmosdbCassandraTableSchemaPartitionKeyList_Override(c CosmosdbCassandraTableSchemaPartitionKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbCassandraTableSchemaPartitionKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaPartitionKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaPartitionKeyList) Resolve(context cdktn.IResolveContext) interface{} {
