...
func (j *jsiiProxy_CosmosdbCassandraTableAutoscaleSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbCassandraTableAutoscaleSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CosmosdbCassandraTableAutoscaleSettingsOutputReference {
	_init_.Initialize()

	if err := validateNewCosmosdbCassandraTableAutoscaleSettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewCosmosdbCassandraTableAutoscaleSettingsOutputReference_Override(c CosmosdbCassandraTableAutoscaleSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbCassandraTableAutoscaleSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbCassandraTableAutoscaleSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraTableAutoscaleSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CosmosdbCassandraTableAutoscaleSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraTableAutoscaleSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
