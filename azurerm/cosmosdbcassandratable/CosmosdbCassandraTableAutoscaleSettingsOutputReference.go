...
func (c *jsiiProxy_CosmosdbCassandraTableAutoscaleSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraTableAutoscaleSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
