...
func (c *jsiiProxy_CosmosdbCassandraTableTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbCassandraTableTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
