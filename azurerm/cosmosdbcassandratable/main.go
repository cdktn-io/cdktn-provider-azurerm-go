...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "cassandraKeyspaceId", GoGetter: "CassandraKeyspaceId"},
			_jsii_.MemberProperty{JsiiProperty: "cassandraKeyspaceIdInput", GoGetter: "CassandraKeyspaceIdInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "clusterKeyInput", GoGetter: "ClusterKeyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putClusterKey", GoMethod: "PutClusterKey"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetClusterKey", GoMethod: "ResetClusterKey"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
