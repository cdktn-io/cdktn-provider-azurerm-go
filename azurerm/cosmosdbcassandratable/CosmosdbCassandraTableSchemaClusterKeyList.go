...
func (j *jsiiProxy_CosmosdbCassandraTableSchemaClusterKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCosmosdbCassandraTableSchemaClusterKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbCassandraTableSchemaClusterKeyList {
	_init_.Initialize()
...
func NewCosmosdbCassandraTableSchemaClusterKeyList_Override(c CosmosdbCassandraTableSchemaClusterKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CosmosdbCassandraTableSchemaClusterKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaClusterKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaClusterKeyList) Resolve(context cdktn.IResolveContext) interface{} {
