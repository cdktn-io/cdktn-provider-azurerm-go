...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isGlobal", GoGetter: "IsGlobal"},
			_jsii_.MemberProperty{JsiiProperty: "isGlobalInput", GoGetter: "IsGlobalInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsGlobal", GoMethod: "ResetIsGlobal"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "isEncrypted", GoGetter: "IsEncrypted"},
			_jsii_.MemberProperty{JsiiProperty: "isEncryptedInput", GoGetter: "IsEncryptedInput"},
			_jsii_.MemberProperty{JsiiProperty: "isOptional", GoGetter: "IsOptional"},
			_jsii_.MemberProperty{JsiiProperty: "isOptionalInput", GoGetter: "IsOptionalInput"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetIsEncrypted", GoMethod: "ResetIsEncrypted"},
			_jsii_.MemberMethod{JsiiMethod: "resetIsOptional", GoMethod: "ResetIsOptional"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
