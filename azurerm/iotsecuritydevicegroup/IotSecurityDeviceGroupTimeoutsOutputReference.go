...
func (i *jsiiProxy_IotSecurityDeviceGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IotSecurityDeviceGroupTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
