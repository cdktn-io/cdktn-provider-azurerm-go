...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/iotsecuritydevicegroup/internal"
...
func (j *jsiiProxy_IotSecurityDeviceGroupTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIotSecurityDeviceGroupTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) IotSecurityDeviceGroupTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewIotSecurityDeviceGroupTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewIotSecurityDeviceGroupTimeoutsOutputReference_Override(i IotSecurityDeviceGroupTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotSecurityDeviceGroupTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IotSecurityDeviceGroupTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotSecurityDeviceGroupTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_IotSecurityDeviceGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotSecurityDeviceGroupTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
