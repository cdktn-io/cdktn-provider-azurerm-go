...
func (j *jsiiProxy_IotSecurityDeviceGroupRangeRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIotSecurityDeviceGroupRangeRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IotSecurityDeviceGroupRangeRuleList {
	_init_.Initialize()
...
func NewIotSecurityDeviceGroupRangeRuleList_Override(i IotSecurityDeviceGroupRangeRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotSecurityDeviceGroupRangeRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IotSecurityDeviceGroupRangeRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IotSecurityDeviceGroupRangeRuleList) Resolve(context cdktn.IResolveContext) interface{} {
