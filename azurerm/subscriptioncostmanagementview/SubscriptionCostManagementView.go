...
func (s *jsiiProxy_SubscriptionCostManagementView) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SubscriptionCostManagementView) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SubscriptionCostManagementView) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
