...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataPlaneProxyAuthenticationModeInput", GoGetter: "DataPlaneProxyAuthenticationModeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "dataPlaneProxyPrivateLinkDelegationEnabledInput", GoGetter: "DataPlaneProxyPrivateLinkDelegationEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDataPlaneProxyAuthenticationMode", GoMethod: "ResetDataPlaneProxyAuthenticationMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetDataPlaneProxyPrivateLinkDelegationEnabled", GoMethod: "ResetDataPlaneProxyPrivateLinkDelegationEnabled"},
