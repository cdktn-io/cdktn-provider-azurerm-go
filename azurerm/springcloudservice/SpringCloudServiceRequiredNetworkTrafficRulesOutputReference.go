...
func (j *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudServiceRequiredNetworkTrafficRulesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SpringCloudServiceRequiredNetworkTrafficRulesOutputReference {
	_init_.Initialize()

	if err := validateNewSpringCloudServiceRequiredNetworkTrafficRulesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewSpringCloudServiceRequiredNetworkTrafficRulesOutputReference_Override(s SpringCloudServiceRequiredNetworkTrafficRulesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
