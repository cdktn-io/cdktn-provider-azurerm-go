...
func (s *jsiiProxy_SpringCloudServiceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudServiceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
