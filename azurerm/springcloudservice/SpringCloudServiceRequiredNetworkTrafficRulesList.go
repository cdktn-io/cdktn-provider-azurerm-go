...
func (s *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesList) Resolve(context cdktf.IResolveContext) interface{} {
