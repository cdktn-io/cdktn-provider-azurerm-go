...
func (j *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudServiceRequiredNetworkTrafficRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SpringCloudServiceRequiredNetworkTrafficRulesList {
	_init_.Initialize()

	if err := validateNewSpringCloudServiceRequiredNetworkTrafficRulesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewSpringCloudServiceRequiredNetworkTrafficRulesList_Override(s SpringCloudServiceRequiredNetworkTrafficRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SpringCloudServiceRequiredNetworkTrafficRulesList) Resolve(context cdktn.IResolveContext) interface{} {
