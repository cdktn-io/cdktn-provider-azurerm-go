...
func (j *jsiiProxy_SpringCloudServiceConfigServerGitSettingRepositoryList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudServiceConfigServerGitSettingRepositoryList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SpringCloudServiceConfigServerGitSettingRepositoryList {
	_init_.Initialize()
...
func NewSpringCloudServiceConfigServerGitSettingRepositoryList_Override(s SpringCloudServiceConfigServerGitSettingRepositoryList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudServiceConfigServerGitSettingRepositoryList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudServiceConfigServerGitSettingRepositoryList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SpringCloudServiceConfigServerGitSettingRepositoryList) Resolve(context cdktn.IResolveContext) interface{} {
