...
func (s *jsiiProxy_SpringCloudServiceTraceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudServiceTraceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
