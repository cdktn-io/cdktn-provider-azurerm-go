...
func (s *jsiiProxy_SpringCloudServiceConfigServerGitSettingSshAuthOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudServiceConfigServerGitSettingSshAuthOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
