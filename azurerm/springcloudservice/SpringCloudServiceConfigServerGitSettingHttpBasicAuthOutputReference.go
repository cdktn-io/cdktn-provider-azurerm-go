...
func (j *jsiiProxy_SpringCloudServiceConfigServerGitSettingHttpBasicAuthOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudServiceConfigServerGitSettingHttpBasicAuthOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SpringCloudServiceConfigServerGitSettingHttpBasicAuthOutputReference {
	_init_.Initialize()

	if err := validateNewSpringCloudServiceConfigServerGitSettingHttpBasicAuthOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewSpringCloudServiceConfigServerGitSettingHttpBasicAuthOutputReference_Override(s SpringCloudServiceConfigServerGitSettingHttpBasicAuthOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudServiceConfigServerGitSettingHttpBasicAuthOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudServiceConfigServerGitSettingHttpBasicAuthOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudServiceConfigServerGitSettingHttpBasicAuthOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SpringCloudServiceConfigServerGitSettingHttpBasicAuthOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudServiceConfigServerGitSettingHttpBasicAuthOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
