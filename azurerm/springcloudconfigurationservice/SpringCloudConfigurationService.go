...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/springcloudconfigurationservice/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/spring_cloud_configuration_service azurerm_spring_cloud_configuration_service}.
...
func (j *jsiiProxy_SpringCloudConfigurationService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SpringCloudConfigurationService) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SpringCloudConfigurationService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SpringCloudConfigurationService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SpringCloudConfigurationService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SpringCloudConfigurationService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/spring_cloud_configuration_service azurerm_spring_cloud_configuration_service} Resource.
func NewSpringCloudConfigurationService(scope constructs.Construct, id *string, config *SpringCloudConfigurationServiceConfig) SpringCloudConfigurationService {
	...
	if err := validateNewSpringCloudConfigurationServiceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SpringCloudConfigurationService)SetCount(val interface{}) {
...
func (j *jsiiProxy_SpringCloudConfigurationService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SpringCloudConfigurationService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SpringCloudConfigurationService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SpringCloudConfigurationService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateSpringCloudConfigurationService_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SpringCloudConfigurationService_IsConstruct(x interface{}) *bool {
	...
	if err := validateSpringCloudConfigurationService_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SpringCloudConfigurationService_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateSpringCloudConfigurationService_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SpringCloudConfigurationService_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateSpringCloudConfigurationService_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SpringCloudConfigurationService) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SpringCloudConfigurationService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudConfigurationService) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SpringCloudConfigurationService) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SpringCloudConfigurationService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SpringCloudConfigurationService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SpringCloudConfigurationService) MoveFromId(id *string) {
...
func (s *jsiiProxy_SpringCloudConfigurationService) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SpringCloudConfigurationService) MoveToId(id *string) {
...
func (s *jsiiProxy_SpringCloudConfigurationService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SpringCloudConfigurationService) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SpringCloudConfigurationService) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SpringCloudConfigurationService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
