...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "refreshIntervalInSeconds", GoGetter: "RefreshIntervalInSeconds"},
			_jsii_.MemberProperty{JsiiProperty: "refreshIntervalInSecondsInput", GoGetter: "RefreshIntervalInSecondsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRefreshIntervalInSeconds", GoMethod: "ResetRefreshIntervalInSeconds"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetStrictHostKeyChecking", GoMethod: "ResetStrictHostKeyChecking"},
			...
			_jsii_.MemberProperty{JsiiProperty: "strictHostKeyChecking", GoGetter: "StrictHostKeyChecking"},
			_jsii_.MemberProperty{JsiiProperty: "strictHostKeyCheckingInput", GoGetter: "StrictHostKeyCheckingInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
