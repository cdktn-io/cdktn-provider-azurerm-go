...
func (j *jsiiProxy_SpringCloudConfigurationServiceRepositoryList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSpringCloudConfigurationServiceRepositoryList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SpringCloudConfigurationServiceRepositoryList {
	_init_.Initialize()
...
func NewSpringCloudConfigurationServiceRepositoryList_Override(s SpringCloudConfigurationServiceRepositoryList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SpringCloudConfigurationServiceRepositoryList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SpringCloudConfigurationServiceRepositoryList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SpringCloudConfigurationServiceRepositoryList) Resolve(context cdktn.IResolveContext) interface{} {
