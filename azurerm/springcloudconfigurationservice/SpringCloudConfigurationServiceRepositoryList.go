...
func (s *jsiiProxy_SpringCloudConfigurationServiceRepositoryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SpringCloudConfigurationServiceRepositoryList) Resolve(context cdktf.IResolveContext) interface{} {
