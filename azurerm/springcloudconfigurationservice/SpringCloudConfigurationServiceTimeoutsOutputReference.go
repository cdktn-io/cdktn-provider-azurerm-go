...
func (s *jsiiProxy_SpringCloudConfigurationServiceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudConfigurationServiceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
