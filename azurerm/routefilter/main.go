...
func init() {
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_RouteFilterRuleList{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "communitiesInput", GoGetter: "CommunitiesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCommunities", GoMethod: "ResetCommunities"},
