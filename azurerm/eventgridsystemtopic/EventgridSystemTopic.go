...
func (j *jsiiProxy_EventgridSystemTopic) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EventgridSystemTopic) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EventgridSystemTopic) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EventgridSystemTopic) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EventgridSystemTopic) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/eventgrid_system_topic azurerm_eventgrid_system_topic} Resource.
...
func (j *jsiiProxy_EventgridSystemTopic)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EventgridSystemTopic)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EventgridSystemTopic)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EventgridSystemTopic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EventgridSystemTopic) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridSystemTopic) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EventgridSystemTopic) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EventgridSystemTopic) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EventgridSystemTopic) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EventgridSystemTopic) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
