...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSourceArmResourceId", GoMethod: "ResetSourceArmResourceId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceArmResourceIdInput", GoGetter: "SourceArmResourceIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "topicTypeInput", GoGetter: "TopicTypeInput"},
