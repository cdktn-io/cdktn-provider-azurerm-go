...
func (j *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SynapseSqlPoolSecurityAlertPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SynapseSqlPoolSecurityAlertPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
