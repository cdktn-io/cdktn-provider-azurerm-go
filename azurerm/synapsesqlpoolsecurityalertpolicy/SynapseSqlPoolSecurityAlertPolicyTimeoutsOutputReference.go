...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/synapsesqlpoolsecurityalertpolicy/internal"
...
func (j *jsiiProxy_SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference {
	_init_.Initialize()

	if err := validateNewSynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
	j := jsiiProxy_SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktn/provider-azurerm.synapseSqlPoolSecurityAlertPolicy.SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference",
...
func NewSynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference_Override(s SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
