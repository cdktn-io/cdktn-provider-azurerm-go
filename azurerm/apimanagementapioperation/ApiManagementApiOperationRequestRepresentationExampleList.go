...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationExampleList) Resolve(context cdktf.IResolveContext) interface{} {
