...
func (j *jsiiProxy_ApiManagementApiOperationRequestRepresentationExampleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationRequestRepresentationExampleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationRequestRepresentationExampleList {
	_init_.Initialize()

	if err := validateNewApiManagementApiOperationRequestRepresentationExampleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiManagementApiOperationRequestRepresentationExampleList_Override(a ApiManagementApiOperationRequestRepresentationExampleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationRequestRepresentationExampleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationExampleList) Resolve(context cdktn.IResolveContext) interface{} {
