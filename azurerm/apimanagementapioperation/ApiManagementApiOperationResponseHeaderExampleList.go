...
func (a *jsiiProxy_ApiManagementApiOperationResponseHeaderExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseHeaderExampleList) Resolve(context cdktf.IResolveContext) interface{} {
