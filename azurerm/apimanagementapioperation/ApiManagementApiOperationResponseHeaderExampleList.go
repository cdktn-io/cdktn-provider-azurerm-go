...
func (j *jsiiProxy_ApiManagementApiOperationResponseHeaderExampleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationResponseHeaderExampleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationResponseHeaderExampleList {
	_init_.Initialize()

	if err := validateNewApiManagementApiOperationResponseHeaderExampleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiManagementApiOperationResponseHeaderExampleList_Override(a ApiManagementApiOperationResponseHeaderExampleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationResponseHeaderExampleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseHeaderExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseHeaderExampleList) Resolve(context cdktn.IResolveContext) interface{} {
