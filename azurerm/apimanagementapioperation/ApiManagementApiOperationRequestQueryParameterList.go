...
func (j *jsiiProxy_ApiManagementApiOperationRequestQueryParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationRequestQueryParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationRequestQueryParameterList {
	_init_.Initialize()
...
func NewApiManagementApiOperationRequestQueryParameterList_Override(a ApiManagementApiOperationRequestQueryParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationRequestQueryParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestQueryParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestQueryParameterList) Resolve(context cdktn.IResolveContext) interface{} {
