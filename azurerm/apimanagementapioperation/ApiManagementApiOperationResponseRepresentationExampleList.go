...
func (j *jsiiProxy_ApiManagementApiOperationResponseRepresentationExampleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationResponseRepresentationExampleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationResponseRepresentationExampleList {
	_init_.Initialize()
...
func NewApiManagementApiOperationResponseRepresentationExampleList_Override(a ApiManagementApiOperationResponseRepresentationExampleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationResponseRepresentationExampleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationExampleList) Resolve(context cdktn.IResolveContext) interface{} {
