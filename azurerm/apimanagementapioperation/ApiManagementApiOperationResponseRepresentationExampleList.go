...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationExampleList) Resolve(context cdktf.IResolveContext) interface{} {
