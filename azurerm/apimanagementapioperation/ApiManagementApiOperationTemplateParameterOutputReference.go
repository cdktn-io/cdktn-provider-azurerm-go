...
func (a *jsiiProxy_ApiManagementApiOperationTemplateParameterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationTemplateParameterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
