...
func (j *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationResponseRepresentationFormParameterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationResponseRepresentationFormParameterList {
	_init_.Initialize()

	if err := validateNewApiManagementApiOperationResponseRepresentationFormParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiManagementApiOperationResponseRepresentationFormParameterList_Override(a ApiManagementApiOperationResponseRepresentationFormParameterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterList) Resolve(context cdktn.IResolveContext) interface{} {
