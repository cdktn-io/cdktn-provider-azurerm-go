...
func (j *jsiiProxy_ApiManagementApiOperationRequestQueryParameterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationRequestQueryParameterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementApiOperationRequestQueryParameterOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementApiOperationRequestQueryParameterOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewApiManagementApiOperationRequestQueryParameterOutputReference_Override(a ApiManagementApiOperationRequestQueryParameterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationRequestQueryParameterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestQueryParameterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestQueryParameterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementApiOperationRequestQueryParameterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestQueryParameterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
