...
func (j *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterExampleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationResponseRepresentationFormParameterExampleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationResponseRepresentationFormParameterExampleList {
	_init_.Initialize()

	if err := validateNewApiManagementApiOperationResponseRepresentationFormParameterExampleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiManagementApiOperationResponseRepresentationFormParameterExampleList_Override(a ApiManagementApiOperationResponseRepresentationFormParameterExampleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterExampleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterExampleList) Resolve(context cdktn.IResolveContext) interface{} {
