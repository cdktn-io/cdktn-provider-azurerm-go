...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterExampleList) Resolve(context cdktf.IResolveContext) interface{} {
