...
func (j *jsiiProxy_ApiManagementApiOperationRequestHeaderList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationRequestHeaderList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationRequestHeaderList {
	_init_.Initialize()
...
func NewApiManagementApiOperationRequestHeaderList_Override(a ApiManagementApiOperationRequestHeaderList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationRequestHeaderList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestHeaderList) Resolve(context cdktn.IResolveContext) interface{} {
