...
func (j *jsiiProxy_ApiManagementApiOperationRequestRepresentationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationRequestRepresentationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationRequestRepresentationList {
	_init_.Initialize()
...
func NewApiManagementApiOperationRequestRepresentationList_Override(a ApiManagementApiOperationRequestRepresentationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationRequestRepresentationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationList) Resolve(context cdktn.IResolveContext) interface{} {
