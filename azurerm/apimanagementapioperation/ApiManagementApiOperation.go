...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/apimanagementapioperation/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/api_management_api_operation azurerm_api_management_api_operation}.
...
func (j *jsiiProxy_ApiManagementApiOperation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiManagementApiOperation) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ApiManagementApiOperation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiManagementApiOperation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiManagementApiOperation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApiManagementApiOperation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/api_management_api_operation azurerm_api_management_api_operation} Resource.
func NewApiManagementApiOperation(scope constructs.Construct, id *string, config *ApiManagementApiOperationConfig) ApiManagementApiOperation {
	...
	if err := validateNewApiManagementApiOperationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApiManagementApiOperation)SetCount(val interface{}) {
...
func (j *jsiiProxy_ApiManagementApiOperation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiManagementApiOperation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiManagementApiOperation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApiManagementApiOperation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApiManagementApiOperation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ApiManagementApiOperation_IsConstruct(x interface{}) *bool {
	...
	if err := validateApiManagementApiOperation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func ApiManagementApiOperation_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateApiManagementApiOperation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func ApiManagementApiOperation_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateApiManagementApiOperation_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ApiManagementApiOperation) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiManagementApiOperation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperation) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApiManagementApiOperation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiManagementApiOperation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiManagementApiOperation) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiManagementApiOperation) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApiManagementApiOperation) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiManagementApiOperation) PutTemplateParameter(value interface{}) {
	if err := a.validatePutTemplateParameterParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_ApiManagementApiOperation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiManagementApiOperation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApiManagementApiOperation) ToHclTerraform() interface{} {
	var returns interface{}
