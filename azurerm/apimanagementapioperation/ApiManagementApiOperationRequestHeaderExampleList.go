...
func (j *jsiiProxy_ApiManagementApiOperationRequestHeaderExampleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationRequestHeaderExampleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationRequestHeaderExampleList {
	_init_.Initialize()

	if err := validateNewApiManagementApiOperationRequestHeaderExampleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiManagementApiOperationRequestHeaderExampleList_Override(a ApiManagementApiOperationRequestHeaderExampleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationRequestHeaderExampleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestHeaderExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestHeaderExampleList) Resolve(context cdktn.IResolveContext) interface{} {
