...
func (a *jsiiProxy_ApiManagementApiOperationRequestHeaderExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestHeaderExampleList) Resolve(context cdktf.IResolveContext) interface{} {
