...
func (j *jsiiProxy_ApiManagementApiOperationRequestRepresentationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationRequestRepresentationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementApiOperationRequestRepresentationOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementApiOperationRequestRepresentationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewApiManagementApiOperationRequestRepresentationOutputReference_Override(a ApiManagementApiOperationRequestRepresentationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationRequestRepresentationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
