...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationList) Resolve(context cdktf.IResolveContext) interface{} {
