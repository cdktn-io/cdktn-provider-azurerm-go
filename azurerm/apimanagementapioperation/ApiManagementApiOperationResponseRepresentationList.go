...
func (j *jsiiProxy_ApiManagementApiOperationResponseRepresentationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationResponseRepresentationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationResponseRepresentationList {
	_init_.Initialize()

	if err := validateNewApiManagementApiOperationResponseRepresentationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewApiManagementApiOperationResponseRepresentationList_Override(a ApiManagementApiOperationResponseRepresentationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationResponseRepresentationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationList) Resolve(context cdktn.IResolveContext) interface{} {
