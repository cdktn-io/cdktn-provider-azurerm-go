...
func (j *jsiiProxy_ApiManagementApiOperationTemplateParameterExampleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApiManagementApiOperationTemplateParameterExampleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementApiOperationTemplateParameterExampleOutputReference {
	_init_.Initialize()

	if err := validateNewApiManagementApiOperationTemplateParameterExampleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewApiManagementApiOperationTemplateParameterExampleOutputReference_Override(a ApiManagementApiOperationTemplateParameterExampleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApiManagementApiOperationTemplateParameterExampleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApiManagementApiOperationTemplateParameterExampleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationTemplateParameterExampleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApiManagementApiOperationTemplateParameterExampleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationTemplateParameterExampleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
