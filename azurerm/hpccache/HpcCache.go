...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/hpc_cache azurerm_hpc_cache} Resource.
...
func (h *jsiiProxy_HpcCache) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HpcCache) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HpcCache) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
