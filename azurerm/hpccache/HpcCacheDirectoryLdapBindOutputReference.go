...
func (j *jsiiProxy_HpcCacheDirectoryLdapBindOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHpcCacheDirectoryLdapBindOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HpcCacheDirectoryLdapBindOutputReference {
	_init_.Initialize()

	if err := validateNewHpcCacheDirectoryLdapBindOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewHpcCacheDirectoryLdapBindOutputReference_Override(h HpcCacheDirectoryLdapBindOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HpcCacheDirectoryLdapBindOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HpcCacheDirectoryLdapBindOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HpcCacheDirectoryLdapBindOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HpcCacheDirectoryLdapBindOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HpcCacheDirectoryLdapBindOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
