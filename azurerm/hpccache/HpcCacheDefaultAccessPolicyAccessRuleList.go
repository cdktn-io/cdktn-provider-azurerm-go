...
func (h *jsiiProxy_HpcCacheDefaultAccessPolicyAccessRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HpcCacheDefaultAccessPolicyAccessRuleList) Resolve(context cdktf.IResolveContext) interface{} {
