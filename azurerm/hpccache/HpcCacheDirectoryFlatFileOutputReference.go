...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/hpccache/internal"
...
func (j *jsiiProxy_HpcCacheDirectoryFlatFileOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHpcCacheDirectoryFlatFileOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) HpcCacheDirectoryFlatFileOutputReference {
	_init_.Initialize()

	if err := validateNewHpcCacheDirectoryFlatFileOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewHpcCacheDirectoryFlatFileOutputReference_Override(h HpcCacheDirectoryFlatFileOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HpcCacheDirectoryFlatFileOutputReference)SetGroupFileUri(val *string) {
	if err := j.validateSetGroupFileUriParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_HpcCacheDirectoryFlatFileOutputReference)SetPasswordFileUri(val *string) {
	if err := j.validateSetPasswordFileUriParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_HpcCacheDirectoryFlatFileOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HpcCacheDirectoryFlatFileOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HpcCacheDirectoryFlatFileOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (h *jsiiProxy_HpcCacheDirectoryFlatFileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (h *jsiiProxy_HpcCacheDirectoryFlatFileOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
