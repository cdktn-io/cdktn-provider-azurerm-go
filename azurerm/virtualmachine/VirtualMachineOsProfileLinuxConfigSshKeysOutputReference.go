...
func (j *jsiiProxy_VirtualMachineOsProfileLinuxConfigSshKeysOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineOsProfileLinuxConfigSshKeysOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualMachineOsProfileLinuxConfigSshKeysOutputReference {
	_init_.Initialize()
...
func NewVirtualMachineOsProfileLinuxConfigSshKeysOutputReference_Override(v VirtualMachineOsProfileLinuxConfigSshKeysOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineOsProfileLinuxConfigSshKeysOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineOsProfileLinuxConfigSshKeysOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineOsProfileLinuxConfigSshKeysOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualMachineOsProfileLinuxConfigSshKeysOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineOsProfileLinuxConfigSshKeysOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
