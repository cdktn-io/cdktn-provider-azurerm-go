...
func (j *jsiiProxy_VirtualMachineStorageDataDiskList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineStorageDataDiskList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineStorageDataDiskList {
	_init_.Initialize()

	if err := validateNewVirtualMachineStorageDataDiskListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewVirtualMachineStorageDataDiskList_Override(v VirtualMachineStorageDataDiskList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineStorageDataDiskList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineStorageDataDiskList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineStorageDataDiskList) Resolve(context cdktn.IResolveContext) interface{} {
