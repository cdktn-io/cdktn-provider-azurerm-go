...
func (v *jsiiProxy_VirtualMachineStorageDataDiskList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineStorageDataDiskList) Resolve(context cdktf.IResolveContext) interface{} {
