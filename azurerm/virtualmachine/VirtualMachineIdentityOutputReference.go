...
func (v *jsiiProxy_VirtualMachineIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
