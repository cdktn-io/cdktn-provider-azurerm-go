...
func (v *jsiiProxy_VirtualMachineBootDiagnosticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineBootDiagnosticsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
