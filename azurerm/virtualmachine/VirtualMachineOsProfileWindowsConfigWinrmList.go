...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmList) Resolve(context cdktf.IResolveContext) interface{} {
