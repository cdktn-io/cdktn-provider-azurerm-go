...
func (j *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineOsProfileWindowsConfigWinrmList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineOsProfileWindowsConfigWinrmList {
	_init_.Initialize()
...
func NewVirtualMachineOsProfileWindowsConfigWinrmList_Override(v VirtualMachineOsProfileWindowsConfigWinrmList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmList) Resolve(context cdktn.IResolveContext) interface{} {
