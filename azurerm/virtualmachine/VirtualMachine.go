...
func (j *jsiiProxy_VirtualMachine) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_VirtualMachine) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_VirtualMachine) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VirtualMachine) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_VirtualMachine) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_VirtualMachine)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_VirtualMachine)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_VirtualMachine)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func VirtualMachine_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (v *jsiiProxy_VirtualMachine) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachine) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (v *jsiiProxy_VirtualMachine) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachine) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_VirtualMachine) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_VirtualMachine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
