...
func (j *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigList {
	_init_.Initialize()
...
func NewVirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigList_Override(v VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigList) Resolve(context cdktn.IResolveContext) interface{} {
