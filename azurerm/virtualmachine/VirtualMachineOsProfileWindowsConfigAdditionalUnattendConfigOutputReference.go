...
func (j *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference {
	_init_.Initialize()
...
func NewVirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference_Override(v VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
