...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/virtualmachine/internal"
...
func (j *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineOsProfileWindowsConfigWinrmOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualMachineOsProfileWindowsConfigWinrmOutputReference {
	_init_.Initialize()

	if err := validateNewVirtualMachineOsProfileWindowsConfigWinrmOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewVirtualMachineOsProfileWindowsConfigWinrmOutputReference_Override(v VirtualMachineOsProfileWindowsConfigWinrmOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigWinrmOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
