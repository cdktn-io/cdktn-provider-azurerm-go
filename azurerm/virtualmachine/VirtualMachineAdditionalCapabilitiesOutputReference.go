...
func (v *jsiiProxy_VirtualMachineAdditionalCapabilitiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineAdditionalCapabilitiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
