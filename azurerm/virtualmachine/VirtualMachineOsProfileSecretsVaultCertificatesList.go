...
func (v *jsiiProxy_VirtualMachineOsProfileSecretsVaultCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineOsProfileSecretsVaultCertificatesList) Resolve(context cdktf.IResolveContext) interface{} {
