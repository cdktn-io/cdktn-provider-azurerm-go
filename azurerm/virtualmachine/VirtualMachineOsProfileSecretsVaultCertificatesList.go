...
func (j *jsiiProxy_VirtualMachineOsProfileSecretsVaultCertificatesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineOsProfileSecretsVaultCertificatesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineOsProfileSecretsVaultCertificatesList {
	_init_.Initialize()

	if err := validateNewVirtualMachineOsProfileSecretsVaultCertificatesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewVirtualMachineOsProfileSecretsVaultCertificatesList_Override(v VirtualMachineOsProfileSecretsVaultCertificatesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineOsProfileSecretsVaultCertificatesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineOsProfileSecretsVaultCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineOsProfileSecretsVaultCertificatesList) Resolve(context cdktn.IResolveContext) interface{} {
