...
func (v *jsiiProxy_VirtualMachineTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
