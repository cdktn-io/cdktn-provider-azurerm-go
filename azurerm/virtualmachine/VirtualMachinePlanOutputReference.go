...
func (v *jsiiProxy_VirtualMachinePlanOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachinePlanOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
