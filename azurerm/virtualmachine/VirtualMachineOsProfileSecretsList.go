...
func (j *jsiiProxy_VirtualMachineOsProfileSecretsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewVirtualMachineOsProfileSecretsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineOsProfileSecretsList {
	_init_.Initialize()
...
func NewVirtualMachineOsProfileSecretsList_Override(v VirtualMachineOsProfileSecretsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VirtualMachineOsProfileSecretsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (v *jsiiProxy_VirtualMachineOsProfileSecretsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineOsProfileSecretsList) Resolve(context cdktn.IResolveContext) interface{} {
